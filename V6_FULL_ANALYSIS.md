...
_Auto-generated **5/4/2026, 11:01:06 AM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 129 shipped+graded picks · 2026-04-18 → 2026-05-03
**Headline:** 59-68-2 · WR 46.5% [38.0%–55.1%] vs 52.4% break-even · -8.5u flat (-6.6%) · -19.7u peak.
**Overall t-test:** t = -0.69 → ✗ noise.

**Verdict:** ✗ overall sample is consistent with zero or negative true ROI.

### Where IS the edge?

The deltas are real signals: **ρ(Δw, flat ROI) = 0.307 ✓ p<.01** and **ρ(Δw+Δq, flat ROI) = 0.248 ✓ p<.01**. The overall sample loses because we ship picks across cohorts that have no edge. Cohort breakdown:
...
- **Stale Δw ≤ 0** — N=34, 9-24, WR 27.3% [15%–44%], flat ROI -47.1% (t=-3.23 ✓ p<.01)
...
- **Stale Δw ≤ 0**: −47.1% flat ROI on 34 picks. Already addressed by the post-4/24 mute engine — should not re-appear.
- **Sample size:** at observed σ (1.09u/pick), we need **~1813 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 129. Cohort findings are provisional until N grows.
...
| Shipped + graded | **129** |
| W-L-P | 59-68-2 |
| Win rate | **46.5%** [38.0%–55.1%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +5.9 pp |
| Peak-units PnL | **-19.7u** |
| Flat-1u PnL | **-8.5u** (-6.6% flat ROI) |
| Flat t-statistic vs zero | -0.69 → ✗ noise |
| Flat 95% CI per-pick | [-0.254, 0.121]u |
...
We have **129** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = +1 | 43 | 21-21-1 | 50.0% [36–64] | -5.5% | -5.4u | -0.37 ✗ noise |
| Δw = +2 | 28 | 13-15-0 | 46.4% [30–64] | -3.3% | -5.8u | -0.16 ✗ noise |
| Δw ≥ +3 | 19 | 13-6-0 | 68.4% [46–85] | +57.3% | +9.1u | 1.66 ~ p<.10 |

**Pearson ρ(Δw, WIN) = 0.272** ✓ p<.01  ·  **ρ(Δw, flat ROI) = 0.307** ✓ p<.01

### §2b. Δq — quality margin (frozen, contribution ≥ 30)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δq ≤ −2 | 2 | 1-1-0 | 50.0% [9–91] | -1.9% | -0.3u | -0.02 ✗ noise |
| Δq = −1 | 0 | — | — | — | — | — |
| Δq = 0 | 6 | 1-5-0 | 16.7% [3–56] | -70.5% | -3.7u | -2.39 ✓ p<.05 |
| Δq = +1 | 30 | 13-17-0 | 43.3% [27–61] | -16.2% | -3.6u | -0.90 ✗ noise |
| Δq = +2 | 38 | 18-20-0 | 47.4% [32–63] | -3.2% | -6.8u | -0.18 ✗ noise |
| Δq ≥ +3 | 47 | 22-23-2 | 48.9% [35–63] | +2.2% | -8.6u | 0.12 ✗ noise |

**Pearson ρ(Δq, WIN) = 0.128** ✗  ·  **ρ(Δq, flat ROI) = 0.120** ✗

### §2c. Δw + Δq — scalar sum (v6.6 hybrid floor input)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 11 | 2-9-0 | 18.2% [5–48] | -63.4% | -6.8u | -2.59 ✓ p<.01 |
| Σ = +1 | 6 | 1-5-0 | 16.7% [3–56] | -70.5% | -3.7u | -2.39 ✓ p<.05 |
| Σ = +2 | 19 | 10-9-0 | 52.6% [32–73] | -5.1% | -3.6u | -0.24 ✗ noise |
...
**Pearson ρ(Δw+Δq, WIN) = 0.237** ✓ p<.01  ·  **ρ(Σ, flat ROI) = 0.248** ✓ p<.01

Spearman rank ρ(Δw+Δq, flat ROI) = 0.215.

### §2d. Which axis is the strongest single predictor?

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | 0.284 ✓ p<.01 | 0.316 ✓ p<.01 | 0.259 | meaningful |
| Δq | 0.128 ✗ | 0.120 ✗ | 0.107 | weak |
| Δw + Δq | 0.237 ✓ p<.01 | 0.248 ✓ p<.01 | 0.215 | meaningful |
| Δw × Δq | 0.253 ✓ p<.01 | 0.273 ✓ p<.01 | 0.226 | meaningful |
| peak.stars | 0.035 ✗ | 0.006 ✗ | 0.003 | weak |
| lock.stars | -0.011 ✗ | 0.002 ✗ | -0.025 | weak |
...
| +0 | N=1 · 1-0 · 100% [21–100] · —  | — | — | N=4 · 0-4 · 0% [0–49] · -100%  | N=4 · 0-4 · 0% [0–49] · -100%  | N=8 · 5-3 · 63% [31–86] · +12%  | N=9 · 1-7 · 13% [2–47] · -66% ✗ |
| +1 | — | — | — | N=1 · 1-0 · 100% [21–100] · —  | N=11 · 5-6 · 45% [21–72] · -18%  | N=15 · 7-8 · 47% [25–70] · -11%  | N=16 · 8-7 · 53% [30–75] · +3%  |
...
| qFor = 1 | 9 | 5-4-0 | 55.6% [27–81] | +5.5% | -0.3u | 0.16 ✗ noise |
| qFor = 2 | 40 | 18-22-0 | 45.0% [31–60] | -13.0% | -5.8u | -0.83 ✗ noise |
| qFor ≥ 3 | 74 | 32-40-2 | 44.4% [34–56] | -6.2% | -16.8u | -0.46 ✗ noise |

ρ(qFor, WIN) = -0.056 ✗  ·  ρ(qFor, flat ROI) = 0.030 ✗

**Margin (qFor − qAgainst):**

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| margin ≤ 0 | 13 | 6-7-0 | 46.2% [23–71] | -19.2% | +0.0u | -0.75 ✗ noise |
| margin = +1 | 29 | 13-16-0 | 44.8% [28–62] | -11.3% | -1.0u | -0.60 ✗ noise |
| margin = +2 | 43 | 20-22-1 | 47.6% [33–62] | -7.3% | -8.9u | -0.48 ✗ noise |
| margin ≥ +3 | 44 | 20-23-1 | 46.5% [33–61] | +0.9% | -9.7u | 0.05 ✗ noise |

ρ(margin, WIN) = 0.055 ✗  ·  ρ(margin, flat ROI) = 0.086 ✗
...
|---|---|---|---|---|---|---|
| qFor = 0 | 6 | 4-2-0 | 66.7% [30–90] | +12.8% | +3.2u | 0.35 ✗ noise |
| qFor = 1 | 19 | 10-9-0 | 52.6% [32–73] | -2.1% | -5.5u | -0.09 ✗ noise |
| qFor = 2 | 41 | 18-22-1 | 45.0% [31–60] | -12.8% | -1.8u | -0.84 ✗ noise |
| qFor ≥ 3 | 63 | 27-35-1 | 43.5% [32–56] | -5.8% | -15.6u | -0.38 ✗ noise |

ρ(qFor, WIN) = -0.068 ✗  ·  ρ(qFor, flat ROI) = -0.026 ✗

**Margin (qFor − qAgainst):**

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| margin ≤ 0 | 16 | 7-9-0 | 43.8% [23–67] | +2.2% | -2.1u | 0.06 ✗ noise |
| margin = +1 | 39 | 21-18-0 | 53.8% [39–68] | +7.5% | -1.3u | 0.45 ✗ noise |
| margin = +2 | 40 | 14-24-2 | 36.8% [23–53] | -28.9% | -11.7u | -1.99 ✓ p<.05 |
| margin ≥ +3 | 34 | 17-17-0 | 50.0% [34–66] | -0.8% | -4.5u | -0.04 ✗ noise |

ρ(margin, WIN) = 0.045 ✗  ·  ρ(margin, flat ROI) = 0.005 ✗
...
| qFor = 1 | 40 | 23-17-0 | 57.5% [42–71] | +10.7% | +5.7u | 0.70 ✗ noise |
| qFor = 2 | 40 | 14-25-1 | 35.9% [23–52] | -20.9% | -14.8u | -1.08 ✗ noise |
| qFor ≥ 3 | 35 | 16-18-1 | 47.1% [31–63] | -4.5% | -7.9u | -0.24 ✗ noise |

ρ(qFor, WIN) = -0.075 ✗  ·  ρ(qFor, flat ROI) = -0.063 ✗

**Margin (qFor − qAgainst):**

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| margin ≤ 0 | 32 | 16-16-0 | 50.0% [34–66] | +14.2% | -0.5u | 0.59 ✗ noise |
| margin = +1 | 43 | 21-21-1 | 50.0% [36–64] | -2.2% | -4.3u | -0.14 ✗ noise |
| margin = +2 | 32 | 12-19-1 | 38.7% [24–56] | -26.5% | -9.2u | -1.61 ✗ noise |
| margin ≥ +3 | 22 | 10-12-0 | 45.5% [27–65] | -16.6% | -5.6u | -0.81 ✗ noise |

ρ(margin, WIN) = -0.025 ✗  ·  ρ(margin, flat ROI) = -0.112 ✗
...
| qFor = 1 | 44 | 22-20-2 | 52.4% [38–67] | +2.9% | +2.9u | 0.20 ✗ noise |
| qFor = 2 | 25 | 9-16-0 | 36.0% [20–55] | -19.0% | -13.1u | -0.71 ✗ noise |
| qFor ≥ 3 | 23 | 10-13-0 | 43.5% [26–63] | -8.8% | -6.8u | -0.36 ✗ noise |

ρ(qFor, WIN) = -0.055 ✗  ·  ρ(qFor, flat ROI) = -0.027 ✗

**Margin (qFor − qAgainst):**

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| margin ≤ 0 | 53 | 26-26-1 | 50.0% [37–63] | +4.4% | +0.7u | 0.27 ✗ noise |
| margin = +1 | 42 | 18-23-1 | 43.9% [30–59] | -13.3% | -12.8u | -0.86 ✗ noise |
| margin = +2 | 18 | 9-9-0 | 50.0% [29–71] | -0.9% | -0.1u | -0.03 ✗ noise |
| margin ≥ +3 | 16 | 6-10-0 | 37.5% [18–61] | -32.1% | -7.5u | -1.40 ✗ noise |

ρ(margin, WIN) = -0.003 ✗  ·  ρ(margin, flat ROI) = -0.071 ✗
...
| qFor = 1 | 51 | 20-31-0 | 39.2% [27–53] | -22.8% | -15.9u | -1.67 ~ p<.10 |
| qFor = 2 | 22 | 11-11-0 | 50.0% [31–69] | +9.2% | -6.4u | 0.30 ✗ noise |
| qFor ≥ 3 | 7 | 3-4-0 | 42.9% [16–75] | +11.4% | +0.6u | 0.19 ✗ noise |

ρ(qFor, WIN) = -0.058 ✗  ·  ρ(qFor, flat ROI) = -0.008 ✗

**Margin (qFor − qAgainst):**

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| margin ≤ 0 | 68 | 32-34-2 | 48.5% [37–60] | +0.2% | -1.3u | 0.02 ✗ noise |
| margin = +1 | 39 | 17-22-0 | 43.6% [29–59] | -16.9% | -15.8u | -1.08 ✗ noise |
...
Tercile cuts: low ≤ 87.1 · mid ≤ 164.8 · high > 164.8

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Low Δcontrib | 44 | 23-21-0 | 52.3% [38–66] | +9.7% | +5.9u | 0.53 ✗ noise |
| Mid Δcontrib | 43 | 20-22-1 | 47.6% [33–62] | -7.5% | -9.2u | -0.49 ✗ noise |
| High Δcontrib | 42 | 16-25-1 | 39.0% [26–54] | -22.8% | -16.3u | -1.44 ✗ noise |

ρ(Δcontrib, WIN) = 0.013 ✗  ·  ρ(Δcontrib, flat ROI) = -0.003 ✗
...
| 4.0★ | 18 | 9-8-1 | 52.9% [31–74] | +7.9% | -1.3u | 0.32 ✗ noise |
...
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 3/33%/-55% | 1/0%/-100% | 4/0%/-100% | 4/25%/-48% | 9/38%/-26% | 12/25%/-51% |
| Δw = +1 | 1/100%/+27% | 3/33%/-35% | 10/56%/+7% | 17/41%/-18% | 2/0%/-100% | 9/67%/+22% |
...
| −150/−101 | 71 | 34-36-1 | 48.6% [37–60] | -8.0% | -11.4u | -0.71 ✗ noise |
...
| +201+ | 6 | 2-4-0 | 33.3% [10–70] | +61.7% | +3.0u | 0.59 ✗ noise |
...
| −150/−101 | -38% (20) | +14% (25) | -18% (16) | +16% (8) |
| −100/+100 | -100% (1) | -100% (1) | -100% (1) | — |
| +101/+150 | +39% (3) | -27% (13) | +36% (8) | +77% (4) |
| +151/+200 | — | — | +198% (1) | — |
| +201+ | -100% (1) | -100% (1) | -100% (1) | +223% (3) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 73 | 33-40-0 | 45.2% [34–57] | -6.5% | -11.9u | -0.47 ✗ noise |
| SPREAD | 22 | 7-14-1 | 33.3% [17–55] | -34.2% | -9.9u | -1.76 ~ p<.10 |
...
|---|---|---|---|---|
| ML | N=14 · 14% · -75% | N=23 · 43% · -20% | N=17 · 41% · -9% | N=16 · 75% · +75% |
| SPREAD | N=10 · 22% · -51% | N=6 · 33% · -36% | N=5 · 60% · +15% | N=1 · 0% · -100% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 44 | 18-26-0 | 40.9% [28–56] | -20.0% | -11.3u | -1.35 ✗ noise |
| NBA | 68 | 31-36-1 | 46.3% [35–58] | -5.3% | -11.6u | -0.37 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=6 · 17% · -66% | N=18 · 39% · -25% | N=13 · 31% · -37% | N=6 · 83% · +63% |
| NBA | N=24 · 26% · -50% | N=17 · 59% · +12% | N=11 · 55% · +13% | N=12 · 58% · +47% |
...
|---|---|---|
| **sharps3Plus** | 85 · 41% · -14.4% · -1.16 ✗ noise | 44 · 57% · +8.3% · 0.57 ✗ noise |
| **plusEV** | 22 · 32% · -31.1% · -1.08 ✗ noise | 107 · 50% · -1.6% · -0.16 ✗ noise |
| **pinnacleConfirms** | 42 · 50% · +4.6% · 0.24 ✗ noise | 31 · 39% · -21.5% · -1.08 ✗ noise |
| **invested10kPlus** | 68 · 44% · -7.9% · -0.55 ✗ noise | 5 · 60% · +12.8% · 0.26 ✗ noise |
| **lineMovingWith** | 79 · 49% · -1.9% · -0.15 ✗ noise | 50 · 43% · -14.0% · -0.94 ✗ noise |
| **predMarketAligns** | 36 · 50% · -1.0% · -0.05 ✗ noise | 37 · 41% · -11.8% · -0.62 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 7 | 6-1-0 | 85.7% [49–97] | +69.7% | +3.5u | 2.46 ✓ p<.05 |
| 1 | 29 | 12-16-1 | 42.9% [27–61] | -18.1% | -4.8u | -1.04 ✗ noise |
| 2 | 40 | 18-21-1 | 46.2% [32–61] | -2.7% | -2.7u | -0.15 ✗ noise |
| 3 | 17 | 6-11-0 | 35.3% [17–59] | -37.3% | -13.7u | -1.70 ~ p<.10 |
| 4 | 14 | 5-9-0 | 35.7% [16–61] | -25.6% | -5.6u | -0.91 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLEAR_MOVE | 33 | 19-13-1 | 59.4% [42–74] | +7.5% | +4.1u | 0.46 ✗ noise |
| NEAR_START | 69 | 31-37-1 | 45.6% [34–57] | -2.3% | -7.5u | -0.16 ✗ noise |
| NO_MOVE | 6 | 2-4-0 | 33.3% [10–70] | -36.2% | -1.1u | -0.90 ✗ noise |
| SMALL_MOVE | 20 | 6-14-0 | 30.0% [15–52] | -40.6% | -16.1u | -1.87 ~ p<.10 |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 68 | 30-37-1 | 44.8% [33–57] | -15.9% | -17.1u | -1.38 ✗ noise |
| STRONG | 32 | 16-16-0 | 50.0% [34–66] | -2.9% | +2.5u | -0.16 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.094 ✗ | -0.025 ✗ | -0.090 | -0.28 |
| totalInvested | -0.121 ✗ | -0.111 ✗ | -0.029 | -1.25 |
| evEdge | -0.006 ✗ | 0.005 ✗ | -0.027 | 0.06 |
| moneyPct | -0.003 ✗ | -0.085 ✗ | -0.050 | -0.97 |
| walletPct | 0.050 ✗ | 0.017 ✗ | 0.041 | 0.19 |
| criteriaMet | -0.038 ✗ | -0.011 ✗ | -0.086 | -0.12 |
| maxContribFor | -0.080 ✗ | -0.056 ✗ | -0.042 | -0.63 |
| meanBaseFor | -0.045 ✗ | -0.034 ✗ | -0.016 | -0.39 |
...
Sample with CLV: **125** picks. Mean CLV = **-0.0024**.
t-statistic vs zero: -1.59 → ✗ noise · 95% CI [-0.0053, 0.0005]
...
| CLV (−2%, 0] | 68 | 31-35-2 | 47.0% [35–59] | -6.2% | -8.4u | -0.49 ✗ noise |
| CLV (0, +2%] | 36 | 18-18-0 | 50.0% [34–66] | +9.5% | -0.2u | 0.45 ✗ noise |
| CLV > +2% | 11 | 4-7-0 | 36.4% [15–65] | -37.7% | -8.8u | -1.39 ✗ noise |

ρ(CLV, flat ROI) = -0.049 ✗
...
Trained on N=129 (with all features non-null). Intercept β₀ = -0.187.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | Δw | +0.576 | ↑ helps |
| 2 | sharpCount | -0.274 | ↓ hurts |
| 3 | Δq | +0.234 | ↑ helps |
| 4 | meanBaseFor | -0.228 | ↓ hurts |
| 5 | criteriaMet | -0.138 | ↓ hurts |
| 6 | log(impliedProb) | +0.126 | ↑ helps |
| 7 | qFor@T50 | -0.102 | ↓ hurts |
| 8 | odds (American) | -0.102 | ↓ hurts |
| 9 | peak.stars | -0.073 | ↓ hurts |
| 10 | walletPct | -0.068 | ↓ hurts |
| 11 | moneyPct | -0.046 | ≈ flat |
| 12 | evEdge | +0.044 | ≈ flat |
| 13 | margin@T50 | +0.042 | ≈ flat |
| 14 | maxContribFor | +0.029 | ≈ flat |
| 15 | log10(invested) | +0.010 | ≈ flat |
...
| Floor-A (Δw = +1 ∧ Δq = +1)  [MUTED v6.6] | 11 | 5-6 | 45.5% | 47.6% | -105 | — (mute) | 0.89u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.326  (annualized × √252 ≈ -5.17)
...
| 2026-05-03 | MLB | ML | away | 2.8 | 0.75 | -130 | 1 | 0 | 1 | 1 | 0 | 2 | -1.00 | W | +0.6u |
| 2026-05-03 | NBA | ML | away | 4.0 | 0.75 | +310 | 0 | 0 | 0 | 1 | 1 | 6 | 0.70 | L | -0.8u |
| 2026-05-03 | NBA | SPREAD | home | 2.5 | 0.75 | -105 | 1 | 1 | 2 | 1 | 0 | 0 | -0.20 | W | +0.7u |
| 2026-05-03 | NBA | ML | away | 4.0 | 0.75 | +260 | 1 | 1 | 2 | 3 | 0 | 4 | -0.70 | L | -0.8u |
| 2026-05-03 | NBA | SPREAD | home | 2.8 | 0.75 | -104 | 0 | -3 | -3 | 1 | 1 | 1 | -1.20 | W | +0.7u |
