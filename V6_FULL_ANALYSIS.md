...
_Auto-generated **5/26/2026, 12:35:02 PM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 321 shipped+graded picks · 2026-04-18 → 2026-05-25  (HC analyses scoped to post-cutover 2026-04-30, 209 picks)
**Headline:** 156-162-3 · WR 49.1% [43.6%–54.5%] vs 52.4% break-even · -15.9u flat (-5.0%) · -67.9u peak.
...
- **ρ(Δw, flat ROI) = 0.074 ✗**  (full sample, N=315)
- **ρ(HC, flat ROI) = -0.022 ✗**  (post-cutover, N=209)
- **ρ(Δw+HC, flat ROI) = -0.047 ✗**  (post-cutover, N=209)
...
- **Tier-1a HC ≥ +2 (post-cutover)** — N=24, 8-16, WR 33.3% [18%–53%], flat ROI -36.3% (t=-1.89 ~ p<.10)
- **Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era)** — N=37, 15-22, WR 40.5% [26%–57%], flat ROI -26.9% (t=-1.80 ~ p<.10)
- **Stale Δw ≤ 0 (full sample)** — N=62, 23-37, WR 38.3% [27%–51%], flat ROI -27.8% (t=-2.40 ✓ p<.05)

### Action map

- **Tier-1a (HC ≥ +2)** — N=24, WR 33.3%, flat ROI -36.3%. Bayesian posterior WR ≈ 38.2%, half-Kelly = **0.0%** bankroll at −110 → **size aggressively**.
- **Tier-1b (HC = +1)** — N=94, WR 56.4%, flat ROI +11.4%. Bayesian posterior WR ≈ 55.8%, half-Kelly = **3.6%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=37, WR 40.5%, flat ROI -26.9%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=66, WR 51.5%, flat ROI +7.0%. Bayesian posterior WR ≈ 51.3%, half-Kelly = **0.0%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -27.8% flat ROI on 62 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (1.01u/pick), we need **~1581 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 321. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **321** |
| W-L-P | 156-162-3 |
| Win rate | **49.1%** [43.6%–54.5%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +3.3 pp |
| Peak-units PnL | **-67.9u** |
| Flat-1u PnL | **-15.9u** (-5.0% flat ROI) |
| Flat t-statistic vs zero | -0.88 → ✗ noise |
| Flat 95% CI per-pick | [-0.161, 0.061]u |

### Power note

At our observed flat-PnL standard deviation (1.01u/pick), to detect a true edge of:
...
We have **321** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = −1 | 10 | 2-8-0 | 20.0% [6–51] | -64.6% | -5.8u | -2.69 ✓ p<.01 |
| Δw = 0 | 51 | 21-28-2 | 42.9% [30–57] | -19.1% | -16.7u | -1.47 ✗ noise |
| Δw = +1 | 110 | 61-48-1 | 56.0% [47–65] | +4.7% | +4.9u | 0.53 ✗ noise |
| Δw = +2 | 77 | 34-43-0 | 44.2% [34–55] | -12.2% | -34.7u | -1.06 ✗ noise |
| Δw ≥ +3 | 66 | 34-32-0 | 51.5% [40–63] | +7.0% | -19.1u | 0.48 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.063** ✗  ·  **ρ(Δw, flat ROI) = 0.074** ✗  (N=315)
...
|---|---|---|---|---|---|---|
| HC ≤ −2 | 0 | — | — | — | — | — |
| HC = −1 | 5 | 1-4-0 | 20.0% [4–62] | -63.2% | -4.6u | -1.72 ~ p<.10 |
| HC = 0 | 86 | 43-41-2 | 51.2% [41–62] | -6.9% | -20.0u | -0.70 ✗ noise |
| HC = +1 | 94 | 53-41-0 | 56.4% [46–66] | +11.4% | -0.4u | 1.09 ✗ noise |
| HC = +2 | 17 | 6-11-0 | 35.3% [17–59] | -26.8% | -22.7u | -1.07 ✗ noise |
| HC ≥ +3 | 7 | 2-5-0 | 28.6% [8–64] | -59.6% | -9.5u | -2.28 ✓ p<.05 |

**Pearson ρ(HC, WIN) = -0.026** ✗  ·  **ρ(HC, flat ROI) = -0.022** ✗  (N=209)

Spearman rank ρ(HC, flat ROI) = 0.054.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 20 | 8-11-1 | 42.1% [23–64] | -23.6% | -9.9u | -1.19 ✗ noise |
| Σ = +1 | 51 | 28-22-1 | 56.0% [42–69] | +4.9% | +6.3u | 0.37 ✗ noise |
| Σ = +2 | 60 | 36-24-0 | 60.0% [47–71] | +12.1% | +3.6u | 1.00 ✗ noise |
| Σ = +3 | 32 | 12-20-0 | 37.5% [23–55] | -23.5% | -19.6u | -1.28 ✗ noise |
| Σ = +4 | 21 | 11-10-0 | 52.4% [32–72] | +5.1% | -13.7u | 0.22 ✗ noise |
| Σ = +5 | 11 | 4-7-0 | 36.4% [15–65] | -27.1% | -9.9u | -0.89 ✗ noise |
| Σ ≥ +6 | 14 | 6-8-0 | 42.9% [21–67] | -19.8% | -14.1u | -0.75 ✗ noise |

**Pearson ρ(Δw+HC, WIN) = -0.046** ✗  ·  **ρ(Σ, flat ROI) = -0.047** ✗  (N=209)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 209.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.046 ✗ | -0.049 ✗ | -0.049 | weak |
| HC margin | -0.026 ✗ | -0.022 ✗ | 0.054 | weak |
| Δw + HC | -0.046 ✗ | -0.047 ✗ | -0.009 | weak |
| peak.stars | -0.111 ✗ | -0.151 ✓ p<.05 | -0.168 | weak |
| vault.star | -0.034 ✗ | -0.048 ✗ | -0.093 | weak |
| lock.stars | -0.090 ✗ | -0.124 ~ p<.10 | -0.126 | weak |
...
Universe N = 209 (post-cutover, both axes present).

| HC \ Δw | ≤ −3 | -2 | -1 | +0 | +1 | +2 | ≥ +3 |
|---|---|---|---|---|---|---|---|
| ≤ −3 | — | — | — | — | — | — | — |
| -2 | — | — | — | — | — | — | — |
| -1 | — | — | — | — | N=2 · 0-2 · 0% [0–66] · —  | N=1 · 1-0 · 100% [21–100] · —  | N=2 · 0-2 · 0% [0–66] · —  |
| +0 | — | — | N=1 · 1-0 · 100% [21–100] · —  | N=14 · 7-6 · 54% [29–77] · -1%  | N=37 · 21-15 · 58% [42–73] · +7%  | N=21 · 11-10 · 52% [32–72] · -5%  | N=13 · 3-10 · 23% [8–50] · -59% ✗ |
| +1 | — | — | N=3 · 0-3 · 0% [0–56] · -100%  | N=13 · 6-7 · 46% [23–71] · -7%  | N=37 · 25-12 · 68% [51–80] · +28%  | N=22 · 10-12 · 45% [27–65] · -4%  | N=19 · 12-7 · 63% [41–81] · +26%  |
| +2 | — | — | — | — | N=1 · 0-1 · 0% [0–79] · —  | N=6 · 1-5 · 17% [3–56] · -59%  | N=10 · 5-5 · 50% [24–76] · -0%  |
| ≥ +3 | — | — | — | N=1 · 1-0 · 100% [21–100] · —  | — | N=2 · 0-2 · 0% [0–66] · —  | N=4 · 1-3 · 25% [5–70] · -64%  |
...
|---|---|---|---|---|---|---|
| Δw ≤ −2 | 0 | — | — | — | — | — |
| Δw = −1 | 4 | 1-3-0 | 25.0% [5–70] | -63.0% | -1.4u | -1.71 ~ p<.10 |
| Δw = 0 | 28 | 14-13-1 | 51.9% [34–69] | -2.5% | -3.3u | -0.14 ✗ noise |
| Δw = +1 | 77 | 46-30-1 | 60.5% [49–71] | +12.9% | +9.5u | 1.22 ✗ noise |
| Δw = +2 | 52 | 23-29-0 | 44.2% [32–58] | -12.7% | -30.9u | -0.90 ✗ noise |
| Δw ≥ +3 | 48 | 21-27-0 | 43.8% [31–58] | -15.1% | -31.2u | -1.05 ✗ noise |

### §3d. Practical lock zones (v7.4 floor anatomy)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 118 | 61-57-0 | 51.7% [43–61] | +1.7% | -32.6u | 0.18 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 37 | 15-22-0 | 40.5% [26–57] | -26.9% | -22.5u | -1.80 ~ p<.10 |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 54 | 29-23-2 | 55.8% [42–68] | +1.6% | -2.1u | 0.13 ✗ noise |
...
Universe N = 298 picks where ≥1 proven wallet appeared on either side.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δcount ≤ −2 (heavy oppose) | 6 | 1-5-0 | 16.7% [3–56] | -59.2% | -7.8u | -1.45 ✗ noise |
| Δcount = −1 | 12 | 5-7-0 | 41.7% [19–68] | -18.7% | -4.9u | -0.64 ✗ noise |
| Δcount = 0 (balanced) | 28 | 9-18-1 | 33.3% [19–52] | -36.2% | -16.8u | -2.11 ✓ p<.05 |
| Δcount = +1 | 119 | 59-58-2 | 50.4% [41–59] | -6.5% | -21.4u | -0.76 ✗ noise |
| Δcount = +2 | 80 | 38-42-0 | 47.5% [37–58] | -6.8% | -17.8u | -0.60 ✗ noise |
| Δcount ≥ +3 (heavy support) | 53 | 36-17-0 | 67.9% [55–79] | +40.8% | +12.4u | 2.54 ✓ p<.05 |

**ρ(Δcount, WIN) = 0.186** ✓ p<.01  ·  **ρ(Δcount, flat ROI) = 0.203** ✓ p<.01
...
Quintile cuts: ≤ -7 · ≤ -1 · ≤ 3 · ≤ 10 · > 10

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 86 | 27-58-1 | 31.8% [23–42] | -37.3% | -65.9u | -3.71 ✓ p<.01 |
| Q2 | 44 | 21-22-1 | 48.8% [35–63] | -4.7% | -14.2u | -0.32 ✗ noise |
| Q3 (balanced) | 52 | 32-20-0 | 61.5% [48–74] | +19.0% | +12.3u | 1.41 ✗ noise |
| Q4 | 61 | 33-28-0 | 54.1% [42–66] | -1.4% | -14.0u | -0.11 ✗ noise |
| Q5 (best — heavy support) | 55 | 35-19-1 | 64.8% [51–76] | +31.9% | +25.5u | 2.04 ✓ p<.05 |

**ρ(ΔWlNet, WIN) = 0.239** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.233** ✓ p<.01
...
Quintile cuts (units): ≤ -6.19 · ≤ -1.56 · ≤ 2.09 · ≤ 8.00 · > 8.00

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 60 | 16-43-1 | 27.1% [17–40] | -49.2% | -64.5u | -4.54 ✓ p<.01 |
| Q2 | 60 | 28-32-0 | 46.7% [35–59] | -9.2% | -18.5u | -0.71 ✗ noise |
| Q3 | 61 | 31-29-1 | 51.7% [39–64] | -5.7% | -5.2u | -0.48 ✗ noise |
| Q4 | 58 | 36-22-0 | 62.1% [49–73] | +21.2% | +3.4u | 1.64 ✗ noise |
| Q5 | 59 | 37-21-1 | 63.8% [51–75] | +31.7% | +28.4u | 2.09 ✓ p<.05 |
...
Quintile cuts (% ROI): ≤ -13.3 · ≤ -2.6 · ≤ 6.0 · ≤ 20.3 · > 20.3

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 60 | 10-48-2 | 17.2% [10–29] | -60.7% | -72.8u | -5.48 ✓ p<.01 |
| Q2 | 61 | 30-31-0 | 49.2% [37–61] | -8.5% | -21.6u | -0.70 ✗ noise |
| Q3 | 58 | 28-30-0 | 48.3% [36–61] | -9.1% | -11.9u | -0.71 ✗ noise |
| Q4 | 60 | 36-23-1 | 61.0% [48–72] | +17.0% | +8.8u | 1.35 ✗ noise |
| Q5 | 59 | 44-15-0 | 74.6% [62–84] | +49.3% | +41.1u | 3.64 ✓ p<.01 |

**ρ(ΔAvgRoi, WIN) = 0.354** ✓ p<.01  ·  **ρ(ΔAvgRoi, flat ROI) = 0.363** ✓ p<.01
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 29 | 3-25-1 | 10.7% [4–27] | -75.3% | -36.3u | -6.07 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 14 | 5-9-0 | 35.7% [16–61] | -25.6% | -9.4u | -0.92 ✗ noise |
| ΔBestRank = 0 (tied) | 1 | 1-0-0 | 100.0% [21–100] | +90.9% | +0.3u | 0.00 ✗ n<2 |
| ΔBestRank ∈ [+1,+4] | 14 | 6-8-0 | 42.9% [21–67] | -11.7% | -9.0u | -0.36 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 46 | 31-14-1 | 68.9% [54–80] | +43.9% | +27.9u | 2.54 ✓ p<.05 |

**ρ(ΔBestRank, WIN) = 0.495** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.542** ✓ p<.01  (N=104)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 18 | 2-16-0 | 11.1% [3–33] | -70.6% | -20.5u | -3.10 ✓ p<.01 |
| Δshare ∈ [−30,−10] pp | 2 | 0-2-0 | 0.0% [0–66] | -100.0% | -3.5u | 0.00 ✗ noise |
| Δshare ≈ 0 (±10 pp) | 218 | 103-113-2 | 47.7% [41–54] | -9.1% | -80.8u | -1.39 ✗ noise |
| Δshare ∈ [+10,+30] pp | 17 | 12-5-0 | 70.6% [47–87] | +39.9% | +8.2u | 1.68 ~ p<.10 |
| Δshare ≥ +30 pp | 43 | 31-11-1 | 73.8% [59–85] | +47.0% | +40.2u | 2.80 ✓ p<.01 |

**ρ(ΔTopQShare, WIN) = 0.250** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.232** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔAvgRoi** | 0.354 ✓ p<.01 | 0.363 ✓ p<.01 | 0.341 |
| 2 | **ΔTopQCount** | 0.304 ✓ p<.01 | 0.340 ✓ p<.01 | 0.290 |
| 3 | **ΔFlatPnl** | 0.281 ✓ p<.01 | 0.322 ✓ p<.01 | 0.286 |
| 4 | **ΔWlNet** | 0.239 ✓ p<.01 | 0.233 ✓ p<.01 | 0.207 |
| 5 | **ΔTopQShare** | 0.250 ✓ p<.01 | 0.232 ✓ p<.01 | 0.262 |
| 6 | **Δcount** | 0.186 ✓ p<.01 | 0.203 ✓ p<.01 | 0.175 |

_(ΔBestRank uses N=104 subset where both sides had a proven wallet — ρ(flat ROI) = 0.542 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 592, dateRange = 2026-04-18 → 2026-05-25, computedAt = 2026-05-26T16:34:47.866Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **298** rows · PIT aggregate computable on **294** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **294** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 189 · 56% · +7.5% | 188 · 49% · -7.5% | -15.0pp |
| WEAK (−3..0) | 94 · 39% · -25.4% | 95 · 51% · +4.6% | +29.9pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=150, WR=57%, ROI=+10.0% | N=153, WR=48%, ROI=-9.6% | -19.6pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=189, WR=56%, ROI=+7.5% | N=188, WR=49%, ROI=-7.5% | -15.0pp |
| AGS < −1 (mute veto) | N=35, WR=26%, ROI=-48.6% | N=51, WR=45%, ROI=-2.9% | +45.7pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-05-12 → 2026-05-25, N=152)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 100 · 50% · -7.6% |
| WEAK (−3..0) | 52 · 49% · -5.2% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=82, WR=46%, ROI=-14.0% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=100, WR=50%, ROI=-7.6% |
| AGS < −1 (mute veto) | N=36, WR=47%, ROI=-8.6% |
...
|---|---|---|---|---|
| `dCount` | COUNT | + | 1.15 | 1.48 |
| `dHcSizeRatio` | INTENSITY_HC | + | 1.36 | 5.54 |
| `dSumRankNorm` | QUALITY_RANK | − | 62.36 | 90.41 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.55 | 1.19 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **294/321** shipped+graded rows (92%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 58 | 32-26-0 | 55.2% [42–67] | +0.8% | -5.6u | 0.06 ✗ noise |
| LOCK | 67 | 28-39-0 | 41.8% [31–54] | -21.4% | -34.2u | -1.84 ~ p<.10 |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 32 | 17-14-1 | 54.8% [38–71] | +7.6% | +3.4u | 0.43 ✗ noise |
| FADE | 55 | 23-30-2 | 43.4% [31–57] | -6.4% | -19.6u | -0.40 ✗ noise |
...
r(WIN) = **0.020** ✗ · r(ROI) = **-0.028** ✗ · Spearman ρ(ROI) = **-0.039**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 35 | 18-16-1 | 52.9% [37–69] | +16.5% | -10.4u | 0.76 ✗ noise |
| z ∈ [−1, 0) | 112 | 58-52-2 | 52.7% [43–62] | -0.7% | -0.2u | -0.08 ✗ noise |
| z ∈ [0, +1) | 94 | 38-56-0 | 40.4% [31–51] | -22.6% | -54.1u | -2.28 ✓ p<.05 |
| z ≥ +1 (very positive) | 53 | 28-25-0 | 52.8% [40–66] | -1.1% | -3.6u | -0.09 ✗ noise |
...
| z ∈ [0, +1) | 260 | 127-130-3 | 49.4% [43–55] | -6.1% | -65.3u | -1.01 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.028** ✗ · r(ROI) = **-0.040** ✗ · Spearman ρ(ROI) = **-0.043**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 46 | 25-20-1 | 55.6% [41–69] | -3.2% | -9.8u | -0.24 ✗ noise |
| z ∈ [−1, 0) | 77 | 40-36-1 | 52.6% [42–63] | +8.9% | -15.8u | 0.68 ✗ noise |
| z ∈ [0, +1) | 132 | 58-73-1 | 44.3% [36–53] | -14.0% | -41.5u | -1.64 ✗ noise |
| z ≥ +1 (very positive) | 39 | 19-20-0 | 48.7% [34–64] | -9.8% | -1.2u | -0.64 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.028 ✗ | -0.040 ✗ | -0.043 |
| 2 | `dCount` | COUNT | 0.020 ✗ | -0.028 ✗ | -0.039 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | +0.142 | 0.769 | 48.8% | meaningful |
| 2 | `dSumRankNorm` | +0.058 | 0.724 | 46.0% | meaningful |
| 3 | `dWinnerCtPreA` | -0.053 | 0.053 | 3.4% | silent (<0.2) |
| 4 | `dHcSizeRatio` | -0.028 | 0.028 | 1.8% | silent (<0.2) |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.152 | +0.688 | +0.152 |
| `dHcSizeRatio` | +0.152 | 1.000 | +0.115 | +1.000 ⚠ |
| `dSumRankNorm` | +0.688 | +0.115 | 1.000 | +0.115 |
| `dWinnerCtPreA` | +0.152 | +1.000 ⚠ | +0.115 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **-0.025**. At AGS ≥ +0.12 fires N=160, WR=47.5%, ROI=-11.1%. At AGS ≥ +null fires N=196, WR=48.5%, ROI=-9.3%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-160 ROI (matched cohort) | Top-160 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.045 | +0.020 | WR=53%, ROI=+3.4% | -14.5pp | N=113, WR=54%, ROI=+4.8% |
| `dHcSizeRatio` | +0.000 | −0.024 | WR=52%, ROI=-2.4% | -8.8pp | N=154, WR=52%, ROI=-3.5% |
| `dSumRankNorm` | -0.041 | +0.016 | WR=44%, ROI=-16.7% | +5.6pp | N=143, WR=46%, ROI=-12.5% |
| `dWinnerCtPreA` | +0.003 | −0.022 | WR=50%, ROI=-6.1% | -5.1pp | N=143, WR=51%, ROI=-5.6% |
...
|---|---|---|---|---|
| 1 | `dHcSizeRatio` | −0.024 | -8.8pp | carries marginal info |
| 2 | `dWinnerCtPreA` | −0.022 | -5.1pp | carries marginal info |
| 3 | `dSumRankNorm` | +0.016 | +5.6pp | redundant — other features cover it |
| 4 | `dCount` | +0.020 | -14.5pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.115 | 0.115 | negative ↓ |
| 2 | `dCount` | COUNT | +0.072 | 0.072 | positive ↑ |
| 3 | `dWinnerCtPreA` | QUALITY_TRACK | +0.040 | 0.040 | flat ≈ 0 |
| 4 | `dHcSizeRatio` | INTENSITY_HC | +0.021 | 0.021 | flat ≈ 0 |

Intercept b = -0.069 · Final log-loss = 0.6908 · N = 294.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 100 | 45-55-0 | 45.0% [36–55] | -19.4% | -61.3u | -2.12 ✓ p<.05 |
| 4.5★ | 28 | 17-11-0 | 60.7% [42–76] | +18.4% | +9.6u | 0.92 ✗ noise |
| 4.0★ | 56 | 25-30-1 | 45.5% [33–58] | -12.3% | -10.0u | -0.94 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 46 | 23-22-1 | 51.1% [37–65] | +3.0% | -1.3u | 0.20 ✗ noise |
| 2.5★ | 53 | 27-25-1 | 51.9% [39–65] | +1.0% | -8.8u | 0.07 ✗ noise |

### §5b. Stars × Δw stratified — does the star tier hold up within each Δw cohort?

| Δw cohort | 5★ | 4.5★ | 4★ | 3.5★ | 3★ | 2.5★ |
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 8/38%/-43% | 3/67%/+12% | 7/14%/-79% | 6/33%/-26% | 15/36%/-31% | 22/43%/-15% |
| Δw = +1 | 11/55%/-7% | 7/57%/+1% | 24/57%/+8% | 28/54%/+4% | 17/59%/+11% | 22/55%/+0% |
| Δw = +2 | 33/39%/-25% | 9/56%/+7% | 20/45%/-11% | — | 9/44%/-3% | 6/50%/+12% |
| Δw ≥ +3 | 46/46%/-18% | 6/67%/+58% | 5/40%/-24% | 3/67%/+156% | 5/80%/+86% | 1/100%/+145% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| −400+ | 7 | 6-1-0 | 85.7% [49–97] | +8.9% | +5.3u | 0.49 ✗ noise |
| −300/−201 | 13 | 9-4-0 | 69.2% [42–87] | -0.8% | +7.6u | -0.04 ✗ noise |
| −200/−151 | 30 | 14-16-0 | 46.7% [30–64] | -25.6% | -15.4u | -1.73 ~ p<.10 |
| −150/−101 | 187 | 92-94-1 | 49.5% [42–57] | -6.1% | -30.7u | -0.88 ✗ noise |
| −100/+100 | 3 | 0-3-0 | 0.0% [0–56] | -100.0% | -4.5u | 0.00 ✗ noise |
| +101/+150 | 67 | 29-36-2 | 44.6% [33–57] | -1.5% | -34.6u | -0.11 ✗ noise |
...
|---|---|---|---|---|
| −400+ | -100% (1) | +27% (1) | +32% (1) | +25% (3) |
| −300/−201 | -19% (7) | +47% (1) | +47% (1) | +7% (4) |
| −200/−151 | -100% (7) | +32% (12) | +22% (4) | -100% (6) |
| −150/−101 | -22% (35) | +11% (68) | -30% (46) | +4% (35) |
| −100/+100 | -100% (1) | -100% (1) | -100% (1) | — |
| +101/+150 | +16% (10) | -27% (25) | +11% (20) | +16% (12) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 169 | 78-91-0 | 46.2% [39–54] | -8.5% | -66.6u | -1.02 ✗ noise |
| SPREAD | 57 | 27-29-1 | 48.2% [36–61] | -12.8% | +1.1u | -1.06 ✗ noise |
| TOTAL | 95 | 51-42-2 | 54.8% [45–65] | +6.0% | -2.4u | 0.61 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=31 · 29% · -47% | N=53 · 55% · +3% | N=40 · 45% · -7% | N=42 · 48% · +4% |
| SPREAD | N=14 · 31% · -42% | N=21 · 52% · -9% | N=11 · 64% · +16% | N=10 · 40% · -22% |
| TOTAL | N=17 · 63% · +20% | N=36 · 60% · +15% | N=26 · 35% · -33% | N=14 · 71% · +38% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 170 | 83-86-1 | 49.1% [42–57] | -6.8% | -36.3u | -0.93 ✗ noise |
| NBA | 114 | 54-59-1 | 47.8% [39–57] | -4.2% | -17.6u | -0.41 ✗ noise |
| NHL | 37 | 19-17-1 | 52.8% [37–68] | +1.3% | -13.9u | 0.08 ✗ noise |

### §8b. Sport × Δw cohort

| Sport | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| MLB | N=28 · 44% · -15% | N=69 · 55% · +2% | N=49 · 45% · -13% | N=23 · 43% · -14% |
| NBA | N=28 · 30% · -46% | N=27 · 52% · +1% | N=20 · 45% · -8% | N=34 · 59% · +27% |
| NHL | N=6 · 50% · -2% | N=14 · 69% · +25% | N=8 · 38% · -21% | N=9 · 44% · -14% |
...
|---|---|---|
| **sharps3Plus** | 163 · 43% · -11.7% · -1.38 ✗ noise | 157 · 54% · +1.1% · 0.14 ✗ noise |
| **plusEV** | 40 · 43% · -14.3% · -0.74 ✗ noise | 280 · 50% · -4.2% · -0.71 ✗ noise |
| **pinnacleConfirms** | 79 · 47% · -5.0% · -0.39 ✗ noise | 145 · 49% · -7.2% · -0.87 ✗ noise |
| **invested10kPlus** | 160 · 46% · -8.3% · -0.98 ✗ noise | 64 · 53% · -1.6% · -0.14 ✗ noise |
| **lineMovingWith** | 169 · 50% · -1.7% · -0.21 ✗ noise | 151 · 47% · -9.6% · -1.20 ✗ noise |
| **predMarketAligns** | 75 · 47% · -7.0% · -0.54 ✗ noise | 149 · 49% · -6.1% · -0.75 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 65 | 37-28-0 | 56.9% [45–68] | +7.6% | -0.5u | 0.64 ✗ noise |
| 1 | 73 | 37-34-2 | 52.1% [41–63] | -3.2% | -9.7u | -0.30 ✗ noise |
| 2 | 84 | 38-45-1 | 45.8% [35–56] | -9.6% | -19.6u | -0.86 ✗ noise |
| 3 | 30 | 13-17-0 | 43.3% [27–61] | -13.6% | -12.4u | -0.71 ✗ noise |
| 4 | 29 | 11-18-0 | 37.9% [23–56] | -26.5% | -16.5u | -1.44 ✗ noise |
| 5 | 31 | 16-15-0 | 51.6% [35–68] | -6.1% | -9.6u | -0.35 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLEAR_MOVE | 81 | 46-34-1 | 57.5% [47–68] | +8.7% | +8.9u | 0.82 ✗ noise |
| NEAR_START | 123 | 54-67-2 | 44.6% [36–54] | -9.4% | -50.3u | -0.96 ✗ noise |
| NO_MOVE | 9 | 4-5-0 | 44.4% [19–73] | -21.0% | -0.2u | -0.66 ✗ noise |
| PREGAME | 46 | 26-20-0 | 56.5% [42–70] | +5.4% | -0.6u | 0.39 ✗ noise |
| SMALL_MOVE | 60 | 24-36-0 | 40.0% [29–53] | -23.8% | -28.0u | -1.89 ~ p<.10 |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 187 | 94-92-1 | 50.5% [43–58] | -6.3% | -38.4u | -0.92 ✗ noise |
| STRONG | 55 | 28-27-0 | 50.9% [38–64] | +2.6% | -9.6u | 0.18 ✗ noise |
| LEAN | 75 | 32-41-2 | 43.8% [33–55] | -7.9% | -21.2u | -0.58 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.080 ✗ | -0.042 ✗ | -0.059 | -0.75 |
| totalInvested | -0.045 ✗ | -0.059 ✗ | -0.059 | -1.05 |
| evEdge | 0.099 ~ p<.10 | 0.067 ✗ | 0.074 | 1.19 |
| moneyPct | 0.060 ✗ | 0.002 ✗ | -0.002 | 0.04 |
| walletPct | 0.095 ~ p<.10 | 0.061 ✗ | 0.057 | 1.09 |
| criteriaMet | -0.070 ✗ | -0.035 ✗ | -0.074 | -0.63 |
| maxContribFor | -0.034 ✗ | -0.013 ✗ | 0.016 | -0.24 |
| meanBaseFor | 0.001 ✗ | 0.023 ✗ | 0.062 | 0.41 |
...
Sample with CLV: **313** picks. Mean CLV = **-0.0019**.
t-statistic vs zero: -1.20 → ✗ noise · 95% CI [-0.0050, 0.0012]

Bucketed CLV vs flat PnL:

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLV ≤ −2% | 32 | 15-17-0 | 46.9% [31–64] | -19.3% | -5.5u | -1.23 ✗ noise |
| CLV (−2%, 0] | 167 | 76-89-2 | 46.1% [39–54] | -10.7% | -58.5u | -1.38 ✗ noise |
| CLV (0, +2%] | 94 | 50-44-0 | 53.2% [43–63] | +9.3% | -11.3u | 0.81 ✗ noise |
| CLV > +2% | 20 | 10-9-1 | 52.6% [32–73] | -9.4% | +1.3u | -0.47 ✗ noise |

ρ(CLV, flat ROI) = 0.043 ✗
...
Trained on N=210 (with all features non-null). Intercept β₀ = 0.016.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | pw.ΔAvgRoi | +0.437 | ↑ helps |
| 2 | pw.ΔFlatPnl | +0.358 | ↑ helps |
| 3 | sharpCount | -0.283 | ↓ hurts |
| 4 | evEdge | +0.251 | ↑ helps |
| 5 | pw.Δcount | +0.242 | ↑ helps |
| 6 | peak.stars | -0.227 | ↓ hurts |
| 7 | odds (American) | -0.186 | ↓ hurts |
| 8 | pw.ΔWlNet | +0.166 | ↑ helps |
| 9 | walletPct | +0.116 | ↑ helps |
| 10 | log(impliedProb) | +0.104 | ↑ helps |
| 11 | vault.star | +0.077 | ↑ helps |
| 12 | Δw | -0.075 | ↓ hurts |
| 13 | log10(invested) | -0.066 | ↓ hurts |
| 14 | criteriaMet | -0.050 | ↓ hurts |
| 15 | Δw + HC | -0.049 | ≈ flat |
| 16 | moneyPct | -0.023 | ≈ flat |
| 17 | pw.ΔTopQShare | -0.022 | ≈ flat |
| 18 | HC margin | +0.019 | ≈ flat |
...
|---|---|---|---|---|---|---|---|---|
| Tier-1a HC ≥ +2 (post-cutover) | 24 | 8-16 | 33.3% | 38.2% | -110 | — (mute) | 3.42u | **MUTE** (negative EV at posterior) |
| Tier-1b HC = +1 (post-cutover) | 94 | 53-41 | 56.4% | 55.8% | -109 | 3.78% bankroll | 1.82u | **UNDER-SIZED** — ship up to 3.78u (1u=1% bankroll) |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 37 | 15-22 | 40.5% | 42.6% | -110 | — (mute) | 2.14u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 66 | 34-32 | 51.5% | 51.3% | -106 | — (mute) | 2.76u | **MUTE** (negative EV at posterior) |
| Stale Δw = 0 | 51 | 21-28 | 42.9% | 44.1% | -110 | — (mute) | 1.34u | **MUTE** (negative EV at posterior) |
| Stale Δw ≤ −1 | 11 | 2-9 | 18.2% | 33.3% | -165 | — (mute) | 1.33u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.331  (annualized × √252 ≈ -5.25)
...
| 2026-04-19 | MLB | ML | home | 4.0 | 2.00 | -106 | 3 | — | — | 1 | 0 | 0.00 | W | +1.8u |
| 2026-04-19 | MLB | ML | home | 3.0 | 1.00 | -125 | 3 | — | — | 1 | 2 | -0.60 | W | +0.8u |
| 2026-04-19 | MLB | ML | away | 2.5 | 1.00 | +100 | 0 | — | — | 0 | 5 | 1.00 | L | -1.0u |
| 2026-04-19 | NBA | ML | away | 4.5 | 1.00 | +295 | 4 | — | — | 4 | 15 | -0.50 | W | +3.1u |
...
| 2026-04-20 | NBA | ML | home | 3.0 | 1.00 | -235 | -1 | — | — | -2 | -11 | -1.00 | L | -1.0u |
...
| 2026-04-21 | NBA | SPREAD | away | 4.5 | 2.00 | -110 | 2 | — | — | 3 | -2 | -0.20 | W | +1.8u |
...
| 2026-04-22 | MLB | ML | home | 2.5 | 0.50 | -152 | 0 | — | — | -1 | 10 | -0.60 | L | -0.5u |
...
| 2026-04-23 | MLB | ML | home | 3.0 | 1.00 | -155 | 0 | — | — | 1 | 7 | 0.30 | L | -1.0u |
| 2026-04-23 | MLB | TOTAL | under | 3.0 | 1.75 | -110 | 2 | — | — | 1 | 0 | 0.00 | L | -1.8u |
| 2026-04-23 | NBA | ML | home | 3.5 | 1.60 | +130 | 1 | — | — | 4 | 12 | -1.20 | W | +2.0u |
...
| 2026-04-24 | MLB | ML | home | 3.5 | 0.75 | -108 | 1 | — | — | 2 | -6 | -1.40 | W | +0.7u |
| 2026-04-24 | NBA | ML | away | 5.0 | 3.00 | -295 | 0 | — | — | 4 | 24 | 0.00 | W | +1.0u |
| 2026-04-24 | NBA | SPREAD | home | 3.0 | 1.50 | -108 | 0 | — | — | 1 | 26 | -1.70 | P | +0.0u |
| 2026-04-24 | NBA | TOTAL | over | 3.5 | 0.50 | -111 | 1 | — | — | 1 | 3 | 0.00 | W | +0.5u |
| 2026-04-24 | NBA | ML | home | 5.0 | 2.00 | +120 | 2 | — | — | 2 | 24 | 0.70 | L | -2.0u |
| 2026-04-24 | NHL | ML | home | 5.0 | 3.00 | +102 | 2 | — | — | 1 | 1 | -1.70 | W | +2.9u |
| 2026-04-25 | MLB | ML | away | 3.5 | 0.75 | +124 | 1 | — | — | 2 | -16 | -1.50 | L | -0.8u |
| 2026-04-25 | MLB | ML | home | 4.0 | 1.25 | +128 | 1 | — | — | 2 | -16 | -0.40 | L | -1.3u |
| 2026-04-25 | NBA | ML | away | 5.0 | 3.00 | -118 | 3 | — | — | 0 | -35 | -1.90 | L | -3.0u |
| 2026-04-25 | NBA | ML | home | 5.0 | 2.00 | +125 | 4 | — | — | 2 | 0 | -1.20 | W | +2.4u |
...
| 2026-04-26 | MLB | TOTAL | over | 3.5 | 0.50 | -116 | 1 | — | — | -1 | 7 | 0.00 | L | -0.5u |
| 2026-04-26 | MLB | ML | home | 3.5 | 0.75 | -110 | 1 | — | — | 1 | 7 | -1.40 | L | -0.8u |
| 2026-04-26 | MLB | ML | away | 5.0 | 2.00 | +100 | 2 | — | — | 0 | 0 | 0.00 | L | -2.0u |
| 2026-04-26 | MLB | TOTAL | over | 4.0 | 0.75 | -102 | 1 | — | — | 2 | -5 | 0.00 | W | +0.7u |
| 2026-04-26 | NBA | ML | away | 5.0 | 3.00 | -290 | 3 | — | — | 2 | 22 | 1.40 | W | +1.0u |
| 2026-04-26 | NBA | TOTAL | over | 4.0 | 0.75 | -101 | 1 | — | — | 4 | 34 | 0.00 | W | +0.7u |
| 2026-04-26 | NBA | ML | away | 5.0 | 3.00 | -158 | 2 | — | — | 2 | 14 | -0.70 | L | -3.0u |
| 2026-04-26 | NBA | TOTAL | under | 5.0 | 2.00 | -110 | 3 | — | — | 1 | -2 | 0.00 | W | +1.8u |
| 2026-04-26 | NBA | SPREAD | home | 4.0 | 0.75 | -110 | 1 | — | — | 3 | 11 | 0.20 | W | +0.7u |
| 2026-04-27 | MLB | ML | home | 5.0 | 2.00 | +140 | 2 | — | — | -1 | -7 | -0.50 | L | -2.0u |
| 2026-04-27 | MLB | ML | away | 3.5 | 0.75 | +104 | 1 | — | — | 1 | -7 | -0.70 | W | +0.8u |
| 2026-04-27 | NBA | SPREAD | away | 4.0 | 0.75 | -114 | 1 | — | — | 2 | -17 | -0.70 | L | -0.8u |
| 2026-04-27 | NBA | TOTAL | over | 5.0 | 2.00 | -104 | 3 | — | — | 4 | 25 | 0.00 | L | -2.0u |
| 2026-04-27 | NBA | ML | home | 5.0 | 3.00 | -500 | 3 | — | — | 4 | 21 | 0.40 | W | +0.6u |
...
| 2026-04-28 | NBA | SPREAD | away | 5.0 | 2.00 | -105 | 3 | — | — | 3 | 25 | 0.20 | L | -2.0u |
| 2026-04-29 | MLB | ML | home | 3.5 | 0.50 | -108 | 1 | — | — | 1 | 7 | 0.50 | L | -0.5u |
| 2026-04-29 | MLB | TOTAL | under | 3.5 | 0.50 | -117 | 1 | — | — | 2 | 2 | 0.00 | L | -0.5u |
| 2026-04-29 | NBA | SPREAD | home | 3.5 | 0.50 | -105 | 1 | — | — | 1 | 22 | -0.70 | L | -0.5u |
| 2026-04-29 | NBA | TOTAL | under | 3.5 | 0.50 | -104 | 1 | — | — | 0 | -8 | 0.00 | L | -0.5u |
| 2026-04-29 | NBA | ML | home | 5.0 | 3.00 | -355 | 4 | — | — | 0 | -6 | 0.20 | W | +0.8u |
...
| 2026-04-30 | NBA | SPREAD | away | 2.5 | 0.75 | -104 | 0 | 1 | 1 | 1 | -15 | 0.20 | L | -0.8u |
| 2026-04-30 | NBA | TOTAL | under | 4.0 | 1.13 | -106 | 1 | 1 | 2 | 3 | 15 | 0.00 | W | +1.0u |
...
| 2026-05-01 | NBA | SPREAD | away | 2.5 | 0.50 | -115 | 1 | 0 | 1 | 1 | 11 | -1.80 | L | -0.5u |
| 2026-05-01 | NBA | ML | home | 5.0 | 3.00 | -180 | 3 | -1 | 2 | 3 | -31 | 0.10 | L | -3.0u |
...
| 2026-05-02 | NBA | TOTAL | over | 4.0 | 1.13 | -109 | 1 | 1 | 2 | 3 | 27 | 0.00 | W | +1.1u |
| 2026-05-03 | MLB | ML | away | 2.8 | 0.75 | -130 | 1 | 1 | 2 | -1 | -7 | -1.00 | W | +0.6u |
| 2026-05-03 | NBA | ML | away | 4.0 | 0.75 | +310 | 0 | 1 | 1 | 2 | 8 | 0.70 | L | -0.8u |
...
| 2026-05-04 | NBA | SPREAD | away | 5.0 | 3.50 | -105 | 5 | 1 | 6 | 5 | 38 | -1.00 | W | +3.3u |
...
| 2026-05-08 | NBA | TOTAL | under | 4.5 | 3.50 | -103 | 3 | 2 | 5 | 2 | 26 | 0.00 | W | +3.4u |
| 2026-05-08 | NBA | SPREAD | away | 5.0 | 3.50 | -105 | 4 | 2 | 6 | 3 | 29 | 0.00 | W | +3.3u |
| 2026-05-08 | NBA | TOTAL | over | 4.0 | 0.75 | +101 | 2 | 0 | 2 | 2 | 19 | 0.00 | W | +0.8u |
| 2026-05-08 | NHL | ML | home | 3.5 | 1.13 | -134 | 1 | 1 | 2 | 1 | 1 | -1.30 | L | -1.1u |
| 2026-05-09 | NBA | SPREAD | home | 4.5 | 1.70 | -104 | — | — | — | 2 | 14 | 0.00 | W | +1.6u |
| 2026-05-09 | NBA | TOTAL | over | 3.5 | 0.75 | -106 | 1 | 1 | 2 | 1 | 5 | 0.00 | W | +0.7u |
| 2026-05-09 | NBA | ML | away | 5.0 | 4.50 | -364 | 3 | 1 | 4 | 6 | 35 | 0.00 | W | +1.2u |
| 2026-05-09 | NBA | SPREAD | away | 4.5 | 2.00 | -104 | 2 | 1 | 3 | 2 | 19 | 0.00 | W | +1.9u |
| 2026-05-10 | MLB | ML | home | 3.5 | 1.13 | -120 | 1 | 1 | 2 | 0 | 2 | 0.00 | W | +0.9u |
| 2026-05-10 | MLB | TOTAL | over | 4.0 | 0.64 | -110 | 2 | 0 | 2 | 1 | -7 | 0.00 | L | -0.6u |
| 2026-05-10 | MLB | TOTAL | over | 4.0 | 0.64 | -110 | 2 | 0 | 2 | 1 | -7 | 0.00 | L | -0.6u |
| 2026-05-10 | MLB | ML | home | 3.5 | 1.13 | -103 | 1 | 1 | 2 | 1 | -7 | 0.00 | L | -1.1u |
| 2026-05-10 | MLB | ML | home | 3.5 | 1.13 | -110 | 1 | 1 | 2 | 1 | -7 | 0.00 | W | +1.0u |
| 2026-05-10 | MLB | ML | away | 3.5 | 1.13 | +134 | 0 | 1 | 1 | 1 | -7 | 0.00 | W | +1.5u |
| 2026-05-10 | NBA | ML | home | 4.0 | 1.50 | +160 | 1 | 1 | 2 | 2 | 20 | 0.80 | W | +2.6u |
| 2026-05-10 | NBA | TOTAL | over | 5.0 | 3.50 | -110 | 3 | 2 | 5 | 2 | 20 | 0.00 | W | +3.3u |
| 2026-05-10 | NHL | ML | away | 4.5 | 4.50 | +108 | 2 | 2 | 4 | 2 | 2 | -0.70 | L | -4.5u |
| 2026-05-10 | NHL | TOTAL | under | 5.0 | 1.70 | -110 | 2 | 1 | 3 | 2 | -1 | 0.00 | L | -1.7u |
| 2026-05-11 | MLB | ML | away | 3.5 | 1.13 | -101 | 1 | 1 | 2 | 2 | -8 | 0.00 | W | +1.1u |
| 2026-05-11 | MLB | ML | home | 3.5 | 1.13 | -156 | 1 | 1 | 2 | 0 | 2 | 0.00 | W | +0.7u |
| 2026-05-11 | NBA | TOTAL | under | 4.5 | 2.00 | -110 | 1 | 2 | 3 | 0 | 10 | 0.00 | L | -2.0u |
...
| 2026-05-12 | MLB | ML | away | 4.5 | 3.00 | +129 | 3 | 0 | 3 | 1 | 7 | -1.00 | L | -3.0u |
| 2026-05-12 | MLB | ML | home | 5.0 | 3.00 | +108 | 3 | 0 | 3 | 2 | 6 | -0.50 | L | -3.0u |
| 2026-05-12 | NBA | SPREAD | away | 5.0 | 3.50 | -105 | 6 | 4 | 10 | 6 | 41 | -0.70 | L | -3.5u |
| 2026-05-13 | MLB | ML | home | 4.5 | 4.50 | -116 | 1 | 1 | 2 | 1 | -7 | -1.30 | W | +3.7u |
| 2026-05-13 | MLB | SPREAD | home | 5.0 | 3.50 | -105 | 1 | 1 | 2 | 2 | -5 | 0.90 | W | +3.2u |
| 2026-05-13 | MLB | TOTAL | under | 4.0 | 0.96 | -110 | 1 | 1 | 2 | 2 | -13 | 0.00 | W | +0.9u |
| 2026-05-13 | MLB | TOTAL | under | 5.0 | 3.50 | -110 | 4 | 2 | 6 | 4 | -7 | 0.00 | L | -3.5u |
| 2026-05-13 | NBA | ML | home | 5.0 | 4.50 | -162 | 6 | 0 | 6 | 3 | -25 | -1.00 | L | -4.5u |
| 2026-05-13 | NBA | TOTAL | over | 5.0 | 3.50 | -101 | 3 | 2 | 5 | 4 | 8 | 0.00 | W | +3.4u |
...
| 2026-05-15 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 1 | 1 | 2 | 2 | -5 | 0.00 | W | +0.3u |
| 2026-05-15 | MLB | ML | home | 4.0 | 2.50 | +128 | 0 | 0 | 0 | 1 | -1 | 0.00 | L | -2.5u |
| 2026-05-15 | MLB | ML | away | 4.0 | 2.75 | -211 | 2 | 1 | 3 | 1 | 7 | -0.90 | W | +1.3u |
| 2026-05-15 | MLB | ML | away | 3.0 | 1.25 | +115 | 0 | 1 | 1 | -1 | -7 | -1.10 | L | -1.3u |
| 2026-05-15 | NBA | ML | away | 2.5 | 0.50 | +145 | 6 | 1 | 7 | 6 | 26 | -0.50 | W | +0.8u |
| 2026-05-15 | NBA | TOTAL | over | 4.0 | 0.75 | -109 | 0 | 1 | 1 | 2 | -10 | 0.00 | L | -0.8u |
| 2026-05-15 | NBA | SPREAD | home | 2.5 | 1.00 | -105 | 1 | 0 | 1 | 1 | 13 | 0.00 | L | -1.0u |
| 2026-05-15 | NBA | TOTAL | over | 5.0 | 2.00 | -110 | 1 | 0 | 1 | 3 | 8 | 0.00 | W | +1.9u |
| 2026-05-16 | MLB | ML | away | 5.0 | 4.50 | +124 | 3 | 1 | 4 | 4 | -2 | -1.30 | W | +1.4u |
| 2026-05-16 | MLB | SPREAD | away | 4.0 | 1.65 | -175 | 2 | 0 | 2 | 2 | 6 | 0.00 | W | +0.9u |
| 2026-05-16 | MLB | ML | home | 5.0 | 2.50 | +119 | 2 | 1 | 3 | 1 | -7 | -2.00 | L | -2.5u |
| 2026-05-16 | MLB | ML | home | 5.0 | 2.50 | +115 | 3 | 2 | 5 | 2 | 6 | -1.10 | W | +2.8u |
| 2026-05-16 | MLB | TOTAL | over | 4.0 | 1.65 | -110 | 2 | 0 | 2 | 1 | -7 | 0.00 | L | -1.6u |
| 2026-05-16 | MLB | ML | away | 2.5 | 0.50 | -102 | 1 | 0 | 1 | 1 | -20 | 0.00 | W | +0.5u |
| 2026-05-17 | MLB | ML | away | 4.0 | 2.75 | -148 | 1 | 0 | 1 | 2 | 0 | -0.70 | W | +1.9u |
| 2026-05-17 | MLB | ML | away | 2.5 | 0.50 | +139 | 0 | 1 | 1 | 0 | -14 | 0.70 | L | -0.5u |
| 2026-05-17 | MLB | ML | away | 5.0 | 5.00 | -129 | 3 | 1 | 4 | 1 | -7 | 0.40 | L | -5.0u |
| 2026-05-17 | MLB | ML | home | 4.0 | 2.75 | -114 | 3 | 1 | 4 | 4 | -1 | 2.20 | W | +2.4u |
| 2026-05-17 | MLB | TOTAL | over | 4.5 | 2.25 | -110 | 2 | 1 | 3 | 2 | -5 | 0.00 | W | +2.0u |
| 2026-05-17 | MLB | TOTAL | over | 5.0 | 2.50 | +107 | 2 | 2 | 4 | 1 | -7 | 0.00 | L | -2.5u |
| 2026-05-17 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 1 | 1 | -1 | 6 | 0.00 | W | +0.3u |
| 2026-05-17 | NBA | ML | away | 3.0 | 1.25 | +165 | 3 | 1 | 4 | 2 | 9 | -0.60 | W | +0.8u |
| 2026-05-17 | NBA | TOTAL | under | 5.0 | 0.75 | -110 | 2 | 3 | 5 | 1 | 19 | 0.00 | L | -0.8u |
| 2026-05-18 | MLB | ML | home | 4.5 | 5.00 | -111 | 2 | 1 | 3 | 2 | 0 | -1.10 | W | +4.4u |
| 2026-05-18 | MLB | ML | away | 4.0 | 2.50 | +120 | 2 | 0 | 2 | 1 | -7 | -2.10 | L | -2.5u |
| 2026-05-18 | MLB | ML | home | 3.0 | 1.25 | -118 | 2 | 0 | 2 | 1 | -7 | 1.00 | W | +1.1u |
| 2026-05-18 | MLB | ML | home | 4.0 | 2.75 | -150 | 2 | 0 | 2 | 1 | 7 | -0.80 | L | -2.8u |
| 2026-05-18 | MLB | ML | home | 3.0 | 1.25 | +132 | 2 | 0 | 2 | 2 | 1 | 0.40 | W | +1.6u |
| 2026-05-18 | NBA | ML | home | 5.0 | 5.00 | -240 | 3 | 2 | 5 | 4 | 14 | -1.60 | L | -5.0u |
...
| 2026-05-19 | MLB | ML | home | 5.0 | 2.50 | +118 | 1 | 1 | 2 | 1 | -9 | -1.30 | L | -2.5u |
| 2026-05-19 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 2 | 0 | 2 | 1 | 4 | 0.00 | W | +1.5u |
| 2026-05-19 | MLB | ML | home | 2.5 | 2.50 | +105 | 1 | 1 | 2 | 2 | -8 | -0.90 | L | -2.5u |
| 2026-05-19 | MLB | ML | away | 2.5 | 1.25 | -104 | 1 | 1 | 2 | 0 | -9 | -1.20 | W | +1.2u |
| 2026-05-19 | NBA | ML | home | 5.0 | 5.00 | -260 | 0 | 3 | 3 | 3 | 16 | -0.50 | W | +1.9u |
| 2026-05-19 | NBA | SPREAD | away | 5.0 | 2.25 | -105 | 3 | 2 | 5 | 2 | -1 | -0.90 | L | -2.3u |
| 2026-05-19 | NBA | TOTAL | under | 5.0 | 3.00 | -106 | 2 | 3 | 5 | 2 | 8 | 0.00 | L | -3.0u |
| 2026-05-20 | MLB | ML | away | 5.0 | 2.50 | +113 | 2 | 1 | 3 | 1 | -7 | -1.00 | L | -2.5u |
| 2026-05-20 | MLB | ML | home | 4.0 | 2.75 | -154 | 2 | 0 | 2 | 1 | 7 | -1.50 | W | +1.9u |
| 2026-05-20 | MLB | TOTAL | under | 4.0 | 0.75 | -110 | 2 | 0 | 2 | 1 | -7 | 0.00 | L | -0.8u |
| 2026-05-20 | MLB | ML | home | 2.5 | 0.50 | -140 | 1 | 1 | 2 | 1 | -7 | -1.10 | W | +0.9u |
| 2026-05-20 | MLB | ML | home | 2.5 | 0.50 | +111 | 0 | 1 | 1 | -1 | -7 | 0.00 | W | +0.6u |
| 2026-05-20 | MLB | ML | away | 4.0 | 2.75 | +113 | 1 | 1 | 2 | 0 | -14 | -1.00 | L | -2.8u |
| 2026-05-20 | NBA | ML | home | 5.0 | 5.00 | -225 | 10 | 5 | 15 | 2 | 8 | -0.20 | W | +2.1u |
| 2026-05-20 | NBA | SPREAD | home | 5.0 | 3.00 | -106 | 6 | 1 | 7 | 4 | 48 | -0.70 | W | +2.7u |
| 2026-05-20 | NBA | TOTAL | over | 5.0 | 1.65 | -112 | 3 | 1 | 4 | 3 | 47 | 0.00 | W | +1.5u |
| 2026-05-20 | NHL | ML | home | 2.5 | 1.25 | -192 | 0 | 1 | 1 | 1 | -2 | -0.80 | L | -1.3u |
| 2026-05-21 | MLB | ML | home | 5.0 | 2.50 | +125 | 1 | 1 | 2 | 2 | -8 | -0.40 | L | -2.5u |
| 2026-05-21 | MLB | SPREAD | home | 3.0 | 0.75 | -148 | 0 | 0 | 0 | 1 | -7 | -1.50 | L | -0.8u |
| 2026-05-21 | MLB | ML | away | 3.0 | 1.25 | +172 | 2 | 0 | 2 | 1 | -7 | -0.50 | L | -1.3u |
| 2026-05-21 | MLB | ML | away | 4.5 | 2.75 | -110 | 2 | 1 | 3 | 1 | -7 | -0.50 | W | +2.5u |
| 2026-05-21 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 0 | 0 | 2 | 0 | 0.00 | W | +0.3u |
| 2026-05-21 | MLB | ML | home | 3.0 | 1.25 | -116 | 3 | 1 | 4 | 2 | -5 | -0.40 | L | -1.3u |
| 2026-05-21 | MLB | ML | away | 3.0 | 1.25 | +129 | 1 | 0 | 1 | 3 | -6 | -0.40 | W | +1.6u |
| 2026-05-21 | MLB | SPREAD | away | 4.0 | 1.65 | -170 | 1 | 1 | 2 | 1 | 2 | 0.30 | W | +1.0u |
| 2026-05-21 | NBA | SPREAD | away | 5.0 | 3.00 | -110 | 4 | 2 | 6 | 3 | 12 | 0.70 | L | -3.0u |
| 2026-05-21 | NHL | ML | home | 4.0 | 2.75 | -197 | 4 | 1 | 5 | 1 | 6 | -1.30 | L | -2.8u |
| 2026-05-21 | NHL | TOTAL | over | 3.0 | 0.75 | +103 | 1 | 0 | 1 | 1 | 6 | 0.00 | W | +0.7u |
| 2026-05-22 | MLB | ML | home | 5.0 | 1.25 | -175 | 1 | 0 | 1 | 1 | 7 | -0.90 | L | -1.3u |
| 2026-05-22 | MLB | ML | home | 4.0 | 1.25 | -195 | 3 | 0 | 3 | 0 | 0 | 0.80 | L | -1.3u |
| 2026-05-22 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 0 | 0 | 0.00 | W | +0.7u |
| 2026-05-22 | MLB | ML | home | 3.0 | 1.25 | -137 | 1 | 0 | 1 | 1 | -6 | 0.00 | L | -1.3u |
| 2026-05-22 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 0 | 0 | 0.00 | L | -0.8u |
| 2026-05-22 | MLB | ML | home | 5.0 | 5.00 | -144 | 4 | 2 | 6 | 2 | 0 | -1.60 | L | -5.0u |
| 2026-05-22 | MLB | SPREAD | home | 5.0 | 0.75 | -155 | 2 | 0 | 2 | 1 | -7 | -0.30 | W | +0.4u |
| 2026-05-22 | MLB | ML | home | 5.0 | 2.75 | -158 | 1 | 0 | 1 | 1 | 7 | -0.80 | W | +1.7u |
| 2026-05-22 | MLB | SPREAD | home | 3.0 | 0.75 | -142 | 1 | 0 | 1 | 1 | -7 | -2.00 | L | -0.8u |
| 2026-05-22 | MLB | ML | home | 5.0 | 5.00 | -145 | 2 | 2 | 4 | 1 | 7 | -2.20 | L | -5.0u |
| 2026-05-22 | MLB | ML | home | 2.5 | 0.50 | +139 | 2 | 1 | 3 | 0 | -5 | -0.90 | W | +0.7u |
| 2026-05-22 | MLB | SPREAD | home | 4.0 | 1.65 | -119 | 1 | 1 | 2 | 1 | -7 | -1.20 | W | +1.3u |
| 2026-05-22 | MLB | ML | away | 5.0 | 1.50 | +185 | 3 | 0 | 3 | 2 | -8 | -1.10 | L | -1.5u |
| 2026-05-22 | MLB | SPREAD | away | 3.0 | 0.75 | -112 | 1 | 0 | 1 | 1 | -7 | -1.40 | W | +0.6u |
| 2026-05-22 | NBA | ML | home | 5.0 | 5.00 | -120 | 0 | 0 | 0 | -3 | -29 | 0.00 | L | -5.0u |
| 2026-05-22 | NBA | SPREAD | home | 2.5 | 1.00 | -110 | 1 | 0 | 1 | -2 | 7 | -0.50 | L | -1.0u |
| 2026-05-22 | NBA | TOTAL | over | 5.0 | 0.75 | +101 | 2 | 1 | 3 | 1 | 15 | 0.00 | W | +0.7u |
| 2026-05-22 | NHL | ML | home | 4.5 | 3.75 | -167 | 4 | 3 | 7 | 3 | 5 | 0.00 | L | -3.8u |
| 2026-05-22 | NHL | TOTAL | under | 5.0 | 2.50 | -110 | 3 | 1 | 4 | 2 | -1 | 0.00 | W | +2.5u |
| 2026-05-23 | MLB | ML | home | 2.5 | 0.50 | -181 | 1 | 0 | 1 | 1 | 10 | -1.70 | W | +0.3u |
| 2026-05-23 | MLB | ML | away | 2.5 | 2.75 | +109 | 2 | 0 | 2 | 2 | -12 | -0.50 | L | -2.8u |
| 2026-05-23 | MLB | TOTAL | over | 2.5 | 0.30 | -110 | 0 | 1 | 1 | 0 | 10 | 0.00 | W | +0.3u |
| 2026-05-23 | MLB | ML | home | 5.0 | 1.00 | -148 | 0 | 0 | 0 | 1 | -6 | -0.20 | L | -1.0u |
| 2026-05-23 | MLB | SPREAD | away | 3.0 | 0.75 | -163 | 1 | 0 | 1 | 1 | -7 | 0.00 | W | +0.5u |
| 2026-05-23 | MLB | TOTAL | under | 5.0 | 3.00 | -110 | 3 | 1 | 4 | 2 | -5 | 0.00 | W | +2.7u |
| 2026-05-23 | MLB | SPREAD | home | 3.0 | 0.75 | -163 | 0 | 0 | 0 | 1 | -6 | -0.90 | L | -0.8u |
| 2026-05-23 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 2 | 1 | 3 | 1 | -7 | 0.00 | L | -0.8u |
...
| 2026-05-23 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 1 | -7 | 0.00 | W | +0.7u |
| 2026-05-23 | MLB | ML | away | 2.5 | 1.25 | -111 | -1 | 1 | 0 | 1 | 2 | 0.40 | L | -1.3u |
| 2026-05-23 | MLB | SPREAD | home | 3.0 | 0.75 | -135 | 0 | 0 | 0 | 1 | -6 | 0.40 | W | +0.6u |
| 2026-05-23 | MLB | TOTAL | under | 2.5 | 0.30 | +108 | 0 | 0 | 0 | 0 | -8 | 0.00 | P | +0.0u |
| 2026-05-23 | MLB | ML | home | 4.0 | 2.50 | +118 | 1 | 0 | 1 | 1 | 1 | 1.10 | W | +2.9u |
| 2026-05-23 | MLB | ML | away | 3.0 | 1.25 | +166 | 2 | 1 | 3 | 2 | 0 | -0.30 | W | +1.8u |
| 2026-05-23 | MLB | SPREAD | away | 4.5 | 2.25 | -123 | 1 | 0 | 1 | 2 | -4 | -0.90 | W | +1.6u |
| 2026-05-23 | MLB | TOTAL | over | 2.5 | 0.30 | -111 | 1 | 0 | 1 | 0 | -10 | 0.00 | L | -0.3u |
| 2026-05-23 | NBA | SPREAD | home | 5.0 | 3.00 | -107 | 5 | 1 | 6 | 2 | 26 | 0.20 | L | -3.0u |
| 2026-05-23 | NBA | TOTAL | under | 5.0 | 3.00 | +102 | 1 | -1 | 0 | 6 | 9 | 0.00 | L | -3.0u |
| 2026-05-23 | NHL | ML | home | 5.0 | 5.00 | -205 | 8 | 0 | 8 | 3 | 14 | -0.70 | W | +2.4u |
| 2026-05-23 | NHL | TOTAL | under | 3.0 | 0.30 | -110 | 1 | 1 | 2 | 1 | 4 | 0.00 | W | +0.3u |
| 2026-05-24 | MLB | ML | home | 4.5 | 3.75 | -101 | 2 | 1 | 3 | 2 | -5 | 0.00 | L | -3.8u |
| 2026-05-24 | MLB | ML | home | 3.0 | 1.25 | -189 | 1 | 0 | 1 | 1 | 7 | 0.00 | W | +0.7u |
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 0.75 | -110 | 1 | 0 | 1 | 2 | 14 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 1 | 1 | 2 | 1 | -6 | 0.00 | L | -1.6u |
...
| 2026-05-24 | MLB | ML | home | 2.5 | 0.50 | +144 | 1 | 1 | 2 | 0 | -14 | 0.00 | L | -0.5u |
...
| 2026-05-24 | MLB | TOTAL | under | 2.5 | 0.30 | -104 | 0 | 0 | 0 | 1 | 12 | 0.00 | W | +0.3u |
| 2026-05-24 | MLB | ML | away | 4.0 | 1.25 | +148 | 2 | 2 | 4 | 1 | -9 | -1.40 | W | +1.9u |
| 2026-05-24 | MLB | ML | away | 3.0 | 1.25 | -122 | -1 | 1 | 0 | 0 | -18 | -1.10 | L | -1.3u |
| 2026-05-24 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 1 | -7 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | SPREAD | home | 3.0 | 0.75 | +134 | 1 | 0 | 1 | 0 | -8 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 1 | -7 | 0.00 | W | +0.7u |
| 2026-05-24 | NBA | SPREAD | away | 5.0 | 1.65 | -103 | 3 | 0 | 3 | 1 | -1 | 0.50 | L | -1.6u |
| 2026-05-24 | NBA | TOTAL | over | 4.5 | 3.00 | -107 | 2 | 1 | 3 | 2 | -13 | 0.00 | L | -3.0u |
| 2026-05-24 | NHL | ML | away | 4.0 | 2.75 | -136 | 3 | 0 | 3 | 0 | 5 | -0.70 | L | -2.8u |
| 2026-05-25 | MLB | ML | home | 5.0 | 5.00 | -149 | 1 | 0 | 1 | 3 | -5 | -0.70 | L | -5.0u |
| 2026-05-25 | MLB | ML | home | 5.0 | 5.00 | -310 | 2 | 0 | 2 | 1 | 7 | -1.20 | W | +1.6u |
...
| 2026-05-25 | MLB | ML | home | 5.0 | 1.25 | -160 | 3 | 0 | 3 | 2 | -13 | -1.10 | L | -1.3u |
| 2026-05-25 | MLB | TOTAL | over | 5.0 | 3.00 | -110 | 3 | 0 | 3 | 3 | 0 | 0.00 | W | +2.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 3.75 | -108 | 0 | 0 | 0 | 3 | -19 | -1.70 | L | -3.8u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -124 | 2 | 0 | 2 | 2 | -13 | -1.30 | W | +0.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 5.00 | -119 | 2 | -1 | 1 | 4 | -7 | -0.60 | W | +3.1u |
| 2026-05-25 | MLB | ML | away | 2.5 | 2.75 | -113 | 0 | 0 | 0 | 0 | 8 | -1.80 | W | +1.1u |
| 2026-05-25 | MLB | ML | home | 4.0 | 5.00 | -209 | -1 | 0 | -1 | 2 | 4 | -0.80 | W | +2.3u |
| 2026-05-25 | MLB | TOTAL | under | 5.0 | 0.75 | -101 | 2 | 1 | 3 | 1 | 10 | 0.00 | W | +0.7u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -178 | 1 | 0 | 1 | 2 | -13 | -1.60 | W | +0.9u |
| 2026-05-25 | NBA | ML | away | 5.0 | 5.00 | -125 | 0 | 0 | 0 | 4 | 45 | -0.40 | W | +4.0u |
| 2026-05-25 | NBA | TOTAL | under | 5.0 | 3.00 | -110 | 2 | 2 | 4 | 0 | -4 | 0.00 | L | -3.0u |
| 2026-05-25 | NHL | ML | home | 5.0 | 2.50 | +120 | 8 | 4 | 12 | 3 | -1 | -0.60 | L | -2.5u |
