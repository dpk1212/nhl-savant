...
_Auto-generated **6/9/2026, 11:48:54 AM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 534 shipped+graded picks · 2026-04-18 → 2026-06-08  (HC analyses scoped to post-cutover 2026-04-30, 422 picks)
**Headline:** 271-258-5 · WR 51.2% [47.0%–55.5%] vs 52.4% break-even · -10.9u flat (-2.0%) · -49.2u peak.
...
- **ρ(Δw, flat ROI) = 0.006 ✗**  (full sample, N=528)
- **ρ(HC, flat ROI) = -0.037 ✗**  (post-cutover, N=422)
- **ρ(Δw+HC, flat ROI) = -0.074 ✗**  (post-cutover, N=422)
...
- **Tier-1a (HC ≥ +2)** — N=40, WR 45.0%, flat ROI -17.0%. Bayesian posterior WR ≈ 46.0%, half-Kelly = **0.0%** bankroll at −110 → **size aggressively**.
- **Tier-1b (HC = +1)** — N=145, WR 55.2%, flat ROI +6.3%. Bayesian posterior WR ≈ 54.8%, half-Kelly = **2.6%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=73, WR 43.8%, flat ROI -18.1%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=96, WR 47.9%, flat ROI -3.1%. Bayesian posterior WR ≈ 48.1%, half-Kelly = **0.0%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -10.4% flat ROI on 129 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (0.99u/pick), we need **~1504 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 534. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **534** |
| W-L-P | 271-258-5 |
| Win rate | **51.2%** [47.0%–55.5%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +1.2 pp |
| Peak-units PnL | **-49.2u** |
| Flat-1u PnL | **-10.9u** (-2.0% flat ROI) |
| Flat t-statistic vs zero | -0.48 → ✗ noise |
| Flat 95% CI per-pick | [-0.104, 0.063]u |
...
We have **534** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = 0 | 106 | 54-49-3 | 52.4% [43–62] | -3.4% | +4.5u | -0.37 ✗ noise |
| Δw = +1 | 185 | 104-79-2 | 56.8% [50–64] | +7.0% | +8.5u | 1.01 ✗ noise |
| Δw = +2 | 118 | 56-62-0 | 47.5% [39–56] | -7.1% | -31.3u | -0.77 ✗ noise |
| Δw ≥ +3 | 96 | 46-50-0 | 47.9% [38–58] | -3.1% | -26.3u | -0.27 ✗ noise |

**Pearson ρ(Δw, WIN) = -0.008** ✗  ·  **ρ(Δw, flat ROI) = 0.006** ✗  (N=528)
...
| HC = −1 | 19 | 9-10-0 | 47.4% [27–68] | +1.7% | +1.5u | 0.07 ✗ noise |
| HC = 0 | 217 | 112-101-4 | 52.6% [46–59] | -2.6% | -21.3u | -0.41 ✗ noise |
| HC = +1 | 145 | 80-65-0 | 55.2% [47–63] | +6.3% | -5.4u | 0.77 ✗ noise |
| HC = +2 | 30 | 15-15-0 | 50.0% [33–67] | -3.8% | -7.1u | -0.21 ✗ noise |
| HC ≥ +3 | 10 | 3-7-0 | 30.0% [11–60] | -56.7% | -8.8u | -2.57 ✓ p<.05 |

**Pearson ρ(HC, WIN) = -0.021** ✗  ·  **ρ(HC, flat ROI) = -0.037** ✗  (N=422)

Spearman rank ρ(HC, flat ROI) = -0.007.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 77 | 37-38-2 | 49.3% [38–60] | -7.8% | -2.1u | -0.73 ✗ noise |
| Σ = +1 | 118 | 70-46-2 | 60.3% [51–69] | +13.2% | +16.1u | 1.53 ✗ noise |
| Σ = +2 | 103 | 60-43-0 | 58.3% [49–67] | +9.2% | +10.7u | 0.98 ✗ noise |
| Σ = +3 | 51 | 19-32-0 | 37.3% [25–51] | -26.3% | -27.1u | -1.89 ~ p<.10 |
| Σ = +4 | 37 | 20-17-0 | 54.1% [38–69] | +6.2% | -9.3u | 0.37 ✗ noise |
| Σ = +5 | 16 | 7-9-0 | 43.8% [23–67] | -17.0% | -7.8u | -0.69 ✗ noise |
| Σ ≥ +6 | 20 | 7-13-0 | 35.0% [18–57] | -36.3% | -19.1u | -1.78 ~ p<.10 |

**Pearson ρ(Δw+HC, WIN) = -0.068** ✗  ·  **ρ(Σ, flat ROI) = -0.074** ✗  (N=422)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 422.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.080 ✗ | -0.078 ✗ | -0.054 | weak |
| HC margin | -0.021 ✗ | -0.037 ✗ | -0.007 | weak |
| Δw + HC | -0.068 ✗ | -0.074 ✗ | -0.046 | weak |
| peak.stars | -0.066 ✗ | -0.092 ~ p<.10 | -0.115 | weak |
| vault.star | -0.063 ✗ | -0.081 ~ p<.10 | -0.106 | weak |
| lock.stars | -0.032 ✗ | -0.054 ✗ | -0.068 | weak |
...
Universe N = 422 (post-cutover, both axes present).

| HC \ Δw | ≤ −3 | -2 | -1 | +0 | +1 | +2 | ≥ +3 |
|---|---|---|---|---|---|---|---|
| ≤ −3 | — | — | — | — | — | — | — |
| -2 | — | N=1 · 1-0 · 100% [21–100] · —  | — | — | — | — | — |
| -1 | — | N=1 · 0-1 · 0% [0–79] · —  | N=2 · 1-1 · 50% [9–91] · —  | N=5 · 4-1 · 80% [38–96] · +72%  | N=5 · 0-5 · 0% [0–43] · -100%  | N=2 · 2-0 · 100% [34–100] · — ★ | N=4 · 2-2 · 50% [15–85] · -1%  |
| +0 | N=1 · 1-0 · 100% [21–100] · —  | N=1 · 0-1 · 0% [0–79] · —  | N=6 · 2-4 · 33% [10–70] · -42%  | N=51 · 27-22 · 55% [41–68] · +1%  | N=91 · 54-35 · 61% [50–70] · +14%  | N=45 · 23-22 · 51% [37–65] · -6%  | N=22 · 5-17 · 23% [10–43] · -59% ✗ |
| +1 | — | — | N=4 · 1-3 · 25% [5–70] · -56%  | N=25 · 14-11 · 56% [37–73] · +2%  | N=53 · 34-19 · 64% [51–76] · +22%  | N=32 · 14-18 · 44% [28–61] · -10%  | N=31 · 17-14 · 55% [38–71] · +8%  |
| +2 | — | — | — | N=1 · 1-0 · 100% [21–100] · —  | N=3 · 1-2 · 33% [6–79] · -40%  | N=11 · 5-6 · 45% [21–72] · -7%  | N=15 · 8-7 · 53% [30–75] · +2%  |
...
| Δw = 0 | 83 | 47-34-2 | 58.0% [47–68] | +6.6% | +17.9u | 0.66 ✗ noise |
| Δw = +1 | 152 | 89-61-2 | 59.3% [51–67] | +11.7% | +13.1u | 1.53 ✗ noise |
| Δw = +2 | 93 | 45-48-0 | 48.4% [38–58] | -6.0% | -27.5u | -0.58 ✗ noise |
| Δw ≥ +3 | 78 | 33-45-0 | 42.3% [32–53] | -19.1% | -38.4u | -1.75 ~ p<.10 |

### §3d. Practical lock zones (v7.4 floor anatomy)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 185 | 98-87-0 | 53.0% [46–60] | +1.3% | -21.3u | 0.18 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 73 | 32-41-0 | 43.8% [33–55] | -18.1% | -24.3u | -1.63 ✗ noise |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 164 | 90-70-4 | 56.3% [49–64] | +5.3% | +7.1u | 0.73 ✗ noise |
...
Universe N = 506 picks where ≥1 proven wallet appeared on either side.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δcount ≤ −2 (heavy oppose) | 7 | 4-3-0 | 57.1% [25–84] | +7.6% | -3.8u | 0.20 ✗ noise |
| Δcount = −1 | 28 | 13-15-0 | 46.4% [30–64] | -7.8% | -6.2u | -0.40 ✗ noise |
| Δcount = 0 (balanced) | 69 | 31-36-2 | 46.3% [35–58] | -11.7% | -7.1u | -1.02 ✗ noise |
| Δcount = +1 | 192 | 95-95-2 | 50.0% [43–57] | -6.5% | -43.0u | -0.95 ✗ noise |
| Δcount = +2 | 120 | 59-61-0 | 49.2% [40–58] | -7.3% | -16.9u | -0.82 ✗ noise |
| Δcount ≥ +3 (heavy support) | 90 | 59-31-0 | 65.6% [55–75] | +31.9% | +40.2u | 2.78 ✓ p<.01 |

**ρ(Δcount, WIN) = 0.085** ~ p<.10  ·  **ρ(Δcount, flat ROI) = 0.095** ✓ p<.05
...
Quintile cuts: ≤ -19 · ≤ -2 · ≤ 6 · ≤ 20 · > 20

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 105 | 45-60-0 | 42.9% [34–52] | -17.9% | -47.4u | -1.91 ~ p<.10 |
| Q2 | 100 | 43-56-1 | 43.4% [34–53] | -14.6% | -26.5u | -1.46 ✗ noise |
| Q3 (balanced) | 103 | 52-51-0 | 50.5% [41–60] | -3.8% | -19.4u | -0.39 ✗ noise |
| Q4 | 98 | 55-41-2 | 57.3% [47–67] | +9.9% | +9.1u | 0.99 ✗ noise |
| Q5 (best — heavy support) | 100 | 66-33-1 | 66.7% [57–75] | +25.3% | +47.6u | 2.53 ✓ p<.05 |

**ρ(ΔWlNet, WIN) = 0.184** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.165** ✓ p<.01
...
Quintile cuts (units): ≤ -17.97 · ≤ -4.00 · ≤ 6.17 · ≤ 16.14 · > 16.14

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 124 | 57-66-1 | 46.3% [38–55] | -13.0% | -29.5u | -1.52 ✗ noise |
| Q2 | 79 | 35-44-0 | 44.3% [34–55] | -17.4% | -23.1u | -1.63 ✗ noise |
| Q3 | 101 | 49-51-1 | 49.0% [39–59] | -6.6% | -18.7u | -0.68 ✗ noise |
| Q4 | 102 | 55-46-1 | 54.5% [45–64] | +0.3% | -12.3u | 0.03 ✗ noise |
| Q5 | 100 | 65-34-1 | 65.7% [56–74] | +33.9% | +46.9u | 3.13 ✓ p<.01 |
...
Quintile cuts (% ROI): ≤ -9.5 · ≤ -2.1 · ≤ 8.5 · ≤ 20.7 · > 20.7

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 120 | 37-82-1 | 31.1% [23–40] | -40.6% | -76.0u | -4.97 ✓ p<.01 |
| Q2 | 83 | 41-42-0 | 49.4% [39–60] | -8.8% | -14.6u | -0.85 ✗ noise |
| Q3 | 113 | 59-54-0 | 52.2% [43–61] | -0.1% | -13.2u | -0.01 ✗ noise |
| Q4 | 92 | 56-34-2 | 62.2% [52–72] | +15.9% | +32.1u | 1.66 ~ p<.10 |
| Q5 | 98 | 68-29-1 | 70.1% [60–78] | +40.1% | +35.0u | 3.87 ✓ p<.01 |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 54 | 12-41-1 | 22.6% [13–36] | -54.5% | -44.5u | -4.76 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 15 | 6-9-0 | 40.0% [20–64] | -17.2% | -7.2u | -0.62 ✗ noise |
| ΔBestRank = 0 (tied) | 2 | 1-1-0 | 50.0% [9–91] | -4.5% | -1.4u | -0.05 ✗ noise |
| ΔBestRank ∈ [+1,+4] | 14 | 5-9-0 | 35.7% [16–61] | -37.3% | -5.7u | -1.58 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 126 | 79-44-3 | 64.2% [55–72] | +27.5% | +36.5u | 2.93 ✓ p<.01 |

**ρ(ΔBestRank, WIN) = 0.379** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.420** ✓ p<.01  (N=211)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 29 | 7-22-0 | 24.1% [12–42] | -57.8% | -19.1u | -4.01 ✓ p<.01 |
| Δshare ∈ [−30,−10] pp | 5 | 2-3-0 | 40.0% [12–77] | -8.8% | -2.5u | -0.15 ✗ noise |
| Δshare ≈ 0 (±10 pp) | 341 | 173-166-2 | 51.0% [46–56] | -4.6% | -35.6u | -0.89 ✗ noise |
| Δshare ∈ [+10,+30] pp | 20 | 13-7-0 | 65.0% [43–82] | +32.7% | +5.7u | 1.32 ✗ noise |
| Δshare ≥ +30 pp | 111 | 66-43-2 | 60.6% [51–69] | +21.6% | +14.6u | 2.13 ✓ p<.05 |

**ρ(ΔTopQShare, WIN) = 0.133** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.153** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔTopQCount** | 0.179 ✓ p<.01 | 0.227 ✓ p<.01 | 0.194 |
| 2 | **ΔWlNet** | 0.184 ✓ p<.01 | 0.165 ✓ p<.01 | 0.134 |
| 3 | **ΔTopQShare** | 0.133 ✓ p<.01 | 0.153 ✓ p<.01 | 0.171 |
| 4 | **Δcount** | 0.085 ~ p<.10 | 0.095 ✓ p<.05 | 0.090 |
| 5 | **ΔFlatPnl** | NaN — | NaN — | 0.168 |
| 6 | **ΔAvgRoi** | NaN — | NaN — | 0.281 |

_(ΔBestRank uses N=211 subset where both sides had a proven wallet — ρ(flat ROI) = 0.420 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 927, dateRange = 2026-04-18 → 2026-06-08, computedAt = 2026-06-09T15:44:55.033Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **506** rows · PIT aggregate computable on **504** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **504** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 342 · 55% · +4.9% | 299 · 53% · -2.1% | -6.9pp |
| WEAK (−3..0) | 144 · 46% · -11.1% | 187 · 52% · +3.6% | +14.8pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=271, WR=56%, ROI=+6.5% | N=226, WR=51%, ROI=-5.4% | -11.9pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=342, WR=55%, ROI=+4.9% | N=299, WR=53%, ROI=-2.1% | -6.9pp |
| AGS < −1 (mute veto) | N=52, WR=45%, ROI=-13.6% | N=105, WR=47%, ROI=-3.7% | +9.9pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-05-26 → 2026-06-08, N=210)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 113 · 58% · +6.8% |
| WEAK (−3..0) | 97 · 52% · +0.4% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=76, WR=57%, ROI=+4.1% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=113, WR=58%, ROI=+6.8% |
| AGS < −1 (mute veto) | N=55, WR=48%, ROI=-6.1% |
...
|---|---|---|---|---|
| `dCount` | COUNT | + | 1.05 | 1.51 |
| `dHcSizeRatio` | INTENSITY_HC | + | 1.04 | 4.47 |
| `dSumRankNorm` | QUALITY_RANK | − | 56.01 | 87.63 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.57 | 1.15 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **504/534** shipped+graded rows (94%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 80 | 39-41-0 | 48.8% [38–60] | -10.7% | -24.0u | -1.01 ✗ noise |
| LOCK | 94 | 43-51-0 | 45.7% [36–56] | -13.9% | -25.6u | -1.40 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 65 | 35-29-1 | 54.7% [43–66] | +5.3% | +10.4u | 0.44 ✗ noise |
| FADE | 110 | 49-58-3 | 45.8% [37–55] | -6.2% | -39.0u | -0.60 ✗ noise |
...
r(WIN) = **-0.016** ✗ · r(ROI) = **-0.050** ✗ · Spearman ρ(ROI) = **-0.052**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 95 | 49-44-2 | 52.7% [43–63] | +7.0% | -24.9u | 0.62 ✗ noise |
| z ∈ [−1, 0) | 176 | 97-77-2 | 55.7% [48–63] | +4.9% | +29.0u | 0.68 ✗ noise |
| z ∈ [0, +1) | 154 | 72-81-1 | 47.1% [39–55] | -11.2% | -39.6u | -1.45 ✗ noise |
| z ≥ +1 (very positive) | 79 | 39-40-0 | 49.4% [39–60] | -8.7% | -7.9u | -0.81 ✗ noise |
...
| z ∈ [0, +1) | 470 | 242-223-5 | 52.0% [48–57] | -1.7% | -40.3u | -0.37 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.056** ✗ · r(ROI) = **-0.064** ✗ · Spearman ρ(ROI) = **-0.062**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 92 | 52-39-1 | 57.1% [47–67] | +4.3% | +0.6u | 0.45 ✗ noise |
| z ∈ [−1, 0) | 163 | 88-73-2 | 54.7% [47–62] | +7.0% | -3.3u | 0.87 ✗ noise |
| z ∈ [0, +1) | 188 | 89-98-1 | 47.6% [41–55] | -8.5% | -37.6u | -1.19 ✗ noise |
| z ≥ +1 (very positive) | 61 | 28-32-1 | 46.7% [35–59] | -13.8% | -3.1u | -1.15 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.056 ✗ | -0.064 ✗ | -0.062 |
| 2 | `dCount` | COUNT | -0.016 ✗ | -0.050 ✗ | -0.052 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | +0.002 | 0.790 | 48.5% | meaningful |
| 2 | `dSumRankNorm` | -0.065 | 0.790 | 48.5% | meaningful |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.057 | +0.718 ⚠ | +0.057 |
| `dHcSizeRatio` | +0.057 | 1.000 | +0.030 | +1.000 ⚠ |
| `dSumRankNorm` | +0.718 ⚠ | +0.030 | 1.000 | +0.030 |
| `dWinnerCtPreA` | +0.057 | +1.000 ⚠ | +0.030 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **-0.025**. At AGS ≥ +0.12 fires N=236, WR=50.4%, ROI=-6.2%. At AGS ≥ +null fires N=311, WR=51.9%, ROI=-3.4%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-236 ROI (matched cohort) | Top-236 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.063 | +0.038 | WR=56%, ROI=+7.3% | -13.5pp | N=243, WR=56%, ROI=+6.5% |
| `dHcSizeRatio` | +0.032 | +0.007 | WR=54%, ROI=+1.8% | -8.0pp | N=239, WR=55%, ROI=+2.1% |
| `dSumRankNorm` | -0.052 | +0.027 | WR=48%, ROI=-10.7% | +4.4pp | N=241, WR=48%, ROI=-10.0% |
| `dWinnerCtPreA` | +0.036 | +0.011 | WR=55%, ROI=+2.5% | -8.7pp | N=228, WR=54%, ROI=+1.0% |
...
|---|---|---|---|---|
| 1 | `dHcSizeRatio` | +0.007 | -8.0pp | redundant — other features cover it |
| 2 | `dWinnerCtPreA` | +0.011 | -8.7pp | redundant — other features cover it |
| 3 | `dSumRankNorm` | +0.027 | +4.4pp | redundant — other features cover it |
| 4 | `dCount` | +0.038 | -13.5pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.123 | 0.123 | negative ↓ |
| 2 | `dWinnerCtPreA` | QUALITY_TRACK | +0.043 | 0.043 | flat ≈ 0 |
| 3 | `dCount` | COUNT | +0.026 | 0.026 | flat ≈ 0 |
| 4 | `dHcSizeRatio` | INTENSITY_HC | +0.020 | 0.020 | flat ≈ 0 |

Intercept b = +0.033 · Final log-loss = 0.6907 · N = 504.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 504 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/504 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 178 | 82-96-0 | 46.1% [39–53] | -15.9% | -73.6u | -2.28 ✓ p<.05 |
| 4.5★ | 73 | 48-24-1 | 66.7% [55–76] | +25.0% | +37.4u | 2.27 ✓ p<.05 |
| 4.0★ | 101 | 47-52-2 | 47.5% [38–57] | -8.6% | -8.8u | -0.88 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 71 | 37-33-1 | 52.9% [41–64] | +4.8% | -2.5u | 0.40 ✗ noise |
| 2.5★ | 73 | 38-34-1 | 52.8% [41–64] | +1.5% | -5.5u | 0.13 ✗ noise |

### §5b. Stars × Δw stratified — does the star tier hold up within each Δw cohort?

| Δw cohort | 5★ | 4.5★ | 4★ | 3.5★ | 3★ | 2.5★ |
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 26/58%/-1% | 19/63%/+15% | 19/33%/-35% | 6/33%/-26% | 28/37%/-31% | 30/52%/-1% |
| Δw = +1 | 30/50%/-9% | 26/68%/+24% | 47/50%/-5% | 28/54%/+4% | 25/68%/+34% | 28/57%/+5% |
| Δw = +2 | 58/43%/-18% | 14/64%/+20% | 29/52%/+2% | — | 9/44%/-3% | 8/38%/-16% |
| Δw ≥ +3 | 62/40%/-26% | 11/73%/+53% | 6/50%/-8% | 3/67%/+156% | 9/67%/+43% | 5/40%/-12% |
...
| −150/−101 | 321 | 160-158-3 | 50.3% [45–56] | -5.4% | -31.9u | -1.03 ✗ noise |
| −100/+100 | 5 | 2-3-0 | 40.0% [12–77] | -20.0% | -3.3u | -0.41 ✗ noise |
| +101/+150 | 106 | 52-52-2 | 50.0% [41–59] | +8.9% | -31.1u | 0.84 ✗ noise |
...
| −150/−101 | -8% (75) | +2% (120) | -22% (68) | +0% (55) |
| −100/+100 | -100% (1) | +33% (3) | -100% (1) | — |
| +101/+150 | +11% (22) | +11% (38) | +10% (30) | -0% (16) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 285 | 145-140-0 | 50.9% [45–57] | -2.0% | -41.3u | -0.33 ✗ noise |
| SPREAD | 85 | 41-43-1 | 48.8% [38–59] | -11.2% | +0.7u | -1.12 ✗ noise |
| TOTAL | 164 | 85-75-4 | 53.1% [45–61] | +2.6% | -8.5u | 0.35 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=70 · 46% · -17% | N=92 · 62% · +16% | N=60 · 47% · -5% | N=60 · 43% · -9% |
| SPREAD | N=21 · 35% · -38% | N=30 · 53% · -2% | N=17 · 65% · +15% | N=16 · 38% · -27% |
| TOTAL | N=38 · 61% · +17% | N=63 · 51% · -2% | N=41 · 41% · -19% | N=20 · 70% · +35% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 362 | 190-169-3 | 52.9% [48–58] | +0.1% | -16.2u | 0.01 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=93 · 53% · -2% | N=142 · 57% · +8% | N=84 · 48% · -7% | N=42 · 48% · -9% |
...
|---|---|---|
| **sharps3Plus** | 231 · 46% · -9.7% · -1.41 ✗ noise | 302 · 55% · +3.3% · 0.62 ✗ noise |
| **plusEV** | 61 · 49% · -2.6% · -0.18 ✗ noise | 472 · 51% · -2.3% · -0.51 ✗ noise |
| **pinnacleConfirms** | 133 · 53% · +3.4% · 0.37 ✗ noise | 246 · 50% · -4.7% · -0.76 ✗ noise |
| **invested10kPlus** | 267 · 50% · -4.3% · -0.69 ✗ noise | 112 · 54% · +3.9% · 0.43 ✗ noise |
| **lineMovingWith** | 263 · 55% · +5.2% · 0.84 ✗ noise | 270 · 48% · -9.6% · -1.62 ✗ noise |
| **predMarketAligns** | 135 · 53% · +2.5% · 0.28 ✗ noise | 244 · 50% · -4.3% · -0.68 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 127 | 66-61-0 | 52.0% [43–60] | -0.6% | -7.8u | -0.07 ✗ noise |
| 1 | 120 | 59-58-3 | 50.4% [41–59] | -5.6% | -25.0u | -0.66 ✗ noise |
| 2 | 131 | 67-62-2 | 51.9% [43–60] | -0.0% | +2.9u | -0.00 ✗ noise |
| 3 | 46 | 23-23-0 | 50.0% [36–64] | -3.8% | -6.7u | -0.25 ✗ noise |
| 4 | 47 | 24-23-0 | 51.1% [37–65] | -7.3% | -10.3u | -0.53 ✗ noise |
...
| NEAR_START | 219 | 106-109-4 | 49.3% [43–56] | -3.2% | -51.5u | -0.46 ✗ noise |
| NO_MOVE | 17 | 9-8-0 | 52.9% [31–74] | -3.3% | +6.8u | -0.14 ✗ noise |
| PREGAME | 78 | 42-36-0 | 53.8% [43–64] | +2.9% | -6.7u | 0.27 ✗ noise |
| SMALL_MOVE | 112 | 53-59-0 | 47.3% [38–57] | -12.0% | -8.4u | -1.33 ✗ noise |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 293 | 151-141-1 | 51.7% [46–57] | -3.0% | -47.9u | -0.54 ✗ noise |
| STRONG | 85 | 44-39-2 | 53.0% [42–63] | +4.0% | +7.5u | 0.37 ✗ noise |
| LEAN | 148 | 72-74-2 | 49.3% [41–57] | -4.2% | -10.2u | -0.48 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.110 ✓ p<.05 | -0.080 ~ p<.10 | -0.070 | -1.85 |
| totalInvested | -0.064 ✗ | -0.076 ~ p<.10 | -0.047 | -1.76 |
| evEdge | 0.075 ~ p<.10 | 0.077 ~ p<.10 | 0.051 | 1.77 |
| moneyPct | 0.057 ✗ | 0.029 ✗ | 0.021 | 0.67 |
| walletPct | 0.049 ✗ | 0.041 ✗ | 0.042 | 0.94 |
| criteriaMet | -0.004 ✗ | 0.009 ✗ | -0.018 | 0.20 |
| maxContribFor | -0.042 ✗ | -0.021 ✗ | -0.004 | -0.50 |
| meanBaseFor | -0.039 ✗ | -0.006 ✗ | 0.024 | -0.13 |
...
Sample with CLV: **522** picks. Mean CLV = **-0.0036**.
t-statistic vs zero: -2.81 → ✓ p<.01 · 95% CI [-0.0061, -0.0011]

Bucketed CLV vs flat PnL:

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLV ≤ −2% | 56 | 24-31-1 | 43.6% [31–57] | -24.2% | -22.8u | -2.09 ✓ p<.05 |
| CLV (−2%, 0] | 302 | 153-146-3 | 51.2% [46–57] | -2.8% | -34.8u | -0.50 ✗ noise |
| CLV (0, +2%] | 140 | 75-65-0 | 53.6% [45–62] | +7.7% | -0.6u | 0.85 ✗ noise |
| CLV > +2% | 24 | 13-10-1 | 56.5% [37–74] | +5.5% | +7.8u | 0.27 ✗ noise |

ρ(CLV, flat ROI) = 0.096 ✓ p<.05
...
Trained on N=404 (with all features non-null). Intercept β₀ = 0.100.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | pw.ΔAvgRoi | +0.485 | ↑ helps |
| 2 | sharpCount | -0.279 | ↓ hurts |
| 3 | pw.Δcount | +0.247 | ↑ helps |
| 4 | log(impliedProb) | +0.187 | ↑ helps |
| 5 | evEdge | +0.186 | ↑ helps |
| 6 | peak.stars | -0.137 | ↓ hurts |
| 7 | pw.ΔWlNet | +0.127 | ↑ helps |
| 8 | pw.ΔFlatPnl | +0.122 | ↑ helps |
| 9 | pw.ΔTopQShare | -0.109 | ↓ hurts |
| 10 | Δw | -0.095 | ↓ hurts |
| 11 | HC margin | +0.089 | ↑ helps |
| 12 | vault.star | +0.059 | ↑ helps |
| 13 | walletPct | +0.042 | ≈ flat |
| 14 | Δw + HC | -0.031 | ≈ flat |
| 15 | criteriaMet | +0.030 | ≈ flat |
| 16 | moneyPct | +0.020 | ≈ flat |
| 17 | log10(invested) | -0.014 | ≈ flat |
| 18 | odds (American) | -0.001 | ≈ flat |
...
|---|---|---|---|---|---|---|---|---|
| Tier-1a HC ≥ +2 (post-cutover) | 40 | 18-22 | 45.0% | 46.0% | -110 | — (mute) | 2.98u | **MUTE** (negative EV at posterior) |
| Tier-1b HC = +1 (post-cutover) | 145 | 80-65 | 55.2% | 54.8% | -110 | 2.58% bankroll | 2.07u | ~ in range — 2.58u |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 73 | 32-41 | 43.8% | 44.6% | -110 | — (mute) | 1.97u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 96 | 46-50 | 47.9% | 48.1% | -110 | — (mute) | 2.46u | **MUTE** (negative EV at posterior) |
| Stale Δw = 0 | 106 | 54-49 | 52.4% | 52.2% | -110 | — (mute) | 1.82u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.160  (annualized × √252 ≈ -2.55)
...
| 2026-04-19 | MLB | ML | away | 2.5 | 1.00 | +100 | 0 | — | — | 0 | 33 | 1.00 | L | -1.0u |
...
| 2026-04-23 | MLB | ML | home | 3.0 | 1.00 | -155 | 0 | — | — | 1 | 35 | 0.30 | L | -1.0u |
...
| 2026-04-26 | MLB | ML | home | 3.5 | 0.75 | -110 | 1 | — | — | 1 | 35 | -1.40 | L | -0.8u |
...
| 2026-04-27 | MLB | ML | home | 5.0 | 2.00 | +140 | 2 | — | — | -1 | -35 | -0.50 | L | -2.0u |
...
| 2026-04-28 | MLB | ML | away | 5.0 | 2.00 | +142 | 3 | — | — | -1 | -1 | 0.00 | L | -2.0u |
...
| 2026-04-29 | MLB | ML | home | 3.5 | 0.50 | -108 | 1 | — | — | 1 | 35 | 0.50 | L | -0.5u |
...
| 2026-05-03 | MLB | ML | away | 2.8 | 0.75 | -130 | 1 | 1 | 2 | -1 | -35 | -1.00 | W | +0.6u |
...
| 2026-05-04 | MLB | ML | home | 3.5 | 1.13 | -199 | -1 | 1 | 0 | -1 | -1 | -0.20 | L | -1.1u |
...
| 2026-05-12 | MLB | ML | away | 4.5 | 3.00 | +129 | 3 | 0 | 3 | 1 | 35 | -1.00 | L | -3.0u |
...
| 2026-05-13 | MLB | TOTAL | under | 4.0 | 0.96 | -110 | 1 | 1 | 2 | 2 | -26 | 0.00 | W | +0.9u |
| 2026-05-13 | MLB | TOTAL | under | 5.0 | 3.50 | -110 | 4 | 2 | 6 | 4 | -28 | 0.00 | L | -3.5u |
...
| 2026-05-14 | MLB | ML | home | 4.0 | 1.25 | +108 | 2 | 0 | 2 | 2 | 16 | -0.90 | L | -1.3u |
...
| 2026-05-15 | MLB | ML | away | 4.0 | 2.75 | -211 | 2 | 1 | 3 | 1 | 35 | -0.90 | W | +1.3u |
| 2026-05-15 | MLB | ML | away | 3.0 | 1.25 | +115 | 0 | 1 | 1 | -1 | -35 | -1.10 | L | -1.3u |
...
| 2026-05-16 | MLB | ML | away | 5.0 | 4.50 | +124 | 3 | 1 | 4 | 4 | -22 | -1.30 | W | +1.4u |
...
| 2026-05-16 | MLB | ML | away | 2.5 | 0.50 | -102 | 1 | 0 | 1 | 1 | -61 | 0.00 | W | +0.5u |
| 2026-05-17 | MLB | ML | away | 4.0 | 2.75 | -148 | 1 | 0 | 1 | 2 | 16 | -0.70 | W | +1.9u |
| 2026-05-17 | MLB | ML | away | 2.5 | 0.50 | +139 | 0 | 1 | 1 | 0 | -54 | 0.70 | L | -0.5u |
...
| 2026-05-18 | MLB | ML | home | 4.5 | 5.00 | -111 | 2 | 1 | 3 | 2 | 16 | -1.10 | W | +4.4u |
| 2026-05-18 | MLB | ML | away | 4.0 | 2.50 | +120 | 2 | 0 | 2 | 1 | -19 | -2.10 | L | -2.5u |
| 2026-05-18 | MLB | ML | home | 3.0 | 1.25 | -118 | 2 | 0 | 2 | 1 | -19 | 1.00 | W | +1.1u |
| 2026-05-18 | MLB | ML | home | 4.0 | 2.75 | -150 | 2 | 0 | 2 | 1 | 35 | -0.80 | L | -2.8u |
...
| 2026-05-20 | MLB | ML | home | 4.0 | 2.75 | -154 | 2 | 0 | 2 | 1 | 35 | -1.50 | W | +1.9u |
| 2026-05-20 | MLB | TOTAL | under | 4.0 | 0.75 | -110 | 2 | 0 | 2 | 1 | -19 | 0.00 | L | -0.8u |
| 2026-05-20 | MLB | ML | home | 2.5 | 0.50 | -140 | 1 | 1 | 2 | 1 | -19 | -1.10 | W | +0.9u |
| 2026-05-20 | MLB | ML | home | 2.5 | 0.50 | +111 | 0 | 1 | 1 | -1 | -35 | 0.00 | W | +0.6u |
| 2026-05-20 | MLB | ML | away | 4.0 | 2.75 | +113 | 1 | 1 | 2 | 0 | -54 | -1.00 | L | -2.8u |
...
| 2026-05-21 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 0 | 0 | 2 | -3 | 0.00 | W | +0.3u |
...
| 2026-05-22 | MLB | ML | home | 5.0 | 1.25 | -175 | 1 | 0 | 1 | 1 | 35 | -0.90 | L | -1.3u |
...
| 2026-05-22 | MLB | ML | home | 5.0 | 5.00 | -144 | 4 | 2 | 6 | 2 | 16 | -1.60 | L | -5.0u |
| 2026-05-22 | MLB | SPREAD | home | 5.0 | 0.75 | -155 | 2 | 0 | 2 | 1 | -19 | -0.30 | W | +0.4u |
| 2026-05-22 | MLB | ML | home | 5.0 | 2.75 | -158 | 1 | 0 | 1 | 1 | 35 | -0.80 | W | +1.7u |
| 2026-05-22 | MLB | SPREAD | home | 3.0 | 0.75 | -142 | 1 | 0 | 1 | 1 | -19 | -2.00 | L | -0.8u |
| 2026-05-22 | MLB | ML | home | 5.0 | 5.00 | -145 | 2 | 2 | 4 | 1 | 35 | -2.20 | L | -5.0u |
| 2026-05-22 | MLB | ML | home | 2.5 | 0.50 | +139 | 2 | 1 | 3 | 0 | -40 | -0.90 | W | +0.7u |
...
| 2026-05-23 | MLB | ML | home | 2.5 | 0.50 | -181 | 1 | 0 | 1 | 2 | 28 | -1.70 | W | +0.3u |
| 2026-05-23 | MLB | ML | away | 2.5 | 2.75 | +109 | 2 | 0 | 2 | 2 | -29 | -0.50 | L | -2.8u |
| 2026-05-23 | MLB | TOTAL | over | 2.5 | 0.30 | -110 | 0 | 1 | 1 | 0 | -4 | 0.00 | W | +0.3u |
...
| 2026-05-23 | MLB | SPREAD | away | 4.5 | 1.50 | -209 | 0 | 0 | 0 | 2 | -26 | 29.00 | W | +2.5u |
...
| 2026-05-23 | MLB | ML | home | 4.0 | 2.50 | +118 | 1 | 0 | 1 | 1 | -3 | 1.10 | W | +2.9u |
| 2026-05-23 | MLB | ML | away | 3.0 | 1.25 | +166 | 2 | 1 | 3 | 2 | -18 | -0.30 | W | +1.8u |
...
| 2026-05-24 | MLB | ML | home | 3.0 | 1.25 | -189 | 1 | 0 | 1 | 1 | 35 | 0.00 | W | +0.7u |
...
| 2026-05-24 | MLB | ML | home | 2.5 | 0.50 | +144 | 1 | 1 | 2 | -1 | -59 | 0.00 | L | -0.5u |
| 2026-05-24 | MLB | SPREAD | home | 4.0 | 1.65 | -110 | 2 | 1 | 3 | 2 | -26 | -1.30 | L | -1.6u |
...
| 2026-05-24 | MLB | ML | away | 4.0 | 1.25 | +148 | 2 | 2 | 4 | 0 | -15 | -1.40 | W | +1.9u |
| 2026-05-24 | MLB | ML | away | 3.0 | 1.25 | -122 | -1 | 1 | 0 | 0 | -42 | -1.10 | L | -1.3u |
...
| 2026-05-25 | MLB | ML | home | 5.0 | 5.00 | -149 | 1 | 0 | 1 | 3 | 6 | -0.70 | L | -5.0u |
| 2026-05-25 | MLB | ML | home | 5.0 | 5.00 | -310 | 2 | 0 | 2 | 1 | 35 | -1.20 | W | +1.6u |
...
| 2026-05-25 | MLB | TOTAL | under | 5.0 | 2.25 | -112 | 4 | 0 | 4 | 4 | -14 | 0.00 | L | -2.3u |
| 2026-05-25 | MLB | ML | home | 5.0 | 1.25 | -160 | 3 | 0 | 3 | 2 | -41 | -1.10 | L | -1.3u |
| 2026-05-25 | MLB | TOTAL | over | 5.0 | 3.00 | -110 | 3 | 0 | 3 | 3 | 6 | 0.00 | W | +2.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 3.75 | -108 | 0 | 0 | 0 | 3 | -48 | -1.70 | L | -3.8u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -124 | 2 | 0 | 2 | 2 | -26 | -1.30 | W | +0.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 5.00 | -119 | 2 | -1 | 1 | 4 | -13 | -0.60 | W | +3.1u |
| 2026-05-25 | MLB | ML | away | 2.5 | 2.75 | -113 | 0 | 0 | 0 | 0 | 10 | -1.80 | W | +1.1u |
| 2026-05-25 | MLB | ML | home | 4.0 | 5.00 | -209 | -1 | 0 | -1 | 3 | 6 | -0.80 | W | +2.3u |
| 2026-05-25 | MLB | TOTAL | under | 5.0 | 0.75 | -101 | 2 | 1 | 3 | 1 | 11 | 0.00 | W | +0.7u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -178 | 1 | 0 | 1 | 2 | -26 | -1.60 | W | +0.9u |
...
| 2026-05-26 | MLB | TOTAL | over | 5.0 | 1.65 | -110 | 2 | 0 | 2 | 2 | -26 | 0.00 | W | +1.5u |
| 2026-05-26 | MLB | ML | away | 5.0 | 1.50 | +200 | 2 | 0 | 2 | 2 | -20 | -1.00 | L | -1.5u |
| 2026-05-26 | MLB | SPREAD | away | 5.0 | 1.00 | -101 | 2 | 1 | 3 | 2 | -26 | 0.50 | L | -1.0u |
| 2026-05-26 | MLB | ML | away | 2.5 | 1.25 | +113 | 0 | 0 | 0 | 0 | 42 | -1.50 | W | +1.4u |
| 2026-05-26 | MLB | ML | home | 2.5 | 1.25 | -130 | 1 | 0 | 1 | 0 | 42 | -1.30 | W | +1.0u |
| 2026-05-26 | MLB | ML | away | 5.0 | 5.00 | -200 | 1 | 0 | 1 | 2 | 28 | -0.60 | W | +1.9u |
...
| 2026-05-26 | MLB | ML | home | 5.0 | 5.00 | -105 | 2 | 1 | 3 | 2 | 28 | -2.00 | W | +3.6u |
| 2026-05-26 | MLB | ML | away | 5.0 | 2.50 | +116 | 1 | 0 | 1 | 2 | 28 | -1.00 | W | +2.9u |
...
| 2026-05-27 | MLB | ML | home | 4.5 | 0.50 | -102 | 3 | 1 | 4 | 3 | 46 | -1.10 | W | +0.4u |
| 2026-05-27 | MLB | SPREAD | away | 5.0 | 2.50 | +141 | 1 | 1 | 2 | 4 | -23 | 0.80 | L | -2.5u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 1.00 | +105 | 2 | 0 | 2 | 2 | -26 | 0.00 | L | -1.0u |
| 2026-05-27 | MLB | ML | home | 4.5 | 3.75 | -420 | 1 | 1 | 2 | 1 | 35 | -0.50 | W | +0.7u |
| 2026-05-27 | MLB | ML | home | 3.0 | 1.25 | -144 | -1 | -1 | -2 | 0 | -17 | -1.00 | L | -1.3u |
| 2026-05-27 | MLB | ML | away | 5.0 | 0.50 | -102 | 3 | 0 | 3 | 2 | 12 | -1.00 | L | -0.5u |
...
| 2026-05-27 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 2 | 5 | 4 | -13 | -0.30 | L | -2.5u |
| 2026-05-27 | MLB | SPREAD | away | 4.5 | 1.65 | -145 | 1 | 1 | 2 | 1 | -7 | -0.30 | W | +1.1u |
| 2026-05-27 | MLB | ML | away | 5.0 | 5.00 | -126 | 2 | 0 | 2 | 1 | -20 | -4.10 | L | -5.0u |
| 2026-05-27 | MLB | ML | home | 4.0 | 1.25 | -190 | 1 | 0 | 1 | 1 | 35 | -0.70 | W | +0.7u |
...
| 2026-05-28 | MLB | TOTAL | over | 5.0 | 3.00 | +101 | 3 | -1 | 2 | 3 | 25 | 0.00 | W | +2.5u |
| 2026-05-28 | MLB | ML | home | 5.0 | 1.25 | -140 | 2 | 0 | 2 | 2 | -20 | -0.50 | L | -1.3u |
| 2026-05-28 | MLB | TOTAL | under | 5.0 | 1.00 | -107 | 1 | 0 | 1 | 1 | 42 | 0.00 | W | +0.0u |
| 2026-05-28 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 1 | 4 | 2 | -83 | -0.60 | L | -2.5u |
| 2026-05-28 | MLB | TOTAL | over | 2.5 | 1.65 | -108 | 2 | 0 | 2 | 2 | -26 | 0.00 | L | -1.6u |
...
| 2026-05-29 | MLB | ML | home | 5.0 | 3.75 | -124 | 2 | 1 | 3 | 3 | 9 | -1.00 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 1.65 | -106 | 2 | 0 | 2 | 3 | 2 | 0.00 | L | -1.6u |
| 2026-05-29 | MLB | ML | home | 4.0 | 2.50 | +120 | 1 | 0 | 1 | 1 | -1 | 0.40 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 2.25 | -112 | 2 | 0 | 2 | 3 | 28 | 0.00 | W | +2.0u |
| 2026-05-29 | MLB | SPREAD | away | 4.0 | 0.75 | +150 | 0 | 0 | 0 | 1 | -7 | -0.50 | L | -0.8u |
| 2026-05-29 | MLB | ML | away | 5.0 | 2.50 | +140 | 2 | 1 | 3 | 1 | -18 | 1.00 | L | -2.5u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 1.65 | -103 | 0 | 0 | 0 | 2 | -26 | 0.00 | W | +1.6u |
| 2026-05-29 | MLB | ML | away | 4.5 | 1.25 | -142 | 0 | 1 | 1 | -2 | 9 | -1.20 | W | +0.3u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 1.65 | -135 | 1 | 0 | 1 | 2 | -26 | 0.40 | W | +1.2u |
| 2026-05-29 | MLB | ML | home | 4.5 | 1.25 | -134 | 1 | 0 | 1 | 0 | 0 | -1.70 | W | +2.8u |
...
| 2026-05-29 | MLB | ML | home | 5.0 | 2.75 | -106 | 2 | 1 | 3 | 2 | 48 | 0.70 | L | -2.8u |
| 2026-05-29 | MLB | SPREAD | home | 4.0 | 1.65 | -175 | 0 | 0 | 0 | 2 | -26 | -0.80 | L | -1.6u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 0.30 | +105 | 2 | 1 | 3 | 1 | 13 | 0.00 | W | +0.3u |
| 2026-05-29 | MLB | ML | home | 4.5 | 3.75 | -122 | 0 | 1 | 1 | 1 | -4 | -0.60 | L | -3.8u |
| 2026-05-29 | MLB | TOTAL | over | 3.0 | 1.00 | -108 | 0 | 0 | 0 | 1 | -7 | 0.00 | W | +1.5u |
...
| 2026-05-30 | MLB | ML | away | 4.5 | 2.75 | -125 | 1 | 2 | 3 | 1 | 1 | -0.60 | W | +2.3u |
...
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -118 | 1 | 1 | 2 | 1 | -28 | -1.30 | L | -3.8u |
| 2026-05-30 | MLB | SPREAD | away | 4.0 | 1.00 | +152 | 1 | 0 | 1 | 1 | -7 | 0.20 | L | -1.0u |
| 2026-05-30 | MLB | ML | home | 5.0 | 5.00 | -120 | 0 | 0 | 0 | 3 | -48 | -1.10 | W | +4.2u |
| 2026-05-30 | MLB | TOTAL | over | 4.5 | 0.75 | +100 | 1 | 1 | 2 | 1 | 5 | 0.00 | W | +0.8u |
| 2026-05-30 | MLB | ML | home | 4.0 | 2.75 | -130 | 0 | 1 | 1 | 0 | 42 | -1.60 | W | +0.4u |
...
| 2026-05-30 | MLB | SPREAD | home | 5.0 | 1.65 | -120 | 2 | 1 | 3 | 2 | -26 | -0.60 | W | +1.4u |
| 2026-05-30 | MLB | ML | away | 5.0 | 2.50 | +108 | 1 | 0 | 1 | 3 | -48 | -0.90 | W | +2.7u |
| 2026-05-30 | MLB | ML | home | 4.0 | 0.50 | +110 | 1 | 0 | 1 | 1 | -19 | -0.20 | W | +0.6u |
| 2026-05-30 | MLB | ML | home | 5.0 | 1.25 | -102 | 2 | 0 | 2 | 2 | 16 | -0.70 | W | +1.2u |
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -122 | 1 | 1 | 2 | 2 | -29 | -0.20 | L | -3.8u |
| 2026-05-30 | MLB | TOTAL | under | 3.0 | 0.75 | -108 | 0 | 0 | 0 | 1 | -7 | 0.00 | L | -0.8u |
...
| 2026-05-31 | MLB | TOTAL | under | 5.0 | 1.65 | -114 | 2 | 0 | 2 | 3 | -17 | 0.00 | L | -1.6u |
| 2026-05-31 | MLB | ML | home | 2.5 | 2.75 | -115 | 1 | 1 | 2 | 1 | 15 | 0.00 | W | +2.4u |
| 2026-05-31 | MLB | ML | away | 5.0 | 1.00 | +115 | -1 | 0 | -1 | 2 | -29 | -0.60 | L | -1.0u |
| 2026-05-31 | MLB | SPREAD | away | 5.0 | 1.00 | -117 | 3 | 1 | 4 | 3 | -23 | -0.20 | L | -1.0u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -164 | 0 | 1 | 1 | 2 | -29 | -1.20 | W | +2.3u |
| 2026-05-31 | MLB | ML | away | 3.0 | 1.25 | -184 | 0 | 0 | 0 | 0 | -15 | -1.70 | W | +0.7u |
| 2026-05-31 | MLB | ML | home | 2.5 | 1.25 | -232 | 0 | 0 | 0 | 1 | 29 | -0.50 | W | +0.5u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -102 | 0 | 1 | 1 | 2 | -69 | 0.20 | W | +4.9u |
| 2026-05-31 | MLB | TOTAL | over | 4.0 | 1.00 | +101 | 2 | 1 | 3 | 2 | -14 | 0.00 | L | -1.0u |
| 2026-05-31 | MLB | ML | away | 4.5 | 2.50 | +110 | 0 | 0 | 0 | 0 | -15 | -1.10 | L | -2.5u |
| 2026-06-01 | MLB | ML | home | 4.5 | 3.00 | -155 | 3 | 2 | 5 | 3 | 28 | -1.00 | W | +2.1u |
| 2026-06-01 | MLB | ML | away | 4.0 | 1.00 | +135 | 2 | 2 | 4 | 3 | 46 | -0.20 | W | +1.4u |
| 2026-06-01 | MLB | ML | away | 5.0 | 2.50 | +160 | 2 | -1 | 1 | 2 | 41 | -1.30 | W | +2.7u |
| 2026-06-01 | MLB | TOTAL | under | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 2 | -33 | 0.00 | L | -1.0u |
| 2026-06-01 | MLB | ML | home | 3.0 | 0.50 | -142 | -1 | 0 | -1 | 0 | 42 | -0.40 | L | -0.5u |
...
| 2026-06-02 | MLB | ML | home | 2.5 | 0.25 | -215 | -1 | 0 | -1 | 0 | 6 | -1.40 | L | -0.3u |
| 2026-06-02 | MLB | TOTAL | under | 4.0 | 1.00 | -117 | 1 | 0 | 1 | 0 | 16 | 0.00 | L | -1.0u |
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +130 | 2 | 0 | 2 | 0 | 77 | -0.60 | W | +3.1u |
| 2026-06-02 | MLB | ML | away | 3.0 | 0.50 | +100 | 1 | 0 | 1 | 2 | 28 | -1.20 | W | +0.5u |
| 2026-06-02 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 13 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 13 | 0.00 | L | -3.0u |
| 2026-06-02 | MLB | ML | home | 4.0 | 1.00 | -112 | 1 | 0 | 1 | 1 | 35 | -1.10 | L | -1.0u |
| 2026-06-02 | MLB | ML | home | 4.0 | 1.00 | -106 | 1 | 0 | 1 | 1 | 35 | -0.50 | L | -1.0u |
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +102 | 0 | -1 | -1 | 0 | -2 | 0.00 | L | -2.5u |
| 2026-06-02 | NHL | TOTAL | over | 5.0 | 5.00 | -110 | 2 | 2 | 4 | 2 | 10 | 0.00 | W | +4.3u |
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -150 | 3 | 1 | 4 | 5 | 3 | -1.30 | W | +0.3u |
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +134 | -1 | -1 | -2 | -1 | 64 | -1.00 | W | +1.2u |
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +125 | 0 | -1 | -1 | 0 | 73 | 0.40 | W | +1.3u |
| 2026-06-03 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 28 | 0.00 | L | -3.0u |
| 2026-06-03 | MLB | ML | home | 4.5 | 1.50 | +167 | 0 | 0 | 0 | -1 | 42 | -0.40 | L | -1.5u |
| 2026-06-03 | MLB | SPREAD | away | 4.0 | 1.00 | -111 | 1 | 0 | 1 | 0 | 12 | 0.20 | W | +0.8u |
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -103 | 3 | 1 | 4 | 2 | 13 | -1.20 | L | -0.5u |
| 2026-06-03 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 1 | 0.00 | L | -5.0u |
| 2026-06-03 | MLB | ML | away | 3.0 | 0.50 | +119 | 1 | 0 | 1 | 1 | 35 | 0.00 | W | +0.6u |
| 2026-06-03 | MLB | ML | away | 4.5 | 3.00 | -137 | 0 | 0 | 0 | -1 | 61 | -1.50 | L | -3.0u |
| 2026-06-03 | MLB | ML | home | 5.0 | 5.00 | -215 | 0 | 1 | 1 | 0 | 57 | -1.00 | W | +2.3u |
| 2026-06-03 | MLB | TOTAL | over | 2.5 | 0.25 | -110 | 1 | 1 | 2 | 1 | -13 | 0.00 | L | -0.3u |
| 2026-06-03 | MLB | TOTAL | under | 4.5 | 2.50 | -110 | 1 | 0 | 1 | 0 | 16 | 0.00 | W | +2.5u |
| 2026-06-03 | MLB | ML | home | 4.5 | 3.00 | -112 | 0 | 0 | 0 | 1 | 35 | -0.90 | W | +2.7u |
| 2026-06-03 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 1 | 1 | 0.00 | W | +4.5u |
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -139 | 0 | 0 | 0 | 0 | 77 | -1.20 | W | +0.3u |
| 2026-06-03 | MLB | TOTAL | under | 4.5 | 2.50 | -110 | 1 | 0 | 1 | 0 | 16 | 0.00 | L | -2.5u |
| 2026-06-03 | NBA | ML | home | 2.5 | 0.25 | -198 | 3 | 4 | 7 | 5 | 14 | -1.20 | L | -0.3u |
| 2026-06-03 | NBA | SPREAD | away | 2.5 | 0.25 | -104 | 3 | -1 | 2 | 3 | -1 | -1.20 | W | +0.2u |
| 2026-06-04 | MLB | ML | away | 3.0 | 0.50 | +104 | 1 | 0 | 1 | 1 | 35 | 0.00 | W | +0.5u |
| 2026-06-04 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | -1 | 0 | 1 | 13 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | +102 | 0 | 0 | 0 | 1 | 35 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 5.0 | 2.50 | +118 | 1 | 1 | 2 | 1 | 70 | -0.40 | W | +3.0u |
| 2026-06-04 | MLB | SPREAD | away | 5.0 | 5.00 | -111 | 0 | 0 | 0 | 1 | 5 | 0.00 | L | -5.0u |
| 2026-06-04 | MLB | ML | home | 5.0 | 5.00 | -131 | 1 | 0 | 1 | 1 | 70 | 0.20 | W | +3.5u |
| 2026-06-04 | MLB | ML | away | 2.5 | 0.25 | +105 | 0 | 0 | 0 | 0 | -32 | -1.00 | W | +0.2u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -210 | 1 | 0 | 1 | 2 | 59 | -1.00 | W | +0.5u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -188 | 0 | 0 | 0 | 0 | 42 | -1.10 | L | -1.0u |
| 2026-06-04 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 13 | 0.00 | W | +2.7u |
| 2026-06-04 | MLB | ML | home | 3.0 | 0.50 | -235 | 4 | 0 | 4 | 4 | 7 | 0.00 | L | -0.5u |
| 2026-06-04 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 0 | 20 | 0.00 | L | -5.0u |
| 2026-06-04 | NHL | ML | home | 2.5 | 0.25 | -160 | -3 | 0 | -3 | 2 | 6 | -0.40 | W | +0.2u |
| 2026-06-05 | MLB | ML | home | 2.5 | 0.25 | -144 | 1 | 1 | 2 | 0 | 41 | -1.20 | L | -0.3u |
| 2026-06-05 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | -1 | 35 | 0.00 | W | +2.8u |
| 2026-06-05 | MLB | ML | away | 3.0 | 0.50 | +128 | 1 | 0 | 1 | 1 | 5 | 0.00 | W | +0.6u |
| 2026-06-05 | MLB | TOTAL | over | 4.0 | 1.00 | -109 | 0 | 0 | 0 | 0 | 16 | 0.00 | P | +0.0u |
| 2026-06-05 | MLB | ML | home | 3.0 | 0.50 | -136 | 1 | 0 | 1 | 2 | 35 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 3 | 0 | 3 | 4 | -12 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | ML | away | 5.0 | 5.00 | -122 | 0 | 1 | 1 | 1 | 28 | -0.80 | L | -5.0u |
| 2026-06-05 | MLB | ML | home | 5.0 | 5.00 | -171 | 0 | 2 | 2 | 3 | 41 | -0.20 | W | +2.7u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -188 | 2 | 0 | 2 | 2 | 28 | -0.90 | W | +0.5u |
| 2026-06-05 | MLB | ML | away | 4.0 | 1.00 | -105 | 1 | 0 | 1 | 1 | 35 | 0.00 | L | -1.0u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -141 | 3 | 2 | 5 | 3 | 18 | 0.30 | W | +0.7u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 2.50 | -110 | 0 | 1 | 1 | -1 | 42 | 0.00 | W | +2.5u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -172 | 1 | 0 | 1 | 1 | 35 | 0.00 | L | -1.0u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 0 | -1 | -1 | 0 | 16 | 0.00 | W | +4.4u |
| 2026-06-05 | MLB | ML | away | 4.5 | 3.00 | -129 | -1 | 1 | 0 | -2 | 41 | -1.10 | W | +2.2u |
...
| 2026-06-06 | MLB | ML | home | 4.5 | 3.00 | -126 | 0 | 0 | 0 | 0 | 42 | -1.00 | W | +2.4u |
| 2026-06-06 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -14 | 0.00 | W | +2.7u |
| 2026-06-06 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 1 | 1 | -1 | 26 | 0.00 | L | -1.0u |
| 2026-06-06 | MLB | ML | home | 3.0 | 0.50 | -130 | 0 | 0 | 0 | -1 | 7 | -0.90 | L | -0.5u |
| 2026-06-06 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 3 | 0.00 | L | -5.0u |
| 2026-06-06 | MLB | ML | home | 4.5 | 3.00 | -350 | 0 | 1 | 1 | 0 | 57 | -0.90 | W | +0.9u |
| 2026-06-06 | MLB | TOTAL | under | 5.0 | 2.50 | -110 | 0 | 0 | 0 | 0 | 20 | 0.00 | L | -2.5u |
| 2026-06-06 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 3 | 1 | 4 | 3 | -16 | 0.00 | W | +2.8u |
| 2026-06-06 | MLB | ML | home | 5.0 | 5.00 | -123 | 0 | 0 | 0 | 1 | 3 | 0.00 | W | +4.1u |
| 2026-06-06 | MLB | TOTAL | under | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 0 | 0.00 | L | -1.0u |
| 2026-06-06 | MLB | ML | home | 5.0 | 2.50 | +117 | -2 | -1 | -3 | -1 | 4 | 0.00 | L | -2.5u |
| 2026-06-06 | MLB | ML | home | 5.0 | 5.00 | -154 | 2 | 1 | 3 | 0 | 77 | -0.80 | L | -5.0u |
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -130 | 1 | 0 | 1 | 0 | 57 | -0.90 | W | +2.2u |
| 2026-06-07 | MLB | TOTAL | over | 3.0 | 0.50 | -112 | 0 | 0 | 0 | 3 | -3 | 0.00 | L | -0.5u |
| 2026-06-07 | MLB | ML | home | 5.0 | 5.00 | -143 | 1 | 0 | 1 | 1 | 5 | 0.00 | W | +3.5u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -14 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -136 | 1 | 0 | 1 | 0 | 57 | 0.00 | W | +0.7u |
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -165 | 2 | 2 | 4 | 3 | 6 | -1.10 | W | +1.8u |
| 2026-06-07 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 1 | 1 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | -107 | 1 | 0 | 1 | -1 | 72 | -0.80 | W | +0.2u |
| 2026-06-07 | MLB | TOTAL | over | 2.5 | 0.25 | -115 | 0 | 0 | 0 | -1 | 0 | 0.00 | W | +0.2u |
| 2026-06-07 | MLB | ML | home | 2.5 | 0.25 | -210 | -1 | 0 | -1 | 1 | 29 | 0.80 | L | -0.3u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -1 | 0.00 | L | -0.5u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | +158 | 1 | 0 | 1 | 3 | 25 | -1.30 | L | -0.5u |
| 2026-06-07 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +0.9u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -105 | 1 | 0 | 1 | 1 | 35 | 0.00 | L | -1.0u |
...
| 2026-06-07 | MLB | TOTAL | over | 5.0 | 2.25 | -114 | 1 | 1 | 2 | 1 | -17 | 0.00 | L | -2.3u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | +102 | 1 | 0 | 1 | -2 | 30 | -0.20 | W | +0.5u |
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 2.25 | +164 | 1 | 1 | 2 | 1 | -7 | 29.50 | W | +3.7u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | +103 | -1 | 0 | -1 | -2 | -7 | 0.20 | W | +0.3u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | -1 | 0 | 1 | 13 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -102 | 2 | 0 | 2 | 0 | 42 | 0.50 | W | +1.0u |
| 2026-06-07 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 18 | 0.00 | W | +4.8u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | -127 | 0 | 1 | 1 | -1 | 72 | -1.90 | W | +0.4u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -1 | 0.00 | W | +0.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -113 | 6 | 1 | 7 | 5 | 34 | -0.50 | L | -3.0u |
| 2026-06-08 | MLB | ML | home | 4.5 | 3.00 | -129 | 3 | 0 | 3 | 1 | 76 | -0.40 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 0 | 10 | 0.00 | L | -3.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -121 | 1 | 1 | 2 | 1 | 47 | -1.60 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 13 | 0.00 | P | +0.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -146 | 1 | 0 | 1 | 1 | 51 | -0.50 | W | +2.0u |
| 2026-06-08 | MLB | ML | home | 4.0 | 1.00 | -118 | 2 | 0 | 2 | 3 | -20 | -0.40 | L | -1.0u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 2.50 | -116 | -2 | -2 | -4 | -1 | 38 | 0.00 | W | +2.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 1.50 | +151 | 0 | -1 | -1 | 1 | 3 | 0.00 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 5.0 | 2.50 | +101 | 0 | 0 | 0 | 0 | 13 | 0.00 | W | +2.5u |
