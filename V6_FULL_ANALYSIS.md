...
_Auto-generated **6/6/2026, 10:23:02 AM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 482 shipped+graded picks · 2026-04-18 → 2026-06-05  (HC analyses scoped to post-cutover 2026-04-30, 370 picks)
**Headline:** 242-236-4 · WR 50.6% [46.2%–55.1%] vs 52.4% break-even · -14.5u flat (-3.0%) · -61.0u peak.
**Overall t-test:** t = -0.66 → ✗ noise.
...
- **ρ(Δw, flat ROI) = 0.017 ✗**  (full sample, N=476)
- **ρ(HC, flat ROI) = -0.032 ✗**  (post-cutover, N=370)
- **ρ(Δw+HC, flat ROI) = -0.071 ✗**  (post-cutover, N=370)
...
- **Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era)** — N=69, 29-40, WR 42.0% [31%–54%], flat ROI -21.2% (t=-1.85 ~ p<.10)

### Action map

- **Tier-1a (HC ≥ +2)** — N=37, WR 43.2%, flat ROI -19.7%. Bayesian posterior WR ≈ 44.7%, half-Kelly = **0.0%** bankroll at −110 → **size aggressively**.
- **Tier-1b (HC = +1)** — N=135, WR 55.6%, flat ROI +7.2%. Bayesian posterior WR ≈ 55.2%, half-Kelly = **2.9%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=69, WR 42.0%, flat ROI -21.2%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=91, WR 47.3%, flat ROI -4.0%. Bayesian posterior WR ≈ 47.5%, half-Kelly = **0.0%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -14.0% flat ROI on 108 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (0.99u/pick), we need **~1518 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 482. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **482** |
| W-L-P | 242-236-4 |
| Win rate | **50.6%** [46.2%–55.1%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +1.8 pp |
| Peak-units PnL | **-61.0u** |
| Flat-1u PnL | **-14.5u** (-3.0% flat ROI) |
| Flat t-statistic vs zero | -0.66 → ✗ noise |
| Flat 95% CI per-pick | [-0.119, 0.059]u |
...
We have **482** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = −1 | 16 | 4-12-0 | 25.0% [10–49] | -52.2% | -5.5u | -2.39 ✓ p<.05 |
| Δw = 0 | 89 | 44-42-3 | 51.2% [41–61] | -6.0% | -3.1u | -0.62 ✗ noise |
| Δw = +1 | 164 | 93-70-1 | 57.1% [49–64] | +7.3% | +9.2u | 0.99 ✗ noise |
| Δw = +2 | 113 | 53-60-0 | 46.9% [38–56] | -7.6% | -30.0u | -0.80 ✗ noise |
| Δw ≥ +3 | 91 | 43-48-0 | 47.3% [37–57] | -4.0% | -32.4u | -0.33 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.001** ✗  ·  **ρ(Δw, flat ROI) = 0.017** ✗  (N=476)
...
|---|---|---|---|---|---|---|
| HC ≤ −2 | 0 | — | — | — | — | — |
| HC = −1 | 16 | 8-8-0 | 50.0% [28–72] | +5.1% | +4.8u | 0.19 ✗ noise |
| HC = 0 | 182 | 92-87-3 | 51.4% [44–59] | -4.9% | -32.2u | -0.71 ✗ noise |
| HC = +1 | 135 | 75-60-0 | 55.6% [47–64] | +7.2% | -1.1u | 0.85 ✗ noise |
| HC = +2 | 27 | 13-14-0 | 48.1% [31–66] | -6.1% | -13.0u | -0.31 ✗ noise |
| HC ≥ +3 | 10 | 3-7-0 | 30.0% [11–60] | -56.7% | -8.8u | -2.57 ✓ p<.05 |

**Pearson ρ(HC, WIN) = -0.018** ✗  ·  **ρ(HC, flat ROI) = -0.032** ✗  (N=370)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 58 | 27-29-2 | 48.2% [36–61] | -11.4% | -6.5u | -0.94 ✗ noise |
| Σ = +1 | 99 | 59-39-1 | 60.2% [50–69] | +14.0% | +14.3u | 1.47 ✗ noise |
| Σ = +2 | 96 | 56-40-0 | 58.3% [48–68] | +8.7% | +8.1u | 0.90 ✗ noise |
| Σ = +3 | 49 | 18-31-0 | 36.7% [25–51] | -26.9% | -24.4u | -1.89 ~ p<.10 |
| Σ = +4 | 35 | 18-17-0 | 51.4% [36–67] | +2.2% | -13.8u | 0.13 ✗ noise |
| Σ = +5 | 15 | 6-9-0 | 40.0% [20–64] | -24.2% | -12.1u | -0.97 ✗ noise |
| Σ ≥ +6 | 18 | 7-11-0 | 38.9% [20–61] | -29.2% | -15.9u | -1.32 ✗ noise |

**Pearson ρ(Δw+HC, WIN) = -0.067** ✗  ·  **ρ(Σ, flat ROI) = -0.071** ✗  (N=370)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 370.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.079 ✗ | -0.075 ✗ | -0.060 | weak |
| HC margin | -0.018 ✗ | -0.032 ✗ | 0.001 | weak |
| Δw + HC | -0.067 ✗ | -0.071 ✗ | -0.049 | weak |
| peak.stars | -0.076 ✗ | -0.104 ✓ p<.05 | -0.123 | weak |
| vault.star | -0.044 ✗ | -0.068 ✗ | -0.110 | weak |
| lock.stars | -0.042 ✗ | -0.067 ✗ | -0.075 | weak |
...
Universe N = 370 (post-cutover, both axes present).

| HC \ Δw | ≤ −3 | -2 | -1 | +0 | +1 | +2 | ≥ +3 |
|---|---|---|---|---|---|---|---|
| ≤ −3 | — | — | — | — | — | — | — |
| -2 | — | — | — | — | — | — | — |
| -1 | — | — | N=2 · 1-1 · 50% [9–91] · —  | N=4 · 3-1 · 75% [30–95] · +52%  | N=4 · 0-4 · 0% [0–49] · -100%  | N=2 · 2-0 · 100% [34–100] · — ★ | N=4 · 2-2 · 50% [15–85] · -1%  |
| +0 | N=1 · 1-0 · 100% [21–100] · —  | N=1 · 0-1 · 0% [0–79] · —  | N=4 · 1-3 · 25% [5–70] · -63%  | N=38 · 20-16 · 56% [40–70] · +0%  | N=75 · 45-29 · 61% [49–71] · +15%  | N=42 · 21-21 · 50% [36–64] · -8%  | N=21 · 4-17 · 19% [8–40] · -65% ✗ |
| +1 | — | — | N=4 · 1-3 · 25% [5–70] · -56%  | N=22 · 12-10 · 55% [35–73] · +2%  | N=49 · 32-17 · 65% [51–77] · +23%  | N=31 · 14-17 · 45% [29–62] · -7%  | N=29 · 16-13 · 55% [38–72] · +9%  |
| +2 | — | — | — | N=1 · 1-0 · 100% [21–100] · —  | N=3 · 1-2 · 33% [6–79] · -40%  | N=10 · 4-6 · 40% [17–69] · -14%  | N=13 · 7-6 · 54% [29–77] · +3%  |
...
| Δw = −1 | 10 | 3-7-0 | 30.0% [11–60] | -44.1% | -1.0u | -1.51 ✗ noise |
| Δw = 0 | 66 | 37-27-2 | 57.8% [46–69] | +5.6% | +10.3u | 0.50 ✗ noise |
| Δw = +1 | 131 | 78-52-1 | 60.0% [51–68] | +12.8% | +13.7u | 1.56 ✗ noise |
| Δw = +2 | 88 | 42-46-0 | 47.7% [38–58] | -6.6% | -26.2u | -0.62 ✗ noise |
| Δw ≥ +3 | 73 | 30-43-0 | 41.1% [31–53] | -21.2% | -44.5u | -1.88 ~ p<.10 |

### §3d. Practical lock zones (v7.4 floor anatomy)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 172 | 91-81-0 | 52.9% [45–60] | +1.4% | -22.9u | 0.19 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 69 | 29-40-0 | 42.0% [31–54] | -21.2% | -28.5u | -1.85 ~ p<.10 |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 129 | 71-55-3 | 56.3% [48–65] | +5.1% | +1.1u | 0.62 ✗ noise |
...
Universe N = 455 picks where ≥1 proven wallet appeared on either side.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δcount ≤ −2 (heavy oppose) | 3 | 3-0-0 | 100.0% [44–100] | +79.6% | +3.2u | 13.26 ✓ p<.01 |
| Δcount = −1 | 23 | 8-15-0 | 34.8% [19–55] | -28.4% | -13.2u | -1.35 ✗ noise |
| Δcount = 0 (balanced) | 55 | 23-30-2 | 43.4% [31–57] | -16.3% | -7.5u | -1.26 ✗ noise |
| Δcount = +1 | 181 | 90-90-1 | 50.0% [43–57] | -6.7% | -44.3u | -0.95 ✗ noise |
| Δcount = +2 | 112 | 55-56-1 | 49.5% [40–59] | -6.4% | -16.5u | -0.70 ✗ noise |
| Δcount ≥ +3 (heavy support) | 81 | 54-27-0 | 66.7% [56–76] | +35.1% | +33.8u | 2.86 ✓ p<.01 |

**ρ(Δcount, WIN) = 0.119** ✓ p<.05  ·  **ρ(Δcount, flat ROI) = 0.140** ✓ p<.01
...
Quintile cuts: ≤ -18 · ≤ -1 · ≤ 6 · ≤ 18 · > 18

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 105 | 47-58-0 | 44.8% [36–54] | -13.3% | -39.9u | -1.39 ✗ noise |
| Q2 | 84 | 29-53-2 | 35.4% [26–46] | -29.6% | -37.9u | -2.86 ✓ p<.01 |
| Q3 (balanced) | 94 | 52-42-0 | 55.3% [45–65] | +4.8% | -26.7u | 0.48 ✗ noise |
| Q4 | 82 | 47-33-2 | 58.8% [48–69] | +16.0% | +22.0u | 1.35 ✗ noise |
| Q5 (best — heavy support) | 90 | 58-32-0 | 64.4% [54–74] | +19.3% | +37.9u | 1.92 ~ p<.10 |

**ρ(ΔWlNet, WIN) = 0.189** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.172** ✓ p<.01
...
Quintile cuts (units): ≤ -17.88 · ≤ -2.86 · ≤ 3.52 · ≤ 10.81 · > 10.81

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 99 | 41-58-0 | 41.4% [32–51] | -22.3% | -55.9u | -2.37 ✓ p<.05 |
| Q2 | 84 | 38-45-1 | 45.8% [35–56] | -12.4% | -17.7u | -1.17 ✗ noise |
| Q3 | 91 | 46-44-1 | 51.1% [41–61] | -2.1% | -4.3u | -0.21 ✗ noise |
| Q4 | 93 | 51-42-0 | 54.8% [45–65] | +1.7% | -8.4u | 0.17 ✗ noise |
| Q5 | 88 | 57-29-2 | 66.3% [56–75] | +32.9% | +41.8u | 2.86 ✓ p<.01 |

**ρ(ΔFlatPnl, WIN) = 0.184** ✓ p<.01  ·  **ρ(ΔFlatPnl, flat ROI) = 0.206** ✓ p<.01
...
Quintile cuts (% ROI): ≤ -9.6 · ≤ -3.1 · ≤ 6.6 · ≤ 19.8 · > 19.8

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 116 | 36-78-2 | 31.6% [24–41] | -36.2% | -66.6u | -4.07 ✓ p<.01 |
| Q2 | 67 | 32-35-0 | 47.8% [36–60] | -11.4% | -20.7u | -0.98 ✗ noise |
| Q3 | 113 | 61-52-0 | 54.0% [45–63] | -0.7% | -14.0u | -0.08 ✗ noise |
| Q4 | 69 | 38-29-2 | 56.7% [45–68] | +6.3% | +13.0u | 0.55 ✗ noise |
| Q5 | 90 | 66-24-0 | 73.3% [63–81] | +46.9% | +43.8u | 4.43 ✓ p<.01 |

**ρ(ΔAvgRoi, WIN) = 0.309** ✓ p<.01  ·  **ρ(ΔAvgRoi, flat ROI) = 0.320** ✓ p<.01
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 46 | 11-34-1 | 24.4% [14–39] | -49.8% | -33.3u | -3.84 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 16 | 4-12-0 | 25.0% [10–49] | -49.0% | -19.1u | -2.09 ✓ p<.05 |
| ΔBestRank = 0 (tied) | 2 | 1-1-0 | 50.0% [9–91] | -4.5% | -1.4u | -0.05 ✗ noise |
| ΔBestRank ∈ [+1,+4] | 19 | 8-11-0 | 42.1% [23–64] | -8.3% | -2.3u | -0.30 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 98 | 60-36-2 | 62.5% [53–72] | +24.5% | +18.0u | 2.27 ✓ p<.05 |

**ρ(ΔBestRank, WIN) = 0.374** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.404** ✓ p<.01  (N=181)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 24 | 5-19-0 | 20.8% [9–40] | -55.8% | -14.3u | -2.78 ✓ p<.01 |
| Δshare ∈ [−30,−10] pp | 3 | 1-2-0 | 33.3% [6–79] | -11.7% | -4.5u | -0.13 ✗ noise |
| Δshare ≈ 0 (±10 pp) | 344 | 173-168-3 | 50.7% [45–56] | -4.3% | -56.9u | -0.84 ✗ noise |
| Δshare ∈ [+10,+30] pp | 16 | 11-4-1 | 73.3% [48–89] | +42.2% | +6.5u | 1.82 ~ p<.10 |
| Δshare ≥ +30 pp | 68 | 43-25-0 | 63.2% [51–74] | +26.3% | +24.6u | 1.97 ✓ p<.05 |

**ρ(ΔTopQShare, WIN) = 0.165** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.157** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔAvgRoi** | 0.309 ✓ p<.01 | 0.320 ✓ p<.01 | 0.279 |
| 2 | **ΔTopQCount** | 0.196 ✓ p<.01 | 0.229 ✓ p<.01 | 0.184 |
| 3 | **ΔFlatPnl** | 0.184 ✓ p<.01 | 0.206 ✓ p<.01 | 0.176 |
| 4 | **ΔWlNet** | 0.189 ✓ p<.01 | 0.172 ✓ p<.01 | 0.143 |
| 5 | **ΔTopQShare** | 0.165 ✓ p<.01 | 0.157 ✓ p<.01 | 0.165 |
| 6 | **Δcount** | 0.119 ✓ p<.05 | 0.140 ✓ p<.01 | 0.118 |

_(ΔBestRank uses N=181 subset where both sides had a proven wallet — ρ(flat ROI) = 0.404 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 842, dateRange = 2026-04-18 → 2026-06-05, computedAt = 2026-06-06T14:20:30.777Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **455** rows · PIT aggregate computable on **453** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **453** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 313 · 55% · +5.2% | 271 · 53% · -1.5% | -6.8pp |
| WEAK (−3..0) | 123 · 44% · -15.0% | 165 · 51% · +1.3% | +16.2pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=235, WR=58%, ROI=+9.7% | N=206, WR=51%, ROI=-3.9% | -13.6pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=313, WR=55%, ROI=+5.2% | N=271, WR=53%, ROI=-1.5% | -6.8pp |
| AGS < −1 (mute veto) | N=41, WR=41%, ROI=-18.7% | N=87, WR=45%, ROI=-6.3% | +12.4pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-05-23 → 2026-06-05, N=219)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 120 · 58% · +6.4% |
| WEAK (−3..0) | 99 · 49% · -4.9% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=81, WR=57%, ROI=+3.8% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=120, WR=58%, ROI=+6.4% |
| AGS < −1 (mute veto) | N=52, WR=43%, ROI=-15.3% |
...
|---|---|---|---|---|
| `dCount` | COUNT | + | 1.07 | 1.52 |
| `dHcSizeRatio` | INTENSITY_HC | + | 1.13 | 4.72 |
| `dSumRankNorm` | QUALITY_RANK | − | 57.06 | 87.51 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.53 | 1.20 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **453/482** shipped+graded rows (94%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 76 | 39-37-0 | 51.3% [40–62] | -6.0% | -16.0u | -0.55 ✗ noise |
| LOCK | 85 | 37-48-0 | 43.5% [33–54] | -17.6% | -33.2u | -1.68 ~ p<.10 |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 64 | 33-30-1 | 52.4% [40–64] | +0.4% | +6.6u | 0.03 ✗ noise |
| FADE | 92 | 39-50-3 | 43.8% [34–54] | -9.2% | -36.2u | -0.80 ✗ noise |
...
r(WIN) = **0.003** ✗ · r(ROI) = **-0.033** ✗ · Spearman ρ(ROI) = **-0.034**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 76 | 38-36-2 | 51.4% [40–62] | +5.2% | -19.6u | 0.40 ✗ noise |
| z ∈ [−1, 0) | 161 | 87-72-2 | 54.7% [47–62] | +2.9% | +13.8u | 0.39 ✗ noise |
| z ∈ [0, +1) | 140 | 64-76-0 | 45.7% [38–54] | -13.0% | -46.7u | -1.59 ✗ noise |
...
| z ∈ [0, +1) | 419 | 213-202-4 | 51.3% [47–56] | -2.9% | -53.2u | -0.63 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.039** ✗ · r(ROI) = **-0.049** ✗ · Spearman ρ(ROI) = **-0.050**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 80 | 43-36-1 | 54.4% [43–65] | -1.5% | -8.8u | -0.15 ✗ noise |
| z ∈ [−1, 0) | 140 | 77-61-2 | 55.8% [47–64] | +9.8% | +8.4u | 1.11 ✗ noise |
| z ∈ [0, +1) | 177 | 81-95-1 | 46.0% [39–53] | -11.1% | -53.7u | -1.51 ✗ noise |
| z ≥ +1 (very positive) | 56 | 27-29-0 | 48.2% [36–61] | -11.3% | -2.1u | -0.89 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.039 ✗ | -0.049 ✗ | -0.050 |
| 2 | `dCount` | COUNT | 0.003 ✗ | -0.033 ✗ | -0.034 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | +0.043 | 0.788 | 48.8% | meaningful |
| 2 | `dSumRankNorm` | -0.024 | 0.777 | 48.1% | meaningful |
| 3 | `dWinnerCtPreA` | -0.033 | 0.033 | 2.1% | silent (<0.2) |
| 4 | `dHcSizeRatio` | -0.018 | 0.018 | 1.1% | silent (<0.2) |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.074 | +0.709 ⚠ | +0.074 |
| `dHcSizeRatio` | +0.074 | 1.000 | +0.048 | +1.000 ⚠ |
| `dSumRankNorm` | +0.709 ⚠ | +0.048 | 1.000 | +0.048 |
| `dWinnerCtPreA` | +0.074 | +1.000 ⚠ | +0.048 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **-0.010**. At AGS ≥ +0.12 fires N=217, WR=50.2%, ROI=-6.2%. At AGS ≥ +null fires N=283, WR=51.6%, ROI=-3.7%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-217 ROI (matched cohort) | Top-217 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.052 | +0.041 | WR=55%, ROI=+5.7% | -11.9pp | N=209, WR=55%, ROI=+5.6% |
| `dHcSizeRatio` | +0.031 | +0.020 | WR=54%, ROI=+1.2% | -7.4pp | N=216, WR=54%, ROI=+0.8% |
| `dSumRankNorm` | -0.035 | +0.025 | WR=48%, ROI=-9.5% | +3.3pp | N=224, WR=48%, ROI=-9.8% |
| `dWinnerCtPreA` | +0.033 | +0.023 | WR=55%, ROI=+1.9% | -8.1pp | N=206, WR=54%, ROI=-0.0% |
...
|---|---|---|---|---|
| 1 | `dHcSizeRatio` | +0.020 | -7.4pp | redundant — other features cover it |
| 2 | `dWinnerCtPreA` | +0.023 | -8.1pp | redundant — other features cover it |
| 3 | `dSumRankNorm` | +0.025 | +3.3pp | redundant — other features cover it |
| 4 | `dCount` | +0.041 | -11.9pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.110 | 0.110 | negative ↓ |
...
Intercept b = +0.010 · Final log-loss = 0.6915 · N = 453.
...
- **Redundant pairs (|r| ≥ 0.7)**: `dCount` ↔ `dSumRankNorm` (r=+0.71); `dHcSizeRatio` ↔ `dWinnerCtPreA` (r=+1.00). Each pair effectively double-counts the same signal in the composite.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 453 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/453 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 167 | 77-90-0 | 46.1% [39–54] | -16.0% | -70.7u | -2.22 ✓ p<.05 |
| 4.5★ | 53 | 34-19-0 | 64.2% [51–76] | +21.0% | +19.9u | 1.58 ✗ noise |
| 4.0★ | 93 | 44-47-2 | 48.4% [38–58] | -6.7% | -6.4u | -0.66 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 64 | 34-29-1 | 54.0% [42–66] | +7.3% | -1.8u | 0.57 ✗ noise |
| 2.5★ | 67 | 34-32-1 | 51.5% [40–63] | -1.0% | -5.9u | -0.08 ✗ noise |

### §5b. Stars × Δw stratified — does the star tier hold up within each Δw cohort?

| Δw cohort | 5★ | 4.5★ | 4★ | 3.5★ | 3★ | 2.5★ |
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 22/59%/+0% | 11/55%/-3% | 18/35%/-31% | 6/33%/-26% | 23/36%/-32% | 27/50%/-4% |
| Δw = +1 | 25/52%/-6% | 19/68%/+22% | 42/51%/-2% | 28/54%/+4% | 23/70%/+37% | 26/54%/-1% |
| Δw = +2 | 57/44%/-16% | 12/58%/+13% | 27/52%/+2% | — | 9/44%/-3% | 8/38%/-16% |
| Δw ≥ +3 | 61/39%/-28% | 8/75%/+64% | 6/50%/-8% | 3/67%/+156% | 9/67%/+43% | 4/50%/+10% |
...
| −300/−201 | 20 | 13-7-0 | 65.0% [43–82] | -6.7% | +10.8u | -0.42 ✗ noise |
| −200/−151 | 47 | 25-22-0 | 53.2% [39–67] | -15.8% | -6.7u | -1.36 ✗ noise |
| −150/−101 | 281 | 139-140-2 | 49.8% [44–56] | -6.1% | -38.2u | -1.08 ✗ noise |
| −100/+100 | 5 | 2-3-0 | 40.0% [12–77] | -20.0% | -3.3u | -0.41 ✗ noise |
| +101/+150 | 102 | 49-51-2 | 49.0% [39–59] | +7.2% | -31.9u | 0.67 ✗ noise |
...
| −300/−201 | -14% (10) | +47% (2) | -4% (3) | -14% (5) |
| −200/−151 | -37% (15) | +26% (15) | +32% (6) | -84% (10) |
| −150/−101 | -9% (60) | +3% (102) | -23% (66) | -1% (50) |
| −100/+100 | -100% (1) | +33% (3) | -100% (1) | — |
| +101/+150 | +7% (19) | +8% (37) | +10% (30) | -0% (16) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 260 | 129-131-0 | 49.6% [44–56] | -3.8% | -54.0u | -0.59 ✗ noise |
| SPREAD | 82 | 38-43-1 | 46.9% [36–58] | -15.5% | -9.3u | -1.55 ✗ noise |
| TOTAL | 140 | 75-62-3 | 54.7% [46–63] | +5.8% | +2.3u | 0.72 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=61 · 43% · -23% | N=83 · 60% · +14% | N=56 · 46% · -5% | N=57 · 44% · -8% |
| SPREAD | N=21 · 35% · -38% | N=29 · 52% · -8% | N=16 · 63% · +12% | N=15 · 33% · -35% |
| TOTAL | N=26 · 67% · +27% | N=52 · 55% · +6% | N=41 · 41% · -19% | N=19 · 68% · +32% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 313 | 162-149-2 | 52.1% [47–58] | -1.4% | -24.9u | -0.26 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=72 · 51% · -5% | N=122 · 57% · +7% | N=79 · 47% · -8% | N=39 · 46% · -11% |
...
|---|---|---|
| **sharps3Plus** | 217 · 46% · -8.4% · -1.17 ✗ noise | 264 · 54% · +0.9% · 0.15 ✗ noise |
| **plusEV** | 57 · 47% · -7.4% · -0.49 ✗ noise | 424 · 51% · -2.7% · -0.58 ✗ noise |
| **pinnacleConfirms** | 121 · 53% · +3.3% · 0.34 ✗ noise | 215 · 50% · -5.4% · -0.81 ✗ noise |
| **invested10kPlus** | 237 · 49% · -5.5% · -0.82 ✗ noise | 99 · 56% · +5.5% · 0.57 ✗ noise |
| **lineMovingWith** | 241 · 54% · +4.1% · 0.64 ✗ noise | 240 · 47% · -10.7% · -1.70 ~ p<.10 |
| **predMarketAligns** | 122 · 53% · +3.4% · 0.35 ✗ noise | 214 · 50% · -5.5% · -0.82 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 108 | 56-52-0 | 51.9% [43–61] | -0.9% | -9.7u | -0.09 ✗ noise |
| 1 | 112 | 55-54-3 | 50.5% [41–60] | -5.7% | -27.6u | -0.64 ✗ noise |
| 2 | 120 | 59-60-1 | 49.6% [41–58] | -4.6% | -4.7u | -0.50 ✗ noise |
| 3 | 42 | 21-21-0 | 50.0% [36–64] | -3.1% | -5.9u | -0.20 ✗ noise |
| 4 | 40 | 20-20-0 | 50.0% [35–65] | -8.0% | -11.1u | -0.52 ✗ noise |
| 5 | 47 | 25-22-0 | 53.2% [39–67] | -1.4% | -5.5u | -0.10 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLEAR_MOVE | 104 | 59-44-1 | 57.3% [48–66] | +7.3% | +9.5u | 0.78 ✗ noise |
| NEAR_START | 192 | 90-99-3 | 47.6% [41–55] | -6.0% | -60.3u | -0.80 ✗ noise |
| NO_MOVE | 16 | 8-8-0 | 50.0% [28–72] | -8.3% | +4.5u | -0.35 ✗ noise |
| PREGAME | 64 | 35-29-0 | 54.7% [43–66] | +4.1% | -4.9u | 0.34 ✗ noise |
| SMALL_MOVE | 104 | 48-56-0 | 46.2% [37–56] | -13.5% | -12.2u | -1.43 ✗ noise |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 274 | 139-134-1 | 50.9% [45–57] | -4.5% | -53.4u | -0.78 ✗ noise |
| STRONG | 73 | 37-35-1 | 51.4% [40–63] | +2.7% | +1.4u | 0.23 ✗ noise |
| LEAN | 129 | 63-64-2 | 49.6% [41–58] | -3.8% | -10.4u | -0.41 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.100 ✓ p<.05 | -0.068 ✗ | -0.069 | -1.49 |
| totalInvested | -0.054 ✗ | -0.068 ✗ | -0.059 | -1.49 |
| evEdge | 0.070 ✗ | 0.049 ✗ | 0.049 | 1.08 |
| moneyPct | 0.044 ✗ | 0.017 ✗ | 0.017 | 0.38 |
| walletPct | 0.047 ✗ | 0.038 ✗ | 0.042 | 0.84 |
| criteriaMet | -0.001 ✗ | 0.015 ✗ | -0.015 | 0.32 |
| maxContribFor | -0.051 ✗ | -0.029 ✗ | -0.013 | -0.63 |
| meanBaseFor | -0.034 ✗ | 0.001 ✗ | 0.030 | 0.03 |
...
Sample with CLV: **471** picks. Mean CLV = **-0.0042**.
t-statistic vs zero: -3.36 → ✓ p<.01 · 95% CI [-0.0067, -0.0018]

Bucketed CLV vs flat PnL:

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLV ≤ −2% | 51 | 22-29-0 | 43.1% [31–57] | -26.2% | -22.1u | -2.16 ✓ p<.05 |
| CLV (−2%, 0] | 271 | 135-133-3 | 50.4% [44–56] | -3.5% | -43.8u | -0.59 ✗ noise |
| CLV (0, +2%] | 128 | 68-60-0 | 53.1% [45–62] | +7.1% | -1.4u | 0.75 ✗ noise |
| CLV > +2% | 21 | 11-9-1 | 55.0% [34–74] | -4.0% | +2.1u | -0.20 ✗ noise |

ρ(CLV, flat ROI) = 0.072 ✗
...
Trained on N=371 (with all features non-null). Intercept β₀ = 0.068.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | pw.ΔAvgRoi | +0.437 | ↑ helps |
| 2 | pw.Δcount | +0.287 | ↑ helps |
| 3 | sharpCount | -0.257 | ↓ hurts |
| 4 | peak.stars | -0.175 | ↓ hurts |
| 5 | evEdge | +0.168 | ↑ helps |
| 6 | log(impliedProb) | +0.165 | ↑ helps |
| 7 | pw.ΔFlatPnl | +0.160 | ↑ helps |
| 8 | Δw | -0.105 | ↓ hurts |
| 9 | pw.ΔWlNet | +0.102 | ↑ helps |
| 10 | HC margin | +0.097 | ↑ helps |
| 11 | criteriaMet | +0.059 | ↑ helps |
| 12 | walletPct | +0.059 | ↑ helps |
| 13 | log10(invested) | -0.049 | ≈ flat |
| 14 | odds (American) | -0.048 | ≈ flat |
| 15 | pw.ΔTopQShare | -0.048 | ≈ flat |
| 16 | vault.star | +0.040 | ≈ flat |
| 17 | Δw + HC | -0.036 | ≈ flat |
| 18 | moneyPct | +0.031 | ≈ flat |
...
|---|---|---|---|---|---|---|---|---|
| Tier-1a HC ≥ +2 (post-cutover) | 37 | 16-21 | 43.2% | 44.7% | -110 | — (mute) | 2.99u | **MUTE** (negative EV at posterior) |
| Tier-1b HC = +1 (post-cutover) | 135 | 75-60 | 55.6% | 55.2% | -110 | 2.93% bankroll | 2.03u | ~ in range — 2.93u |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 69 | 29-40 | 42.0% | 43.0% | -110 | — (mute) | 1.97u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 91 | 43-48 | 47.3% | 47.5% | -108 | — (mute) | 2.44u | **MUTE** (negative EV at posterior) |
| Stale Δw = 0 | 89 | 44-42 | 51.2% | 51.0% | -110 | — (mute) | 1.79u | **MUTE** (negative EV at posterior) |
| Stale Δw ≤ −1 | 19 | 5-14 | 26.3% | 34.5% | -142 | — (mute) | 1.30u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.214  (annualized × √252 ≈ -3.39)
...
| 2026-04-21 | MLB | ML | away | 3.0 | 1.50 | +100 | 1 | — | — | 1 | -2 | -0.50 | L | -1.5u |
...
| 2026-04-26 | MLB | ML | away | 3.5 | 0.75 | +108 | 1 | — | — | 1 | 9 | 0.50 | L | -0.8u |
...
| 2026-04-28 | MLB | ML | home | 3.5 | 0.75 | -118 | 1 | — | — | 1 | 9 | -0.80 | W | +0.6u |
...
| 2026-05-12 | MLB | ML | away | 5.0 | 4.50 | +108 | 4 | 0 | 4 | 2 | 6 | -0.20 | L | -4.5u |
...
| 2026-05-13 | MLB | SPREAD | home | 5.0 | 3.50 | -105 | 1 | 1 | 2 | 2 | -21 | 0.90 | W | +3.2u |
| 2026-05-13 | MLB | TOTAL | under | 4.0 | 0.96 | -110 | 1 | 1 | 2 | 2 | -18 | 0.00 | W | +0.9u |
| 2026-05-13 | MLB | TOTAL | under | 5.0 | 3.50 | -110 | 4 | 2 | 6 | 4 | -16 | 0.00 | L | -3.5u |
...
| 2026-05-14 | MLB | ML | home | 4.0 | 1.25 | +108 | 2 | 0 | 2 | 2 | 6 | -0.90 | L | -1.3u |
...
| 2026-05-16 | MLB | ML | away | 2.5 | 0.50 | -102 | 1 | 0 | 1 | 1 | -43 | 0.00 | W | +0.5u |
| 2026-05-17 | MLB | ML | away | 4.0 | 2.75 | -148 | 1 | 0 | 1 | 2 | 6 | -0.70 | W | +1.9u |
| 2026-05-17 | MLB | ML | away | 2.5 | 0.50 | +139 | 0 | 1 | 1 | 0 | -44 | 0.70 | L | -0.5u |
| 2026-05-17 | MLB | ML | away | 5.0 | 5.00 | -129 | 3 | 1 | 4 | 1 | -19 | 0.40 | L | -5.0u |
| 2026-05-17 | MLB | ML | home | 4.0 | 2.75 | -114 | 3 | 1 | 4 | 4 | -11 | 2.20 | W | +2.4u |
| 2026-05-17 | MLB | TOTAL | over | 4.5 | 2.25 | -110 | 2 | 1 | 3 | 2 | -21 | 0.00 | W | +2.0u |
...
| 2026-05-18 | MLB | ML | home | 4.5 | 5.00 | -111 | 2 | 1 | 3 | 2 | 6 | -1.10 | W | +4.4u |
...
| 2026-05-19 | MLB | ML | away | 2.5 | 1.25 | -104 | 1 | 1 | 2 | 0 | -17 | -1.20 | W | +1.2u |
...
| 2026-05-20 | MLB | ML | away | 4.0 | 2.75 | +113 | 1 | 1 | 2 | 0 | -44 | -1.00 | L | -2.8u |
...
| 2026-05-21 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 0 | 0 | 2 | -11 | 0.00 | W | +0.3u |
| 2026-05-21 | MLB | ML | home | 3.0 | 1.25 | -116 | 3 | 1 | 4 | 2 | -21 | -0.40 | L | -1.3u |
| 2026-05-21 | MLB | ML | away | 3.0 | 1.25 | +129 | 1 | 0 | 1 | 3 | -43 | -0.40 | W | +1.6u |
...
| 2026-05-22 | MLB | ML | home | 5.0 | 5.00 | -144 | 4 | 2 | 6 | 2 | 6 | -1.60 | L | -5.0u |
...
| 2026-05-23 | MLB | SPREAD | away | 4.5 | 1.50 | -209 | 0 | 0 | 0 | 2 | -18 | 29.00 | W | +2.5u |
...
| 2026-05-23 | MLB | ML | home | 4.0 | 2.50 | +118 | 1 | 0 | 1 | 1 | -11 | 1.10 | W | +2.9u |
...
| 2026-05-24 | MLB | ML | home | 4.5 | 3.75 | -101 | 2 | 1 | 3 | 2 | -21 | 0.00 | L | -3.8u |
| 2026-05-24 | MLB | ML | home | 3.0 | 1.25 | -189 | 1 | 0 | 1 | 1 | 25 | 0.00 | W | +0.7u |
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 0.75 | -110 | 1 | 0 | 1 | 2 | 10 | 0.00 | L | -0.8u |
...
| 2026-05-24 | MLB | ML | home | 2.5 | 0.50 | +144 | 1 | 1 | 2 | -1 | -49 | 0.00 | L | -0.5u |
| 2026-05-24 | MLB | SPREAD | home | 4.0 | 1.65 | -110 | 2 | 1 | 3 | 2 | -18 | -1.30 | L | -1.6u |
| 2026-05-24 | MLB | ML | home | 3.0 | 1.25 | -107 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +1.2u |
...
| 2026-05-24 | MLB | ML | away | 3.0 | 1.25 | -122 | -1 | 1 | 0 | 0 | -35 | -1.10 | L | -1.3u |
| 2026-05-24 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 2 | -14 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | SPREAD | home | 3.0 | 0.75 | +134 | 1 | 0 | 1 | 1 | -9 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 0 | -24 | 0.00 | W | +0.7u |
...
| 2026-05-25 | MLB | TOTAL | over | 5.0 | 3.00 | -110 | 3 | 0 | 3 | 3 | 14 | 0.00 | W | +2.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 3.75 | -108 | 0 | 0 | 0 | 3 | -41 | -1.70 | L | -3.8u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -124 | 2 | 0 | 2 | 2 | -18 | -1.30 | W | +0.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 5.00 | -119 | 2 | -1 | 1 | 4 | -5 | -0.60 | W | +3.1u |
...
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -178 | 1 | 0 | 1 | 2 | -18 | -1.60 | W | +0.9u |
...
| 2026-05-26 | MLB | TOTAL | over | 5.0 | 1.65 | -110 | 2 | 0 | 2 | 2 | -18 | 0.00 | W | +1.5u |
| 2026-05-26 | MLB | ML | away | 5.0 | 1.50 | +200 | 2 | 0 | 2 | 2 | -21 | -1.00 | L | -1.5u |
| 2026-05-26 | MLB | SPREAD | away | 5.0 | 1.00 | -101 | 2 | 1 | 3 | 2 | -18 | 0.50 | L | -1.0u |
...
| 2026-05-27 | MLB | ML | home | 4.5 | 0.50 | -102 | 3 | 1 | 4 | 3 | 36 | -1.10 | W | +0.4u |
| 2026-05-27 | MLB | SPREAD | away | 5.0 | 2.50 | +141 | 1 | 1 | 2 | 4 | -14 | 0.80 | L | -2.5u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 1.00 | +105 | 2 | 0 | 2 | 2 | -18 | 0.00 | L | -1.0u |
...
| 2026-05-27 | MLB | TOTAL | under | 5.0 | 1.00 | -112 | 3 | 1 | 4 | 3 | -13 | 0.00 | W | +0.0u |
| 2026-05-27 | MLB | ML | away | 4.0 | 1.00 | -108 | 1 | -1 | 0 | 0 | 40 | -0.90 | L | -1.0u |
| 2026-05-27 | MLB | ML | home | 5.0 | 0.50 | +132 | 2 | 0 | 2 | 2 | 11 | -0.50 | L | -0.5u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 1.65 | +104 | 2 | 0 | 2 | 2 | 7 | 0.00 | W | +1.7u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 0.75 | +104 | 2 | 0 | 2 | 2 | 10 | 0.00 | W | +0.8u |
| 2026-05-27 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 2 | 5 | 4 | -16 | -0.30 | L | -2.5u |
| 2026-05-27 | MLB | SPREAD | away | 4.5 | 1.65 | -145 | 1 | 1 | 2 | 1 | 1 | -0.30 | W | +1.1u |
| 2026-05-27 | MLB | ML | away | 5.0 | 5.00 | -126 | 2 | 0 | 2 | 1 | -2 | -4.10 | L | -5.0u |
...
| 2026-05-28 | MLB | TOTAL | under | 5.0 | 1.00 | -107 | 1 | 0 | 1 | 1 | 35 | 0.00 | W | +0.0u |
| 2026-05-28 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 1 | 4 | 2 | -66 | -0.60 | L | -2.5u |
| 2026-05-28 | MLB | TOTAL | over | 2.5 | 1.65 | -108 | 2 | 0 | 2 | 2 | -18 | 0.00 | L | -1.6u |
| 2026-05-28 | NBA | SPREAD | away | 5.0 | 1.00 | -110 | 1 | 2 | 3 | 0 | -1 | -0.90 | L | -1.0u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.50 | +118 | 5 | 1 | 6 | 5 | 22 | -0.90 | L | -2.5u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 0.75 | -135 | 2 | 0 | 2 | 1 | -22 | 1.00 | L | -0.8u |
| 2026-05-29 | MLB | ML | home | 5.0 | 3.75 | -124 | 2 | 1 | 3 | 3 | 7 | -1.00 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 1.65 | -106 | 2 | 0 | 2 | 3 | 10 | 0.00 | L | -1.6u |
| 2026-05-29 | MLB | ML | home | 4.0 | 2.50 | +120 | 1 | 0 | 1 | 1 | -2 | 0.40 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 2.25 | -112 | 2 | 0 | 2 | 3 | 37 | 0.00 | W | +2.0u |
| 2026-05-29 | MLB | SPREAD | away | 4.0 | 0.75 | +150 | 0 | 0 | 0 | 1 | 1 | -0.50 | L | -0.8u |
| 2026-05-29 | MLB | ML | away | 5.0 | 2.50 | +140 | 2 | 1 | 3 | 1 | -25 | 1.00 | L | -2.5u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 1.65 | -103 | 0 | 0 | 0 | 2 | -18 | 0.00 | W | +1.6u |
| 2026-05-29 | MLB | ML | away | 4.5 | 1.25 | -142 | 0 | 1 | 1 | -2 | 23 | -1.20 | W | +0.3u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 1.65 | -135 | 1 | 0 | 1 | 2 | -18 | 0.40 | W | +1.2u |
| 2026-05-29 | MLB | ML | home | 4.5 | 1.25 | -134 | 1 | 0 | 1 | 0 | -6 | -1.70 | W | +2.8u |
| 2026-05-29 | MLB | SPREAD | away | 5.0 | 2.25 | -184 | 0 | 0 | 0 | 2 | 5 | -1.00 | W | +1.2u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 0.75 | -109 | 1 | 0 | 1 | 2 | 10 | 0.00 | W | +0.7u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.75 | -106 | 2 | 1 | 3 | 2 | 34 | 0.70 | L | -2.8u |
| 2026-05-29 | MLB | SPREAD | home | 4.0 | 1.65 | -175 | 0 | 0 | 0 | 2 | -18 | -0.80 | L | -1.6u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 0.30 | +105 | 2 | 1 | 3 | 1 | 9 | 0.00 | W | +0.3u |
| 2026-05-29 | MLB | ML | home | 4.5 | 3.75 | -122 | 0 | 1 | 1 | 1 | 5 | -0.60 | L | -3.8u |
...
| 2026-05-30 | MLB | ML | away | 5.0 | 2.50 | +132 | 2 | 1 | 3 | 2 | -21 | 0.00 | L | -2.5u |
| 2026-05-30 | MLB | ML | away | 4.5 | 2.75 | -125 | 1 | 2 | 3 | 1 | 7 | -0.60 | W | +2.3u |
| 2026-05-30 | MLB | ML | home | 5.0 | 5.00 | -130 | 1 | 0 | 1 | 2 | -18 | -1.20 | L | -5.0u |
| 2026-05-30 | MLB | ML | away | 4.0 | 3.75 | -132 | 1 | 1 | 2 | 1 | 49 | -1.00 | W | +2.9u |
...
| 2026-05-30 | MLB | TOTAL | over | 4.0 | 2.25 | -116 | 2 | 0 | 2 | 2 | 6 | 0.00 | W | +1.9u |
| 2026-05-30 | MLB | TOTAL | under | 4.0 | 1.65 | -107 | 1 | 0 | 1 | 1 | 5 | 0.00 | L | -1.6u |
| 2026-05-30 | MLB | ML | home | 4.0 | 2.50 | +129 | 1 | 0 | 1 | 1 | -19 | -0.90 | W | +0.7u |
| 2026-05-30 | MLB | SPREAD | home | 5.0 | 1.65 | -120 | 2 | 1 | 3 | 2 | -18 | -0.60 | W | +1.4u |
| 2026-05-30 | MLB | ML | away | 5.0 | 2.50 | +108 | 1 | 0 | 1 | 3 | -41 | -0.90 | W | +2.7u |
| 2026-05-30 | MLB | ML | home | 4.0 | 0.50 | +110 | 1 | 0 | 1 | 1 | -19 | -0.20 | W | +0.6u |
| 2026-05-30 | MLB | ML | home | 5.0 | 1.25 | -102 | 2 | 0 | 2 | 2 | 6 | -0.70 | W | +1.2u |
...
| 2026-05-31 | MLB | ML | home | 2.5 | 2.75 | -115 | 1 | 1 | 2 | 1 | 26 | 0.00 | W | +2.4u |
| 2026-05-31 | MLB | ML | away | 5.0 | 1.00 | +115 | -1 | 0 | -1 | 2 | -22 | -0.60 | L | -1.0u |
| 2026-05-31 | MLB | SPREAD | away | 5.0 | 1.00 | -117 | 3 | 1 | 4 | 3 | -12 | -0.20 | L | -1.0u |
...
| 2026-06-01 | MLB | ML | away | 5.0 | 2.50 | +160 | 2 | -1 | 1 | 2 | 35 | -1.30 | W | +2.7u |
...
| 2026-06-02 | MLB | TOTAL | under | 4.0 | 1.00 | -117 | 1 | 0 | 1 | 0 | 8 | 0.00 | L | -1.0u |
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +130 | 2 | 0 | 2 | 0 | 55 | -0.60 | W | +3.1u |
| 2026-06-02 | MLB | ML | away | 3.0 | 0.50 | +100 | 1 | 0 | 1 | 2 | 26 | -1.20 | W | +0.5u |
| 2026-06-02 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 8 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 8 | 0.00 | L | -3.0u |
| 2026-06-02 | MLB | ML | home | 4.0 | 1.00 | -112 | 1 | 0 | 1 | 1 | 25 | -1.10 | L | -1.0u |
| 2026-06-02 | MLB | ML | home | 4.0 | 1.00 | -106 | 1 | 0 | 1 | 1 | 25 | -0.50 | L | -1.0u |
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +102 | 0 | -1 | -1 | 0 | 1 | 0.00 | L | -2.5u |
...
| 2026-06-03 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 32 | 0.00 | L | -3.0u |
...
| 2026-06-03 | MLB | TOTAL | under | 4.5 | 2.50 | -110 | 1 | 0 | 1 | 0 | 8 | 0.00 | W | +2.5u |
| 2026-06-03 | MLB | ML | home | 4.5 | 3.00 | -112 | 0 | 0 | 0 | 1 | 25 | -0.90 | W | +2.7u |
| 2026-06-03 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 1 | 1 | 0.00 | W | +4.5u |
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -139 | 0 | 0 | 0 | 0 | 58 | -1.20 | W | +0.3u |
| 2026-06-03 | MLB | TOTAL | under | 4.5 | 2.50 | -110 | 1 | 0 | 1 | 0 | 8 | 0.00 | L | -2.5u |
...
| 2026-06-04 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | -1 | 0 | 1 | 8 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | +102 | 0 | 0 | 0 | 1 | 25 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 5.0 | 2.50 | +118 | 1 | 1 | 2 | 1 | 56 | -0.40 | W | +3.0u |
| 2026-06-04 | MLB | SPREAD | away | 5.0 | 5.00 | -111 | 0 | 0 | 0 | 1 | 5 | 0.00 | L | -5.0u |
| 2026-06-04 | MLB | ML | home | 5.0 | 5.00 | -131 | 1 | 0 | 1 | 1 | 56 | 0.20 | W | +3.5u |
...
| 2026-06-04 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 8 | 0.00 | W | +2.7u |
| 2026-06-04 | MLB | ML | home | 3.0 | 0.50 | -235 | 4 | 0 | 4 | 4 | 15 | 0.00 | L | -0.5u |
| 2026-06-04 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 0 | 7 | 0.00 | L | -5.0u |
| 2026-06-04 | NHL | ML | home | 2.5 | 0.25 | -160 | -3 | 0 | -3 | 2 | 7 | -0.40 | W | +0.2u |
| 2026-06-05 | MLB | ML | home | 2.5 | 0.25 | -144 | 1 | 1 | 2 | 0 | 25 | -1.20 | L | -0.3u |
| 2026-06-05 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | -1 | 26 | 0.00 | W | +2.8u |
| 2026-06-05 | MLB | ML | away | 3.0 | 0.50 | +128 | 1 | 0 | 1 | 1 | 5 | 0.00 | W | +0.6u |
| 2026-06-05 | MLB | TOTAL | over | 4.0 | 1.00 | -109 | 0 | 0 | 0 | 0 | 8 | 0.00 | P | +0.0u |
| 2026-06-05 | MLB | ML | home | 3.0 | 0.50 | -136 | 1 | 0 | 1 | 1 | 25 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 3 | 0 | 3 | 4 | -4 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | ML | away | 5.0 | 5.00 | -122 | 0 | 1 | 1 | 1 | 32 | -0.80 | L | -5.0u |
| 2026-06-05 | MLB | ML | home | 5.0 | 5.00 | -171 | 0 | 2 | 2 | 3 | 34 | -0.20 | W | +2.7u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -188 | 2 | 0 | 2 | 2 | 26 | -0.90 | W | +0.5u |
| 2026-06-05 | MLB | ML | away | 4.0 | 1.00 | -105 | 1 | 0 | 1 | 1 | 25 | 0.00 | L | -1.0u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -141 | 3 | 2 | 5 | 3 | 7 | 0.30 | W | +0.7u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 2.50 | -110 | 0 | 1 | 1 | -1 | 30 | 0.00 | W | +2.5u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -172 | 1 | 0 | 1 | 1 | 25 | 0.00 | L | -1.0u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 0 | -1 | -1 | 0 | 8 | 0.00 | W | +4.4u |
| 2026-06-05 | MLB | ML | away | 4.5 | 3.00 | -129 | -1 | 1 | 0 | -2 | 29 | -1.10 | W | +2.2u |
| 2026-06-05 | MLB | SPREAD | away | 3.0 | 0.50 | +126 | 1 | 0 | 1 | 1 | 5 | 0.00 | W | +0.6u |
