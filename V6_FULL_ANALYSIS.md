...
_Auto-generated **6/7/2026, 10:45:15 AM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 496 shipped+graded picks · 2026-04-18 → 2026-06-06  (HC analyses scoped to post-cutover 2026-04-30, 384 picks)
**Headline:** 249-243-4 · WR 50.6% [46.2%–55.0%] vs 52.4% break-even · -15.9u flat (-3.2%) · -62.7u peak.
**Overall t-test:** t = -0.72 → ✗ noise.
...
- **ρ(Δw, flat ROI) = 0.022 ✗**  (full sample, N=490)
- **ρ(HC, flat ROI) = -0.028 ✗**  (post-cutover, N=384)
- **ρ(Δw+HC, flat ROI) = -0.062 ✗**  (post-cutover, N=384)
...
- **Tier-1b (HC = +1)** — N=139, WR 55.4%, flat ROI +6.4%. Bayesian posterior WR ≈ 55.0%, half-Kelly = **2.8%** bankroll at −110.
...
- **Stale Δw ≤ 0 (full sample)** — -13.1% flat ROI on 117 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (0.99u/pick), we need **~1511 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 496. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **496** |
| W-L-P | 249-243-4 |
| Win rate | **50.6%** [46.2%–55.0%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +1.8 pp |
| Peak-units PnL | **-62.7u** |
| Flat-1u PnL | **-15.9u** (-3.2% flat ROI) |
| Flat t-statistic vs zero | -0.72 → ✗ noise |
| Flat 95% CI per-pick | [-0.119, 0.055]u |
...
We have **496** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = 0 | 97 | 49-45-3 | 52.1% [42–62] | -4.8% | +5.7u | -0.51 ✗ noise |
| Δw = +1 | 167 | 94-72-1 | 56.6% [49–64] | +6.5% | +3.4u | 0.89 ✗ noise |
| Δw = +2 | 114 | 53-61-0 | 46.5% [38–56] | -8.5% | -35.0u | -0.89 ✗ noise |
| Δw ≥ +3 | 92 | 44-48-0 | 47.8% [38–58] | -2.9% | -29.7u | -0.25 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.004** ✗  ·  **ρ(Δw, flat ROI) = 0.022** ✗  (N=490)
...
|---|---|---|---|---|---|---|
| HC ≤ −2 | 0 | — | — | — | — | — |
| HC = −1 | 17 | 8-9-0 | 47.1% [26–69] | -1.1% | +2.2u | -0.04 ✗ noise |
| HC = 0 | 191 | 97-91-3 | 51.6% [44–59] | -4.5% | -29.1u | -0.66 ✗ noise |
| HC = +1 | 139 | 77-62-0 | 55.4% [47–63] | +6.4% | -3.5u | 0.77 ✗ noise |
| HC = +2 | 27 | 13-14-0 | 48.1% [31–66] | -6.1% | -13.0u | -0.31 ✗ noise |
| HC ≥ +3 | 10 | 3-7-0 | 30.0% [11–60] | -56.7% | -8.8u | -2.57 ✓ p<.05 |

**Pearson ρ(HC, WIN) = -0.014** ✗  ·  **ρ(HC, flat ROI) = -0.028** ✗  (N=384)

Spearman rank ρ(HC, flat ROI) = 0.004.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 65 | 31-32-2 | 49.2% [37–61] | -9.5% | -0.1u | -0.83 ✗ noise |
| Σ = +1 | 104 | 61-42-1 | 59.2% [50–68] | +11.6% | +8.4u | 1.25 ✗ noise |
| Σ = +2 | 96 | 56-40-0 | 58.3% [48–68] | +8.7% | +8.1u | 0.90 ✗ noise |
| Σ = +3 | 50 | 18-32-0 | 36.0% [24–50] | -28.3% | -29.4u | -2.02 ✓ p<.05 |
| Σ = +4 | 36 | 19-17-0 | 52.8% [37–68] | +4.6% | -11.0u | 0.27 ✗ noise |
| Σ = +5 | 15 | 6-9-0 | 40.0% [20–64] | -24.2% | -12.1u | -0.97 ✗ noise |
| Σ ≥ +6 | 18 | 7-11-0 | 38.9% [20–61] | -29.2% | -15.9u | -1.32 ✗ noise |

**Pearson ρ(Δw+HC, WIN) = -0.060** ✗  ·  **ρ(Σ, flat ROI) = -0.062** ✗  (N=384)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 384.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.071 ✗ | -0.066 ✗ | -0.049 | weak |
| HC margin | -0.014 ✗ | -0.028 ✗ | 0.004 | weak |
| Δw + HC | -0.060 ✗ | -0.062 ✗ | -0.040 | weak |
| peak.stars | -0.076 ✗ | -0.106 ✓ p<.05 | -0.126 | weak |
| vault.star | -0.036 ✗ | -0.055 ✗ | -0.091 | weak |
| lock.stars | -0.044 ✗ | -0.070 ✗ | -0.080 | weak |
...
Universe N = 384 (post-cutover, both axes present).

| HC \ Δw | ≤ −3 | -2 | -1 | +0 | +1 | +2 | ≥ +3 |
|---|---|---|---|---|---|---|---|
| ≤ −3 | — | — | — | — | — | — | — |
| -2 | — | — | — | — | — | — | — |
| -1 | — | N=1 · 0-1 · 0% [0–79] · —  | N=2 · 1-1 · 50% [9–91] · —  | N=4 · 3-1 · 75% [30–95] · +52%  | N=4 · 0-4 · 0% [0–49] · -100%  | N=2 · 2-0 · 100% [34–100] · — ★ | N=4 · 2-2 · 50% [15–85] · -1%  |
| +0 | N=1 · 1-0 · 100% [21–100] · —  | N=1 · 0-1 · 0% [0–79] · —  | N=4 · 1-3 · 25% [5–70] · -63%  | N=44 · 24-18 · 57% [42–71] · +4%  | N=78 · 46-31 · 60% [49–70] · +13%  | N=42 · 21-21 · 50% [36–64] · -8%  | N=21 · 4-17 · 19% [8–40] · -65% ✗ |
| +1 | — | — | N=4 · 1-3 · 25% [5–70] · -56%  | N=24 · 13-11 · 54% [35–72] · -1%  | N=49 · 32-17 · 65% [51–77] · +23%  | N=32 · 14-18 · 44% [28–61] · -10%  | N=30 · 17-13 · 57% [39–73] · +11%  |
...
| Δw = 0 | 74 | 42-30-2 | 58.3% [47–69] | +6.0% | +19.0u | 0.57 ✗ noise |
| Δw = +1 | 134 | 79-54-1 | 59.4% [51–67] | +11.7% | +8.0u | 1.44 ✗ noise |
| Δw = +2 | 89 | 42-47-0 | 47.2% [37–57] | -7.7% | -31.2u | -0.72 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 176 | 93-83-0 | 52.8% [45–60] | +0.9% | -25.3u | 0.12 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 69 | 29-40-0 | 42.0% [31–54] | -21.2% | -28.5u | -1.85 ~ p<.10 |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 139 | 76-60-3 | 55.9% [47–64] | +4.2% | +1.7u | 0.53 ✗ noise |
...
Universe N = 466 picks where ≥1 proven wallet appeared on either side.
...
| Δcount = −1 | 26 | 8-18-0 | 30.8% [17–50] | -36.7% | -17.3u | -1.92 ~ p<.10 |
| Δcount = 0 (balanced) | 62 | 27-33-2 | 45.0% [33–58] | -14.6% | -9.8u | -1.21 ✗ noise |
| Δcount = +1 | 179 | 89-90-0 | 49.7% [42–57] | -7.2% | -46.9u | -1.01 ✗ noise |
| Δcount = +2 | 114 | 57-56-1 | 50.4% [41–59] | -4.9% | -12.9u | -0.54 ✗ noise |
| Δcount ≥ +3 (heavy support) | 82 | 55-27-0 | 67.1% [56–76] | +35.8% | +36.5u | 2.95 ✓ p<.01 |

**ρ(Δcount, WIN) = 0.129** ✓ p<.01  ·  **ρ(Δcount, flat ROI) = 0.152** ✓ p<.01
...
Quintile cuts: ≤ -15 · ≤ -1 · ≤ 6 · ≤ 18 · > 18

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 100 | 46-54-0 | 46.0% [37–56] | -10.6% | -30.4u | -1.07 ✗ noise |
| Q2 | 88 | 30-57-1 | 34.5% [25–45] | -32.0% | -46.4u | -3.18 ✓ p<.01 |
| Q3 (balanced) | 96 | 51-44-1 | 53.7% [44–63] | +2.8% | -20.5u | 0.28 ✗ noise |
| Q4 | 92 | 54-37-1 | 59.3% [49–69] | +15.2% | +16.8u | 1.39 ✗ noise |
| Q5 (best — heavy support) | 90 | 58-32-0 | 64.4% [54–74] | +18.7% | +33.4u | 1.87 ~ p<.10 |

**ρ(ΔWlNet, WIN) = 0.180** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.154** ✓ p<.01
...
Quintile cuts (units): ≤ -16.55 · ≤ -3.50 · ≤ 4.13 · ≤ 11.30 · > 11.30

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 99 | 43-56-0 | 43.4% [34–53] | -18.1% | -45.5u | -1.90 ~ p<.10 |
| Q2 | 88 | 38-49-1 | 43.7% [34–54] | -16.9% | -23.8u | -1.66 ~ p<.10 |
| Q3 | 93 | 50-43-0 | 53.8% [44–64] | +3.2% | +0.6u | 0.31 ✗ noise |
| Q4 | 93 | 48-45-0 | 51.6% [42–62] | -4.6% | -19.2u | -0.47 ✗ noise |
| Q5 | 93 | 60-31-2 | 65.9% [56–75] | +31.1% | +40.9u | 2.81 ✓ p<.01 |

**ρ(ΔFlatPnl, WIN) = 0.166** ✓ p<.01  ·  **ρ(ΔFlatPnl, flat ROI) = 0.185** ✓ p<.01
...
Quintile cuts (% ROI): ≤ -9.0 · ≤ -3.3 · ≤ 6.5 · ≤ 19.8 · > 19.8

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 114 | 37-76-1 | 32.7% [25–42] | -34.1% | -60.6u | -3.75 ✓ p<.01 |
| Q2 | 73 | 33-40-0 | 45.2% [34–57] | -17.6% | -24.4u | -1.63 ✗ noise |
| Q3 | 111 | 60-51-0 | 54.1% [45–63] | -0.0% | -20.9u | -0.01 ✗ noise |
| Q4 | 75 | 43-30-2 | 58.9% [47–69] | +11.3% | +26.9u | 1.03 ✗ noise |
| Q5 | 93 | 66-27-0 | 71.0% [61–79] | +40.9% | +31.9u | 3.88 ✓ p<.01 |

**ρ(ΔAvgRoi, WIN) = 0.306** ✓ p<.01  ·  **ρ(ΔAvgRoi, flat ROI) = 0.316** ✓ p<.01
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 48 | 10-37-1 | 21.3% [12–35] | -56.0% | -41.9u | -4.61 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 16 | 7-9-0 | 43.8% [23–67] | -12.9% | -5.2u | -0.49 ✗ noise |
| ΔBestRank = 0 (tied) | 2 | 1-1-0 | 50.0% [9–91] | -4.5% | -1.4u | -0.05 ✗ noise |
| ΔBestRank ∈ [+1,+4] | 16 | 6-10-0 | 37.5% [18–61] | -20.8% | -4.5u | -0.70 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 107 | 64-41-2 | 61.0% [51–70] | +21.4% | +12.7u | 2.07 ✓ p<.05 |

**ρ(ΔBestRank, WIN) = 0.361** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.388** ✓ p<.01  (N=189)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 27 | 7-20-0 | 25.9% [13–45] | -45.8% | -14.3u | -2.33 ✓ p<.05 |
| Δshare ∈ [−30,−10] pp | 3 | 1-2-0 | 33.3% [6–79] | -11.7% | -4.5u | -0.13 ✗ noise |
| Δshare ≈ 0 (±10 pp) | 326 | 162-162-2 | 50.0% [45–55] | -6.1% | -56.0u | -1.16 ✗ noise |
| Δshare ∈ [+10,+30] pp | 19 | 13-5-1 | 72.2% [49–88] | +40.1% | +7.0u | 1.87 ~ p<.10 |
| Δshare ≥ +30 pp | 91 | 56-35-0 | 61.5% [51–71] | +21.8% | +20.8u | 1.94 ~ p<.10 |

**ρ(ΔTopQShare, WIN) = 0.150** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.144** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔAvgRoi** | 0.306 ✓ p<.01 | 0.316 ✓ p<.01 | 0.268 |
| 2 | **ΔTopQCount** | 0.197 ✓ p<.01 | 0.231 ✓ p<.01 | 0.171 |
| 3 | **ΔFlatPnl** | 0.166 ✓ p<.01 | 0.185 ✓ p<.01 | 0.159 |
| 4 | **ΔWlNet** | 0.180 ✓ p<.01 | 0.154 ✓ p<.01 | 0.121 |
| 5 | **Δcount** | 0.129 ✓ p<.01 | 0.152 ✓ p<.01 | 0.132 |
| 6 | **ΔTopQShare** | 0.150 ✓ p<.01 | 0.144 ✓ p<.01 | 0.148 |

_(ΔBestRank uses N=189 subset where both sides had a proven wallet — ρ(flat ROI) = 0.388 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 867, dateRange = 2026-04-18 → 2026-06-06, computedAt = 2026-06-07T14:32:26.600Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **466** rows · PIT aggregate computable on **466** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **466** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 315 · 56% · +5.8% | 275 · 53% · -1.1% | -7.0pp |
| WEAK (−3..0) | 131 · 44% · -15.9% | 171 · 51% · +0.4% | +16.3pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=245, WR=58%, ROI=+9.4% | N=209, WR=52%, ROI=-3.8% | -13.2pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=315, WR=56%, ROI=+5.8% | N=275, WR=53%, ROI=-1.1% | -7.0pp |
| AGS < −1 (mute veto) | N=43, WR=40%, ROI=-25.5% | N=94, WR=45%, ROI=-7.3% | +18.2pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-05-24 → 2026-06-06, N=211)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 114 · 59% · +6.8% |
| WEAK (−3..0) | 97 · 47% · -9.9% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=77, WR=57%, ROI=+3.4% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=114, WR=59%, ROI=+6.8% |
| AGS < −1 (mute veto) | N=56, WR=40%, ROI=-21.5% |
...
|---|---|---|---|---|
| `dCount` | COUNT | + | 1.06 | 1.51 |
| `dHcSizeRatio` | INTENSITY_HC | + | 1.09 | 4.68 |
| `dSumRankNorm` | QUALITY_RANK | − | 56.58 | 87.19 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.58 | 1.18 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **466/496** shipped+graded rows (94%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| LOCK | 88 | 39-49-0 | 44.3% [34–55] | -16.2% | -31.4u | -1.57 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 64 | 33-30-1 | 52.4% [40–64] | +0.4% | +2.4u | 0.03 ✗ noise |
| FADE | 99 | 42-54-3 | 43.8% [34–54] | -9.9% | -37.4u | -0.91 ✗ noise |
...
r(WIN) = **0.013** ✗ · r(ROI) = **-0.023** ✗ · Spearman ρ(ROI) = **-0.021**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 82 | 40-40-2 | 50.0% [39–61] | +2.0% | -23.5u | 0.16 ✗ noise |
| z ∈ [−1, 0) | 165 | 89-74-2 | 54.6% [47–62] | +2.7% | +10.6u | 0.36 ✗ noise |
| z ∈ [0, +1) | 143 | 67-76-0 | 46.9% [39–55] | -11.3% | -40.3u | -1.40 ✗ noise |
...
| z ∈ [0, +1) | 432 | 220-208-4 | 51.4% [47–56] | -3.0% | -53.9u | -0.64 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.029** ✗ · r(ROI) = **-0.039** ✗ · Spearman ρ(ROI) = **-0.038**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 83 | 45-37-1 | 54.9% [44–65] | -0.6% | -6.7u | -0.06 ✗ noise |
| z ∈ [−1, 0) | 146 | 78-66-2 | 54.2% [46–62] | +6.5% | -3.6u | 0.75 ✗ noise |
| z ∈ [0, +1) | 180 | 84-95-1 | 46.9% [40–54] | -9.7% | -47.4u | -1.34 ✗ noise |
| z ≥ +1 (very positive) | 57 | 28-29-0 | 49.1% [37–62] | -9.5% | +0.7u | -0.75 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.029 ✗ | -0.039 ✗ | -0.038 |
| 2 | `dCount` | COUNT | 0.013 ✗ | -0.023 ✗ | -0.021 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | +0.025 | 0.789 | 48.7% | meaningful |
| 2 | `dSumRankNorm` | -0.035 | 0.779 | 48.1% | meaningful |
| 3 | `dWinnerCtPreA` | -0.036 | 0.036 | 2.2% | silent (<0.2) |
| 4 | `dHcSizeRatio` | -0.017 | 0.017 | 1.0% | silent (<0.2) |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.066 | +0.713 ⚠ | +0.066 |
| `dHcSizeRatio` | +0.066 | 1.000 | +0.043 | +1.000 ⚠ |
| `dSumRankNorm` | +0.713 ⚠ | +0.043 | 1.000 | +0.043 |
| `dWinnerCtPreA` | +0.066 | +1.000 ⚠ | +0.043 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **-0.002**. At AGS ≥ +0.12 fires N=221, WR=50.7%, ROI=-5.6%. At AGS ≥ +null fires N=289, WR=51.9%, ROI=-3.3%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-221 ROI (matched cohort) | Top-221 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.038 | +0.036 | WR=54%, ROI=+3.3% | -8.9pp | N=217, WR=55%, ROI=+4.3% |
| `dHcSizeRatio` | +0.030 | +0.028 | WR=54%, ROI=+0.2% | -5.8pp | N=220, WR=54%, ROI=+0.6% |
| `dSumRankNorm` | -0.024 | +0.022 | WR=48%, ROI=-9.9% | +4.3pp | N=227, WR=48%, ROI=-8.8% |
| `dWinnerCtPreA` | +0.033 | +0.031 | WR=55%, ROI=+1.8% | -7.4pp | N=209, WR=53%, ROI=-0.6% |
...
|---|---|---|---|---|
| 1 | `dSumRankNorm` | +0.022 | +4.3pp | redundant — other features cover it |
| 2 | `dHcSizeRatio` | +0.028 | -5.8pp | redundant — other features cover it |
| 3 | `dWinnerCtPreA` | +0.031 | -7.4pp | redundant — other features cover it |
| 4 | `dCount` | +0.036 | -8.9pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.097 | 0.097 | negative ↓ |
| 2 | `dCount` | COUNT | +0.056 | 0.056 | positive ↑ |
| 3 | `dWinnerCtPreA` | QUALITY_TRACK | +0.041 | 0.041 | flat ≈ 0 |
| 4 | `dHcSizeRatio` | INTENSITY_HC | +0.020 | 0.020 | flat ≈ 0 |

Intercept b = +0.014 · Final log-loss = 0.6918 · N = 466.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 466 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/466 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 172 | 78-94-0 | 45.3% [38–53] | -17.4% | -81.6u | -2.45 ✓ p<.05 |
| 4.5★ | 58 | 39-19-0 | 67.2% [54–78] | +25.7% | +31.4u | 2.08 ✓ p<.05 |
| 4.0★ | 95 | 44-49-2 | 47.3% [37–57] | -8.7% | -8.4u | -0.87 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 65 | 34-30-1 | 53.1% [41–65] | +5.6% | -2.3u | 0.45 ✗ noise |
| 2.5★ | 68 | 35-32-1 | 52.2% [40–64] | +0.4% | -5.7u | 0.03 ✗ noise |

### §5b. Stars × Δw stratified — does the star tier hold up within each Δw cohort?

| Δw cohort | 5★ | 4.5★ | 4★ | 3.5★ | 3★ | 2.5★ |
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 25/56%/-5% | 15/67%/+17% | 19/33%/-35% | 6/33%/-26% | 24/35%/-35% | 27/50%/-4% |
| Δw = +1 | 26/50%/-9% | 19/68%/+22% | 43/50%/-4% | 28/54%/+4% | 23/70%/+37% | 27/56%/+2% |
| Δw = +2 | 58/43%/-18% | 12/58%/+13% | 27/52%/+2% | — | 9/44%/-3% | 8/38%/-16% |
...
| −200/−151 | 48 | 25-23-0 | 52.1% [38–66] | -17.6% | -11.7u | -1.53 ✗ noise |
| −150/−101 | 292 | 145-145-2 | 50.0% [44–56] | -5.8% | -33.3u | -1.05 ✗ noise |
| −100/+100 | 5 | 2-3-0 | 40.0% [12–77] | -20.0% | -3.3u | -0.41 ✗ noise |
| +101/+150 | 103 | 49-52-2 | 48.5% [39–58] | +6.2% | -34.4u | 0.57 ✗ noise |
...
| −200/−151 | -37% (15) | +26% (15) | +13% (7) | -84% (10) |
| −150/−101 | -8% (67) | +2% (105) | -23% (66) | +1% (51) |
| −100/+100 | -100% (1) | +33% (3) | -100% (1) | — |
| +101/+150 | +2% (20) | +8% (37) | +10% (30) | -0% (16) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 266 | 132-134-0 | 49.6% [44–56] | -4.1% | -54.7u | -0.65 ✗ noise |
| SPREAD | 82 | 38-43-1 | 46.9% [36–58] | -15.5% | -9.3u | -1.55 ✗ noise |
| TOTAL | 148 | 79-66-3 | 54.5% [46–62] | +5.3% | +1.2u | 0.67 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=66 · 44% · -21% | N=83 · 60% · +14% | N=57 · 46% · -6% | N=57 · 44% · -8% |
| SPREAD | N=21 · 35% · -38% | N=29 · 52% · -8% | N=16 · 63% · +12% | N=15 · 33% · -35% |
| TOTAL | N=30 · 64% · +22% | N=55 · 54% · +3% | N=41 · 41% · -19% | N=20 · 70% · +35% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 327 | 169-156-2 | 52.0% [47–57] | -1.8% | -26.6u | -0.34 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=81 · 52% · -5% | N=125 · 57% · +6% | N=80 · 46% · -9% | N=40 · 48% · -9% |
...
|---|---|---|
| **sharps3Plus** | 219 · 46% · -8.3% · -1.17 ✗ noise | 276 · 54% · +0.3% · 0.06 ✗ noise |
| **plusEV** | 57 · 47% · -7.4% · -0.49 ✗ noise | 438 · 51% · -3.0% · -0.65 ✗ noise |
| **pinnacleConfirms** | 125 · 53% · +2.4% · 0.26 ✗ noise | 225 · 50% · -5.4% · -0.83 ✗ noise |
| **invested10kPlus** | 247 · 49% · -5.1% · -0.77 ✗ noise | 103 · 54% · +3.2% · 0.34 ✗ noise |
| **lineMovingWith** | 248 · 54% · +4.0% · 0.62 ✗ noise | 247 · 47% · -11.0% · -1.77 ~ p<.10 |
| **predMarketAligns** | 126 · 52% · +1.1% · 0.12 ✗ noise | 224 · 50% · -4.7% · -0.72 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 114 | 59-55-0 | 51.8% [43–61] | -1.2% | -7.2u | -0.13 ✗ noise |
| 1 | 114 | 56-55-3 | 50.5% [41–60] | -5.6% | -29.9u | -0.64 ✗ noise |
| 2 | 121 | 60-60-1 | 50.0% [41–59] | -3.8% | -1.9u | -0.42 ✗ noise |
| 3 | 44 | 22-22-0 | 50.0% [36–64] | -3.4% | -8.5u | -0.22 ✗ noise |
| 4 | 43 | 21-22-0 | 48.8% [35–63] | -11.5% | -13.3u | -0.79 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLEAR_MOVE | 105 | 59-45-1 | 56.7% [47–66] | +6.3% | +8.5u | 0.67 ✗ noise |
| NEAR_START | 198 | 94-101-3 | 48.2% [41–55] | -5.4% | -57.1u | -0.73 ✗ noise |
| NO_MOVE | 16 | 8-8-0 | 50.0% [28–72] | -8.3% | +4.5u | -0.35 ✗ noise |
| PREGAME | 69 | 38-31-0 | 55.1% [43–66] | +4.7% | -1.4u | 0.41 ✗ noise |
| SMALL_MOVE | 106 | 48-58-0 | 45.3% [36–55] | -15.2% | -19.7u | -1.62 ✗ noise |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 278 | 140-137-1 | 50.5% [45–56] | -5.2% | -61.7u | -0.90 ✗ noise |
| STRONG | 75 | 39-35-1 | 52.7% [41–64] | +4.1% | +4.6u | 0.35 ✗ noise |
| LEAN | 136 | 67-67-2 | 50.0% [42–58] | -3.2% | -4.7u | -0.35 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.098 ✓ p<.05 | -0.066 ✗ | -0.065 | -1.47 |
| totalInvested | -0.055 ✗ | -0.069 ✗ | -0.059 | -1.53 |
| evEdge | 0.069 ✗ | 0.049 ✗ | 0.049 | 1.09 |
| moneyPct | 0.040 ✗ | 0.014 ✗ | 0.012 | 0.31 |
| walletPct | 0.039 ✗ | 0.033 ✗ | 0.040 | 0.74 |
| criteriaMet | -0.003 ✗ | 0.011 ✗ | -0.019 | 0.24 |
| maxContribFor | -0.049 ✗ | -0.026 ✗ | -0.009 | -0.57 |
| meanBaseFor | -0.042 ✗ | -0.006 ✗ | 0.024 | -0.13 |
...
Sample with CLV: **485** picks. Mean CLV = **-0.0041**.
t-statistic vs zero: -3.40 → ✓ p<.01 · 95% CI [-0.0065, -0.0018]
...
| CLV (−2%, 0] | 281 | 139-139-3 | 50.0% [44–56] | -4.5% | -48.8u | -0.77 ✗ noise |
| CLV (0, +2%] | 132 | 71-61-0 | 53.8% [45–62] | +8.2% | +1.8u | 0.88 ✗ noise |
...
Trained on N=385 (with all features non-null). Intercept β₀ = 0.064.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | pw.ΔAvgRoi | +0.466 | ↑ helps |
| 2 | pw.Δcount | +0.327 | ↑ helps |
| 3 | sharpCount | -0.256 | ↓ hurts |
| 4 | peak.stars | -0.181 | ↓ hurts |
| 5 | evEdge | +0.173 | ↑ helps |
| 6 | log(impliedProb) | +0.155 | ↑ helps |
| 7 | pw.ΔFlatPnl | +0.151 | ↑ helps |
| 8 | Δw | -0.103 | ↓ hurts |
| 9 | HC margin | +0.095 | ↑ helps |
| 10 | pw.ΔWlNet | +0.092 | ↑ helps |
| 11 | pw.ΔTopQShare | -0.092 | ↓ hurts |
| 12 | odds (American) | -0.053 | ↓ hurts |
| 13 | criteriaMet | +0.052 | ↑ helps |
| 14 | log10(invested) | -0.051 | ↓ hurts |
| 15 | moneyPct | +0.050 | ↑ helps |
| 16 | vault.star | +0.047 | ≈ flat |
| 17 | walletPct | +0.039 | ≈ flat |
| 18 | Δw + HC | -0.035 | ≈ flat |
...
| Tier-1b HC = +1 (post-cutover) | 139 | 77-62 | 55.4% | 55.0% | -110 | 2.79% bankroll | 2.06u | ~ in range — 2.79u |
...
| Stale Δw = 0 | 97 | 49-45 | 52.1% | 51.9% | -110 | — (mute) | 1.86u | **MUTE** (negative EV at posterior) |
| Stale Δw ≤ −1 | 20 | 5-15 | 25.0% | 33.3% | -129 | — (mute) | 1.36u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.218  (annualized × √252 ≈ -3.46)
...
| 2026-04-24 | MLB | ML | home | 3.5 | 0.75 | -108 | 1 | — | — | 1 | -18 | -1.40 | W | +0.7u |
...
| 2026-04-25 | MLB | ML | away | 3.5 | 0.75 | +124 | 1 | — | — | 1 | -18 | -1.50 | L | -0.8u |
| 2026-04-25 | MLB | ML | home | 4.0 | 1.25 | +128 | 1 | — | — | 1 | -18 | -0.40 | L | -1.3u |
...
| 2026-04-26 | MLB | TOTAL | over | 3.5 | 0.50 | -116 | 1 | — | — | -1 | 18 | 0.00 | L | -0.5u |
| 2026-04-26 | MLB | ML | home | 3.5 | 0.75 | -110 | 1 | — | — | 1 | 27 | -1.40 | L | -0.8u |
...
| 2026-04-27 | MLB | ML | away | 3.5 | 0.75 | +104 | 1 | — | — | 1 | -18 | -0.70 | W | +0.8u |
...
| 2026-05-10 | MLB | ML | home | 3.5 | 1.13 | -120 | 1 | 1 | 2 | 1 | -18 | 0.00 | W | +0.9u |
| 2026-05-10 | MLB | TOTAL | over | 4.0 | 0.64 | -110 | 2 | 0 | 2 | 1 | -18 | 0.00 | L | -0.6u |
| 2026-05-10 | MLB | TOTAL | over | 4.0 | 0.64 | -110 | 2 | 0 | 2 | 1 | -18 | 0.00 | L | -0.6u |
| 2026-05-10 | MLB | ML | home | 3.5 | 1.13 | -103 | 1 | 1 | 2 | 1 | -18 | 0.00 | L | -1.1u |
| 2026-05-10 | MLB | ML | home | 3.5 | 1.13 | -110 | 1 | 1 | 2 | 1 | -18 | 0.00 | W | +1.0u |
| 2026-05-10 | MLB | ML | away | 3.5 | 1.13 | +134 | 0 | 1 | 1 | 1 | -18 | 0.00 | W | +1.5u |
...
| 2026-05-11 | MLB | ML | home | 3.5 | 1.13 | -156 | 1 | 1 | 2 | 1 | -18 | 0.00 | W | +0.7u |
...
| 2026-05-13 | MLB | ML | home | 4.5 | 4.50 | -116 | 1 | 1 | 2 | 1 | -18 | -1.30 | W | +3.7u |
| 2026-05-13 | MLB | SPREAD | home | 5.0 | 3.50 | -105 | 1 | 1 | 2 | 2 | -22 | 0.90 | W | +3.2u |
| 2026-05-13 | MLB | TOTAL | under | 4.0 | 0.96 | -110 | 1 | 1 | 2 | 2 | -15 | 0.00 | W | +0.9u |
...
| 2026-05-15 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 1 | 1 | 2 | 2 | -18 | 0.00 | W | +0.3u |
...
| 2026-05-16 | MLB | ML | home | 5.0 | 2.50 | +119 | 2 | 1 | 3 | 1 | -18 | -2.00 | L | -2.5u |
| 2026-05-16 | MLB | ML | home | 5.0 | 2.50 | +115 | 3 | 2 | 5 | 2 | 0 | -1.10 | W | +2.8u |
| 2026-05-16 | MLB | TOTAL | over | 4.0 | 1.65 | -110 | 2 | 0 | 2 | 1 | -18 | 0.00 | L | -1.6u |
...
| 2026-05-17 | MLB | ML | away | 5.0 | 5.00 | -129 | 3 | 1 | 4 | 1 | -18 | 0.40 | L | -5.0u |
| 2026-05-17 | MLB | ML | home | 4.0 | 2.75 | -114 | 3 | 1 | 4 | 4 | -10 | 2.20 | W | +2.4u |
| 2026-05-17 | MLB | TOTAL | over | 4.5 | 2.25 | -110 | 2 | 1 | 3 | 2 | -22 | 0.00 | W | +2.0u |
| 2026-05-17 | MLB | TOTAL | over | 5.0 | 2.50 | +107 | 2 | 2 | 4 | 1 | -18 | 0.00 | L | -2.5u |
...
| 2026-05-18 | MLB | ML | away | 4.0 | 2.50 | +120 | 2 | 0 | 2 | 1 | -18 | -2.10 | L | -2.5u |
| 2026-05-18 | MLB | ML | home | 3.0 | 1.25 | -118 | 2 | 0 | 2 | 1 | -18 | 1.00 | W | +1.1u |
...
| 2026-05-20 | MLB | ML | away | 5.0 | 2.50 | +113 | 2 | 1 | 3 | 1 | -18 | -1.00 | L | -2.5u |
| 2026-05-20 | MLB | ML | home | 4.0 | 2.75 | -154 | 2 | 0 | 2 | 1 | 27 | -1.50 | W | +1.9u |
| 2026-05-20 | MLB | TOTAL | under | 4.0 | 0.75 | -110 | 2 | 0 | 2 | 1 | -18 | 0.00 | L | -0.8u |
| 2026-05-20 | MLB | ML | home | 2.5 | 0.50 | -140 | 1 | 1 | 2 | 1 | -18 | -1.10 | W | +0.9u |
...
| 2026-05-21 | MLB | SPREAD | home | 3.0 | 0.75 | -148 | 0 | 0 | 0 | 1 | -18 | -1.50 | L | -0.8u |
| 2026-05-21 | MLB | ML | away | 3.0 | 1.25 | +172 | 2 | 0 | 2 | 1 | -18 | -0.50 | L | -1.3u |
| 2026-05-21 | MLB | ML | away | 4.5 | 2.75 | -110 | 2 | 1 | 3 | 1 | -18 | -0.50 | W | +2.5u |
...
| 2026-05-23 | MLB | ML | home | 2.5 | 0.50 | -181 | 1 | 0 | 1 | 2 | 30 | -1.70 | W | +0.3u |
| 2026-05-23 | MLB | ML | away | 2.5 | 2.75 | +109 | 2 | 0 | 2 | 2 | -14 | -0.50 | L | -2.8u |
| 2026-05-23 | MLB | TOTAL | over | 2.5 | 0.30 | -110 | 0 | 1 | 1 | 0 | -12 | 0.00 | W | +0.3u |
| 2026-05-23 | MLB | ML | home | 5.0 | 1.00 | -148 | 0 | 0 | 0 | 1 | -17 | -0.20 | L | -1.0u |
| 2026-05-23 | MLB | SPREAD | away | 3.0 | 0.75 | -163 | 1 | 0 | 1 | 1 | -18 | 0.00 | W | +0.5u |
| 2026-05-23 | MLB | TOTAL | under | 5.0 | 3.00 | -110 | 3 | 1 | 4 | 2 | -18 | 0.00 | W | +2.7u |
| 2026-05-23 | MLB | SPREAD | home | 3.0 | 0.75 | -163 | 0 | 0 | 0 | 1 | 3 | -0.90 | L | -0.8u |
| 2026-05-23 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 2 | 1 | 3 | 1 | -18 | 0.00 | L | -0.8u |
| 2026-05-23 | MLB | SPREAD | away | 4.5 | 1.50 | -209 | 0 | 0 | 0 | 2 | -15 | 29.00 | W | +2.5u |
| 2026-05-23 | MLB | TOTAL | under | 3.0 | 0.75 | +102 | 0 | 0 | 0 | 1 | 3 | 0.00 | W | +0.8u |
| 2026-05-23 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 1 | -18 | 0.00 | W | +0.7u |
| 2026-05-23 | MLB | ML | away | 2.5 | 1.25 | -111 | -1 | 1 | 0 | 1 | 4 | 0.40 | L | -1.3u |
| 2026-05-23 | MLB | SPREAD | home | 3.0 | 0.75 | -135 | 0 | 0 | 0 | 1 | 3 | 0.40 | W | +0.6u |
| 2026-05-23 | MLB | TOTAL | under | 2.5 | 0.30 | +108 | 0 | 0 | 0 | 0 | -6 | 0.00 | P | +0.0u |
| 2026-05-23 | MLB | ML | home | 4.0 | 2.50 | +118 | 1 | 0 | 1 | 1 | -12 | 1.10 | W | +2.9u |
| 2026-05-23 | MLB | ML | away | 3.0 | 1.25 | +166 | 2 | 1 | 3 | 2 | -26 | -0.30 | W | +1.8u |
...
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 1 | 1 | 2 | 0 | -23 | 0.00 | L | -1.6u |
...
| 2026-05-24 | MLB | ML | home | 2.5 | 0.50 | +144 | 1 | 1 | 2 | -1 | -51 | 0.00 | L | -0.5u |
| 2026-05-24 | MLB | SPREAD | home | 4.0 | 1.65 | -110 | 2 | 1 | 3 | 2 | -15 | -1.30 | L | -1.6u |
...
| 2026-05-24 | MLB | ML | away | 4.0 | 1.25 | +148 | 2 | 2 | 4 | 0 | -20 | -1.40 | W | +1.9u |
| 2026-05-24 | MLB | ML | away | 3.0 | 1.25 | -122 | -1 | 1 | 0 | 0 | -27 | -1.10 | L | -1.3u |
| 2026-05-24 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 2 | -12 | 0.00 | L | -0.8u |
...
| 2026-05-25 | MLB | ML | home | 5.0 | 5.00 | -310 | 2 | 0 | 2 | 1 | 27 | -1.20 | W | +1.6u |
...
| 2026-05-25 | MLB | ML | home | 5.0 | 1.25 | -160 | 3 | 0 | 3 | 2 | -35 | -1.10 | L | -1.3u |
| 2026-05-25 | MLB | TOTAL | over | 5.0 | 3.00 | -110 | 3 | 0 | 3 | 3 | 16 | 0.00 | W | +2.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 3.75 | -108 | 0 | 0 | 0 | 3 | -32 | -1.70 | L | -3.8u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -124 | 2 | 0 | 2 | 2 | -15 | -1.30 | W | +0.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 5.00 | -119 | 2 | -1 | 1 | 4 | -2 | -0.60 | W | +3.1u |
| 2026-05-25 | MLB | ML | away | 2.5 | 2.75 | -113 | 0 | 0 | 0 | 0 | 0 | -1.80 | W | +1.1u |
| 2026-05-25 | MLB | ML | home | 4.0 | 5.00 | -209 | -1 | 0 | -1 | 3 | 13 | -0.80 | W | +2.3u |
| 2026-05-25 | MLB | TOTAL | under | 5.0 | 0.75 | -101 | 2 | 1 | 3 | 1 | 2 | 0.00 | W | +0.7u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -178 | 1 | 0 | 1 | 2 | -15 | -1.60 | W | +0.9u |
...
| 2026-05-26 | MLB | TOTAL | over | 5.0 | 1.65 | -110 | 2 | 0 | 2 | 2 | -15 | 0.00 | W | +1.5u |
| 2026-05-26 | MLB | ML | away | 5.0 | 1.50 | +200 | 2 | 0 | 2 | 2 | -19 | -1.00 | L | -1.5u |
| 2026-05-26 | MLB | SPREAD | away | 5.0 | 1.00 | -101 | 2 | 1 | 3 | 2 | -15 | 0.50 | L | -1.0u |
| 2026-05-26 | MLB | ML | away | 2.5 | 1.25 | +113 | 0 | 0 | 0 | 0 | 24 | -1.50 | W | +1.4u |
| 2026-05-26 | MLB | ML | home | 2.5 | 1.25 | -130 | 1 | 0 | 1 | 0 | 24 | -1.30 | W | +1.0u |
| 2026-05-26 | MLB | ML | away | 5.0 | 5.00 | -200 | 1 | 0 | 1 | 2 | 30 | -0.60 | W | +1.9u |
...
| 2026-05-26 | MLB | ML | home | 5.0 | 5.00 | -105 | 2 | 1 | 3 | 2 | 30 | -2.00 | W | +3.6u |
| 2026-05-26 | MLB | ML | away | 5.0 | 2.50 | +116 | 1 | 0 | 1 | 2 | 30 | -1.00 | W | +2.9u |
...
| 2026-05-27 | MLB | SPREAD | away | 5.0 | 2.50 | +141 | 1 | 1 | 2 | 4 | -11 | 0.80 | L | -2.5u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 1.00 | +105 | 2 | 0 | 2 | 2 | -15 | 0.00 | L | -1.0u |
| 2026-05-27 | MLB | ML | home | 4.5 | 3.75 | -420 | 1 | 1 | 2 | 1 | 27 | -0.50 | W | +0.7u |
| 2026-05-27 | MLB | ML | home | 3.0 | 1.25 | -144 | -1 | -1 | -2 | 0 | -13 | -1.00 | L | -1.3u |
| 2026-05-27 | MLB | ML | away | 5.0 | 0.50 | -102 | 3 | 0 | 3 | 2 | 5 | -1.00 | L | -0.5u |
...
| 2026-05-27 | MLB | ML | away | 4.0 | 1.00 | -108 | 1 | -1 | 0 | 0 | 28 | -0.90 | L | -1.0u |
| 2026-05-27 | MLB | ML | home | 5.0 | 0.50 | +132 | 2 | 0 | 2 | 2 | 7 | -0.50 | L | -0.5u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 1.65 | +104 | 2 | 0 | 2 | 2 | 8 | 0.00 | W | +1.7u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 0.75 | +104 | 2 | 0 | 2 | 2 | 12 | 0.00 | W | +0.8u |
| 2026-05-27 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 2 | 5 | 4 | -5 | -0.30 | L | -2.5u |
| 2026-05-27 | MLB | SPREAD | away | 4.5 | 1.65 | -145 | 1 | 1 | 2 | 1 | 3 | -0.30 | W | +1.1u |
| 2026-05-27 | MLB | ML | away | 5.0 | 5.00 | -126 | 2 | 0 | 2 | 1 | -3 | -4.10 | L | -5.0u |
| 2026-05-27 | MLB | ML | home | 4.0 | 1.25 | -190 | 1 | 0 | 1 | 1 | 27 | -0.70 | W | +0.7u |
| 2026-05-27 | MLB | SPREAD | away | 5.0 | 3.00 | -135 | 0 | 0 | 0 | 3 | 7 | -0.90 | W | +2.2u |
...
| 2026-05-28 | MLB | ML | home | 5.0 | 1.25 | -140 | 2 | 0 | 2 | 2 | -19 | -0.50 | L | -1.3u |
| 2026-05-28 | MLB | TOTAL | under | 5.0 | 1.00 | -107 | 1 | 0 | 1 | 1 | 27 | 0.00 | W | +0.0u |
| 2026-05-28 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 1 | 4 | 2 | -59 | -0.60 | L | -2.5u |
| 2026-05-28 | MLB | TOTAL | over | 2.5 | 1.65 | -108 | 2 | 0 | 2 | 2 | -15 | 0.00 | L | -1.6u |
| 2026-05-28 | NBA | SPREAD | away | 5.0 | 1.00 | -110 | 1 | 2 | 3 | 0 | -1 | -0.90 | L | -1.0u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.50 | +118 | 5 | 1 | 6 | 5 | 19 | -0.90 | L | -2.5u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 0.75 | -135 | 2 | 0 | 2 | 1 | -26 | 1.00 | L | -0.8u |
| 2026-05-29 | MLB | ML | home | 5.0 | 3.75 | -124 | 2 | 1 | 3 | 3 | 12 | -1.00 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 1.65 | -106 | 2 | 0 | 2 | 3 | 12 | 0.00 | L | -1.6u |
| 2026-05-29 | MLB | ML | home | 4.0 | 2.50 | +120 | 1 | 0 | 1 | 1 | -1 | 0.40 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 2.25 | -112 | 2 | 0 | 2 | 3 | 33 | 0.00 | W | +2.0u |
| 2026-05-29 | MLB | SPREAD | away | 4.0 | 0.75 | +150 | 0 | 0 | 0 | 1 | 3 | -0.50 | L | -0.8u |
| 2026-05-29 | MLB | ML | away | 5.0 | 2.50 | +140 | 2 | 1 | 3 | 1 | -26 | 1.00 | L | -2.5u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 1.65 | -103 | 0 | 0 | 0 | 2 | -15 | 0.00 | W | +1.6u |
| 2026-05-29 | MLB | ML | away | 4.5 | 1.25 | -142 | 0 | 1 | 1 | -2 | 13 | -1.20 | W | +0.3u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 1.65 | -135 | 1 | 0 | 1 | 2 | -15 | 0.40 | W | +1.2u |
| 2026-05-29 | MLB | ML | home | 4.5 | 1.25 | -134 | 1 | 0 | 1 | 0 | -10 | -1.70 | W | +2.8u |
| 2026-05-29 | MLB | SPREAD | away | 5.0 | 2.25 | -184 | 0 | 0 | 0 | 2 | 7 | -1.00 | W | +1.2u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 0.75 | -109 | 1 | 0 | 1 | 2 | 12 | 0.00 | W | +0.7u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.75 | -106 | 2 | 1 | 3 | 2 | 33 | 0.70 | L | -2.8u |
| 2026-05-29 | MLB | SPREAD | home | 4.0 | 1.65 | -175 | 0 | 0 | 0 | 2 | -15 | -0.80 | L | -1.6u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 0.30 | +105 | 2 | 1 | 3 | 1 | 6 | 0.00 | W | +0.3u |
...
| 2026-05-30 | MLB | ML | away | 4.5 | 2.75 | -125 | 1 | 2 | 3 | 1 | 15 | -0.60 | W | +2.3u |
| 2026-05-30 | MLB | ML | home | 5.0 | 5.00 | -130 | 1 | 0 | 1 | 2 | -11 | -1.20 | L | -5.0u |
| 2026-05-30 | MLB | ML | away | 4.0 | 3.75 | -132 | 1 | 1 | 2 | 1 | 51 | -1.00 | W | +2.9u |
| 2026-05-30 | MLB | SPREAD | home | 3.0 | 0.75 | -143 | 0 | 1 | 1 | 0 | -7 | -1.40 | L | -0.8u |
...
| 2026-05-30 | MLB | TOTAL | over | 4.0 | 2.25 | -116 | 2 | 0 | 2 | 2 | 9 | 0.00 | W | +1.9u |
| 2026-05-30 | MLB | TOTAL | under | 4.0 | 1.65 | -107 | 1 | 0 | 1 | 1 | 6 | 0.00 | L | -1.6u |
| 2026-05-30 | MLB | ML | home | 4.0 | 2.50 | +129 | 1 | 0 | 1 | 1 | -18 | -0.90 | W | +0.7u |
| 2026-05-30 | MLB | SPREAD | home | 5.0 | 1.65 | -120 | 2 | 1 | 3 | 2 | -15 | -0.60 | W | +1.4u |
| 2026-05-30 | MLB | ML | away | 5.0 | 2.50 | +108 | 1 | 0 | 1 | 3 | -32 | -0.90 | W | +2.7u |
| 2026-05-30 | MLB | ML | home | 4.0 | 0.50 | +110 | 1 | 0 | 1 | 1 | -18 | -0.20 | W | +0.6u |
...
| 2026-05-31 | MLB | ML | away | 3.0 | 2.75 | -125 | -2 | 0 | -2 | 1 | -10 | -1.20 | L | -2.8u |
...
| 2026-05-31 | MLB | SPREAD | away | 5.0 | 1.00 | -117 | 3 | 1 | 4 | 3 | -10 | -0.20 | L | -1.0u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -164 | 0 | 1 | 1 | 2 | -14 | -1.20 | W | +2.3u |
| 2026-05-31 | MLB | ML | away | 3.0 | 1.25 | -184 | 0 | 0 | 0 | 0 | -20 | -1.70 | W | +0.7u |
| 2026-05-31 | MLB | ML | home | 2.5 | 1.25 | -232 | 0 | 0 | 0 | 1 | 31 | -0.50 | W | +0.5u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -102 | 0 | 1 | 1 | 2 | -45 | 0.20 | W | +4.9u |
| 2026-05-31 | MLB | TOTAL | over | 4.0 | 1.00 | +101 | 2 | 1 | 3 | 2 | -2 | 0.00 | L | -1.0u |
| 2026-05-31 | MLB | ML | away | 4.5 | 2.50 | +110 | 0 | 0 | 0 | 0 | -20 | -1.10 | L | -2.5u |
| 2026-06-01 | MLB | ML | home | 4.5 | 3.00 | -155 | 3 | 2 | 5 | 3 | 30 | -1.00 | W | +2.1u |
| 2026-06-01 | MLB | ML | away | 4.0 | 1.00 | +135 | 2 | 2 | 4 | 3 | 44 | -0.20 | W | +1.4u |
| 2026-06-01 | MLB | ML | away | 5.0 | 2.50 | +160 | 2 | -1 | 1 | 2 | 25 | -1.30 | W | +2.7u |
...
| 2026-06-01 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 1 | -22 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | ML | home | 2.5 | 0.25 | -215 | -1 | 0 | -1 | 0 | 18 | -1.40 | L | -0.3u |
| 2026-06-02 | MLB | TOTAL | under | 4.0 | 1.00 | -117 | 1 | 0 | 1 | 0 | 6 | 0.00 | L | -1.0u |
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +130 | 2 | 0 | 2 | 0 | 50 | -0.60 | W | +3.1u |
| 2026-06-02 | MLB | ML | away | 3.0 | 0.50 | +100 | 1 | 0 | 1 | 2 | 30 | -1.20 | W | +0.5u |
| 2026-06-02 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 9 | 0.00 | L | -3.0u |
...
| 2026-06-03 | MLB | TOTAL | under | 4.5 | 2.50 | -110 | 1 | 0 | 1 | 0 | 6 | 0.00 | W | +2.5u |
...
| 2026-06-03 | MLB | TOTAL | under | 4.5 | 2.50 | -110 | 1 | 0 | 1 | 0 | 6 | 0.00 | L | -2.5u |
| 2026-06-03 | NBA | ML | home | 2.5 | 0.25 | -198 | 3 | 4 | 7 | 5 | 15 | -1.20 | L | -0.3u |
| 2026-06-03 | NBA | SPREAD | away | 2.5 | 0.25 | -104 | 3 | -1 | 2 | 4 | 0 | -1.20 | W | +0.2u |
| 2026-06-04 | MLB | ML | away | 3.0 | 0.50 | +104 | 1 | 0 | 1 | 1 | 27 | 0.00 | W | +0.5u |
| 2026-06-04 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | -1 | 0 | 1 | 9 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | +102 | 0 | 0 | 0 | 1 | 27 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 5.0 | 2.50 | +118 | 1 | 1 | 2 | 1 | 53 | -0.40 | W | +3.0u |
| 2026-06-04 | MLB | SPREAD | away | 5.0 | 5.00 | -111 | 0 | 0 | 0 | 1 | 6 | 0.00 | L | -5.0u |
| 2026-06-04 | MLB | ML | home | 5.0 | 5.00 | -131 | 1 | 0 | 1 | 1 | 53 | 0.20 | W | +3.5u |
...
| 2026-06-04 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +2.7u |
...
| 2026-06-05 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | -1 | 18 | 0.00 | W | +2.8u |
| 2026-06-05 | MLB | ML | away | 3.0 | 0.50 | +128 | 1 | 0 | 1 | 1 | 6 | 0.00 | W | +0.6u |
| 2026-06-05 | MLB | TOTAL | over | 4.0 | 1.00 | -109 | 0 | 0 | 0 | 0 | 6 | 0.00 | P | +0.0u |
| 2026-06-05 | MLB | ML | home | 3.0 | 0.50 | -136 | 1 | 0 | 1 | 2 | 27 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 3 | 0 | 3 | 4 | 0 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | ML | away | 5.0 | 5.00 | -122 | 0 | 1 | 1 | 1 | 29 | -0.80 | L | -5.0u |
| 2026-06-05 | MLB | ML | home | 5.0 | 5.00 | -171 | 0 | 2 | 2 | 3 | 39 | -0.20 | W | +2.7u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -188 | 2 | 0 | 2 | 2 | 30 | -0.90 | W | +0.5u |
...
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 0 | -1 | -1 | 0 | 6 | 0.00 | W | +4.4u |
| 2026-06-05 | MLB | ML | away | 4.5 | 3.00 | -129 | -1 | 1 | 0 | -2 | 25 | -1.10 | W | +2.2u |
| 2026-06-05 | MLB | SPREAD | away | 3.0 | 0.50 | +126 | 1 | 0 | 1 | 1 | 6 | 0.00 | W | +0.6u |
...
| 2026-06-06 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -12 | 0.00 | W | +2.7u |
...
| 2026-06-06 | MLB | TOTAL | under | 5.0 | 2.50 | -110 | 0 | 0 | 0 | 0 | 6 | 0.00 | L | -2.5u |
...
| 2026-06-06 | MLB | ML | home | 5.0 | 2.50 | +117 | -2 | -1 | -3 | -1 | -5 | 0.00 | L | -2.5u |
