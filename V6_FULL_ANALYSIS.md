...
_Auto-generated **6/15/2026, 1:47:41 PM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 640 shipped+graded picks · 2026-04-18 → 2026-06-14  (HC analyses scoped to post-cutover 2026-04-30, 528 picks)
**Headline:** 322-310-8 · WR 50.9% [47.1%–54.8%] vs 52.4% break-even · -15.1u flat (-2.4%) · -58.5u peak.
**Overall t-test:** t = -0.60 → ✗ noise.
...
- **ρ(Δw, flat ROI) = -0.001 ✗**  (full sample, N=634)
- **ρ(HC, flat ROI) = -0.039 ✗**  (post-cutover, N=528)
- **ρ(Δw+HC, flat ROI) = -0.068 ✗**  (post-cutover, N=528)
...
- **Tier-1b (HC = +1)** — N=158, WR 55.7%, flat ROI +7.2%. Bayesian posterior WR ≈ 55.4%, half-Kelly = **3.1%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=88, WR 46.0%, flat ROI -14.0%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=105, WR 46.7%, flat ROI -5.9%. Bayesian posterior WR ≈ 47.0%, half-Kelly = **0.0%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -6.6% flat ROI on 164 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (0.99u/pick), we need **~1495 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 640. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **640** |
| W-L-P | 322-310-8 |
| Win rate | **50.9%** [47.1%–54.8%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +1.4 pp |
| Peak-units PnL | **-58.5u** |
| Flat-1u PnL | **-15.1u** (-2.4% flat ROI) |
| Flat t-statistic vs zero | -0.60 → ✗ noise |
| Flat 95% CI per-pick | [-0.100, 0.053]u |
...
We have **640** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = −1 | 24 | 8-15-1 | 34.8% [19–55] | -31.8% | -3.8u | -1.68 ~ p<.10 |
| Δw = 0 | 134 | 69-62-3 | 52.7% [44–61] | -0.5% | +15.3u | -0.06 ✗ noise |
| Δw = +1 | 232 | 124-105-3 | 54.1% [48–60] | +2.2% | -8.7u | 0.35 ✗ noise |
| Δw = +2 | 133 | 66-66-1 | 50.0% [42–58] | -3.0% | -30.5u | -0.35 ✗ noise |
| Δw ≥ +3 | 105 | 49-56-0 | 46.7% [37–56] | -5.9% | -31.5u | -0.54 ✗ noise |

**Pearson ρ(Δw, WIN) = -0.008** ✗  ·  **ρ(Δw, flat ROI) = -0.001** ✗  (N=634)
...
| HC = 0 | 303 | 149-147-7 | 50.3% [45–56] | -5.3% | -54.4u | -0.97 ✗ noise |
| HC = +1 | 158 | 88-70-0 | 55.7% [48–63] | +7.2% | +7.5u | 0.92 ✗ noise |
| HC = +2 | 31 | 16-15-0 | 51.6% [35–68] | -0.4% | -4.6u | -0.02 ✗ noise |
| HC ≥ +3 | 11 | 3-8-0 | 27.3% [10–57] | -60.6% | -9.1u | -2.98 ✓ p<.01 |

**Pearson ρ(HC, WIN) = -0.023** ✗  ·  **ρ(HC, flat ROI) = -0.039** ✗  (N=528)

Spearman rank ρ(HC, flat ROI) = 0.001.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 114 | 57-54-3 | 51.4% [42–60] | -2.1% | +12.7u | -0.24 ✗ noise |
| Σ = +1 | 159 | 86-70-3 | 55.1% [47–63] | +4.3% | -10.6u | 0.57 ✗ noise |
| Σ = +2 | 119 | 69-49-1 | 58.5% [49–67] | +9.4% | +9.8u | 1.09 ✗ noise |
| Σ = +3 | 57 | 23-34-0 | 40.4% [29–53] | -21.2% | -19.9u | -1.62 ✗ noise |
...
**Pearson ρ(Δw+HC, WIN) = -0.057** ✗  ·  **ρ(Σ, flat ROI) = -0.068** ✗  (N=528)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 528.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.064 ✗ | -0.069 ✗ | -0.048 | weak |
| HC margin | -0.023 ✗ | -0.039 ✗ | 0.001 | weak |
| Δw + HC | -0.057 ✗ | -0.068 ✗ | -0.035 | weak |
| peak.stars | -0.056 ✗ | -0.076 ~ p<.10 | -0.082 | weak |
| vault.star | -0.038 ✗ | -0.051 ✗ | -0.067 | weak |
| lock.stars | -0.035 ✗ | -0.048 ✗ | -0.050 | weak |
...
Universe N = 528 (post-cutover, both axes present).
...
| +0 | N=1 · 1-0 · 100% [21–100] · —  | N=2 · 0-2 · 0% [0–66] · —  | N=10 · 3-6 · 33% [12–65] · -36%  | N=77 · 40-35 · 53% [42–64] · +1%  | N=131 · 69-59 · 54% [45–62] · +2%  | N=57 · 30-26 · 54% [41–66] · -1%  | N=25 · 6-19 · 24% [11–43] · -56% ✗ |
| +1 | — | — | N=5 · 2-3 · 40% [12–77] · -27%  | N=26 · 15-11 · 58% [39–74] · +7%  | N=57 · 36-21 · 63% [50–74] · +20%  | N=35 · 17-18 · 49% [33–64] · -2%  | N=35 · 18-17 · 51% [36–67] · +1%  |
...
| Δw = −1 | 18 | 7-10-1 | 41.2% [22–64] | -20.5% | +0.6u | -0.92 ✗ noise |
| Δw = 0 | 111 | 62-47-2 | 56.9% [48–66] | +7.6% | +28.7u | 0.83 ✗ noise |
| Δw = +1 | 199 | 109-87-3 | 55.6% [49–62] | +4.9% | -4.2u | 0.74 ✗ noise |
| Δw = +2 | 108 | 55-52-1 | 51.4% [42–61] | -1.1% | -26.7u | -0.12 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 200 | 107-93-0 | 53.5% [47–60] | +2.3% | -6.2u | 0.33 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 88 | 40-47-1 | 46.0% [36–56] | -14.0% | -33.6u | -1.39 ✗ noise |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 240 | 124-110-6 | 53.0% [47–59] | +0.6% | -8.1u | 0.10 ✗ noise |
...
Universe N = 613 picks where ≥1 proven wallet appeared on either side.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δcount ≤ −2 (heavy oppose) | 8 | 4-4-0 | 50.0% [22–78] | -4.1% | -4.1u | -0.11 ✗ noise |
| Δcount = −1 | 38 | 19-19-0 | 50.0% [35–65] | -1.1% | -1.6u | -0.07 ✗ noise |
| Δcount = 0 (balanced) | 93 | 42-49-2 | 46.2% [36–56] | -11.5% | -4.5u | -1.15 ✗ noise |
| Δcount = +1 | 243 | 119-123-1 | 49.2% [43–55] | -7.7% | -65.3u | -1.27 ✗ noise |
| Δcount = +2 | 133 | 70-62-1 | 53.0% [45–61] | +0.8% | -6.2u | 0.09 ✗ noise |
| Δcount ≥ +3 (heavy support) | 98 | 59-36-3 | 62.1% [52–71] | +24.1% | +36.1u | 2.20 ✓ p<.05 |

**ρ(Δcount, WIN) = 0.059** ✗  ·  **ρ(Δcount, flat ROI) = 0.076** ~ p<.10
...
Quintile cuts: ≤ -15 · ≤ 1 · ≤ 7 · ≤ 22 · > 22

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 123 | 51-71-1 | 41.8% [33–51] | -19.0% | -58.5u | -2.19 ✓ p<.05 |
| Q2 | 134 | 60-73-1 | 45.1% [37–54] | -11.9% | -38.6u | -1.40 ✗ noise |
| Q3 (balanced) | 112 | 54-56-2 | 49.1% [40–58] | -7.8% | -14.6u | -0.87 ✗ noise |
| Q4 | 123 | 73-48-2 | 60.3% [51–69] | +17.1% | +30.6u | 1.92 ~ p<.10 |
| Q5 (best — heavy support) | 121 | 75-45-1 | 62.5% [54–71] | +17.8% | +35.7u | 1.94 ~ p<.10 |

**ρ(ΔWlNet, WIN) = 0.159** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.144** ✓ p<.01
...
Quintile cuts (units): ≤ -15.37 · ≤ -2.18 · ≤ 5.47 · ≤ 15.05 · > 15.05

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 123 | 52-69-2 | 43.0% [35–52] | -20.0% | -44.2u | -2.40 ✓ p<.05 |
| Q2 | 123 | 56-66-1 | 45.9% [37–55] | -13.3% | -22.7u | -1.55 ✗ noise |
| Q3 | 149 | 75-73-1 | 50.7% [43–59] | -4.9% | -21.0u | -0.63 ✗ noise |
| Q4 | 96 | 56-38-2 | 59.6% [49–69] | +14.1% | +6.9u | 1.43 ✗ noise |
| Q5 | 122 | 74-47-1 | 61.2% [52–69] | +24.0% | +35.6u | 2.44 ✓ p<.05 |
...
Quintile cuts (% ROI): ≤ -9.3 · ≤ -0.9 · ≤ 6.7 · ≤ 22.0 · > 22.0

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 124 | 37-86-1 | 30.1% [23–39] | -41.9% | -84.0u | -5.20 ✓ p<.01 |
| Q2 | 125 | 63-61-1 | 50.8% [42–59] | -7.0% | -6.2u | -0.84 ✗ noise |
| Q3 | 123 | 62-60-1 | 50.8% [42–60] | -3.0% | -29.5u | -0.34 ✗ noise |
| Q4 | 119 | 72-45-2 | 61.5% [52–70] | +18.9% | +38.1u | 2.15 ✓ p<.05 |
| Q5 | 122 | 79-41-2 | 65.8% [57–74] | +29.7% | +36.1u | 3.19 ✓ p<.01 |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 63 | 14-48-1 | 22.6% [14–34] | -54.8% | -46.5u | -5.20 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 14 | 6-8-0 | 42.9% [21–67] | -20.8% | -3.9u | -0.81 ✗ noise |
| ΔBestRank = 0 (tied) | 2 | 1-1-0 | 50.0% [9–91] | -4.5% | -1.4u | -0.05 ✗ noise |
| ΔBestRank ∈ [+1,+4] | 19 | 9-10-0 | 47.4% [27–68] | -7.4% | -0.8u | -0.31 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 165 | 96-66-3 | 59.3% [52–67] | +17.8% | +25.7u | 2.17 ✓ p<.05 |

**ρ(ΔBestRank, WIN) = 0.323** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.352** ✓ p<.01  (N=263)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 32 | 9-23-0 | 28.1% [16–45] | -45.9% | -19.2u | -2.89 ✓ p<.01 |
| Δshare ∈ [−30,−10] pp | 5 | 0-5-0 | 0.0% [0–43] | -100.0% | -3.3u | 0.00 ✗ noise |
| Δshare ≈ 0 (±10 pp) | 407 | 203-200-4 | 50.4% [46–55] | -5.0% | -45.1u | -1.06 ✗ noise |
| Δshare ∈ [+10,+30] pp | 26 | 14-11-1 | 56.0% [37–73] | +5.7% | +1.4u | 0.31 ✗ noise |
| Δshare ≥ +30 pp | 143 | 87-54-2 | 61.7% [53–69] | +23.2% | +20.6u | 2.62 ✓ p<.01 |

**ρ(ΔTopQShare, WIN) = 0.129** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.140** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔTopQCount** | 0.166 ✓ p<.01 | 0.206 ✓ p<.01 | 0.168 |
| 2 | **ΔWlNet** | 0.159 ✓ p<.01 | 0.144 ✓ p<.01 | 0.111 |
| 3 | **ΔTopQShare** | 0.129 ✓ p<.01 | 0.140 ✓ p<.01 | 0.160 |
| 4 | **Δcount** | 0.059 ✗ | 0.076 ~ p<.10 | 0.080 |
| 5 | **ΔFlatPnl** | NaN — | NaN — | 0.165 |
| 6 | **ΔAvgRoi** | NaN — | NaN — | 0.252 |

_(ΔBestRank uses N=263 subset where both sides had a proven wallet — ρ(flat ROI) = 0.352 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 1093, dateRange = 2026-04-18 → 2026-06-14, computedAt = 2026-06-15T17:38:15.364Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **613** rows · PIT aggregate computable on **610** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **610** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 426 · 55% · +4.2% | 361 · 52% · -2.5% | -6.8pp |
| WEAK (−3..0) | 167 · 45% · -12.5% | 232 · 52% · +2.7% | +15.2pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=340, WR=54%, ROI=+3.7% | N=271, WR=51%, ROI=-4.2% | -7.9pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=426, WR=55%, ROI=+4.2% | N=361, WR=52%, ROI=-2.5% | -6.8pp |
| AGS < −1 (mute veto) | N=57, WR=44%, ROI=-16.1% | N=143, WR=49%, ROI=-1.1% | +15.0pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-06-01 → 2026-06-14, N=224)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 111 · 55% · +2.0% |
| WEAK (−3..0) | 113 · 52% · +3.2% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=79, WR=57%, ROI=+6.4% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=111, WR=55%, ROI=+2.0% |
| AGS < −1 (mute veto) | N=78, WR=51%, ROI=+0.9% |
...
|---|---|---|---|---|
| `dCount` | COUNT | + | 1.01 | 1.45 |
| `dHcSizeRatio` | INTENSITY_HC | + | 0.89 | 4.36 |
| `dSumRankNorm` | QUALITY_RANK | − | 54.19 | 86.68 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.56 | 1.12 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **610/640** shipped+graded rows (95%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 100 | 50-48-2 | 51.0% [41–61] | -5.9% | -21.7u | -0.63 ✗ noise |
| LOCK | 106 | 48-58-0 | 45.3% [36–55] | -14.6% | -31.1u | -1.57 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 73 | 37-34-2 | 52.1% [41–63] | +0.4% | +6.2u | 0.03 ✗ noise |
| FADE | 150 | 71-76-3 | 48.3% [40–56] | -2.1% | -27.4u | -0.24 ✗ noise |
...
r(WIN) = **-0.017** ✗ · r(ROI) = **-0.044** ✗ · Spearman ρ(ROI) = **-0.050**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 138 | 71-65-2 | 52.2% [44–60] | +5.6% | -13.6u | 0.61 ✗ noise |
| z ∈ [−1, 0) | 206 | 110-93-3 | 54.2% [47–61] | +1.9% | +13.0u | 0.29 ✗ noise |
| z ∈ [0, +1) | 174 | 83-90-1 | 48.0% [41–55] | -9.2% | -42.3u | -1.26 ✗ noise |
...
| z ∈ [0, +1) | 576 | 293-275-8 | 51.6% [47–56] | -2.1% | -49.7u | -0.52 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.054** ✗ · r(ROI) = **-0.062** ✗ · Spearman ρ(ROI) = **-0.066**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 113 | 63-49-1 | 56.3% [47–65] | +4.3% | -2.6u | 0.49 ✗ noise |
| z ∈ [−1, 0) | 223 | 119-102-2 | 53.8% [47–60] | +5.3% | -6.3u | 0.77 ✗ noise |
| z ∈ [0, +1) | 203 | 94-105-4 | 47.2% [40–54] | -9.2% | -38.6u | -1.35 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.054 ✗ | -0.062 ✗ | -0.066 |
| 2 | `dCount` | COUNT | -0.017 ✗ | -0.044 ✗ | -0.050 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | -0.056 | 0.818 | 49.4% | dominant |
| 2 | `dSumRankNorm` | -0.127 | 0.800 | 48.3% | meaningful |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.031 | +0.732 ⚠ | +0.031 |
| `dHcSizeRatio` | +0.031 | 1.000 | +0.008 | +1.000 ⚠ |
| `dSumRankNorm` | +0.732 ⚠ | +0.008 | 1.000 | +0.008 |
| `dWinnerCtPreA` | +0.031 | +1.000 ⚠ | +0.008 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **-0.019**. At AGS ≥ +0.12 fires N=279, WR=50.9%, ROI=-4.9%. At AGS ≥ +null fires N=371, WR=51.6%, ROI=-3.6%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-279 ROI (matched cohort) | Top-279 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.069 | +0.049 | WR=56%, ROI=+7.1% | -12.0pp | N=311, WR=55%, ROI=+5.1% |
| `dHcSizeRatio` | +0.032 | +0.012 | WR=54%, ROI=+0.4% | -5.3pp | N=291, WR=55%, ROI=+2.2% |
| `dSumRankNorm` | -0.054 | +0.035 | WR=47%, ROI=-10.6% | +5.7pp | N=274, WR=48%, ROI=-9.0% |
| `dWinnerCtPreA` | +0.034 | +0.015 | WR=54%, ROI=+1.0% | -6.0pp | N=280, WR=54%, ROI=+1.3% |
...
|---|---|---|---|---|
| 1 | `dHcSizeRatio` | +0.012 | -5.3pp | redundant — other features cover it |
| 2 | `dWinnerCtPreA` | +0.015 | -6.0pp | redundant — other features cover it |
| 3 | `dSumRankNorm` | +0.035 | +5.7pp | redundant — other features cover it |
| 4 | `dCount` | +0.049 | -12.0pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.122 | 0.122 | negative ↓ |
| 2 | `dWinnerCtPreA` | QUALITY_TRACK | +0.033 | 0.033 | flat ≈ 0 |
| 3 | `dCount` | COUNT | +0.030 | 0.030 | flat ≈ 0 |
| 4 | `dHcSizeRatio` | INTENSITY_HC | +0.013 | 0.013 | flat ≈ 0 |

Intercept b = +0.007 · Final log-loss = 0.6910 · N = 610.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 610 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/610 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 204 | 96-108-0 | 47.1% [40–54] | -13.3% | -68.3u | -2.01 ✓ p<.05 |
| 4.5★ | 97 | 58-37-2 | 61.1% [51–70] | +16.2% | +27.2u | 1.64 ✗ noise |
| 4.0★ | 131 | 60-69-2 | 46.5% [38–55] | -10.0% | -13.5u | -1.16 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 83 | 44-36-3 | 55.0% [44–65] | +7.0% | -1.3u | 0.65 ✗ noise |
| 2.5★ | 87 | 45-41-1 | 52.3% [42–63] | +0.2% | -6.5u | 0.02 ✗ noise |

### §5b. Stars × Δw stratified — does the star tier hold up within each Δw cohort?

| Δw cohort | 5★ | 4.5★ | 4★ | 3.5★ | 3★ | 2.5★ |
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 32/63%/+12% | 27/59%/+15% | 29/36%/-29% | 6/33%/-26% | 31/38%/-28% | 38/51%/-2% |
| Δw = +1 | 40/48%/-13% | 41/59%/+9% | 62/48%/-9% | 28/54%/+4% | 30/67%/+29% | 30/57%/+4% |
| Δw = +2 | 63/44%/-15% | 15/60%/+12% | 33/55%/+6% | — | 13/58%/+15% | 9/44%/-5% |
...
| −200/−151 | 57 | 29-28-0 | 50.9% [38–63] | -19.2% | -22.1u | -1.81 ~ p<.10 |
| −150/−101 | 390 | 199-186-5 | 51.7% [47–57] | -2.9% | -21.4u | -0.60 ✗ noise |
| −100/+100 | 8 | 4-4-0 | 50.0% [22–78] | +0.0% | -0.8u | 0.00 ✗ noise |
| +101/+150 | 128 | 57-68-3 | 45.6% [37–54] | -0.4% | -38.1u | -0.04 ✗ noise |
...
| −200/−151 | -44% (17) | +10% (20) | +24% (9) | -84% (10) |
| −150/−101 | -1% (96) | +0% (152) | -14% (80) | -0% (59) |
| −100/+100 | -100% (2) | +50% (4) | -100% (1) | +100% (1) |
| +101/+150 | +4% (32) | -4% (45) | +10% (32) | -16% (19) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 347 | 172-174-1 | 49.7% [44–55] | -4.2% | -58.9u | -0.76 ✗ noise |
| SPREAD | 99 | 47-50-2 | 48.5% [39–58] | -10.4% | -4.9u | -1.11 ✗ noise |
| TOTAL | 194 | 103-86-5 | 54.5% [47–61] | +5.0% | +5.4u | 0.73 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=90 · 46% · -14% | N=118 · 55% · +4% | N=70 · 53% · +5% | N=66 · 41% · -15% |
| SPREAD | N=25 · 33% · -35% | N=38 · 54% · -1% | N=19 · 63% · +13% | N=16 · 38% · -27% |
| TOTAL | N=49 · 64% · +22% | N=76 · 53% · +1% | N=44 · 40% · -22% | N=23 · 70% · +34% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 460 | 237-218-5 | 52.1% [47–57] | -1.2% | -27.1u | -0.28 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=124 · 52% · -2% | N=189 · 54% · +2% | N=97 · 52% · -1% | N=49 · 45% · -14% |
...
|---|---|---|
| **sharps3Plus** | 253 · 45% · -10.4% · -1.62 ✗ noise | 386 · 54% · +2.6% · 0.53 ✗ noise |
| **plusEV** | 69 · 48% · -4.3% · -0.31 ✗ noise | 570 · 51% · -2.4% · -0.59 ✗ noise |
| **pinnacleConfirms** | 150 · 52% · +0.0% · 0.00 ✗ noise | 326 · 50% · -3.7% · -0.69 ✗ noise |
| **invested10kPlus** | 309 · 51% · -2.1% · -0.37 ✗ noise | 167 · 51% · -3.3% · -0.44 ✗ noise |
| **lineMovingWith** | 290 · 54% · +3.5% · 0.61 ✗ noise | 349 · 48% · -7.7% · -1.46 ✗ noise |
| **predMarketAligns** | 156 · 51% · -2.2% · -0.26 ✗ noise | 320 · 51% · -2.7% · -0.50 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 183 | 95-88-0 | 51.9% [45–59] | -0.1% | -2.6u | -0.02 ✗ noise |
| 1 | 134 | 65-64-5 | 50.4% [42–59] | -3.8% | -23.9u | -0.47 ✗ noise |
| 2 | 146 | 75-68-3 | 52.4% [44–60] | +0.3% | +1.0u | 0.04 ✗ noise |
| 3 | 56 | 27-29-0 | 48.2% [36–61] | -9.0% | -12.3u | -0.68 ✗ noise |
| 4 | 55 | 28-27-0 | 50.9% [38–64] | -7.1% | -9.9u | -0.55 ✗ noise |
...
| NEAR_START | 251 | 119-127-5 | 48.4% [42–55] | -5.8% | -58.0u | -0.90 ✗ noise |
| NO_MOVE | 20 | 10-10-0 | 50.0% [30–70] | -7.9% | +4.4u | -0.37 ✗ noise |
| PREGAME | 123 | 66-57-0 | 53.7% [45–62] | +2.9% | +3.8u | 0.33 ✗ noise |
| SMALL_MOVE | 135 | 66-67-2 | 49.6% [41–58] | -5.5% | -10.9u | -0.65 ✗ noise |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 352 | 176-173-3 | 50.4% [45–56] | -5.2% | -77.9u | -1.02 ✗ noise |
| STRONG | 98 | 49-47-2 | 51.0% [41–61] | +0.1% | -1.1u | 0.01 ✗ noise |
| LEAN | 182 | 93-86-3 | 52.0% [45–59] | +1.4% | +19.1u | 0.18 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.098 ✓ p<.05 | -0.077 ~ p<.10 | -0.059 | -1.96 |
| totalInvested | -0.065 ~ p<.10 | -0.078 ✓ p<.05 | -0.026 | -1.97 |
| evEdge | 0.086 ✓ p<.05 | 0.113 ✓ p<.01 | 0.048 | 2.86 |
| moneyPct | 0.025 ✗ | -0.003 ✗ | -0.019 | -0.08 |
| walletPct | 0.019 ✗ | 0.004 ✗ | -0.000 | 0.11 |
| criteriaMet | -0.016 ✗ | -0.011 ✗ | -0.041 | -0.27 |
| maxContribFor | -0.014 ✗ | -0.000 ✗ | 0.024 | -0.01 |
| meanBaseFor | 0.004 ✗ | 0.029 ✗ | 0.054 | 0.72 |
...
Sample with CLV: **627** picks. Mean CLV = **-0.0042**.
t-statistic vs zero: -3.52 → ✓ p<.01 · 95% CI [-0.0066, -0.0019]
...
| CLV (−2%, 0] | 369 | 185-178-6 | 51.0% [46–56] | -3.0% | -41.7u | -0.60 ✗ noise |
| CLV (0, +2%] | 163 | 85-78-0 | 52.1% [45–60] | +4.3% | -13.7u | 0.51 ✗ noise |
| CLV > +2% | 27 | 13-13-1 | 50.0% [32–68] | -6.2% | +2.8u | -0.33 ✗ noise |

ρ(CLV, flat ROI) = 0.084 ✓ p<.05
...
Trained on N=506 (with all features non-null). Intercept β₀ = 0.073.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | pw.ΔAvgRoi | +0.329 | ↑ helps |
| 2 | sharpCount | -0.294 | ↓ hurts |
| 3 | evEdge | +0.207 | ↑ helps |
| 4 | pw.ΔFlatPnl | +0.171 | ↑ helps |
| 5 | pw.Δcount | +0.168 | ↑ helps |
| 6 | peak.stars | -0.139 | ↓ hurts |
| 7 | log(impliedProb) | +0.114 | ↑ helps |
| 8 | vault.star | +0.107 | ↑ helps |
| 9 | odds (American) | -0.102 | ↓ hurts |
| 10 | pw.ΔWlNet | +0.096 | ↑ helps |
| 11 | HC margin | +0.056 | ↑ helps |
| 12 | log10(invested) | +0.054 | ↑ helps |
| 13 | Δw | -0.045 | ≈ flat |
| 14 | pw.ΔTopQShare | -0.037 | ≈ flat |
| 15 | moneyPct | -0.012 | ≈ flat |
| 16 | walletPct | -0.011 | ≈ flat |
| 17 | Δw + HC | -0.008 | ≈ flat |
| 18 | criteriaMet | -0.004 | ≈ flat |
...
| Tier-1b HC = +1 (post-cutover) | 158 | 88-70 | 55.7% | 55.4% | -110 | 3.13% bankroll | 2.10u | ~ in range — 3.13u |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 88 | 40-47 | 46.0% | 46.4% | -110 | — (mute) | 2.00u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 105 | 49-56 | 46.7% | 47.0% | -110 | — (mute) | 2.44u | **MUTE** (negative EV at posterior) |
| Stale Δw = 0 | 134 | 69-62 | 52.7% | 52.5% | -110 | 0.11% bankroll | 1.83u | **OVER-SIZED** — reduce to 0.11u |
| Stale Δw ≤ −1 | 30 | 10-19 | 34.5% | 38.5% | -116 | — (mute) | 1.32u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.155  (annualized × √252 ≈ -2.46)
...
| 2026-04-28 | MLB | ML | away | 5.0 | 2.00 | +112 | 2 | — | — | 2 | 5 | 0.00 | W | +2.2u |
...
| 2026-05-15 | MLB | ML | home | 4.0 | 2.50 | +128 | 0 | 0 | 0 | 1 | -3 | 0.00 | L | -2.5u |
...
| 2026-05-16 | MLB | ML | away | 2.5 | 0.50 | -102 | 1 | 0 | 1 | 1 | -45 | 0.00 | W | +0.5u |
...
| 2026-05-21 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 0 | 0 | 2 | -12 | 0.00 | W | +0.3u |
...
| 2026-05-23 | MLB | ML | away | 2.5 | 2.75 | +109 | 2 | 0 | 2 | 2 | -23 | -0.50 | L | -2.8u |
...
| 2026-05-23 | MLB | ML | home | 4.0 | 2.50 | +118 | 1 | 0 | 1 | 1 | -12 | 1.10 | W | +2.9u |
| 2026-05-23 | MLB | ML | away | 3.0 | 1.25 | +166 | 2 | 1 | 3 | 2 | -28 | -0.30 | W | +1.8u |
...
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 1 | 1 | 2 | 0 | -31 | 0.00 | L | -1.6u |
...
| 2026-05-24 | MLB | ML | home | 2.5 | 0.50 | +144 | 1 | 1 | 2 | -1 | -53 | 0.00 | L | -0.5u |
...
| 2026-05-24 | MLB | TOTAL | under | 2.5 | 0.30 | -104 | 0 | 0 | 0 | 1 | 10 | 0.00 | W | +0.3u |
| 2026-05-24 | MLB | ML | away | 4.0 | 1.25 | +148 | 2 | 2 | 4 | 0 | -23 | -1.40 | W | +1.9u |
| 2026-05-24 | MLB | ML | away | 3.0 | 1.25 | -122 | -1 | 1 | 0 | 0 | -34 | -1.10 | L | -1.3u |
| 2026-05-24 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 2 | -11 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | SPREAD | home | 3.0 | 0.75 | +134 | 1 | 0 | 1 | 1 | -5 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 0 | -27 | 0.00 | W | +0.7u |
...
| 2026-05-25 | MLB | ML | home | 4.0 | 1.25 | -125 | 1 | -1 | 0 | 1 | -17 | -1.90 | L | -1.3u |
| 2026-05-25 | MLB | SPREAD | away | 4.0 | 1.65 | -184 | 1 | 0 | 1 | 1 | -6 | 28.40 | W | +2.4u |
| 2026-05-25 | MLB | TOTAL | under | 5.0 | 2.25 | -112 | 4 | 0 | 4 | 4 | -9 | 0.00 | L | -2.3u |
...
| 2026-05-25 | MLB | TOTAL | under | 5.0 | 0.75 | -101 | 2 | 1 | 3 | 1 | 1 | 0.00 | W | +0.7u |
...
| 2026-05-26 | MLB | ML | away | 2.5 | 1.25 | +113 | 0 | 0 | 0 | 0 | 26 | -1.50 | W | +1.4u |
| 2026-05-26 | MLB | ML | home | 2.5 | 1.25 | -130 | 1 | 0 | 1 | 0 | 26 | -1.30 | W | +1.0u |
...
| 2026-05-27 | MLB | ML | home | 4.5 | 0.50 | -102 | 3 | 1 | 4 | 3 | 29 | -1.10 | W | +0.4u |
| 2026-05-27 | MLB | SPREAD | away | 5.0 | 2.50 | +141 | 1 | 1 | 2 | 4 | -16 | 0.80 | L | -2.5u |
...
| 2026-05-27 | MLB | TOTAL | under | 5.0 | 1.00 | -112 | 3 | 1 | 4 | 3 | -16 | 0.00 | W | +0.0u |
| 2026-05-27 | MLB | ML | away | 4.0 | 1.00 | -108 | 1 | -1 | 0 | 0 | 32 | -0.90 | L | -1.0u |
...
| 2026-05-27 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 2 | 5 | 3 | -17 | -0.30 | L | -2.5u |
...
| 2026-05-27 | MLB | SPREAD | away | 5.0 | 3.00 | -135 | 0 | 0 | 0 | 3 | 3 | -0.90 | W | +2.2u |
...
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 0.75 | -135 | 2 | 0 | 2 | 1 | -25 | 1.00 | L | -0.8u |
...
| 2026-05-29 | MLB | ML | away | 4.5 | 1.25 | -142 | 0 | 1 | 1 | -1 | 19 | -1.20 | W | +0.3u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 1.65 | -135 | 1 | 0 | 1 | 2 | -19 | 0.40 | W | +1.2u |
| 2026-05-29 | MLB | ML | home | 4.5 | 1.25 | -134 | 1 | 0 | 1 | 0 | -6 | -1.70 | W | +2.8u |
| 2026-05-29 | MLB | SPREAD | away | 5.0 | 2.25 | -184 | 0 | 0 | 0 | 2 | 3 | -1.00 | W | +1.2u |
...
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 0.30 | +105 | 2 | 1 | 3 | 1 | 5 | 0.00 | W | +0.3u |
...
| 2026-05-30 | MLB | ML | home | 5.0 | 5.00 | -130 | 1 | 0 | 1 | 2 | -15 | -1.20 | L | -5.0u |
| 2026-05-30 | MLB | ML | away | 4.0 | 3.75 | -132 | 1 | 1 | 2 | 1 | 53 | -1.00 | W | +2.9u |
...
| 2026-05-30 | MLB | ML | home | 4.0 | 2.75 | -130 | 0 | 1 | 1 | 0 | 26 | -1.60 | W | +0.4u |
| 2026-05-30 | MLB | TOTAL | over | 4.0 | 2.25 | -116 | 2 | 0 | 2 | 2 | 8 | 0.00 | W | +1.9u |
| 2026-05-30 | MLB | TOTAL | under | 4.0 | 1.65 | -107 | 1 | 0 | 1 | 1 | 8 | 0.00 | L | -1.6u |
...
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -122 | 1 | 1 | 2 | 2 | -23 | -0.20 | L | -3.8u |
...
| 2026-05-31 | MLB | TOTAL | over | 4.0 | 1.00 | +101 | 2 | 1 | 3 | 2 | -6 | 0.00 | L | -1.0u |
...
| 2026-06-01 | MLB | ML | away | 5.0 | 2.50 | +160 | 2 | -1 | 1 | 2 | 38 | -1.30 | W | +2.7u |
| 2026-06-01 | MLB | TOTAL | under | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 2 | -32 | 0.00 | L | -1.0u |
| 2026-06-01 | MLB | ML | home | 3.0 | 0.50 | -142 | -1 | 0 | -1 | -1 | 25 | -0.40 | L | -0.5u |
| 2026-06-01 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 2 | 0.00 | L | -5.0u |
| 2026-06-01 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 2 | -34 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | ML | home | 2.5 | 0.25 | -215 | -1 | 0 | -1 | 0 | -1 | -1.40 | L | -0.3u |
...
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +102 | 0 | -1 | -1 | 0 | -6 | 0.00 | L | -2.5u |
...
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +125 | 0 | -1 | -1 | 0 | 56 | 0.40 | W | +1.3u |
| 2026-06-03 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 39 | 0.00 | L | -3.0u |
| 2026-06-03 | MLB | ML | home | 4.5 | 1.50 | +167 | 0 | 0 | 0 | -1 | 22 | -0.40 | L | -1.5u |
| 2026-06-03 | MLB | SPREAD | away | 4.0 | 1.00 | -111 | 1 | 0 | 1 | 0 | 8 | 0.20 | W | +0.8u |
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -103 | 3 | 1 | 4 | 3 | 4 | -1.20 | L | -0.5u |
| 2026-06-03 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | -3 | 0.00 | L | -5.0u |
| 2026-06-03 | MLB | ML | away | 3.0 | 0.50 | +119 | 1 | 0 | 1 | 1 | 26 | 0.00 | W | +0.6u |
| 2026-06-03 | MLB | ML | away | 4.5 | 3.00 | -137 | 0 | 0 | 0 | -1 | 45 | -1.50 | L | -3.0u |
...
| 2026-06-04 | MLB | ML | away | 3.0 | 0.50 | +104 | 1 | 0 | 1 | 1 | 26 | 0.00 | W | +0.5u |
| 2026-06-04 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | -1 | 0 | 1 | 16 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | +102 | 0 | 0 | 0 | 1 | 26 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 5.0 | 2.50 | +118 | 1 | 1 | 2 | 1 | 65 | -0.40 | W | +3.0u |
| 2026-06-04 | MLB | SPREAD | away | 5.0 | 5.00 | -111 | 0 | 0 | 0 | 1 | 8 | 0.00 | L | -5.0u |
...
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -188 | 0 | 0 | 0 | 0 | 26 | -1.10 | L | -1.0u |
| 2026-06-04 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 16 | 0.00 | W | +2.7u |
| 2026-06-04 | MLB | ML | home | 3.0 | 0.50 | -235 | 4 | 0 | 4 | 4 | 13 | 0.00 | L | -0.5u |
...
| 2026-06-05 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | -1 | 30 | 0.00 | W | +2.8u |
| 2026-06-05 | MLB | ML | away | 3.0 | 0.50 | +128 | 1 | 0 | 1 | 1 | 8 | 0.00 | W | +0.6u |
| 2026-06-05 | MLB | TOTAL | over | 4.0 | 1.00 | -109 | 0 | 0 | 0 | 0 | 7 | 0.00 | P | +0.0u |
| 2026-06-05 | MLB | ML | home | 3.0 | 0.50 | -136 | 1 | 0 | 1 | 2 | 28 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 3 | 0 | 3 | 4 | -4 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | ML | away | 5.0 | 5.00 | -122 | 0 | 1 | 1 | 1 | 39 | -0.80 | L | -5.0u |
| 2026-06-05 | MLB | ML | home | 5.0 | 5.00 | -171 | 0 | 2 | 2 | 3 | 42 | -0.20 | W | +2.7u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -188 | 2 | 0 | 2 | 2 | 26 | -0.90 | W | +0.5u |
| 2026-06-05 | MLB | ML | away | 4.0 | 1.00 | -105 | 1 | 0 | 1 | 1 | 26 | 0.00 | L | -1.0u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -141 | 3 | 2 | 5 | 3 | 11 | 0.30 | W | +0.7u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 2.50 | -110 | 0 | 1 | 1 | -1 | 39 | 0.00 | W | +2.5u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -172 | 1 | 0 | 1 | 1 | 26 | 0.00 | L | -1.0u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 0 | -1 | -1 | 0 | 7 | 0.00 | W | +4.4u |
| 2026-06-05 | MLB | ML | away | 4.5 | 3.00 | -129 | -1 | 1 | 0 | -2 | 37 | -1.10 | W | +2.2u |
| 2026-06-05 | MLB | SPREAD | away | 3.0 | 0.50 | +126 | 1 | 0 | 1 | 1 | 8 | 0.00 | W | +0.6u |
...
| 2026-06-06 | MLB | ML | home | 4.5 | 3.00 | -126 | 0 | 0 | 0 | 0 | 26 | -1.00 | W | +2.4u |
| 2026-06-06 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -11 | 0.00 | W | +2.7u |
| 2026-06-06 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 1 | 1 | -1 | 20 | 0.00 | L | -1.0u |
...
| 2026-06-07 | MLB | ML | home | 5.0 | 5.00 | -143 | 1 | 0 | 1 | 1 | 8 | 0.00 | W | +3.5u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -11 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -136 | 1 | 0 | 1 | 0 | 49 | 0.00 | W | +0.7u |
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -165 | 2 | 2 | 4 | 3 | 3 | -1.10 | W | +1.8u |
| 2026-06-07 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 1 | 3 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | -107 | 1 | 0 | 1 | -1 | 57 | -0.80 | W | +0.2u |
| 2026-06-07 | MLB | TOTAL | over | 2.5 | 0.25 | -115 | 0 | 0 | 0 | -1 | -9 | 0.00 | W | +0.2u |
...
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 3.00 | -152 | 2 | 0 | 2 | 2 | 8 | -0.50 | W | +1.9u |
| 2026-06-07 | MLB | TOTAL | over | 5.0 | 2.25 | -114 | 1 | 1 | 2 | 0 | -7 | 0.00 | L | -2.3u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | +102 | 1 | 0 | 1 | -2 | 22 | -0.20 | W | +0.5u |
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 2.25 | +164 | 1 | 1 | 2 | 1 | 0 | 29.50 | W | +3.7u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | +103 | -1 | 0 | -1 | -2 | -6 | 0.20 | W | +0.3u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | -1 | 0 | 2 | 7 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -102 | 2 | 0 | 2 | 0 | 26 | 0.50 | W | +1.0u |
| 2026-06-07 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 10 | 0.00 | W | +4.8u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | -127 | 0 | 1 | 1 | -1 | 57 | -1.90 | W | +0.4u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -3 | 0.00 | W | +0.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -113 | 6 | 1 | 7 | 6 | 30 | -0.50 | L | -3.0u |
| 2026-06-08 | MLB | ML | home | 4.5 | 3.00 | -129 | 3 | 0 | 3 | 1 | 60 | -0.40 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | -1 | 7 | 0.00 | L | -3.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -121 | 1 | 1 | 2 | 0 | 39 | -1.60 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 3 | 10 | 0.00 | P | +0.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -146 | 1 | 0 | 1 | -1 | 45 | -0.50 | W | +2.0u |
| 2026-06-08 | MLB | ML | home | 4.0 | 1.00 | -118 | 2 | 0 | 2 | 1 | -21 | -0.40 | L | -1.0u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 2.50 | -116 | -2 | -2 | -4 | -1 | 38 | 0.00 | W | +2.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 1.50 | +151 | 0 | -1 | -1 | 1 | 2 | 0.00 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 5.0 | 2.50 | +101 | 0 | 0 | 0 | -1 | 12 | 0.00 | W | +2.5u |
...
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | +132 | 1 | 0 | 1 | 2 | 35 | -1.20 | L | -0.3u |
| 2026-06-09 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 16 | 0.00 | W | +4.3u |
| 2026-06-09 | MLB | ML | away | 3.0 | 0.50 | -148 | 1 | 0 | 1 | 2 | 26 | 0.00 | L | -0.5u |
...
| 2026-06-10 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 0 | 13 | 0.00 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 4.5 | 3.00 | -148 | 0 | 0 | 0 | 1 | 8 | -0.50 | L | -3.0u |
...
| 2026-06-10 | MLB | ML | away | 3.0 | 0.50 | +136 | 0 | 0 | 0 | -1 | 15 | 0.00 | L | -0.5u |
...
| 2026-06-10 | MLB | ML | home | 4.0 | 1.00 | +178 | 1 | 0 | 1 | -1 | 30 | -1.40 | W | +1.7u |
| 2026-06-10 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 3 | 0 | 3 | 0 | 8 | 0.00 | W | +4.5u |
| 2026-06-10 | MLB | ML | away | 5.0 | 5.00 | -104 | 0 | 0 | 0 | 1 | 8 | -0.20 | L | -5.0u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | +148 | 0 | 0 | 0 | 1 | 26 | -0.80 | W | +1.5u |
...
| 2026-06-10 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 23 | 0.00 | W | +3.0u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | -120 | 1 | 0 | 1 | 1 | 26 | -0.40 | W | +0.8u |
| 2026-06-10 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | -1 | 0 | -1 | 1 | 8 | 0.00 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 5.0 | 5.00 | -106 | 1 | 0 | 1 | 0 | 46 | -0.70 | L | -5.0u |
| 2026-06-10 | MLB | SPREAD | home | 2.5 | 1.00 | -190 | 0 | 0 | 0 | 1 | -23 | -31.40 | L | -1.0u |
| 2026-06-10 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 4 | 1 | 5 | 0 | -3 | 0.00 | L | -5.0u |
| 2026-06-10 | NBA | ML | away | 2.5 | 0.25 | +112 | -2 | 0 | -2 | -3 | -11 | 0.20 | L | -0.3u |
| 2026-06-10 | NBA | TOTAL | under | 2.5 | 0.25 | -108 | 4 | 1 | 5 | 3 | 9 | 0.00 | W | +0.2u |
| 2026-06-11 | MLB | ML | away | 4.0 | 1.00 | +112 | 0 | 0 | 0 | 1 | 5 | 0.00 | L | -1.0u |
| 2026-06-11 | MLB | ML | away | 3.0 | 0.50 | -120 | -1 | 0 | -1 | 3 | -15 | -1.70 | P | +0.0u |
...
| 2026-06-11 | MLB | TOTAL | under | 5.0 | 1.00 | -108 | 1 | 1 | 2 | 0 | -9 | 0.00 | L | -1.0u |
| 2026-06-11 | MLB | ML | away | 5.0 | 1.00 | +110 | 3 | 1 | 4 | 3 | 3 | -0.90 | L | -1.0u |
...
| 2026-06-11 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | -1 | -1 | -2 | 0 | 5 | 0.00 | W | +0.2u |
...
| 2026-06-12 | MLB | TOTAL | over | 4.0 | 1.00 | +100 | 0 | 0 | 0 | 0 | 7 | 0.00 | L | -1.0u |
| 2026-06-12 | MLB | ML | home | 3.0 | 0.50 | -210 | 2 | 0 | 2 | 1 | 26 | -0.10 | W | +0.2u |
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +111 | 3 | 1 | 4 | 3 | 3 | -0.70 | L | -0.3u |
| 2026-06-12 | MLB | ML | away | 4.0 | 1.00 | -114 | 2 | 0 | 2 | 0 | 8 | -1.20 | W | +0.9u |
| 2026-06-12 | MLB | ML | home | 5.0 | 2.50 | +123 | 0 | 1 | 1 | 1 | -3 | 0.00 | W | +3.1u |
| 2026-06-12 | MLB | SPREAD | away | 4.0 | 1.00 | +121 | 0 | 0 | 0 | 1 | 7 | 0.40 | L | -1.0u |
| 2026-06-12 | MLB | ML | home | 4.5 | 3.00 | -138 | 1 | 0 | 1 | 1 | 26 | -1.00 | L | -3.0u |
| 2026-06-12 | MLB | SPREAD | home | 3.0 | 0.50 | -107 | 2 | 0 | 2 | 2 | 9 | -0.40 | W | +0.4u |
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +118 | -1 | 0 | -1 | -1 | -7 | -0.20 | L | -0.3u |
| 2026-06-12 | MLB | ML | away | 4.0 | 1.00 | -136 | 2 | 0 | 2 | 1 | 26 | -1.30 | W | +0.7u |
| 2026-06-12 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | 1 | 7 | 0.00 | W | +2.7u |
| 2026-06-12 | MLB | ML | home | 3.0 | 0.50 | -134 | 2 | 0 | 2 | 2 | 26 | -1.10 | W | +0.4u |
| 2026-06-12 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 3 | 0.00 | W | +2.7u |
| 2026-06-12 | MLB | SPREAD | away | 4.0 | 1.00 | -106 | 1 | 0 | 1 | 1 | 8 | -1.00 | L | -1.0u |
| 2026-06-13 | MLB | ML | away | 5.0 | 5.00 | -128 | 3 | 0 | 3 | 1 | 60 | -0.20 | L | -5.0u |
| 2026-06-13 | MLB | SPREAD | away | 4.0 | 1.00 | +123 | 1 | 0 | 1 | 1 | 8 | 0.00 | L | -1.0u |
| 2026-06-13 | MLB | ML | away | 4.5 | 3.00 | -102 | 0 | 0 | 0 | 1 | 8 | -2.00 | W | +2.9u |
| 2026-06-13 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 0 | 0 | 0 | 0 | 4 | 0.00 | W | +4.5u |
| 2026-06-13 | MLB | ML | away | 2.5 | 0.25 | -118 | 0 | 0 | 0 | -2 | 50 | -1.30 | W | +0.2u |
| 2026-06-13 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 8 | 0.00 | W | +2.7u |
| 2026-06-13 | MLB | ML | away | 4.5 | 2.50 | +136 | 1 | 0 | 1 | -1 | -24 | 1.30 | L | -2.5u |
| 2026-06-13 | MLB | ML | home | 5.0 | 2.50 | +134 | 2 | 0 | 2 | 0 | 8 | 0.00 | W | +3.4u |
| 2026-06-13 | MLB | SPREAD | home | 4.0 | 1.00 | -130 | 1 | 0 | 1 | 1 | 8 | 0.00 | W | +0.8u |
| 2026-06-13 | MLB | SPREAD | away | 4.0 | 1.00 | -120 | 1 | 0 | 1 | 1 | 8 | 0.20 | W | +0.8u |
| 2026-06-13 | MLB | ML | away | 4.5 | 2.50 | +114 | 1 | 0 | 1 | 0 | 8 | 0.00 | L | -2.5u |
| 2026-06-13 | MLB | TOTAL | under | 4.0 | 1.00 | +101 | 0 | 0 | 0 | 0 | 7 | 0.00 | W | +1.0u |
| 2026-06-13 | MLB | ML | home | 4.5 | 3.00 | -157 | 0 | 0 | 0 | -1 | 14 | 0.00 | L | -3.0u |
| 2026-06-13 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 1 | 0 | 1 | 2 | 8 | 0.00 | W | +0.5u |
| 2026-06-13 | MLB | ML | home | 5.0 | 5.00 | -115 | 1 | 1 | 2 | -1 | 26 | -0.40 | W | +4.3u |
| 2026-06-13 | MLB | SPREAD | away | 4.0 | 1.00 | -106 | 0 | 0 | 0 | 1 | 8 | 0.00 | L | -1.0u |
| 2026-06-13 | MLB | ML | home | 4.0 | 1.00 | -112 | 0 | 0 | 0 | 1 | 8 | -1.30 | W | +0.8u |
| 2026-06-13 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 2 | 0.00 | L | -5.0u |
| 2026-06-13 | NBA | ML | home | 2.5 | 0.25 | -205 | 6 | 6 | 12 | 6 | -27 | 0.60 | L | -0.3u |
| 2026-06-14 | MLB | ML | away | 4.0 | 1.00 | +106 | 1 | 1 | 2 | 2 | -9 | -1.50 | L | -1.0u |
| 2026-06-14 | MLB | ML | home | 2.5 | 0.25 | -124 | 1 | 0 | 1 | 2 | -41 | -1.50 | W | +0.2u |
| 2026-06-14 | MLB | SPREAD | away | 5.0 | 5.00 | -180 | 1 | 0 | 1 | 0 | 7 | 0.00 | L | -5.0u |
| 2026-06-14 | MLB | ML | home | 5.0 | 5.00 | -192 | 1 | 0 | 1 | 1 | 2 | 0.00 | L | -5.0u |
| 2026-06-14 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 8 | 0.00 | L | -3.0u |
| 2026-06-14 | MLB | ML | away | 4.5 | 2.50 | +106 | 0 | 0 | 0 | 1 | 8 | 0.00 | L | -2.5u |
| 2026-06-14 | MLB | SPREAD | away | 4.5 | 3.00 | -116 | 2 | 0 | 2 | 1 | 2 | 0.00 | L | -3.0u |
| 2026-06-14 | MLB | SPREAD | away | 4.0 | 1.00 | -158 | 1 | -1 | 0 | 2 | 8 | 0.10 | W | +0.6u |
| 2026-06-14 | MLB | ML | away | 4.0 | 1.00 | -125 | 2 | 1 | 3 | 3 | 17 | -1.20 | W | +0.8u |
| 2026-06-14 | MLB | ML | away | 4.5 | 3.00 | -101 | 1 | 0 | 1 | 1 | 8 | 0.00 | L | -3.0u |
| 2026-06-14 | MLB | ML | away | 2.5 | 0.25 | -115 | 2 | 0 | 2 | 2 | 26 | 0.00 | W | +0.2u |
