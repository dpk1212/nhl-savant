...
_Auto-generated **5/8/2026, 10:46:27 AM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 142 shipped+graded picks · 2026-04-18 → 2026-05-07  (HC analyses scoped to post-cutover 2026-04-30, 31 picks)
**Headline:** 66-74-2 · WR 47.1% [39.1%–55.4%] vs 52.4% break-even · -7.8u flat (-5.5%) · -16.1u peak.
**Overall t-test:** t = -0.61 → ✗ noise.
...
- **ρ(Δw, flat ROI) = 0.287 ✓ p<.01**  (full sample, N=137)
- **ρ(HC, flat ROI) = 0.117 ✗**  (post-cutover, N=31)
- **ρ(Δw+HC, flat ROI) = 0.171 ✗**  (post-cutover, N=31)
...
- **Tier-1b (HC = +1)** — N=21, WR 52.4%, flat ROI +6.6%. Bayesian posterior WR ≈ 51.6%, half-Kelly = **0.0%** bankroll at −110.
...
- **Sample size:** at observed σ (1.08u/pick), we need **~1787 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 142. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **142** |
| W-L-P | 66-74-2 |
| Win rate | **47.1%** [39.1%–55.4%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +5.2 pp |
| Peak-units PnL | **-16.1u** |
| Flat-1u PnL | **-7.8u** (-5.5% flat ROI) |
| Flat t-statistic vs zero | -0.61 → ✗ noise |
| Flat 95% CI per-pick | [-0.233, 0.122]u |
...
We have **142** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = +1 | 48 | 25-22-1 | 53.2% [39–67] | +1.0% | -2.3u | 0.07 ✗ noise |
| Δw = +2 | 30 | 13-17-0 | 43.3% [27–61] | -9.8% | -8.9u | -0.50 ✗ noise |
| Δw ≥ +3 | 24 | 16-8-0 | 66.7% [47–82] | +49.1% | +13.9u | 1.70 ~ p<.10 |

**Pearson ρ(Δw, WIN) = 0.260** ✓ p<.01  ·  **ρ(Δw, flat ROI) = 0.287** ✓ p<.01  (N=137)
...
| HC = +1 | 21 | 11-10-0 | 52.4% [32–72] | +6.6% | -3.2u | 0.28 ✗ noise |
| HC = +2 | 0 | — | — | — | — | — |
| HC ≥ +3 | 0 | — | — | — | — | — |

**Pearson ρ(HC, WIN) = 0.127** ✗  ·  **ρ(HC, flat ROI) = 0.117** ✗  (N=31)

Spearman rank ρ(HC, flat ROI) = 0.119.
...
| Σ = +2 | 12 | 8-4-0 | 66.7% [39–86] | +28.2% | -0.9u | 1.01 ✗ noise |
...
**Pearson ρ(Δw+HC, WIN) = 0.174** ✗  ·  **ρ(Σ, flat ROI) = 0.171** ✗  (N=31)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 31.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | 0.113 ✗ | 0.115 ✗ | 0.133 | weak |
| HC margin | 0.127 ✗ | 0.117 ✗ | 0.119 | weak |
| Δw + HC | 0.174 ✗ | 0.171 ✗ | 0.241 | weak |
| peak.stars | -0.119 ✗ | -0.095 ✗ | -0.044 | weak |
| vault.star | -0.075 ✗ | -0.036 ✗ | 0.017 | weak |
| lock.stars | -0.067 ✗ | -0.043 ✗ | 0.034 | weak |
...
Universe N = 31 (post-cutover, both axes present).
...
| +1 | — | — | N=1 · 0-1 · 0% [0–79] · —  | N=4 · 1-3 · 25% [5–70] · -51%  | N=9 · 7-2 · 78% [45–94] · +50%  | N=4 · 1-3 · 25% [5–70] · -26%  | N=3 · 2-1 · 67% [21–94] · +31%  |
| +2 | — | — | — | — | — | — | — |
| ≥ +3 | — | — | — | — | — | — | — |
...
| Δw = +1 | 15 | 10-4-1 | 71.4% [45–88] | +34.7% | +2.2u | 1.52 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 21 | 11-10-0 | 52.4% [32–72] | +6.6% | -3.2u | 0.28 ✗ noise |
...
Universe N = 110 picks where ≥1 proven wallet appeared on either side.
...
Quintile cuts: ≤ -2 · ≤ 3 · ≤ 5 · ≤ 9 · > 9

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 26 | 6-20-0 | 23.1% [11–42] | -51.2% | -21.7u | -2.78 ✓ p<.01 |
| Q2 | 31 | 15-16-0 | 48.4% [32–65] | -5.8% | -12.3u | -0.33 ✗ noise |
| Q3 (balanced) | 10 | 6-4-0 | 60.0% [31–83] | +8.3% | +4.4u | 0.27 ✗ noise |
| Q4 | 25 | 16-9-0 | 64.0% [45–80] | +45.7% | +16.7u | 1.62 ✗ noise |
| Q5 (best — heavy support) | 18 | 12-5-1 | 70.6% [47–87] | +28.9% | +7.2u | 1.39 ✗ noise |

**ρ(ΔWlNet, WIN) = 0.331** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.300** ✓ p<.01
...
Quintile cuts (units): ≤ -0.97 · ≤ 2.54 · ≤ 5.65 · ≤ 9.20 · > 9.20

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 23 | 5-18-0 | 21.7% [10–42] | -57.8% | -18.0u | -3.33 ✓ p<.01 |
| Q2 | 24 | 11-13-0 | 45.8% [28–65] | -13.2% | -13.8u | -0.66 ✗ noise |
| Q3 | 20 | 8-12-0 | 40.0% [22–61] | -26.6% | -3.8u | -1.27 ✗ noise |
| Q4 | 22 | 18-4-0 | 81.8% [61–93] | +62.7% | +16.2u | 3.48 ✓ p<.01 |
| Q5 | 21 | 13-7-1 | 65.0% [43–82] | +49.1% | +13.7u | 1.54 ✗ noise |

**ρ(ΔFlatPnl, WIN) = 0.360** ✓ p<.01  ·  **ρ(ΔFlatPnl, flat ROI) = 0.434** ✓ p<.01
...
Quintile cuts (% ROI): ≤ -15.8 · ≤ 12.1 · ≤ 19.9 · ≤ 28.9 · > 28.9

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 23 | 3-20-0 | 13.0% [5–32] | -71.3% | -26.1u | -4.51 ✓ p<.01 |
| Q2 | 24 | 8-16-0 | 33.3% [18–53] | -30.2% | -13.2u | -1.35 ✗ noise |
| Q3 | 20 | 11-9-0 | 55.0% [34–74] | +8.0% | -2.0u | 0.34 ✗ noise |
| Q4 | 22 | 16-5-1 | 76.2% [55–89] | +40.5% | +11.2u | 2.27 ✓ p<.05 |
| Q5 | 21 | 17-4-0 | 81.0% [60–92] | +73.7% | +24.4u | 2.75 ✓ p<.01 |

**ρ(ΔAvgRoi, WIN) = 0.447** ✓ p<.01  ·  **ρ(ΔAvgRoi, flat ROI) = 0.434** ✓ p<.01
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 14 | 2-12-0 | 14.3% [4–40] | -67.5% | -16.7u | -3.05 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 4 | 1-3-0 | 25.0% [5–70] | -52.3% | -2.9u | -1.10 ✗ noise |
| ΔBestRank = 0 (tied) | 0 | — | — | — | — | — |
| ΔBestRank ∈ [+1,+4] | 6 | 2-4-0 | 33.3% [10–70] | -38.1% | -4.3u | -0.97 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 13 | 5-7-1 | 41.7% [19–68] | +0.4% | -0.0u | 0.01 ✗ noise |

**ρ(ΔBestRank, WIN) = 0.293** ~ p<.10  ·  **ρ(ΔBestRank, flat ROI) = 0.332** ✓ p<.05  (N=37)
...
| Δshare ≈ 0 (±10 pp) | 65 | 28-36-1 | 43.8% [32–56] | -18.8% | -29.1u | -1.62 ✗ noise |
| Δshare ∈ [+10,+30] pp | 3 | 2-1-0 | 66.7% [21–94] | +96.7% | +5.8u | 0.85 ✗ noise |
| Δshare ≥ +30 pp | 31 | 23-8-0 | 74.2% [57–86] | +58.6% | +26.8u | 2.71 ✓ p<.01 |

**ρ(ΔTopQShare, WIN) = 0.292** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.279** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **Δcount** | 0.402 ✓ p<.01 | 0.482 ✓ p<.01 | 0.406 |
| 2 | **ΔTopQCount** | 0.379 ✓ p<.01 | 0.441 ✓ p<.01 | 0.379 |
| 3 | **ΔAvgRoi** | 0.447 ✓ p<.01 | 0.434 ✓ p<.01 | 0.438 |
| 4 | **ΔFlatPnl** | 0.360 ✓ p<.01 | 0.434 ✓ p<.01 | 0.369 |
| 5 | **ΔWlNet** | 0.331 ✓ p<.01 | 0.300 ✓ p<.01 | 0.290 |
| 6 | **ΔTopQShare** | 0.292 ✓ p<.01 | 0.279 ✓ p<.01 | 0.328 |

_(ΔBestRank uses N=37 subset where both sides had a proven wallet — ρ(flat ROI) = 0.332 ✓ p<.05.)_
...
| 3.5★ | 29 | 13-16-0 | 44.8% [28–62] | +2.4% | +0.5u | 0.10 ✗ noise |
...
| Δw = +1 | 1/100%/+27% | 3/33%/-35% | 11/60%/+15% | 20/50%/-1% | 2/0%/-100% | 10/60%/+9% |
...
| −150/−101 | 79 | 39-39-1 | 50.0% [39–61] | -5.1% | -3.9u | -0.48 ✗ noise |
...
| −150/−101 | -38% (20) | +15% (28) | -27% (18) | +38% (11) |
...
| TOTAL | 38 | 22-15-1 | 59.5% [43–74] | +14.5% | +4.6u | 0.94 ✗ noise |
...
| TOTAL | N=10 · 50% · -3% | N=16 · 73% · +39% | N=7 · 43% · -17% | N=3 · 67% · +30% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 46 | 19-27-0 | 41.3% [28–56] | -19.3% | -11.7u | -1.34 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=7 · 14% · -71% | N=19 · 42% · -19% | N=13 · 31% · -37% | N=6 · 83% · +63% |
...
|---|---|---|
| **sharps3Plus** | 91 · 42% · -13.5% · -1.14 ✗ noise | 50 · 56% · +6.1% · 0.45 ✗ noise |
| **plusEV** | 22 · 32% · -31.1% · -1.08 ✗ noise | 119 · 50% · -2.0% · -0.22 ✗ noise |
| **pinnacleConfirms** | 45 · 49% · +1.2% · 0.06 ✗ noise | 33 · 39% · -20.5% · -1.07 ✗ noise |
| **invested10kPlus** | 71 · 42% · -11.8% · -0.84 ✗ noise | 7 · 71% · +30.8% · 0.85 ✗ noise |
| **lineMovingWith** | 89 · 50% · -0.3% · -0.02 ✗ noise | 52 · 41% · -17.3% · -1.19 ✗ noise |
| **predMarketAligns** | 37 · 51% · +0.7% · 0.03 ✗ noise | 41 · 39% · -15.8% · -0.89 ✗ noise |
...
| 1 | 33 | 14-18-1 | 43.8% [28–61] | -16.5% | -5.1u | -1.01 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 76 | 35-40-1 | 46.7% [36–58] | -12.5% | -12.2u | -1.15 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.089 ✗ | -0.020 ✗ | -0.069 | -0.24 |
| totalInvested | -0.136 ✗ | -0.123 ✗ | -0.062 | -1.46 |
| evEdge | 0.001 ✗ | 0.010 ✗ | -0.018 | 0.12 |
| moneyPct | 0.011 ✗ | -0.071 ✗ | -0.037 | -0.84 |
| walletPct | 0.084 ✗ | 0.046 ✗ | 0.060 | 0.54 |
| criteriaMet | -0.054 ✗ | -0.031 ✗ | -0.104 | -0.36 |
| maxContribFor | -0.073 ✗ | -0.047 ✗ | -0.021 | -0.55 |
| meanBaseFor | -0.062 ✗ | -0.045 ✗ | -0.028 | -0.54 |
...
Sample with CLV: **138** picks. Mean CLV = **-0.0030**.
t-statistic vs zero: -2.19 → ✓ p<.05 · 95% CI [-0.0058, -0.0003]
...
| CLV (−2%, 0] | 77 | 37-38-2 | 49.3% [38–60] | -2.5% | -3.7u | -0.21 ✗ noise |
...
Trained on N=31 (with all features non-null). Intercept β₀ = 0.292.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | log10(invested) | -0.977 | ↓ hurts |
| 2 | pw.Δcount | +0.777 | ↑ helps |
| 3 | pw.ΔAvgRoi | +0.644 | ↑ helps |
| 4 | evEdge | +0.592 | ↑ helps |
| 5 | walletPct | -0.504 | ↓ hurts |
| 6 | sharpCount | -0.476 | ↓ hurts |
| 7 | pw.ΔWlNet | +0.469 | ↑ helps |
| 8 | pw.ΔFlatPnl | +0.371 | ↑ helps |
| 9 | odds (American) | -0.341 | ↓ hurts |
| 10 | moneyPct | -0.275 | ↓ hurts |
| 11 | peak.stars | -0.268 | ↓ hurts |
| 12 | log(impliedProb) | +0.225 | ↑ helps |
| 13 | pw.ΔTopQShare | -0.216 | ↓ hurts |
| 14 | Δw + HC | +0.181 | ↑ helps |
| 15 | HC margin | +0.162 | ↑ helps |
| 16 | vault.star | -0.157 | ↓ hurts |
| 17 | Δw | +0.103 | ↑ helps |
| 18 | criteriaMet | -0.038 | ≈ flat |
...
| Tier-1b HC = +1 (post-cutover) | 21 | 11-10 | 52.4% | 51.6% | -105 | 0.40% bankroll | 1.54u | **OVER-SIZED** — reduce to 0.40u |
...
**Daily Sharpe-like (μ/σ):** -0.212  (annualized × √252 ≈ -3.36)
...
| 2026-04-19 | MLB | ML | home | 4.0 | 2.00 | -106 | 3 | — | — | 2 | 6 | 0.00 | W | +1.8u |
...
| 2026-04-19 | NBA | SPREAD | home | 5.0 | 2.00 | -110 | 0 | — | — | 1 | 3 | -0.70 | L | -2.0u |
...
| 2026-04-20 | NBA | ML | home | 3.0 | 1.00 | -235 | -1 | — | — | 0 | -11 | -1.00 | L | -1.0u |
| 2026-04-20 | NBA | SPREAD | home | 4.5 | 2.00 | -102 | 1 | — | — | 2 | 11 | -0.20 | L | -2.0u |
| 2026-04-20 | NBA | TOTAL | under | 2.5 | 0.50 | -102 | 0 | — | — | 1 | 3 | 0.00 | W | +0.5u |
| 2026-04-20 | NBA | ML | home | 3.0 | 1.00 | -285 | -1 | — | — | -1 | -2 | 2.00 | L | -1.0u |
| 2026-04-20 | NBA | SPREAD | home | 3.0 | 0.75 | -105 | -1 | — | — | -2 | -11 | 1.20 | L | -0.8u |
| 2026-04-20 | NBA | TOTAL | over | 2.5 | 0.50 | -115 | 0 | — | — | 0 | 0 | 0.00 | W | +0.4u |
| 2026-04-20 | NBA | ML | away | 3.5 | 0.50 | +360 | 3 | — | — | 1 | 10 | 0.60 | L | -0.5u |
| 2026-04-20 | NBA | SPREAD | home | 3.0 | 0.75 | -110 | 0 | — | — | 1 | 3 | -1.40 | W | +0.7u |
...
| 2026-04-21 | NBA | TOTAL | over | 3.5 | 1.50 | -108 | 0 | — | — | 1 | 3 | 0.00 | L | -1.5u |
| 2026-04-21 | NBA | ML | away | 3.5 | 0.50 | +475 | 3 | — | — | 6 | 8 | 0.60 | W | +2.4u |
| 2026-04-21 | NBA | SPREAD | away | 4.5 | 2.00 | -110 | 2 | — | — | 3 | 5 | -0.20 | W | +1.8u |
| 2026-04-21 | NBA | TOTAL | over | 4.0 | 1.75 | -102 | 0 | — | — | 1 | 3 | 0.00 | L | -1.8u |
...
| 2026-04-23 | NBA | TOTAL | over | 4.5 | 2.00 | -104 | 1 | — | — | 2 | 6 | 0.00 | W | +1.9u |
...
| 2026-04-24 | NBA | ML | home | 5.0 | 2.00 | +120 | 2 | — | — | 2 | 8 | 0.70 | L | -2.0u |
...
| 2026-04-27 | NBA | SPREAD | away | 4.0 | 0.75 | -114 | 1 | — | — | -1 | -10 | -0.70 | L | -0.8u |
| 2026-04-27 | NBA | TOTAL | over | 5.0 | 2.00 | -104 | 3 | — | — | 1 | 12 | 0.00 | L | -2.0u |
| 2026-04-27 | NBA | ML | home | 5.0 | 3.00 | -500 | 3 | — | — | 4 | 19 | 0.40 | W | +0.6u |
| 2026-04-27 | NBA | TOTAL | over | 5.0 | 2.00 | -115 | 2 | — | — | 2 | 19 | 0.00 | W | +1.7u |
...
| 2026-04-28 | NBA | SPREAD | away | 5.0 | 2.00 | -105 | 3 | — | — | 3 | 15 | 0.20 | L | -2.0u |
...
| 2026-04-30 | NBA | SPREAD | away | 2.5 | 0.75 | -104 | 0 | 1 | 1 | 0 | -22 | 0.20 | L | -0.8u |
...
| 2026-05-01 | NBA | ML | home | 5.0 | 3.00 | -180 | 3 | -1 | 2 | 3 | -10 | 0.10 | L | -3.0u |
...
| 2026-05-04 | NBA | SPREAD | away | 4.0 | 1.13 | -110 | 2 | 1 | 3 | 2 | 5 | -2.10 | L | -1.1u |
| 2026-05-04 | NBA | TOTAL | under | 5.0 | 2.00 | -102 | 2 | 1 | 3 | 2 | 3 | 0.00 | L | -2.0u |
| 2026-05-04 | NHL | ML | home | 3.5 | 1.13 | -165 | 1 | 1 | 2 | 1 | 3 | -0.10 | W | +0.7u |
| 2026-05-05 | NBA | ML | away | 5.0 | 4.50 | +132 | 4 | 1 | 5 | 3 | 8 | -0.40 | L | -4.5u |
...
| 2026-05-06 | NBA | SPREAD | away | 5.0 | 3.50 | -105 | 4 | 0 | 4 | 4 | 15 | -1.20 | W | +3.2u |
