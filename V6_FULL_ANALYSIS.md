...
_Auto-generated **6/21/2026, 11:05:34 AM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 733 shipped+graded picks · 2026-04-18 → 2026-06-20  (HC analyses scoped to post-cutover 2026-04-30, 621 picks)
**Headline:** 372-353-8 · WR 51.3% [47.7%–54.9%] vs 52.4% break-even · -15.9u flat (-2.2%) · -99.0u peak.
...
- **ρ(Δw, flat ROI) = 0.006 ✗**  (full sample, N=727)
- **ρ(HC, flat ROI) = -0.019 ✗**  (post-cutover, N=621)
- **ρ(Δw+HC, flat ROI) = -0.046 ✗**  (post-cutover, N=621)
...
- **Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era)** — N=97, 43-53, WR 44.8% [35%–55%], flat ROI -16.3% (t=-1.71 ~ p<.10)

### Action map

- **Tier-1a (HC ≥ +2)** — N=44, WR 47.7%, flat ROI -12.4%. Bayesian posterior WR ≈ 48.1%, half-Kelly = **0.0%** bankroll at −110 → **size aggressively**.
- **Tier-1b (HC = +1)** — N=167, WR 56.9%, flat ROI +8.8%. Bayesian posterior WR ≈ 56.5%, half-Kelly = **4.3%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=97, WR 44.8%, flat ROI -16.3%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=112, WR 49.1%, flat ROI -2.2%. Bayesian posterior WR ≈ 49.2%, half-Kelly = **0.0%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -6.2% flat ROI on 191 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (0.98u/pick), we need **~1477 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 733. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **733** |
| W-L-P | 372-353-8 |
| Win rate | **51.3%** [47.7%–54.9%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +1.1 pp |
| Peak-units PnL | **-99.0u** |
| Flat-1u PnL | **-15.9u** (-2.2% flat ROI) |
| Flat t-statistic vs zero | -0.60 → ✗ noise |
| Flat 95% CI per-pick | [-0.093, 0.049]u |
...
We have **733** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = −1 | 33 | 12-20-1 | 37.5% [23–55] | -27.0% | -10.7u | -1.63 ✗ noise |
| Δw = 0 | 150 | 78-69-3 | 53.1% [45–61] | -0.4% | +7.9u | -0.05 ✗ noise |
| Δw = +1 | 283 | 151-129-3 | 53.9% [48–60] | +1.6% | -38.7u | 0.28 ✗ noise |
| Δw = +2 | 141 | 69-71-1 | 49.3% [41–57] | -5.0% | -35.1u | -0.60 ✗ noise |
| Δw ≥ +3 | 112 | 55-57-0 | 49.1% [40–58] | -2.2% | -20.1u | -0.21 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.002** ✗  ·  **ρ(Δw, flat ROI) = 0.006** ✗  (N=727)
...
| HC = 0 | 380 | 188-185-7 | 50.4% [45–55] | -5.5% | -105.3u | -1.13 ✗ noise |
| HC = +1 | 167 | 95-72-0 | 56.9% [49–64] | +8.8% | +16.2u | 1.17 ✗ noise |
| HC = +2 | 32 | 17-15-0 | 53.1% [36–69] | +1.9% | -0.1u | 0.11 ✗ noise |
| HC ≥ +3 | 12 | 4-8-0 | 33.3% [14–61] | -50.4% | -6.7u | -2.38 ✓ p<.05 |

**Pearson ρ(HC, WIN) = -0.003** ✗  ·  **ρ(HC, flat ROI) = -0.019** ✗  (N=621)

Spearman rank ρ(HC, flat ROI) = 0.017.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 141 | 71-67-3 | 51.4% [43–60] | -2.4% | -4.6u | -0.30 ✗ noise |
| Σ = +1 | 207 | 112-92-3 | 54.9% [48–62] | +3.6% | -40.1u | 0.54 ✗ noise |
| Σ = +2 | 128 | 71-56-1 | 55.9% [47–64] | +4.7% | +0.4u | 0.56 ✗ noise |
| Σ = +3 | 62 | 27-35-0 | 43.5% [32–56] | -16.8% | -15.8u | -1.35 ✗ noise |
...
**Pearson ρ(Δw+HC, WIN) = -0.034** ✗  ·  **ρ(Σ, flat ROI) = -0.046** ✗  (N=621)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 621.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.045 ✗ | -0.052 ✗ | -0.034 | weak |
| HC margin | -0.003 ✗ | -0.019 ✗ | 0.017 | weak |
| Δw + HC | -0.034 ✗ | -0.046 ✗ | -0.020 | weak |
| peak.stars | -0.045 ✗ | -0.065 ✗ | -0.067 | weak |
| vault.star | -0.009 ✗ | -0.022 ✗ | -0.041 | weak |
| lock.stars | -0.026 ✗ | -0.042 ✗ | -0.044 | weak |
...
Universe N = 621 (post-cutover, both axes present).
...
| +0 | N=1 · 1-0 · 100% [21–100] · —  | N=4 · 1-3 · 25% [5–70] · -44%  | N=13 · 3-9 · 25% [9–53] · -51% ✗ | N=92 · 49-41 · 54% [44–64] · +2%  | N=179 · 95-81 · 54% [47–61] · +2%  | N=63 · 31-31 · 50% [38–62] · -8%  | N=28 · 8-20 · 29% [15–47] · -48% ✗ |
| +1 | — | — | N=7 · 4-3 · 57% [25–84] · +2%  | N=26 · 15-11 · 58% [39–74] · +7%  | N=60 · 37-23 · 62% [49–73] · +17%  | N=37 · 19-18 · 51% [36–67] · +1%  | N=37 · 20-17 · 54% [38–69] · +6%  |
...
| Δw = −1 | 27 | 11-15-1 | 42.3% [26–61] | -18.4% | -6.2u | -0.99 ✗ noise |
| Δw = 0 | 127 | 71-54-2 | 56.8% [48–65] | +6.6% | +21.3u | 0.79 ✗ noise |
| Δw = +1 | 250 | 136-111-3 | 55.1% [49–61] | +3.7% | -34.1u | 0.62 ✗ noise |
| Δw = +2 | 116 | 58-57-1 | 50.4% [41–59] | -3.7% | -31.3u | -0.40 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 211 | 116-95-0 | 55.0% [48–62] | +4.4% | +9.3u | 0.66 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 97 | 43-53-1 | 44.8% [35–55] | -16.3% | -42.8u | -1.71 ~ p<.10 |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 313 | 162-145-6 | 52.8% [47–58] | -0.2% | -54.9u | -0.03 ✗ noise |
...
Universe N = 710 picks where ≥1 proven wallet appeared on either side.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δcount ≤ −2 (heavy oppose) | 14 | 7-7-0 | 50.0% [27–73] | -3.8% | -7.7u | -0.14 ✗ noise |
| Δcount = −1 | 48 | 25-23-0 | 52.1% [38–66] | +3.0% | -5.5u | 0.20 ✗ noise |
| Δcount = 0 (balanced) | 114 | 50-62-2 | 44.6% [36–54] | -13.9% | -30.8u | -1.53 ✗ noise |
| Δcount = +1 | 260 | 130-129-1 | 50.2% [44–56] | -6.4% | -78.8u | -1.09 ✗ noise |
| Δcount = +2 | 163 | 84-78-1 | 51.9% [44–59] | -2.4% | -15.6u | -0.32 ✗ noise |
| Δcount ≥ +3 (heavy support) | 111 | 69-39-3 | 63.9% [54–72] | +26.0% | +46.1u | 2.60 ✓ p<.01 |

**ρ(Δcount, WIN) = 0.066** ~ p<.10  ·  **ρ(Δcount, flat ROI) = 0.076** ✓ p<.05
...
Quintile cuts: ≤ -9 · ≤ 2 · ≤ 10 · ≤ 23 · > 23

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 145 | 64-81-0 | 44.1% [36–52] | -13.3% | -60.9u | -1.61 ✗ noise |
| Q2 | 147 | 65-80-2 | 44.8% [37–53] | -12.7% | -34.1u | -1.59 ✗ noise |
| Q3 (balanced) | 139 | 75-62-2 | 54.7% [46–63] | +3.2% | -21.6u | 0.40 ✗ noise |
| Q4 | 154 | 84-68-2 | 55.3% [47–63] | +6.1% | -6.8u | 0.76 ✗ noise |
| Q5 (best — heavy support) | 125 | 77-47-1 | 62.1% [53–70] | +14.1% | +31.1u | 1.60 ✗ noise |

**ρ(ΔWlNet, WIN) = 0.140** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.112** ✓ p<.01
...
Quintile cuts (units): ≤ -11.95 · ≤ 0.13 · ≤ 6.90 · ≤ 14.18 · > 14.18

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 143 | 64-78-1 | 45.1% [37–53] | -16.7% | -47.4u | -2.16 ✓ p<.05 |
| Q2 | 142 | 64-76-2 | 45.7% [38–54] | -12.9% | -9.8u | -1.61 ✗ noise |
| Q3 | 170 | 88-81-1 | 52.1% [45–59] | -3.3% | -42.2u | -0.46 ✗ noise |
| Q4 | 114 | 66-45-3 | 59.5% [50–68] | +13.6% | -10.5u | 1.51 ✗ noise |
| Q5 | 141 | 83-58-0 | 58.9% [51–67] | +18.3% | +17.6u | 2.02 ✓ p<.05 |
...
Quintile cuts (% ROI): ≤ -7.5 · ≤ 0.2 · ≤ 6.3 · ≤ 20.5 · > 20.5

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 143 | 47-96-0 | 32.9% [26–41] | -38.1% | -77.9u | -5.05 ✓ p<.01 |
| Q2 | 144 | 75-66-3 | 53.2% [45–61] | -0.5% | +3.7u | -0.06 ✗ noise |
| Q3 | 149 | 77-71-1 | 52.0% [44–60] | -3.0% | -34.4u | -0.39 ✗ noise |
| Q4 | 133 | 76-56-1 | 57.6% [49–66] | +11.1% | +20.5u | 1.28 ✗ noise |
| Q5 | 141 | 90-49-2 | 64.7% [57–72] | +27.1% | -4.2u | 3.15 ✓ p<.01 |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 72 | 18-53-1 | 25.4% [17–37] | -50.1% | -50.4u | -4.95 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 20 | 8-12-0 | 40.0% [22–61] | -26.8% | -2.4u | -1.29 ✗ noise |
| ΔBestRank = 0 (tied) | 0 | — | — | — | — | — |
| ΔBestRank ∈ [+1,+4] | 22 | 14-8-0 | 63.6% [43–80] | +27.3% | +2.2u | 1.26 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 207 | 116-88-3 | 56.9% [50–63] | +12.1% | +2.7u | 1.67 ~ p<.10 |

**ρ(ΔBestRank, WIN) = 0.264** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.290** ✓ p<.01  (N=321)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 34 | 11-23-0 | 32.4% [19–49] | -38.7% | -21.1u | -2.45 ✓ p<.05 |
| Δshare ∈ [−30,−10] pp | 5 | 0-5-0 | 0.0% [0–43] | -100.0% | -3.3u | 0.00 ✗ noise |
| Δshare ≈ 0 (±10 pp) | 461 | 231-226-4 | 50.5% [46–55] | -4.7% | -63.8u | -1.05 ✗ noise |
| Δshare ∈ [+10,+30] pp | 29 | 14-14-1 | 50.0% [33–67] | -5.5% | -4.1u | -0.31 ✗ noise |
| Δshare ≥ +30 pp | 181 | 109-70-2 | 60.9% [54–68] | +19.2% | -0.1u | 2.51 ✓ p<.05 |

**ρ(ΔTopQShare, WIN) = 0.114** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.121** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔTopQCount** | 0.147 ✓ p<.01 | 0.179 ✓ p<.01 | 0.139 |
| 2 | **ΔTopQShare** | 0.114 ✓ p<.01 | 0.121 ✓ p<.01 | 0.131 |
| 3 | **ΔWlNet** | 0.140 ✓ p<.01 | 0.112 ✓ p<.01 | 0.064 |
| 4 | **Δcount** | 0.066 ~ p<.10 | 0.076 ✓ p<.05 | 0.074 |
| 5 | **ΔFlatPnl** | NaN — | NaN — | 0.137 |
| 6 | **ΔAvgRoi** | NaN — | NaN — | 0.203 |

_(ΔBestRank uses N=321 subset where both sides had a proven wallet — ρ(flat ROI) = 0.290 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 1268, dateRange = 2026-04-18 → 2026-06-20, computedAt = 2026-06-21T15:02:49.097Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **710** rows · PIT aggregate computable on **702** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **702** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 489 · 54% · +2.4% | 420 · 53% · -1.7% | -4.2pp |
| WEAK (−3..0) | 200 · 47% · -8.3% | 269 · 51% · +0.9% | +9.3pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=393, WR=55%, ROI=+3.5% | N=324, WR=52%, ROI=-2.2% | -5.7pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=489, WR=54%, ROI=+2.4% | N=420, WR=53%, ROI=-1.7% | -4.2pp |
| AGS < −1 (mute veto) | N=77, WR=48%, ROI=-7.8% | N=160, WR=48%, ROI=-3.3% | +4.5pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-06-07 → 2026-06-20, N=233)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 133 · 53% · -1.3% |
| WEAK (−3..0) | 100 · 54% · +3.8% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=106, WR=56%, ROI=+4.0% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=133, WR=53%, ROI=-1.3% |
| AGS < −1 (mute veto) | N=65, WR=52%, ROI=+4.0% |
...
| `dHcSizeRatio` | INTENSITY_HC | + | 0.79 | 4.13 |
| `dSumRankNorm` | QUALITY_RANK | − | 50.92 | 85.22 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.52 | 1.09 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **702/733** shipped+graded rows (96%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 119 | 62-55-2 | 53.0% [44–62] | -3.4% | -21.4u | -0.40 ✗ noise |
| LOCK | 128 | 62-66-0 | 48.4% [40–57] | -8.3% | -35.4u | -0.96 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 96 | 48-46-2 | 51.1% [41–61] | -2.9% | -7.2u | -0.29 ✗ noise |
| FADE | 168 | 80-85-3 | 48.5% [41–56] | -2.4% | -36.9u | -0.29 ✗ noise |
...
r(WIN) = **0.001** ✗ · r(ROI) = **-0.027** ✗ · Spearman ρ(ROI) = **-0.036**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 162 | 81-79-2 | 50.6% [43–58] | +1.8% | -29.6u | 0.21 ✗ noise |
| z ∈ [−1, 0) | 236 | 130-103-3 | 55.8% [49–62] | +4.6% | -0.6u | 0.74 ✗ noise |
| z ∈ [0, +1) | 206 | 98-107-1 | 47.8% [41–55] | -10.0% | -52.9u | -1.50 ✗ noise |
...
| z ∈ [0, +1) | 668 | 342-318-8 | 51.8% [48–56] | -2.0% | -90.1u | -0.55 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.046** ✗ · r(ROI) = **-0.054** ✗ · Spearman ρ(ROI) = **-0.062**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 133 | 72-60-1 | 54.5% [46–63] | +1.7% | -12.1u | 0.21 ✗ noise |
| z ∈ [−1, 0) | 271 | 145-124-2 | 53.9% [48–60] | +4.4% | -27.1u | 0.72 ✗ noise |
| z ∈ [0, +1) | 225 | 106-115-4 | 48.0% [41–55] | -8.6% | -51.1u | -1.34 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.046 ✗ | -0.054 ✗ | -0.062 |
| 2 | `dCount` | COUNT | 0.001 ✗ | -0.027 ✗ | -0.036 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | -0.080 | 0.801 | 49.3% | dominant |
| 2 | `dSumRankNorm` | -0.188 | 0.790 | 48.7% | meaningful |
| 3 | `dWinnerCtPreA` | -0.023 | 0.023 | 1.4% | silent (<0.2) |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.021 | +0.700 | +0.021 |
| `dHcSizeRatio` | +0.021 | 1.000 | -0.015 | +1.000 ⚠ |
| `dSumRankNorm` | +0.700 | -0.015 | 1.000 | -0.015 |
| `dWinnerCtPreA` | +0.021 | +1.000 ⚠ | -0.015 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **-0.008**. At AGS ≥ +0.12 fires N=327, WR=52.3%, ROI=-2.5%. At AGS ≥ +null fires N=424, WR=52.5%, ROI=-2.2%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-327 ROI (matched cohort) | Top-327 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.067 | +0.059 | WR=56%, ROI=+8.2% | -10.7pp | N=372, WR=55%, ROI=+4.5% |
| `dHcSizeRatio` | +0.038 | +0.030 | WR=55%, ROI=+1.9% | -4.4pp | N=346, WR=54%, ROI=+1.5% |
| `dSumRankNorm` | -0.044 | +0.036 | WR=49%, ROI=-8.4% | +5.9pp | N=300, WR=49%, ROI=-8.1% |
| `dWinnerCtPreA` | +0.040 | +0.032 | WR=54%, ROI=+0.1% | -2.6pp | N=336, WR=54%, ROI=+1.0% |
...
|---|---|---|---|---|
| 1 | `dHcSizeRatio` | +0.030 | -4.4pp | redundant — other features cover it |
| 2 | `dWinnerCtPreA` | +0.032 | -2.6pp | redundant — other features cover it |
| 3 | `dSumRankNorm` | +0.036 | +5.9pp | redundant — other features cover it |
| 4 | `dCount` | +0.059 | -10.7pp | redundant — other features cover it |
...
| 2 | `dCount` | COUNT | +0.057 | 0.057 | positive ↑ |
| 3 | `dWinnerCtPreA` | QUALITY_TRACK | +0.028 | 0.028 | flat ≈ 0 |
| 4 | `dHcSizeRatio` | INTENSITY_HC | +0.011 | 0.011 | flat ≈ 0 |

Intercept b = +0.017 · Final log-loss = 0.6910 · N = 702.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 702 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/702 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 221 | 107-114-0 | 48.4% [42–55] | -11.1% | -85.7u | -1.76 ~ p<.10 |
| 4.5★ | 129 | 74-53-2 | 58.3% [50–66] | +10.1% | +8.8u | 1.19 ✗ noise |
| 4.0★ | 149 | 69-78-2 | 46.9% [39–55] | -9.5% | -18.0u | -1.18 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 97 | 51-43-3 | 54.3% [44–64] | +4.5% | -0.3u | 0.46 ✗ noise |
| 2.5★ | 99 | 52-46-1 | 53.1% [43–63] | +2.1% | -7.7u | 0.21 ✗ noise |

### §5b. Stars × Δw stratified — does the star tier hold up within each Δw cohort?

| Δw cohort | 5★ | 4.5★ | 4★ | 3.5★ | 3★ | 2.5★ |
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 35/63%/+11% | 36/56%/+6% | 34/33%/-34% | 6/33%/-26% | 34/41%/-23% | 45/55%/+5% |
| Δw = +1 | 53/53%/-3% | 56/56%/+3% | 73/49%/-6% | 28/54%/+4% | 37/62%/+19% | 35/54%/+1% |
| Δw = +2 | 64/44%/-16% | 17/53%/-1% | 35/57%/+10% | — | 16/53%/+3% | 9/44%/-5% |
...
| −200/−151 | 78 | 44-34-0 | 56.4% [45–67] | -10.2% | -27.8u | -1.14 ✗ noise |
| −150/−101 | 439 | 224-210-5 | 51.6% [47–56] | -3.1% | -44.0u | -0.68 ✗ noise |
| −100/+100 | 9 | 5-4-0 | 55.6% [27–81] | +11.1% | +1.7u | 0.32 ✗ noise |
| +101/+150 | 141 | 61-77-3 | 44.2% [36–53] | -3.3% | -50.0u | -0.37 ✗ noise |
...
| −200/−151 | -20% (24) | +0% (30) | +30% (11) | -59% (12) |
| −150/−101 | -4% (109) | +1% (181) | -15% (83) | +2% (63) |
| −100/+100 | -100% (2) | +60% (5) | -100% (1) | +100% (1) |
| +101/+150 | -1% (38) | -7% (49) | +4% (34) | -10% (20) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 390 | 197-192-1 | 50.6% [46–56] | -3.3% | -68.2u | -0.65 ✗ noise |
| SPREAD | 122 | 60-60-2 | 50.0% [41–59] | -7.1% | -12.5u | -0.82 ✗ noise |
| TOTAL | 221 | 115-101-5 | 53.2% [47–60] | +2.6% | -18.3u | 0.40 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=102 · 47% · -13% | N=139 · 55% · +3% | N=75 · 52% · +2% | N=71 · 45% · -8% |
| SPREAD | N=32 · 35% · -35% | N=53 · 56% · +5% | N=20 · 65% · +17% | N=16 · 38% · -27% |
| TOTAL | N=57 · 64% · +21% | N=91 · 51% · -3% | N=46 · 38% · -26% | N=25 · 68% · +31% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 553 | 287-261-5 | 52.4% [48–57] | -1.2% | -67.5u | -0.29 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=151 · 52% · -2% | N=240 · 54% · +1% | N=105 · 50% · -3% | N=56 · 50% · -5% |
...
|---|---|---|
| **sharps3Plus** | 271 · 47% · -8.1% · -1.31 ✗ noise | 461 · 54% · +1.0% · 0.22 ✗ noise |
| **plusEV** | 74 · 49% · -4.3% · -0.33 ✗ noise | 658 · 52% · -2.1% · -0.57 ✗ noise |
| **pinnacleConfirms** | 168 · 54% · +3.1% · 0.40 ✗ noise | 396 · 50% · -5.2% · -1.06 ✗ noise |
| **invested10kPlus** | 344 · 51% · -2.9% · -0.54 ✗ noise | 220 · 51% · -2.4% · -0.36 ✗ noise |
| **lineMovingWith** | 320 · 55% · +5.3% · 0.96 ✗ noise | 412 · 48% · -8.3% · -1.73 ~ p<.10 |
| **predMarketAligns** | 178 · 53% · -0.4% · -0.05 ✗ noise | 386 · 50% · -3.8% · -0.76 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 231 | 118-113-0 | 51.1% [45–57] | -2.0% | -45.6u | -0.32 ✗ noise |
| 1 | 149 | 73-71-5 | 50.7% [43–59] | -3.6% | -27.6u | -0.46 ✗ noise |
...
| 5 | 59 | 31-28-0 | 52.5% [40–65] | -4.2% | -8.0u | -0.34 ✗ noise |
...
| NEAR_START | 286 | 138-143-5 | 49.1% [43–55] | -5.1% | -64.2u | -0.86 ✗ noise |
| NO_MOVE | 22 | 11-11-0 | 50.0% [31–69] | -8.3% | +5.7u | -0.41 ✗ noise |
| PREGAME | 164 | 87-77-0 | 53.0% [45–61] | +1.6% | -30.8u | 0.21 ✗ noise |
| SMALL_MOVE | 147 | 72-73-2 | 49.7% [42–58] | -6.3% | -14.6u | -0.79 ✗ noise |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 418 | 213-202-3 | 51.3% [47–56] | -4.1% | -106.2u | -0.88 ✗ noise |
| STRONG | 106 | 53-51-2 | 51.0% [41–60] | -0.3% | -3.0u | -0.03 ✗ noise |
| LEAN | 199 | 101-95-3 | 51.5% [45–58] | +0.7% | +9.4u | 0.10 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.087 ✓ p<.05 | -0.068 ~ p<.10 | -0.055 | -1.84 |
| totalInvested | -0.069 ~ p<.10 | -0.080 ✓ p<.05 | -0.026 | -2.16 |
| evEdge | 0.088 ✓ p<.05 | 0.108 ✓ p<.01 | 0.047 | 2.92 |
| moneyPct | 0.031 ✗ | 0.002 ✗ | -0.019 | 0.05 |
| walletPct | 0.022 ✗ | 0.004 ✗ | -0.002 | 0.12 |
| criteriaMet | 0.007 ✗ | 0.007 ✗ | -0.027 | 0.20 |
| maxContribFor | -0.028 ✗ | -0.013 ✗ | 0.008 | -0.36 |
| meanBaseFor | -0.016 ✗ | 0.009 ✗ | 0.033 | 0.25 |
...
Sample with CLV: **720** picks. Mean CLV = **-0.0041**.
t-statistic vs zero: -3.57 → ✓ p<.01 · 95% CI [-0.0064, -0.0019]

Bucketed CLV vs flat PnL:

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLV ≤ −2% | 77 | 36-40-1 | 47.4% [37–58] | -13.7% | -17.8u | -1.30 ✗ noise |
| CLV (−2%, 0] | 427 | 215-206-6 | 51.1% [46–56] | -3.2% | -64.8u | -0.69 ✗ noise |
| CLV (0, +2%] | 184 | 99-85-0 | 53.8% [47–61] | +6.3% | -14.1u | 0.82 ✗ noise |
| CLV > +2% | 32 | 16-15-1 | 51.6% [35–68] | -4.3% | +1.5u | -0.25 ✗ noise |

ρ(CLV, flat ROI) = 0.076 ✓ p<.05
...
Trained on N=579 (with all features non-null). Intercept β₀ = 0.075.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | sharpCount | -0.294 | ↓ hurts |
| 2 | pw.ΔAvgRoi | +0.269 | ↑ helps |
| 3 | evEdge | +0.209 | ↑ helps |
| 4 | pw.Δcount | +0.183 | ↑ helps |
| 5 | pw.ΔFlatPnl | +0.182 | ↑ helps |
| 6 | log(impliedProb) | +0.142 | ↑ helps |
| 7 | peak.stars | -0.118 | ↓ hurts |
| 8 | odds (American) | -0.092 | ↓ hurts |
| 9 | vault.star | +0.086 | ↑ helps |
| 10 | HC margin | +0.078 | ↑ helps |
| 11 | criteriaMet | +0.039 | ≈ flat |
| 12 | pw.ΔWlNet | +0.039 | ≈ flat |
| 13 | Δw | -0.036 | ≈ flat |
| 14 | log10(invested) | +0.034 | ≈ flat |
| 15 | pw.ΔTopQShare | -0.031 | ≈ flat |
| 16 | moneyPct | -0.019 | ≈ flat |
| 17 | Δw + HC | +0.007 | ≈ flat |
...
| Tier-1b HC = +1 (post-cutover) | 167 | 95-72 | 56.9% | 56.5% | -110 | 4.32% bankroll | 2.06u | **UNDER-SIZED** — ship up to 4.32u (1u=1% bankroll) |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 97 | 43-53 | 44.8% | 45.3% | -110 | — (mute) | 2.03u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 112 | 55-57 | 49.1% | 49.2% | -110 | — (mute) | 2.45u | **MUTE** (negative EV at posterior) |
| Stale Δw = 0 | 150 | 78-69 | 53.1% | 52.9% | -110 | 0.51% bankroll | 1.84u | **OVER-SIZED** — reduce to 0.51u |
| Stale Δw ≤ −1 | 41 | 15-25 | 37.5% | 40.0% | -111 | — (mute) | 1.36u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.234  (annualized × √252 ≈ -3.72)
...
| 2026-04-25 | MLB | ML | away | 3.5 | 0.75 | +124 | 1 | — | — | 0 | -22 | -1.50 | L | -0.8u |
...
| 2026-04-26 | MLB | TOTAL | over | 3.5 | 0.50 | -116 | 1 | — | — | 0 | 22 | 0.00 | L | -0.5u |
| 2026-04-26 | MLB | ML | home | 3.5 | 0.75 | -110 | 1 | — | — | 2 | 26 | -1.40 | L | -0.8u |
| 2026-04-26 | MLB | ML | away | 5.0 | 2.00 | +100 | 2 | — | — | 2 | -2 | 0.00 | L | -2.0u |
| 2026-04-26 | MLB | TOTAL | over | 4.0 | 0.75 | -102 | 1 | — | — | 3 | -10 | 0.00 | W | +0.7u |
...
| 2026-04-27 | MLB | ML | home | 5.0 | 2.00 | +140 | 2 | — | — | 1 | -29 | -0.50 | L | -2.0u |
| 2026-04-27 | MLB | ML | away | 3.5 | 0.75 | +104 | 1 | — | — | 2 | -16 | -0.70 | W | +0.8u |
...
| 2026-04-28 | MLB | ML | home | 3.5 | 0.75 | -118 | 1 | — | — | 2 | 9 | -0.80 | W | +0.6u |
| 2026-04-28 | MLB | ML | away | 5.0 | 3.00 | -102 | 2 | — | — | 0 | 8 | -0.50 | L | -3.0u |
| 2026-04-28 | MLB | ML | home | 5.0 | 3.00 | -124 | 2 | — | — | 1 | 9 | -0.80 | W | +2.4u |
| 2026-04-28 | MLB | ML | home | 5.0 | 2.00 | +102 | 2 | — | — | 2 | -2 | -1.90 | L | -2.0u |
| 2026-04-28 | MLB | ML | home | 3.5 | 0.75 | +108 | 1 | — | — | 2 | -2 | -0.20 | L | -0.8u |
| 2026-04-28 | MLB | ML | away | 5.0 | 2.00 | +142 | 3 | — | — | 0 | 10 | 0.00 | L | -2.0u |
| 2026-04-28 | MLB | ML | away | 5.0 | 2.00 | +112 | 2 | — | — | 2 | 13 | 0.00 | W | +2.2u |
...
| 2026-04-29 | MLB | ML | home | 3.5 | 0.50 | -108 | 1 | — | — | 2 | 34 | 0.50 | L | -0.5u |
| 2026-04-29 | MLB | TOTAL | under | 3.5 | 0.50 | -117 | 1 | — | — | 3 | -3 | 0.00 | L | -0.5u |
...
| 2026-05-02 | MLB | ML | away | 4.5 | 3.00 | +140 | 1 | 1 | 2 | 2 | 4 | -0.50 | L | -3.0u |
...
| 2026-05-13 | MLB | TOTAL | under | 4.0 | 0.96 | -110 | 1 | 1 | 2 | 2 | -11 | 0.00 | W | +0.9u |
| 2026-05-13 | MLB | TOTAL | under | 5.0 | 3.50 | -110 | 4 | 2 | 6 | 5 | -15 | 0.00 | L | -3.5u |
...
| 2026-05-16 | MLB | ML | away | 5.0 | 4.50 | +124 | 3 | 1 | 4 | 4 | -24 | -1.30 | W | +1.4u |
...
| 2026-05-21 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 0 | 0 | 1 | -24 | 0.00 | W | +0.3u |
...
| 2026-05-22 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | -1 | -3 | 0.00 | L | -0.8u |
...
| 2026-05-23 | MLB | ML | away | 2.5 | 2.75 | +109 | 2 | 0 | 2 | 2 | -11 | -0.50 | L | -2.8u |
| 2026-05-23 | MLB | TOTAL | over | 2.5 | 0.30 | -110 | 0 | 1 | 1 | 0 | -17 | 0.00 | W | +0.3u |
| 2026-05-23 | MLB | ML | home | 5.0 | 1.00 | -148 | 0 | 0 | 0 | 1 | -19 | -0.20 | L | -1.0u |
| 2026-05-23 | MLB | SPREAD | away | 3.0 | 0.75 | -163 | 1 | 0 | 1 | 0 | -22 | 0.00 | W | +0.5u |
...
| 2026-05-23 | MLB | SPREAD | away | 4.5 | 1.50 | -209 | 0 | 0 | 0 | 2 | -11 | 29.00 | W | +2.5u |
...
| 2026-05-23 | MLB | TOTAL | over | 2.5 | 0.30 | -111 | 1 | 0 | 1 | 0 | 5 | 0.00 | L | -0.3u |
...
| 2026-05-24 | MLB | ML | home | 2.5 | 0.50 | +144 | 1 | 1 | 2 | -2 | -68 | 0.00 | L | -0.5u |
| 2026-05-24 | MLB | SPREAD | home | 4.0 | 1.65 | -110 | 2 | 1 | 3 | 2 | -11 | -1.30 | L | -1.6u |
...
| 2026-05-24 | MLB | ML | away | 4.0 | 1.25 | +148 | 2 | 2 | 4 | 0 | -27 | -1.40 | W | +1.9u |
| 2026-05-24 | MLB | ML | away | 3.0 | 1.25 | -122 | -1 | 1 | 0 | 0 | -21 | -1.10 | L | -1.3u |
...
| 2026-05-25 | MLB | ML | home | 5.0 | 5.00 | -310 | 2 | 0 | 2 | 2 | 34 | -1.20 | W | +1.6u |
| 2026-05-25 | MLB | TOTAL | over | 4.0 | 1.65 | +103 | 1 | 0 | 1 | 2 | 13 | 0.00 | L | -1.6u |
| 2026-05-25 | MLB | ML | home | 4.0 | 1.25 | -125 | 1 | -1 | 0 | 1 | -5 | -1.90 | L | -1.3u |
...
| 2026-05-25 | MLB | TOTAL | over | 5.0 | 3.00 | -110 | 3 | 0 | 3 | 3 | 18 | 0.00 | W | +2.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 3.75 | -108 | 0 | 0 | 0 | 3 | -30 | -1.70 | L | -3.8u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -124 | 2 | 0 | 2 | 2 | -11 | -1.30 | W | +0.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 5.00 | -119 | 2 | -1 | 1 | 4 | -1 | -0.60 | W | +3.1u |
...
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -178 | 1 | 0 | 1 | 2 | -11 | -1.60 | W | +0.9u |
...
| 2026-05-26 | MLB | TOTAL | over | 5.0 | 1.65 | -110 | 2 | 0 | 2 | 2 | -11 | 0.00 | W | +1.5u |
| 2026-05-26 | MLB | ML | away | 5.0 | 1.50 | +200 | 2 | 0 | 2 | 2 | -21 | -1.00 | L | -1.5u |
| 2026-05-26 | MLB | SPREAD | away | 5.0 | 1.00 | -101 | 2 | 1 | 3 | 2 | -11 | 0.50 | L | -1.0u |
...
| 2026-05-26 | MLB | SPREAD | home | 4.0 | 1.00 | +105 | 1 | 0 | 1 | 2 | 13 | -0.20 | L | -1.0u |
...
| 2026-05-27 | MLB | ML | home | 4.5 | 0.50 | -102 | 3 | 1 | 4 | 3 | 25 | -1.10 | W | +0.4u |
| 2026-05-27 | MLB | SPREAD | away | 5.0 | 2.50 | +141 | 1 | 1 | 2 | 4 | -8 | 0.80 | L | -2.5u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 1.00 | +105 | 2 | 0 | 2 | 2 | -11 | 0.00 | L | -1.0u |
...
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 1.65 | +104 | 2 | 0 | 2 | 2 | 13 | 0.00 | W | +1.7u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 0.75 | +104 | 2 | 0 | 2 | 2 | 14 | 0.00 | W | +0.8u |
...
| 2026-05-27 | MLB | SPREAD | away | 5.0 | 3.00 | -135 | 0 | 0 | 0 | 3 | 11 | -0.90 | W | +2.2u |
...
| 2026-05-28 | MLB | TOTAL | over | 5.0 | 3.00 | +101 | 3 | -1 | 2 | 3 | 37 | 0.00 | W | +2.5u |
| 2026-05-28 | MLB | ML | home | 5.0 | 1.25 | -140 | 2 | 0 | 2 | 2 | -20 | -0.50 | L | -1.3u |
| 2026-05-28 | MLB | TOTAL | under | 5.0 | 1.00 | -107 | 1 | 0 | 1 | 1 | 21 | 0.00 | W | +0.0u |
| 2026-05-28 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 1 | 4 | 2 | -61 | -0.60 | L | -2.5u |
| 2026-05-28 | MLB | TOTAL | over | 2.5 | 1.65 | -108 | 2 | 0 | 2 | 2 | -11 | 0.00 | L | -1.6u |
| 2026-05-28 | NBA | SPREAD | away | 5.0 | 1.00 | -110 | 1 | 2 | 3 | 0 | -2 | -0.90 | L | -1.0u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.50 | +118 | 5 | 1 | 6 | 5 | 21 | -0.90 | L | -2.5u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 0.75 | -135 | 2 | 0 | 2 | 1 | -32 | 1.00 | L | -0.8u |
| 2026-05-29 | MLB | ML | home | 5.0 | 3.75 | -124 | 2 | 1 | 3 | 3 | 20 | -1.00 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 1.65 | -106 | 2 | 0 | 2 | 3 | 14 | 0.00 | L | -1.6u |
...
| 2026-05-29 | MLB | ML | away | 5.0 | 2.50 | +140 | 2 | 1 | 3 | 1 | -33 | 1.00 | L | -2.5u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 1.65 | -103 | 0 | 0 | 0 | 2 | -11 | 0.00 | W | +1.6u |
| 2026-05-29 | MLB | ML | away | 4.5 | 1.25 | -142 | 0 | 1 | 1 | -1 | 13 | -1.20 | W | +0.3u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 1.65 | -135 | 1 | 0 | 1 | 2 | -11 | 0.40 | W | +1.2u |
| 2026-05-29 | MLB | ML | home | 4.5 | 1.25 | -134 | 1 | 0 | 1 | 0 | -16 | -1.70 | W | +2.8u |
| 2026-05-29 | MLB | SPREAD | away | 5.0 | 2.25 | -184 | 0 | 0 | 0 | 2 | 11 | -1.00 | W | +1.2u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 0.75 | -109 | 1 | 0 | 1 | 2 | 14 | 0.00 | W | +0.7u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.75 | -106 | 2 | 1 | 3 | 2 | 31 | 0.70 | L | -2.8u |
| 2026-05-29 | MLB | SPREAD | home | 4.0 | 1.65 | -175 | 0 | 0 | 0 | 2 | -11 | -0.80 | L | -1.6u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 0.30 | +105 | 2 | 1 | 3 | 1 | 0 | 0.00 | W | +0.3u |
| 2026-05-29 | MLB | ML | home | 4.5 | 3.75 | -122 | 0 | 1 | 1 | 1 | 8 | -0.60 | L | -3.8u |
...
| 2026-05-30 | MLB | ML | away | 4.0 | 3.75 | -132 | 1 | 1 | 2 | 1 | 65 | -1.00 | W | +2.9u |
| 2026-05-30 | MLB | SPREAD | home | 3.0 | 0.75 | -143 | 0 | 1 | 1 | 0 | -14 | -1.40 | L | -0.8u |
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -118 | 1 | 1 | 2 | 1 | -9 | -1.30 | L | -3.8u |
| 2026-05-30 | MLB | SPREAD | away | 4.0 | 1.00 | +152 | 1 | 0 | 1 | 1 | 8 | 0.20 | L | -1.0u |
| 2026-05-30 | MLB | ML | home | 5.0 | 5.00 | -120 | 0 | 0 | 0 | 3 | -30 | -1.10 | W | +4.2u |
...
| 2026-05-30 | MLB | SPREAD | home | 5.0 | 1.65 | -120 | 2 | 1 | 3 | 2 | -11 | -0.60 | W | +1.4u |
| 2026-05-30 | MLB | ML | away | 5.0 | 2.50 | +108 | 1 | 0 | 1 | 3 | -30 | -0.90 | W | +2.7u |
| 2026-05-30 | MLB | ML | home | 4.0 | 0.50 | +110 | 1 | 0 | 1 | 1 | -19 | -0.20 | W | +0.6u |
| 2026-05-30 | MLB | ML | home | 5.0 | 1.25 | -102 | 2 | 0 | 2 | 2 | 12 | -0.70 | W | +1.2u |
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -122 | 1 | 1 | 2 | 2 | -11 | -0.20 | L | -3.8u |
...
| 2026-05-31 | MLB | ML | away | 3.0 | 2.75 | -125 | -2 | 0 | -2 | 1 | -5 | -1.20 | L | -2.8u |
| 2026-05-31 | MLB | TOTAL | under | 5.0 | 1.65 | -114 | 2 | 0 | 2 | 3 | -5 | 0.00 | L | -1.6u |
| 2026-05-31 | MLB | ML | home | 2.5 | 2.75 | -115 | 1 | 1 | 2 | 1 | 32 | 0.00 | W | +2.4u |
| 2026-05-31 | MLB | ML | away | 5.0 | 1.00 | +115 | -1 | 0 | -1 | 2 | -11 | -0.60 | L | -1.0u |
| 2026-05-31 | MLB | SPREAD | away | 5.0 | 1.00 | -117 | 3 | 1 | 4 | 3 | -6 | -0.20 | L | -1.0u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -164 | 0 | 1 | 1 | 2 | -11 | -1.20 | W | +2.3u |
| 2026-05-31 | MLB | ML | away | 3.0 | 1.25 | -184 | 0 | 0 | 0 | 0 | -27 | -1.70 | W | +0.7u |
| 2026-05-31 | MLB | ML | home | 2.5 | 1.25 | -232 | 0 | 0 | 0 | 1 | 41 | -0.50 | W | +0.5u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -102 | 0 | 1 | 1 | 2 | -48 | 0.20 | W | +4.9u |
| 2026-05-31 | MLB | TOTAL | over | 4.0 | 1.00 | +101 | 2 | 1 | 3 | 2 | 3 | 0.00 | L | -1.0u |
| 2026-05-31 | MLB | ML | away | 4.5 | 2.50 | +110 | 0 | 0 | 0 | 0 | -27 | -1.10 | L | -2.5u |
...
| 2026-06-01 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 13 | 0.00 | L | -5.0u |
| 2026-06-01 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 3 | -27 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | ML | home | 2.5 | 0.25 | -215 | -1 | 0 | -1 | 0 | 17 | -1.40 | L | -0.3u |
| 2026-06-02 | MLB | TOTAL | under | 4.0 | 1.00 | -117 | 1 | 0 | 1 | 0 | -2 | 0.00 | L | -1.0u |
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +130 | 2 | 0 | 2 | 0 | 58 | -0.60 | W | +3.1u |
...
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +134 | -1 | -1 | -2 | -1 | 42 | -1.00 | W | +1.2u |
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +125 | 0 | -1 | -1 | 0 | 48 | 0.40 | W | +1.3u |
| 2026-06-03 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 43 | 0.00 | L | -3.0u |
| 2026-06-03 | MLB | ML | home | 4.5 | 1.50 | +167 | 0 | 0 | 0 | -1 | 17 | -0.40 | L | -1.5u |
| 2026-06-03 | MLB | SPREAD | away | 4.0 | 1.00 | -111 | 1 | 0 | 1 | 0 | 7 | 0.20 | W | +0.8u |
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -103 | 3 | 1 | 4 | 3 | 13 | -1.20 | L | -0.5u |
| 2026-06-03 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | -11 | 0.00 | L | -5.0u |
| 2026-06-03 | MLB | ML | away | 3.0 | 0.50 | +119 | 1 | 0 | 1 | 0 | 36 | 0.00 | W | +0.6u |
| 2026-06-03 | MLB | ML | away | 4.5 | 3.00 | -137 | 0 | 0 | 0 | -1 | 42 | -1.50 | L | -3.0u |
| 2026-06-03 | MLB | ML | home | 5.0 | 5.00 | -215 | 0 | 1 | 1 | 0 | 50 | -1.00 | W | +2.3u |
| 2026-06-03 | MLB | TOTAL | over | 2.5 | 0.25 | -110 | 1 | 1 | 2 | 1 | -14 | 0.00 | L | -0.3u |
...
| 2026-06-04 | MLB | ML | away | 3.0 | 0.50 | +104 | 1 | 0 | 1 | 1 | 23 | 0.00 | W | +0.5u |
| 2026-06-04 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | -1 | 0 | 0 | 21 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | +102 | 0 | 0 | 0 | 1 | 31 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 5.0 | 2.50 | +118 | 1 | 1 | 2 | 1 | 66 | -0.40 | W | +3.0u |
| 2026-06-04 | MLB | SPREAD | away | 5.0 | 5.00 | -111 | 0 | 0 | 0 | 1 | 15 | 0.00 | L | -5.0u |
| 2026-06-04 | MLB | ML | home | 5.0 | 5.00 | -131 | 1 | 0 | 1 | 1 | 66 | 0.20 | W | +3.5u |
| 2026-06-04 | MLB | ML | away | 2.5 | 0.25 | +105 | 0 | 0 | 0 | 0 | -29 | -1.00 | W | +0.2u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -210 | 1 | 0 | 1 | 2 | 64 | -1.00 | W | +0.5u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -188 | 0 | 0 | 0 | 0 | 23 | -1.10 | L | -1.0u |
| 2026-06-04 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 24 | 0.00 | W | +2.7u |
| 2026-06-04 | MLB | ML | home | 3.0 | 0.50 | -235 | 4 | 0 | 4 | 4 | 20 | 0.00 | L | -0.5u |
| 2026-06-04 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 0 | 8 | 0.00 | L | -5.0u |
| 2026-06-04 | NHL | ML | home | 2.5 | 0.25 | -160 | -3 | 0 | -3 | 2 | 11 | -0.40 | W | +0.2u |
| 2026-06-05 | MLB | ML | home | 2.5 | 0.25 | -144 | 1 | 1 | 2 | 0 | 32 | -1.20 | L | -0.3u |
| 2026-06-05 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | -1 | 17 | 0.00 | W | +2.8u |
...
| 2026-06-05 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 3 | 0 | 3 | 4 | 10 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | ML | away | 5.0 | 5.00 | -122 | 0 | 1 | 1 | 1 | 43 | -0.80 | L | -5.0u |
...
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -141 | 3 | 2 | 5 | 3 | 27 | 0.30 | W | +0.7u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 2.50 | -110 | 0 | 1 | 1 | -1 | 27 | 0.00 | W | +2.5u |
...
| 2026-06-06 | MLB | TOTAL | under | 5.0 | 2.50 | -110 | 0 | 0 | 0 | 0 | 8 | 0.00 | L | -2.5u |
| 2026-06-06 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 3 | 1 | 4 | 3 | 5 | 0.00 | W | +2.8u |
...
| 2026-06-06 | MLB | ML | home | 5.0 | 5.00 | -154 | 2 | 1 | 3 | 0 | 58 | -0.80 | L | -5.0u |
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -130 | 1 | 0 | 1 | 0 | 50 | -0.90 | W | +2.2u |
| 2026-06-07 | MLB | TOTAL | over | 3.0 | 0.50 | -112 | 0 | 0 | 0 | 2 | 12 | 0.00 | L | -0.5u |
| 2026-06-07 | MLB | ML | home | 5.0 | 5.00 | -143 | 1 | 0 | 1 | 1 | 15 | 0.00 | W | +3.5u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -4 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -136 | 1 | 0 | 1 | 0 | 50 | 0.00 | W | +0.7u |
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -165 | 2 | 2 | 4 | 3 | 20 | -1.10 | W | +1.8u |
| 2026-06-07 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 2 | 1 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | -107 | 1 | 0 | 1 | -1 | 43 | -0.80 | W | +0.2u |
| 2026-06-07 | MLB | TOTAL | over | 2.5 | 0.25 | -115 | 0 | 0 | 0 | -1 | -18 | 0.00 | W | +0.2u |
| 2026-06-07 | MLB | ML | home | 2.5 | 0.25 | -210 | -1 | 0 | -1 | 1 | 41 | 0.80 | L | -0.3u |
...
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 3.00 | -152 | 2 | 0 | 2 | 2 | 23 | -0.50 | W | +1.9u |
| 2026-06-07 | MLB | TOTAL | over | 5.0 | 2.25 | -114 | 1 | 1 | 2 | 0 | 2 | 0.00 | L | -2.3u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | +102 | 1 | 0 | 1 | -2 | 3 | -0.20 | W | +0.5u |
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 2.25 | +164 | 1 | 1 | 2 | 1 | 8 | 29.50 | W | +3.7u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | +103 | -1 | 0 | -1 | -2 | -22 | 0.20 | W | +0.3u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | -1 | 0 | 2 | 9 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -102 | 2 | 0 | 2 | 0 | 23 | 0.50 | W | +1.0u |
| 2026-06-07 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | -4 | 0.00 | W | +4.8u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | -127 | 0 | 1 | 1 | -1 | 43 | -1.90 | W | +0.4u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -2 | 0.00 | W | +0.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -113 | 6 | 1 | 7 | 6 | 56 | -0.50 | L | -3.0u |
| 2026-06-08 | MLB | ML | home | 4.5 | 3.00 | -129 | 3 | 0 | 3 | 1 | 53 | -0.40 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | -1 | 2 | 0.00 | L | -3.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -121 | 1 | 1 | 2 | 0 | 43 | -1.60 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 3 | 19 | 0.00 | P | +0.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -146 | 1 | 0 | 1 | -1 | 49 | -0.50 | W | +2.0u |
| 2026-06-08 | MLB | ML | home | 4.0 | 1.00 | -118 | 2 | 0 | 2 | 1 | -30 | -0.40 | L | -1.0u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 2.50 | -116 | -2 | -2 | -4 | -1 | 26 | 0.00 | W | +2.5u |
...
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | +132 | 1 | 0 | 1 | 2 | 31 | -1.20 | L | -0.3u |
| 2026-06-09 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 8 | 0.00 | W | +4.3u |
| 2026-06-09 | MLB | ML | away | 3.0 | 0.50 | -148 | 1 | 0 | 1 | 2 | 39 | 0.00 | L | -0.5u |
| 2026-06-09 | MLB | ML | away | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 4 | 46 | 0.80 | L | -1.0u |
| 2026-06-09 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 0 | 0 | 1 | 3 | 0.00 | L | -1.0u |
| 2026-06-09 | MLB | ML | away | 4.0 | 1.00 | -143 | 1 | 0 | 1 | 1 | 31 | 0.00 | L | -1.0u |
| 2026-06-09 | MLB | SPREAD | home | 4.5 | 3.00 | -117 | 1 | 0 | 1 | 0 | 12 | 0.00 | W | +2.6u |
| 2026-06-09 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | -2 | 8 | 0.00 | W | +0.5u |
| 2026-06-09 | MLB | ML | away | 5.0 | 5.00 | -122 | 2 | 1 | 3 | 2 | 8 | 0.00 | W | +4.1u |
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | -120 | 0 | 0 | 0 | 0 | 16 | 0.00 | L | -0.3u |
| 2026-06-09 | MLB | ML | home | 4.0 | 1.00 | -107 | 1 | 0 | 1 | 1 | 31 | -1.30 | L | -1.0u |
...
| 2026-06-09 | MLB | ML | home | 5.0 | 2.50 | +100 | 4 | 2 | 6 | 0 | 3 | 0.00 | W | +2.5u |
| 2026-06-09 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 1 | 2 | 0 | 11 | 0.00 | W | +4.5u |
| 2026-06-09 | MLB | ML | home | 4.0 | 1.00 | +102 | 2 | 0 | 2 | 1 | -5 | -1.20 | L | -1.0u |
| 2026-06-09 | MLB | ML | away | 4.0 | 1.00 | -119 | 1 | 0 | 1 | 0 | 50 | -0.80 | L | -1.0u |
...
| 2026-06-10 | MLB | ML | away | 4.5 | 3.00 | -148 | 0 | 0 | 0 | 1 | 15 | -0.50 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | +136 | 3 | 0 | 3 | 4 | 50 | -1.10 | L | -1.0u |
...
| 2026-06-10 | MLB | ML | away | 3.0 | 0.50 | +136 | 0 | 0 | 0 | -2 | 19 | 0.00 | L | -0.5u |
...
| 2026-06-10 | MLB | ML | home | 4.0 | 1.00 | +178 | 1 | 0 | 1 | -1 | 17 | -1.40 | W | +1.7u |
| 2026-06-10 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 3 | 0 | 3 | 0 | 3 | 0.00 | W | +4.5u |
| 2026-06-10 | MLB | ML | away | 5.0 | 5.00 | -104 | 0 | 0 | 0 | 1 | 15 | -0.20 | L | -5.0u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | +148 | 0 | 0 | 0 | 1 | 31 | -0.80 | W | +1.5u |
| 2026-06-10 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 2 | 19 | 0.00 | W | +2.7u |
| 2026-06-10 | MLB | ML | home | 4.5 | 2.50 | +103 | 0 | 0 | 0 | 2 | 1 | 0.00 | W | +2.6u |
| 2026-06-10 | MLB | ML | home | 4.0 | 1.00 | -127 | 1 | 0 | 1 | 1 | 31 | 0.00 | L | -1.0u |
| 2026-06-10 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +3.0u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | -120 | 1 | 0 | 1 | 1 | 31 | -0.40 | W | +0.8u |
| 2026-06-10 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | -1 | 0 | -1 | 1 | 15 | 0.00 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 5.0 | 5.00 | -106 | 1 | 0 | 1 | 0 | 40 | -0.70 | L | -5.0u |
| 2026-06-10 | MLB | SPREAD | home | 2.5 | 1.00 | -190 | 0 | 0 | 0 | 1 | -19 | -31.40 | L | -1.0u |
| 2026-06-10 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 4 | 1 | 5 | 0 | -10 | 0.00 | L | -5.0u |
...
| 2026-06-11 | MLB | ML | away | 3.0 | 0.50 | -120 | -1 | 0 | -1 | 3 | 4 | -1.70 | P | +0.0u |
...
| 2026-06-11 | MLB | TOTAL | under | 5.0 | 1.00 | -108 | 1 | 1 | 2 | -1 | -6 | 0.00 | L | -1.0u |
| 2026-06-11 | MLB | ML | away | 5.0 | 1.00 | +110 | 3 | 1 | 4 | 3 | 20 | -0.90 | L | -1.0u |
| 2026-06-11 | MLB | ML | away | 3.0 | 0.50 | -111 | 1 | 0 | 1 | 1 | 31 | 0.00 | L | -0.5u |
| 2026-06-11 | MLB | ML | home | 5.0 | 5.00 | -131 | 2 | 1 | 3 | 0 | 3 | 0.00 | W | +3.8u |
| 2026-06-11 | MLB | ML | away | 4.0 | 1.00 | +100 | 1 | 0 | 1 | 1 | -31 | -0.50 | W | +1.0u |
| 2026-06-11 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | -1 | -1 | -2 | -1 | 4 | 0.00 | W | +0.2u |
| 2026-06-11 | NHL | TOTAL | under | 3.0 | 0.50 | -104 | 2 | 0 | 2 | 3 | 14 | 0.00 | P | +0.0u |
| 2026-06-12 | MLB | ML | home | 5.0 | 5.00 | -114 | 0 | 0 | 0 | 0 | 3 | 0.00 | W | +4.4u |
| 2026-06-12 | MLB | ML | home | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 0 | 3 | 0.00 | L | -3.0u |
| 2026-06-12 | MLB | TOTAL | over | 4.0 | 1.00 | +100 | 0 | 0 | 0 | 0 | -2 | 0.00 | L | -1.0u |
| 2026-06-12 | MLB | ML | home | 3.0 | 0.50 | -210 | 2 | 0 | 2 | 1 | 31 | -0.10 | W | +0.2u |
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +111 | 3 | 1 | 4 | 3 | 20 | -0.70 | L | -0.3u |
| 2026-06-12 | MLB | ML | away | 4.0 | 1.00 | -114 | 2 | 0 | 2 | 0 | 7 | -1.20 | W | +0.9u |
| 2026-06-12 | MLB | ML | home | 5.0 | 2.50 | +123 | 0 | 1 | 1 | 0 | 3 | 0.00 | W | +3.1u |
| 2026-06-12 | MLB | SPREAD | away | 4.0 | 1.00 | +121 | 0 | 0 | 0 | 1 | 23 | 0.40 | L | -1.0u |
| 2026-06-12 | MLB | ML | home | 4.5 | 3.00 | -138 | 1 | 0 | 1 | 1 | 31 | -1.00 | L | -3.0u |
| 2026-06-12 | MLB | SPREAD | home | 3.0 | 0.50 | -107 | 2 | 0 | 2 | 2 | 15 | -0.40 | W | +0.4u |
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +118 | -1 | 0 | -1 | -1 | -26 | -0.20 | L | -0.3u |
| 2026-06-12 | MLB | ML | away | 4.0 | 1.00 | -136 | 2 | 0 | 2 | 1 | 31 | -1.30 | W | +0.7u |
| 2026-06-12 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | 0 | 3 | 0.00 | W | +2.7u |
| 2026-06-12 | MLB | ML | home | 3.0 | 0.50 | -134 | 2 | 0 | 2 | 2 | 39 | -1.10 | W | +0.4u |
| 2026-06-12 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 2 | 1 | 0.00 | W | +2.7u |
| 2026-06-12 | MLB | SPREAD | away | 4.0 | 1.00 | -106 | 1 | 0 | 1 | 1 | 15 | -1.00 | L | -1.0u |
| 2026-06-13 | MLB | ML | away | 5.0 | 5.00 | -128 | 3 | 0 | 3 | 1 | 55 | -0.20 | L | -5.0u |
...
| 2026-06-13 | MLB | ML | away | 2.5 | 0.25 | -118 | 0 | 0 | 0 | -2 | 42 | -1.30 | W | +0.2u |
| 2026-06-13 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 15 | 0.00 | W | +2.7u |
| 2026-06-13 | MLB | ML | away | 4.5 | 2.50 | +136 | 1 | 0 | 1 | -1 | -34 | 1.30 | L | -2.5u |
| 2026-06-13 | MLB | ML | home | 5.0 | 2.50 | +134 | 2 | 0 | 2 | -1 | 0 | 0.00 | W | +3.4u |
| 2026-06-13 | MLB | SPREAD | home | 4.0 | 1.00 | -130 | 1 | 0 | 1 | 1 | 15 | 0.00 | W | +0.8u |
| 2026-06-13 | MLB | SPREAD | away | 4.0 | 1.00 | -120 | 1 | 0 | 1 | 1 | 15 | 0.20 | W | +0.8u |
| 2026-06-13 | MLB | ML | away | 4.5 | 2.50 | +114 | 1 | 0 | 1 | 0 | 7 | 0.00 | L | -2.5u |
| 2026-06-13 | MLB | TOTAL | under | 4.0 | 1.00 | +101 | 0 | 0 | 0 | 0 | -2 | 0.00 | W | +1.0u |
| 2026-06-13 | MLB | ML | home | 4.5 | 3.00 | -157 | 0 | 0 | 0 | -1 | 8 | 0.00 | L | -3.0u |
| 2026-06-13 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 1 | 0 | 1 | 2 | 23 | 0.00 | W | +0.5u |
| 2026-06-13 | MLB | ML | home | 5.0 | 5.00 | -115 | 1 | 1 | 2 | -1 | 9 | -0.40 | W | +4.3u |
| 2026-06-13 | MLB | SPREAD | away | 4.0 | 1.00 | -106 | 0 | 0 | 0 | 1 | 15 | 0.00 | L | -1.0u |
| 2026-06-13 | MLB | ML | home | 4.0 | 1.00 | -112 | 0 | 0 | 0 | 1 | 15 | -1.30 | W | +0.8u |
...
| 2026-06-14 | MLB | SPREAD | away | 5.0 | 5.00 | -180 | 1 | 0 | 1 | 0 | 10 | 0.00 | L | -5.0u |
...
| 2026-06-14 | MLB | SPREAD | away | 4.5 | 3.00 | -116 | 2 | 0 | 2 | 1 | 5 | 0.00 | L | -3.0u |
| 2026-06-14 | MLB | SPREAD | away | 4.0 | 1.00 | -158 | 1 | -1 | 0 | 2 | 23 | 0.10 | W | +0.6u |
| 2026-06-14 | MLB | ML | away | 4.0 | 1.00 | -125 | 2 | 1 | 3 | 4 | 35 | -1.20 | W | +0.8u |
| 2026-06-14 | MLB | ML | away | 4.5 | 3.00 | -101 | 1 | 0 | 1 | 1 | 15 | 0.00 | L | -3.0u |
| 2026-06-14 | MLB | ML | away | 2.5 | 0.25 | -115 | 2 | 0 | 2 | 2 | 39 | 0.00 | W | +0.2u |
...
| 2026-06-15 | MLB | ML | away | 3.0 | 0.50 | +115 | 2 | 0 | 2 | 1 | 7 | -0.80 | L | -0.5u |
| 2026-06-15 | MLB | ML | away | 3.0 | 0.50 | +160 | 2 | 0 | 2 | 1 | -2 | -0.70 | L | -0.5u |
| 2026-06-15 | MLB | SPREAD | away | 2.5 | 0.25 | -120 | 0 | 0 | 0 | 0 | -9 | 0.00 | L | -0.3u |
| 2026-06-15 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 3 | 0 | 3 | 3 | 19 | 0.00 | L | -3.0u |
| 2026-06-15 | MLB | ML | home | 2.5 | 0.25 | -157 | 1 | 0 | 1 | 2 | 30 | -0.20 | L | -0.3u |
| 2026-06-15 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 6 | 0.00 | L | -1.0u |
...
| 2026-06-15 | MLB | ML | home | 2.5 | 0.25 | -161 | -1 | 1 | 0 | -2 | 6 | -1.00 | W | +0.0u |
| 2026-06-15 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -1.0u |
| 2026-06-16 | MLB | ML | home | 4.0 | 1.00 | -145 | 1 | 0 | 1 | 0 | 28 | -1.00 | W | +0.0u |
...
| 2026-06-16 | MLB | ML | home | 4.5 | 3.00 | -163 | 5 | 3 | 8 | 5 | 33 | -1.00 | W | +2.4u |
| 2026-06-16 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | -1 | 0 | -1 | -1 | -5 | 0.00 | L | -3.0u |
| 2026-06-16 | MLB | ML | home | 4.5 | 3.00 | -135 | 3 | 2 | 5 | 2 | -2 | -2.10 | W | +4.5u |
| 2026-06-16 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 6 | 0.00 | W | +0.0u |
| 2026-06-16 | MLB | ML | away | 2.5 | 0.25 | -106 | 1 | 0 | 1 | 2 | 34 | -0.20 | W | +0.0u |
| 2026-06-16 | MLB | ML | home | 3.0 | 0.50 | -174 | 2 | 1 | 3 | 3 | 49 | -1.40 | W | +2.3u |
| 2026-06-16 | MLB | ML | away | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 0 | 20 | -0.80 | L | -1.0u |
| 2026-06-16 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 3 | 24 | 0.00 | L | -5.0u |
| 2026-06-16 | MLB | ML | home | 3.0 | 0.50 | -138 | 0 | 0 | 0 | 0 | 36 | 0.70 | L | -0.5u |
| 2026-06-16 | MLB | ML | away | 3.0 | 0.50 | -102 | 1 | 0 | 1 | 1 | 31 | -1.00 | L | -0.5u |
| 2026-06-16 | MLB | SPREAD | away | 4.0 | 1.00 | -160 | 0 | 0 | 0 | 2 | 16 | 30.10 | W | +0.0u |
| 2026-06-16 | MLB | ML | home | 3.0 | 0.50 | -161 | 1 | 1 | 2 | 1 | 25 | -0.40 | L | -0.5u |
...
| 2026-06-17 | MLB | ML | away | 4.5 | 2.50 | +112 | -1 | -1 | -2 | -1 | 52 | -1.20 | L | -2.5u |
| 2026-06-17 | MLB | ML | home | 5.0 | 5.00 | -173 | 1 | 0 | 1 | 0 | -4 | 0.00 | W | +0.0u |
| 2026-06-17 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 15 | 0.00 | W | +2.7u |
| 2026-06-17 | MLB | ML | away | 5.0 | 2.50 | +100 | 1 | 0 | 1 | 1 | 15 | 0.00 | W | +2.5u |
| 2026-06-17 | MLB | ML | home | 4.5 | 2.50 | +115 | 1 | 0 | 1 | 0 | 12 | 0.00 | L | -2.5u |
...
| 2026-06-18 | MLB | ML | home | 4.5 | 3.00 | -141 | 1 | 1 | 2 | 1 | 42 | -1.30 | L | -3.0u |
| 2026-06-18 | MLB | ML | home | 4.5 | 3.00 | -151 | 3 | 0 | 3 | 4 | 45 | -1.50 | W | +0.0u |
| 2026-06-18 | MLB | ML | away | 4.5 | 2.50 | +108 | 3 | 1 | 4 | 4 | 5 | -1.20 | W | +2.6u |
...
| 2026-06-18 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 3 | 0 | 3 | 2 | 0 | 0.00 | W | +2.8u |
| 2026-06-19 | MLB | ML | home | 4.5 | 3.00 | -205 | 1 | 0 | 1 | 2 | 9 | 0.10 | W | +0.0u |
...
| 2026-06-19 | MLB | ML | away | 4.5 | 1.00 | +239 | 1 | 0 | 1 | 0 | -4 | 0.00 | L | -1.0u |
| 2026-06-19 | MLB | SPREAD | home | 4.5 | 3.00 | -111 | 1 | 1 | 2 | 1 | 20 | 0.00 | W | +3.1u |
| 2026-06-19 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 2 | 0 | 2 | 2 | -15 | 0.00 | L | -3.0u |
| 2026-06-19 | MLB | ML | away | 4.0 | 1.00 | +107 | 0 | 0 | 0 | 0 | -33 | 0.00 | L | -1.0u |
| 2026-06-19 | MLB | SPREAD | away | 4.0 | 1.00 | -115 | 2 | 0 | 2 | 3 | 18 | 0.00 | W | +2.5u |
| 2026-06-19 | MLB | ML | away | 4.5 | 2.50 | +141 | 1 | 0 | 1 | 1 | 15 | 0.00 | L | -2.5u |
| 2026-06-19 | MLB | ML | home | 2.5 | 0.25 | +158 | -1 | -1 | -2 | 0 | -9 | -1.10 | W | +0.0u |
| 2026-06-19 | MLB | SPREAD | away | 4.5 | 2.50 | -101 | 0 | -1 | -1 | 0 | 12 | -0.70 | L | -2.5u |
| 2026-06-19 | MLB | ML | home | 4.5 | 3.00 | -163 | -1 | -1 | -2 | -1 | 69 | -0.40 | W | +2.4u |
...
| 2026-06-20 | MLB | ML | home | 4.5 | 3.00 | -200 | -2 | 0 | -2 | -2 | -16 | -1.30 | L | -3.0u |
| 2026-06-20 | MLB | SPREAD | home | 3.0 | 0.50 | -110 | 1 | 0 | 1 | 1 | 3 | 0.00 | L | -0.5u |
| 2026-06-20 | MLB | ML | away | 4.5 | 2.50 | +123 | 2 | 0 | 2 | 2 | 4 | -3.20 | L | -2.5u |
| 2026-06-20 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | -1 | 1 | 0 | -1 | 9 | 0.00 | W | +0.0u |
| 2026-06-20 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 1 | 5 | 0.00 | W | +1.8u |
| 2026-06-20 | MLB | ML | away | 3.0 | 0.50 | +116 | 0 | 0 | 0 | -1 | 9 | 0.00 | W | +0.0u |
| 2026-06-20 | MLB | TOTAL | under | 4.0 | 1.00 | -110 | -1 | 0 | -1 | -1 | -5 | 0.00 | L | -1.0u |
| 2026-06-20 | MLB | ML | home | 4.0 | 1.00 | -190 | 2 | 1 | 3 | 1 | 41 | -1.70 | W | +2.0u |
| 2026-06-20 | MLB | ML | home | 5.0 | 5.00 | -137 | 1 | 0 | 1 | 1 | 15 | 0.00 | W | +2.2u |
| 2026-06-20 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 1 | 0 | 1 | 1 | 3 | 0.00 | W | +0.0u |
| 2026-06-20 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 1 | 0 | 1 | 1 | 3 | 0.00 | L | -0.5u |
