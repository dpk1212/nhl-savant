...
_Auto-generated **6/25/2026, 11:35:32 AM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 839 shipped+graded picks · 2026-04-18 → 2026-06-24  (HC analyses scoped to post-cutover 2026-04-30, 727 picks)
**Headline:** 420-411-8 · WR 50.5% [47.1%–53.9%] vs 52.4% break-even · -30.1u flat (-3.6%) · -174.7u peak.
**Overall t-test:** t = -1.06 → ✗ noise.
...
- **ρ(Δw, flat ROI) = 0.026 ✗**  (full sample, N=833)
- **ρ(HC, flat ROI) = -0.014 ✗**  (post-cutover, N=727)
- **ρ(Δw+HC, flat ROI) = -0.022 ✗**  (post-cutover, N=727)
...
- **Stale Δw ≤ 0 (full sample)** — N=227, 105-118, WR 47.1% [41%–54%], flat ROI -11.0% (t=-1.74 ~ p<.10)

### Action map

- **Tier-1a (HC ≥ +2)** — N=46, WR 45.7%, flat ROI -16.2%. Bayesian posterior WR ≈ 46.4%, half-Kelly = **0.0%** bankroll at −110 → **size aggressively**.
- **Tier-1b (HC = +1)** — N=171, WR 57.9%, flat ROI +10.4%. Bayesian posterior WR ≈ 57.5%, half-Kelly = **5.3%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=111, WR 46.4%, flat ROI -12.9%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=117, WR 50.4%, flat ROI -0.2%. Bayesian posterior WR ≈ 50.4%, half-Kelly = **0.0%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -11.0% flat ROI on 227 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (0.98u/pick), we need **~1477 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 839. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **839** |
| W-L-P | 420-411-8 |
| Win rate | **50.5%** [47.1%–53.9%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +1.8 pp |
| Peak-units PnL | **-174.7u** |
| Flat-1u PnL | **-30.1u** (-3.6% flat ROI) |
| Flat t-statistic vs zero | -1.06 → ✗ noise |
| Flat 95% CI per-pick | [-0.102, 0.030]u |
...
We have **839** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = −1 | 37 | 14-22-1 | 38.9% [25–55] | -24.2% | -12.7u | -1.54 ✗ noise |
| Δw = 0 | 181 | 88-90-3 | 49.4% [42–57] | -7.0% | -40.4u | -1.00 ✗ noise |
| Δw = +1 | 336 | 177-156-3 | 53.2% [48–58] | +0.5% | -70.0u | 0.10 ✗ noise |
| Δw = +2 | 153 | 75-77-1 | 49.3% [42–57] | -4.9% | -34.2u | -0.62 ✗ noise |
| Δw ≥ +3 | 117 | 59-58-0 | 50.4% [41–59] | -0.2% | -14.8u | -0.02 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.024** ✗  ·  **ρ(Δw, flat ROI) = 0.026** ✗  (N=833)
...
| HC = 0 | 479 | 231-241-7 | 48.9% [44–53] | -7.7% | -190.9u | -1.77 ~ p<.10 |
| HC = +1 | 171 | 99-72-0 | 57.9% [50–65] | +10.4% | +23.7u | 1.40 ✗ noise |
| HC = +2 | 33 | 17-16-0 | 51.5% [35–67] | -1.2% | -1.1u | -0.07 ✗ noise |
| HC ≥ +3 | 13 | 4-9-0 | 30.8% [13–58] | -54.2% | -7.0u | -2.73 ✓ p<.01 |

**Pearson ρ(HC, WIN) = 0.002** ✗  ·  **ρ(HC, flat ROI) = -0.014** ✗  (N=727)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 178 | 84-91-3 | 48.0% [41–55] | -8.8% | -51.4u | -1.23 ✗ noise |
| Σ = +1 | 256 | 135-118-3 | 53.4% [47–59] | +1.1% | -76.6u | 0.18 ✗ noise |
| Σ = +2 | 141 | 78-62-1 | 55.7% [47–64] | +4.5% | +0.0u | 0.57 ✗ noise |
| Σ = +3 | 67 | 31-36-0 | 46.3% [35–58] | -11.1% | -8.6u | -0.92 ✗ noise |
| Σ = +4 | 41 | 22-19-0 | 53.7% [39–68] | +5.2% | -5.7u | 0.33 ✗ noise |
| Σ = +5 | 20 | 10-10-0 | 50.0% [30–70] | -9.3% | -6.9u | -0.44 ✗ noise |
| Σ ≥ +6 | 24 | 9-15-0 | 37.5% [21–57] | -31.9% | -14.8u | -1.70 ~ p<.10 |

**Pearson ρ(Δw+HC, WIN) = -0.009** ✗  ·  **ρ(Σ, flat ROI) = -0.022** ✗  (N=727)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 727.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.013 ✗ | -0.021 ✗ | -0.006 | weak |
| HC margin | 0.002 ✗ | -0.014 ✗ | 0.023 | weak |
| Δw + HC | -0.009 ✗ | -0.022 ✗ | 0.007 | weak |
| peak.stars | -0.029 ✗ | -0.045 ✗ | -0.051 | weak |
| vault.star | -0.021 ✗ | -0.031 ✗ | -0.046 | weak |
| lock.stars | -0.021 ✗ | -0.034 ✗ | -0.035 | weak |
...
Universe N = 727 (post-cutover, both axes present).
...
| +0 | N=2 · 1-1 · 50% [9–91] · —  | N=4 · 1-3 · 25% [5–70] · -44%  | N=17 · 5-11 · 31% [14–56] · -39%  | N=123 · 59-62 · 49% [40–58] · -8%  | N=228 · 118-107 · 52% [46–59] · -1%  | N=74 · 36-37 · 49% [38–61] · -8%  | N=31 · 11-20 · 35% [21–53] · -34% ✗ |
| +1 | — | — | N=7 · 4-3 · 57% [25–84] · +2%  | N=26 · 15-11 · 58% [39–74] · +7%  | N=62 · 39-23 · 63% [50–74] · +19%  | N=38 · 20-18 · 53% [37–68] · +3%  | N=38 · 21-17 · 55% [40–70] · +6%  |
| +2 | — | — | — | N=1 · 1-0 · 100% [21–100] · —  | N=4 · 1-3 · 25% [5–70] · -55%  | N=11 · 5-6 · 45% [21–72] · -7%  | N=17 · 10-7 · 59% [36–78] · +12%  |
| ≥ +3 | — | — | — | N=1 · 1-0 · 100% [21–100] · —  | — | N=3 · 1-2 · 33% [6–79] · -50%  | N=9 · 2-7 · 22% [6–55] · -66% ✗ |
...
| Δw = −1 | 31 | 13-17-1 | 43.3% [27–61] | -16.2% | -8.2u | -0.93 ✗ noise |
| Δw = 0 | 158 | 81-75-2 | 51.9% [44–60] | -2.3% | -27.0u | -0.31 ✗ noise |
| Δw = +1 | 303 | 162-138-3 | 54.0% [48–60] | +2.1% | -65.4u | 0.39 ✗ noise |
| Δw = +2 | 128 | 64-63-1 | 50.4% [42–59] | -3.7% | -30.4u | -0.43 ✗ noise |
| Δw ≥ +3 | 99 | 46-53-0 | 46.5% [37–56] | -12.2% | -27.0u | -1.26 ✗ noise |

### §3d. Practical lock zones (v7.4 floor anatomy)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 217 | 120-97-0 | 55.3% [49–62] | +4.7% | +15.6u | 0.72 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 111 | 51-59-1 | 46.4% [37–56] | -12.9% | -41.4u | -1.42 ✗ noise |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 399 | 198-195-6 | 50.4% [45–55] | -4.3% | -138.3u | -0.90 ✗ noise |
...
Universe N = 809 picks where ≥1 proven wallet appeared on either side.
...
| Δcount = −1 | 53 | 23-30-0 | 43.4% [31–57] | -14.7% | -34.2u | -1.08 ✗ noise |
| Δcount = 0 (balanced) | 135 | 61-72-2 | 45.9% [38–54] | -11.4% | -22.4u | -1.36 ✗ noise |
| Δcount = +1 | 316 | 159-156-1 | 50.5% [45–56] | -5.5% | -132.4u | -1.03 ✗ noise |
| Δcount = +2 | 158 | 83-74-1 | 52.9% [45–61] | +0.1% | -18.2u | 0.02 ✗ noise |
| Δcount ≥ +3 (heavy support) | 123 | 77-43-3 | 64.2% [55–72] | +24.9% | +54.1u | 2.66 ✓ p<.01 |

**ρ(Δcount, WIN) = 0.122** ✓ p<.01  ·  **ρ(Δcount, flat ROI) = 0.125** ✓ p<.01
...
Quintile cuts: ≤ -7 · ≤ 2 · ≤ 11 · ≤ 22 · > 22

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 181 | 73-108-0 | 40.3% [33–48] | -20.6% | -96.1u | -2.83 ✓ p<.01 |
| Q2 | 147 | 67-78-2 | 46.2% [38–54] | -9.8% | -35.3u | -1.22 ✗ noise |
| Q3 (balanced) | 194 | 104-88-2 | 54.2% [47–61] | +2.2% | -69.0u | 0.32 ✗ noise |
| Q4 | 128 | 70-57-1 | 55.1% [46–63] | +5.1% | +1.8u | 0.59 ✗ noise |
| Q5 (best — heavy support) | 159 | 97-60-2 | 61.8% [54–69] | +14.7% | +32.9u | 1.88 ~ p<.10 |

**ρ(ΔWlNet, WIN) = 0.157** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.134** ✓ p<.01
...
Quintile cuts (units): ≤ -17.97 · ≤ 11.58 · ≤ 17.35 · ≤ 0.87 · > 0.87

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 152 | 68-83-1 | 45.0% [37–53] | -15.2% | -40.3u | -1.98 ✓ p<.05 |
| Q2 | 418 | 212-205-1 | 50.8% [46–56] | -4.0% | -97.0u | -0.85 ✗ noise |
| Q3 | 69 | 39-27-3 | 59.1% [47–70] | +11.7% | +12.1u | 1.03 ✗ noise |
| Q4 | 0 | — | — | — | — | — |
| Q5 | 170 | 92-76-2 | 54.8% [47–62] | +8.4% | -40.5u | 1.03 ✗ noise |
...
Quintile cuts (% ROI): ≤ -9.5 · ≤ 18.6 · ≤ 17.5 · ≤ 0.6 · > 0.6

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 156 | 50-104-2 | 32.5% [26–40] | -37.3% | -97.7u | -5.13 ✓ p<.01 |
| Q2 | 431 | 235-194-2 | 54.8% [50–59] | +4.0% | +5.2u | 0.86 ✗ noise |
| Q3 | 0 | — | — | — | — | — |
| Q4 | 0 | — | — | — | — | — |
| Q5 | 222 | 126-93-3 | 57.5% [51–64] | +10.5% | -73.3u | 1.55 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 110 | 34-74-2 | 31.5% [23–41] | -37.7% | -56.8u | -4.29 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 19 | 7-12-0 | 36.8% [19–59] | -34.1% | -19.1u | -1.66 ~ p<.10 |
| ΔBestRank = 0 (tied) | 3 | 2-1-0 | 66.7% [21–94] | +33.0% | +2.6u | 0.49 ✗ noise |
| ΔBestRank ∈ [+1,+4] | 24 | 14-10-0 | 58.3% [39–76] | +16.5% | +13.5u | 0.78 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 212 | 114-96-2 | 54.3% [48–61] | +6.9% | -38.6u | 0.95 ✗ noise |

**ρ(ΔBestRank, WIN) = 0.223** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.230** ✓ p<.01  (N=368)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 63 | 19-43-1 | 30.6% [21–43] | -39.4% | -42.3u | -3.39 ✓ p<.01 |
| Δshare ∈ [−30,−10] pp | 10 | 2-8-0 | 20.0% [6–51] | -55.6% | -5.3u | -1.86 ~ p<.10 |
| Δshare ≈ 0 (±10 pp) | 535 | 273-260-2 | 51.2% [47–55] | -3.1% | -120.2u | -0.73 ✗ noise |
| Δshare ∈ [+10,+30] pp | 35 | 17-17-1 | 50.0% [34–66] | -3.7% | -1.5u | -0.22 ✗ noise |
| Δshare ≥ +30 pp | 166 | 100-63-3 | 61.3% [54–68] | +18.3% | +3.6u | 2.31 ✓ p<.05 |

**ρ(ΔTopQShare, WIN) = 0.120** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.117** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔTopQCount** | 0.172 ✓ p<.01 | 0.179 ✓ p<.01 | 0.136 |
| 2 | **ΔWlNet** | 0.157 ✓ p<.01 | 0.134 ✓ p<.01 | 0.090 |
| 3 | **Δcount** | 0.122 ✓ p<.01 | 0.125 ✓ p<.01 | 0.099 |
| 4 | **ΔTopQShare** | 0.120 ✓ p<.01 | 0.117 ✓ p<.01 | 0.125 |
| 5 | **ΔFlatPnl** | NaN — | NaN — | 0.089 |
| 6 | **ΔAvgRoi** | NaN — | NaN — | 0.099 |

_(ΔBestRank uses N=368 subset where both sides had a proven wallet — ρ(flat ROI) = 0.230 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 1428, dateRange = 2026-04-18 → 2026-06-24, computedAt = 2026-06-25T15:33:28.852Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **809** rows · PIT aggregate computable on **801** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **801** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 643 · 54% · +2.4% | 465 · 53% · -1.4% | -3.9pp |
| WEAK (−3..0) | 137 · 41% · -19.7% | 315 · 50% · -1.5% | +18.2pp |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=447, WR=55%, ROI=+3.4% | N=355, WR=53%, ROI=-1.7% | -5.0pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=643, WR=54%, ROI=+2.4% | N=465, WR=53%, ROI=-1.4% | -3.9pp |
| AGS < −1 (mute veto) | N=61, WR=48%, ROI=-8.6% | N=183, WR=47%, ROI=-4.5% | +4.1pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-06-11 → 2026-06-24, N=244)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 130 · 55% · +1.3% |
| WEAK (−3..0) | 112 · 49% · -7.2% |
| FADE (<−3) | 2 · 0% · -100.0% |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=104, WR=57%, ROI=+5.1% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=130, WR=55%, ROI=+1.3% |
| AGS < −1 (mute veto) | N=62, WR=47%, ROI=-8.3% |
...
|---|---|---|---|---|
| `dCount` | COUNT | + | 0.84 | 1.89 |
| `dHcSizeRatio` | INTENSITY_HC | + | 0.50 | 6.29 |
| `dSumRankNorm` | QUALITY_RANK | − | 45.08 | 87.14 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.48 | 1.44 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **801/839** shipped+graded rows (95%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 133 | 72-59-2 | 55.0% [46–63] | +0.1% | -22.7u | 0.01 ✗ noise |
| LOCK | 141 | 68-73-0 | 48.2% [40–56] | -8.5% | -45.0u | -1.04 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 118 | 59-57-2 | 50.9% [42–60] | -3.1% | -25.0u | -0.35 ✗ noise |
| FADE | 195 | 91-101-3 | 47.4% [40–54] | -4.7% | -58.7u | -0.63 ✗ noise |
...
r(WIN) = **0.048** ✗ · r(ROI) = **0.023** ✗ · Spearman ρ(ROI) = **-0.010**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 174 | 84-88-2 | 48.8% [41–56] | -3.7% | -45.0u | -0.49 ✗ noise |
| z ∈ [−1, 0) | 305 | 161-141-3 | 53.3% [48–59] | +1.6% | -60.0u | 0.29 ✗ noise |
| z ∈ [0, +1) | 217 | 106-110-1 | 49.1% [42–56] | -7.7% | -46.9u | -1.19 ✗ noise |
| z ≥ +1 (very positive) | 105 | 52-51-2 | 50.5% [41–60] | -7.0% | -13.4u | -0.77 ✗ noise |
...
| z ∈ [0, +1) | 767 | 388-371-8 | 51.1% [48–55] | -3.2% | -162.3u | -0.92 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.032** ✗ · r(ROI) = **-0.038** ✗ · Spearman ρ(ROI) = **-0.042**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 147 | 77-69-1 | 52.7% [45–61] | -1.5% | -16.8u | -0.19 ✗ noise |
| z ∈ [−1, 0) | 323 | 168-153-2 | 52.3% [47–58] | +1.3% | -75.7u | 0.23 ✗ noise |
| z ∈ [0, +1) | 252 | 121-127-4 | 48.8% [43–55] | -6.7% | -68.0u | -1.09 ✗ noise |
| z ≥ +1 (very positive) | 79 | 37-41-1 | 47.4% [37–58] | -13.6% | -4.8u | -1.31 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.032 ✗ | -0.038 ✗ | -0.042 |
| 2 | `dCount` | COUNT | 0.048 ✗ | 0.023 ✗ | -0.010 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | -0.124 | 0.810 | 50.4% | dominant |
| 2 | `dSumRankNorm` | -0.216 | 0.778 | 48.5% | meaningful |
| 3 | `dWinnerCtPreA` | -0.014 | 0.014 | 0.9% | silent (<0.2) |
...
|---|---|---|---|---|
| `dCount` | 1.000 | -0.013 | +0.652 | -0.013 |
| `dHcSizeRatio` | -0.013 | 1.000 | -0.035 | +1.000 ⚠ |
| `dSumRankNorm` | +0.652 | -0.035 | 1.000 | -0.035 |
| `dWinnerCtPreA` | -0.013 | +1.000 ⚠ | -0.035 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **0.012**. At AGS ≥ +0.12 fires N=362, WR=52.5%, ROI=-2.0%. At AGS ≥ +null fires N=476, WR=52.2%, ROI=-2.5%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-362 ROI (matched cohort) | Top-362 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.050 | +0.038 | WR=55%, ROI=+5.8% | -7.8pp | N=435, WR=53%, ROI=+1.3% |
| `dHcSizeRatio` | +0.051 | +0.039 | WR=54%, ROI=+1.1% | -3.1pp | N=394, WR=54%, ROI=+0.7% |
| `dSumRankNorm` | -0.021 | +0.009 | WR=49%, ROI=-7.8% | +5.8pp | N=318, WR=50%, ROI=-6.3% |
| `dWinnerCtPreA` | +0.051 | +0.039 | WR=54%, ROI=+1.0% | -3.0pp | N=385, WR=54%, ROI=+0.5% |
...
|---|---|---|---|---|
| 1 | `dSumRankNorm` | +0.009 | +5.8pp | redundant — other features cover it |
| 2 | `dCount` | +0.038 | -7.8pp | redundant — other features cover it |
| 3 | `dHcSizeRatio` | +0.039 | -3.1pp | redundant — other features cover it |
| 4 | `dWinnerCtPreA` | +0.039 | -3.0pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.147 | 0.147 | negative ↓ |
| 2 | `dCount` | COUNT | +0.131 | 0.131 | positive ↑ |
| 3 | `dWinnerCtPreA` | QUALITY_TRACK | +0.016 | 0.016 | flat ≈ 0 |
| 4 | `dHcSizeRatio` | INTENSITY_HC | +0.004 | 0.004 | flat ≈ 0 |

Intercept b = -0.003 · Final log-loss = 0.6894 · N = 801.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 801 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/801 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 247 | 120-127-0 | 48.6% [42–55] | -10.4% | -123.6u | -1.73 ~ p<.10 |
| 4.5★ | 163 | 90-71-2 | 55.9% [48–63] | +5.6% | -16.2u | 0.73 ✗ noise |
| 4.0★ | 167 | 77-88-2 | 46.7% [39–54] | -9.5% | -24.1u | -1.25 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 109 | 54-52-3 | 50.9% [42–60] | -1.3% | -4.8u | -0.14 ✗ noise |
| 2.5★ | 115 | 60-54-1 | 52.6% [44–62] | +0.3% | -9.7u | 0.04 ✗ noise |

### §5b. Stars × Δw stratified — does the star tier hold up within each Δw cohort?

| Δw cohort | 5★ | 4.5★ | 4★ | 3.5★ | 3★ | 2.5★ |
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 46/54%/-3% | 44/52%/-0% | 37/33%/-35% | 6/33%/-26% | 39/35%/-33% | 54/55%/+6% |
| Δw = +1 | 64/55%/+1% | 75/53%/+0% | 85/48%/-8% | 28/54%/+4% | 44/59%/+14% | 39/54%/-2% |
| Δw = +2 | 67/45%/-14% | 22/50%/-5% | 37/57%/+9% | — | 16/53%/+3% | 11/45%/-9% |
| Δw ≥ +3 | 68/41%/-24% | 19/79%/+50% | 8/50%/+1% | 3/67%/+156% | 10/70%/+46% | 9/33%/-30% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| −400+ | 12 | 10-2-0 | 83.3% [55–95] | +3.7% | +7.8u | 0.26 ✗ noise |
| −300/−201 | 28 | 18-10-0 | 64.3% [46–79] | -7.2% | +9.6u | -0.54 ✗ noise |
| −200/−151 | 86 | 50-36-0 | 58.1% [48–68] | -7.4% | -31.7u | -0.87 ✗ noise |
| −150/−101 | 491 | 248-238-5 | 51.0% [47–55] | -4.1% | -88.0u | -0.97 ✗ noise |
| −100/+100 | 10 | 6-4-0 | 60.0% [31–83] | +20.0% | +4.3u | 0.61 ✗ noise |
| +101/+150 | 166 | 72-91-3 | 44.2% [37–52] | -3.0% | -72.5u | -0.36 ✗ noise |
| +151/+200 | 24 | 13-11-0 | 54.2% [35–72] | +42.3% | +10.8u | 1.54 ✗ noise |
| +201+ | 20 | 3-17-0 | 15.0% [5–36] | -35.8% | -4.8u | -0.98 ✗ noise |

### §6b. Odds × Δw heatmap (flat ROI %, sample size in parens)

| Odds | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| −400+ | -36% (2) | -10% (4) | +32% (1) | +24% (4) |
| −300/−201 | -16% (12) | +18% (5) | +15% (5) | -29% (6) |
| −200/−151 | -24% (25) | +4% (35) | +33% (12) | -50% (13) |
| −150/−101 | -7% (130) | +0% (205) | -16% (88) | +2% (65) |
| −100/+100 | -100% (2) | +67% (6) | -100% (1) | +100% (1) |
| +101/+150 | -9% (46) | -1% (64) | +4% (36) | -10% (20) |
| +151/+200 | +70% (3) | +31% (10) | +54% (7) | +73% (3) |
| +201+ | -55% (7) | -100% (5) | -100% (3) | +94% (5) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 443 | 218-224-1 | 49.3% [45–54] | -6.0% | -103.1u | -1.25 ✗ noise |
| SPREAD | 141 | 70-69-2 | 50.4% [42–59] | -5.6% | -33.7u | -0.70 ✗ noise |
| TOTAL | 255 | 132-118-5 | 52.8% [47–59] | +1.6% | -37.9u | 0.27 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=120 · 44% · -18% | N=163 · 53% · -2% | N=82 · 52% · +3% | N=75 · 47% · -6% |
| SPREAD | N=40 · 36% · -34% | N=63 · 58% · +10% | N=21 · 62% · +11% | N=16 · 38% · -27% |
| TOTAL | N=67 · 60% · +15% | N=110 · 51% · -2% | N=50 · 39% · -24% | N=26 · 69% · +33% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 637 | 326-306-5 | 51.6% [48–55] | -2.5% | -133.8u | -0.65 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=180 · 49% · -7% | N=285 · 53% · +1% | N=113 · 50% · -3% | N=58 · 52% · -3% |
...
|---|---|---|
| **sharps3Plus** | 290 · 46% · -9.8% · -1.65 ~ p<.10 | 548 · 53% · -0.6% · -0.14 ✗ noise |
| **plusEV** | 78 · 49% · -5.5% · -0.44 ✗ noise | 760 · 51% · -3.6% · -1.02 ✗ noise |
| **pinnacleConfirms** | 176 · 55% · +3.5% · 0.46 ✗ noise | 484 · 49% · -7.4% · -1.67 ~ p<.10 |
| **invested10kPlus** | 373 · 51% · -3.3% · -0.65 ✗ noise | 287 · 49% · -5.9% · -1.03 ✗ noise |
| **lineMovingWith** | 336 · 55% · +4.1% · 0.76 ✗ noise | 502 · 48% · -9.0% · -2.08 ✓ p<.05 |
| **predMarketAligns** | 194 · 52% · -2.9% · -0.40 ✗ noise | 466 · 50% · -5.1% · -1.13 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 300 | 152-148-0 | 50.7% [45–56] | -2.8% | -103.2u | -0.50 ✗ noise |
| 1 | 161 | 77-79-5 | 49.4% [42–57] | -5.2% | -32.1u | -0.68 ✗ noise |
| 2 | 170 | 84-83-3 | 50.3% [43–58] | -3.8% | -13.0u | -0.51 ✗ noise |
| 3 | 66 | 33-33-0 | 50.0% [38–62] | -7.3% | -10.8u | -0.61 ✗ noise |
| 4 | 66 | 36-30-0 | 54.5% [43–66] | -0.8% | -8.9u | -0.07 ✗ noise |
| 5 | 61 | 31-30-0 | 50.8% [39–63] | -7.4% | -9.3u | -0.60 ✗ noise |
...
| NEAR_START | 317 | 153-159-5 | 49.0% [44–55] | -5.3% | -72.4u | -0.93 ✗ noise |
| NO_MOVE | 24 | 11-13-0 | 45.8% [28–65] | -15.9% | +4.2u | -0.82 ✗ noise |
| PREGAME | 216 | 112-104-0 | 51.9% [45–58] | -0.8% | -76.2u | -0.12 ✗ noise |
| SMALL_MOVE | 162 | 79-81-2 | 49.4% [42–57] | -6.8% | -26.9u | -0.89 ✗ noise |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 483 | 247-233-3 | 51.5% [47–56] | -3.4% | -147.2u | -0.78 ✗ noise |
| STRONG | 119 | 59-58-2 | 50.4% [41–59] | -2.3% | -7.9u | -0.25 ✗ noise |
| LEAN | 225 | 109-113-3 | 49.1% [43–56] | -4.1% | -17.2u | -0.59 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.071 ✓ p<.05 | -0.056 ✗ | -0.044 | -1.61 |
| totalInvested | -0.053 ✗ | -0.062 ~ p<.10 | 0.000 | -1.80 |
| evEdge | 0.085 ✓ p<.05 | 0.102 ✓ p<.01 | 0.041 | 2.98 |
| moneyPct | 0.050 ✗ | 0.025 ✗ | 0.008 | 0.71 |
| walletPct | 0.046 ✗ | 0.032 ✗ | 0.024 | 0.92 |
| criteriaMet | 0.007 ✗ | 0.005 ✗ | -0.029 | 0.14 |
| maxContribFor | -0.005 ✗ | 0.007 ✗ | 0.023 | 0.19 |
| meanBaseFor | -0.004 ✗ | 0.018 ✗ | 0.035 | 0.53 |
...
Sample with CLV: **824** picks. Mean CLV = **-0.0029**.
t-statistic vs zero: -1.90 → ~ p<.10 · 95% CI [-0.0059, 0.0001]

Bucketed CLV vs flat PnL:

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLV ≤ −2% | 96 | 44-51-1 | 46.3% [37–56] | -14.8% | -32.6u | -1.55 ✗ noise |
| CLV (−2%, 0] | 483 | 243-234-6 | 50.9% [46–55] | -3.3% | -89.0u | -0.75 ✗ noise |
| CLV (0, +2%] | 205 | 107-98-0 | 52.2% [45–59] | +2.9% | -39.8u | 0.40 ✗ noise |
| CLV > +2% | 40 | 20-19-1 | 51.3% [36–66] | -5.0% | -3.5u | -0.33 ✗ noise |

ρ(CLV, flat ROI) = 0.020 ✗
...
Trained on N=611 (with all features non-null). Intercept β₀ = 0.056.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | sharpCount | -0.262 | ↓ hurts |
| 2 | pw.Δcount | +0.226 | ↑ helps |
| 3 | log(impliedProb) | +0.199 | ↑ helps |
| 4 | pw.ΔAvgRoi | +0.198 | ↑ helps |
| 5 | pw.ΔFlatPnl | +0.190 | ↑ helps |
| 6 | evEdge | +0.180 | ↑ helps |
| 7 | pw.ΔTopQShare | +0.155 | ↑ helps |
| 8 | pw.ΔWlNet | +0.119 | ↑ helps |
| 9 | odds (American) | -0.107 | ↓ hurts |
| 10 | HC margin | +0.076 | ↑ helps |
| 11 | peak.stars | -0.074 | ↓ hurts |
| 12 | moneyPct | -0.048 | ≈ flat |
| 13 | Δw | -0.041 | ≈ flat |
| 14 | log10(invested) | +0.037 | ≈ flat |
| 15 | vault.star | +0.033 | ≈ flat |
| 16 | criteriaMet | +0.012 | ≈ flat |
| 17 | walletPct | +0.008 | ≈ flat |
| 18 | Δw + HC | +0.003 | ≈ flat |
...
|---|---|---|---|---|---|---|---|---|
| Tier-1a HC ≥ +2 (post-cutover) | 46 | 21-25 | 45.7% | 46.4% | -110 | — (mute) | 2.80u | **MUTE** (negative EV at posterior) |
| Tier-1b HC = +1 (post-cutover) | 171 | 99-72 | 57.9% | 57.5% | -110 | 5.33% bankroll | 2.05u | **UNDER-SIZED** — ship up to 5.33u (1u=1% bankroll) |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 111 | 51-59 | 46.4% | 46.7% | -110 | — (mute) | 2.00u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 117 | 59-58 | 50.4% | 50.4% | -110 | — (mute) | 2.45u | **MUTE** (negative EV at posterior) |
| Stale Δw = 0 | 181 | 88-90 | 49.4% | 49.5% | -110 | — (mute) | 1.89u | **MUTE** (negative EV at posterior) |
| Stale Δw ≤ −1 | 46 | 17-28 | 37.8% | 40.0% | -110 | — (mute) | 1.33u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.332  (annualized × √252 ≈ -5.27)
...
| 2026-05-11 | MLB | ML | away | 3.5 | 1.13 | -101 | 1 | 1 | 2 | 2 | -25 | 0.00 | W | +1.1u |
...
| 2026-05-16 | MLB | ML | away | 5.0 | 4.50 | +124 | 3 | 1 | 4 | 4 | -30 | -1.30 | W | +1.4u |
...
| 2026-05-18 | MLB | ML | home | 3.0 | 1.25 | +132 | 2 | 0 | 2 | 2 | -7 | 0.40 | W | +1.6u |
...
| 2026-05-19 | MLB | ML | home | 5.0 | 2.50 | +118 | 1 | 1 | 2 | 1 | -26 | -1.30 | L | -2.5u |
| 2026-05-19 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 2 | 0 | 2 | 1 | 1 | 0.00 | W | +1.5u |
| 2026-05-19 | MLB | ML | home | 2.5 | 2.50 | +105 | 1 | 1 | 2 | 2 | -25 | -0.90 | L | -2.5u |
...
| 2026-05-21 | MLB | ML | home | 5.0 | 2.50 | +125 | 1 | 1 | 2 | 2 | -25 | -0.40 | L | -2.5u |
...
| 2026-05-22 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | -1 | 6 | 0.00 | W | +0.7u |
...
| 2026-05-22 | MLB | ML | away | 5.0 | 1.50 | +185 | 3 | 0 | 3 | 2 | -25 | -1.10 | L | -1.5u |
...
| 2026-05-23 | MLB | TOTAL | over | 2.5 | 0.30 | -110 | 0 | 1 | 1 | 0 | -33 | 0.00 | W | +0.3u |
| 2026-05-23 | MLB | ML | home | 5.0 | 1.00 | -148 | 0 | 0 | 0 | 1 | -19 | -0.20 | L | -1.0u |
| 2026-05-23 | MLB | SPREAD | away | 3.0 | 0.75 | -163 | 1 | 0 | 1 | 1 | -19 | 0.00 | W | +0.5u |
| 2026-05-23 | MLB | TOTAL | under | 5.0 | 3.00 | -110 | 3 | 1 | 4 | 3 | -25 | 0.00 | W | +2.7u |
...
| 2026-05-23 | MLB | ML | away | 3.0 | 1.25 | +166 | 2 | 1 | 3 | 2 | -43 | -0.30 | W | +1.8u |
| 2026-05-23 | MLB | SPREAD | away | 4.5 | 2.25 | -123 | 1 | 0 | 1 | 2 | 6 | -0.90 | W | +1.6u |
| 2026-05-23 | MLB | TOTAL | over | 2.5 | 0.30 | -111 | 1 | 0 | 1 | 0 | 11 | 0.00 | L | -0.3u |
...
| 2026-05-24 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 2 | 0 | 2 | 1 | 6 | 0.00 | W | +0.7u |
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 1 | 0 | 1 | 1 | 10 | 0.00 | L | -1.6u |
| 2026-05-24 | MLB | ML | home | 2.5 | 0.50 | +144 | 1 | 1 | 2 | -2 | -59 | 0.00 | L | -0.5u |
...
| 2026-05-24 | MLB | SPREAD | home | 3.0 | 0.75 | +134 | 1 | 0 | 1 | 1 | -3 | 0.00 | L | -0.8u |
...
| 2026-05-25 | MLB | TOTAL | under | 5.0 | 2.25 | -112 | 4 | 0 | 4 | 4 | 10 | 0.00 | L | -2.3u |
| 2026-05-25 | MLB | ML | home | 5.0 | 1.25 | -160 | 3 | 0 | 3 | 2 | -38 | -1.10 | L | -1.3u |
| 2026-05-25 | MLB | TOTAL | over | 5.0 | 3.00 | -110 | 3 | 0 | 3 | 3 | 34 | 0.00 | W | +2.5u |
...
| 2026-05-26 | MLB | ML | away | 5.0 | 1.50 | +200 | 2 | 0 | 2 | 2 | -25 | -1.00 | L | -1.5u |
...
| 2026-05-26 | MLB | ML | away | 5.0 | 5.00 | -102 | 3 | 1 | 4 | 3 | -24 | -0.50 | W | +4.9u |
...
| 2026-05-27 | MLB | ML | home | 4.5 | 0.50 | -102 | 3 | 1 | 4 | 3 | 20 | -1.10 | W | +0.4u |
...
| 2026-05-27 | MLB | ML | away | 5.0 | 0.50 | -102 | 3 | 0 | 3 | 2 | -2 | -1.00 | L | -0.5u |
...
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 0.75 | +104 | 2 | 0 | 2 | 2 | 28 | 0.00 | W | +0.8u |
| 2026-05-27 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 2 | 5 | 3 | 0 | -0.30 | L | -2.5u |
| 2026-05-27 | MLB | SPREAD | away | 4.5 | 1.65 | -145 | 1 | 1 | 2 | 1 | 12 | -0.30 | W | +1.1u |
| 2026-05-27 | MLB | ML | away | 5.0 | 5.00 | -126 | 2 | 0 | 2 | 2 | 10 | -4.10 | L | -5.0u |
...
| 2026-05-28 | MLB | TOTAL | over | 5.0 | 3.00 | +101 | 3 | -1 | 2 | 3 | 53 | 0.00 | W | +2.5u |
...
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 1.65 | -106 | 2 | 0 | 2 | 3 | 28 | 0.00 | L | -1.6u |
| 2026-05-29 | MLB | ML | home | 4.0 | 2.50 | +120 | 1 | 0 | 1 | 1 | -6 | 0.40 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 2.25 | -112 | 2 | 0 | 2 | 3 | 53 | 0.00 | W | +2.0u |
...
| 2026-05-29 | MLB | ML | home | 4.5 | 1.25 | -134 | 1 | 0 | 1 | 0 | -25 | -1.70 | W | +2.8u |
| 2026-05-29 | MLB | SPREAD | away | 5.0 | 2.25 | -184 | 0 | 0 | 0 | 2 | 13 | -1.00 | W | +1.2u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 0.75 | -109 | 1 | 0 | 1 | 2 | 28 | 0.00 | W | +0.7u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.75 | -106 | 2 | 1 | 3 | 2 | 26 | 0.70 | L | -2.8u |
...
| 2026-05-30 | MLB | ML | away | 4.0 | 3.75 | -132 | 1 | 1 | 2 | 1 | 57 | -1.00 | W | +2.9u |
...
| 2026-05-30 | MLB | TOTAL | over | 4.0 | 2.25 | -116 | 2 | 0 | 2 | 2 | 23 | 0.00 | W | +1.9u |
...
| 2026-05-31 | MLB | TOTAL | under | 5.0 | 1.65 | -114 | 2 | 0 | 2 | 3 | 9 | 0.00 | L | -1.6u |
...
| 2026-06-01 | MLB | ML | away | 5.0 | 2.50 | +160 | 2 | -1 | 1 | 2 | 26 | -1.30 | W | +2.7u |
| 2026-06-01 | MLB | TOTAL | under | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 2 | -7 | 0.00 | L | -1.0u |
...
| 2026-06-03 | MLB | ML | home | 4.5 | 1.50 | +167 | 0 | 0 | 0 | -1 | 7 | -0.40 | L | -1.5u |
...
| 2026-06-03 | MLB | TOTAL | over | 2.5 | 0.25 | -110 | 1 | 1 | 2 | 1 | -23 | 0.00 | L | -0.3u |
...
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -139 | 0 | 0 | 0 | -1 | 66 | -1.20 | W | +0.3u |
...
| 2026-06-05 | MLB | ML | home | 3.0 | 0.50 | -136 | 1 | 0 | 1 | 3 | 35 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 3 | 0 | 3 | 4 | 20 | 0.00 | W | +0.4u |
...
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -141 | 3 | 2 | 5 | 3 | 19 | 0.30 | W | +0.7u |
...
| 2026-06-06 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 1 | 1 | -1 | 4 | 0.00 | L | -1.0u |
...
| 2026-06-06 | MLB | ML | home | 5.0 | 2.50 | +117 | -2 | -1 | -3 | -1 | -7 | 0.00 | L | -2.5u |
| 2026-06-06 | MLB | ML | home | 5.0 | 5.00 | -154 | 2 | 1 | 3 | 0 | 50 | -0.80 | L | -5.0u |
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -130 | 1 | 0 | 1 | 0 | 46 | -0.90 | W | +2.2u |
| 2026-06-07 | MLB | TOTAL | over | 3.0 | 0.50 | -112 | 0 | 0 | 0 | 3 | 22 | 0.00 | L | -0.5u |
...
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | -107 | 1 | 0 | 1 | -1 | 39 | -0.80 | W | +0.2u |
| 2026-06-07 | MLB | TOTAL | over | 2.5 | 0.25 | -115 | 0 | 0 | 0 | -1 | -21 | 0.00 | W | +0.2u |
| 2026-06-07 | MLB | ML | home | 2.5 | 0.25 | -210 | -1 | 0 | -1 | 1 | 45 | 0.80 | L | -0.3u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -6 | 0.00 | L | -0.5u |
...
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 3.00 | -152 | 2 | 0 | 2 | 1 | 27 | -0.50 | W | +1.9u |
| 2026-06-07 | MLB | TOTAL | over | 5.0 | 2.25 | -114 | 1 | 1 | 2 | 1 | -8 | 0.00 | L | -2.3u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | +102 | 1 | 0 | 1 | -2 | -2 | -0.20 | W | +0.5u |
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 2.25 | +164 | 1 | 1 | 2 | 1 | 12 | 29.50 | W | +3.7u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | +103 | -1 | 0 | -1 | -2 | -26 | 0.20 | W | +0.3u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | -1 | 0 | 1 | 10 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -102 | 2 | 0 | 2 | 0 | 15 | 0.50 | W | +1.0u |
| 2026-06-07 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 7 | 0.00 | W | +4.8u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | -127 | 0 | 1 | 1 | -1 | 39 | -1.90 | W | +0.4u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -6 | 0.00 | W | +0.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -113 | 6 | 1 | 7 | 6 | 61 | -0.50 | L | -3.0u |
| 2026-06-08 | MLB | ML | home | 4.5 | 3.00 | -129 | 3 | 0 | 3 | 2 | 49 | -0.40 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | -1 | -5 | 0.00 | L | -3.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -121 | 1 | 1 | 2 | 0 | 23 | -1.60 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 2 | 50 | 0.00 | P | +0.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -146 | 1 | 0 | 1 | 0 | 25 | -0.50 | W | +2.0u |
| 2026-06-08 | MLB | ML | home | 4.0 | 1.00 | -118 | 2 | 0 | 2 | 2 | -45 | -0.40 | L | -1.0u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 2.50 | -116 | -2 | -2 | -4 | -2 | 18 | 0.00 | W | +2.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 1.50 | +151 | 0 | -1 | -1 | 0 | 15 | 0.00 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 5.0 | 2.50 | +101 | 0 | 0 | 0 | -1 | -8 | 0.00 | W | +2.5u |
...
| 2026-06-09 | MLB | ML | home | 4.0 | 1.00 | +102 | 2 | 0 | 2 | 2 | -3 | -1.20 | L | -1.0u |
...
| 2026-06-10 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 0 | 8 | 0.00 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 4.5 | 3.00 | -148 | 0 | 0 | 0 | 0 | 15 | -0.50 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | +136 | 3 | 0 | 3 | 5 | 49 | -1.10 | L | -1.0u |
...
| 2026-06-10 | MLB | ML | away | 5.0 | 5.00 | -106 | 1 | 0 | 1 | -1 | 32 | -0.70 | L | -5.0u |
...
| 2026-06-11 | MLB | ML | away | 4.0 | 1.00 | +112 | 0 | 0 | 0 | 0 | 14 | 0.00 | L | -1.0u |
| 2026-06-11 | MLB | ML | away | 3.0 | 0.50 | -120 | -1 | 0 | -1 | 4 | 0 | -1.70 | P | +0.0u |
| 2026-06-11 | MLB | SPREAD | away | 4.5 | 2.50 | +140 | 1 | 0 | 1 | 3 | 7 | -1.00 | P | +0.0u |
| 2026-06-11 | MLB | ML | home | 5.0 | 5.00 | — | 1 | 0 | 1 | 1 | -6 | 0.00 | L | -5.0u |
| 2026-06-11 | MLB | ML | away | 3.0 | 0.50 | -167 | 1 | -1 | 0 | 1 | 54 | -0.10 | W | +0.3u |
| 2026-06-11 | MLB | TOTAL | under | 5.0 | 1.00 | -108 | 1 | 1 | 2 | 0 | -20 | 0.00 | L | -1.0u |
...
| 2026-06-12 | MLB | ML | home | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | -8 | 0.00 | L | -3.0u |
| 2026-06-12 | MLB | TOTAL | over | 4.0 | 1.00 | +100 | 0 | 0 | 0 | 0 | 4 | 0.00 | L | -1.0u |
| 2026-06-12 | MLB | ML | home | 3.0 | 0.50 | -210 | 2 | 0 | 2 | 2 | 23 | -0.10 | W | +0.2u |
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +111 | 3 | 1 | 4 | 3 | 20 | -0.70 | L | -0.3u |
| 2026-06-12 | MLB | ML | away | 4.0 | 1.00 | -114 | 2 | 0 | 2 | 1 | -5 | -1.20 | W | +0.9u |
| 2026-06-12 | MLB | ML | home | 5.0 | 2.50 | +123 | 0 | 1 | 1 | 0 | -1 | 0.00 | W | +3.1u |
| 2026-06-12 | MLB | SPREAD | away | 4.0 | 1.00 | +121 | 0 | 0 | 0 | 2 | 23 | 0.40 | L | -1.0u |
| 2026-06-12 | MLB | ML | home | 4.5 | 3.00 | -138 | 1 | 0 | 1 | 0 | 31 | -1.00 | L | -3.0u |
| 2026-06-12 | MLB | SPREAD | home | 3.0 | 0.50 | -107 | 2 | 0 | 2 | 2 | 7 | -0.40 | W | +0.4u |
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +118 | -1 | 0 | -1 | -1 | -22 | -0.20 | L | -0.3u |
| 2026-06-12 | MLB | ML | away | 4.0 | 1.00 | -136 | 2 | 0 | 2 | 2 | 23 | -1.30 | W | +0.7u |
...
| 2026-06-12 | MLB | SPREAD | away | 4.0 | 1.00 | -106 | 1 | 0 | 1 | 0 | 15 | -1.00 | L | -1.0u |
| 2026-06-13 | MLB | ML | away | 5.0 | 5.00 | -128 | 3 | 0 | 3 | 1 | 44 | -0.20 | L | -5.0u |
...
| 2026-06-13 | MLB | ML | away | 4.5 | 2.50 | +136 | 1 | 0 | 1 | -2 | -25 | 1.30 | L | -2.5u |
| 2026-06-13 | MLB | ML | home | 5.0 | 2.50 | +134 | 2 | 0 | 2 | -1 | -6 | 0.00 | W | +3.4u |
| 2026-06-13 | MLB | SPREAD | home | 4.0 | 1.00 | -130 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.8u |
| 2026-06-13 | MLB | SPREAD | away | 4.0 | 1.00 | -120 | 1 | 0 | 1 | 2 | 7 | 0.20 | W | +0.8u |
...
| 2026-06-14 | MLB | ML | away | 4.0 | 1.00 | +106 | 1 | 1 | 2 | 3 | 5 | -1.50 | L | -1.0u |
| 2026-06-14 | MLB | ML | home | 2.5 | 0.25 | -124 | 1 | 0 | 1 | 2 | -23 | -1.50 | W | +0.2u |
...
| 2026-06-14 | MLB | SPREAD | away | 4.5 | 3.00 | -116 | 2 | 0 | 2 | 2 | 6 | 0.00 | L | -3.0u |
| 2026-06-14 | MLB | SPREAD | away | 4.0 | 1.00 | -158 | 1 | -1 | 0 | 1 | 27 | 0.10 | W | +0.6u |
| 2026-06-14 | MLB | ML | away | 4.0 | 1.00 | -125 | 2 | 1 | 3 | 4 | 31 | -1.20 | W | +0.8u |
...
| 2026-06-15 | MLB | ML | away | 3.0 | 0.50 | +160 | 2 | 0 | 2 | 0 | 21 | -0.70 | L | -0.5u |
| 2026-06-15 | MLB | SPREAD | away | 2.5 | 0.25 | -120 | 0 | 0 | 0 | -1 | 0 | 0.00 | L | -0.3u |
| 2026-06-15 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 3 | 0 | 3 | 2 | 30 | 0.00 | L | -3.0u |
| 2026-06-15 | MLB | ML | home | 2.5 | 0.25 | -157 | 1 | 0 | 1 | 3 | 22 | -0.20 | L | -0.3u |
| 2026-06-15 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 16 | 0.00 | L | -1.0u |
...
| 2026-06-15 | MLB | ML | home | 2.5 | 0.25 | -161 | -1 | 1 | 0 | -2 | 8 | -1.00 | W | +0.0u |
| 2026-06-15 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 13 | 0.00 | L | -1.0u |
| 2026-06-15 | SOC | ML | home | 2.5 | 0.25 | -105 | 3 | 3 | 6 | 1 | 2 | -1.10 | L | -0.3u |
...
| 2026-06-16 | MLB | ML | home | 4.5 | 3.00 | -163 | 5 | 3 | 8 | 5 | 38 | -1.00 | W | +2.4u |
| 2026-06-16 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | -1 | 0 | -1 | -1 | -16 | 0.00 | L | -3.0u |
| 2026-06-16 | MLB | ML | home | 4.5 | 3.00 | -135 | 3 | 2 | 5 | 2 | 11 | -2.10 | W | +4.5u |
| 2026-06-16 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 7 | 0.00 | W | +0.0u |
| 2026-06-16 | MLB | ML | away | 2.5 | 0.25 | -106 | 1 | 0 | 1 | 1 | 27 | -0.20 | W | +0.0u |
| 2026-06-16 | MLB | ML | home | 3.0 | 0.50 | -174 | 2 | 1 | 3 | 2 | 30 | -1.40 | W | +2.3u |
| 2026-06-16 | MLB | ML | away | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 0 | 24 | -0.80 | L | -1.0u |
| 2026-06-16 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 2 | 18 | 0.00 | L | -5.0u |
| 2026-06-16 | MLB | ML | home | 3.0 | 0.50 | -138 | 0 | 0 | 0 | 0 | 24 | 0.70 | L | -0.5u |
| 2026-06-16 | MLB | ML | away | 3.0 | 0.50 | -102 | 1 | 0 | 1 | 1 | 27 | -1.00 | L | -0.5u |
| 2026-06-16 | MLB | SPREAD | away | 4.0 | 1.00 | -160 | 0 | 0 | 0 | 2 | 21 | 30.10 | W | +0.0u |
| 2026-06-16 | MLB | ML | home | 3.0 | 0.50 | -161 | 1 | 1 | 2 | 1 | 7 | -0.40 | L | -0.5u |
| 2026-06-16 | MLB | ML | away | 5.0 | 2.50 | +120 | -1 | -1 | -2 | -1 | 26 | -1.80 | L | -2.5u |
| 2026-06-16 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 0 | 0 | 2 | 12 | 0.00 | L | -1.0u |
| 2026-06-16 | MLB | ML | away | 2.5 | 0.25 | -112 | 1 | 0 | 1 | 2 | 10 | -0.90 | W | +0.0u |
| 2026-06-16 | MLB | SPREAD | away | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +0.0u |
| 2026-06-16 | SOC | ML | home | 4.0 | 1.00 | +1375 | 1 | 0 | 1 | -2 | -19 | 0.00 | L | -1.0u |
| 2026-06-17 | MLB | ML | away | 2.5 | 0.25 | +126 | -2 | 0 | -2 | -1 | -14 | -0.40 | W | +0.0u |
| 2026-06-17 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +2.7u |
| 2026-06-17 | MLB | ML | away | 4.5 | 2.50 | +112 | -1 | -1 | -2 | -1 | 41 | -1.20 | L | -2.5u |
| 2026-06-17 | MLB | ML | home | 5.0 | 5.00 | -173 | 1 | 0 | 1 | 1 | -6 | 0.00 | W | +0.0u |
...
| 2026-06-17 | SOC | ML | away | 5.0 | 1.00 | +1028 | 1 | 0 | 1 | -5 | -28 | 0.00 | L | -1.0u |
| 2026-06-17 | SOC | ML | home | 4.0 | 1.00 | -140 | 0 | 0 | 0 | 0 | 3 | -0.30 | W | +0.0u |
| 2026-06-17 | SOC | ML | home | 4.0 | 1.00 | +142 | 1 | 0 | 1 | 2 | -2 | 0.00 | W | +0.0u |
| 2026-06-18 | MLB | ML | home | 4.0 | 1.00 | -138 | 1 | 0 | 1 | 1 | 2 | 0.00 | W | +0.0u |
| 2026-06-18 | MLB | ML | home | 4.5 | 3.00 | -141 | 1 | 1 | 2 | 1 | 40 | -1.30 | L | -3.0u |
| 2026-06-18 | MLB | ML | home | 4.5 | 3.00 | -151 | 3 | 0 | 3 | 3 | 45 | -1.50 | W | +0.0u |
| 2026-06-18 | MLB | ML | away | 4.5 | 2.50 | +108 | 3 | 1 | 4 | 3 | -2 | -1.20 | W | +2.6u |
| 2026-06-18 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +2.7u |
| 2026-06-18 | MLB | SPREAD | away | 4.5 | 3.00 | -199 | 1 | 0 | 1 | 2 | 5 | 0.00 | L | -3.0u |
| 2026-06-18 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 3 | 0 | 3 | 3 | -8 | 0.00 | W | +2.8u |
| 2026-06-18 | SOC | ML | home | 5.0 | 2.50 | +113 | 2 | 0 | 2 | 4 | 7 | 0.00 | W | +0.0u |
| 2026-06-19 | MLB | ML | home | 4.5 | 3.00 | -205 | 1 | 0 | 1 | 1 | 8 | 0.10 | W | +0.0u |
| 2026-06-19 | MLB | TOTAL | over | 4.5 | 3.00 | -114 | 0 | 0 | 0 | 2 | 23 | 0.00 | W | +0.0u |
| 2026-06-19 | MLB | SPREAD | away | 5.0 | 5.00 | -194 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +0.0u |
| 2026-06-19 | MLB | TOTAL | over | 3.0 | 0.50 | -117 | 0 | 0 | 0 | 0 | 4 | 0.00 | W | +0.0u |
| 2026-06-19 | MLB | ML | away | 4.5 | 1.00 | +239 | 1 | 0 | 1 | 1 | -6 | 0.00 | L | -1.0u |
| 2026-06-19 | MLB | SPREAD | home | 4.5 | 3.00 | -111 | 1 | 1 | 2 | 0 | 5 | 0.00 | W | +3.1u |
| 2026-06-19 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 2 | 0 | 2 | 2 | -10 | 0.00 | L | -3.0u |
| 2026-06-19 | MLB | ML | away | 4.0 | 1.00 | +107 | 0 | 0 | 0 | 0 | -33 | 0.00 | L | -1.0u |
| 2026-06-19 | MLB | SPREAD | away | 4.0 | 1.00 | -115 | 2 | 0 | 2 | 3 | 26 | 0.00 | W | +2.5u |
| 2026-06-19 | MLB | ML | away | 4.5 | 2.50 | +141 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -2.5u |
| 2026-06-19 | MLB | ML | home | 2.5 | 0.25 | +158 | -1 | -1 | -2 | 0 | -10 | -1.10 | W | +0.0u |
| 2026-06-19 | MLB | SPREAD | away | 4.5 | 2.50 | -101 | 0 | -1 | -1 | 0 | 15 | -0.70 | L | -2.5u |
| 2026-06-19 | MLB | ML | home | 4.5 | 3.00 | -163 | -1 | -1 | -2 | -1 | 51 | -0.40 | W | +2.4u |
...
| 2026-06-19 | SOC | ML | away | 3.0 | 0.50 | +2500 | 0 | 0 | 0 | -4 | -15 | 0.00 | L | -0.5u |
| 2026-06-19 | SOC | ML | home | 4.5 | 2.50 | +108 | 1 | 0 | 1 | 5 | 24 | -2.40 | L | -2.5u |
| 2026-06-20 | MLB | SPREAD | away | 5.0 | 5.00 | -194 | 0 | 0 | 0 | 1 | 9 | 0.00 | W | +0.0u |
| 2026-06-20 | MLB | ML | home | 4.5 | 3.00 | -200 | -2 | 0 | -2 | -3 | -22 | -1.30 | L | -3.0u |
| 2026-06-20 | MLB | SPREAD | home | 3.0 | 0.50 | -110 | 1 | 0 | 1 | 0 | 0 | 0.00 | L | -0.5u |
| 2026-06-20 | MLB | ML | away | 4.5 | 2.50 | +123 | 2 | 0 | 2 | 3 | 3 | -3.20 | L | -2.5u |
| 2026-06-20 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | -1 | 1 | 0 | 0 | 10 | 0.00 | W | +0.0u |
| 2026-06-20 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | 6 | 0.00 | W | +1.8u |
| 2026-06-20 | MLB | ML | away | 3.0 | 0.50 | +116 | 0 | 0 | 0 | -2 | -1 | 0.00 | W | +0.0u |
| 2026-06-20 | MLB | TOTAL | under | 4.0 | 1.00 | -110 | -1 | 0 | -1 | -1 | -16 | 0.00 | L | -1.0u |
| 2026-06-20 | MLB | ML | home | 4.0 | 1.00 | -190 | 2 | 1 | 3 | 0 | 33 | -1.70 | W | +2.0u |
...
| 2026-06-20 | SOC | ML | away | 2.5 | 0.25 | +474 | -3 | 0 | -3 | -19 | -46 | 0.00 | L | -0.3u |
| 2026-06-20 | SOC | ML | away | 2.5 | 0.25 | +2200 | 0 | 0 | 0 | -1 | -10 | -0.20 | L | -0.3u |
| 2026-06-21 | MLB | ML | home | 4.0 | 1.00 | -226 | 1 | 0 | 1 | 1 | 45 | 0.30 | L | -1.0u |
| 2026-06-21 | MLB | SPREAD | away | 5.0 | 5.00 | -190 | 0 | 0 | 0 | 1 | 9 | -0.50 | L | -5.0u |
| 2026-06-21 | MLB | TOTAL | under | 4.5 | 2.50 | +100 | 1 | 1 | 2 | 1 | 30 | 0.00 | W | +2.5u |
| 2026-06-21 | MLB | ML | home | 4.0 | 1.00 | -104 | -1 | 0 | -1 | -1 | -36 | -0.50 | L | -1.0u |
| 2026-06-21 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 1 | 0.00 | L | -1.0u |
| 2026-06-21 | MLB | ML | away | 5.0 | 2.50 | +113 | 0 | 0 | 0 | 1 | -6 | 0.00 | L | -2.5u |
...
| 2026-06-21 | MLB | ML | home | 4.5 | 3.00 | -178 | 3 | 0 | 3 | 3 | 46 | -1.30 | W | +1.6u |
| 2026-06-21 | MLB | ML | home | 3.0 | 0.50 | +130 | 0 | 0 | 0 | 0 | 24 | -0.80 | L | -0.5u |
| 2026-06-21 | MLB | ML | home | 3.0 | 0.50 | +123 | 1 | 0 | 1 | 1 | 27 | -0.20 | W | +0.0u |
| 2026-06-21 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 0 | -2 | 0.00 | L | -3.0u |
...
| 2026-06-21 | SOC | ML | away | 4.5 | 1.00 | +725 | 2 | 0 | 2 | -5 | -38 | 0.00 | L | -1.0u |
| 2026-06-21 | SOC | ML | home | 4.0 | 1.00 | +650 | 2 | 0 | 2 | 1 | 1 | -0.20 | L | -1.0u |
| 2026-06-21 | SOC | ML | draw | 3.0 | 0.50 | +950 | 0 | 0 | 0 | -8 | -26 | 0.00 | L | -0.5u |
| 2026-06-22 | MLB | ML | home | 4.5 | 3.00 | -138 | 0 | 0 | 0 | 0 | 8 | 0.30 | W | +0.0u |
| 2026-06-22 | MLB | SPREAD | away | 5.0 | 5.00 | -168 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +0.0u |
| 2026-06-22 | MLB | TOTAL | over | 4.5 | 1.00 | +105 | 1 | 0 | 1 | 1 | 2 | 0.00 | L | -1.0u |
| 2026-06-22 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 0 | 10 | 0.00 | L | -3.0u |
| 2026-06-22 | MLB | SPREAD | away | 5.0 | 2.50 | +118 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +0.0u |
| 2026-06-22 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 12 | 0.00 | W | +0.0u |
| 2026-06-22 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +2.7u |
...
| 2026-06-22 | MLB | ML | home | 5.0 | 2.50 | +133 | 0 | 0 | 0 | 0 | -9 | 0.00 | L | -2.5u |
| 2026-06-22 | MLB | ML | home | 5.0 | 2.50 | +137 | 0 | 0 | 0 | 0 | -9 | 0.00 | L | -2.5u |
| 2026-06-22 | MLB | SPREAD | home | 4.5 | 1.00 | -109 | 0 | 0 | 0 | -1 | 11 | 0.00 | W | +0.0u |
| 2026-06-22 | MLB | SPREAD | away | 4.5 | 2.50 | +138 | 2 | 0 | 2 | 1 | 24 | 0.00 | L | -2.5u |
| 2026-06-22 | MLB | TOTAL | under | 4.0 | 1.00 | -104 | 2 | 1 | 3 | 3 | 10 | 0.00 | W | +3.9u |
| 2026-06-22 | MLB | ML | away | 5.0 | 5.00 | — | 1 | 0 | 1 | 1 | 1 | 0.00 | L | -5.0u |
| 2026-06-22 | SOC | ML | draw | 4.5 | 1.00 | +350 | -1 | 0 | -1 | -16 | -43 | -0.70 | L | -1.0u |
| 2026-06-22 | SOC | ML | home | 2.5 | 0.25 | -950 | 1 | 0 | 1 | 8 | 39 | 0.00 | W | +0.0u |
| 2026-06-22 | SOC | ML | home | 4.5 | 2.50 | +139 | 1 | 0 | 1 | 9 | 45 | 0.00 | W | +0.0u |
| 2026-06-23 | MLB | ML | home | 3.0 | 0.50 | -109 | 0 | 0 | 0 | 0 | 15 | -1.80 | L | -0.5u |
| 2026-06-23 | MLB | SPREAD | away | 5.0 | 5.00 | -168 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +0.0u |
| 2026-06-23 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 0 | 0 | 0 | 1 | -6 | 0.00 | W | +0.0u |
| 2026-06-23 | MLB | ML | away | 4.5 | 3.00 | -108 | 2 | 0 | 2 | 2 | -1 | -1.40 | L | -3.0u |
| 2026-06-23 | MLB | ML | away | 4.5 | 3.00 | -133 | 1 | 0 | 1 | 1 | 10 | -1.40 | L | -3.0u |
| 2026-06-23 | MLB | SPREAD | away | 3.0 | 0.50 | +110 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -0.5u |
| 2026-06-23 | MLB | ML | away | 3.0 | 0.50 | -162 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-23 | MLB | SPREAD | home | 4.0 | 1.00 | -107 | 0 | 0 | 0 | 0 | -15 | 0.00 | L | -1.0u |
| 2026-06-23 | MLB | TOTAL | under | 5.0 | 5.00 | -114 | 0 | 0 | 0 | -1 | -19 | 0.00 | L | -5.0u |
| 2026-06-23 | MLB | ML | home | 2.5 | 0.25 | -125 | 1 | 0 | 1 | 1 | 10 | -1.90 | L | -0.3u |
| 2026-06-23 | MLB | TOTAL | under | 5.0 | 1.00 | -102 | 1 | 2 | 3 | 1 | 4 | 0.00 | L | -1.0u |
| 2026-06-23 | MLB | ML | away | 4.5 | 3.00 | -172 | 1 | 0 | 1 | 1 | -4 | 0.00 | W | +0.0u |
| 2026-06-23 | MLB | TOTAL | under | 5.0 | 1.00 | -109 | 2 | 0 | 2 | 2 | -3 | 0.00 | L | -1.0u |
| 2026-06-23 | MLB | SPREAD | away | 5.0 | 2.50 | +132 | 1 | 0 | 1 | 1 | -4 | 0.00 | W | +0.0u |
| 2026-06-23 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -1.0u |
| 2026-06-23 | MLB | ML | home | 5.0 | 2.50 | +104 | 1 | 0 | 1 | 1 | -6 | 0.00 | L | -2.5u |
| 2026-06-23 | MLB | SPREAD | away | 5.0 | 5.00 | -110 | 0 | 0 | 0 | 1 | 9 | 0.00 | L | -5.0u |
| 2026-06-23 | MLB | ML | away | 4.0 | 1.00 | +117 | 1 | 0 | 1 | 1 | 31 | -0.20 | L | -1.0u |
| 2026-06-23 | MLB | SPREAD | away | 2.5 | 0.25 | +106 | 1 | 0 | 1 | 1 | 29 | -1.50 | W | +0.0u |
| 2026-06-23 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | 0 | 0 | 0 | 0 | -3 | 0.00 | W | +0.0u |
| 2026-06-23 | MLB | ML | home | 4.5 | 1.00 | -153 | 2 | 0 | 2 | 2 | 12 | 0.00 | W | +0.0u |
| 2026-06-23 | MLB | SPREAD | home | 3.0 | 0.50 | +139 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
...
| 2026-06-24 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-24 | MLB | ML | away | 4.5 | 3.00 | -132 | 1 | 0 | 1 | 1 | 11 | -1.10 | L | -3.0u |
| 2026-06-24 | MLB | SPREAD | away | 4.0 | 1.00 | +155 | 1 | 0 | 1 | 1 | 11 | -0.30 | L | -1.0u |
| 2026-06-24 | MLB | TOTAL | under | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 16 | 0.00 | W | +0.0u |
| 2026-06-24 | MLB | ML | away | 3.0 | 0.50 | +110 | 1 | 0 | 1 | 1 | 27 | 0.00 | L | -0.5u |
| 2026-06-24 | MLB | TOTAL | over | 2.5 | 0.25 | -110 | 0 | 0 | 0 | 0 | -20 | 0.00 | W | +0.0u |
| 2026-06-24 | MLB | ML | home | 4.5 | 2.50 | +152 | 2 | 0 | 2 | 2 | 35 | -1.10 | W | +5.8u |
| 2026-06-24 | MLB | SPREAD | away | 5.0 | 5.00 | -105 | 0 | 0 | 0 | 1 | 9 | 0.00 | L | -5.0u |
| 2026-06-24 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | -1 | 0 | 1 | 0 | 0.00 | W | +3.6u |
| 2026-06-24 | MLB | ML | away | 4.5 | 2.50 | -134 | 1 | 0 | 1 | 2 | 8 | -0.20 | W | +0.0u |
| 2026-06-24 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 0 | 0 | 0 | -1 | -9 | 0.00 | L | -5.0u |
| 2026-06-24 | MLB | ML | home | 4.5 | 3.00 | -134 | 1 | 0 | 1 | 0 | -5 | -1.90 | L | -3.0u |
| 2026-06-24 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | 0 | 0 | 0 | 0 | 5 | 0.00 | W | +0.0u |
| 2026-06-24 | MLB | ML | away | 3.0 | 0.50 | +132 | 0 | 0 | 0 | 0 | 24 | -2.20 | L | -0.5u |
| 2026-06-24 | MLB | SPREAD | home | 4.0 | 1.00 | -115 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-24 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 16 | 0.00 | L | -3.0u |
| 2026-06-24 | MLB | ML | away | 4.5 | 2.50 | +117 | 1 | 0 | 1 | 1 | 10 | 0.00 | W | +0.0u |
| 2026-06-24 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 16 | 0.00 | W | +0.0u |
| 2026-06-24 | MLB | ML | home | 2.5 | 0.25 | -102 | -1 | 0 | -1 | -1 | 9 | -0.70 | W | +0.0u |
| 2026-06-24 | MLB | SPREAD | away | 4.0 | 1.00 | +136 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -1.0u |
| 2026-06-24 | MLB | TOTAL | under | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 16 | 0.00 | W | +0.0u |
| 2026-06-24 | MLB | ML | home | 4.5 | 2.50 | +108 | 0 | 0 | 0 | 0 | -7 | 0.00 | L | -2.5u |
| 2026-06-24 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -3.0u |
| 2026-06-24 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -0.5u |
| 2026-06-24 | MLB | TOTAL | under | 5.0 | 1.00 | -115 | 2 | 0 | 2 | 2 | 15 | 0.00 | W | +0.0u |
| 2026-06-24 | SOC | ML | home | 4.0 | 1.00 | +153 | 3 | 0 | 3 | 2 | 19 | -1.10 | W | +0.0u |
| 2026-06-24 | SOC | ML | home | 4.5 | 3.00 | -525 | 4 | 1 | 5 | 3 | 36 | 0.50 | W | +1.1u |
| 2026-06-24 | SOC | ML | away | 4.5 | 3.00 | -104 | -1 | 0 | -1 | 2 | 29 | -1.00 | W | +0.0u |
| 2026-06-24 | SOC | ML | home | 2.5 | 0.25 | -257 | 2 | 0 | 2 | 2 | 20 | -1.10 | W | +0.0u |
