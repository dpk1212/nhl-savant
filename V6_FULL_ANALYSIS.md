...
_Auto-generated **5/31/2026, 10:25:10 AM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 404 shipped+graded picks · 2026-04-18 → 2026-05-30  (HC analyses scoped to post-cutover 2026-04-30, 292 picks)
**Headline:** 200-201-3 · WR 49.9% [45.0%–54.7%] vs 52.4% break-even · -17.3u flat (-4.3%) · -74.3u peak.
...
- **ρ(Δw, flat ROI) = 0.026 ✗**  (full sample, N=398)
- **ρ(HC, flat ROI) = -0.027 ✗**  (post-cutover, N=292)
- **ρ(Δw+HC, flat ROI) = -0.080 ✗**  (post-cutover, N=292)
...
- **Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era)** — N=59, 23-36, WR 39.0% [28%–52%], flat ROI -28.5% (t=-2.40 ✓ p<.05)
- **Stale Δw ≤ 0 (full sample)** — N=78, 33-43, WR 43.4% [33%–55%], flat ROI -19.3% (t=-1.85 ~ p<.10)

### Action map

- **Tier-1a (HC ≥ +2)** — N=30, WR 36.7%, flat ROI -31.7%. Bayesian posterior WR ≈ 40.0%, half-Kelly = **0.0%** bankroll at −110 → **size aggressively**.
- **Tier-1b (HC = +1)** — N=120, WR 55.0%, flat ROI +6.9%. Bayesian posterior WR ≈ 54.6%, half-Kelly = **2.3%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=59, WR 39.0%, flat ROI -28.5%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=81, WR 46.9%, flat ROI -3.1%. Bayesian posterior WR ≈ 47.3%, half-Kelly = **0.0%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -19.3% flat ROI on 78 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (1.00u/pick), we need **~1535 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 404. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **404** |
| W-L-P | 200-201-3 |
| Win rate | **49.9%** [45.0%–54.7%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +2.5 pp |
| Peak-units PnL | **-74.3u** |
| Flat-1u PnL | **-17.3u** (-4.3% flat ROI) |
| Flat t-statistic vs zero | -0.86 → ✗ noise |
| Flat 95% CI per-pick | [-0.140, 0.055]u |
...
We have **404** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = 0 | 66 | 31-33-2 | 48.4% [37–60] | -10.0% | -8.3u | -0.87 ✗ noise |
| Δw = +1 | 136 | 78-57-1 | 57.8% [49–66] | +7.8% | +10.1u | 0.97 ✗ noise |
| Δw = +2 | 103 | 47-56-0 | 45.6% [36–55] | -10.9% | -38.7u | -1.11 ✗ noise |
| Δw ≥ +3 | 81 | 38-43-0 | 46.9% [36–58] | -3.1% | -33.7u | -0.24 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.010** ✗  ·  **ρ(Δw, flat ROI) = 0.026** ✗  (N=398)
...
| HC = 0 | 134 | 70-62-2 | 53.0% [45–61] | -2.4% | -11.1u | -0.29 ✗ noise |
| HC = +1 | 120 | 66-54-0 | 55.0% [46–64] | +6.9% | -15.7u | 0.76 ✗ noise |
| HC = +2 | 21 | 8-13-0 | 38.1% [21–59] | -23.0% | -23.9u | -1.04 ✗ noise |
| HC ≥ +3 | 9 | 3-6-0 | 33.3% [12–65] | -51.8% | -8.6u | -2.15 ✓ p<.05 |

**Pearson ρ(HC, WIN) = -0.023** ✗  ·  **ρ(HC, flat ROI) = -0.027** ✗  (N=292)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 33 | 16-16-1 | 50.0% [34–66] | -9.2% | +0.1u | -0.58 ✗ noise |
| Σ = +1 | 71 | 42-28-1 | 60.0% [48–71] | +12.6% | +12.0u | 1.13 ✗ noise |
| Σ = +2 | 84 | 48-36-0 | 57.1% [46–67] | +6.1% | -4.0u | 0.59 ✗ noise |
| Σ = +3 | 46 | 17-29-0 | 37.0% [25–51] | -26.3% | -23.6u | -1.78 ~ p<.10 |
...
**Pearson ρ(Δw+HC, WIN) = -0.080** ✗  ·  **ρ(Σ, flat ROI) = -0.080** ✗  (N=292)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 292.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.093 ✗ | -0.089 ✗ | -0.082 | weak |
| HC margin | -0.023 ✗ | -0.027 ✗ | 0.015 | weak |
| Δw + HC | -0.080 ✗ | -0.080 ✗ | -0.063 | weak |
| peak.stars | -0.093 ✗ | -0.132 ✓ p<.05 | -0.156 | weak |
| vault.star | -0.050 ✗ | -0.066 ✗ | -0.125 | weak |
| lock.stars | -0.045 ✗ | -0.078 ✗ | -0.088 | weak |
...
Universe N = 292 (post-cutover, both axes present).
...
| +0 | — | — | N=1 · 1-0 · 100% [21–100] · —  | N=25 · 15-9 · 63% [43–79] · +14%  | N=53 · 33-19 · 63% [50–75] · +18%  | N=37 · 18-19 · 49% [33–64] · -11%  | N=18 · 3-15 · 17% [6–39] · -70% ✗ |
| +1 | — | — | N=3 · 0-3 · 0% [0–56] · -100%  | N=17 · 8-9 · 47% [26–69] · -8%  | N=44 · 29-15 · 66% [51–78] · +23%  | N=30 · 14-16 · 47% [30–64] · -4%  | N=26 · 15-11 · 58% [39–74] · +15%  |
...
| Δw = 0 | 43 | 24-18-1 | 57.1% [42–71] | +5.7% | +5.1u | 0.40 ✗ noise |
| Δw = +1 | 103 | 63-39-1 | 61.8% [52–71] | +15.0% | +14.6u | 1.64 ✗ noise |
| Δw = +2 | 78 | 36-42-0 | 46.2% [36–57] | -10.8% | -35.0u | -0.96 ✗ noise |
| Δw ≥ +3 | 63 | 25-38-0 | 39.7% [29–52] | -22.8% | -45.8u | -1.86 ~ p<.10 |

### §3d. Practical lock zones (v7.4 floor anatomy)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 150 | 77-73-0 | 51.3% [43–59] | -0.8% | -48.2u | -0.10 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 59 | 23-36-0 | 39.0% [28–52] | -28.5% | -32.7u | -2.40 ✓ p<.05 |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 83 | 49-32-2 | 60.5% [50–70] | +11.4% | +17.3u | 1.14 ✗ noise |
...
Universe N = 379 picks where ≥1 proven wallet appeared on either side.
...
| Δcount = 0 (balanced) | 35 | 12-22-1 | 35.3% [21–52] | -27.8% | -12.8u | -1.68 ~ p<.10 |
| Δcount = +1 | 151 | 74-75-2 | 49.7% [42–58] | -8.7% | -37.6u | -1.15 ✗ noise |
| Δcount = +2 | 106 | 51-55-0 | 48.1% [39–58] | -7.2% | -31.0u | -0.75 ✗ noise |
| Δcount ≥ +3 (heavy support) | 69 | 48-21-0 | 69.6% [58–79] | +40.2% | +34.3u | 3.05 ✓ p<.01 |

**ρ(Δcount, WIN) = 0.155** ✓ p<.01  ·  **ρ(Δcount, flat ROI) = 0.169** ✓ p<.01
...
Quintile cuts: ≤ -17 · ≤ -4 · ≤ 3 · ≤ 14 · > 14

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 85 | 35-50-0 | 41.2% [31–52] | -21.4% | -49.2u | -2.06 ✓ p<.05 |
| Q2 | 71 | 27-43-1 | 38.6% [28–50] | -23.7% | -40.0u | -2.04 ✓ p<.05 |
| Q3 (balanced) | 80 | 40-39-1 | 50.6% [40–61] | -3.0% | +3.9u | -0.28 ✗ noise |
| Q4 | 68 | 41-27-0 | 60.3% [48–71] | +13.6% | -5.1u | 1.17 ✗ noise |
| Q5 (best — heavy support) | 75 | 49-25-1 | 66.2% [55–76] | +28.4% | +29.8u | 2.28 ✓ p<.05 |

**ρ(ΔWlNet, WIN) = 0.186** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.171** ✓ p<.01
...
Quintile cuts (units): ≤ -15.37 · ≤ -4.95 · ≤ 1.14 · ≤ 10.24 · > 10.24

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 83 | 34-48-1 | 41.5% [31–52] | -21.7% | -43.7u | -2.12 ✓ p<.05 |
| Q2 | 69 | 28-41-0 | 40.6% [30–52] | -23.4% | -49.8u | -2.05 ✓ p<.05 |
| Q3 | 76 | 36-39-1 | 48.0% [37–59] | -6.7% | +1.2u | -0.59 ✗ noise |
| Q4 | 76 | 46-30-0 | 60.5% [49–71] | +15.5% | +11.4u | 1.41 ✗ noise |
| Q5 | 75 | 48-26-1 | 64.9% [54–75] | +27.5% | +20.3u | 2.17 ✓ p<.05 |

**ρ(ΔFlatPnl, WIN) = 0.187** ✓ p<.01  ·  **ρ(ΔFlatPnl, flat ROI) = 0.207** ✓ p<.01
...
Quintile cuts (% ROI): ≤ -10.8 · ≤ -5.3 · ≤ 4.4 · ≤ 15.8 · > 15.8

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 76 | 22-52-2 | 29.7% [21–41] | -39.5% | -68.3u | -3.63 ✓ p<.01 |
| Q2 | 76 | 35-41-0 | 46.1% [35–57] | -15.7% | -19.1u | -1.47 ✗ noise |
| Q3 | 79 | 41-38-0 | 51.9% [41–63] | -0.3% | -14.8u | -0.02 ✗ noise |
| Q4 | 74 | 41-32-1 | 56.2% [45–67] | +7.8% | +7.5u | 0.68 ✗ noise |
| Q5 | 74 | 53-21-0 | 71.6% [60–81] | +39.9% | +34.0u | 3.36 ✓ p<.01 |

**ρ(ΔAvgRoi, WIN) = 0.301** ✓ p<.01  ·  **ρ(ΔAvgRoi, flat ROI) = 0.308** ✓ p<.01
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 40 | 7-32-1 | 17.9% [9–33] | -60.3% | -43.7u | -4.57 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 12 | 5-7-0 | 41.7% [19–68] | -22.7% | -7.8u | -0.82 ✗ noise |
| ΔBestRank = 0 (tied) | 1 | 1-0-0 | 100.0% [21–100] | +90.9% | +0.3u | 0.00 ✗ n<2 |
| ΔBestRank ∈ [+1,+4] | 21 | 5-16-0 | 23.8% [11–45] | -50.8% | -19.9u | -2.55 ✓ p<.05 |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 65 | 43-21-1 | 67.2% [55–77] | +38.6% | +25.1u | 2.72 ✓ p<.01 |

**ρ(ΔBestRank, WIN) = 0.475** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.483** ✓ p<.01  (N=139)
...
| Δshare ≈ 0 (±10 pp) | 268 | 126-141-1 | 47.2% [41–53] | -10.8% | -81.2u | -1.84 ~ p<.10 |
| Δshare ∈ [+10,+30] pp | 15 | 10-5-0 | 66.7% [42–85] | +28.3% | +1.8u | 1.10 ✗ noise |
| Δshare ≥ +30 pp | 71 | 50-20-1 | 71.4% [60–81] | +41.0% | +37.0u | 3.35 ✓ p<.01 |

**ρ(ΔTopQShare, WIN) = 0.222** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.204** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔAvgRoi** | 0.301 ✓ p<.01 | 0.308 ✓ p<.01 | 0.263 |
| 2 | **ΔTopQCount** | 0.273 ✓ p<.01 | 0.298 ✓ p<.01 | 0.254 |
| 3 | **ΔFlatPnl** | 0.187 ✓ p<.01 | 0.207 ✓ p<.01 | 0.196 |
| 4 | **ΔTopQShare** | 0.222 ✓ p<.01 | 0.204 ✓ p<.01 | 0.228 |
| 5 | **ΔWlNet** | 0.186 ✓ p<.01 | 0.171 ✓ p<.01 | 0.160 |
| 6 | **Δcount** | 0.155 ✓ p<.01 | 0.169 ✓ p<.01 | 0.158 |

_(ΔBestRank uses N=139 subset where both sides had a proven wallet — ρ(flat ROI) = 0.483 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 705, dateRange = 2026-04-18 → 2026-05-30, computedAt = 2026-05-31T14:22:18.065Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **379** rows · PIT aggregate computable on **375** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **375** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 257 · 55% · +5.5% | 244 · 51% · -4.6% | -10.1pp |
| WEAK (−3..0) | 105 · 41% · -20.3% | 118 · 51% · +3.5% | +23.8pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=199, WR=57%, ROI=+8.6% | N=190, WR=50%, ROI=-6.6% | -15.3pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=257, WR=55%, ROI=+5.5% | N=244, WR=51%, ROI=-4.6% | -10.1pp |
| AGS < −1 (mute veto) | N=37, WR=30%, ROI=-41.1% | N=62, WR=47%, ROI=-1.4% | +39.6pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-05-17 → 2026-05-30, N=203)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 134 · 54% · -0.0% |
| WEAK (−3..0) | 69 · 49% · -7.1% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=101, WR=51%, ROI=-5.1% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=134, WR=54%, ROI=-0.0% |
| AGS < −1 (mute veto) | N=43, WR=49%, ROI=-6.1% |
...
|---|---|---|---|---|
| `dCount` | COUNT | + | 1.16 | 1.47 |
| `dHcSizeRatio` | INTENSITY_HC | + | 1.30 | 5.24 |
| `dSumRankNorm` | QUALITY_RANK | − | 62.72 | 90.90 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.50 | 1.14 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **375/404** shipped+graded rows (93%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| LOCK | 79 | 35-44-0 | 44.3% [34–55] | -16.6% | -31.0u | -1.53 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 45 | 23-21-1 | 52.3% [38–66] | +0.9% | -3.0u | 0.06 ✗ noise |
| FADE | 67 | 29-36-2 | 44.6% [33–57] | -5.8% | -23.0u | -0.41 ✗ noise |
...
r(WIN) = **-0.005** ✗ · r(ROI) = **-0.042** ✗ · Spearman ρ(ROI) = **-0.041**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 46 | 25-20-1 | 55.6% [41–69] | +16.5% | -8.6u | 0.93 ✗ noise |
| z ∈ [−1, 0) | 136 | 71-63-2 | 53.0% [45–61] | -0.8% | -7.7u | -0.09 ✗ noise |
| z ∈ [0, +1) | 129 | 58-71-0 | 45.0% [37–54] | -14.2% | -43.1u | -1.67 ~ p<.10 |
| z ≥ +1 (very positive) | 64 | 32-32-0 | 50.0% [38–62] | -6.9% | -10.2u | -0.57 ✗ noise |
...
| z ∈ [0, +1) | 341 | 171-167-3 | 50.6% [45–56] | -4.4% | -66.4u | -0.85 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.052** ✗ · r(ROI) = **-0.056** ✗ · Spearman ρ(ROI) = **-0.048**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 61 | 35-25-1 | 58.3% [46–70] | +2.9% | -3.7u | 0.25 ✗ noise |
| z ∈ [−1, 0) | 104 | 56-47-1 | 54.4% [45–64] | +8.2% | -10.2u | 0.78 ✗ noise |
| z ∈ [0, +1) | 161 | 72-88-1 | 45.0% [37–53] | -12.4% | -51.4u | -1.60 ✗ noise |
| z ≥ +1 (very positive) | 49 | 23-26-0 | 46.9% [34–61] | -13.5% | -4.2u | -1.00 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.052 ✗ | -0.056 ✗ | -0.048 |
| 2 | `dCount` | COUNT | -0.005 ✗ | -0.042 ✗ | -0.041 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | +0.122 | 0.757 | 48.2% | meaningful |
| 2 | `dSumRankNorm` | +0.032 | 0.753 | 47.9% | meaningful |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.133 | +0.678 | +0.133 |
| `dHcSizeRatio` | +0.133 | 1.000 | +0.091 | +1.000 ⚠ |
| `dSumRankNorm` | +0.678 | +0.091 | 1.000 | +0.091 |
| `dWinnerCtPreA` | +0.133 | +1.000 ⚠ | +0.091 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **-0.022**. At AGS ≥ +0.12 fires N=197, WR=49.2%, ROI=-8.0%. At AGS ≥ +null fires N=252, WR=50.4%, ROI=-6.1%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-197 ROI (matched cohort) | Top-197 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.050 | +0.027 | WR=55%, ROI=+4.9% | -12.9pp | N=155, WR=56%, ROI=+6.6% |
| `dHcSizeRatio` | +0.017 | −0.005 | WR=53%, ROI=-1.5% | -6.5pp | N=192, WR=53%, ROI=-1.8% |
| `dSumRankNorm` | -0.045 | +0.023 | WR=47%, ROI=-10.4% | +2.4pp | N=189, WR=48%, ROI=-9.9% |
| `dWinnerCtPreA` | +0.020 | −0.002 | WR=53%, ROI=-2.3% | -5.7pp | N=181, WR=53%, ROI=-2.3% |
...
|---|---|---|---|---|
| 1 | `dHcSizeRatio` | −0.005 | -6.5pp | mild marginal info |
| 2 | `dWinnerCtPreA` | −0.002 | -5.7pp | mild marginal info |
| 3 | `dSumRankNorm` | +0.023 | +2.4pp | redundant — other features cover it |
| 4 | `dCount` | +0.027 | -12.9pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.135 | 0.135 | negative ↓ |
| 2 | `dWinnerCtPreA` | QUALITY_TRACK | +0.043 | 0.043 | flat ≈ 0 |
| 3 | `dCount` | COUNT | +0.041 | 0.041 | flat ≈ 0 |
| 4 | `dHcSizeRatio` | INTENSITY_HC | +0.024 | 0.024 | flat ≈ 0 |

Intercept b = -0.015 · Final log-loss = 0.6906 · N = 375.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 375 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/375 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 146 | 65-81-0 | 44.5% [37–53] | -19.7% | -79.9u | -2.60 ✓ p<.01 |
| 4.5★ | 39 | 26-13-0 | 66.7% [51–79] | +26.3% | +15.0u | 1.68 ~ p<.10 |
| 4.0★ | 75 | 37-37-1 | 50.0% [39–61] | -3.8% | -2.7u | -0.33 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 50 | 24-25-1 | 49.0% [36–63] | -1.4% | -2.5u | -0.09 ✗ noise |
...
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 12/58%/-4% | 5/60%/+1% | 12/33%/-43% | 6/33%/-26% | 19/33%/-35% | 23/45%/-10% |
| Δw = +1 | 21/52%/-7% | 12/75%/+30% | 34/58%/+11% | 28/54%/+4% | 17/59%/+11% | 23/57%/+4% |
| Δw = +2 | 51/41%/-23% | 12/58%/+13% | 24/50%/-1% | — | 9/44%/-3% | 7/43%/-4% |
| Δw ≥ +3 | 60/40%/-27% | 7/71%/+64% | 5/40%/-24% | 3/67%/+156% | 5/80%/+86% | 1/100%/+145% |
...
| −200/−151 | 38 | 19-19-0 | 50.0% [35–65] | -21.0% | -12.9u | -1.62 ✗ noise |
| −150/−101 | 236 | 118-117-1 | 50.2% [44–57] | -5.2% | -36.7u | -0.84 ✗ noise |
| −100/+100 | 4 | 1-3-0 | 25.0% [5–70] | -50.0% | -3.8u | -1.00 ✗ noise |
| +101/+150 | 87 | 39-46-2 | 45.9% [36–56] | +0.1% | -36.3u | 0.01 ✗ noise |
...
| −200/−151 | -68% (10) | +35% (14) | +27% (5) | -100% (8) |
| −150/−101 | -12% (46) | +10% (82) | -24% (62) | -2% (43) |
| −100/+100 | -100% (1) | +0% (2) | -100% (1) | — |
| +101/+150 | +15% (12) | -9% (32) | +5% (27) | -0% (16) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 211 | 100-111-0 | 47.4% [41–54] | -7.4% | -71.4u | -1.02 ✗ noise |
| SPREAD | 76 | 35-40-1 | 46.7% [36–58] | -16.9% | -4.7u | -1.64 ✗ noise |
| TOTAL | 117 | 65-50-2 | 56.5% [47–65] | +9.5% | +1.9u | 1.07 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=37 · 35% · -36% | N=69 · 59% · +11% | N=51 · 43% · -13% | N=51 · 43% · -7% |
| SPREAD | N=20 · 37% · -35% | N=27 · 48% · -16% | N=16 · 63% · +12% | N=12 · 33% · -35% |
| TOTAL | N=21 · 65% · +25% | N=40 · 62% · +18% | N=36 · 42% · -18% | N=18 · 67% · +29% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 241 | 123-117-1 | 51.2% [45–58] | -3.2% | -34.2u | -0.52 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=43 · 50% · -7% | N=94 · 59% · +8% | N=71 · 45% · -12% | N=32 · 44% · -13% |
...
|---|---|---|
| **sharps3Plus** | 194 · 44% · -11.3% · -1.49 ✗ noise | 209 · 55% · +1.6% · 0.24 ✗ noise |
| **plusEV** | 51 · 43% · -15.4% · -0.95 ✗ noise | 352 · 51% · -3.1% · -0.59 ✗ noise |
| **pinnacleConfirms** | 101 · 48% · -5.8% · -0.53 ✗ noise | 165 · 50% · -5.9% · -0.77 ✗ noise |
| **invested10kPlus** | 190 · 47% · -8.8% · -1.15 ✗ noise | 76 · 54% · +1.5% · 0.14 ✗ noise |
| **lineMovingWith** | 210 · 53% · +2.1% · 0.30 ✗ noise | 193 · 46% · -11.9% · -1.70 ~ p<.10 |
| **predMarketAligns** | 98 · 49% · -4.3% · -0.39 ✗ noise | 168 · 49% · -6.7% · -0.88 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 80 | 42-38-0 | 52.5% [42–63] | -1.0% | -9.5u | -0.09 ✗ noise |
| 1 | 98 | 51-45-2 | 53.1% [43–63] | -0.5% | -8.3u | -0.05 ✗ noise |
| 2 | 106 | 52-53-1 | 49.5% [40–59] | -4.3% | -11.9u | -0.44 ✗ noise |
| 3 | 36 | 17-19-0 | 47.2% [32–63] | -6.9% | -11.1u | -0.40 ✗ noise |
| 4 | 34 | 15-19-0 | 44.1% [29–61] | -18.1% | -14.7u | -1.09 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLEAR_MOVE | 98 | 55-42-1 | 56.7% [47–66] | +7.1% | +4.9u | 0.73 ✗ noise |
| NEAR_START | 156 | 73-81-2 | 47.4% [40–55] | -5.8% | -53.1u | -0.69 ✗ noise |
| NO_MOVE | 13 | 5-8-0 | 38.5% [18–64] | -31.0% | -1.0u | -1.22 ✗ noise |
| PREGAME | 46 | 26-20-0 | 56.5% [42–70] | +5.4% | -0.6u | 0.39 ✗ noise |
| SMALL_MOVE | 89 | 39-50-0 | 43.8% [34–54] | -17.9% | -26.9u | -1.75 ~ p<.10 |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 234 | 116-117-1 | 49.8% [43–56] | -7.4% | -54.4u | -1.20 ✗ noise |
| STRONG | 66 | 35-31-0 | 53.0% [41–65] | +6.3% | -2.9u | 0.50 ✗ noise |
| LEAN | 99 | 47-50-2 | 48.5% [39–58] | -3.5% | -17.3u | -0.32 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.106 ✓ p<.05 | -0.071 ✗ | -0.084 | -1.42 |
| totalInvested | -0.043 ✗ | -0.058 ✗ | -0.063 | -1.17 |
| evEdge | 0.081 ✗ | 0.055 ✗ | 0.048 | 1.10 |
| moneyPct | 0.022 ✗ | -0.011 ✗ | -0.005 | -0.23 |
| walletPct | 0.037 ✗ | 0.022 ✗ | 0.028 | 0.44 |
| criteriaMet | -0.054 ✗ | -0.028 ✗ | -0.048 | -0.57 |
| maxContribFor | -0.065 ✗ | -0.036 ✗ | -0.016 | -0.72 |
| meanBaseFor | -0.037 ✗ | -0.000 ✗ | 0.037 | -0.01 |
...
Sample with CLV: **393** picks. Mean CLV = **-0.0034**.
t-statistic vs zero: -2.35 → ✓ p<.05 · 95% CI [-0.0063, -0.0006]

Bucketed CLV vs flat PnL:

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLV ≤ −2% | 39 | 18-21-0 | 46.2% [32–61] | -21.0% | -10.2u | -1.50 ✗ noise |
| CLV (−2%, 0] | 224 | 109-113-2 | 49.1% [43–56] | -5.8% | -50.9u | -0.88 ✗ noise |
| CLV (0, +2%] | 109 | 56-53-0 | 51.4% [42–61] | +4.3% | -19.3u | 0.41 ✗ noise |
| CLV > +2% | 21 | 11-9-1 | 55.0% [34–74] | -4.0% | +2.1u | -0.20 ✗ noise |

ρ(CLV, flat ROI) = 0.060 ✗
...
Trained on N=293 (with all features non-null). Intercept β₀ = 0.052.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | pw.ΔAvgRoi | +0.343 | ↑ helps |
| 2 | pw.Δcount | +0.294 | ↑ helps |
| 3 | sharpCount | -0.279 | ↓ hurts |
| 4 | evEdge | +0.219 | ↑ helps |
| 5 | log(impliedProb) | +0.200 | ↑ helps |
| 6 | peak.stars | -0.167 | ↓ hurts |
| 7 | pw.ΔWlNet | +0.153 | ↑ helps |
| 8 | pw.ΔFlatPnl | +0.144 | ↑ helps |
| 9 | Δw | -0.133 | ↓ hurts |
| 10 | pw.ΔTopQShare | +0.128 | ↑ helps |
| 11 | HC margin | +0.122 | ↑ helps |
| 12 | odds (American) | -0.100 | ↓ hurts |
| 13 | log10(invested) | -0.050 | ↓ hurts |
| 14 | Δw + HC | -0.047 | ≈ flat |
| 15 | criteriaMet | -0.037 | ≈ flat |
| 16 | walletPct | +0.018 | ≈ flat |
| 17 | vault.star | +0.017 | ≈ flat |
...
| Tier-1b HC = +1 (post-cutover) | 120 | 66-54 | 55.0% | 54.6% | -109 | 2.57% bankroll | 1.97u | ~ in range — 2.57u |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 59 | 23-36 | 39.0% | 40.6% | -110 | — (mute) | 1.98u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 81 | 38-43 | 46.9% | 47.3% | -106 | — (mute) | 2.64u | **MUTE** (negative EV at posterior) |
| Stale Δw = 0 | 66 | 31-33 | 48.4% | 48.6% | -110 | — (mute) | 1.49u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.294  (annualized × √252 ≈ -4.66)
...
| 2026-04-25 | MLB | ML | away | 3.5 | 0.75 | +124 | 1 | — | — | 1 | -17 | -1.50 | L | -0.8u |
| 2026-04-25 | MLB | ML | home | 4.0 | 1.25 | +128 | 1 | — | — | 1 | -17 | -0.40 | L | -1.3u |
...
| 2026-04-26 | MLB | TOTAL | over | 3.5 | 0.50 | -116 | 1 | — | — | -1 | 17 | 0.00 | L | -0.5u |
...
| 2026-04-27 | MLB | ML | away | 3.5 | 0.75 | +104 | 1 | — | — | 1 | -17 | -0.70 | W | +0.8u |
...
| 2026-04-28 | MLB | ML | home | 5.0 | 3.00 | -124 | 2 | — | — | 1 | 0 | -0.80 | W | +2.4u |
...
| 2026-05-02 | MLB | ML | away | 4.5 | 3.00 | +140 | 1 | 1 | 2 | 1 | 0 | -0.50 | L | -3.0u |
...
| 2026-05-10 | MLB | ML | home | 3.5 | 1.13 | -120 | 1 | 1 | 2 | 1 | -17 | 0.00 | W | +0.9u |
| 2026-05-10 | MLB | TOTAL | over | 4.0 | 0.64 | -110 | 2 | 0 | 2 | 1 | -17 | 0.00 | L | -0.6u |
| 2026-05-10 | MLB | TOTAL | over | 4.0 | 0.64 | -110 | 2 | 0 | 2 | 1 | -17 | 0.00 | L | -0.6u |
| 2026-05-10 | MLB | ML | home | 3.5 | 1.13 | -103 | 1 | 1 | 2 | 1 | -17 | 0.00 | L | -1.1u |
| 2026-05-10 | MLB | ML | home | 3.5 | 1.13 | -110 | 1 | 1 | 2 | 1 | -17 | 0.00 | W | +1.0u |
| 2026-05-10 | MLB | ML | away | 3.5 | 1.13 | +134 | 0 | 1 | 1 | 1 | -17 | 0.00 | W | +1.5u |
...
| 2026-05-11 | MLB | ML | away | 3.5 | 1.13 | -101 | 1 | 1 | 2 | 2 | -17 | 0.00 | W | +1.1u |
| 2026-05-11 | MLB | ML | home | 3.5 | 1.13 | -156 | 1 | 1 | 2 | 1 | -17 | 0.00 | W | +0.7u |
...
| 2026-05-13 | MLB | ML | home | 4.5 | 4.50 | -116 | 1 | 1 | 2 | 1 | -17 | -1.30 | W | +3.7u |
| 2026-05-13 | MLB | SPREAD | home | 5.0 | 3.50 | -105 | 1 | 1 | 2 | 2 | -18 | 0.90 | W | +3.2u |
...
| 2026-05-15 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 1 | 1 | 2 | 2 | -15 | 0.00 | W | +0.3u |
...
| 2026-05-16 | MLB | ML | home | 5.0 | 2.50 | +119 | 2 | 1 | 3 | 1 | -17 | -2.00 | L | -2.5u |
| 2026-05-16 | MLB | ML | home | 5.0 | 2.50 | +115 | 3 | 2 | 5 | 2 | 3 | -1.10 | W | +2.8u |
| 2026-05-16 | MLB | TOTAL | over | 4.0 | 1.65 | -110 | 2 | 0 | 2 | 1 | -17 | 0.00 | L | -1.6u |
| 2026-05-16 | MLB | ML | away | 2.5 | 0.50 | -102 | 1 | 0 | 1 | 1 | -50 | 0.00 | W | +0.5u |
| 2026-05-17 | MLB | ML | away | 4.0 | 2.75 | -148 | 1 | 0 | 1 | 2 | 7 | -0.70 | W | +1.9u |
| 2026-05-17 | MLB | ML | away | 2.5 | 0.50 | +139 | 0 | 1 | 1 | 0 | -41 | 0.70 | L | -0.5u |
| 2026-05-17 | MLB | ML | away | 5.0 | 5.00 | -129 | 3 | 1 | 4 | 1 | -17 | 0.40 | L | -5.0u |
| 2026-05-17 | MLB | ML | home | 4.0 | 2.75 | -114 | 3 | 1 | 4 | 4 | -7 | 2.20 | W | +2.4u |
| 2026-05-17 | MLB | TOTAL | over | 4.5 | 2.25 | -110 | 2 | 1 | 3 | 2 | -18 | 0.00 | W | +2.0u |
| 2026-05-17 | MLB | TOTAL | over | 5.0 | 2.50 | +107 | 2 | 2 | 4 | 1 | -17 | 0.00 | L | -2.5u |
...
| 2026-05-18 | MLB | ML | away | 4.0 | 2.50 | +120 | 2 | 0 | 2 | 1 | -17 | -2.10 | L | -2.5u |
| 2026-05-18 | MLB | ML | home | 3.0 | 1.25 | -118 | 2 | 0 | 2 | 1 | -17 | 1.00 | W | +1.1u |
...
| 2026-05-19 | MLB | ML | home | 5.0 | 2.50 | +118 | 1 | 1 | 2 | 1 | -17 | -1.30 | L | -2.5u |
| 2026-05-19 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 2 | 0 | 2 | 1 | 4 | 0.00 | W | +1.5u |
| 2026-05-19 | MLB | ML | home | 2.5 | 2.50 | +105 | 1 | 1 | 2 | 2 | -17 | -0.90 | L | -2.5u |
...
| 2026-05-20 | MLB | ML | away | 5.0 | 2.50 | +113 | 2 | 1 | 3 | 1 | -17 | -1.00 | L | -2.5u |
| 2026-05-20 | MLB | ML | home | 4.0 | 2.75 | -154 | 2 | 0 | 2 | 1 | 24 | -1.50 | W | +1.9u |
| 2026-05-20 | MLB | TOTAL | under | 4.0 | 0.75 | -110 | 2 | 0 | 2 | 1 | -17 | 0.00 | L | -0.8u |
| 2026-05-20 | MLB | ML | home | 2.5 | 0.50 | -140 | 1 | 1 | 2 | 1 | -17 | -1.10 | W | +0.9u |
| 2026-05-20 | MLB | ML | home | 2.5 | 0.50 | +111 | 0 | 1 | 1 | -1 | -24 | 0.00 | W | +0.6u |
| 2026-05-20 | MLB | ML | away | 4.0 | 2.75 | +113 | 1 | 1 | 2 | 0 | -41 | -1.00 | L | -2.8u |
...
| 2026-05-21 | MLB | ML | home | 5.0 | 2.50 | +125 | 1 | 1 | 2 | 2 | -17 | -0.40 | L | -2.5u |
| 2026-05-21 | MLB | SPREAD | home | 3.0 | 0.75 | -148 | 0 | 0 | 0 | 1 | -17 | -1.50 | L | -0.8u |
| 2026-05-21 | MLB | ML | away | 3.0 | 1.25 | +172 | 2 | 0 | 2 | 1 | -17 | -0.50 | L | -1.3u |
| 2026-05-21 | MLB | ML | away | 4.5 | 2.75 | -110 | 2 | 1 | 3 | 1 | -17 | -0.50 | W | +2.5u |
| 2026-05-21 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 0 | 0 | 2 | -1 | 0.00 | W | +0.3u |
| 2026-05-21 | MLB | ML | home | 3.0 | 1.25 | -116 | 3 | 1 | 4 | 2 | -18 | -0.40 | L | -1.3u |
| 2026-05-21 | MLB | ML | away | 3.0 | 1.25 | +129 | 1 | 0 | 1 | 3 | -39 | -0.40 | W | +1.6u |
...
| 2026-05-22 | MLB | SPREAD | home | 5.0 | 0.75 | -155 | 2 | 0 | 2 | 1 | -17 | -0.30 | W | +0.4u |
| 2026-05-22 | MLB | ML | home | 5.0 | 2.75 | -158 | 1 | 0 | 1 | 1 | 24 | -0.80 | W | +1.7u |
| 2026-05-22 | MLB | SPREAD | home | 3.0 | 0.75 | -142 | 1 | 0 | 1 | 1 | -17 | -2.00 | L | -0.8u |
| 2026-05-22 | MLB | ML | home | 5.0 | 5.00 | -145 | 2 | 2 | 4 | 1 | 24 | -2.20 | L | -5.0u |
| 2026-05-22 | MLB | ML | home | 2.5 | 0.50 | +139 | 2 | 1 | 3 | 0 | -25 | -0.90 | W | +0.7u |
| 2026-05-22 | MLB | SPREAD | home | 4.0 | 1.65 | -119 | 1 | 1 | 2 | 1 | -17 | -1.20 | W | +1.3u |
| 2026-05-22 | MLB | ML | away | 5.0 | 1.50 | +185 | 3 | 0 | 3 | 2 | -17 | -1.10 | L | -1.5u |
| 2026-05-22 | MLB | SPREAD | away | 3.0 | 0.75 | -112 | 1 | 0 | 1 | 1 | -17 | -1.40 | W | +0.6u |
...
| 2026-05-23 | MLB | ML | home | 2.5 | 0.50 | -181 | 1 | 0 | 1 | 2 | 15 | -1.70 | W | +0.3u |
...
| 2026-05-23 | MLB | SPREAD | away | 3.0 | 0.75 | -163 | 1 | 0 | 1 | 1 | -17 | 0.00 | W | +0.5u |
| 2026-05-23 | MLB | TOTAL | under | 5.0 | 3.00 | -110 | 3 | 1 | 4 | 2 | -15 | 0.00 | W | +2.7u |
| 2026-05-23 | MLB | SPREAD | home | 3.0 | 0.75 | -163 | 0 | 0 | 0 | 1 | -9 | -0.90 | L | -0.8u |
| 2026-05-23 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 2 | 1 | 3 | 1 | -17 | 0.00 | L | -0.8u |
...
| 2026-05-23 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 1 | -17 | 0.00 | W | +0.7u |
...
| 2026-05-24 | MLB | ML | home | 4.5 | 3.75 | -101 | 2 | 1 | 3 | 2 | -18 | 0.00 | L | -3.8u |
...
| 2026-05-24 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 2 | -18 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | SPREAD | home | 3.0 | 0.75 | +134 | 1 | 0 | 1 | 1 | -15 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 0 | -16 | 0.00 | W | +0.7u |
...
| 2026-05-25 | MLB | ML | home | 5.0 | 1.25 | -160 | 3 | 0 | 3 | 2 | -22 | -1.10 | L | -1.3u |
...
| 2026-05-26 | MLB | ML | away | 5.0 | 1.50 | +200 | 2 | 0 | 2 | 2 | -17 | -1.00 | L | -1.5u |
...
| 2026-05-26 | MLB | ML | away | 5.0 | 5.00 | -200 | 1 | 0 | 1 | 2 | 15 | -0.60 | W | +1.9u |
...
| 2026-05-26 | MLB | ML | home | 5.0 | 5.00 | -105 | 2 | 1 | 3 | 2 | 15 | -2.00 | W | +3.6u |
| 2026-05-26 | MLB | ML | away | 5.0 | 2.50 | +116 | 1 | 0 | 1 | 2 | 15 | -1.00 | W | +2.9u |
...
| 2026-05-27 | MLB | ML | away | 5.0 | 5.00 | -126 | 2 | 0 | 2 | 2 | -12 | -4.10 | L | -5.0u |
...
| 2026-05-28 | MLB | TOTAL | over | 5.0 | 3.00 | +101 | 3 | -1 | 2 | 3 | 20 | 0.00 | W | +2.5u |
| 2026-05-28 | MLB | ML | home | 5.0 | 1.25 | -140 | 2 | 0 | 2 | 2 | -18 | -0.50 | L | -1.3u |
| 2026-05-28 | MLB | TOTAL | under | 5.0 | 1.00 | -107 | 1 | 0 | 1 | 1 | 26 | 0.00 | W | +0.0u |
| 2026-05-28 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 1 | 4 | 2 | -55 | -0.60 | L | -2.5u |
...
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 0.75 | -135 | 2 | 0 | 2 | 1 | -8 | 1.00 | L | -0.8u |
...
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 2.25 | -112 | 2 | 0 | 2 | 3 | 8 | 0.00 | W | +2.0u |
| 2026-05-29 | MLB | SPREAD | away | 4.0 | 0.75 | +150 | 0 | 0 | 0 | 1 | -9 | -0.50 | L | -0.8u |
| 2026-05-29 | MLB | ML | away | 5.0 | 2.50 | +140 | 2 | 1 | 3 | 1 | -11 | 1.00 | L | -2.5u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 1.65 | -103 | 0 | 0 | 0 | 2 | -26 | 0.00 | W | +1.6u |
| 2026-05-29 | MLB | ML | away | 4.5 | 1.25 | -142 | 0 | 1 | 1 | -1 | 4 | -1.20 | W | +0.3u |
...
| 2026-05-30 | MLB | ML | away | 5.0 | 2.50 | +132 | 2 | 1 | 3 | 2 | -18 | 0.00 | L | -2.5u |
| 2026-05-30 | MLB | ML | away | 4.5 | 2.75 | -125 | 1 | 2 | 3 | 1 | 5 | -0.60 | W | +2.3u |
| 2026-05-30 | MLB | ML | home | 5.0 | 5.00 | -130 | 1 | 0 | 1 | 2 | -6 | -1.20 | L | -5.0u |
| 2026-05-30 | MLB | ML | away | 4.0 | 3.75 | -132 | 1 | 1 | 2 | 1 | 40 | -1.00 | W | +2.9u |
| 2026-05-30 | MLB | SPREAD | home | 3.0 | 0.75 | -143 | 0 | 1 | 1 | 0 | 8 | -1.40 | L | -0.8u |
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -118 | 1 | 1 | 2 | 1 | -14 | -1.30 | L | -3.8u |
