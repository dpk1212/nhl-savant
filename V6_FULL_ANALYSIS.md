...
_Auto-generated **5/14/2026, 11:12:54 AM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 176 shipped+graded picks · 2026-04-18 → 2026-05-13  (HC analyses scoped to post-cutover 2026-04-30, 64 picks)
**Headline:** 84-90-2 · WR 48.3% [41.0%–55.7%] vs 52.4% break-even · -6.8u flat (-3.9%) · -18.3u peak.
...
- **ρ(Δw, flat ROI) = 0.157 ✓ p<.05**  (full sample, N=170)
- **ρ(HC, flat ROI) = 0.113 ✗**  (post-cutover, N=64)
- **ρ(Δw+HC, flat ROI) = -0.073 ✗**  (post-cutover, N=64)
...
- **Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era)** — N=12, 3-9, WR 25.0% [9%–53%], flat ROI -51.3% (t=-2.02 ✓ p<.05)
...
- **Tier-1b (HC = +1)** — N=38, WR 60.5%, flat ROI +20.0%. Bayesian posterior WR ≈ 58.3%, half-Kelly = **6.3%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=12, WR 25.0%, flat ROI -51.3%. Δw saves the pick when HC is silent.
...
- **Sample size:** at observed σ (1.06u/pick), we need **~1733 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 176. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **176** |
| W-L-P | 84-90-2 |
| Win rate | **48.3%** [41.0%–55.7%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +4.1 pp |
| Peak-units PnL | **-18.3u** |
| Flat-1u PnL | **-6.8u** (-3.9% flat ROI) |
| Flat t-statistic vs zero | -0.48 → ✗ noise |
| Flat 95% CI per-pick | [-0.196, 0.118]u |
...
We have **176** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = +1 | 60 | 34-25-1 | 57.6% [45–69] | +10.2% | +8.3u | 0.82 ✗ noise |
| Δw = +2 | 39 | 15-24-0 | 38.5% [25–54] | -20.4% | -17.5u | -1.23 ✗ noise |
| Δw ≥ +3 | 35 | 21-14-0 | 60.0% [44–74] | +28.2% | +6.5u | 1.27 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.138** ~ p<.10  ·  **ρ(Δw, flat ROI) = 0.157** ✓ p<.05  (N=170)
...
| HC = 0 | 16 | 6-9-1 | 40.0% [20–64] | -21.6% | -14.0u | -0.91 ✗ noise |
| HC = +1 | 38 | 23-15-0 | 60.5% [45–74] | +20.0% | +9.8u | 1.21 ✗ noise |
| HC = +2 | 7 | 4-3-0 | 57.1% [25–84] | +11.7% | +3.4u | 0.30 ✗ noise |
| HC ≥ +3 | 1 | 0-1-0 | 0.0% [0–79] | -100.0% | -3.5u | 0.00 ✗ n<2 |

**Pearson ρ(HC, WIN) = 0.127** ✗  ·  **ρ(HC, flat ROI) = 0.113** ✗  (N=64)

Spearman rank ρ(HC, flat ROI) = 0.190.
...
| Σ = +2 | 27 | 18-9-0 | 66.7% [48–81] | +29.8% | +9.9u | 1.62 ✗ noise |
...
**Pearson ρ(Δw+HC, WIN) = -0.050** ✗  ·  **ρ(Σ, flat ROI) = -0.073** ✗  (N=64)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 64.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.131 ✗ | -0.150 ✗ | -0.108 | weak |
| HC margin | 0.127 ✗ | 0.113 ✗ | 0.190 | weak |
| Δw + HC | -0.050 ✗ | -0.073 ✗ | -0.013 | weak |
| peak.stars | -0.141 ✗ | -0.148 ✗ | -0.124 | weak |
| vault.star | -0.040 ✗ | -0.005 ✗ | -0.028 | weak |
| lock.stars | -0.110 ✗ | -0.138 ✗ | -0.095 | weak |
...
Universe N = 64 (post-cutover, both axes present).
...
| -2 | — | — | — | — | — | — | — |
| -1 | — | — | — | — | — | — | N=2 · 0-2 · 0% [0–66] · —  |
| +0 | — | — | — | — | N=6 · 3-2 · 60% [23–88] · +12%  | N=5 · 2-3 · 40% [12–77] · -22%  | N=5 · 1-4 · 20% [4–62] · -61%  |
| +1 | — | — | N=1 · 0-1 · 0% [0–79] · —  | N=5 · 2-3 · 40% [12–77] · -14%  | N=20 · 16-4 · 80% [58–92] · +56% ★ | N=8 · 2-6 · 25% [7–59] · -38%  | N=4 · 3-1 · 75% [30–95] · +30%  |
...
| Δw = +1 | 27 | 19-7-1 | 73.1% [54–86] | +40.2% | +12.8u | 2.36 ✓ p<.05 |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 46 | 27-19-0 | 58.7% [44–72] | +16.1% | +9.8u | 1.08 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 12 | 3-9-0 | 25.0% [9–53] | -51.3% | -17.1u | -2.02 ✓ p<.05 |
...
Universe N = 156 picks where ≥1 proven wallet appeared on either side.
...
| Q2 | 31 | 12-18-1 | 40.0% [25–58] | -18.4% | -11.7u | -1.00 ✗ noise |
| Q3 (balanced) | 26 | 12-14-0 | 46.2% [29–65] | -7.9% | -11.6u | -0.39 ✗ noise |
...
Quintile cuts (units): ≤ -2.31 · ≤ 1.38 · ≤ 3.68 · ≤ 11.94 · > 11.94

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 32 | 11-21-0 | 34.4% [20–52] | -34.9% | -14.7u | -2.14 ✓ p<.05 |
| Q2 | 31 | 12-18-1 | 40.0% [25–58] | -18.1% | -8.6u | -1.01 ✗ noise |
| Q3 | 31 | 12-19-0 | 38.7% [24–56] | -24.5% | -16.8u | -1.39 ✗ noise |
| Q4 | 31 | 21-10-0 | 67.7% [50–81] | +35.2% | +6.8u | 1.86 ~ p<.10 |
| Q5 | 31 | 22-8-1 | 73.3% [56–86] | +51.4% | +24.6u | 2.42 ✓ p<.05 |

**ρ(ΔFlatPnl, WIN) = 0.342** ✓ p<.01  ·  **ρ(ΔFlatPnl, flat ROI) = 0.370** ✓ p<.01
...
Quintile cuts (% ROI): ≤ -11.8 · ≤ -0.1 · ≤ 11.7 · ≤ 29.4 · > 29.4

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 32 | 7-24-1 | 22.6% [11–40] | -48.8% | -22.7u | -2.79 ✓ p<.01 |
| Q2 | 31 | 12-19-0 | 38.7% [24–56] | -24.0% | -12.5u | -1.36 ✗ noise |
| Q3 | 31 | 10-21-0 | 32.3% [19–50] | -38.8% | -28.6u | -2.36 ✓ p<.05 |
| Q4 | 31 | 24-6-1 | 80.0% [63–90] | +49.8% | +19.4u | 3.38 ✓ p<.01 |
| Q5 | 31 | 25-6-0 | 80.6% [64–91] | +71.4% | +35.8u | 3.56 ✓ p<.01 |

**ρ(ΔAvgRoi, WIN) = 0.448** ✓ p<.01  ·  **ρ(ΔAvgRoi, flat ROI) = 0.433** ✓ p<.01
...
| Δshare ≈ 0 (±10 pp) | 98 | 41-55-2 | 42.7% [33–53] | -18.0% | -39.5u | -1.85 ~ p<.10 |
| Δshare ∈ [+10,+30] pp | 10 | 5-5-0 | 50.0% [24–76] | -3.9% | +0.7u | -0.12 ✗ noise |
| Δshare ≥ +30 pp | 35 | 29-6-0 | 82.9% [67–92] | +72.9% | +35.8u | 4.07 ✓ p<.01 |

**ρ(ΔTopQShare, WIN) = 0.304** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.262** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔAvgRoi** | 0.448 ✓ p<.01 | 0.433 ✓ p<.01 | 0.443 |
| 2 | **ΔTopQCount** | 0.382 ✓ p<.01 | 0.404 ✓ p<.01 | 0.345 |
| 3 | **ΔFlatPnl** | 0.342 ✓ p<.01 | 0.370 ✓ p<.01 | 0.333 |
| 4 | **ΔWlNet** | 0.314 ✓ p<.01 | 0.287 ✓ p<.01 | 0.275 |
| 5 | **Δcount** | 0.243 ✓ p<.01 | 0.283 ✓ p<.01 | 0.203 |
| 6 | **ΔTopQShare** | 0.304 ✓ p<.01 | 0.262 ✓ p<.01 | 0.311 |
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 156, dateRange = 2026-04-18 → 2026-05-13, computedAt = 2026-05-14T15:10:58.073Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **156** rows · PIT aggregate computable on **150** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **150** rows (34 used the cold-start fallback calibration for the early dates).

Same rows, same outcomes — only the AGS scoring lens differs:

| Tier | In-sample N · WR · ROI | PIT-OOS N · WR · ROI | Δ ROI (OOS − in-sample) |
|---|---|---|---|
| ELITE (≥+7) | 6 · 100% · +94.3% | 6 · 67% · +18.9% | -75.4pp |
| LOCK (+5..+7) | 9 · 67% · +72.6% | 19 · 63% · +18.6% | -54.0pp |
| STRONG (+3..+5) | 25 · 72% · +31.9% | 29 · 69% · +33.2% | +1.2pp |
| NEUTRAL (0..+3) | 43 · 53% · +7.8% | 35 · 44% · -12.4% | -20.1pp |
| WEAK (−3..0) | 22 · 43% · -16.9% | 24 · 33% · -32.3% | -15.4pp |
| FADE (<−3) | 36 · 20% · -59.5% | 28 · 37% · -13.7% | +45.8pp |

Production-threshold lift (the rules that actually fire):

| Floor | In-sample fire | PIT-OOS fire | Δ ROI (OOS − in-sample) |
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=15, WR=80%, ROI=+81.3% | N=25, WR=64%, ROI=+18.7% | -62.6pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=40, WR=75%, ROI=+50.4% | N=54, WR=67%, ROI=+26.5% | -24.0pp |
| AGS < −1 (mute veto) | N=46, WR=27%, ROI=-48.3% | N=43, WR=40%, ROI=-11.4% | +36.9pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-04-30 → 2026-05-13, N=64)
...
| ELITE (≥+7) | 4 · 75% · +29.5% |
| LOCK (+5..+7) | 10 · 70% · +36.7% |
| STRONG (+3..+5) | 15 · 67% · +32.3% |
| NEUTRAL (0..+3) | 20 · 37% · -25.6% |
| WEAK (−3..0) | 6 · 33% · -31.5% |
| FADE (<−3) | 9 · 44% · -7.4% |
...
| AGS ≥ +3 (Δw=+1 confirm route B) | N=29, WR=69%, ROI=+33.4% |
| AGS < −1 (mute veto) | N=13, WR=46%, ROI=-4.3% |
...
|---|---|---|---|---|
| `dCount` | TOTAL | + | 1.85 | 1.59 |
| `dContribution` | TOTAL | + | 108.96 | 92.77 |
| `dBestContrib` | CONCENTRATION | + | 49.56 | 41.40 |
| `dBestWalletBase` | CONCENTRATION | + | 45.45 | 36.16 |
| `dConvictionAvg` | BLENDED | + | 0.64 | 0.56 |
| `dRoiNormAvg` | BLENDED | + | 36.92 | 34.45 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **150/176** shipped+graded rows (85%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| STRONG | 30 | 20-10-0 | 66.7% [49–81] | +28.7% | +12.5u | 1.68 ~ p<.10 |
| NEUTRAL | 40 | 16-23-1 | 41.0% [27–57] | -18.7% | -9.9u | -1.19 ✗ noise |
| WEAK | 26 | 8-18-0 | 30.8% [17–50] | -37.5% | -9.2u | -1.97 ✓ p<.05 |
| FADE | 28 | 10-17-1 | 37.0% [22–56] | -13.7% | -18.4u | -0.54 ✗ noise |
...
r(WIN) = **0.111** ✗ · r(ROI) = **0.022** ✗ · Spearman ρ(ROI) = **0.062**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 22 | 10-12-0 | 45.5% [27–65] | +9.6% | -4.8u | 0.31 ✗ noise |
| z ∈ [−1, 0) | 48 | 22-24-2 | 47.8% [34–62] | -7.6% | -8.3u | -0.54 ✗ noise |
| z ∈ [0, +1) | 54 | 23-31-0 | 42.6% [30–56] | -18.5% | -18.6u | -1.40 ✗ noise |
| z ≥ +1 (very positive) | 26 | 15-11-0 | 57.7% [39–74] | +10.5% | +12.0u | 0.54 ✗ noise |

#### `dContribution` (TOTAL)

r(WIN) = **0.197** ✓ p<.05 · r(ROI) = **0.085** ✗ · Spearman ρ(ROI) = **0.133**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 12 | 4-7-1 | 36.4% [15–65] | +6.7% | -4.5u | 0.13 ✗ noise |
| z ∈ [−1, 0) | 60 | 22-37-1 | 37.3% [26–50] | -26.6% | -22.2u | -2.12 ✓ p<.05 |
| z ∈ [0, +1) | 49 | 27-22-0 | 55.1% [41–68] | +8.0% | +1.8u | 0.56 ✗ noise |
| z ≥ +1 (very positive) | 29 | 17-12-0 | 58.6% [41–74] | +8.5% | +5.2u | 0.47 ✗ noise |

#### `dBestContrib` (CONCENTRATION)

r(WIN) = **0.268** ✓ p<.01 · r(ROI) = **0.161** ✓ p<.05 · Spearman ρ(ROI) = **0.260**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 13 | 3-10-0 | 23.1% [8–50] | -23.9% | -10.4u | -0.51 ✗ noise |
| z ∈ [−1, 0) | 40 | 16-23-1 | 41.0% [27–57] | -21.4% | -17.3u | -1.39 ✗ noise |
| z ∈ [0, +1) | 72 | 32-39-1 | 45.1% [34–57] | -12.1% | -7.5u | -1.04 ✗ noise |
| z ≥ +1 (very positive) | 25 | 19-6-0 | 76.0% [57–89] | +46.2% | +15.5u | 2.67 ✓ p<.01 |

#### `dBestWalletBase` (CONCENTRATION)

r(WIN) = **0.180** ✓ p<.05 · r(ROI) = **0.098** ✗ · Spearman ρ(ROI) = **0.221**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 20 | 7-13-0 | 35.0% [18–57] | -17.2% | -9.6u | -0.54 ✗ noise |
| z ∈ [−1, 0) | 34 | 14-19-1 | 42.4% [27–59] | -15.8% | -13.5u | -0.91 ✗ noise |
| z ∈ [0, +1) | 74 | 32-42-0 | 43.2% [33–55] | -16.1% | -16.8u | -1.41 ✗ noise |
| z ≥ +1 (very positive) | 22 | 17-4-1 | 81.0% [60–92] | +54.3% | +20.2u | 3.23 ✓ p<.01 |

#### `dConvictionAvg` (BLENDED)

r(WIN) = **0.181** ✓ p<.05 · r(ROI) = **0.075** ✗ · Spearman ρ(ROI) = **0.146**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 16 | 4-12-0 | 25.0% [10–49] | -27.3% | -11.3u | -0.70 ✗ noise |
| z ∈ [−1, 0) | 34 | 17-16-1 | 51.5% [35–67] | -1.2% | -5.6u | -0.07 ✗ noise |
| z ∈ [0, +1) | 83 | 39-43-1 | 47.6% [37–58] | -7.4% | -3.0u | -0.68 ✗ noise |
| z ≥ +1 (very positive) | 17 | 10-7-0 | 58.8% [36–78] | +12.2% | +0.1u | 0.51 ✗ noise |

#### `dRoiNormAvg` (BLENDED)

r(WIN) = **0.150** ~ p<.10 · r(ROI) = **0.045** ✗ · Spearman ρ(ROI) = **0.146**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 18 | 6-12-0 | 33.3% [16–56] | -11.3% | -11.5u | -0.31 ✗ noise |
| z ∈ [−1, 0) | 38 | 16-21-1 | 43.2% [29–59] | -16.6% | -9.3u | -1.03 ✗ noise |
| z ∈ [0, +1) | 76 | 37-39-0 | 48.7% [38–60] | -5.4% | +5.5u | -0.48 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dBestContrib` | CONCENTRATION | 0.268 ✓ p<.01 | 0.161 ✓ p<.05 | 0.260 |
| 2 | `dBestWalletBase` | CONCENTRATION | 0.180 ✓ p<.05 | 0.098 ✗ | 0.221 |
| 3 | `dRoiNormAvg` | BLENDED | 0.150 ~ p<.10 | 0.045 ✗ | 0.146 |
| 4 | `dConvictionAvg` | BLENDED | 0.181 ✓ p<.05 | 0.075 ✗ | 0.146 |
| 5 | `dContribution` | TOTAL | 0.197 ✓ p<.05 | 0.085 ✗ | 0.133 |
| 6 | `dCount` | TOTAL | 0.111 ✗ | 0.022 ✗ | 0.062 |
...
|---|---|---|---|---|---|
| 1 | `dBestWalletBase` | +0.080 | 0.837 | 17.7% | dominant |
| 2 | `dCount` | +0.177 | 0.819 | 17.3% | dominant |
| 3 | `dContribution` | +0.196 | 0.781 | 16.5% | meaningful |
| 4 | `dBestContrib` | +0.158 | 0.778 | 16.4% | meaningful |
| 5 | `dRoiNormAvg` | +0.066 | 0.762 | 16.1% | meaningful |
| 6 | `dConvictionAvg` | +0.099 | 0.760 | 16.0% | meaningful |
...
|---|---|---|---|---|---|---|
| `dCount` | 1.000 | +0.892 ⚠ | +0.468 | +0.527 | +0.362 | +0.377 |
| `dContribution` | +0.892 ⚠ | 1.000 | +0.637 | +0.529 | +0.448 | +0.408 |
| `dBestContrib` | +0.468 | +0.637 | 1.000 | +0.855 ⚠ | +0.891 ⚠ | +0.763 ⚠ |
| `dBestWalletBase` | +0.527 | +0.529 | +0.855 ⚠ | 1.000 | +0.813 ⚠ | +0.895 ⚠ |
| `dConvictionAvg` | +0.362 | +0.448 | +0.891 ⚠ | +0.813 ⚠ | 1.000 | +0.759 ⚠ |
| `dRoiNormAvg` | +0.377 | +0.408 | +0.763 ⚠ | +0.895 ⚠ | +0.759 ⚠ | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **0.214**. At AGS ≥ +5 fires N=26, WR=61.5%, ROI=+14.1%. At AGS ≥ +3 fires N=56, WR=64.3%, ROI=+21.9%.
...
|---|---|---|---|---|---|
| `dCount` | +0.227 | +0.013 | WR=69%, ROI=+28.9% | -14.8pp | N=13, WR=69%, ROI=+25.4% |
| `dContribution` | +0.218 | +0.004 | WR=65%, ROI=+21.6% | -7.5pp | N=14, WR=79%, ROI=+44.1% |
| `dBestContrib` | +0.199 | −0.015 | WR=65%, ROI=+21.7% | -7.6pp | N=15, WR=60%, ROI=+10.5% |
| `dBestWalletBase` | +0.214 | −0.000 | WR=62%, ROI=+14.1% | +0.0pp | N=15, WR=67%, ROI=+23.5% |
| `dConvictionAvg` | +0.208 | −0.006 | WR=65%, ROI=+21.7% | -7.6pp | N=18, WR=61%, ROI=+14.2% |
| `dRoiNormAvg` | +0.211 | −0.003 | WR=62%, ROI=+17.0% | -2.9pp | N=17, WR=71%, ROI=+32.1% |
...
|---|---|---|---|---|
| 1 | `dBestContrib` | −0.015 | -7.6pp | mild marginal info |
| 2 | `dConvictionAvg` | −0.006 | -7.6pp | mild marginal info |
| 3 | `dRoiNormAvg` | −0.003 | -2.9pp | mild marginal info |
| 4 | `dBestWalletBase` | −0.000 | +0.0pp | mild marginal info |
| 5 | `dContribution` | +0.004 | -7.5pp | redundant — other features cover it |
| 6 | `dCount` | +0.013 | -14.8pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dBestContrib` | CONCENTRATION | +0.430 | 0.430 | positive ↑ |
| 2 | `dContribution` | TOTAL | +0.229 | 0.229 | positive ↑ |
| 3 | `dCount` | TOTAL | -0.161 | 0.161 | negative ↓ |
| 4 | `dRoiNormAvg` | BLENDED | -0.073 | 0.073 | negative ↓ |
| 5 | `dBestWalletBase` | CONCENTRATION | +0.054 | 0.054 | positive ↑ |
| 6 | `dConvictionAvg` | BLENDED | -0.032 | 0.032 | flat ≈ 0 |

Intercept b = -0.227 · Final log-loss = 0.6528 · N = 150.
...
| 4 | `dRoiNormAvg` | BLENDED | #3 | #5 | #3 | #4 | 3.75 |
| 5 | `dCount` | TOTAL | #6 | #2 | #6 | #3 | 4.25 |
| 6 | `dConvictionAvg` | BLENDED | #4 | #6 | #2 | #6 | 4.50 |

#### Plain-English summary

- **Workhorse**: `dBestContrib` (CONCENTRATION) — ranks #1/#4/#1/#1 across the four lenses. Whatever else changes, this one stays.
- **Weakest contributor**: `dConvictionAvg` (BLENDED) — composite avg rank 4.50. Strong candidate to down-weight or drop in v9.
- **Redundant pairs (|r| ≥ 0.7)**: `dCount` ↔ `dContribution` (r=+0.89); `dBestContrib` ↔ `dBestWalletBase` (r=+0.86); `dBestContrib` ↔ `dConvictionAvg` (r=+0.89); `dBestContrib` ↔ `dRoiNormAvg` (r=+0.76); `dBestWalletBase` ↔ `dConvictionAvg` (r=+0.81); `dBestWalletBase` ↔ `dRoiNormAvg` (r=+0.90); `dConvictionAvg` ↔ `dRoiNormAvg` (r=+0.76). Each pair effectively double-counts the same signal in the composite.
- **v9 simplification candidate**: only `dBestContrib` carries marginal info (Spearman ρ drop > 0.01 when removed). The other 5 features add roughly nothing on top — a 2- or 3-feature composite would likely match the 6-feature AGS's discriminative power. **Don't remove them yet** — at N=150 we lack the power to distinguish "redundant in this sample" from "redundant in the population." Revisit once the sample doubles.
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 150 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/150 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| 4.0★ | 27 | 13-13-1 | 50.0% [32–68] | +3.0% | -1.3u | 0.15 ✗ noise |
...
| Δw = +1 | 2/100%/+61% | 5/40%/-24% | 13/67%/+32% | 27/56%/+8% | 2/0%/-100% | 10/60%/+9% |
...
| −150/−101 | 103 | 52-50-1 | 51.0% [41–60] | -2.8% | +6.6u | -0.30 ✗ noise |
...
| −150/−101 | -38% (20) | +20% (38) | -39% (25) | +35% (17) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 94 | 43-51-0 | 45.7% [36–56] | -6.7% | -26.5u | -0.57 ✗ noise |
| SPREAD | 31 | 13-17-1 | 43.3% [27–61] | -15.5% | +1.6u | -0.90 ✗ noise |
| TOTAL | 51 | 28-22-1 | 56.0% [42–69] | +8.3% | +6.7u | 0.62 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=16 · 19% · -64% | N=33 · 55% · +4% | N=19 · 37% · -18% | N=23 · 57% · +27% |
| SPREAD | N=10 · 22% · -51% | N=8 · 38% · -27% | N=7 · 57% · +10% | N=5 · 60% · +17% |
| TOTAL | N=10 · 50% · -3% | N=19 · 72% · +37% | N=13 · 31% · -40% | N=7 · 71% · +39% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 63 | 27-36-0 | 42.9% [31–55] | -16.6% | -17.6u | -1.35 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=8 · 25% · -45% | N=27 · 56% · +6% | N=17 · 24% · -52% | N=10 · 50% · -2% |
...
|---|---|---|
| **sharps3Plus** | 106 · 43% · -11.1% · -1.03 ✗ noise | 69 · 55% · +5.2% · 0.44 ✗ noise |
| **plusEV** | 24 · 38% · -17.9% · -0.64 ✗ noise | 151 · 50% · -2.6% · -0.32 ✗ noise |
| **pinnacleConfirms** | 49 · 47% · -3.3% · -0.19 ✗ noise | 57 · 44% · -13.1% · -0.94 ✗ noise |
| **invested10kPlus** | 93 · 44% · -9.8% · -0.83 ✗ noise | 13 · 54% · +0.5% · 0.02 ✗ noise |
| **lineMovingWith** | 100 · 51% · +0.4% · 0.04 ✗ noise | 75 · 45% · -11.6% · -0.97 ✗ noise |
| **predMarketAligns** | 39 · 49% · -4.5% · -0.24 ✗ noise | 67 · 43% · -10.9% · -0.83 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 27 | 17-10-0 | 63.0% [44–78] | +22.4% | +5.1u | 1.19 ✗ noise |
| 1 | 36 | 16-19-1 | 45.7% [30–62] | -12.4% | -5.5u | -0.78 ✗ noise |
| 2 | 50 | 24-25-1 | 49.0% [36–63] | +1.3% | +6.6u | 0.09 ✗ noise |
| 3 | 21 | 9-12-0 | 42.9% [24–63] | -19.9% | -10.2u | -0.92 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLEAR_MOVE | 42 | 27-14-1 | 65.9% [51–78] | +20.5% | +21.8u | 1.47 ✗ noise |
| NEAR_START | 84 | 36-47-1 | 43.4% [33–54] | -8.1% | -22.7u | -0.64 ✗ noise |
| NO_MOVE | 6 | 2-4-0 | 33.3% [10–70] | -36.2% | -1.1u | -0.90 ✗ noise |
| PREGAME | 16 | 9-7-0 | 56.3% [33–77] | +5.1% | +1.5u | 0.21 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 101 | 48-52-1 | 48.0% [38–58] | -10.1% | -16.1u | -1.08 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.119 ✗ | -0.059 ✗ | -0.093 | -0.78 |
| totalInvested | -0.133 ~ p<.10 | -0.119 ✗ | -0.055 | -1.57 |
| evEdge | 0.056 ✗ | 0.062 ✗ | 0.068 | 0.82 |
| moneyPct | 0.008 ✗ | -0.072 ✗ | -0.041 | -0.95 |
| walletPct | 0.083 ✗ | 0.035 ✗ | 0.034 | 0.46 |
| criteriaMet | -0.080 ✗ | -0.049 ✗ | -0.116 | -0.64 |
| maxContribFor | 0.040 ✗ | 0.052 ✗ | 0.085 | 0.68 |
| meanBaseFor | 0.006 ✗ | 0.018 ✗ | 0.052 | 0.24 |
...
Sample with CLV: **168** picks. Mean CLV = **-0.0032**.
t-statistic vs zero: -2.60 → ✓ p<.01 · 95% CI [-0.0056, -0.0008]
...
| CLV (−2%, 0] | 93 | 43-48-2 | 47.3% [37–57] | -6.4% | -18.0u | -0.61 ✗ noise |
| CLV (0, +2%] | 50 | 25-25-0 | 50.0% [37–63] | +7.9% | +1.2u | 0.46 ✗ noise |
| CLV > +2% | 11 | 4-7-0 | 36.4% [15–65] | -37.7% | -8.8u | -1.39 ✗ noise |

ρ(CLV, flat ROI) = -0.038 ✗
...
Trained on N=65 (with all features non-null). Intercept β₀ = 0.129.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | pw.ΔAvgRoi | +0.621 | ↑ helps |
| 2 | sharpCount | -0.535 | ↓ hurts |
| 3 | pw.Δcount | +0.510 | ↑ helps |
| 4 | pw.ΔFlatPnl | +0.509 | ↑ helps |
| 5 | evEdge | +0.467 | ↑ helps |
| 6 | Δw | -0.430 | ↓ hurts |
| 7 | pw.ΔWlNet | +0.427 | ↑ helps |
| 8 | moneyPct | -0.348 | ↓ hurts |
| 9 | pw.ΔTopQShare | +0.310 | ↑ helps |
| 10 | odds (American) | -0.308 | ↓ hurts |
| 11 | Δw + HC | -0.301 | ↓ hurts |
| 12 | peak.stars | -0.247 | ↓ hurts |
| 13 | log(impliedProb) | +0.151 | ↑ helps |
| 14 | HC margin | +0.118 | ↑ helps |
| 15 | log10(invested) | -0.098 | ↓ hurts |
| 16 | vault.star | +0.083 | ↑ helps |
| 17 | criteriaMet | -0.033 | ≈ flat |
| 18 | walletPct | -0.033 | ≈ flat |
...
| Tier-1b HC = +1 (post-cutover) | 38 | 23-15 | 60.5% | 58.3% | -106 | 7.08% bankroll | 1.63u | **UNDER-SIZED** — ship up to 7.08u (1u=1% bankroll) |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 12 | 3-9 | 25.0% | 36.4% | -105 | — (mute) | 2.15u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.150  (annualized × √252 ≈ -2.38)
