...
_Auto-generated **6/3/2026, 1:54:04 PM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 432 shipped+graded picks · 2026-04-18 → 2026-06-02  (HC analyses scoped to post-cutover 2026-04-30, 320 picks)
**Headline:** 213-216-3 · WR 49.7% [44.9%–54.4%] vs 52.4% break-even · -20.2u flat (-4.7%) · -69.1u peak.
**Overall t-test:** t = -0.97 → ✗ noise.
...
- **ρ(Δw, flat ROI) = 0.045 ✗**  (full sample, N=426)
- **ρ(HC, flat ROI) = 0.007 ✗**  (post-cutover, N=320)
- **ρ(Δw+HC, flat ROI) = -0.036 ✗**  (post-cutover, N=320)
...
- **Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era)** — N=62, 25-37, WR 40.3% [29%–53%], flat ROI -24.0% (t=-2.00 ✓ p<.05)
- **Stale Δw ≤ 0 (full sample)** — N=89, 37-50, WR 42.5% [33%–53%], flat ROI -21.9% (t=-2.27 ✓ p<.05)

### Action map

- **Tier-1a (HC ≥ +2)** — N=33, WR 42.4%, flat ROI -20.0%. Bayesian posterior WR ≈ 44.2%, half-Kelly = **0.0%** bankroll at −110 → **size aggressively**.
- **Tier-1b (HC = +1)** — N=126, WR 55.6%, flat ROI +7.7%. Bayesian posterior WR ≈ 55.1%, half-Kelly = **2.9%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=62, WR 40.3%, flat ROI -24.0%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=83, WR 47.0%, flat ROI -3.4%. Bayesian posterior WR ≈ 47.3%, half-Kelly = **0.0%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -21.9% flat ROI on 89 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (1.00u/pick), we need **~1533 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 432. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **432** |
| W-L-P | 213-216-3 |
| Win rate | **49.7%** [44.9%–54.4%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +2.7 pp |
| Peak-units PnL | **-69.1u** |
| Flat-1u PnL | **-20.2u** (-4.7% flat ROI) |
| Flat t-statistic vs zero | -0.97 → ✗ noise |
| Flat 95% CI per-pick | [-0.141, 0.047]u |
...
We have **432** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = −1 | 14 | 2-12-0 | 14.3% [4–40] | -74.7% | -8.8u | -4.28 ✓ p<.01 |
| Δw = 0 | 73 | 35-36-2 | 49.3% [38–61] | -9.6% | -5.9u | -0.90 ✗ noise |
| Δw = +1 | 145 | 82-62-1 | 56.9% [49–65] | +6.5% | +7.4u | 0.82 ✗ noise |
| Δw = +2 | 109 | 51-58-0 | 46.8% [38–56] | -7.4% | -29.8u | -0.76 ✗ noise |
| Δw ≥ +3 | 83 | 39-44-0 | 47.0% [37–58] | -3.4% | -32.6u | -0.27 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.027** ✗  ·  **ρ(Δw, flat ROI) = 0.045** ✗  (N=426)
...
|---|---|---|---|---|---|---|
| HC ≤ −2 | 0 | — | — | — | — | — |
| HC = −1 | 10 | 3-7-0 | 30.0% [11–60] | -35.5% | -4.1u | -1.06 ✗ noise |
| HC = 0 | 151 | 75-74-2 | 50.3% [42–58] | -7.3% | -24.2u | -0.96 ✗ noise |
| HC = +1 | 126 | 70-56-0 | 55.6% [47–64] | +7.7% | -5.4u | 0.87 ✗ noise |
| HC = +2 | 24 | 11-13-0 | 45.8% [28–65] | -8.1% | -16.1u | -0.38 ✗ noise |
| HC ≥ +3 | 9 | 3-6-0 | 33.3% [12–65] | -51.8% | -8.6u | -2.15 ✓ p<.05 |

**Pearson ρ(HC, WIN) = 0.013** ✗  ·  **ρ(HC, flat ROI) = 0.007** ✗  (N=320)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 42 | 18-23-1 | 43.9% [30–59] | -21.6% | -9.2u | -1.57 ✗ noise |
| Σ = +1 | 81 | 47-33-1 | 58.8% [48–69] | +11.2% | +14.1u | 1.06 ✗ noise |
| Σ = +2 | 88 | 51-37-0 | 58.0% [48–68] | +8.1% | +2.6u | 0.81 ✗ noise |
| Σ = +3 | 47 | 17-30-0 | 36.2% [24–50] | -27.8% | -24.6u | -1.92 ~ p<.10 |
| Σ = +4 | 31 | 17-14-0 | 54.8% [38–71] | +10.0% | -12.9u | 0.54 ✗ noise |
| Σ = +5 | 14 | 5-9-0 | 35.7% [16–61] | -31.0% | -12.8u | -1.20 ✗ noise |
| Σ ≥ +6 | 17 | 7-10-0 | 41.2% [22–64] | -25.1% | -15.6u | -1.09 ✗ noise |

**Pearson ρ(Δw+HC, WIN) = -0.039** ✗  ·  **ρ(Σ, flat ROI) = -0.036** ✗  (N=320)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 320.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.059 ✗ | -0.052 ✗ | -0.042 | weak |
| HC margin | 0.013 ✗ | 0.007 ✗ | 0.047 | weak |
| Δw + HC | -0.039 ✗ | -0.036 ✗ | -0.018 | weak |
| peak.stars | -0.087 ✗ | -0.117 ✓ p<.05 | -0.132 | weak |
| vault.star | -0.025 ✗ | -0.040 ✗ | -0.093 | weak |
| lock.stars | -0.060 ✗ | -0.085 ✗ | -0.089 | weak |
...
Universe N = 320 (post-cutover, both axes present).

| HC \ Δw | ≤ −3 | -2 | -1 | +0 | +1 | +2 | ≥ +3 |
|---|---|---|---|---|---|---|---|
| ≤ −3 | — | — | — | — | — | — | — |
| -2 | — | — | — | — | — | — | — |
| -1 | — | — | N=1 · 0-1 · 0% [0–79] · —  | N=1 · 0-1 · 0% [0–79] · —  | N=3 · 0-3 · 0% [0–56] · -100%  | N=2 · 2-0 · 100% [34–100] · — ★ | N=3 · 1-2 · 33% [6–79] · -33%  |
| +0 | — | N=1 · 0-1 · 0% [0–79] · —  | N=4 · 1-3 · 25% [5–70] · -63%  | N=29 · 17-11 · 61% [42–76] · +8%  | N=60 · 35-24 · 59% [47–71] · +11%  | N=39 · 19-20 · 49% [34–64] · -10%  | N=18 · 3-15 · 17% [6–39] · -70% ✗ |
| +1 | — | — | N=3 · 0-3 · 0% [0–56] · -100%  | N=19 · 10-9 · 53% [32–73] · +1%  | N=46 · 31-15 · 67% [53–79] · +26%  | N=31 · 14-17 · 45% [29–62] · -7%  | N=27 · 15-12 · 56% [37–72] · +11%  |
...
| Δw = −1 | 8 | 1-7-0 | 12.5% [2–47] | -81.5% | -4.4u | -4.41 ✓ p<.01 |
| Δw = 0 | 50 | 28-21-1 | 57.1% [43–70] | +4.0% | +7.5u | 0.31 ✗ noise |
| Δw = +1 | 112 | 67-44-1 | 60.4% [51–69] | +12.6% | +12.0u | 1.43 ✗ noise |
| Δw = +2 | 84 | 40-44-0 | 47.6% [37–58] | -6.3% | -26.0u | -0.57 ✗ noise |
| Δw ≥ +3 | 65 | 26-39-0 | 40.0% [29–52] | -22.7% | -44.7u | -1.88 ~ p<.10 |

### §3d. Practical lock zones (v7.4 floor anatomy)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 159 | 84-75-0 | 52.8% [45–60] | +1.9% | -30.1u | 0.25 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 62 | 25-37-0 | 40.3% [29–53] | -24.0% | -28.5u | -2.00 ✓ p<.05 |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 99 | 53-44-2 | 54.6% [45–64] | +0.4% | +0.2u | 0.04 ✗ noise |
...
Universe N = 407 picks where ≥1 proven wallet appeared on either side.
...
| Δcount = −1 | 17 | 7-10-0 | 41.2% [22–64] | -18.2% | -8.1u | -0.73 ✗ noise |
| Δcount = 0 (balanced) | 41 | 14-26-1 | 35.0% [22–50] | -29.0% | -16.7u | -1.91 ~ p<.10 |
| Δcount = +1 | 157 | 77-78-2 | 49.7% [42–57] | -8.8% | -41.0u | -1.19 ✗ noise |
| Δcount = +2 | 116 | 57-59-0 | 49.1% [40–58] | -5.0% | -17.7u | -0.54 ✗ noise |
| Δcount ≥ +3 (heavy support) | 73 | 50-23-0 | 68.5% [57–78] | +38.0% | +35.1u | 2.96 ✓ p<.01 |

**ρ(Δcount, WIN) = 0.160** ✓ p<.01  ·  **ρ(Δcount, flat ROI) = 0.174** ✓ p<.01
...
Quintile cuts: ≤ -21 · ≤ -4 · ≤ 2 · ≤ 15 · > 15

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 83 | 36-47-0 | 43.4% [33–54] | -17.1% | -40.8u | -1.62 ✗ noise |
| Q2 | 82 | 32-49-1 | 39.5% [30–50] | -21.6% | -28.3u | -1.98 ✓ p<.05 |
| Q3 (balanced) | 81 | 39-41-1 | 48.8% [38–60] | -8.4% | -15.7u | -0.80 ✗ noise |
| Q4 | 83 | 46-37-0 | 55.4% [45–66] | +5.6% | -13.4u | 0.52 ✗ noise |
| Q5 (best — heavy support) | 78 | 52-25-1 | 67.5% [56–77] | +31.1% | +42.8u | 2.56 ✓ p<.05 |

**ρ(ΔWlNet, WIN) = 0.181** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.172** ✓ p<.01
...
Quintile cuts (units): ≤ -19.38 · ≤ -7.18 · ≤ 1.65 · ≤ 10.64 · > 10.64

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 90 | 37-53-0 | 41.1% [32–51] | -22.6% | -48.1u | -2.28 ✓ p<.05 |
| Q2 | 73 | 31-41-1 | 43.1% [32–55] | -17.9% | -34.1u | -1.59 ✗ noise |
| Q3 | 86 | 43-42-1 | 50.6% [40–61] | -2.4% | +6.9u | -0.22 ✗ noise |
| Q4 | 88 | 48-40-0 | 54.5% [44–65] | -0.9% | -10.7u | -0.09 ✗ noise |
| Q5 | 70 | 46-23-1 | 66.7% [55–77] | +37.6% | +30.7u | 2.79 ✓ p<.01 |

**ρ(ΔFlatPnl, WIN) = 0.180** ✓ p<.01  ·  **ρ(ΔFlatPnl, flat ROI) = 0.204** ✓ p<.01
...
Quintile cuts (% ROI): ≤ -10.6 · ≤ -5.5 · ≤ 4.9 · ≤ 15.3 · > 15.3

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 111 | 34-75-2 | 31.2% [23–40] | -37.9% | -77.0u | -4.26 ✓ p<.01 |
| Q2 | 55 | 29-26-0 | 52.7% [40–65] | -3.9% | -9.0u | -0.31 ✗ noise |
| Q3 | 79 | 42-37-0 | 53.2% [42–64] | +1.5% | -5.2u | 0.14 ✗ noise |
| Q4 | 81 | 45-35-1 | 56.3% [45–67] | +6.0% | +2.0u | 0.56 ✗ noise |
| Q5 | 81 | 55-26-0 | 67.9% [57–77] | +35.1% | +33.9u | 2.99 ✓ p<.01 |

**ρ(ΔAvgRoi, WIN) = 0.282** ✓ p<.01  ·  **ρ(ΔAvgRoi, flat ROI) = 0.301** ✓ p<.01
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 44 | 9-34-1 | 20.9% [11–35] | -55.1% | -38.0u | -4.23 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 21 | 6-15-0 | 28.6% [14–50] | -45.2% | -22.3u | -2.29 ✓ p<.05 |
| ΔBestRank = 0 (tied) | 2 | 1-1-0 | 50.0% [9–91] | -4.5% | -1.4u | -0.05 ✗ noise |
| ΔBestRank ∈ [+1,+4] | 17 | 5-12-0 | 29.4% [13–53] | -38.2% | -7.5u | -1.57 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 69 | 48-20-1 | 70.6% [59–80] | +44.6% | +31.9u | 3.34 ✓ p<.01 |

**ρ(ΔBestRank, WIN) = 0.464** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.477** ✓ p<.01  (N=153)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 23 | 5-18-0 | 21.7% [10–42] | -53.7% | -15.5u | -2.57 ✓ p<.05 |
| Δshare ∈ [−30,−10] pp | 2 | 0-2-0 | 0.0% [0–66] | -100.0% | -2.8u | 0.00 ✗ noise |
| Δshare ≈ 0 (±10 pp) | 302 | 145-155-2 | 48.3% [43–54] | -8.8% | -79.3u | -1.59 ✗ noise |
| Δshare ∈ [+10,+30] pp | 19 | 14-5-0 | 73.7% [51–88] | +45.9% | +8.2u | 2.12 ✓ p<.05 |
| Δshare ≥ +30 pp | 61 | 41-19-1 | 68.3% [56–79] | +36.5% | +34.0u | 2.62 ✓ p<.01 |

**ρ(ΔTopQShare, WIN) = 0.183** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.182** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔAvgRoi** | 0.282 ✓ p<.01 | 0.301 ✓ p<.01 | 0.259 |
| 2 | **ΔTopQCount** | 0.255 ✓ p<.01 | 0.298 ✓ p<.01 | 0.255 |
| 3 | **ΔFlatPnl** | 0.180 ✓ p<.01 | 0.204 ✓ p<.01 | 0.183 |
| 4 | **ΔTopQShare** | 0.183 ✓ p<.01 | 0.182 ✓ p<.01 | 0.218 |
| 5 | **Δcount** | 0.160 ✓ p<.01 | 0.174 ✓ p<.01 | 0.165 |
| 6 | **ΔWlNet** | 0.181 ✓ p<.01 | 0.172 ✓ p<.01 | 0.156 |

_(ΔBestRank uses N=153 subset where both sides had a proven wallet — ρ(flat ROI) = 0.477 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 770, dateRange = 2026-04-18 → 2026-06-02, computedAt = 2026-06-03T17:33:57.217Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **407** rows · PIT aggregate computable on **403** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **403** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 283 · 55% · +4.5% | 256 · 52% · -3.5% | -8.0pp |
| WEAK (−3..0) | 107 · 41% · -21.2% | 134 · 50% · -0.9% | +20.4pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=221, WR=58%, ROI=+10.9% | N=198, WR=51%, ROI=-5.1% | -16.0pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=283, WR=55%, ROI=+4.5% | N=256, WR=52%, ROI=-3.5% | -8.0pp |
| AGS < −1 (mute veto) | N=38, WR=29%, ROI=-42.6% | N=69, WR=43%, ROI=-9.2% | +33.4pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-05-20 → 2026-06-02, N=206)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 126 · 56% · +2.3% |
| WEAK (−3..0) | 80 · 47% · -11.3% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=92, WR=53%, ROI=-0.5% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=126, WR=56%, ROI=+2.3% |
| AGS < −1 (mute veto) | N=46, WR=43%, ROI=-17.3% |
...
| `dHcSizeRatio` | INTENSITY_HC | + | 1.26 | 5.19 |
| `dSumRankNorm` | QUALITY_RANK | − | 60.15 | 90.50 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.53 | 1.16 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **403/432** shipped+graded rows (93%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 71 | 37-34-0 | 52.1% [41–63] | -4.4% | -15.8u | -0.39 ✗ noise |
| LOCK | 83 | 36-47-0 | 43.4% [33–54] | -17.5% | -33.4u | -1.64 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 50 | 24-25-1 | 49.0% [36–63] | -5.9% | -2.4u | -0.43 ✗ noise |
| FADE | 74 | 30-42-2 | 41.7% [31–53] | -12.6% | -32.3u | -0.96 ✗ noise |
...
r(WIN) = **0.013** ✗ · r(ROI) = **-0.019** ✗ · Spearman ρ(ROI) = **-0.017**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 54 | 26-27-1 | 49.1% [36–62] | +2.1% | -22.9u | 0.13 ✗ noise |
| z ∈ [−1, 0) | 148 | 79-67-2 | 54.1% [46–62] | +1.7% | +11.4u | 0.22 ✗ noise |
| z ∈ [0, +1) | 132 | 59-73-0 | 44.7% [36–53] | -14.7% | -46.1u | -1.74 ~ p<.10 |
| z ≥ +1 (very positive) | 69 | 35-34-0 | 50.7% [39–62] | -5.1% | -6.6u | -0.44 ✗ noise |
...
| z ∈ [0, +1) | 369 | 184-182-3 | 50.3% [45–55] | -4.9% | -61.2u | -0.98 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.048** ✗ · r(ROI) = **-0.051** ✗ · Spearman ρ(ROI) = **-0.042**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 68 | 37-30-1 | 55.2% [43–67] | -1.6% | -9.6u | -0.15 ✗ noise |
| z ∈ [−1, 0) | 117 | 63-53-1 | 54.3% [45–63] | +7.3% | +0.4u | 0.74 ✗ noise |
| z ∈ [0, +1) | 166 | 75-90-1 | 45.5% [38–53] | -11.7% | -49.6u | -1.53 ✗ noise |
| z ≥ +1 (very positive) | 52 | 24-28-0 | 46.2% [33–59] | -14.0% | -5.5u | -1.06 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.048 ✗ | -0.051 ✗ | -0.042 |
| 2 | `dCount` | COUNT | 0.013 ✗ | -0.019 ✗ | -0.017 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | +0.090 | 0.765 | 48.3% | meaningful |
| 2 | `dSumRankNorm` | +0.007 | 0.760 | 48.0% | meaningful |
| 3 | `dWinnerCtPreA` | -0.039 | 0.039 | 2.4% | silent (<0.2) |
| 4 | `dHcSizeRatio` | -0.021 | 0.021 | 1.3% | silent (<0.2) |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.106 | +0.694 | +0.106 |
| `dHcSizeRatio` | +0.106 | 1.000 | +0.070 | +1.000 ⚠ |
| `dSumRankNorm` | +0.694 | +0.070 | 1.000 | +0.070 |
| `dWinnerCtPreA` | +0.106 | +1.000 ⚠ | +0.070 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **0.009**. At AGS ≥ +0.12 fires N=205, WR=49.8%, ROI=-6.5%. At AGS ≥ +null fires N=264, WR=50.8%, ROI=-4.9%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-205 ROI (matched cohort) | Top-205 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.043 | +0.034 | WR=54%, ROI=+4.0% | -10.5pp | N=175, WR=55%, ROI=+4.3% |
| `dHcSizeRatio` | +0.047 | +0.038 | WR=54%, ROI=+0.8% | -7.3pp | N=201, WR=54%, ROI=+0.9% |
| `dSumRankNorm` | -0.020 | +0.011 | WR=46%, ROI=-11.9% | +5.5pp | N=209, WR=47%, ROI=-10.9% |
| `dWinnerCtPreA` | +0.049 | +0.040 | WR=54%, ROI=+1.6% | -8.1pp | N=189, WR=54%, ROI=+0.0% |
...
|---|---|---|---|---|
| 1 | `dSumRankNorm` | +0.011 | +5.5pp | redundant — other features cover it |
| 2 | `dCount` | +0.034 | -10.5pp | redundant — other features cover it |
| 3 | `dHcSizeRatio` | +0.038 | -7.3pp | redundant — other features cover it |
| 4 | `dWinnerCtPreA` | +0.040 | -8.1pp | redundant — other features cover it |
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 403 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/403 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 156 | 70-86-0 | 44.9% [37–53] | -18.2% | -73.6u | -2.44 ✓ p<.05 |
| 4.5★ | 44 | 29-15-0 | 65.9% [51–78] | +24.4% | +17.0u | 1.66 ~ p<.10 |
| 4.0★ | 81 | 38-42-1 | 47.5% [37–58] | -8.0% | -6.3u | -0.73 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 54 | 26-27-1 | 49.1% [36–62] | -2.1% | -4.6u | -0.15 ✗ noise |
| 2.5★ | 59 | 31-27-1 | 53.4% [41–66] | +2.9% | -5.3u | 0.23 ✗ noise |

### §5b. Stars × Δw stratified — does the star tier hold up within each Δw cohort?

| Δw cohort | 5★ | 4.5★ | 4★ | 3.5★ | 3★ | 2.5★ |
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 16/56%/-5% | 6/50%/-16% | 13/31%/-47% | 6/33%/-26% | 22/33%/-37% | 25/46%/-11% |
| Δw = +1 | 22/50%/-11% | 15/73%/+29% | 37/53%/+2% | 28/54%/+4% | 18/61%/+16% | 24/58%/+7% |
| Δw = +2 | 55/44%/-17% | 12/58%/+13% | 26/50%/+0% | — | 9/44%/-3% | 7/43%/-4% |
| Δw ≥ +3 | 61/39%/-28% | 8/75%/+64% | 5/40%/-24% | 3/67%/+156% | 5/80%/+86% | 1/100%/+145% |
...
| −300/−201 | 16 | 11-5-0 | 68.8% [44–86] | -1.7% | +8.8u | -0.10 ✗ noise |
| −200/−151 | 41 | 22-19-0 | 53.7% [39–68] | -15.1% | -7.9u | -1.21 ✗ noise |
| −150/−101 | 251 | 123-127-1 | 49.2% [43–55] | -7.0% | -37.6u | -1.17 ✗ noise |
| −100/+100 | 5 | 2-3-0 | 40.0% [12–77] | -20.0% | -3.3u | -0.41 ✗ noise |
| +101/+150 | 93 | 41-50-2 | 45.1% [35–55] | -1.3% | -38.8u | -0.12 ✗ noise |
| +151/+200 | 10 | 5-5-0 | 50.0% [24–76] | +34.9% | +2.2u | 0.77 ✗ noise |
...
| −300/−201 | -21% (9) | +47% (1) | +44% (2) | +7% (4) |
| −200/−151 | -47% (12) | +35% (14) | +27% (5) | -82% (9) |
| −150/−101 | -15% (50) | +6% (90) | -23% (64) | -4% (44) |
| −100/+100 | -100% (1) | +33% (3) | -100% (1) | — |
| +101/+150 | -8% (15) | -9% (32) | +10% (30) | -0% (16) |
| +151/+200 | — | +30% (2) | +65% (5) | +32% (2) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 229 | 110-119-0 | 48.0% [42–54] | -6.2% | -62.4u | -0.89 ✗ noise |
| SPREAD | 77 | 35-41-1 | 46.1% [35–57] | -18.0% | -5.7u | -1.76 ~ p<.10 |
| TOTAL | 126 | 68-56-2 | 54.8% [46–63] | +6.2% | -0.9u | 0.72 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=47 · 36% · -35% | N=73 · 59% · +10% | N=54 · 46% · -4% | N=52 · 44% · -5% |
| SPREAD | N=20 · 37% · -35% | N=27 · 48% · -16% | N=16 · 63% · +12% | N=13 · 31% · -40% |
| TOTAL | N=22 · 62% · +19% | N=45 · 59% · +14% | N=39 · 41% · -20% | N=18 · 67% · +29% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 268 | 135-132-1 | 50.6% [45–57] | -4.3% | -33.3u | -0.73 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=54 · 47% · -14% | N=103 · 57% · +6% | N=76 · 46% · -9% | N=34 · 44% · -14% |
...
|---|---|---|
| **sharps3Plus** | 203 · 45% · -9.9% · -1.33 ✗ noise | 228 · 54% · -0.7% · -0.11 ✗ noise |
| **plusEV** | 52 · 44% · -13.2% · -0.83 ✗ noise | 379 · 50% · -3.9% · -0.78 ✗ noise |
| **pinnacleConfirms** | 110 · 51% · +0.5% · 0.05 ✗ noise | 179 · 49% · -7.8% · -1.07 ✗ noise |
| **invested10kPlus** | 205 · 48% · -6.7% · -0.91 ✗ noise | 84 · 54% · +0.3% · 0.03 ✗ noise |
| **lineMovingWith** | 223 · 53% · +3.0% · 0.44 ✗ noise | 208 · 45% · -13.6% · -2.02 ✓ p<.05 |
| **predMarketAligns** | 109 · 51% · +0.4% · 0.04 ✗ noise | 180 · 48% · -7.7% · -1.05 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 89 | 45-44-0 | 50.6% [40–61] | -4.5% | -14.7u | -0.45 ✗ noise |
| 1 | 102 | 51-49-2 | 51.0% [41–61] | -4.4% | -14.1u | -0.47 ✗ noise |
| 2 | 111 | 54-56-1 | 49.1% [40–58] | -5.3% | -12.5u | -0.56 ✗ noise |
| 3 | 41 | 20-21-0 | 48.8% [34–64] | -4.9% | -6.2u | -0.31 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLEAR_MOVE | 101 | 57-43-1 | 57.0% [47–66] | +7.0% | +6.7u | 0.73 ✗ noise |
| NEAR_START | 170 | 80-88-2 | 47.6% [40–55] | -5.4% | -49.4u | -0.66 ✗ noise |
| NO_MOVE | 13 | 5-8-0 | 38.5% [18–64] | -31.0% | -1.0u | -1.22 ✗ noise |
| PREGAME | 51 | 28-23-0 | 54.9% [41–68] | +2.6% | -5.7u | 0.19 ✗ noise |
| SMALL_MOVE | 95 | 41-54-0 | 43.2% [34–53] | -18.6% | -22.2u | -1.88 ~ p<.10 |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 249 | 123-125-1 | 49.6% [43–56] | -7.1% | -52.2u | -1.17 ✗ noise |
| STRONG | 67 | 36-31-0 | 53.7% [42–65] | +7.6% | -0.5u | 0.60 ✗ noise |
| LEAN | 111 | 52-57-2 | 47.7% [39–57] | -6.3% | -16.6u | -0.62 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.085 ~ p<.10 | -0.049 ✗ | -0.052 | -1.02 |
| totalInvested | -0.039 ✗ | -0.052 ✗ | -0.049 | -1.09 |
| evEdge | 0.076 ✗ | 0.052 ✗ | 0.044 | 1.07 |
| moneyPct | 0.047 ✗ | 0.019 ✗ | 0.009 | 0.39 |
| walletPct | 0.050 ✗ | 0.040 ✗ | 0.037 | 0.83 |
| criteriaMet | -0.015 ✗ | 0.010 ✗ | -0.011 | 0.21 |
| maxContribFor | -0.051 ✗ | -0.021 ✗ | -0.000 | -0.43 |
| meanBaseFor | -0.033 ✗ | 0.005 ✗ | 0.039 | 0.11 |
...
Sample with CLV: **421** picks. Mean CLV = **-0.0038**.
t-statistic vs zero: -2.79 → ✓ p<.01 · 95% CI [-0.0065, -0.0011]

Bucketed CLV vs flat PnL:

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLV ≤ −2% | 45 | 20-25-0 | 44.4% [31–59] | -24.6% | -18.0u | -1.91 ~ p<.10 |
| CLV (−2%, 0] | 238 | 116-120-2 | 49.2% [43–55] | -5.5% | -48.4u | -0.87 ✗ noise |
| CLV (0, +2%] | 117 | 60-57-0 | 51.3% [42–60] | +4.1% | -8.9u | 0.41 ✗ noise |
...
Trained on N=321 (with all features non-null). Intercept β₀ = 0.030.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | pw.ΔAvgRoi | +0.370 | ↑ helps |
| 2 | pw.Δcount | +0.326 | ↑ helps |
| 3 | sharpCount | -0.271 | ↓ hurts |
| 4 | peak.stars | -0.205 | ↓ hurts |
| 5 | evEdge | +0.195 | ↑ helps |
| 6 | log(impliedProb) | +0.184 | ↑ helps |
| 7 | pw.ΔFlatPnl | +0.161 | ↑ helps |
| 8 | HC margin | +0.145 | ↑ helps |
| 9 | Δw | -0.114 | ↓ hurts |
| 10 | pw.ΔWlNet | +0.106 | ↑ helps |
| 11 | odds (American) | -0.101 | ↓ hurts |
| 12 | moneyPct | +0.052 | ↑ helps |
| 13 | criteriaMet | +0.033 | ≈ flat |
| 14 | log10(invested) | -0.029 | ≈ flat |
| 15 | vault.star | +0.025 | ≈ flat |
| 16 | pw.ΔTopQShare | -0.023 | ≈ flat |
| 17 | walletPct | +0.022 | ≈ flat |
| 18 | Δw + HC | -0.022 | ≈ flat |
...
|---|---|---|---|---|---|---|---|---|
| Tier-1a HC ≥ +2 (post-cutover) | 33 | 14-19 | 42.4% | 44.2% | -110 | — (mute) | 3.16u | **MUTE** (negative EV at posterior) |
| Tier-1b HC = +1 (post-cutover) | 126 | 70-56 | 55.6% | 55.1% | -110 | 2.90% bankroll | 2.02u | ~ in range — 2.90u |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 62 | 25-37 | 40.3% | 41.7% | -110 | — (mute) | 1.99u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 83 | 39-44 | 47.0% | 47.3% | -107 | — (mute) | 2.63u | **MUTE** (negative EV at posterior) |
| Stale Δw = 0 | 73 | 35-36 | 49.3% | 49.4% | -110 | — (mute) | 1.60u | **MUTE** (negative EV at posterior) |
| Stale Δw ≤ −1 | 16 | 2-14 | 12.5% | 26.9% | -142 | — (mute) | 1.27u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.261  (annualized × √252 ≈ -4.15)
...
| 2026-04-19 | MLB | ML | away | 2.5 | 1.00 | +100 | 0 | — | — | 0 | 20 | 1.00 | L | -1.0u |
...
| 2026-04-22 | MLB | ML | home | 2.5 | 0.50 | -152 | 0 | — | — | 0 | -3 | -0.60 | L | -0.5u |
...
| 2026-04-23 | MLB | ML | home | 3.0 | 1.00 | -155 | 0 | — | — | 1 | 22 | 0.30 | L | -1.0u |
...
| 2026-04-24 | MLB | ML | home | 3.5 | 0.75 | -108 | 1 | — | — | 2 | -19 | -1.40 | W | +0.7u |
...
| 2026-04-26 | MLB | ML | home | 3.5 | 0.75 | -110 | 1 | — | — | 1 | 22 | -1.40 | L | -0.8u |
...
| 2026-04-27 | MLB | ML | home | 5.0 | 2.00 | +140 | 2 | — | — | -1 | -22 | -0.50 | L | -2.0u |
...
| 2026-04-28 | MLB | ML | away | 5.0 | 2.00 | +142 | 3 | — | — | 0 | -1 | 0.00 | L | -2.0u |
| 2026-04-28 | MLB | ML | away | 5.0 | 2.00 | +112 | 2 | — | — | 2 | 7 | 0.00 | W | +2.2u |
...
| 2026-04-29 | MLB | ML | home | 3.5 | 0.50 | -108 | 1 | — | — | 1 | 22 | 0.50 | L | -0.5u |
...
| 2026-05-03 | MLB | ML | away | 2.8 | 0.75 | -130 | 1 | 1 | 2 | -1 | -22 | -1.00 | W | +0.6u |
...
| 2026-05-04 | MLB | ML | home | 3.5 | 1.13 | -199 | -1 | 1 | 0 | 0 | -1 | -0.20 | L | -1.1u |
...
| 2026-05-12 | MLB | ML | away | 4.5 | 3.00 | +129 | 3 | 0 | 3 | 1 | 22 | -1.00 | L | -3.0u |
...
| 2026-05-15 | MLB | ML | away | 4.0 | 2.75 | -211 | 2 | 1 | 3 | 1 | 22 | -0.90 | W | +1.3u |
| 2026-05-15 | MLB | ML | away | 3.0 | 1.25 | +115 | 0 | 1 | 1 | -1 | -22 | -1.10 | L | -1.3u |
...
| 2026-05-16 | MLB | ML | away | 2.5 | 0.50 | -102 | 1 | 0 | 1 | 1 | -48 | 0.00 | W | +0.5u |
...
| 2026-05-18 | MLB | ML | home | 4.0 | 2.75 | -150 | 2 | 0 | 2 | 1 | 22 | -0.80 | L | -2.8u |
...
| 2026-05-21 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 0 | 0 | 2 | -9 | 0.00 | W | +0.3u |
| 2026-05-21 | MLB | ML | home | 3.0 | 1.25 | -116 | 3 | 1 | 4 | 2 | -22 | -0.40 | L | -1.3u |
| 2026-05-21 | MLB | ML | away | 3.0 | 1.25 | +129 | 1 | 0 | 1 | 3 | -41 | -0.40 | W | +1.6u |
...
| 2026-05-22 | MLB | ML | home | 5.0 | 2.75 | -158 | 1 | 0 | 1 | 1 | 22 | -0.80 | W | +1.7u |
| 2026-05-22 | MLB | SPREAD | home | 3.0 | 0.75 | -142 | 1 | 0 | 1 | 1 | -21 | -2.00 | L | -0.8u |
| 2026-05-22 | MLB | ML | home | 5.0 | 5.00 | -145 | 2 | 2 | 4 | 1 | 22 | -2.20 | L | -5.0u |
| 2026-05-22 | MLB | ML | home | 2.5 | 0.50 | +139 | 2 | 1 | 3 | 0 | -23 | -0.90 | W | +0.7u |
...
| 2026-05-23 | MLB | ML | away | 2.5 | 2.75 | +109 | 2 | 0 | 2 | 2 | -20 | -0.50 | L | -2.8u |
| 2026-05-23 | MLB | TOTAL | over | 2.5 | 0.30 | -110 | 0 | 1 | 1 | 0 | 2 | 0.00 | W | +0.3u |
| 2026-05-23 | MLB | ML | home | 5.0 | 1.00 | -148 | 0 | 0 | 0 | 1 | -15 | -0.20 | L | -1.0u |
...
| 2026-05-23 | MLB | ML | away | 3.0 | 1.25 | +166 | 2 | 1 | 3 | 2 | -19 | -0.30 | W | +1.8u |
...
| 2026-05-24 | MLB | ML | home | 3.0 | 1.25 | -189 | 1 | 0 | 1 | 1 | 22 | 0.00 | W | +0.7u |
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 0.75 | -110 | 1 | 0 | 1 | 2 | 14 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 1 | 1 | 2 | 0 | -16 | 0.00 | L | -1.6u |
...
| 2026-05-24 | MLB | ML | home | 2.5 | 0.50 | +144 | 1 | 1 | 2 | -1 | -44 | 0.00 | L | -0.5u |
...
| 2026-05-24 | MLB | ML | away | 4.0 | 1.25 | +148 | 2 | 2 | 4 | 0 | -10 | -1.40 | W | +1.9u |
| 2026-05-24 | MLB | ML | away | 3.0 | 1.25 | -122 | -1 | 1 | 0 | 0 | -31 | -1.10 | L | -1.3u |
| 2026-05-24 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 2 | -20 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | SPREAD | home | 3.0 | 0.75 | +134 | 1 | 0 | 1 | 2 | -20 | 0.00 | L | -0.8u |
...
| 2026-05-25 | MLB | ML | home | 5.0 | 5.00 | -310 | 2 | 0 | 2 | 1 | 22 | -1.20 | W | +1.6u |
| 2026-05-25 | MLB | TOTAL | over | 4.0 | 1.65 | +103 | 1 | 0 | 1 | 2 | 1 | 0.00 | L | -1.6u |
| 2026-05-25 | MLB | ML | home | 4.0 | 1.25 | -125 | 1 | -1 | 0 | 1 | -19 | -1.90 | L | -1.3u |
...
| 2026-05-26 | MLB | ML | away | 5.0 | 5.00 | -102 | 3 | 1 | 4 | 3 | -12 | -0.50 | W | +4.9u |
...
| 2026-05-27 | MLB | ML | home | 4.5 | 0.50 | -102 | 3 | 1 | 4 | 3 | 30 | -1.10 | W | +0.4u |
...
| 2026-05-27 | MLB | ML | home | 4.5 | 3.75 | -420 | 1 | 1 | 2 | 1 | 22 | -0.50 | W | +0.7u |
...
| 2026-05-27 | MLB | ML | away | 4.0 | 1.00 | -108 | 1 | -1 | 0 | -1 | 46 | -0.90 | L | -1.0u |
...
| 2026-05-27 | MLB | ML | home | 4.0 | 1.25 | -190 | 1 | 0 | 1 | 1 | 22 | -0.70 | W | +0.7u |
...
| 2026-05-28 | MLB | TOTAL | over | 5.0 | 3.00 | +101 | 3 | -1 | 2 | 3 | 28 | 0.00 | W | +2.5u |
...
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 0.75 | -135 | 2 | 0 | 2 | 1 | -16 | 1.00 | L | -0.8u |
| 2026-05-29 | MLB | ML | home | 5.0 | 3.75 | -124 | 2 | 1 | 3 | 3 | -4 | -1.00 | W | +3.0u |
...
| 2026-05-29 | MLB | ML | away | 5.0 | 2.50 | +140 | 2 | 1 | 3 | 0 | -16 | 1.00 | L | -2.5u |
...
| 2026-05-30 | MLB | ML | away | 4.5 | 2.75 | -125 | 1 | 2 | 3 | 2 | 2 | -0.60 | W | +2.3u |
| 2026-05-30 | MLB | ML | home | 5.0 | 5.00 | -130 | 1 | 0 | 1 | 2 | -14 | -1.20 | L | -5.0u |
| 2026-05-30 | MLB | ML | away | 4.0 | 3.75 | -132 | 1 | 1 | 2 | 1 | 44 | -1.00 | W | +2.9u |
| 2026-05-30 | MLB | SPREAD | home | 3.0 | 0.75 | -143 | 0 | 1 | 1 | 0 | 4 | -1.40 | L | -0.8u |
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -118 | 1 | 1 | 2 | 1 | -18 | -1.30 | L | -3.8u |
...
| 2026-05-30 | MLB | TOTAL | over | 4.0 | 2.25 | -116 | 2 | 0 | 2 | 2 | -4 | 0.00 | W | +1.9u |
...
| 2026-05-30 | MLB | ML | home | 5.0 | 1.25 | -102 | 2 | 0 | 2 | 2 | 1 | -0.70 | W | +1.2u |
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -122 | 1 | 1 | 2 | 2 | -20 | -0.20 | L | -3.8u |
...
| 2026-05-31 | MLB | ML | away | 3.0 | 2.75 | -125 | -2 | 0 | -2 | 1 | -19 | -1.20 | L | -2.8u |
| 2026-05-31 | MLB | TOTAL | under | 5.0 | 1.65 | -114 | 2 | 0 | 2 | 3 | -20 | 0.00 | L | -1.6u |
| 2026-05-31 | MLB | ML | home | 2.5 | 2.75 | -115 | 1 | 1 | 2 | 1 | 22 | 0.00 | W | +2.4u |
| 2026-05-31 | MLB | ML | away | 5.0 | 1.00 | +115 | -1 | 0 | -1 | 2 | -20 | -0.60 | L | -1.0u |
| 2026-05-31 | MLB | SPREAD | away | 5.0 | 1.00 | -117 | 3 | 1 | 4 | 3 | -20 | -0.20 | L | -1.0u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -164 | 0 | 1 | 1 | 2 | -20 | -1.20 | W | +2.3u |
| 2026-05-31 | MLB | ML | away | 3.0 | 1.25 | -184 | 0 | 0 | 0 | 0 | -10 | -1.70 | W | +0.7u |
| 2026-05-31 | MLB | ML | home | 2.5 | 1.25 | -232 | 0 | 0 | 0 | 1 | 19 | -0.50 | W | +0.5u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -102 | 0 | 1 | 1 | 2 | -43 | 0.20 | W | +4.9u |
| 2026-05-31 | MLB | TOTAL | over | 4.0 | 1.00 | +101 | 2 | 1 | 3 | 2 | -5 | 0.00 | L | -1.0u |
| 2026-05-31 | MLB | ML | away | 4.5 | 2.50 | +110 | 0 | 0 | 0 | 0 | -10 | -1.10 | L | -2.5u |
| 2026-06-01 | MLB | ML | home | 4.5 | 3.00 | -155 | 3 | 2 | 5 | 3 | 18 | -1.00 | W | +2.1u |
| 2026-06-01 | MLB | ML | away | 4.0 | 1.00 | +135 | 2 | 2 | 4 | 3 | 32 | -0.20 | W | +1.4u |
| 2026-06-01 | MLB | ML | away | 5.0 | 2.50 | +160 | 2 | -1 | 1 | 2 | 31 | -1.30 | W | +2.7u |
| 2026-06-01 | MLB | TOTAL | under | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 2 | -19 | 0.00 | L | -1.0u |
| 2026-06-01 | MLB | ML | home | 3.0 | 0.50 | -142 | -1 | 0 | -1 | -1 | 25 | -0.40 | L | -0.5u |
| 2026-06-01 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 6 | 0.00 | L | -5.0u |
| 2026-06-01 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 1 | -20 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | ML | home | 2.5 | 0.25 | -215 | -1 | 0 | -1 | 0 | 17 | -1.40 | L | -0.3u |
| 2026-06-02 | MLB | TOTAL | under | 4.0 | 1.00 | -117 | 1 | 0 | 1 | 0 | 11 | 0.00 | L | -1.0u |
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +130 | 2 | 0 | 2 | 0 | 47 | -0.60 | W | +3.1u |
| 2026-06-02 | MLB | ML | away | 3.0 | 0.50 | +100 | 1 | 0 | 1 | 2 | 17 | -1.20 | W | +0.5u |
| 2026-06-02 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 5 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 5 | 0.00 | L | -3.0u |
| 2026-06-02 | MLB | ML | home | 4.0 | 1.00 | -112 | 1 | 0 | 1 | 1 | 22 | -1.10 | L | -1.0u |
| 2026-06-02 | MLB | ML | home | 4.0 | 1.00 | -106 | 1 | 0 | 1 | 1 | 22 | -0.50 | L | -1.0u |
