...
_Auto-generated **5/28/2026, 12:46:21 PM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 355 shipped+graded picks · 2026-04-18 → 2026-05-27  (HC analyses scoped to post-cutover 2026-04-30, 243 picks)
**Headline:** 176-176-3 · WR 50.0% [44.8%–55.2%] vs 52.4% break-even · -14.0u flat (-4.0%) · -61.9u peak.
...
- **ρ(Δw, flat ROI) = 0.058 ✗**  (full sample, N=349)
- **ρ(HC, flat ROI) = 0.001 ✗**  (post-cutover, N=243)
- **ρ(Δw+HC, flat ROI) = -0.047 ✗**  (post-cutover, N=243)
...
- **Tier-1a HC ≥ +2 (post-cutover)** — N=27, 10-17, WR 37.0% [22%–56%], flat ROI -30.8% (t=-1.70 ~ p<.10)
- **Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era)** — N=48, 19-29, WR 39.6% [27%–54%], flat ROI -28.2% (t=-2.15 ✓ p<.05)
- **Stale Δw ≤ 0 (full sample)** — N=67, 27-38, WR 41.5% [30%–54%], flat ROI -22.1% (t=-1.96 ✓ p<.05)

### Action map

- **Tier-1a (HC ≥ +2)** — N=27, WR 37.0%, flat ROI -30.8%. Bayesian posterior WR ≈ 40.5%, half-Kelly = **0.0%** bankroll at −110 → **size aggressively**.
- **Tier-1b (HC = +1)** — N=103, WR 57.3%, flat ROI +12.0%. Bayesian posterior WR ≈ 56.6%, half-Kelly = **4.5%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=48, WR 39.6%, flat ROI -28.2%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=74, WR 50.0%, flat ROI +3.4%. Bayesian posterior WR ≈ 50.0%, half-Kelly = **0.0%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -22.1% flat ROI on 67 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (1.00u/pick), we need **~1552 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 355. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **355** |
| W-L-P | 176-176-3 |
| Win rate | **50.0%** [44.8%–55.2%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +2.4 pp |
| Peak-units PnL | **-61.9u** |
| Flat-1u PnL | **-14.0u** (-4.0% flat ROI) |
| Flat t-statistic vs zero | -0.74 → ✗ noise |
| Flat 95% CI per-pick | [-0.144, 0.065]u |
...
We have **355** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = +1 | 119 | 67-51-1 | 56.8% [48–65] | +5.1% | +8.6u | 0.60 ✗ noise |
| Δw = +2 | 89 | 41-48-0 | 46.1% [36–56] | -9.7% | -33.3u | -0.91 ✗ noise |
| Δw ≥ +3 | 74 | 37-37-0 | 50.0% [39–61] | +3.4% | -23.7u | 0.25 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.044** ✗  ·  **ρ(Δw, flat ROI) = 0.058** ✗  (N=349)
...
|---|---|---|---|---|---|---|
| HC ≤ −2 | 0 | — | — | — | — | — |
| HC = −1 | 7 | 1-6-0 | 14.3% [3–51] | -73.7% | -6.9u | -2.80 ✓ p<.01 |
| HC = 0 | 106 | 55-49-2 | 52.9% [43–62] | -3.9% | -14.7u | -0.44 ✗ noise |
| HC = +1 | 103 | 59-44-0 | 57.3% [48–66] | +12.0% | +3.0u | 1.22 ✗ noise |
| HC = +2 | 19 | 7-12-0 | 36.8% [19–59] | -24.4% | -25.2u | -1.04 ✗ noise |
| HC ≥ +3 | 8 | 3-5-0 | 37.5% [14–69] | -45.8% | -7.6u | -1.73 ~ p<.10 |

**Pearson ρ(HC, WIN) = 0.001** ✗  ·  **ρ(HC, flat ROI) = 0.001** ✗  (N=243)

Spearman rank ρ(HC, flat ROI) = 0.060.
...
| Σ = +1 | 56 | 32-23-1 | 58.2% [45–70] | +8.0% | +11.7u | 0.64 ✗ noise |
| Σ = +2 | 71 | 42-29-0 | 59.2% [48–70] | +9.3% | -0.3u | 0.83 ✗ noise |
| Σ = +3 | 37 | 13-24-0 | 35.1% [22–51] | -28.6% | -20.8u | -1.71 ~ p<.10 |
| Σ = +4 | 26 | 15-11-0 | 57.7% [39–74] | +14.8% | -12.1u | 0.73 ✗ noise |
| Σ = +5 | 12 | 4-8-0 | 33.3% [14–61] | -33.2% | -12.4u | -1.16 ✗ noise |
| Σ ≥ +6 | 15 | 7-8-0 | 46.7% [25–70] | -15.1% | -12.1u | -0.60 ✗ noise |

**Pearson ρ(Δw+HC, WIN) = -0.047** ✗  ·  **ρ(Σ, flat ROI) = -0.047** ✗  (N=243)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 243.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.064 ✗ | -0.063 ✗ | -0.061 | weak |
| HC margin | 0.001 ✗ | 0.001 ✗ | 0.060 | weak |
| Δw + HC | -0.047 ✗ | -0.047 ✗ | -0.020 | weak |
| peak.stars | -0.095 ✗ | -0.139 ✓ p<.05 | -0.156 | weak |
| vault.star | -0.027 ✗ | -0.043 ✗ | -0.091 | weak |
| lock.stars | -0.034 ✗ | -0.078 ✗ | -0.105 | weak |
...
Universe N = 243 (post-cutover, both axes present).

| HC \ Δw | ≤ −3 | -2 | -1 | +0 | +1 | +2 | ≥ +3 |
|---|---|---|---|---|---|---|---|
| ≤ −3 | — | — | — | — | — | — | — |
| -2 | — | — | — | — | — | — | — |
| -1 | — | — | N=1 · 0-1 · 0% [0–79] · —  | — | N=3 · 0-3 · 0% [0–56] · -100%  | N=1 · 1-0 · 100% [21–100] · —  | N=2 · 0-2 · 0% [0–66] · —  |
| +0 | — | — | N=1 · 1-0 · 100% [21–100] · —  | N=18 · 11-6 · 65% [41–83] · +18%  | N=42 · 25-16 · 61% [46–74] · +11%  | N=29 · 15-14 · 52% [34–69] · -6%  | N=16 · 3-13 · 19% [7–43] · -67% ✗ |
| +1 | — | — | N=3 · 0-3 · 0% [0–56] · -100%  | N=13 · 6-7 · 46% [23–71] · -7%  | N=40 · 27-13 · 68% [52–80] · +26%  | N=24 · 11-13 · 46% [28–65] · -4%  | N=23 · 15-8 · 65% [45–81] · +30%  |
| +2 | — | — | — | — | N=1 · 0-1 · 0% [0–79] · —  | N=7 · 2-5 · 29% [8–64] · -37%  | N=11 · 5-6 · 45% [21–72] · -9%  |
...
| Δw = +1 | 86 | 52-33-1 | 61.2% [51–71] | +12.6% | +13.2u | 1.27 ✗ noise |
| Δw = +2 | 64 | 30-34-0 | 46.9% [35–59] | -9.2% | -29.5u | -0.73 ✗ noise |
| Δw ≥ +3 | 56 | 24-32-0 | 42.9% [31–56] | -16.8% | -35.8u | -1.27 ✗ noise |

### §3d. Practical lock zones (v7.4 floor anatomy)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 130 | 69-61-0 | 53.1% [45–61] | +3.2% | -29.8u | 0.36 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 48 | 19-29-0 | 39.6% [27–54] | -28.2% | -29.4u | -2.15 ✓ p<.05 |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 65 | 37-26-2 | 58.7% [46–70] | +6.5% | +7.8u | 0.58 ✗ noise |
...
Universe N = 329 picks where ≥1 proven wallet appeared on either side.
...
| Δcount = −1 | 10 | 5-5-0 | 50.0% [24–76] | -2.4% | -5.6u | -0.07 ✗ noise |
| Δcount = 0 (balanced) | 33 | 11-21-1 | 34.4% [20–52] | -31.3% | -14.3u | -1.87 ~ p<.10 |
| Δcount = +1 | 130 | 65-63-2 | 50.8% [42–59] | -6.6% | -24.1u | -0.81 ✗ noise |
| Δcount = +2 | 90 | 43-47-0 | 47.8% [38–58] | -7.8% | -22.9u | -0.75 ✗ noise |
| Δcount ≥ +3 (heavy support) | 60 | 43-17-0 | 71.7% [59–81] | +45.2% | +27.3u | 3.16 ✓ p<.01 |

**ρ(Δcount, WIN) = 0.191** ✓ p<.01  ·  **ρ(Δcount, flat ROI) = 0.201** ✓ p<.01
...
Quintile cuts: ≤ -12 · ≤ -2 · ≤ 4 · ≤ 14 · > 14

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 79 | 31-48-0 | 39.2% [29–50] | -24.4% | -50.2u | -2.25 ✓ p<.05 |
| Q2 | 58 | 26-31-1 | 45.6% [33–58] | -11.5% | -17.2u | -0.90 ✗ noise |
| Q3 (balanced) | 73 | 38-34-1 | 52.8% [41–64] | +2.2% | -2.1u | 0.19 ✗ noise |
| Q4 | 54 | 33-21-0 | 61.1% [48–73] | +14.2% | +6.2u | 1.10 ✗ noise |
| Q5 (best — heavy support) | 65 | 40-24-1 | 62.5% [50–73] | +21.6% | +15.8u | 1.56 ✗ noise |

**ρ(ΔWlNet, WIN) = 0.197** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.187** ✓ p<.01
...
Quintile cuts (units): ≤ -10.45 · ≤ -1.48 · ≤ 2.83 · ≤ 9.10 · > 9.10

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 84 | 33-50-1 | 39.8% [30–51] | -25.8% | -55.0u | -2.58 ✓ p<.01 |
| Q2 | 49 | 19-30-0 | 38.8% [26–53] | -23.4% | -30.3u | -1.64 ✗ noise |
| Q3 | 65 | 34-30-1 | 53.1% [41–65] | +0.6% | +5.5u | 0.05 ✗ noise |
| Q4 | 71 | 43-28-0 | 60.6% [49–71] | +11.2% | +0.6u | 1.01 ✗ noise |
| Q5 | 60 | 39-20-1 | 66.1% [53–77] | +36.9% | +31.7u | 2.49 ✓ p<.05 |

**ρ(ΔFlatPnl, WIN) = 0.214** ✓ p<.01  ·  **ρ(ΔFlatPnl, flat ROI) = 0.247** ✓ p<.01
...
Quintile cuts (% ROI): ≤ -9.4 · ≤ -3.5 · ≤ 6.9 · ≤ 17.2 · > 17.2

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 66 | 18-46-2 | 28.1% [19–40] | -44.9% | -63.1u | -4.04 ✓ p<.01 |
| Q2 | 66 | 29-37-0 | 43.9% [33–56] | -18.0% | -26.0u | -1.55 ✗ noise |
| Q3 | 68 | 38-30-0 | 55.9% [44–67] | +10.7% | +4.6u | 0.86 ✗ noise |
| Q4 | 64 | 35-28-1 | 55.6% [43–67] | +1.4% | -2.4u | 0.12 ✗ noise |
| Q5 | 65 | 48-17-0 | 73.8% [62–83] | +47.1% | +39.3u | 3.69 ✓ p<.01 |

**ρ(ΔAvgRoi, WIN) = 0.327** ✓ p<.01  ·  **ρ(ΔAvgRoi, flat ROI) = 0.346** ✓ p<.01
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 35 | 6-28-1 | 17.6% [8–34] | -61.7% | -38.8u | -4.50 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 9 | 2-7-0 | 22.2% [6–55] | -54.9% | -13.1u | -1.84 ~ p<.10 |
| ΔBestRank = 0 (tied) | 1 | 1-0-0 | 100.0% [21–100] | +90.9% | +0.3u | 0.00 ✗ n<2 |
| ΔBestRank ∈ [+1,+4] | 15 | 5-10-0 | 33.3% [15–58] | -11.4% | -7.9u | -0.32 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 52 | 33-18-1 | 64.7% [51–76] | +31.0% | +19.1u | 1.95 ~ p<.10 |

**ρ(ΔBestRank, WIN) = 0.489** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.502** ✓ p<.01  (N=112)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 24 | 4-20-0 | 16.7% [7–36] | -61.9% | -24.7u | -3.15 ✓ p<.01 |
| Δshare ∈ [−30,−10] pp | 1 | 0-1-0 | 0.0% [0–79] | -100.0% | -2.3u | 0.00 ✗ n<2 |
| Δshare ≈ 0 (±10 pp) | 225 | 110-113-2 | 49.3% [43–56] | -6.8% | -66.0u | -1.06 ✗ noise |
| Δshare ∈ [+10,+30] pp | 19 | 13-6-0 | 68.4% [46–85] | +32.8% | +1.0u | 1.45 ✗ noise |
| Δshare ≥ +30 pp | 60 | 41-18-1 | 69.5% [57–80] | +37.0% | +44.4u | 2.69 ✓ p<.01 |

**ρ(ΔTopQShare, WIN) = 0.230** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.213** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔAvgRoi** | 0.327 ✓ p<.01 | 0.346 ✓ p<.01 | 0.305 |
| 2 | **ΔTopQCount** | 0.280 ✓ p<.01 | 0.312 ✓ p<.01 | 0.259 |
| 3 | **ΔFlatPnl** | 0.214 ✓ p<.01 | 0.247 ✓ p<.01 | 0.217 |
| 4 | **ΔTopQShare** | 0.230 ✓ p<.01 | 0.213 ✓ p<.01 | 0.226 |
| 5 | **Δcount** | 0.191 ✓ p<.01 | 0.201 ✓ p<.01 | 0.168 |
| 6 | **ΔWlNet** | 0.197 ✓ p<.01 | 0.187 ✓ p<.01 | 0.172 |

_(ΔBestRank uses N=112 subset where both sides had a proven wallet — ρ(flat ROI) = 0.502 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 636, dateRange = 2026-04-18 → 2026-05-27, computedAt = 2026-05-28T16:43:05.742Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **329** rows · PIT aggregate computable on **328** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **328** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 224 · 56% · +6.8% | 216 · 50% · -6.2% | -13.0pp |
| WEAK (−3..0) | 90 · 40% · -22.2% | 98 · 54% · +8.8% | +31.0pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=180, WR=58%, ROI=+9.6% | N=175, WR=49%, ROI=-8.3% | -17.9pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=224, WR=56%, ROI=+6.8% | N=216, WR=50%, ROI=-6.2% | -13.0pp |
| AGS < −1 (mute veto) | N=34, WR=29%, ROI=-41.5% | N=52, WR=46%, ROI=-1.1% | +40.3pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-05-14 → 2026-05-27, N=175)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 119 · 53% · -3.1% |
| WEAK (−3..0) | 56 · 51% · -2.5% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=97, WR=49%, ROI=-8.6% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=119, WR=53%, ROI=-3.1% |
| AGS < −1 (mute veto) | N=37, WR=49%, ROI=-5.9% |
...
|---|---|---|---|---|
| `dCount` | COUNT | + | 1.12 | 1.50 |
| `dHcSizeRatio` | INTENSITY_HC | + | 1.31 | 5.48 |
| `dSumRankNorm` | QUALITY_RANK | − | 60.55 | 90.56 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.55 | 1.15 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **328/355** shipped+graded rows (92%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 63 | 33-30-0 | 52.4% [40–64] | -4.1% | -17.4u | -0.34 ✗ noise |
| LOCK | 75 | 32-43-0 | 42.7% [32–54] | -20.0% | -36.6u | -1.81 ~ p<.10 |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 36 | 21-14-1 | 60.0% [44–74] | +15.6% | +5.8u | 0.97 ✗ noise |
| FADE | 57 | 24-31-2 | 43.6% [31–57] | -6.3% | -20.9u | -0.40 ✗ noise |
...
r(WIN) = **0.006** ✗ · r(ROI) = **-0.037** ✗ · Spearman ρ(ROI) = **-0.045**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 39 | 21-17-1 | 55.3% [40–70] | +19.4% | -9.1u | 0.97 ✗ noise |
| z ∈ [−1, 0) | 118 | 63-53-2 | 54.3% [45–63] | +0.6% | +2.6u | 0.07 ✗ noise |
| z ∈ [0, +1) | 112 | 48-64-0 | 42.9% [34–52] | -18.0% | -47.3u | -1.97 ✓ p<.05 |
...
| z ∈ [0, +1) | 294 | 147-144-3 | 50.5% [45–56] | -4.7% | -59.3u | -0.84 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.039** ✗ · r(ROI) = **-0.047** ✗ · Spearman ρ(ROI) = **-0.047**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 52 | 28-23-1 | 54.9% [41–68] | -4.2% | -13.7u | -0.34 ✗ noise |
| z ∈ [−1, 0) | 88 | 50-37-1 | 57.5% [47–67] | +15.0% | +4.2u | 1.28 ✗ noise |
| z ∈ [0, +1) | 143 | 62-80-1 | 43.7% [36–52] | -15.1% | -50.5u | -1.84 ~ p<.10 |
| z ≥ +1 (very positive) | 45 | 22-23-0 | 48.9% [35–63] | -9.9% | -2.4u | -0.70 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.039 ✗ | -0.047 ✗ | -0.047 |
| 2 | `dCount` | COUNT | 0.006 ✗ | -0.037 ✗ | -0.045 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | +0.149 | 0.758 | 48.3% | meaningful |
| 2 | `dSumRankNorm` | +0.057 | 0.738 | 47.0% | meaningful |
| 3 | `dWinnerCtPreA` | -0.050 | 0.050 | 3.2% | silent (<0.2) |
| 4 | `dHcSizeRatio` | -0.025 | 0.025 | 1.6% | silent (<0.2) |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.141 | +0.673 | +0.141 |
| `dHcSizeRatio` | +0.141 | 1.000 | +0.099 | +1.000 ⚠ |
| `dSumRankNorm` | +0.673 | +0.099 | 1.000 | +0.099 |
| `dWinnerCtPreA` | +0.141 | +1.000 ⚠ | +0.099 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **-0.023**. At AGS ≥ +0.12 fires N=182, WR=48.4%, ROI=-9.7%. At AGS ≥ +null fires N=224, WR=49.6%, ROI=-7.8%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-182 ROI (matched cohort) | Top-182 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.052 | +0.028 | WR=56%, ROI=+6.3% | -16.0pp | N=130, WR=57%, ROI=+8.5% |
| `dHcSizeRatio` | +0.015 | −0.009 | WR=52%, ROI=-2.5% | -7.3pp | N=174, WR=53%, ROI=-2.3% |
| `dSumRankNorm` | -0.048 | +0.025 | WR=45%, ROI=-14.4% | +4.6pp | N=179, WR=46%, ROI=-12.9% |
| `dWinnerCtPreA` | +0.019 | −0.005 | WR=52%, ROI=-3.5% | -6.2pp | N=163, WR=52%, ROI=-4.1% |
...
|---|---|---|---|---|
| 1 | `dHcSizeRatio` | −0.009 | -7.3pp | mild marginal info |
| 2 | `dWinnerCtPreA` | −0.005 | -6.2pp | mild marginal info |
| 3 | `dSumRankNorm` | +0.025 | +4.6pp | redundant — other features cover it |
| 4 | `dCount` | +0.028 | -16.0pp | redundant — other features cover it |
...
| 3 | `dCount` | COUNT | +0.046 | 0.046 | flat ≈ 0 |
| 4 | `dHcSizeRatio` | INTENSITY_HC | +0.025 | 0.025 | flat ≈ 0 |

Intercept b = -0.022 · Final log-loss = 0.6911 · N = 328.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 328 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/328 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 121 | 56-65-0 | 46.3% [38–55] | -17.0% | -59.4u | -2.03 ✓ p<.05 |
...
| 2.5★ | 55 | 29-25-1 | 53.7% [41–66] | +4.4% | -6.3u | 0.33 ✗ noise |
...
| Δw = +1 | 14/57%/-1% | 9/67%/+11% | 27/54%/+2% | 28/54%/+4% | 17/59%/+11% | 23/57%/+4% |
| Δw = +2 | 42/43%/-20% | 9/56%/+7% | 23/48%/-5% | — | 9/44%/-3% | 6/50%/+12% |
| Δw ≥ +3 | 53/43%/-21% | 7/71%/+64% | 5/40%/-24% | 3/67%/+156% | 5/80%/+86% | 1/100%/+145% |
...
| −150/−101 | 204 | 102-101-1 | 50.2% [43–57] | -4.7% | -28.1u | -0.71 ✗ noise |
| −100/+100 | 3 | 0-3-0 | 0.0% [0–56] | -100.0% | -4.5u | 0.00 ✗ noise |
| +101/+150 | 76 | 33-41-2 | 44.6% [34–56] | -2.1% | -35.3u | -0.17 ✗ noise |
...
| −150/−101 | -18% (38) | +12% (71) | -26% (51) | +3% (41) |
| −100/+100 | -100% (1) | -100% (1) | -100% (1) | — |
| +101/+150 | +25% (11) | -27% (28) | +9% (24) | +7% (13) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 187 | 88-99-0 | 47.1% [40–54] | -7.8% | -63.2u | -1.00 ✗ noise |
| SPREAD | 66 | 32-33-1 | 49.2% [37–61] | -12.0% | +0.4u | -1.09 ✗ noise |
| TOTAL | 102 | 56-44-2 | 56.0% [46–65] | +8.3% | +0.9u | 0.88 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=33 · 30% · -44% | N=59 · 58% · +6% | N=45 · 44% · -9% | N=47 · 47% · +1% |
| SPREAD | N=16 · 40% · -28% | N=24 · 50% · -13% | N=14 · 64% · +15% | N=11 · 36% · -29% |
| TOTAL | N=18 · 65% · +24% | N=36 · 60% · +15% | N=30 · 40% · -22% | N=16 · 69% · +32% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 198 | 99-98-1 | 50.3% [43–57] | -5.3% | -32.6u | -0.78 ✗ noise |
| NBA | 117 | 57-59-1 | 49.1% [40–58] | -2.1% | -13.1u | -0.21 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=32 · 48% · -8% | N=78 · 56% · +3% | N=58 · 45% · -13% | N=29 · 45% · -11% |
| NBA | N=29 · 32% · -41% | N=27 · 52% · +1% | N=22 · 50% · -1% | N=34 · 59% · +27% |
...
|---|---|---|
| **sharps3Plus** | 178 · 44% · -11.8% · -1.48 ✗ noise | 176 · 56% · +3.2% · 0.46 ✗ noise |
| **plusEV** | 45 · 44% · -12.9% · -0.73 ✗ noise | 309 · 51% · -3.1% · -0.56 ✗ noise |
| **pinnacleConfirms** | 88 · 48% · -5.4% · -0.45 ✗ noise | 154 · 49% · -6.4% · -0.81 ✗ noise |
| **invested10kPlus** | 173 · 47% · -8.2% · -1.02 ✗ noise | 69 · 54% · -0.6% · -0.05 ✗ noise |
| **lineMovingWith** | 185 · 52% · +1.2% · 0.16 ✗ noise | 169 · 47% · -10.5% · -1.38 ✗ noise |
| **predMarketAligns** | 87 · 49% · -3.2% · -0.27 ✗ noise | 155 · 48% · -7.6% · -0.96 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 72 | 39-33-0 | 54.2% [43–65] | +2.1% | -4.8u | 0.19 ✗ noise |
| 1 | 81 | 43-36-2 | 54.4% [43–65] | +1.6% | +0.5u | 0.16 ✗ noise |
| 2 | 93 | 44-48-1 | 47.8% [38–58] | -7.1% | -17.7u | -0.68 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLEAR_MOVE | 87 | 51-35-1 | 59.3% [49–69] | +11.1% | +17.7u | 1.09 ✗ noise |
| NEAR_START | 138 | 61-75-2 | 44.9% [37–53] | -9.9% | -59.2u | -1.08 ✗ noise |
| NO_MOVE | 11 | 4-7-0 | 36.4% [15–65] | -35.4% | -2.2u | -1.29 ✗ noise |
| PREGAME | 46 | 26-20-0 | 56.5% [42–70] | +5.4% | -0.6u | 0.39 ✗ noise |
| SMALL_MOVE | 71 | 32-39-0 | 45.1% [34–57] | -15.4% | -20.1u | -1.34 ✗ noise |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 210 | 107-102-1 | 51.2% [44–58] | -5.4% | -32.0u | -0.83 ✗ noise |
| STRONG | 58 | 30-28-0 | 51.7% [39–64] | +4.2% | -9.1u | 0.31 ✗ noise |
| LEAN | 83 | 37-44-2 | 45.7% [35–56] | -6.7% | -22.1u | -0.54 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.089 ~ p<.10 | -0.051 ✗ | -0.079 | -0.96 |
| totalInvested | -0.032 ✗ | -0.049 ✗ | -0.060 | -0.93 |
| evEdge | 0.093 ~ p<.10 | 0.064 ✗ | 0.060 | 1.20 |
| moneyPct | 0.046 ✗ | 0.002 ✗ | 0.008 | 0.04 |
| walletPct | 0.079 ✗ | 0.053 ✗ | 0.054 | 1.00 |
| criteriaMet | -0.060 ✗ | -0.032 ✗ | -0.062 | -0.60 |
| maxContribFor | -0.069 ✗ | -0.038 ✗ | -0.010 | -0.71 |
| meanBaseFor | -0.036 ✗ | -0.000 ✗ | 0.037 | -0.01 |
...
Sample with CLV: **346** picks. Mean CLV = **-0.0025**.
t-statistic vs zero: -1.70 → ~ p<.10 · 95% CI [-0.0053, 0.0004]
...
Trained on N=244 (with all features non-null). Intercept β₀ = 0.072.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | pw.Δcount | +0.344 | ↑ helps |
| 2 | pw.ΔAvgRoi | +0.339 | ↑ helps |
| 3 | peak.stars | -0.282 | ↓ hurts |
| 4 | sharpCount | -0.274 | ↓ hurts |
| 5 | evEdge | +0.269 | ↑ helps |
| 6 | pw.ΔFlatPnl | +0.189 | ↑ helps |
| 7 | odds (American) | -0.180 | ↓ hurts |
| 8 | log(impliedProb) | +0.156 | ↑ helps |
| 9 | HC margin | +0.143 | ↑ helps |
| 10 | pw.ΔWlNet | +0.135 | ↑ helps |
| 11 | pw.ΔTopQShare | +0.123 | ↑ helps |
| 12 | Δw | -0.121 | ↓ hurts |
| 13 | walletPct | +0.112 | ↑ helps |
| 14 | vault.star | +0.083 | ↑ helps |
| 15 | log10(invested) | -0.070 | ↓ hurts |
| 16 | criteriaMet | -0.046 | ≈ flat |
| 17 | Δw + HC | -0.028 | ≈ flat |
...
|---|---|---|---|---|---|---|---|---|
| Tier-1a HC ≥ +2 (post-cutover) | 27 | 10-17 | 37.0% | 40.5% | -110 | — (mute) | 3.35u | **MUTE** (negative EV at posterior) |
| Tier-1b HC = +1 (post-cutover) | 103 | 59-44 | 57.3% | 56.6% | -109 | 4.69% bankroll | 1.89u | **UNDER-SIZED** — ship up to 4.69u (1u=1% bankroll) |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 48 | 19-29 | 39.6% | 41.4% | -110 | — (mute) | 2.02u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 74 | 37-37 | 50.0% | 50.0% | -106 | — (mute) | 2.68u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.255  (annualized × √252 ≈ -4.05)
...
| 2026-04-20 | NBA | ML | home | 3.0 | 1.00 | -235 | -1 | — | — | -2 | -15 | -1.00 | L | -1.0u |
...
| 2026-04-24 | MLB | ML | home | 3.5 | 0.75 | -108 | 1 | — | — | 2 | -11 | -1.40 | W | +0.7u |
| 2026-04-24 | NBA | ML | away | 5.0 | 3.00 | -295 | 0 | — | — | 4 | 25 | 0.00 | W | +1.0u |
| 2026-04-24 | NBA | SPREAD | home | 3.0 | 1.50 | -108 | 0 | — | — | 1 | 29 | -1.70 | P | +0.0u |
...
| 2026-04-25 | MLB | ML | away | 3.5 | 0.75 | +124 | 1 | — | — | 1 | -12 | -1.50 | L | -0.8u |
| 2026-04-25 | MLB | ML | home | 4.0 | 1.25 | +128 | 1 | — | — | 1 | -12 | -0.40 | L | -1.3u |
| 2026-04-25 | NBA | ML | away | 5.0 | 3.00 | -118 | 3 | — | — | 0 | -35 | -1.90 | L | -3.0u |
| 2026-04-25 | NBA | ML | home | 5.0 | 2.00 | +125 | 4 | — | — | 2 | 2 | -1.20 | W | +2.4u |
| 2026-04-25 | NBA | SPREAD | home | 5.0 | 2.00 | -105 | 2 | — | — | 2 | 8 | -0.70 | L | -2.0u |
| 2026-04-25 | NHL | ML | away | 3.5 | 0.75 | +118 | 1 | — | — | 0 | 0 | -0.60 | L | -0.8u |
| 2026-04-25 | NHL | ML | home | 5.0 | 3.00 | -120 | 2 | — | — | 1 | 3 | -0.40 | L | -3.0u |
| 2026-04-26 | MLB | ML | away | 3.5 | 0.75 | +108 | 1 | — | — | 1 | 4 | 0.50 | L | -0.8u |
| 2026-04-26 | MLB | TOTAL | over | 3.5 | 0.50 | -116 | 1 | — | — | -1 | 12 | 0.00 | L | -0.5u |
| 2026-04-26 | MLB | ML | home | 3.5 | 0.75 | -110 | 1 | — | — | 1 | 20 | -1.40 | L | -0.8u |
| 2026-04-26 | MLB | ML | away | 5.0 | 2.00 | +100 | 2 | — | — | 0 | 0 | 0.00 | L | -2.0u |
| 2026-04-26 | MLB | TOTAL | over | 4.0 | 0.75 | -102 | 1 | — | — | 2 | -8 | 0.00 | W | +0.7u |
...
| 2026-04-26 | NBA | TOTAL | under | 5.0 | 2.00 | -110 | 3 | — | — | 1 | -3 | 0.00 | W | +1.8u |
| 2026-04-26 | NBA | SPREAD | home | 4.0 | 0.75 | -110 | 1 | — | — | 3 | 10 | 0.20 | W | +0.7u |
| 2026-04-27 | MLB | ML | home | 5.0 | 2.00 | +140 | 2 | — | — | -1 | -20 | -0.50 | L | -2.0u |
| 2026-04-27 | MLB | ML | away | 3.5 | 0.75 | +104 | 1 | — | — | 1 | -12 | -0.70 | W | +0.8u |
| 2026-04-27 | NBA | SPREAD | away | 4.0 | 0.75 | -114 | 1 | — | — | 1 | -14 | -0.70 | L | -0.8u |
| 2026-04-27 | NBA | TOTAL | over | 5.0 | 2.00 | -104 | 3 | — | — | 3 | 30 | 0.00 | L | -2.0u |
...
| 2026-04-28 | NBA | ML | away | 5.0 | 0.50 | +215 | 2 | — | — | 1 | 2 | -0.70 | L | -0.5u |
| 2026-04-28 | NBA | SPREAD | away | 5.0 | 2.00 | -105 | 2 | — | — | 5 | 10 | -1.60 | W | +1.8u |
| 2026-04-28 | NBA | SPREAD | away | 5.0 | 2.00 | -105 | 3 | — | — | 3 | 27 | 0.20 | L | -2.0u |
| 2026-04-29 | MLB | ML | home | 3.5 | 0.50 | -108 | 1 | — | — | 1 | 20 | 0.50 | L | -0.5u |
| 2026-04-29 | MLB | TOTAL | under | 3.5 | 0.50 | -117 | 1 | — | — | 2 | 0 | 0.00 | L | -0.5u |
| 2026-04-29 | NBA | SPREAD | home | 3.5 | 0.50 | -105 | 1 | — | — | 1 | 23 | -0.70 | L | -0.5u |
...
| 2026-04-30 | NBA | ML | home | 4.0 | 1.00 | +198 | 2 | 1 | 3 | 3 | -21 | -0.20 | W | +0.0u |
...
| 2026-05-01 | NBA | ML | home | 5.0 | 3.00 | -180 | 3 | -1 | 2 | 2 | -28 | 0.10 | L | -3.0u |
...
| 2026-05-04 | NBA | TOTAL | under | 5.0 | 3.50 | -102 | 3 | 1 | 4 | 3 | 13 | 0.00 | W | +3.2u |
...
| 2026-05-05 | NBA | TOTAL | under | 4.0 | 0.75 | -113 | 1 | 0 | 1 | 2 | 20 | 0.00 | W | +0.7u |
...
| 2026-05-08 | NBA | TOTAL | over | 4.0 | 0.75 | +101 | 2 | 0 | 2 | 2 | 20 | 0.00 | W | +0.8u |
| 2026-05-08 | NHL | ML | home | 3.5 | 1.13 | -134 | 1 | 1 | 2 | 1 | 1 | -1.30 | L | -1.1u |
| 2026-05-09 | NBA | SPREAD | home | 4.5 | 1.70 | -104 | — | — | — | 2 | 13 | 0.00 | W | +1.6u |
| 2026-05-09 | NBA | TOTAL | over | 3.5 | 0.75 | -106 | 1 | 1 | 2 | 1 | 5 | 0.00 | W | +0.7u |
| 2026-05-09 | NBA | ML | away | 5.0 | 4.50 | -364 | 3 | 1 | 4 | 6 | 39 | 0.00 | W | +1.2u |
| 2026-05-09 | NBA | SPREAD | away | 4.5 | 2.00 | -104 | 2 | 1 | 3 | 2 | 20 | 0.00 | W | +1.9u |
| 2026-05-10 | MLB | ML | home | 3.5 | 1.13 | -120 | 1 | 1 | 2 | 1 | -12 | 0.00 | W | +0.9u |
| 2026-05-10 | MLB | TOTAL | over | 4.0 | 0.64 | -110 | 2 | 0 | 2 | 1 | -12 | 0.00 | L | -0.6u |
| 2026-05-10 | MLB | TOTAL | over | 4.0 | 0.64 | -110 | 2 | 0 | 2 | 1 | -12 | 0.00 | L | -0.6u |
| 2026-05-10 | MLB | ML | home | 3.5 | 1.13 | -103 | 1 | 1 | 2 | 1 | -12 | 0.00 | L | -1.1u |
| 2026-05-10 | MLB | ML | home | 3.5 | 1.13 | -110 | 1 | 1 | 2 | 1 | -12 | 0.00 | W | +1.0u |
| 2026-05-10 | MLB | ML | away | 3.5 | 1.13 | +134 | 0 | 1 | 1 | 1 | -12 | 0.00 | W | +1.5u |
| 2026-05-10 | NBA | ML | home | 4.0 | 1.50 | +160 | 1 | 1 | 2 | 2 | 22 | 0.80 | W | +2.6u |
| 2026-05-10 | NBA | TOTAL | over | 5.0 | 3.50 | -110 | 3 | 2 | 5 | 2 | 21 | 0.00 | W | +3.3u |
| 2026-05-10 | NHL | ML | away | 4.5 | 4.50 | +108 | 2 | 2 | 4 | 2 | 3 | -0.70 | L | -4.5u |
| 2026-05-10 | NHL | TOTAL | under | 5.0 | 1.70 | -110 | 2 | 1 | 3 | 2 | -1 | 0.00 | L | -1.7u |
| 2026-05-11 | MLB | ML | away | 3.5 | 1.13 | -101 | 1 | 1 | 2 | 2 | -14 | 0.00 | W | +1.1u |
| 2026-05-11 | MLB | ML | home | 3.5 | 1.13 | -156 | 1 | 1 | 2 | 1 | -12 | 0.00 | W | +0.7u |
...
| 2026-05-12 | NBA | SPREAD | away | 5.0 | 3.50 | -105 | 6 | 4 | 10 | 6 | 44 | -0.70 | L | -3.5u |
| 2026-05-13 | MLB | ML | home | 4.5 | 4.50 | -116 | 1 | 1 | 2 | 1 | -12 | -1.30 | W | +3.7u |
| 2026-05-13 | MLB | SPREAD | home | 5.0 | 3.50 | -105 | 1 | 1 | 2 | 2 | -12 | 0.90 | W | +3.2u |
| 2026-05-13 | MLB | TOTAL | under | 4.0 | 0.96 | -110 | 1 | 1 | 2 | 2 | -19 | 0.00 | W | +0.9u |
| 2026-05-13 | MLB | TOTAL | under | 5.0 | 3.50 | -110 | 4 | 2 | 6 | 4 | -15 | 0.00 | L | -3.5u |
| 2026-05-13 | NBA | ML | home | 5.0 | 4.50 | -162 | 6 | 0 | 6 | 3 | -26 | -1.00 | L | -4.5u |
| 2026-05-13 | NBA | TOTAL | over | 5.0 | 3.50 | -101 | 3 | 2 | 5 | 4 | 9 | 0.00 | W | +3.4u |
...
| 2026-05-15 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 1 | 1 | 2 | 2 | -10 | 0.00 | W | +0.3u |
...
| 2026-05-15 | NBA | ML | away | 2.5 | 0.50 | +145 | 6 | 1 | 7 | 6 | 24 | -0.50 | W | +0.8u |
| 2026-05-15 | NBA | TOTAL | over | 4.0 | 0.75 | -109 | 0 | 1 | 1 | 2 | -10 | 0.00 | L | -0.8u |
| 2026-05-15 | NBA | SPREAD | home | 2.5 | 1.00 | -105 | 1 | 0 | 1 | 1 | 14 | 0.00 | L | -1.0u |
| 2026-05-15 | NBA | TOTAL | over | 5.0 | 2.00 | -110 | 1 | 0 | 1 | 3 | 9 | 0.00 | W | +1.9u |
| 2026-05-16 | MLB | ML | away | 5.0 | 4.50 | +124 | 3 | 1 | 4 | 4 | -10 | -1.30 | W | +1.4u |
| 2026-05-16 | MLB | SPREAD | away | 4.0 | 1.65 | -175 | 2 | 0 | 2 | 2 | 4 | 0.00 | W | +0.9u |
| 2026-05-16 | MLB | ML | home | 5.0 | 2.50 | +119 | 2 | 1 | 3 | 1 | -12 | -2.00 | L | -2.5u |
| 2026-05-16 | MLB | ML | home | 5.0 | 2.50 | +115 | 3 | 2 | 5 | 2 | 4 | -1.10 | W | +2.8u |
| 2026-05-16 | MLB | TOTAL | over | 4.0 | 1.65 | -110 | 2 | 0 | 2 | 1 | -12 | 0.00 | L | -1.6u |
| 2026-05-16 | MLB | ML | away | 2.5 | 0.50 | -102 | 1 | 0 | 1 | 1 | -39 | 0.00 | W | +0.5u |
| 2026-05-17 | MLB | ML | away | 4.0 | 2.75 | -148 | 1 | 0 | 1 | 2 | 8 | -0.70 | W | +1.9u |
| 2026-05-17 | MLB | ML | away | 2.5 | 0.50 | +139 | 0 | 1 | 1 | 0 | -32 | 0.70 | L | -0.5u |
| 2026-05-17 | MLB | ML | away | 5.0 | 5.00 | -129 | 3 | 1 | 4 | 1 | -12 | 0.40 | L | -5.0u |
| 2026-05-17 | MLB | ML | home | 4.0 | 2.75 | -114 | 3 | 1 | 4 | 4 | -5 | 2.20 | W | +2.4u |
| 2026-05-17 | MLB | TOTAL | over | 4.5 | 2.25 | -110 | 2 | 1 | 3 | 2 | -12 | 0.00 | W | +2.0u |
| 2026-05-17 | MLB | TOTAL | over | 5.0 | 2.50 | +107 | 2 | 2 | 4 | 1 | -12 | 0.00 | L | -2.5u |
| 2026-05-17 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 1 | 1 | -1 | 7 | 0.00 | W | +0.3u |
| 2026-05-17 | NBA | ML | away | 3.0 | 1.25 | +165 | 3 | 1 | 4 | 2 | 11 | -0.60 | W | +0.8u |
| 2026-05-17 | NBA | TOTAL | under | 5.0 | 0.75 | -110 | 2 | 3 | 5 | 1 | 18 | 0.00 | L | -0.8u |
| 2026-05-18 | MLB | ML | home | 4.5 | 5.00 | -111 | 2 | 1 | 3 | 2 | 8 | -1.10 | W | +4.4u |
| 2026-05-18 | MLB | ML | away | 4.0 | 2.50 | +120 | 2 | 0 | 2 | 1 | -12 | -2.10 | L | -2.5u |
| 2026-05-18 | MLB | ML | home | 3.0 | 1.25 | -118 | 2 | 0 | 2 | 1 | -12 | 1.00 | W | +1.1u |
...
| 2026-05-18 | NBA | SPREAD | home | 2.5 | 1.00 | -110 | 1 | 1 | 2 | 0 | 13 | 0.20 | L | -1.0u |
| 2026-05-18 | NHL | ML | home | 5.0 | 5.00 | -112 | 2 | 2 | 4 | 2 | 5 | -1.10 | L | -5.0u |
| 2026-05-18 | NHL | TOTAL | under | 4.5 | 2.25 | -110 | 3 | 1 | 4 | 1 | 6 | 0.00 | W | +2.0u |
| 2026-05-19 | MLB | ML | home | 5.0 | 2.50 | +118 | 1 | 1 | 2 | 1 | -15 | -1.30 | L | -2.5u |
| 2026-05-19 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 2 | 0 | 2 | 1 | 4 | 0.00 | W | +1.5u |
| 2026-05-19 | MLB | ML | home | 2.5 | 2.50 | +105 | 1 | 1 | 2 | 2 | -14 | -0.90 | L | -2.5u |
| 2026-05-19 | MLB | ML | away | 2.5 | 1.25 | -104 | 1 | 1 | 2 | 0 | -12 | -1.20 | W | +1.2u |
| 2026-05-19 | NBA | ML | home | 5.0 | 5.00 | -260 | 0 | 3 | 3 | 3 | 17 | -0.50 | W | +1.9u |
| 2026-05-19 | NBA | SPREAD | away | 5.0 | 2.25 | -105 | 3 | 2 | 5 | 2 | 0 | -0.90 | L | -2.3u |
| 2026-05-19 | NBA | TOTAL | under | 5.0 | 3.00 | -106 | 2 | 3 | 5 | 2 | 10 | 0.00 | L | -3.0u |
| 2026-05-20 | MLB | ML | away | 5.0 | 2.50 | +113 | 2 | 1 | 3 | 1 | -12 | -1.00 | L | -2.5u |
| 2026-05-20 | MLB | ML | home | 4.0 | 2.75 | -154 | 2 | 0 | 2 | 1 | 20 | -1.50 | W | +1.9u |
| 2026-05-20 | MLB | TOTAL | under | 4.0 | 0.75 | -110 | 2 | 0 | 2 | 1 | -12 | 0.00 | L | -0.8u |
| 2026-05-20 | MLB | ML | home | 2.5 | 0.50 | -140 | 1 | 1 | 2 | 1 | -12 | -1.10 | W | +0.9u |
| 2026-05-20 | MLB | ML | home | 2.5 | 0.50 | +111 | 0 | 1 | 1 | -1 | -20 | 0.00 | W | +0.6u |
| 2026-05-20 | MLB | ML | away | 4.0 | 2.75 | +113 | 1 | 1 | 2 | 0 | -32 | -1.00 | L | -2.8u |
| 2026-05-20 | NBA | ML | home | 5.0 | 5.00 | -225 | 10 | 5 | 15 | 2 | 11 | -0.20 | W | +2.1u |
| 2026-05-20 | NBA | SPREAD | home | 5.0 | 3.00 | -106 | 6 | 1 | 7 | 4 | 50 | -0.70 | W | +2.7u |
| 2026-05-20 | NBA | TOTAL | over | 5.0 | 1.65 | -112 | 3 | 1 | 4 | 3 | 46 | 0.00 | W | +1.5u |
| 2026-05-20 | NHL | ML | home | 2.5 | 1.25 | -192 | 0 | 1 | 1 | 1 | -1 | -0.80 | L | -1.3u |
| 2026-05-21 | MLB | ML | home | 5.0 | 2.50 | +125 | 1 | 1 | 2 | 2 | -14 | -0.40 | L | -2.5u |
| 2026-05-21 | MLB | SPREAD | home | 3.0 | 0.75 | -148 | 0 | 0 | 0 | 1 | -12 | -1.50 | L | -0.8u |
| 2026-05-21 | MLB | ML | away | 3.0 | 1.25 | +172 | 2 | 0 | 2 | 1 | -12 | -0.50 | L | -1.3u |
| 2026-05-21 | MLB | ML | away | 4.5 | 2.75 | -110 | 2 | 1 | 3 | 1 | -12 | -0.50 | W | +2.5u |
| 2026-05-21 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 0 | 0 | 2 | -2 | 0.00 | W | +0.3u |
| 2026-05-21 | MLB | ML | home | 3.0 | 1.25 | -116 | 3 | 1 | 4 | 2 | -12 | -0.40 | L | -1.3u |
| 2026-05-21 | MLB | ML | away | 3.0 | 1.25 | +129 | 1 | 0 | 1 | 3 | -28 | -0.40 | W | +1.6u |
| 2026-05-21 | MLB | SPREAD | away | 4.0 | 1.65 | -170 | 1 | 1 | 2 | 1 | 0 | 0.30 | W | +1.0u |
| 2026-05-21 | NBA | SPREAD | away | 5.0 | 3.00 | -110 | 4 | 2 | 6 | 3 | 17 | 0.70 | L | -3.0u |
...
| 2026-05-22 | MLB | ML | home | 3.0 | 1.25 | -137 | 1 | 0 | 1 | 1 | -3 | 0.00 | L | -1.3u |
| 2026-05-22 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 0 | 0 | 0.00 | L | -0.8u |
| 2026-05-22 | MLB | ML | home | 5.0 | 5.00 | -144 | 4 | 2 | 6 | 2 | 8 | -1.60 | L | -5.0u |
| 2026-05-22 | MLB | SPREAD | home | 5.0 | 0.75 | -155 | 2 | 0 | 2 | 1 | -12 | -0.30 | W | +0.4u |
| 2026-05-22 | MLB | ML | home | 5.0 | 2.75 | -158 | 1 | 0 | 1 | 1 | 20 | -0.80 | W | +1.7u |
| 2026-05-22 | MLB | SPREAD | home | 3.0 | 0.75 | -142 | 1 | 0 | 1 | 1 | -12 | -2.00 | L | -0.8u |
| 2026-05-22 | MLB | ML | home | 5.0 | 5.00 | -145 | 2 | 2 | 4 | 1 | 20 | -2.20 | L | -5.0u |
| 2026-05-22 | MLB | ML | home | 2.5 | 0.50 | +139 | 2 | 1 | 3 | 0 | -20 | -0.90 | W | +0.7u |
| 2026-05-22 | MLB | SPREAD | home | 4.0 | 1.65 | -119 | 1 | 1 | 2 | 1 | -12 | -1.20 | W | +1.3u |
| 2026-05-22 | MLB | ML | away | 5.0 | 1.50 | +185 | 3 | 0 | 3 | 2 | -14 | -1.10 | L | -1.5u |
| 2026-05-22 | MLB | SPREAD | away | 3.0 | 0.75 | -112 | 1 | 0 | 1 | 1 | -12 | -1.40 | W | +0.6u |
| 2026-05-22 | NBA | ML | home | 5.0 | 5.00 | -120 | 0 | 0 | 0 | -4 | -27 | 0.00 | L | -5.0u |
...
| 2026-05-23 | MLB | ML | home | 2.5 | 0.50 | -181 | 1 | 0 | 1 | 2 | 13 | -1.70 | W | +0.3u |
| 2026-05-23 | MLB | ML | away | 2.5 | 2.75 | +109 | 2 | 0 | 2 | 2 | -10 | -0.50 | L | -2.8u |
| 2026-05-23 | MLB | TOTAL | over | 2.5 | 0.30 | -110 | 0 | 1 | 1 | 0 | 7 | 0.00 | W | +0.3u |
| 2026-05-23 | MLB | ML | home | 5.0 | 1.00 | -148 | 0 | 0 | 0 | 1 | -3 | -0.20 | L | -1.0u |
| 2026-05-23 | MLB | SPREAD | away | 3.0 | 0.75 | -163 | 1 | 0 | 1 | 1 | -12 | 0.00 | W | +0.5u |
| 2026-05-23 | MLB | TOTAL | under | 5.0 | 3.00 | -110 | 3 | 1 | 4 | 2 | -10 | 0.00 | W | +2.7u |
| 2026-05-23 | MLB | SPREAD | home | 3.0 | 0.75 | -163 | 0 | 0 | 0 | 1 | -7 | -0.90 | L | -0.8u |
| 2026-05-23 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 2 | 1 | 3 | 1 | -12 | 0.00 | L | -0.8u |
| 2026-05-23 | MLB | SPREAD | away | 4.5 | 1.50 | -209 | 0 | 0 | 0 | 2 | -19 | 29.00 | W | +2.5u |
| 2026-05-23 | MLB | TOTAL | under | 3.0 | 0.75 | +102 | 0 | 0 | 0 | 1 | -7 | 0.00 | W | +0.8u |
| 2026-05-23 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 1 | -12 | 0.00 | W | +0.7u |
| 2026-05-23 | MLB | ML | away | 2.5 | 1.25 | -111 | -1 | 1 | 0 | 1 | -4 | 0.40 | L | -1.3u |
| 2026-05-23 | MLB | SPREAD | home | 3.0 | 0.75 | -135 | 0 | 0 | 0 | 1 | -7 | 0.40 | W | +0.6u |
| 2026-05-23 | MLB | TOTAL | under | 2.5 | 0.30 | +108 | 0 | 0 | 0 | 0 | -11 | 0.00 | P | +0.0u |
| 2026-05-23 | MLB | ML | home | 4.0 | 2.50 | +118 | 1 | 0 | 1 | 1 | -1 | 1.10 | W | +2.9u |
| 2026-05-23 | MLB | ML | away | 3.0 | 1.25 | +166 | 2 | 1 | 3 | 2 | -7 | -0.30 | W | +1.8u |
...
| 2026-05-23 | NBA | TOTAL | under | 5.0 | 3.00 | +102 | 1 | -1 | 0 | 5 | 16 | 0.00 | L | -3.0u |
| 2026-05-23 | NHL | ML | home | 5.0 | 5.00 | -205 | 8 | 0 | 8 | 4 | 10 | -0.70 | W | +2.4u |
| 2026-05-23 | NHL | TOTAL | under | 3.0 | 0.30 | -110 | 1 | 1 | 2 | 0 | 2 | 0.00 | W | +0.3u |
| 2026-05-24 | MLB | ML | home | 4.5 | 3.75 | -101 | 2 | 1 | 3 | 2 | -12 | 0.00 | L | -3.8u |
| 2026-05-24 | MLB | ML | home | 3.0 | 1.25 | -189 | 1 | 0 | 1 | 1 | 20 | 0.00 | W | +0.7u |
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 0.75 | -110 | 1 | 0 | 1 | 2 | 15 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 1 | 1 | 2 | 1 | -3 | 0.00 | L | -1.6u |
...
| 2026-05-24 | MLB | ML | home | 2.5 | 0.50 | +144 | 1 | 1 | 2 | 0 | -32 | 0.00 | L | -0.5u |
| 2026-05-24 | MLB | SPREAD | home | 4.0 | 1.65 | -110 | 2 | 1 | 3 | 2 | -19 | -1.30 | L | -1.6u |
| 2026-05-24 | MLB | ML | home | 3.0 | 1.25 | -107 | 1 | 0 | 1 | 1 | 4 | 0.00 | W | +1.2u |
| 2026-05-24 | MLB | TOTAL | under | 2.5 | 1.00 | -101 | 1 | 1 | 2 | 1 | -7 | 0.00 | W | +0.0u |
| 2026-05-24 | MLB | TOTAL | under | 2.5 | 0.30 | -104 | 0 | 0 | 0 | 1 | 15 | 0.00 | W | +0.3u |
| 2026-05-24 | MLB | ML | away | 4.0 | 1.25 | +148 | 2 | 2 | 4 | 0 | 4 | -1.40 | W | +1.9u |
| 2026-05-24 | MLB | ML | away | 3.0 | 1.25 | -122 | -1 | 1 | 0 | 0 | -17 | -1.10 | L | -1.3u |
| 2026-05-24 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 1 | -12 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | SPREAD | home | 3.0 | 0.75 | +134 | 1 | 0 | 1 | 0 | -11 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 1 | -12 | 0.00 | W | +0.7u |
| 2026-05-24 | NBA | SPREAD | away | 5.0 | 1.65 | -103 | 3 | 0 | 3 | 1 | 1 | 0.50 | L | -1.6u |
| 2026-05-24 | NBA | TOTAL | over | 4.5 | 3.00 | -107 | 2 | 1 | 3 | 2 | -14 | 0.00 | L | -3.0u |
...
| 2026-05-25 | MLB | ML | home | 4.0 | 1.25 | -125 | 1 | -1 | 0 | 1 | -10 | -1.90 | L | -1.3u |
...
| 2026-05-25 | MLB | ML | home | 5.0 | 1.25 | -160 | 3 | 0 | 3 | 2 | -15 | -1.10 | L | -1.3u |
| 2026-05-25 | MLB | TOTAL | over | 5.0 | 3.00 | -110 | 3 | 0 | 3 | 3 | 0 | 0.00 | W | +2.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 3.75 | -108 | 0 | 0 | 0 | 3 | -22 | -1.70 | L | -3.8u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -124 | 2 | 0 | 2 | 2 | -19 | -1.30 | W | +0.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 5.00 | -119 | 2 | -1 | 1 | 4 | -12 | -0.60 | W | +3.1u |
| 2026-05-25 | MLB | ML | away | 2.5 | 2.75 | -113 | 0 | 0 | 0 | 0 | 9 | -1.80 | W | +1.1u |
| 2026-05-25 | MLB | ML | home | 4.0 | 5.00 | -209 | -1 | 0 | -1 | 3 | 10 | -0.80 | W | +2.3u |
| 2026-05-25 | MLB | TOTAL | under | 5.0 | 0.75 | -101 | 2 | 1 | 3 | 1 | 11 | 0.00 | W | +0.7u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -178 | 1 | 0 | 1 | 2 | -19 | -1.60 | W | +0.9u |
| 2026-05-25 | NBA | ML | away | 5.0 | 5.00 | -125 | 0 | 0 | 0 | 4 | 44 | -0.40 | W | +4.0u |
| 2026-05-25 | NBA | TOTAL | under | 5.0 | 3.00 | -110 | 2 | 2 | 4 | -1 | -1 | 0.00 | L | -3.0u |
...
| 2026-05-26 | MLB | ML | away | 5.0 | 1.50 | +200 | 2 | 0 | 2 | 2 | -14 | -1.00 | L | -1.5u |
...
| 2026-05-26 | MLB | ML | away | 5.0 | 5.00 | -200 | 1 | 0 | 1 | 2 | 13 | -0.60 | W | +1.9u |
...
| 2026-05-26 | MLB | ML | home | 5.0 | 5.00 | -105 | 2 | 1 | 3 | 2 | 13 | -2.00 | W | +3.6u |
| 2026-05-26 | MLB | ML | away | 5.0 | 2.50 | +116 | 1 | 0 | 1 | 2 | 13 | -1.00 | W | +2.9u |
| 2026-05-26 | NBA | ML | home | 5.0 | 5.00 | -198 | 2 | 4 | 6 | 3 | 14 | -0.70 | W | +1.9u |
| 2026-05-26 | NBA | SPREAD | home | 5.0 | 1.00 | -110 | 2 | 2 | 4 | 1 | 21 | 1.20 | W | +0.0u |
| 2026-05-26 | NBA | TOTAL | over | 5.0 | 3.00 | -108 | 0 | 0 | 0 | 3 | 7 | 0.00 | W | +2.6u |
...
| 2026-05-27 | MLB | ML | home | 3.0 | 1.25 | -144 | -1 | -1 | -2 | 0 | -3 | -1.00 | L | -1.3u |
| 2026-05-27 | MLB | ML | away | 5.0 | 0.50 | -102 | 3 | 0 | 3 | 2 | 16 | -1.00 | L | -0.5u |
| 2026-05-27 | MLB | SPREAD | away | 4.0 | 0.75 | -163 | 0 | 0 | 0 | 1 | -7 | 0.40 | W | +0.5u |
| 2026-05-27 | MLB | TOTAL | under | 5.0 | 1.00 | -112 | 3 | 1 | 4 | 3 | -6 | 0.00 | W | +0.0u |
| 2026-05-27 | MLB | ML | away | 4.0 | 1.00 | -108 | 1 | -1 | 0 | 0 | 26 | -0.90 | L | -1.0u |
| 2026-05-27 | MLB | ML | home | 5.0 | 0.50 | +132 | 2 | 0 | 2 | 2 | -11 | -0.50 | L | -0.5u |
...
| 2026-05-27 | MLB | SPREAD | away | 4.5 | 1.65 | -145 | 1 | 1 | 2 | 1 | -7 | -0.30 | W | +1.1u |
| 2026-05-27 | MLB | ML | away | 5.0 | 5.00 | -126 | 2 | 0 | 2 | 2 | -11 | -4.10 | L | -5.0u |
