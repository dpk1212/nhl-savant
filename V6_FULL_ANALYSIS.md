...
_Auto-generated **6/14/2026, 11:03:10 AM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 627 shipped+graded picks · 2026-04-18 → 2026-06-13  (HC analyses scoped to post-cutover 2026-04-30, 515 picks)
**Headline:** 316-303-8 · WR 51.1% [47.1%–55.0%] vs 52.4% break-even · -12.9u flat (-2.1%) · -42.4u peak.
**Overall t-test:** t = -0.52 → ✗ noise.
...
- **ρ(Δw, flat ROI) = 0.001 ✗**  (full sample, N=621)
- **ρ(HC, flat ROI) = -0.042 ✗**  (post-cutover, N=515)
- **ρ(Δw+HC, flat ROI) = -0.069 ✗**  (post-cutover, N=515)
...
- **Tier-1b (HC = +1)** — N=155, WR 55.5%, flat ROI +6.9%. Bayesian posterior WR ≈ 55.2%, half-Kelly = **2.9%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=86, WR 45.9%, flat ROI -14.1%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=105, WR 46.7%, flat ROI -5.9%. Bayesian posterior WR ≈ 47.0%, half-Kelly = **0.0%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -7.2% flat ROI on 161 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (0.99u/pick), we need **~1499 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 627. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **627** |
| W-L-P | 316-303-8 |
| Win rate | **51.1%** [47.1%–55.0%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +1.3 pp |
| Peak-units PnL | **-42.4u** |
| Flat-1u PnL | **-12.9u** (-2.1% flat ROI) |
| Flat t-statistic vs zero | -0.52 → ✗ noise |
| Flat 95% CI per-pick | [-0.098, 0.057]u |
...
We have **627** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = −1 | 22 | 6-15-1 | 28.6% [14–50] | -42.8% | -8.5u | -2.25 ✓ p<.05 |
| Δw = 0 | 133 | 69-61-3 | 53.1% [45–61] | +0.3% | +17.8u | 0.03 ✗ noise |
| Δw = +1 | 225 | 122-100-3 | 55.0% [48–61] | +3.9% | +7.5u | 0.61 ✗ noise |
| Δw = +2 | 130 | 64-65-1 | 49.6% [41–58] | -3.6% | -28.4u | -0.41 ✗ noise |
| Δw ≥ +3 | 105 | 49-56-0 | 46.7% [37–56] | -5.9% | -31.5u | -0.54 ✗ noise |

**Pearson ρ(Δw, WIN) = -0.006** ✗  ·  **ρ(Δw, flat ROI) = 0.001** ✗  (N=621)
...
| HC = −1 | 23 | 13-10-0 | 56.5% [37–74] | +16.1% | +9.5u | 0.73 ✗ noise |
| HC = 0 | 294 | 146-141-7 | 50.9% [45–57] | -4.3% | -37.7u | -0.78 ✗ noise |
| HC = +1 | 155 | 86-69-0 | 55.5% [48–63] | +6.9% | +7.5u | 0.87 ✗ noise |
| HC = +2 | 31 | 16-15-0 | 51.6% [35–68] | -0.4% | -4.6u | -0.02 ✗ noise |
| HC ≥ +3 | 11 | 3-8-0 | 27.3% [10–57] | -60.6% | -9.1u | -2.98 ✓ p<.01 |

**Pearson ρ(HC, WIN) = -0.025** ✗  ·  **ρ(HC, flat ROI) = -0.042** ✗  (N=515)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 110 | 54-53-3 | 50.5% [41–60] | -3.5% | +10.0u | -0.38 ✗ noise |
| Σ = +1 | 154 | 85-66-3 | 56.3% [48–64] | +6.5% | +5.2u | 0.85 ✗ noise |
| Σ = +2 | 116 | 68-47-1 | 59.1% [50–68] | +10.6% | +13.6u | 1.22 ✗ noise |
| Σ = +3 | 56 | 22-34-0 | 39.3% [28–52] | -23.0% | -20.7u | -1.74 ~ p<.10 |
| Σ = +4 | 39 | 20-19-0 | 51.3% [36–66] | +0.7% | -10.5u | 0.04 ✗ noise |
| Σ = +5 | 18 | 8-10-0 | 44.4% [25–66] | -15.5% | -12.5u | -0.67 ✗ noise |
| Σ ≥ +6 | 22 | 8-14-0 | 36.4% [20–57] | -33.0% | -16.9u | -1.67 ~ p<.10 |

**Pearson ρ(Δw+HC, WIN) = -0.057** ✗  ·  **ρ(Σ, flat ROI) = -0.069** ✗  (N=515)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 515.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.063 ✗ | -0.069 ✗ | -0.048 | weak |
| HC margin | -0.025 ✗ | -0.042 ✗ | -0.003 | weak |
| Δw + HC | -0.057 ✗ | -0.069 ✗ | -0.036 | weak |
| peak.stars | -0.041 ✗ | -0.062 ✗ | -0.074 | weak |
| vault.star | -0.054 ✗ | -0.068 ✗ | -0.081 | weak |
| lock.stars | -0.022 ✗ | -0.035 ✗ | -0.039 | weak |
...
Universe N = 515 (post-cutover, both axes present).

| HC \ Δw | ≤ −3 | -2 | -1 | +0 | +1 | +2 | ≥ +3 |
|---|---|---|---|---|---|---|---|
| ≤ −3 | — | — | — | — | — | — | — |
| -2 | — | N=1 · 1-0 · 100% [21–100] · —  | — | — | — | — | — |
| -1 | — | N=1 · 0-1 · 0% [0–79] · —  | N=3 · 2-1 · 67% [21–94] · +42%  | N=6 · 5-1 · 83% [44–97] · +75% ★ | N=7 · 2-5 · 29% [8–64] · -49%  | N=2 · 2-0 · 100% [34–100] · — ★ | N=4 · 2-2 · 50% [15–85] · -1%  |
| +0 | N=1 · 1-0 · 100% [21–100] · —  | N=2 · 0-2 · 0% [0–66] · —  | N=9 · 2-6 · 25% [7–59] · -50%  | N=76 · 40-34 · 54% [43–65] · +3%  | N=126 · 68-55 · 55% [46–64] · +5%  | N=55 · 29-25 · 54% [41–66] · -1%  | N=25 · 6-19 · 24% [11–43] · -56% ✗ |
| +1 | — | — | N=4 · 1-3 · 25% [5–70] · -56%  | N=26 · 15-11 · 58% [39–74] · +7%  | N=56 · 36-20 · 64% [51–76] · +22%  | N=34 · 16-18 · 47% [31–63] · -5%  | N=35 · 18-17 · 51% [36–67] · +1%  |
...
| Δw = −1 | 16 | 5-10-1 | 33.3% [15–58] | -34.2% | -4.0u | -1.49 ✗ noise |
| Δw = 0 | 110 | 62-46-2 | 57.4% [48–66] | +8.5% | +31.2u | 0.94 ✗ noise |
| Δw = +1 | 192 | 107-82-3 | 56.6% [49–63] | +7.0% | +12.0u | 1.02 ✗ noise |
| Δw = +2 | 105 | 53-51-1 | 51.0% [41–60] | -1.8% | -24.6u | -0.19 ✗ noise |
| Δw ≥ +3 | 87 | 36-51-0 | 41.4% [32–52] | -20.8% | -43.6u | -2.01 ✓ p<.05 |

### §3d. Practical lock zones (v7.4 floor anatomy)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 197 | 105-92-0 | 53.3% [46–60] | +2.0% | -6.2u | 0.28 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 86 | 39-46-1 | 45.9% [36–56] | -14.1% | -30.8u | -1.39 ✗ noise |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 232 | 121-105-6 | 53.5% [47–60] | +1.8% | +5.1u | 0.28 ✗ noise |
...
Universe N = 604 picks where ≥1 proven wallet appeared on either side.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δcount ≤ −2 (heavy oppose) | 13 | 6-7-0 | 46.2% [23–71] | -0.7% | -5.8u | -0.02 ✗ noise |
| Δcount = −1 | 34 | 16-18-0 | 47.1% [31–63] | -10.1% | -13.3u | -0.60 ✗ noise |
| Δcount = 0 (balanced) | 96 | 43-51-2 | 45.7% [36–56] | -10.7% | -9.0u | -1.06 ✗ noise |
| Δcount = +1 | 230 | 117-111-2 | 51.3% [45–58] | -4.0% | -22.2u | -0.64 ✗ noise |
| Δcount = +2 | 128 | 64-63-1 | 50.4% [42–59] | -4.7% | -21.2u | -0.55 ✗ noise |
| Δcount ≥ +3 (heavy support) | 103 | 61-40-2 | 60.4% [51–69] | +20.8% | +33.9u | 1.93 ~ p<.10 |

**ρ(Δcount, WIN) = 0.060** ✗  ·  **ρ(Δcount, flat ROI) = 0.070** ~ p<.10
...
Quintile cuts: ≤ -15 · ≤ 0 · ≤ 8 · ≤ 22 · > 22

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 121 | 50-70-1 | 41.7% [33–51] | -19.2% | -54.9u | -2.18 ✓ p<.05 |
| Q2 | 126 | 50-74-2 | 40.3% [32–49] | -21.9% | -46.3u | -2.56 ✓ p<.05 |
| Q3 (balanced) | 124 | 71-53-0 | 57.3% [48–66] | +8.1% | +19.5u | 0.95 ✗ noise |
| Q4 | 118 | 68-47-3 | 59.1% [50–68] | +15.3% | +19.3u | 1.67 ~ p<.10 |
| Q5 (best — heavy support) | 115 | 68-46-1 | 59.6% [50–68] | +13.2% | +24.7u | 1.38 ✗ noise |

**ρ(ΔWlNet, WIN) = 0.164** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.152** ✓ p<.01
...
Quintile cuts (units): ≤ -16.82 · ≤ -2.21 · ≤ 5.78 · ≤ 16.82 · > 16.82

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 131 | 56-73-2 | 43.4% [35–52] | -18.5% | -38.5u | -2.27 ✓ p<.05 |
| Q2 | 111 | 45-65-1 | 40.9% [32–50] | -23.3% | -37.7u | -2.63 ✓ p<.01 |
| Q3 | 121 | 68-53-0 | 56.2% [47–65] | +6.7% | +12.4u | 0.77 ✗ noise |
| Q4 | 121 | 66-52-3 | 55.9% [47–65] | +5.6% | -6.0u | 0.64 ✗ noise |
| Q5 | 120 | 72-47-1 | 60.5% [52–69] | +23.1% | +32.2u | 2.32 ✓ p<.05 |
...
Quintile cuts (% ROI): ≤ -9.5 · ≤ -1.5 · ≤ 8.3 · ≤ 21.6 · > 21.6

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 124 | 34-89-1 | 27.6% [21–36] | -46.9% | -93.3u | -6.04 ✓ p<.01 |
| Q2 | 118 | 58-59-1 | 49.6% [41–59] | -8.6% | -9.2u | -0.99 ✗ noise |
| Q3 | 122 | 66-55-1 | 54.5% [46–63] | +2.4% | +2.6u | 0.28 ✗ noise |
| Q4 | 120 | 72-46-2 | 61.0% [52–69] | +18.0% | +37.8u | 2.06 ✓ p<.05 |
| Q5 | 120 | 77-41-2 | 65.3% [56–73] | +30.2% | +24.5u | 3.16 ✓ p<.01 |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 59 | 12-46-1 | 20.7% [12–33] | -59.1% | -47.9u | -5.70 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 14 | 5-9-0 | 35.7% [16–61] | -34.2% | -3.1u | -1.37 ✗ noise |
| ΔBestRank = 0 (tied) | 1 | 0-1-0 | 0.0% [0–79] | -100.0% | -1.6u | 0.00 ✗ n<2 |
| ΔBestRank ∈ [+1,+4] | 18 | 8-10-0 | 44.4% [25–66] | -9.0% | -7.8u | -0.36 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 170 | 98-68-4 | 59.0% [51–66] | +17.8% | +14.8u | 2.20 ✓ p<.05 |

**ρ(ΔBestRank, WIN) = 0.328** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.361** ✓ p<.01  (N=262)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 33 | 9-24-0 | 27.3% [15–44] | -46.5% | -20.7u | -2.93 ✓ p<.01 |
| Δshare ∈ [−30,−10] pp | 5 | 0-5-0 | 0.0% [0–43] | -100.0% | -3.3u | 0.00 ✗ noise |
| Δshare ≈ 0 (±10 pp) | 393 | 192-197-4 | 49.4% [44–54] | -7.5% | -56.2u | -1.58 ✗ noise |
| Δshare ∈ [+10,+30] pp | 28 | 17-11-0 | 60.7% [42–76] | +14.8% | +3.4u | 0.83 ✗ noise |
| Δshare ≥ +30 pp | 145 | 89-53-3 | 62.7% [54–70] | +26.4% | +39.2u | 2.98 ✓ p<.01 |

**ρ(ΔTopQShare, WIN) = 0.160** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.177** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔTopQCount** | 0.180 ✓ p<.01 | 0.225 ✓ p<.01 | 0.194 |
| 2 | **ΔTopQShare** | 0.160 ✓ p<.01 | 0.177 ✓ p<.01 | 0.192 |
| 3 | **ΔWlNet** | 0.164 ✓ p<.01 | 0.152 ✓ p<.01 | 0.121 |
| 4 | **Δcount** | 0.060 ✗ | 0.070 ~ p<.10 | 0.061 |
| 5 | **ΔFlatPnl** | NaN — | NaN — | 0.175 |
| 6 | **ΔAvgRoi** | NaN — | NaN — | 0.276 |

_(ΔBestRank uses N=262 subset where both sides had a proven wallet — ρ(flat ROI) = 0.361 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 1077, dateRange = 2026-04-18 → 2026-06-13, computedAt = 2026-06-14T14:58:52.128Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **604** rows · PIT aggregate computable on **597** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **597** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 415 · 55% · +4.6% | 356 · 52% · -2.7% | -7.3pp |
| WEAK (−3..0) | 169 · 44% · -14.1% | 228 · 51% · +2.2% | +16.2pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=337, WR=55%, ROI=+5.1% | N=268, WR=51%, ROI=-4.5% | -9.6pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=415, WR=55%, ROI=+4.6% | N=356, WR=52%, ROI=-2.7% | -7.3pp |
| AGS < −1 (mute veto) | N=61, WR=45%, ROI=-12.1% | N=140, WR=48%, ROI=-1.7% | +10.4pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-05-31 → 2026-06-13, N=222)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 105 · 56% · +4.4% |
| WEAK (−3..0) | 117 · 51% · +0.6% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=75, WR=58%, ROI=+7.2% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=105, WR=56%, ROI=+4.4% |
| AGS < −1 (mute veto) | N=78, WR=49%, ROI=-1.9% |
...
|---|---|---|---|---|
| `dCount` | COUNT | + | 1.01 | 1.50 |
| `dHcSizeRatio` | INTENSITY_HC | + | 0.89 | 4.52 |
| `dSumRankNorm` | QUALITY_RANK | − | 53.18 | 87.81 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.57 | 1.14 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **597/627** shipped+graded rows (95%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 97 | 49-46-2 | 51.6% [42–61] | -4.8% | -18.4u | -0.51 ✗ noise |
| LOCK | 104 | 48-56-0 | 46.2% [37–56] | -13.0% | -21.1u | -1.37 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 73 | 37-34-2 | 52.1% [41–63] | +0.4% | +6.2u | 0.03 ✗ noise |
| FADE | 146 | 68-75-3 | 47.6% [40–56] | -3.1% | -29.7u | -0.35 ✗ noise |
...
r(WIN) = **-0.018** ✗ · r(ROI) = **-0.045** ✗ · Spearman ρ(ROI) = **-0.050**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 135 | 69-64-2 | 51.9% [43–60] | +5.1% | -15.2u | 0.55 ✗ noise |
| z ∈ [−1, 0) | 200 | 108-89-3 | 54.8% [48–62] | +3.2% | +27.7u | 0.48 ✗ noise |
| z ∈ [0, +1) | 173 | 83-89-1 | 48.3% [41–56] | -8.7% | -39.3u | -1.18 ✗ noise |
| z ≥ +1 (very positive) | 89 | 42-45-2 | 48.3% [38–59] | -10.5% | -9.9u | -1.05 ✗ noise |
...
| z ∈ [0, +1) | 563 | 287-268-8 | 51.7% [48–56] | -1.7% | -33.6u | -0.43 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.063** ✗ · r(ROI) = **-0.070** ~ p<.10 · Spearman ρ(ROI) = **-0.075**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 113 | 63-49-1 | 56.3% [47–65] | +4.3% | -2.6u | 0.49 ✗ noise |
| z ∈ [−1, 0) | 214 | 116-96-2 | 54.7% [48–61] | +7.1% | +10.4u | 1.01 ✗ noise |
| z ∈ [0, +1) | 201 | 93-104-4 | 47.2% [40–54] | -9.1% | -38.2u | -1.33 ✗ noise |
| z ≥ +1 (very positive) | 69 | 30-38-1 | 44.1% [33–56] | -18.4% | -6.2u | -1.65 ~ p<.10 |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.063 ✗ | -0.070 ~ p<.10 | -0.075 |
| 2 | `dCount` | COUNT | -0.018 ✗ | -0.045 ✗ | -0.050 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | -0.057 | 0.817 | 49.2% | dominant |
| 2 | `dSumRankNorm` | -0.129 | 0.803 | 48.4% | dominant |
| 3 | `dWinnerCtPreA` | -0.028 | 0.028 | 1.7% | silent (<0.2) |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.030 | +0.732 ⚠ | +0.030 |
| `dHcSizeRatio` | +0.030 | 1.000 | +0.004 | +1.000 ⚠ |
| `dSumRankNorm` | +0.732 ⚠ | +0.004 | 1.000 | +0.004 |
| `dWinnerCtPreA` | +0.030 | +1.000 ⚠ | +0.004 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **-0.014**. At AGS ≥ +0.12 fires N=273, WR=51.3%, ROI=-4.2%. At AGS ≥ +null fires N=362, WR=52.1%, ROI=-2.7%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-273 ROI (matched cohort) | Top-273 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.075 | +0.060 | WR=57%, ROI=+8.7% | -12.9pp | N=303, WR=56%, ROI=+6.6% |
| `dHcSizeRatio` | +0.041 | +0.026 | WR=54%, ROI=+1.9% | -6.1pp | N=286, WR=55%, ROI=+3.4% |
| `dSumRankNorm` | -0.052 | +0.037 | WR=48%, ROI=-10.0% | +5.8pp | N=270, WR=48%, ROI=-9.0% |
| `dWinnerCtPreA` | +0.043 | +0.028 | WR=54%, ROI=+1.9% | -6.1pp | N=275, WR=55%, ROI=+2.5% |
...
|---|---|---|---|---|
| 1 | `dHcSizeRatio` | +0.026 | -6.1pp | redundant — other features cover it |
| 2 | `dWinnerCtPreA` | +0.028 | -6.1pp | redundant — other features cover it |
| 3 | `dSumRankNorm` | +0.037 | +5.8pp | redundant — other features cover it |
| 4 | `dCount` | +0.060 | -12.9pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.144 | 0.144 | negative ↓ |
| 2 | `dCount` | COUNT | +0.042 | 0.042 | flat ≈ 0 |
| 3 | `dWinnerCtPreA` | QUALITY_TRACK | +0.034 | 0.034 | flat ≈ 0 |
| 4 | `dHcSizeRatio` | INTENSITY_HC | +0.013 | 0.013 | flat ≈ 0 |

Intercept b = +0.008 · Final log-loss = 0.6901 · N = 597.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 597 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/597 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 201 | 95-106-0 | 47.3% [40–54] | -12.9% | -62.7u | -1.95 ~ p<.10 |
| 4.5★ | 93 | 58-33-2 | 63.7% [53–73] | +21.2% | +38.7u | 2.12 ✓ p<.05 |
| 4.0★ | 128 | 58-68-2 | 46.0% [38–55] | -10.6% | -13.9u | -1.21 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 83 | 44-36-3 | 55.0% [44–65] | +7.0% | -1.3u | 0.65 ✗ noise |
| 2.5★ | 84 | 42-41-1 | 50.6% [40–61] | -2.8% | -7.1u | -0.27 ✗ noise |

### §5b. Stars × Δw stratified — does the star tier hold up within each Δw cohort?

| Δw cohort | 5★ | 4.5★ | 4★ | 3.5★ | 3★ | 2.5★ |
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 31/61%/+9% | 26/62%/+19% | 29/36%/-29% | 6/33%/-26% | 31/38%/-28% | 37/50%/-4% |
| Δw = +1 | 38/50%/-8% | 39/62%/+14% | 60/47%/-8% | 28/54%/+4% | 30/67%/+29% | 29/55%/+2% |
| Δw = +2 | 63/44%/-15% | 14/64%/+20% | 32/53%/+4% | — | 13/58%/+15% | 8/38%/-16% |
| Δw ≥ +3 | 67/40%/-26% | 11/73%/+53% | 7/43%/-21% | 3/67%/+156% | 9/67%/+43% | 8/38%/-21% |
...
| −300/−201 | 23 | 14-9-0 | 60.9% [41–78] | -12.4% | +10.6u | -0.83 ✗ noise |
| −200/−151 | 54 | 28-26-0 | 51.9% [39–65] | -17.8% | -12.7u | -1.63 ✗ noise |
| −150/−101 | 382 | 194-183-5 | 51.5% [46–56] | -3.3% | -18.2u | -0.68 ✗ noise |
| −100/+100 | 8 | 4-4-0 | 50.0% [22–78] | +0.0% | -0.8u | 0.00 ✗ noise |
| +101/+150 | 126 | 57-66-3 | 46.3% [38–55] | +1.2% | -34.6u | 0.12 ✗ noise |
| +151/+200 | 15 | 8-7-0 | 53.3% [30–75] | +42.8% | +7.8u | 1.20 ✗ noise |
...
| −300/−201 | -22% (11) | +47% (2) | +9% (4) | -29% (6) |
| −200/−151 | -44% (17) | +20% (17) | +24% (9) | -84% (10) |
| −150/−101 | -3% (94) | +1% (149) | -16% (77) | -0% (59) |
| −100/+100 | -100% (2) | +50% (4) | -100% (1) | +100% (1) |
| +101/+150 | +7% (31) | -2% (44) | +10% (32) | -16% (19) |
| +151/+200 | +26% (2) | +60% (5) | +65% (5) | +32% (2) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 339 | 168-170-1 | 49.7% [44–55] | -4.1% | -48.8u | -0.74 ✗ noise |
| SPREAD | 96 | 46-48-2 | 48.9% [39–59] | -9.3% | +2.4u | -0.97 ✗ noise |
| TOTAL | 192 | 102-85-5 | 54.5% [47–62] | +5.1% | +3.9u | 0.75 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=88 · 46% · -14% | N=114 · 56% · +6% | N=68 · 51% · +2% | N=66 · 41% · -15% |
| SPREAD | N=25 · 33% · -35% | N=36 · 54% · -0% | N=18 · 67% · +19% | N=16 · 38% · -27% |
| TOTAL | N=48 · 63% · +21% | N=75 · 53% · +3% | N=44 · 40% · -22% | N=23 · 70% · +34% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 449 | 233-211-5 | 52.5% [48–57] | -0.4% | -6.3u | -0.09 ✗ noise |
| NBA | 130 | 60-69-1 | 46.5% [38–55] | -7.4% | -15.3u | -0.78 ✗ noise |
| NHL | 48 | 23-23-2 | 50.0% [36–64] | -3.0% | -20.8u | -0.21 ✗ noise |

### §8b. Sport × Δw cohort

| Sport | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| MLB | N=123 · 53% · -1% | N=182 · 55% · +4% | N=94 · 51% · -1% | N=49 · 45% · -14% |
| NBA | N=30 · 31% · -43% | N=29 · 48% · -6% | N=23 · 48% · -5% | N=43 · 53% · +14% |
| NHL | N=8 · 63% · +33% | N=14 · 69% · +25% | N=13 · 42% · -18% | N=13 · 31% · -40% |
...
|---|---|---|
| **sharps3Plus** | 249 · 45% · -11.2% · -1.72 ~ p<.10 | 377 · 55% · +3.6% · 0.73 ✗ noise |
| **plusEV** | 68 · 47% · -5.3% · -0.38 ✗ noise | 558 · 51% · -1.9% · -0.47 ✗ noise |
| **pinnacleConfirms** | 147 · 51% · -1.7% · -0.20 ✗ noise | 316 · 51% · -2.4% · -0.43 ✗ noise |
| **invested10kPlus** | 303 · 51% · -2.0% · -0.35 ✗ noise | 160 · 51% · -2.5% · -0.32 ✗ noise |
| **lineMovingWith** | 286 · 54% · +2.5% · 0.42 ✗ noise | 340 · 49% · -6.3% · -1.19 ✗ noise |
| **predMarketAligns** | 155 · 51% · -2.7% · -0.33 ✗ noise | 308 · 51% · -1.9% · -0.34 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 176 | 94-82-0 | 53.4% [46–61] | +2.8% | +14.4u | 0.38 ✗ noise |
| 1 | 134 | 65-64-5 | 50.4% [42–59] | -3.8% | -23.9u | -0.47 ✗ noise |
| 2 | 143 | 73-67-3 | 52.1% [44–60] | +0.0% | +1.2u | 0.00 ✗ noise |
| 3 | 55 | 26-29-0 | 47.3% [35–60] | -10.7% | -12.6u | -0.81 ✗ noise |
| 4 | 53 | 26-27-0 | 49.1% [36–62] | -10.5% | -10.9u | -0.80 ✗ noise |
| 5 | 52 | 26-26-0 | 50.0% [37–63] | -7.0% | -13.3u | -0.52 ✗ noise |
| 6 | 14 | 6-8-0 | 42.9% [21–67] | +17.4% | +2.5u | 0.39 ✗ noise |

### §9c. Regime

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLEAR_MOVE | 109 | 59-49-1 | 54.6% [45–64] | +2.4% | -0.3u | 0.26 ✗ noise |
| NEAR_START | 247 | 116-126-5 | 47.9% [42–54] | -6.5% | -58.2u | -1.00 ✗ noise |
| NO_MOVE | 20 | 10-10-0 | 50.0% [30–70] | -7.9% | +4.4u | -0.37 ✗ noise |
| PREGAME | 117 | 66-51-0 | 56.4% [47–65] | +8.2% | +25.3u | 0.92 ✗ noise |
| SMALL_MOVE | 132 | 63-67-2 | 48.5% [40–57] | -7.4% | -16.1u | -0.87 ✗ noise |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 344 | 174-167-3 | 51.0% [46–56] | -4.0% | -56.8u | -0.79 ✗ noise |
| STRONG | 97 | 48-47-2 | 50.5% [41–60] | -0.7% | -1.9u | -0.07 ✗ noise |
| LEAN | 178 | 90-85-3 | 51.4% [44–59] | +0.6% | +14.8u | 0.08 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.103 ✓ p<.05 | -0.082 ✓ p<.05 | -0.065 | -2.05 |
| totalInvested | -0.067 ~ p<.10 | -0.080 ✓ p<.05 | -0.033 | -2.01 |
| evEdge | 0.088 ✓ p<.05 | 0.114 ✓ p<.01 | 0.052 | 2.88 |
| moneyPct | 0.033 ✗ | 0.003 ✗ | -0.011 | 0.09 |
| walletPct | 0.031 ✗ | 0.016 ✗ | 0.010 | 0.40 |
| criteriaMet | -0.030 ✗ | -0.024 ✗ | -0.054 | -0.60 |
| maxContribFor | -0.018 ✗ | -0.005 ✗ | 0.018 | -0.13 |
| meanBaseFor | 0.009 ✗ | 0.033 ✗ | 0.059 | 0.83 |
...
Sample with CLV: **614** picks. Mean CLV = **-0.0043**.
t-statistic vs zero: -3.50 → ✓ p<.01 · 95% CI [-0.0067, -0.0019]

Bucketed CLV vs flat PnL:

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLV ≤ −2% | 68 | 33-34-1 | 49.3% [38–61] | -10.7% | -2.1u | -0.95 ✗ noise |
| CLV (−2%, 0] | 361 | 180-175-6 | 50.7% [46–56] | -3.4% | -36.5u | -0.67 ✗ noise |
| CLV (0, +2%] | 158 | 84-74-0 | 53.2% [45–61] | +6.5% | -2.8u | 0.77 ✗ noise |
| CLV > +2% | 27 | 13-13-1 | 50.0% [32–68] | -6.2% | +2.8u | -0.33 ✗ noise |

ρ(CLV, flat ROI) = 0.087 ✓ p<.05
...
Trained on N=493 (with all features non-null). Intercept β₀ = 0.078.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | pw.ΔAvgRoi | +0.343 | ↑ helps |
| 2 | sharpCount | -0.291 | ↓ hurts |
| 3 | evEdge | +0.211 | ↑ helps |
| 4 | pw.Δcount | +0.173 | ↑ helps |
| 5 | pw.ΔFlatPnl | +0.164 | ↑ helps |
| 6 | log(impliedProb) | +0.139 | ↑ helps |
| 7 | peak.stars | -0.099 | ↓ hurts |
| 8 | pw.ΔWlNet | +0.093 | ↑ helps |
| 9 | vault.star | +0.079 | ↑ helps |
| 10 | odds (American) | -0.078 | ↓ hurts |
| 11 | HC margin | +0.064 | ↑ helps |
| 12 | Δw | -0.041 | ≈ flat |
| 13 | log10(invested) | +0.038 | ≈ flat |
| 14 | criteriaMet | -0.028 | ≈ flat |
| 15 | pw.ΔTopQShare | -0.020 | ≈ flat |
| 16 | moneyPct | -0.010 | ≈ flat |
| 17 | walletPct | +0.009 | ≈ flat |
| 18 | Δw + HC | -0.002 | ≈ flat |
...
| Tier-1b HC = +1 (post-cutover) | 155 | 86-69 | 55.5% | 55.2% | -110 | 2.91% bankroll | 2.13u | ~ in range — 2.91u |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 86 | 39-46 | 45.9% | 46.3% | -110 | — (mute) | 2.01u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 105 | 49-56 | 46.7% | 47.0% | -110 | — (mute) | 2.44u | **MUTE** (negative EV at posterior) |
| Stale Δw = 0 | 133 | 69-61 | 53.1% | 52.9% | -110 | 0.50% bankroll | 1.83u | **OVER-SIZED** — reduce to 0.50u |
| Stale Δw ≤ −1 | 28 | 8-19 | 29.6% | 35.1% | -120 | — (mute) | 1.23u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.119  (annualized × √252 ≈ -1.89)
...
| 2026-04-20 | NHL | ML | away | 4.0 | 1.50 | +146 | 0 | — | — | 1 | 3 | -1.00 | L | -1.5u |
...
| 2026-04-21 | NHL | ML | away | 3.0 | 0.75 | +145 | 3 | — | — | -2 | -7 | -0.90 | W | +1.1u |
| 2026-04-21 | NHL | ML | home | 2.5 | 1.00 | -184 | 1 | — | — | 0 | -8 | -1.60 | W | +0.5u |
...
| 2026-04-22 | NHL | ML | home | 3.0 | 0.50 | -188 | 1 | — | — | -2 | -10 | -1.80 | L | -0.5u |
...
| 2026-04-23 | NHL | ML | home | 2.5 | 1.35 | +140 | 1 | — | — | -2 | -6 | 1.40 | L | -1.4u |
...
| 2026-04-24 | NHL | ML | home | 5.0 | 3.00 | +102 | 2 | — | — | 1 | 7 | -1.70 | W | +2.9u |
...
| 2026-04-26 | MLB | ML | away | 3.5 | 0.75 | +108 | 1 | — | — | 2 | 0 | 0.50 | L | -0.8u |
| 2026-04-26 | MLB | TOTAL | over | 3.5 | 0.50 | -116 | 1 | — | — | -1 | 19 | 0.00 | L | -0.5u |
| 2026-04-26 | MLB | ML | home | 3.5 | 0.75 | -110 | 1 | — | — | 2 | 19 | -1.40 | L | -0.8u |
...
| 2026-04-29 | NHL | ML | away | 5.0 | 2.00 | +145 | 2 | — | — | 2 | 10 | -0.30 | W | +2.8u |
...
| 2026-05-01 | NHL | ML | away | 4.0 | 0.50 | -114 | 2 | 0 | 2 | 4 | 11 | -0.70 | W | +0.0u |
...
| 2026-05-06 | NHL | ML | away | 3.5 | 1.13 | +141 | 1 | 1 | 2 | 0 | 7 | — | W | +1.6u |
...
| 2026-05-10 | NHL | ML | away | 4.5 | 4.50 | +108 | 2 | 2 | 4 | 2 | 8 | -0.70 | L | -4.5u |
...
| 2026-05-11 | NHL | TOTAL | under | 4.5 | 1.27 | -110 | 2 | 0 | 2 | 2 | 15 | 0.00 | L | -1.3u |
...
| 2026-05-13 | MLB | TOTAL | under | 4.0 | 0.96 | -110 | 1 | 1 | 2 | 2 | -23 | 0.00 | W | +0.9u |
| 2026-05-13 | MLB | TOTAL | under | 5.0 | 3.50 | -110 | 4 | 2 | 6 | 4 | -26 | 0.00 | L | -3.5u |
...
| 2026-05-15 | MLB | ML | home | 4.0 | 2.50 | +128 | 0 | 0 | 0 | 0 | 4 | 0.00 | L | -2.5u |
...
| 2026-05-16 | MLB | ML | away | 5.0 | 4.50 | +124 | 3 | 1 | 4 | 4 | -25 | -1.30 | W | +1.4u |
...
| 2026-05-16 | MLB | ML | away | 2.5 | 0.50 | -102 | 1 | 0 | 1 | 1 | -49 | 0.00 | W | +0.5u |
...
| 2026-05-17 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 1 | 1 | -1 | 4 | 0.00 | W | +0.3u |
...
| 2026-05-18 | MLB | ML | home | 3.0 | 1.25 | +132 | 2 | 0 | 2 | 2 | -4 | 0.40 | W | +1.6u |
...
| 2026-05-21 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 0 | 0 | 2 | -8 | 0.00 | W | +0.3u |
...
| 2026-05-23 | MLB | ML | home | 2.5 | 0.50 | -181 | 1 | 0 | 1 | 2 | 22 | -1.70 | W | +0.3u |
| 2026-05-23 | MLB | ML | away | 2.5 | 2.75 | +109 | 2 | 0 | 2 | 2 | -27 | -0.50 | L | -2.8u |
...
| 2026-05-23 | MLB | SPREAD | home | 3.0 | 0.75 | -163 | 0 | 0 | 0 | 1 | -4 | -0.90 | L | -0.8u |
| 2026-05-23 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 2 | 1 | 3 | 1 | -19 | 0.00 | L | -0.8u |
| 2026-05-23 | MLB | SPREAD | away | 4.5 | 1.50 | -209 | 0 | 0 | 0 | 2 | -23 | 29.00 | W | +2.5u |
| 2026-05-23 | MLB | TOTAL | under | 3.0 | 0.75 | +102 | 0 | 0 | 0 | 1 | -4 | 0.00 | W | +0.8u |
| 2026-05-23 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 1 | -19 | 0.00 | W | +0.7u |
| 2026-05-23 | MLB | ML | away | 2.5 | 1.25 | -111 | -1 | 1 | 0 | 1 | 8 | 0.40 | L | -1.3u |
| 2026-05-23 | MLB | SPREAD | home | 3.0 | 0.75 | -135 | 0 | 0 | 0 | 1 | -4 | 0.40 | W | +0.6u |
| 2026-05-23 | MLB | TOTAL | under | 2.5 | 0.30 | +108 | 0 | 0 | 0 | 0 | -11 | 0.00 | P | +0.0u |
| 2026-05-23 | MLB | ML | home | 4.0 | 2.50 | +118 | 1 | 0 | 1 | 1 | -8 | 1.10 | W | +2.9u |
| 2026-05-23 | MLB | ML | away | 3.0 | 1.25 | +166 | 2 | 1 | 3 | 2 | -24 | -0.30 | W | +1.8u |
...
| 2026-05-23 | NHL | ML | home | 5.0 | 5.00 | -205 | 8 | 0 | 8 | 4 | 7 | -0.70 | W | +2.4u |
...
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 1 | 0 | 1 | 1 | 4 | 0.00 | L | -1.6u |
| 2026-05-24 | MLB | ML | home | 2.5 | 0.50 | +144 | 1 | 1 | 2 | -1 | -54 | 0.00 | L | -0.5u |
| 2026-05-24 | MLB | SPREAD | home | 4.0 | 1.65 | -110 | 2 | 1 | 3 | 2 | -23 | -1.30 | L | -1.6u |
| 2026-05-24 | MLB | ML | home | 3.0 | 1.25 | -107 | 1 | 0 | 1 | 1 | 7 | 0.00 | W | +1.2u |
| 2026-05-24 | MLB | TOTAL | under | 2.5 | 1.00 | -101 | 1 | 1 | 2 | 1 | -4 | 0.00 | W | +0.0u |
| 2026-05-24 | MLB | TOTAL | under | 2.5 | 0.30 | -104 | 0 | 0 | 0 | 1 | 14 | 0.00 | W | +0.3u |
| 2026-05-24 | MLB | ML | away | 4.0 | 1.25 | +148 | 2 | 2 | 4 | 0 | -19 | -1.40 | W | +1.9u |
| 2026-05-24 | MLB | ML | away | 3.0 | 1.25 | -122 | -1 | 1 | 0 | 0 | -38 | -1.10 | L | -1.3u |
| 2026-05-24 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 2 | -10 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | SPREAD | home | 3.0 | 0.75 | +134 | 1 | 0 | 1 | 1 | -4 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 0 | -28 | 0.00 | W | +0.7u |
...
| 2026-05-25 | MLB | TOTAL | over | 5.0 | 3.00 | -110 | 3 | 0 | 3 | 3 | 7 | 0.00 | W | +2.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 3.75 | -108 | 0 | 0 | 0 | 3 | -46 | -1.70 | L | -3.8u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -124 | 2 | 0 | 2 | 2 | -23 | -1.30 | W | +0.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 5.00 | -119 | 2 | -1 | 1 | 4 | -12 | -0.60 | W | +3.1u |
| 2026-05-25 | MLB | ML | away | 2.5 | 2.75 | -113 | 0 | 0 | 0 | 0 | 7 | -1.80 | W | +1.1u |
| 2026-05-25 | MLB | ML | home | 4.0 | 5.00 | -209 | -1 | 0 | -1 | 3 | -1 | -0.80 | W | +2.3u |
| 2026-05-25 | MLB | TOTAL | under | 5.0 | 0.75 | -101 | 2 | 1 | 3 | 1 | 5 | 0.00 | W | +0.7u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -178 | 1 | 0 | 1 | 2 | -23 | -1.60 | W | +0.9u |
...
| 2026-05-26 | MLB | TOTAL | over | 5.0 | 1.65 | -110 | 2 | 0 | 2 | 2 | -23 | 0.00 | W | +1.5u |
| 2026-05-26 | MLB | ML | away | 5.0 | 1.50 | +200 | 2 | 0 | 2 | 2 | -22 | -1.00 | L | -1.5u |
| 2026-05-26 | MLB | SPREAD | away | 5.0 | 1.00 | -101 | 2 | 1 | 3 | 2 | -23 | 0.50 | L | -1.0u |
| 2026-05-26 | MLB | ML | away | 2.5 | 1.25 | +113 | 0 | 0 | 0 | 0 | 30 | -1.50 | W | +1.4u |
| 2026-05-26 | MLB | ML | home | 2.5 | 1.25 | -130 | 1 | 0 | 1 | 0 | 30 | -1.30 | W | +1.0u |
| 2026-05-26 | MLB | ML | away | 5.0 | 5.00 | -200 | 1 | 0 | 1 | 2 | 22 | -0.60 | W | +1.9u |
...
| 2026-05-26 | MLB | ML | home | 5.0 | 5.00 | -105 | 2 | 1 | 3 | 2 | 22 | -2.00 | W | +3.6u |
| 2026-05-26 | MLB | ML | away | 5.0 | 2.50 | +116 | 1 | 0 | 1 | 2 | 22 | -1.00 | W | +2.9u |
...
| 2026-05-27 | MLB | SPREAD | away | 5.0 | 2.50 | +141 | 1 | 1 | 2 | 4 | -20 | 0.80 | L | -2.5u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 1.00 | +105 | 2 | 0 | 2 | 2 | -23 | 0.00 | L | -1.0u |
...
| 2026-05-27 | MLB | SPREAD | away | 4.0 | 0.75 | -163 | 0 | 0 | 0 | 1 | -4 | 0.40 | W | +0.5u |
| 2026-05-27 | MLB | TOTAL | under | 5.0 | 1.00 | -112 | 3 | 1 | 4 | 3 | -20 | 0.00 | W | +0.0u |
| 2026-05-27 | MLB | ML | away | 4.0 | 1.00 | -108 | 1 | -1 | 0 | 0 | 38 | -0.90 | L | -1.0u |
| 2026-05-27 | MLB | ML | home | 5.0 | 0.50 | +132 | 2 | 0 | 2 | 2 | 4 | -0.50 | L | -0.5u |
...
| 2026-05-27 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 2 | 5 | 3 | -21 | -0.30 | L | -2.5u |
| 2026-05-27 | MLB | SPREAD | away | 4.5 | 1.65 | -145 | 1 | 1 | 2 | 1 | -4 | -0.30 | W | +1.1u |
| 2026-05-27 | MLB | ML | away | 5.0 | 5.00 | -126 | 2 | 0 | 2 | 2 | -7 | -4.10 | L | -5.0u |
...
| 2026-05-28 | MLB | TOTAL | over | 5.0 | 3.00 | +101 | 3 | -1 | 2 | 3 | 26 | 0.00 | W | +2.5u |
| 2026-05-28 | MLB | ML | home | 5.0 | 1.25 | -140 | 2 | 0 | 2 | 2 | -20 | -0.50 | L | -1.3u |
| 2026-05-28 | MLB | TOTAL | under | 5.0 | 1.00 | -107 | 1 | 0 | 1 | 1 | 38 | 0.00 | W | +0.0u |
| 2026-05-28 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 1 | 4 | 2 | -72 | -0.60 | L | -2.5u |
| 2026-05-28 | MLB | TOTAL | over | 2.5 | 1.65 | -108 | 2 | 0 | 2 | 2 | -23 | 0.00 | L | -1.6u |
| 2026-05-28 | NBA | SPREAD | away | 5.0 | 1.00 | -110 | 1 | 2 | 3 | 0 | -2 | -0.90 | L | -1.0u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.50 | +118 | 5 | 1 | 6 | 5 | 14 | -0.90 | L | -2.5u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 0.75 | -135 | 2 | 0 | 2 | 1 | -21 | 1.00 | L | -0.8u |
| 2026-05-29 | MLB | ML | home | 5.0 | 3.75 | -124 | 2 | 1 | 3 | 3 | 3 | -1.00 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 1.65 | -106 | 2 | 0 | 2 | 3 | 3 | 0.00 | L | -1.6u |
| 2026-05-29 | MLB | ML | home | 4.0 | 2.50 | +120 | 1 | 0 | 1 | 1 | -3 | 0.40 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 2.25 | -112 | 2 | 0 | 2 | 3 | 30 | 0.00 | W | +2.0u |
| 2026-05-29 | MLB | SPREAD | away | 4.0 | 0.75 | +150 | 0 | 0 | 0 | 1 | -4 | -0.50 | L | -0.8u |
| 2026-05-29 | MLB | ML | away | 5.0 | 2.50 | +140 | 2 | 1 | 3 | 1 | -21 | 1.00 | L | -2.5u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 1.65 | -103 | 0 | 0 | 0 | 2 | -23 | 0.00 | W | +1.6u |
| 2026-05-29 | MLB | ML | away | 4.5 | 1.25 | -142 | 0 | 1 | 1 | -1 | 21 | -1.20 | W | +0.3u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 1.65 | -135 | 1 | 0 | 1 | 2 | -23 | 0.40 | W | +1.2u |
| 2026-05-29 | MLB | ML | home | 4.5 | 1.25 | -134 | 1 | 0 | 1 | 0 | -3 | -1.70 | W | +2.8u |
| 2026-05-29 | MLB | SPREAD | away | 5.0 | 2.25 | -184 | 0 | 0 | 0 | 2 | -1 | -1.00 | W | +1.2u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 0.75 | -109 | 1 | 0 | 1 | 2 | 3 | 0.00 | W | +0.7u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.75 | -106 | 2 | 1 | 3 | 2 | 37 | 0.70 | L | -2.8u |
| 2026-05-29 | MLB | SPREAD | home | 4.0 | 1.65 | -175 | 0 | 0 | 0 | 2 | -23 | -0.80 | L | -1.6u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 0.30 | +105 | 2 | 1 | 3 | 1 | 11 | 0.00 | W | +0.3u |
| 2026-05-29 | MLB | ML | home | 4.5 | 3.75 | -122 | 0 | 1 | 1 | 1 | 0 | -0.60 | L | -3.8u |
| 2026-05-29 | MLB | TOTAL | over | 3.0 | 1.00 | -108 | 0 | 0 | 0 | 1 | -4 | 0.00 | W | +1.5u |
| 2026-05-29 | NHL | ML | away | 5.0 | 1.00 | +205 | 3 | 0 | 3 | 0 | -2 | -0.60 | L | -1.0u |
| 2026-05-29 | NHL | SPREAD | away | 5.0 | 3.00 | -118 | 3 | 1 | 4 | 1 | -5 | 0.00 | L | -3.0u |
| 2026-05-29 | NHL | TOTAL | under | 5.0 | 2.25 | -106 | 2 | 0 | 2 | 2 | -2 | 0.00 | L | -2.3u |
| 2026-05-30 | MLB | ML | away | 5.0 | 2.50 | +132 | 2 | 1 | 3 | 2 | -25 | 0.00 | L | -2.5u |
| 2026-05-30 | MLB | ML | away | 4.5 | 2.75 | -125 | 1 | 2 | 3 | 1 | 7 | -0.60 | W | +2.3u |
| 2026-05-30 | MLB | ML | home | 5.0 | 5.00 | -130 | 1 | 0 | 1 | 2 | -14 | -1.20 | L | -5.0u |
| 2026-05-30 | MLB | ML | away | 4.0 | 3.75 | -132 | 1 | 1 | 2 | 1 | 54 | -1.00 | W | +2.9u |
| 2026-05-30 | MLB | SPREAD | home | 3.0 | 0.75 | -143 | 0 | 1 | 1 | 0 | -2 | -1.40 | L | -0.8u |
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -118 | 1 | 1 | 2 | 1 | -24 | -1.30 | L | -3.8u |
| 2026-05-30 | MLB | SPREAD | away | 4.0 | 1.00 | +152 | 1 | 0 | 1 | 1 | -4 | 0.20 | L | -1.0u |
| 2026-05-30 | MLB | ML | home | 5.0 | 5.00 | -120 | 0 | 0 | 0 | 3 | -46 | -1.10 | W | +4.2u |
| 2026-05-30 | MLB | TOTAL | over | 4.5 | 0.75 | +100 | 1 | 1 | 2 | 1 | 2 | 0.00 | W | +0.8u |
| 2026-05-30 | MLB | ML | home | 4.0 | 2.75 | -130 | 0 | 1 | 1 | 0 | 30 | -1.60 | W | +0.4u |
| 2026-05-30 | MLB | TOTAL | over | 4.0 | 2.25 | -116 | 2 | 0 | 2 | 2 | 5 | 0.00 | W | +1.9u |
| 2026-05-30 | MLB | TOTAL | under | 4.0 | 1.65 | -107 | 1 | 0 | 1 | 1 | 9 | 0.00 | L | -1.6u |
| 2026-05-30 | MLB | ML | home | 4.0 | 2.50 | +129 | 1 | 0 | 1 | 1 | -19 | -0.90 | W | +0.7u |
| 2026-05-30 | MLB | SPREAD | home | 5.0 | 1.65 | -120 | 2 | 1 | 3 | 2 | -23 | -0.60 | W | +1.4u |
| 2026-05-30 | MLB | ML | away | 5.0 | 2.50 | +108 | 1 | 0 | 1 | 3 | -46 | -0.90 | W | +2.7u |
| 2026-05-30 | MLB | ML | home | 4.0 | 0.50 | +110 | 1 | 0 | 1 | 1 | -19 | -0.20 | W | +0.6u |
| 2026-05-30 | MLB | ML | home | 5.0 | 1.25 | -102 | 2 | 0 | 2 | 2 | 7 | -0.70 | W | +1.2u |
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -122 | 1 | 1 | 2 | 2 | -27 | -0.20 | L | -3.8u |
| 2026-05-30 | MLB | TOTAL | under | 3.0 | 0.75 | -108 | 0 | 0 | 0 | 1 | -4 | 0.00 | L | -0.8u |
| 2026-05-30 | NBA | ML | home | 5.0 | 1.00 | -154 | 3 | 3 | 6 | 0 | 5 | 0.00 | L | -1.0u |
| 2026-05-30 | NBA | TOTAL | under | 5.0 | 2.50 | -109 | 5 | 0 | 5 | 6 | 6 | 0.00 | L | -2.5u |
| 2026-05-31 | MLB | ML | away | 3.0 | 2.75 | -125 | -2 | 0 | -2 | 1 | -21 | -1.20 | L | -2.8u |
| 2026-05-31 | MLB | TOTAL | under | 5.0 | 1.65 | -114 | 2 | 0 | 2 | 3 | -16 | 0.00 | L | -1.6u |
| 2026-05-31 | MLB | ML | home | 2.5 | 2.75 | -115 | 1 | 1 | 2 | 1 | 19 | 0.00 | W | +2.4u |
| 2026-05-31 | MLB | ML | away | 5.0 | 1.00 | +115 | -1 | 0 | -1 | 2 | -27 | -0.60 | L | -1.0u |
| 2026-05-31 | MLB | SPREAD | away | 5.0 | 1.00 | -117 | 3 | 1 | 4 | 3 | -19 | -0.20 | L | -1.0u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -164 | 0 | 1 | 1 | 2 | -27 | -1.20 | W | +2.3u |
| 2026-05-31 | MLB | ML | away | 3.0 | 1.25 | -184 | 0 | 0 | 0 | 0 | -19 | -1.70 | W | +0.7u |
| 2026-05-31 | MLB | ML | home | 2.5 | 1.25 | -232 | 0 | 0 | 0 | 1 | 25 | -0.50 | W | +0.5u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -102 | 0 | 1 | 1 | 2 | -59 | 0.20 | W | +4.9u |
| 2026-05-31 | MLB | TOTAL | over | 4.0 | 1.00 | +101 | 2 | 1 | 3 | 2 | -10 | 0.00 | L | -1.0u |
| 2026-05-31 | MLB | ML | away | 4.5 | 2.50 | +110 | 0 | 0 | 0 | 0 | -19 | -1.10 | L | -2.5u |
| 2026-06-01 | MLB | ML | home | 4.5 | 3.00 | -155 | 3 | 2 | 5 | 3 | 22 | -1.00 | W | +2.1u |
| 2026-06-01 | MLB | ML | away | 4.0 | 1.00 | +135 | 2 | 2 | 4 | 3 | 42 | -0.20 | W | +1.4u |
| 2026-06-01 | MLB | ML | away | 5.0 | 2.50 | +160 | 2 | -1 | 1 | 2 | 44 | -1.30 | W | +2.7u |
| 2026-06-01 | MLB | TOTAL | under | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 2 | -36 | 0.00 | L | -1.0u |
| 2026-06-01 | MLB | ML | home | 3.0 | 0.50 | -142 | -1 | 0 | -1 | -1 | 29 | -0.40 | L | -0.5u |
| 2026-06-01 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 11 | 0.00 | L | -5.0u |
| 2026-06-01 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 2 | -31 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | ML | home | 2.5 | 0.25 | -215 | -1 | 0 | -1 | 0 | -5 | -1.40 | L | -0.3u |
| 2026-06-02 | MLB | TOTAL | under | 4.0 | 1.00 | -117 | 1 | 0 | 1 | 0 | 11 | 0.00 | L | -1.0u |
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +130 | 2 | 0 | 2 | 0 | 69 | -0.60 | W | +3.1u |
| 2026-06-02 | MLB | ML | away | 3.0 | 0.50 | +100 | 1 | 0 | 1 | 2 | 22 | -1.20 | W | +0.5u |
...
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +134 | -1 | -1 | -2 | -1 | 53 | -1.00 | W | +1.2u |
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +125 | 0 | -1 | -1 | 0 | 60 | 0.40 | W | +1.3u |
| 2026-06-03 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 35 | 0.00 | L | -3.0u |
| 2026-06-03 | MLB | ML | home | 4.5 | 1.50 | +167 | 0 | 0 | 0 | -1 | 27 | -0.40 | L | -1.5u |
| 2026-06-03 | MLB | SPREAD | away | 4.0 | 1.00 | -111 | 1 | 0 | 1 | 0 | 13 | 0.20 | W | +0.8u |
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -103 | 3 | 1 | 4 | 3 | 4 | -1.20 | L | -0.5u |
| 2026-06-03 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 1 | 0.00 | L | -5.0u |
| 2026-06-03 | MLB | ML | away | 3.0 | 0.50 | +119 | 1 | 0 | 1 | 0 | 33 | 0.00 | W | +0.6u |
| 2026-06-03 | MLB | ML | away | 4.5 | 3.00 | -137 | 0 | 0 | 0 | -1 | 49 | -1.50 | L | -3.0u |
| 2026-06-03 | MLB | ML | home | 5.0 | 5.00 | -215 | 0 | 1 | 1 | 0 | 49 | -1.00 | W | +2.3u |
| 2026-06-03 | MLB | TOTAL | over | 2.5 | 0.25 | -110 | 1 | 1 | 2 | 1 | -10 | 0.00 | L | -0.3u |
| 2026-06-03 | MLB | TOTAL | under | 4.5 | 2.50 | -110 | 1 | 0 | 1 | 0 | 11 | 0.00 | W | +2.5u |
| 2026-06-03 | MLB | ML | home | 4.5 | 3.00 | -112 | 0 | 0 | 0 | 1 | 26 | -0.90 | W | +2.7u |
| 2026-06-03 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 1 | 3 | 0.00 | W | +4.5u |
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -139 | 0 | 0 | 0 | -1 | 70 | -1.20 | W | +0.3u |
| 2026-06-03 | MLB | TOTAL | under | 4.5 | 2.50 | -110 | 1 | 0 | 1 | 0 | 11 | 0.00 | L | -2.5u |
| 2026-06-03 | NBA | ML | home | 2.5 | 0.25 | -198 | 3 | 4 | 7 | 5 | 9 | -1.20 | L | -0.3u |
| 2026-06-03 | NBA | SPREAD | away | 2.5 | 0.25 | -104 | 3 | -1 | 2 | 4 | 1 | -1.20 | W | +0.2u |
| 2026-06-04 | MLB | ML | away | 3.0 | 0.50 | +104 | 1 | 0 | 1 | 2 | 19 | 0.00 | W | +0.5u |
...
| 2026-06-04 | MLB | SPREAD | away | 5.0 | 5.00 | -111 | 0 | 0 | 0 | 1 | 9 | 0.00 | L | -5.0u |
| 2026-06-04 | MLB | ML | home | 5.0 | 5.00 | -131 | 1 | 0 | 1 | 1 | 65 | 0.20 | W | +3.5u |
| 2026-06-04 | MLB | ML | away | 2.5 | 0.25 | +105 | 0 | 0 | 0 | 0 | -23 | -1.00 | W | +0.2u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -210 | 1 | 0 | 1 | 2 | 52 | -1.00 | W | +0.5u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -188 | 0 | 0 | 0 | 0 | 30 | -1.10 | L | -1.0u |
| 2026-06-04 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 0 | 23 | 0.00 | W | +2.7u |
| 2026-06-04 | MLB | ML | home | 3.0 | 0.50 | -235 | 4 | 0 | 4 | 4 | 10 | 0.00 | L | -0.5u |
| 2026-06-04 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 0 | 20 | 0.00 | L | -5.0u |
| 2026-06-04 | NHL | ML | home | 2.5 | 0.25 | -160 | -3 | 0 | -3 | 2 | 10 | -0.40 | W | +0.2u |
| 2026-06-05 | MLB | ML | home | 2.5 | 0.25 | -144 | 1 | 1 | 2 | 0 | 32 | -1.20 | L | -0.3u |
| 2026-06-05 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | -1 | 34 | 0.00 | W | +2.8u |
| 2026-06-05 | MLB | ML | away | 3.0 | 0.50 | +128 | 1 | 0 | 1 | 0 | 16 | 0.00 | W | +0.6u |
| 2026-06-05 | MLB | TOTAL | over | 4.0 | 1.00 | -109 | 0 | 0 | 0 | 0 | 11 | 0.00 | P | +0.0u |
| 2026-06-05 | MLB | ML | home | 3.0 | 0.50 | -136 | 1 | 0 | 1 | 2 | 26 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 3 | 0 | 3 | 4 | -7 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | ML | away | 5.0 | 5.00 | -122 | 0 | 1 | 1 | 1 | 35 | -0.80 | L | -5.0u |
| 2026-06-05 | MLB | ML | home | 5.0 | 5.00 | -171 | 0 | 2 | 2 | 3 | 38 | -0.20 | W | +2.7u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -188 | 2 | 0 | 2 | 2 | 22 | -0.90 | W | +0.5u |
| 2026-06-05 | MLB | ML | away | 4.0 | 1.00 | -105 | 1 | 0 | 1 | 1 | 26 | 0.00 | L | -1.0u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -141 | 3 | 2 | 5 | 3 | 12 | 0.30 | W | +0.7u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 2.50 | -110 | 0 | 1 | 1 | -1 | 43 | 0.00 | W | +2.5u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -172 | 1 | 0 | 1 | 1 | 26 | 0.00 | L | -1.0u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 0 | -1 | -1 | 0 | 11 | 0.00 | W | +4.4u |
| 2026-06-05 | MLB | ML | away | 4.5 | 3.00 | -129 | -1 | 1 | 0 | -2 | 42 | -1.10 | W | +2.2u |
| 2026-06-05 | MLB | SPREAD | away | 3.0 | 0.50 | +126 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +0.6u |
| 2026-06-05 | NBA | ML | home | 2.5 | 0.25 | -230 | 2 | 2 | 4 | 4 | 11 | 1.00 | L | -0.3u |
| 2026-06-05 | NBA | SPREAD | home | 2.5 | 0.25 | -106 | 3 | 0 | 3 | 0 | 4 | -0.70 | L | -0.3u |
| 2026-06-06 | MLB | TOTAL | over | 2.5 | 0.25 | -110 | 1 | 0 | 1 | 0 | 30 | 0.00 | W | +0.2u |
| 2026-06-06 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 0 | 3 | 0.00 | W | +2.7u |
| 2026-06-06 | MLB | ML | home | 4.5 | 3.00 | -126 | 0 | 0 | 0 | 0 | 30 | -1.00 | W | +2.4u |
| 2026-06-06 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -10 | 0.00 | W | +2.7u |
| 2026-06-06 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 1 | 1 | -1 | 24 | 0.00 | L | -1.0u |
| 2026-06-06 | MLB | ML | home | 3.0 | 0.50 | -130 | 0 | 0 | 0 | -1 | 10 | -0.90 | L | -0.5u |
| 2026-06-06 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 4 | 0.00 | L | -5.0u |
| 2026-06-06 | MLB | ML | home | 4.5 | 3.00 | -350 | 0 | 1 | 1 | 0 | 51 | -0.90 | W | +0.9u |
| 2026-06-06 | MLB | TOTAL | under | 5.0 | 2.50 | -110 | 0 | 0 | 0 | 0 | 20 | 0.00 | L | -2.5u |
| 2026-06-06 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 3 | 1 | 4 | 3 | -11 | 0.00 | W | +2.8u |
| 2026-06-06 | MLB | ML | home | 5.0 | 5.00 | -123 | 0 | 0 | 0 | 1 | 4 | 0.00 | W | +4.1u |
| 2026-06-06 | MLB | TOTAL | under | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 1 | 0.00 | L | -1.0u |
| 2026-06-06 | MLB | ML | home | 5.0 | 2.50 | +117 | -2 | -1 | -3 | -1 | 14 | 0.00 | L | -2.5u |
| 2026-06-06 | MLB | ML | home | 5.0 | 5.00 | -154 | 2 | 1 | 3 | 0 | 69 | -0.80 | L | -5.0u |
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -130 | 1 | 0 | 1 | 0 | 49 | -0.90 | W | +2.2u |
| 2026-06-07 | MLB | TOTAL | over | 3.0 | 0.50 | -112 | 0 | 0 | 0 | 3 | 1 | 0.00 | L | -0.5u |
| 2026-06-07 | MLB | ML | home | 5.0 | 5.00 | -143 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +3.5u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -10 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -136 | 1 | 0 | 1 | 0 | 49 | 0.00 | W | +0.7u |
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -165 | 2 | 2 | 4 | 3 | -1 | -1.10 | W | +1.8u |
| 2026-06-07 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 1 | 3 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | -107 | 1 | 0 | 1 | -1 | 60 | -0.80 | W | +0.2u |
| 2026-06-07 | MLB | TOTAL | over | 2.5 | 0.25 | -115 | 0 | 0 | 0 | -1 | -5 | 0.00 | W | +0.2u |
| 2026-06-07 | MLB | ML | home | 2.5 | 0.25 | -210 | -1 | 0 | -1 | 1 | 25 | 0.80 | L | -0.3u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -3 | 0.00 | L | -0.5u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | +158 | 1 | 0 | 1 | 3 | 17 | -1.30 | L | -0.5u |
| 2026-06-07 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 7 | 0.00 | W | +0.9u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -105 | 1 | 0 | 1 | 1 | 26 | 0.00 | L | -1.0u |
| 2026-06-07 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 4 | 0.00 | L | -5.0u |
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 3.00 | -152 | 2 | 0 | 2 | 1 | 4 | -0.50 | W | +1.9u |
| 2026-06-07 | MLB | TOTAL | over | 5.0 | 2.25 | -114 | 1 | 1 | 2 | 1 | -10 | 0.00 | L | -2.3u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | +102 | 1 | 0 | 1 | -2 | 27 | -0.20 | W | +0.5u |
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 2.25 | +164 | 1 | 1 | 2 | 1 | -4 | 29.50 | W | +3.7u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | +103 | -1 | 0 | -1 | -2 | -2 | 0.20 | W | +0.3u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | -1 | 0 | 1 | 13 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -102 | 2 | 0 | 2 | 0 | 30 | 0.50 | W | +1.0u |
| 2026-06-07 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 13 | 0.00 | W | +4.8u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | -127 | 0 | 1 | 1 | -1 | 60 | -1.90 | W | +0.4u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -3 | 0.00 | W | +0.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -113 | 6 | 1 | 7 | 5 | 30 | -0.50 | L | -3.0u |
| 2026-06-08 | MLB | ML | home | 4.5 | 3.00 | -129 | 3 | 0 | 3 | 1 | 70 | -0.40 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 0 | 8 | 0.00 | L | -3.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -121 | 1 | 1 | 2 | 1 | 39 | -1.60 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 12 | 0.00 | P | +0.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -146 | 1 | 0 | 1 | 1 | 46 | -0.50 | W | +2.0u |
| 2026-06-08 | MLB | ML | home | 4.0 | 1.00 | -118 | 2 | 0 | 2 | 3 | -21 | -0.40 | L | -1.0u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 2.50 | -116 | -2 | -2 | -4 | -1 | 36 | 0.00 | W | +2.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 1.50 | +151 | 0 | -1 | -1 | 0 | 11 | 0.00 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 5.0 | 2.50 | +101 | 0 | 0 | 0 | 0 | 11 | 0.00 | W | +2.5u |
...
| 2026-06-09 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 20 | 0.00 | W | +4.3u |
| 2026-06-09 | MLB | ML | away | 3.0 | 0.50 | -148 | 1 | 0 | 1 | 3 | 23 | 0.00 | L | -0.5u |
| 2026-06-09 | MLB | ML | away | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 4 | 21 | 0.80 | L | -1.0u |
| 2026-06-09 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 0 | 0 | 1 | 3 | 0.00 | L | -1.0u |
| 2026-06-09 | MLB | ML | away | 4.0 | 1.00 | -143 | 1 | 0 | 1 | 1 | 26 | 0.00 | L | -1.0u |
| 2026-06-09 | MLB | SPREAD | home | 4.5 | 3.00 | -117 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +2.6u |
| 2026-06-09 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 0 | 9 | 0.00 | W | +0.5u |
| 2026-06-09 | MLB | ML | away | 5.0 | 5.00 | -122 | 2 | 1 | 3 | 1 | 4 | 0.00 | W | +4.1u |
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | -120 | 0 | 0 | 0 | 0 | 17 | 0.00 | L | -0.3u |
| 2026-06-09 | MLB | ML | home | 4.0 | 1.00 | -107 | 1 | 0 | 1 | 0 | 25 | -1.30 | L | -1.0u |
| 2026-06-09 | MLB | ML | home | 5.0 | 5.00 | -105 | 1 | -1 | 0 | 1 | 3 | 0.00 | W | +4.8u |
| 2026-06-09 | MLB | ML | away | 4.5 | 2.50 | +115 | 1 | 0 | 1 | 0 | 30 | -0.70 | L | -2.5u |
| 2026-06-09 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 4 | 0.00 | W | +2.7u |
| 2026-06-09 | MLB | ML | away | 3.0 | 0.50 | -116 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +0.4u |
| 2026-06-09 | MLB | ML | home | 5.0 | 2.50 | +100 | 4 | 2 | 6 | 1 | 3 | 0.00 | W | +2.5u |
...
| 2026-06-09 | NHL | SPREAD | away | 4.5 | 1.00 | +215 | 0 | 0 | 0 | 2 | 10 | 41.70 | W | +2.1u |
| 2026-06-09 | NHL | TOTAL | under | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 2 | 11 | 0.00 | L | -5.0u |
| 2026-06-10 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 9 | 0.00 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 4.5 | 3.00 | -148 | 0 | 0 | 0 | 0 | 8 | -0.50 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | +136 | 3 | 0 | 3 | 5 | 54 | -1.10 | L | -1.0u |
...
| 2026-06-10 | MLB | ML | away | 3.0 | 0.50 | +136 | 0 | 0 | 0 | -1 | 17 | 0.00 | L | -0.5u |
| 2026-06-10 | MLB | TOTAL | under | 4.0 | 1.00 | -113 | 1 | 0 | 1 | 1 | -4 | 0.00 | L | -1.0u |
| 2026-06-10 | MLB | ML | home | 2.5 | 0.25 | -117 | 0 | 0 | 0 | 1 | -9 | 0.00 | W | +0.2u |
| 2026-06-10 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 1 | 3 | 0.00 | L | -5.0u |
| 2026-06-10 | MLB | ML | home | 4.0 | 1.00 | +178 | 1 | 0 | 1 | -2 | 33 | -1.40 | W | +1.7u |
| 2026-06-10 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 3 | 0 | 3 | 1 | 3 | 0.00 | W | +4.5u |
| 2026-06-10 | MLB | ML | away | 5.0 | 5.00 | -104 | 0 | 0 | 0 | 1 | 9 | -0.20 | L | -5.0u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | +148 | 0 | 0 | 0 | 0 | 25 | -0.80 | W | +1.5u |
...
| 2026-06-10 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | -1 | 0 | -1 | 1 | 9 | 0.00 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 5.0 | 5.00 | -106 | 1 | 0 | 1 | -1 | 49 | -0.70 | L | -5.0u |
| 2026-06-10 | MLB | SPREAD | home | 2.5 | 1.00 | -190 | 0 | 0 | 0 | 0 | -24 | -31.40 | L | -1.0u |
| 2026-06-10 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 4 | 1 | 5 | -1 | 0 | 0.00 | L | -5.0u |
...
| 2026-06-11 | MLB | ML | away | 3.0 | 0.50 | -120 | -1 | 0 | -1 | 4 | -17 | -1.70 | P | +0.0u |
| 2026-06-11 | MLB | SPREAD | away | 4.5 | 2.50 | +140 | 1 | 0 | 1 | 3 | 0 | -1.00 | P | +0.0u |
| 2026-06-11 | MLB | ML | home | 5.0 | 5.00 | — | 1 | 0 | 1 | 1 | -3 | 0.00 | L | -5.0u |
| 2026-06-11 | MLB | ML | away | 3.0 | 0.50 | -167 | 1 | -1 | 0 | 1 | 52 | -0.10 | W | +0.3u |
| 2026-06-11 | MLB | TOTAL | under | 5.0 | 1.00 | -108 | 1 | 1 | 2 | 1 | -8 | 0.00 | L | -1.0u |
| 2026-06-11 | MLB | ML | away | 5.0 | 1.00 | +110 | 3 | 1 | 4 | 3 | -1 | -0.90 | L | -1.0u |
| 2026-06-11 | MLB | ML | away | 3.0 | 0.50 | -111 | 1 | 0 | 1 | 1 | 26 | 0.00 | L | -0.5u |
| 2026-06-11 | MLB | ML | home | 5.0 | 5.00 | -131 | 2 | 1 | 3 | 1 | 3 | 0.00 | W | +3.8u |
| 2026-06-11 | MLB | ML | away | 4.0 | 1.00 | +100 | 1 | 0 | 1 | 1 | -29 | -0.50 | W | +1.0u |
| 2026-06-11 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | -1 | -1 | -2 | -1 | 6 | 0.00 | W | +0.2u |
| 2026-06-11 | NHL | TOTAL | under | 3.0 | 0.50 | -104 | 2 | 0 | 2 | 2 | 11 | 0.00 | P | +0.0u |
| 2026-06-12 | MLB | ML | home | 5.0 | 5.00 | -114 | 0 | 0 | 0 | 1 | 3 | 0.00 | W | +4.4u |
| 2026-06-12 | MLB | ML | home | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 2 | 4 | 0.00 | L | -3.0u |
| 2026-06-12 | MLB | TOTAL | over | 4.0 | 1.00 | +100 | 0 | 0 | 0 | 0 | 11 | 0.00 | L | -1.0u |
| 2026-06-12 | MLB | ML | home | 3.0 | 0.50 | -210 | 2 | 0 | 2 | 2 | 27 | -0.10 | W | +0.2u |
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +111 | 3 | 1 | 4 | 3 | -1 | -0.70 | L | -0.3u |
| 2026-06-12 | MLB | ML | away | 4.0 | 1.00 | -114 | 2 | 0 | 2 | 1 | 14 | -1.20 | W | +0.9u |
| 2026-06-12 | MLB | ML | home | 5.0 | 2.50 | +123 | 0 | 1 | 1 | 0 | 4 | 0.00 | W | +3.1u |
| 2026-06-12 | MLB | SPREAD | away | 4.0 | 1.00 | +121 | 0 | 0 | 0 | 1 | 4 | 0.40 | L | -1.0u |
| 2026-06-12 | MLB | ML | home | 4.5 | 3.00 | -138 | 1 | 0 | 1 | 0 | 25 | -1.00 | L | -3.0u |
| 2026-06-12 | MLB | SPREAD | home | 3.0 | 0.50 | -107 | 2 | 0 | 2 | 3 | 11 | -0.40 | W | +0.4u |
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +118 | -1 | 0 | -1 | -1 | -1 | -0.20 | L | -0.3u |
| 2026-06-12 | MLB | ML | away | 4.0 | 1.00 | -136 | 2 | 0 | 2 | 2 | 27 | -1.30 | W | +0.7u |
| 2026-06-12 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | 1 | 7 | 0.00 | W | +2.7u |
| 2026-06-12 | MLB | ML | home | 3.0 | 0.50 | -134 | 2 | 0 | 2 | 3 | 23 | -1.10 | W | +0.4u |
| 2026-06-12 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 3 | 0.00 | W | +2.7u |
| 2026-06-12 | MLB | SPREAD | away | 4.0 | 1.00 | -106 | 1 | 0 | 1 | 0 | 8 | -1.00 | L | -1.0u |
| 2026-06-13 | MLB | ML | away | 5.0 | 5.00 | -128 | 3 | 0 | 3 | 1 | 65 | -0.20 | L | -5.0u |
| 2026-06-13 | MLB | SPREAD | away | 4.0 | 1.00 | +123 | 1 | 0 | 1 | 1 | 9 | 0.00 | L | -1.0u |
| 2026-06-13 | MLB | ML | away | 4.5 | 3.00 | -102 | 0 | 0 | 0 | 1 | 9 | -2.00 | W | +2.9u |
| 2026-06-13 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 0 | 0 | 0 | 0 | 6 | 0.00 | W | +4.5u |
| 2026-06-13 | MLB | ML | away | 2.5 | 0.25 | -118 | 0 | 0 | 0 | -2 | 53 | -1.30 | W | +0.2u |
| 2026-06-13 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +2.7u |
| 2026-06-13 | MLB | ML | away | 4.5 | 2.50 | +136 | 1 | 0 | 1 | -2 | -19 | 1.30 | L | -2.5u |
| 2026-06-13 | MLB | ML | home | 5.0 | 2.50 | +134 | 2 | 0 | 2 | 1 | 3 | 0.00 | W | +3.4u |
| 2026-06-13 | MLB | SPREAD | home | 4.0 | 1.00 | -130 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +0.8u |
| 2026-06-13 | MLB | SPREAD | away | 4.0 | 1.00 | -120 | 1 | 0 | 1 | 2 | 10 | 0.20 | W | +0.8u |
| 2026-06-13 | MLB | ML | away | 4.5 | 2.50 | +114 | 1 | 0 | 1 | 0 | 13 | 0.00 | L | -2.5u |
| 2026-06-13 | MLB | TOTAL | under | 4.0 | 1.00 | +101 | 0 | 0 | 0 | 0 | 11 | 0.00 | W | +1.0u |
| 2026-06-13 | MLB | ML | home | 4.5 | 3.00 | -157 | 0 | 0 | 0 | 0 | 9 | 0.00 | L | -3.0u |
| 2026-06-13 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 1 | 0 | 1 | 1 | 4 | 0.00 | W | +0.5u |
| 2026-06-13 | MLB | ML | home | 5.0 | 5.00 | -115 | 1 | 1 | 2 | -1 | 30 | -0.40 | W | +4.3u |
| 2026-06-13 | MLB | SPREAD | away | 4.0 | 1.00 | -106 | 0 | 0 | 0 | 1 | 9 | 0.00 | L | -1.0u |
| 2026-06-13 | MLB | ML | home | 4.0 | 1.00 | -112 | 0 | 0 | 0 | 2 | 10 | -1.30 | W | +0.8u |
