...
_Auto-generated **6/19/2026, 11:54:51 AM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 700 shipped+graded picks · 2026-04-18 → 2026-06-18  (HC analyses scoped to post-cutover 2026-04-30, 588 picks)
**Headline:** 353-339-8 · WR 51.0% [47.3%–54.7%] vs 52.4% break-even · -18.0u flat (-2.6%) · -87.0u peak.
...
- **ρ(Δw, flat ROI) = 0.012 ✗**  (full sample, N=694)
- **ρ(HC, flat ROI) = -0.020 ✗**  (post-cutover, N=588)
- **ρ(Δw+HC, flat ROI) = -0.044 ✗**  (post-cutover, N=588)
...
- **Tier-1b (HC = +1)** — N=164, WR 56.1%, flat ROI +7.5%. Bayesian posterior WR ≈ 55.7%, half-Kelly = **3.5%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=94, WR 45.2%, flat ROI -15.7%. Δw saves the pick when HC is silent.
...
- **Sample size:** at observed σ (0.98u/pick), we need **~1483 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 700. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **700** |
| W-L-P | 353-339-8 |
| Win rate | **51.0%** [47.3%–54.7%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +1.4 pp |
| Peak-units PnL | **-87.0u** |
| Flat-1u PnL | **-18.0u** (-2.6% flat ROI) |
| Flat t-statistic vs zero | -0.69 → ✗ noise |
| Flat 95% CI per-pick | [-0.099, 0.047]u |
...
We have **700** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = +1 | 266 | 142-121-3 | 54.0% [48–60] | +2.0% | -30.9u | 0.33 ✗ noise |
| Δw = +2 | 137 | 67-69-1 | 49.3% [41–58] | -4.7% | -34.2u | -0.56 ✗ noise |
| Δw ≥ +3 | 112 | 55-57-0 | 49.1% [40–58] | -2.2% | -20.1u | -0.21 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.007** ✗  ·  **ρ(Δw, flat ROI) = 0.012** ✗  (N=694)
...
| HC = 0 | 353 | 174-172-7 | 50.3% [45–56] | -5.5% | -88.3u | -1.09 ✗ noise |
| HC = +1 | 164 | 92-72-0 | 56.1% [48–63] | +7.5% | +11.1u | 0.99 ✗ noise |
| HC = +2 | 32 | 17-15-0 | 53.1% [36–69] | +1.9% | -0.1u | 0.11 ✗ noise |
| HC ≥ +3 | 12 | 4-8-0 | 33.3% [14–61] | -50.4% | -6.7u | -2.38 ✓ p<.05 |

**Pearson ρ(HC, WIN) = -0.003** ✗  ·  **ρ(HC, flat ROI) = -0.020** ✗  (N=588)
...
| Σ = +1 | 191 | 104-84-3 | 55.3% [48–62] | +4.7% | -29.3u | 0.68 ✗ noise |
| Σ = +2 | 124 | 69-54-1 | 56.1% [47–65] | +5.0% | +0.3u | 0.59 ✗ noise |
...
**Pearson ρ(Δw+HC, WIN) = -0.032** ✗  ·  **ρ(Σ, flat ROI) = -0.044** ✗  (N=588)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 588.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.041 ✗ | -0.048 ✗ | -0.027 | weak |
| HC margin | -0.003 ✗ | -0.020 ✗ | 0.015 | weak |
| Δw + HC | -0.032 ✗ | -0.044 ✗ | -0.016 | weak |
| peak.stars | -0.050 ✗ | -0.067 ✗ | -0.069 | weak |
| vault.star | -0.010 ✗ | -0.023 ✗ | -0.041 | weak |
| lock.stars | -0.031 ✗ | -0.045 ✗ | -0.044 | weak |
...
Universe N = 588 (post-cutover, both axes present).
...
| +0 | N=1 · 1-0 · 100% [21–100] · —  | N=3 · 1-2 · 33% [6–79] · -25%  | N=12 · 3-8 · 27% [10–57] · -47%  | N=86 · 44-40 · 52% [42–63] · -1%  | N=163 · 87-73 · 54% [47–62] · +3%  | N=60 · 30-29 · 51% [38–63] · -6%  | N=28 · 8-20 · 29% [15–47] · -48% ✗ |
| +1 | — | — | N=6 · 3-3 · 50% [19–81] · -12%  | N=26 · 15-11 · 58% [39–74] · +7%  | N=59 · 36-23 · 61% [48–72] · +16%  | N=36 · 18-18 · 50% [34–66] · -1%  | N=37 · 20-17 · 54% [38–69] · +6%  |
...
| Δw = +1 | 233 | 127-103-3 | 55.2% [49–62] | +4.3% | -26.4u | 0.68 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 208 | 113-95-0 | 54.3% [48–61] | +3.3% | +4.2u | 0.49 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 94 | 42-51-1 | 45.2% [35–55] | -15.7% | -39.8u | -1.61 ✗ noise |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 286 | 147-133-6 | 52.5% [47–58] | -0.5% | -40.8u | -0.09 ✗ noise |
...
Universe N = 678 picks where ≥1 proven wallet appeared on either side.
...
| Δcount = 0 (balanced) | 110 | 50-58-2 | 46.3% [37–56] | -10.2% | +0.6u | -1.10 ✗ noise |
| Δcount = +1 | 251 | 125-125-1 | 50.0% [44–56] | -6.7% | -83.3u | -1.12 ✗ noise |
| Δcount = +2 | 142 | 71-70-1 | 50.4% [42–58] | -5.2% | -23.0u | -0.64 ✗ noise |
| Δcount ≥ +3 (heavy support) | 115 | 71-41-3 | 63.4% [54–72] | +24.6% | +52.2u | 2.50 ✓ p<.05 |

**ρ(Δcount, WIN) = 0.069** ~ p<.10  ·  **ρ(Δcount, flat ROI) = 0.076** ✓ p<.05
...
Quintile cuts: ≤ -10 · ≤ 2 · ≤ 8 · ≤ 21 · > 21

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 136 | 60-76-0 | 44.1% [36–53] | -14.5% | -45.1u | -1.73 ~ p<.10 |
| Q2 | 161 | 69-89-3 | 43.7% [36–51] | -14.4% | -50.4u | -1.87 ~ p<.10 |
| Q3 (balanced) | 111 | 58-52-1 | 52.7% [43–62] | -1.3% | -19.9u | -0.15 ✗ noise |
| Q4 | 147 | 84-61-2 | 57.9% [50–66] | +11.7% | +12.0u | 1.44 ✗ noise |
| Q5 (best — heavy support) | 123 | 74-48-1 | 60.7% [52–69] | +12.6% | +22.3u | 1.39 ✗ noise |

**ρ(ΔWlNet, WIN) = 0.141** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.120** ✓ p<.01
...
Quintile cuts (units): ≤ -14.58 · ≤ -0.43 · ≤ 5.65 · ≤ 13.70 · > 13.70

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 136 | 61-74-1 | 45.2% [37–54] | -16.0% | -47.1u | -2.00 ✓ p<.05 |
| Q2 | 136 | 60-74-2 | 44.8% [37–53] | -15.7% | -20.0u | -1.93 ~ p<.10 |
| Q3 | 135 | 68-67-0 | 50.4% [42–59] | -6.8% | -26.8u | -0.84 ✗ noise |
| Q4 | 136 | 75-57-4 | 56.8% [48–65] | +9.3% | -1.9u | 1.12 ✗ noise |
| Q5 | 135 | 81-54-0 | 60.0% [52–68] | +20.8% | +14.7u | 2.24 ✓ p<.05 |
...
Quintile cuts (% ROI): ≤ -8.6 · ≤ -0.3 · ≤ 7.8 · ≤ 20.4 · > 20.4

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 136 | 40-96-0 | 29.4% [22–38] | -43.6% | -98.4u | -5.72 ✓ p<.01 |
| Q2 | 136 | 73-60-3 | 54.9% [46–63] | +0.8% | +13.4u | 0.10 ✗ noise |
| Q3 | 135 | 68-66-1 | 50.7% [42–59] | -3.6% | -3.7u | -0.43 ✗ noise |
| Q4 | 136 | 78-56-2 | 58.2% [50–66] | +11.2% | -0.2u | 1.35 ✗ noise |
| Q5 | 135 | 86-48-1 | 64.2% [56–72] | +26.9% | +7.9u | 3.02 ✓ p<.01 |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 73 | 17-55-1 | 23.6% [15–35] | -53.5% | -52.8u | -5.46 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 15 | 6-9-0 | 40.0% [20–64] | -23.2% | -3.3u | -0.90 ✗ noise |
| ΔBestRank = 0 (tied) | 1 | 1-0-0 | 100.0% [21–100] | +90.9% | +0.3u | 0.00 ✗ n<2 |
| ΔBestRank ∈ [+1,+4] | 14 | 7-7-0 | 50.0% [27–73] | -4.4% | -0.9u | -0.16 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 203 | 115-85-3 | 57.5% [51–64] | +14.1% | +10.0u | 1.92 ~ p<.10 |

**ρ(ΔBestRank, WIN) = 0.305** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.328** ✓ p<.01  (N=306)
...
| Δshare ≈ 0 (±10 pp) | 470 | 229-236-5 | 49.2% [45–54] | -7.0% | -83.8u | -1.59 ✗ noise |
| Δshare ∈ [+10,+30] pp | 32 | 18-14-0 | 56.3% [39–72] | +7.2% | +1.1u | 0.42 ✗ noise |
| Δshare ≥ +30 pp | 134 | 87-45-2 | 65.9% [57–73] | +30.0% | +26.9u | 3.36 ✓ p<.01 |

**ρ(ΔTopQShare, WIN) = 0.157** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.164** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔTopQCount** | 0.174 ✓ p<.01 | 0.206 ✓ p<.01 | 0.171 |
| 2 | **ΔTopQShare** | 0.157 ✓ p<.01 | 0.164 ✓ p<.01 | 0.176 |
| 3 | **ΔWlNet** | 0.141 ✓ p<.01 | 0.120 ✓ p<.01 | 0.075 |
| 4 | **Δcount** | 0.069 ~ p<.10 | 0.076 ✓ p<.05 | 0.068 |
| 5 | **ΔFlatPnl** | NaN — | NaN — | 0.152 |
| 6 | **ΔAvgRoi** | NaN — | NaN — | 0.221 |

_(ΔBestRank uses N=306 subset where both sides had a proven wallet — ρ(flat ROI) = 0.328 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 1208, dateRange = 2026-04-18 → 2026-06-18, computedAt = 2026-06-19T15:53:11.449Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **678** rows · PIT aggregate computable on **670** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **670** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 468 · 55% · +3.0% | 401 · 52% · -2.6% | -5.6pp |
| WEAK (−3..0) | 190 · 45% · -12.1% | 257 · 51% · +0.6% | +12.7pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=372, WR=55%, ROI=+4.1% | N=306, WR=52%, ROI=-3.7% | -7.8pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=468, WR=55%, ROI=+3.0% | N=401, WR=52%, ROI=-2.6% | -5.6pp |
| AGS < −1 (mute veto) | N=72, WR=47%, ROI=-7.6% | N=154, WR=48%, ROI=-2.4% | +5.1pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-06-05 → 2026-06-18, N=235)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 126 · 54% · +0.7% |
| WEAK (−3..0) | 109 · 51% · +0.0% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=98, WR=56%, ROI=+3.7% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=126, WR=54%, ROI=+0.7% |
| AGS < −1 (mute veto) | N=74, WR=55%, ROI=+7.4% |
...
| `dHcSizeRatio` | INTENSITY_HC | + | 0.87 | 4.38 |
| `dSumRankNorm` | QUALITY_RANK | − | 51.54 | 86.01 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.55 | 1.09 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **670/700** shipped+graded rows (96%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 113 | 58-53-2 | 52.3% [43–61] | -4.0% | -23.4u | -0.46 ✗ noise |
| LOCK | 120 | 57-63-0 | 47.5% [39–56] | -10.4% | -32.1u | -1.19 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 87 | 42-43-2 | 49.4% [39–60] | -5.0% | -7.3u | -0.48 ✗ noise |
| FADE | 161 | 77-81-3 | 48.7% [41–56] | -2.1% | -29.9u | -0.25 ✗ noise |
...
r(WIN) = **-0.008** ✗ · r(ROI) = **-0.034** ✗ · Spearman ρ(ROI) = **-0.043**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 153 | 78-73-2 | 51.7% [44–59] | +3.6% | -20.6u | 0.42 ✗ noise |
| z ∈ [−1, 0) | 219 | 120-96-3 | 55.6% [49–62] | +4.3% | +7.4u | 0.66 ✗ noise |
| z ∈ [0, +1) | 201 | 93-107-1 | 46.5% [40–53] | -12.0% | -60.3u | -1.76 ~ p<.10 |
...
| z ∈ [0, +1) | 636 | 324-304-8 | 51.6% [48–55] | -2.3% | -78.2u | -0.62 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.056** ✗ · r(ROI) = **-0.063** ✗ · Spearman ρ(ROI) = **-0.069**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 124 | 69-54-1 | 56.1% [47–65] | +4.8% | -4.8u | 0.56 ✗ noise |
| z ∈ [−1, 0) | 255 | 135-118-2 | 53.4% [47–59] | +3.4% | -23.0u | 0.53 ✗ noise |
| z ∈ [0, +1) | 218 | 101-113-4 | 47.2% [41–54] | -9.5% | -50.6u | -1.45 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.056 ✗ | -0.063 ✗ | -0.069 |
| 2 | `dCount` | COUNT | -0.008 ✗ | -0.034 ✗ | -0.043 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | -0.065 | 0.807 | 49.6% | dominant |
| 2 | `dSumRankNorm` | -0.159 | 0.786 | 48.2% | meaningful |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.024 | +0.706 ⚠ | +0.024 |
| `dHcSizeRatio` | +0.024 | 1.000 | -0.007 | +1.000 ⚠ |
| `dSumRankNorm` | +0.706 ⚠ | -0.007 | 1.000 | -0.007 |
| `dWinnerCtPreA` | +0.024 | +1.000 ⚠ | -0.007 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **-0.011**. At AGS ≥ +0.12 fires N=310, WR=51.6%, ROI=-3.7%. At AGS ≥ +null fires N=406, WR=52.1%, ROI=-2.8%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-310 ROI (matched cohort) | Top-310 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.075 | +0.064 | WR=56%, ROI=+7.8% | -11.5pp | N=347, WR=55%, ROI=+4.9% |
| `dHcSizeRatio` | +0.042 | +0.031 | WR=54%, ROI=+1.7% | -5.4pp | N=327, WR=54%, ROI=+1.7% |
| `dSumRankNorm` | -0.050 | +0.040 | WR=48%, ROI=-10.7% | +7.0pp | N=294, WR=48%, ROI=-9.1% |
| `dWinnerCtPreA` | +0.044 | +0.033 | WR=54%, ROI=+0.9% | -4.6pp | N=315, WR=54%, ROI=+1.3% |
...
|---|---|---|---|---|
| 1 | `dHcSizeRatio` | +0.031 | -5.4pp | redundant — other features cover it |
| 2 | `dWinnerCtPreA` | +0.033 | -4.6pp | redundant — other features cover it |
| 3 | `dSumRankNorm` | +0.040 | +7.0pp | redundant — other features cover it |
| 4 | `dCount` | +0.064 | -11.5pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.137 | 0.137 | negative ↓ |
...
Intercept b = +0.006 · Final log-loss = 0.6906 · N = 670.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 670 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/670 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| 4.5★ | 116 | 68-46-2 | 59.6% [50–68] | +12.9% | +19.0u | 1.44 ✗ noise |
| 4.0★ | 145 | 67-76-2 | 46.9% [39–55] | -9.4% | -20.5u | -1.14 ✗ noise |
...
| Δw = +1 | 48/50%/-8% | 50/56%/+4% | 73/49%/-6% | 28/54%/+4% | 33/64%/+23% | 33/58%/+7% |
...
| −200/−151 | 72 | 39-33-0 | 54.2% [43–65] | -13.6% | -29.2u | -1.45 ✗ noise |
| −150/−101 | 422 | 214-203-5 | 51.3% [47–56] | -3.6% | -38.1u | -0.79 ✗ noise |
| −100/+100 | 9 | 5-4-0 | 55.6% [27–81] | +11.1% | +1.7u | 0.32 ✗ noise |
| +101/+150 | 135 | 59-73-3 | 44.7% [36–53] | -2.3% | -43.8u | -0.25 ✗ noise |
...
| −200/−151 | -24% (21) | -4% (28) | +27% (10) | -59% (12) |
| −150/−101 | -6% (103) | +1% (172) | -15% (81) | +2% (63) |
| −100/+100 | -100% (2) | +60% (5) | -100% (1) | +100% (1) |
| +101/+150 | -2% (36) | -6% (46) | +7% (33) | -10% (20) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 377 | 189-187-1 | 50.3% [45–55] | -3.9% | -64.8u | -0.74 ✗ noise |
| SPREAD | 112 | 54-56-2 | 49.1% [40–58] | -8.6% | -14.6u | -0.96 ✗ noise |
| TOTAL | 211 | 110-96-5 | 53.4% [47–60] | +2.9% | -7.7u | 0.45 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=97 · 46% · -15% | N=133 · 55% · +3% | N=73 · 52% · +3% | N=71 · 45% · -8% |
| SPREAD | N=30 · 34% · -36% | N=46 · 56% · +4% | N=19 · 63% · +13% | N=16 · 38% · -27% |
| TOTAL | N=52 · 62% · +19% | N=87 · 52% · -0% | N=45 · 39% · -24% | N=25 · 68% · +31% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 520 | 268-247-5 | 52.0% [48–56] | -1.7% | -55.5u | -0.40 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=139 · 51% · -5% | N=223 · 54% · +1% | N=101 · 50% · -3% | N=56 · 50% · -5% |
...
|---|---|---|
| **sharps3Plus** | 265 · 47% · -8.6% · -1.37 ✗ noise | 434 · 53% · +0.8% · 0.17 ✗ noise |
| **plusEV** | 73 · 48% · -5.1% · -0.38 ✗ noise | 626 · 51% · -2.5% · -0.65 ✗ noise |
| **pinnacleConfirms** | 163 · 53% · +1.9% · 0.23 ✗ noise | 370 · 50% · -5.1% · -1.00 ✗ noise |
| **invested10kPlus** | 339 · 51% · -3.7% · -0.69 ✗ noise | 194 · 51% · -1.5% · -0.22 ✗ noise |
| **lineMovingWith** | 309 · 55% · +4.2% · 0.76 ✗ noise | 390 · 48% · -8.3% · -1.69 ~ p<.10 |
| **predMarketAligns** | 173 · 52% · -1.7% · -0.22 ✗ noise | 360 · 50% · -3.5% · -0.69 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 209 | 107-102-0 | 51.2% [44–58] | -1.5% | -30.6u | -0.22 ✗ noise |
| 1 | 146 | 71-70-5 | 50.4% [42–58] | -4.2% | -26.6u | -0.53 ✗ noise |
| 2 | 154 | 78-73-3 | 51.7% [44–59] | -1.5% | -4.0u | -0.19 ✗ noise |
| 3 | 60 | 30-30-0 | 50.0% [38–62] | -5.4% | -10.6u | -0.43 ✗ noise |
| 4 | 60 | 31-29-0 | 51.7% [39–64] | -6.2% | -8.4u | -0.51 ✗ noise |
| 5 | 56 | 29-27-0 | 51.8% [39–64] | -4.7% | -9.4u | -0.37 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLEAR_MOVE | 111 | 61-49-1 | 55.5% [46–64] | +3.6% | +2.4u | 0.39 ✗ noise |
| NEAR_START | 276 | 132-139-5 | 48.7% [43–55] | -5.6% | -62.2u | -0.93 ✗ noise |
| NO_MOVE | 22 | 11-11-0 | 50.0% [31–69] | -8.3% | +5.7u | -0.41 ✗ noise |
| PREGAME | 144 | 76-68-0 | 52.8% [45–61] | +1.5% | -20.8u | 0.19 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 396 | 201-192-3 | 51.1% [46–56] | -4.1% | -94.5u | -0.86 ✗ noise |
| STRONG | 104 | 52-50-2 | 51.0% [41–60] | -0.2% | -3.1u | -0.03 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.087 ✓ p<.05 | -0.068 ~ p<.10 | -0.055 | -1.80 |
| totalInvested | -0.064 ~ p<.10 | -0.075 ✓ p<.05 | -0.029 | -1.99 |
| evEdge | 0.088 ✓ p<.05 | 0.109 ✓ p<.01 | 0.045 | 2.89 |
| moneyPct | 0.033 ✗ | 0.005 ✗ | -0.013 | 0.14 |
| walletPct | 0.028 ✗ | 0.013 ✗ | 0.007 | 0.34 |
| criteriaMet | 0.001 ✗ | 0.002 ✗ | -0.031 | 0.05 |
| maxContribFor | -0.017 ✗ | -0.003 ✗ | 0.019 | -0.09 |
| meanBaseFor | -0.000 ✗ | 0.025 ✗ | 0.048 | 0.66 |
...
Sample with CLV: **687** picks. Mean CLV = **-0.0041**.
t-statistic vs zero: -3.45 → ✓ p<.01 · 95% CI [-0.0065, -0.0018]
...
| CLV (−2%, 0] | 413 | 208-199-6 | 51.1% [46–56] | -3.1% | -59.8u | -0.65 ✗ noise |
| CLV (0, +2%] | 173 | 91-82-0 | 52.6% [45–60] | +4.6% | -14.1u | 0.58 ✗ noise |
| CLV > +2% | 29 | 14-14-1 | 50.0% [33–67] | -7.1% | +1.8u | -0.39 ✗ noise |

ρ(CLV, flat ROI) = 0.081 ✓ p<.05
...
Trained on N=550 (with all features non-null). Intercept β₀ = 0.061.
...
| 4 | pw.ΔFlatPnl | +0.169 | ↑ helps |
| 5 | pw.Δcount | +0.149 | ↑ helps |
| 6 | peak.stars | -0.124 | ↓ hurts |
| 7 | log(impliedProb) | +0.121 | ↑ helps |
| 8 | vault.star | +0.093 | ↑ helps |
| 9 | odds (American) | -0.093 | ↓ hurts |
| 10 | pw.ΔTopQShare | +0.079 | ↑ helps |
| 11 | HC margin | +0.077 | ↑ helps |
| 12 | pw.ΔWlNet | +0.065 | ↑ helps |
| 13 | criteriaMet | +0.037 | ≈ flat |
| 14 | Δw | -0.027 | ≈ flat |
...
| Tier-1b HC = +1 (post-cutover) | 164 | 92-72 | 56.1% | 55.7% | -110 | 3.53% bankroll | 2.07u | **UNDER-SIZED** — ship up to 3.53u (1u=1% bankroll) |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 94 | 42-51 | 45.2% | 45.6% | -110 | — (mute) | 2.03u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.212  (annualized × √252 ≈ -3.37)
...
| 2026-04-26 | MLB | ML | home | 3.5 | 0.75 | -110 | 1 | — | — | 2 | 21 | -1.40 | L | -0.8u |
...
| 2026-05-16 | MLB | ML | away | 2.5 | 0.50 | -102 | 1 | 0 | 1 | 1 | -40 | 0.00 | W | +0.5u |
...
| 2026-05-24 | MLB | ML | away | 3.0 | 1.25 | -122 | -1 | 1 | 0 | 0 | -23 | -1.10 | L | -1.3u |
...
| 2026-05-25 | MLB | ML | home | 5.0 | 5.00 | -149 | 1 | 0 | 1 | 3 | 12 | -0.70 | L | -5.0u |
...
| 2026-05-25 | MLB | TOTAL | under | 5.0 | 2.25 | -112 | 4 | 0 | 4 | 4 | -6 | 0.00 | L | -2.3u |
...
| 2026-05-25 | MLB | ML | home | 4.0 | 5.00 | -209 | -1 | 0 | -1 | 3 | 12 | -0.80 | W | +2.3u |
...
| 2026-05-27 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 2 | 5 | 3 | -8 | -0.30 | L | -2.5u |
...
| 2026-05-28 | MLB | TOTAL | under | 5.0 | 1.00 | -107 | 1 | 0 | 1 | 1 | 23 | 0.00 | W | +0.0u |
...
| 2026-05-29 | MLB | ML | home | 5.0 | 2.50 | +118 | 5 | 1 | 6 | 5 | 17 | -0.90 | L | -2.5u |
...
| 2026-05-30 | MLB | ML | away | 4.5 | 2.75 | -125 | 1 | 2 | 3 | 1 | 26 | -0.60 | W | +2.3u |
| 2026-05-30 | MLB | ML | home | 5.0 | 5.00 | -130 | 1 | 0 | 1 | 2 | -4 | -1.20 | L | -5.0u |
| 2026-05-30 | MLB | ML | away | 4.0 | 3.75 | -132 | 1 | 1 | 2 | 1 | 60 | -1.00 | W | +2.9u |
...
| 2026-05-30 | MLB | ML | home | 4.0 | 2.75 | -130 | 0 | 1 | 1 | 0 | 21 | -1.60 | W | +0.4u |
...
| 2026-05-31 | MLB | ML | home | 2.5 | 1.25 | -232 | 0 | 0 | 0 | 1 | 33 | -0.50 | W | +0.5u |
...
| 2026-06-01 | MLB | ML | home | 3.0 | 0.50 | -142 | -1 | 0 | -1 | -1 | 20 | -0.40 | L | -0.5u |
| 2026-06-01 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 7 | 0.00 | L | -5.0u |
| 2026-06-01 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 2 | -33 | 0.00 | W | +2.7u |
...
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -150 | 3 | 1 | 4 | 5 | 6 | -1.30 | W | +0.3u |
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +134 | -1 | -1 | -2 | -1 | 40 | -1.00 | W | +1.2u |
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +125 | 0 | -1 | -1 | 0 | 45 | 0.40 | W | +1.3u |
| 2026-06-03 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 40 | 0.00 | L | -3.0u |
| 2026-06-03 | MLB | ML | home | 4.5 | 1.50 | +167 | 0 | 0 | 0 | -1 | 16 | -0.40 | L | -1.5u |
| 2026-06-03 | MLB | SPREAD | away | 4.0 | 1.00 | -111 | 1 | 0 | 1 | 0 | 10 | 0.20 | W | +0.8u |
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -103 | 3 | 1 | 4 | 3 | 8 | -1.20 | L | -0.5u |
| 2026-06-03 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | -8 | 0.00 | L | -5.0u |
| 2026-06-03 | MLB | ML | away | 3.0 | 0.50 | +119 | 1 | 0 | 1 | 0 | 31 | 0.00 | W | +0.6u |
| 2026-06-03 | MLB | ML | away | 4.5 | 3.00 | -137 | 0 | 0 | 0 | -1 | 40 | -1.50 | L | -3.0u |
...
| 2026-06-04 | MLB | ML | away | 3.0 | 0.50 | +104 | 1 | 0 | 1 | 2 | 21 | 0.00 | W | +0.5u |
...
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -210 | 1 | 0 | 1 | 2 | 55 | -1.00 | W | +0.5u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -188 | 0 | 0 | 0 | 0 | 21 | -1.10 | L | -1.0u |
| 2026-06-04 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 0 | 21 | 0.00 | W | +2.7u |
| 2026-06-04 | MLB | ML | home | 3.0 | 0.50 | -235 | 4 | 0 | 4 | 4 | 16 | 0.00 | L | -0.5u |
...
| 2026-06-05 | MLB | ML | home | 3.0 | 0.50 | -136 | 1 | 0 | 1 | 3 | 30 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 3 | 0 | 3 | 4 | 6 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | ML | away | 5.0 | 5.00 | -122 | 0 | 1 | 1 | 1 | 40 | -0.80 | L | -5.0u |
...
| 2026-06-06 | MLB | ML | home | 4.5 | 3.00 | -126 | 0 | 0 | 0 | 0 | 21 | -1.00 | W | +2.4u |
| 2026-06-06 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -4 | 0.00 | W | +2.7u |
| 2026-06-06 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 1 | 1 | -1 | 11 | 0.00 | L | -1.0u |
...
| 2026-06-07 | MLB | TOTAL | over | 3.0 | 0.50 | -112 | 0 | 0 | 0 | 3 | 7 | 0.00 | L | -0.5u |
...
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -165 | 2 | 2 | 4 | 3 | 12 | -1.10 | W | +1.8u |
| 2026-06-07 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 1 | 1 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | -107 | 1 | 0 | 1 | -1 | 41 | -0.80 | W | +0.2u |
| 2026-06-07 | MLB | TOTAL | over | 2.5 | 0.25 | -115 | 0 | 0 | 0 | -1 | -15 | 0.00 | W | +0.2u |
| 2026-06-07 | MLB | ML | home | 2.5 | 0.25 | -210 | -1 | 0 | -1 | 1 | 33 | 0.80 | L | -0.3u |
...
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 3.00 | -152 | 2 | 0 | 2 | 1 | 21 | -0.50 | W | +1.9u |
| 2026-06-07 | MLB | TOTAL | over | 5.0 | 2.25 | -114 | 1 | 1 | 2 | 1 | -1 | 0.00 | L | -2.3u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | +102 | 1 | 0 | 1 | -2 | 10 | -0.20 | W | +0.5u |
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 2.25 | +164 | 1 | 1 | 2 | 1 | 5 | 29.50 | W | +3.7u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | +103 | -1 | 0 | -1 | -2 | -14 | 0.20 | W | +0.3u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | -1 | 0 | 1 | 10 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -102 | 2 | 0 | 2 | 0 | 21 | 0.50 | W | +1.0u |
| 2026-06-07 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 2 | 0.00 | W | +4.8u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | -127 | 0 | 1 | 1 | -1 | 41 | -1.90 | W | +0.4u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -2 | 0.00 | W | +0.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -113 | 6 | 1 | 7 | 6 | 47 | -0.50 | L | -3.0u |
| 2026-06-08 | MLB | ML | home | 4.5 | 3.00 | -129 | 3 | 0 | 3 | 2 | 53 | -0.40 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | -1 | -1 | 0.00 | L | -3.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -121 | 1 | 1 | 2 | 0 | 38 | -1.60 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 2 | 16 | 0.00 | P | +0.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -146 | 1 | 0 | 1 | 0 | 43 | -0.50 | W | +2.0u |
| 2026-06-08 | MLB | ML | home | 4.0 | 1.00 | -118 | 2 | 0 | 2 | 2 | -28 | -0.40 | L | -1.0u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 2.50 | -116 | -2 | -2 | -4 | -2 | 27 | 0.00 | W | +2.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 1.50 | +151 | 0 | -1 | -1 | 0 | 7 | 0.00 | W | +2.3u |
...
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | +132 | 1 | 0 | 1 | 3 | 26 | -1.20 | L | -0.3u |
| 2026-06-09 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 11 | 0.00 | W | +4.3u |
| 2026-06-09 | MLB | ML | away | 3.0 | 0.50 | -148 | 1 | 0 | 1 | 3 | 30 | 0.00 | L | -0.5u |
...
| 2026-06-09 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | -1 | 12 | 0.00 | W | +0.5u |
| 2026-06-09 | MLB | ML | away | 5.0 | 5.00 | -122 | 2 | 1 | 3 | 1 | 2 | 0.00 | W | +4.1u |
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | -120 | 0 | 0 | 0 | 0 | 11 | 0.00 | L | -0.3u |
| 2026-06-09 | MLB | ML | home | 4.0 | 1.00 | -107 | 1 | 0 | 1 | 0 | 27 | -1.30 | L | -1.0u |
| 2026-06-09 | MLB | ML | home | 5.0 | 5.00 | -105 | 1 | -1 | 0 | 1 | 1 | 0.00 | W | +4.8u |
| 2026-06-09 | MLB | ML | away | 4.5 | 2.50 | +115 | 1 | 0 | 1 | 0 | 21 | -0.70 | L | -2.5u |
| 2026-06-09 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 0 | 4 | 0.00 | W | +2.7u |
...
| 2026-06-10 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 0 | 17 | 0.00 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 4.5 | 3.00 | -148 | 0 | 0 | 0 | 0 | 16 | -0.50 | L | -3.0u |
...
| 2026-06-10 | MLB | ML | home | 4.0 | 1.00 | +178 | 1 | 0 | 1 | -2 | 20 | -1.40 | W | +1.7u |
...
| 2026-06-11 | MLB | SPREAD | away | 4.5 | 2.50 | +140 | 1 | 0 | 1 | 3 | 5 | -1.00 | P | +0.0u |
...
| 2026-06-11 | MLB | ML | away | 5.0 | 1.00 | +110 | 3 | 1 | 4 | 3 | 12 | -0.90 | L | -1.0u |
...
| 2026-06-11 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | -1 | -1 | -2 | -1 | 5 | 0.00 | W | +0.2u |
...
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +111 | 3 | 1 | 4 | 3 | 12 | -0.70 | L | -0.3u |
| 2026-06-12 | MLB | ML | away | 4.0 | 1.00 | -114 | 2 | 0 | 2 | 1 | 9 | -1.20 | W | +0.9u |
| 2026-06-12 | MLB | ML | home | 5.0 | 2.50 | +123 | 0 | 1 | 1 | 0 | 3 | 0.00 | W | +3.1u |
| 2026-06-12 | MLB | SPREAD | away | 4.0 | 1.00 | +121 | 0 | 0 | 0 | 1 | 20 | 0.40 | L | -1.0u |
| 2026-06-12 | MLB | ML | home | 4.5 | 3.00 | -138 | 1 | 0 | 1 | 0 | 27 | -1.00 | L | -3.0u |
| 2026-06-12 | MLB | SPREAD | home | 3.0 | 0.50 | -107 | 2 | 0 | 2 | 3 | 14 | -0.40 | W | +0.4u |
...
| 2026-06-12 | MLB | ML | home | 3.0 | 0.50 | -134 | 2 | 0 | 2 | 3 | 30 | -1.10 | W | +0.4u |
| 2026-06-12 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 1 | 0.00 | W | +2.7u |
| 2026-06-12 | MLB | SPREAD | away | 4.0 | 1.00 | -106 | 1 | 0 | 1 | 0 | 16 | -1.00 | L | -1.0u |
| 2026-06-13 | MLB | ML | away | 5.0 | 5.00 | -128 | 3 | 0 | 3 | 1 | 56 | -0.20 | L | -5.0u |
...
| 2026-06-13 | MLB | SPREAD | away | 4.0 | 1.00 | -120 | 1 | 0 | 1 | 2 | 14 | 0.20 | W | +0.8u |
| 2026-06-13 | MLB | ML | away | 4.5 | 2.50 | +114 | 1 | 0 | 1 | 0 | 10 | 0.00 | L | -2.5u |
| 2026-06-13 | MLB | TOTAL | under | 4.0 | 1.00 | +101 | 0 | 0 | 0 | 0 | 0 | 0.00 | W | +1.0u |
| 2026-06-13 | MLB | ML | home | 4.5 | 3.00 | -157 | 0 | 0 | 0 | -1 | 8 | 0.00 | L | -3.0u |
| 2026-06-13 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 1 | 0 | 1 | 1 | 21 | 0.00 | W | +0.5u |
| 2026-06-13 | MLB | ML | home | 5.0 | 5.00 | -115 | 1 | 1 | 2 | -1 | 15 | -0.40 | W | +4.3u |
| 2026-06-13 | MLB | SPREAD | away | 4.0 | 1.00 | -106 | 0 | 0 | 0 | 1 | 15 | 0.00 | L | -1.0u |
| 2026-06-13 | MLB | ML | home | 4.0 | 1.00 | -112 | 0 | 0 | 0 | 2 | 14 | -1.30 | W | +0.8u |
| 2026-06-13 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 7 | 0.00 | L | -5.0u |
| 2026-06-13 | NBA | ML | home | 2.5 | 0.25 | -205 | 6 | 6 | 12 | 6 | -27 | 0.60 | L | -0.3u |
| 2026-06-14 | MLB | ML | away | 4.0 | 1.00 | +106 | 1 | 1 | 2 | 3 | 5 | -1.50 | L | -1.0u |
| 2026-06-14 | MLB | ML | home | 2.5 | 0.25 | -124 | 1 | 0 | 1 | 2 | -25 | -1.50 | W | +0.2u |
| 2026-06-14 | MLB | SPREAD | away | 5.0 | 5.00 | -180 | 1 | 0 | 1 | 0 | 4 | 0.00 | L | -5.0u |
...
| 2026-06-14 | MLB | SPREAD | away | 4.0 | 1.00 | -158 | 1 | -1 | 0 | 1 | 21 | 0.10 | W | +0.6u |
| 2026-06-14 | MLB | ML | away | 4.0 | 1.00 | -125 | 2 | 1 | 3 | 4 | 27 | -1.20 | W | +0.8u |
| 2026-06-14 | MLB | ML | away | 4.5 | 3.00 | -101 | 1 | 0 | 1 | 1 | 15 | 0.00 | L | -3.0u |
| 2026-06-14 | MLB | ML | away | 2.5 | 0.25 | -115 | 2 | 0 | 2 | 3 | 30 | 0.00 | W | +0.2u |
...
| 2026-06-15 | MLB | ML | away | 3.0 | 0.50 | +115 | 2 | 0 | 2 | 2 | 13 | -0.80 | L | -0.5u |
| 2026-06-15 | MLB | ML | away | 3.0 | 0.50 | +160 | 2 | 0 | 2 | 0 | 1 | -0.70 | L | -0.5u |
| 2026-06-15 | MLB | SPREAD | away | 2.5 | 0.25 | -120 | 0 | 0 | 0 | -1 | -8 | 0.00 | L | -0.3u |
| 2026-06-15 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 3 | 0 | 3 | 2 | 22 | 0.00 | L | -3.0u |
...
| 2026-06-15 | MLB | ML | home | 3.0 | 0.50 | -154 | 1 | 0 | 1 | 3 | 11 | 0.50 | W | +0.0u |
...
| 2026-06-16 | MLB | ML | home | 4.5 | 3.00 | -194 | 1 | 0 | 1 | -1 | 6 | 0.40 | L | -3.0u |
...
| 2026-06-16 | MLB | ML | home | 4.5 | 3.00 | -163 | 5 | 3 | 8 | 5 | 31 | -1.00 | W | +2.4u |
...
| 2026-06-16 | MLB | ML | home | 3.0 | 0.50 | -138 | 0 | 0 | 0 | 0 | 28 | 0.70 | L | -0.5u |
| 2026-06-16 | MLB | ML | away | 3.0 | 0.50 | -102 | 1 | 0 | 1 | 1 | 26 | -1.00 | L | -0.5u |
| 2026-06-16 | MLB | SPREAD | away | 4.0 | 1.00 | -160 | 0 | 0 | 0 | 2 | 9 | 30.10 | W | +0.0u |
...
| 2026-06-17 | MLB | ML | home | 5.0 | 5.00 | -173 | 1 | 0 | 1 | 1 | -1 | 0.00 | W | +0.0u |
...
| 2026-06-17 | MLB | SPREAD | away | 5.0 | 5.00 | -181 | 0 | 0 | 0 | 1 | 4 | -0.80 | W | +0.0u |
| 2026-06-17 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 6 | 0.00 | L | -5.0u |
| 2026-06-17 | MLB | ML | home | 2.5 | 0.25 | -157 | 0 | 0 | 0 | 0 | 14 | -1.10 | W | +0.0u |
| 2026-06-17 | MLB | SPREAD | home | 2.5 | 0.25 | +125 | -1 | 0 | -1 | -1 | 13 | -0.60 | L | -0.3u |
| 2026-06-17 | MLB | ML | home | 5.0 | 5.00 | -123 | 1 | 0 | 1 | 0 | 15 | 0.00 | L | -5.0u |
| 2026-06-17 | MLB | SPREAD | home | 4.0 | 1.00 | +161 | 1 | 0 | 1 | 1 | 1 | 0.00 | L | -1.0u |
| 2026-06-18 | MLB | ML | home | 4.0 | 1.00 | -138 | 1 | 0 | 1 | 1 | 3 | 0.00 | W | +0.0u |
| 2026-06-18 | MLB | ML | home | 4.5 | 3.00 | -141 | 1 | 1 | 2 | 1 | 36 | -1.30 | L | -3.0u |
| 2026-06-18 | MLB | ML | home | 4.5 | 3.00 | -151 | 3 | 0 | 3 | 4 | 34 | -1.50 | W | +0.0u |
...
| 2026-06-18 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 3 | 0 | 3 | 3 | 5 | 0.00 | W | +2.8u |
