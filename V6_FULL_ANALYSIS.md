...
_Auto-generated **6/11/2026, 12:43:32 PM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 580 shipped+graded picks · 2026-04-18 → 2026-06-10  (HC analyses scoped to post-cutover 2026-04-30, 468 picks)
**Headline:** 292-283-5 · WR 50.8% [46.7%–54.9%] vs 52.4% break-even · -14.2u flat (-2.4%) · -47.1u peak.
...
- **ρ(Δw, flat ROI) = 0.012 ✗**  (full sample, N=574)
- **ρ(HC, flat ROI) = -0.023 ✗**  (post-cutover, N=468)
- **ρ(Δw+HC, flat ROI) = -0.056 ✗**  (post-cutover, N=468)
...
- **Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era)** — N=78, 33-45, WR 42.3% [32%–53%], flat ROI -20.9% (t=-1.95 ~ p<.10)

### Action map

- **Tier-1a (HC ≥ +2)** — N=41, WR 46.3%, flat ROI -14.1%. Bayesian posterior WR ≈ 47.1%, half-Kelly = **0.0%** bankroll at −110 → **size aggressively**.
- **Tier-1b (HC = +1)** — N=149, WR 55.7%, flat ROI +7.2%. Bayesian posterior WR ≈ 55.3%, half-Kelly = **3.1%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=78, WR 42.3%, flat ROI -20.9%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=101, WR 48.5%, flat ROI -2.2%. Bayesian posterior WR ≈ 48.6%, half-Kelly = **0.0%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -9.8% flat ROI on 145 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (0.99u/pick), we need **~1516 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 580. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **580** |
| W-L-P | 292-283-5 |
| Win rate | **50.8%** [46.7%–54.9%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +1.6 pp |
| Peak-units PnL | **-47.1u** |
| Flat-1u PnL | **-14.2u** (-2.4% flat ROI) |
| Flat t-statistic vs zero | -0.59 → ✗ noise |
| Flat 95% CI per-pick | [-0.105, 0.056]u |
...
We have **580** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = −1 | 19 | 5-14-0 | 26.3% [12–49] | -49.0% | -8.5u | -2.40 ✓ p<.05 |
| Δw = 0 | 120 | 61-56-3 | 52.1% [43–61] | -1.9% | +5.1u | -0.22 ✗ noise |
| Δw = +1 | 206 | 114-90-2 | 55.9% [49–63] | +5.8% | +18.8u | 0.87 ✗ noise |
| Δw = +2 | 122 | 57-65-0 | 46.7% [38–56] | -8.7% | -38.2u | -0.96 ✗ noise |
| Δw ≥ +3 | 101 | 49-52-0 | 48.5% [39–58] | -2.2% | -25.0u | -0.19 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.002** ✗  ·  **ρ(Δw, flat ROI) = 0.012** ✗  (N=574)
...
| HC = 0 | 257 | 128-125-4 | 50.6% [44–57] | -4.9% | -30.4u | -0.82 ✗ noise |
| HC = +1 | 149 | 83-66-0 | 55.7% [48–63] | +7.2% | -1.5u | 0.90 ✗ noise |
| HC = +2 | 31 | 16-15-0 | 51.6% [35–68] | -0.4% | -4.6u | -0.02 ✗ noise |
| HC ≥ +3 | 10 | 3-7-0 | 30.0% [11–60] | -56.7% | -8.8u | -2.57 ✓ p<.05 |

**Pearson ρ(HC, WIN) = -0.004** ✗  ·  **ρ(HC, flat ROI) = -0.023** ✗  (N=468)

Spearman rank ρ(HC, flat ROI) = 0.008.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 94 | 45-47-2 | 48.9% [39–59] | -6.2% | +0.0u | -0.61 ✗ noise |
| Σ = +1 | 137 | 78-57-2 | 57.8% [49–66] | +9.1% | +17.1u | 1.13 ✗ noise |
| Σ = +2 | 107 | 61-46-0 | 57.0% [48–66] | +6.9% | +4.3u | 0.75 ✗ noise |
| Σ = +3 | 54 | 21-33-0 | 38.9% [27–52] | -23.5% | -19.5u | -1.74 ~ p<.10 |
...
**Pearson ρ(Δw+HC, WIN) = -0.047** ✗  ·  **ρ(Σ, flat ROI) = -0.056** ✗  (N=468)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 468.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.060 ✗ | -0.062 ✗ | -0.042 | weak |
| HC margin | -0.004 ✗ | -0.023 ✗ | 0.008 | weak |
| Δw + HC | -0.047 ✗ | -0.056 ✗ | -0.030 | weak |
| peak.stars | -0.044 ✗ | -0.066 ✗ | -0.085 | weak |
| vault.star | -0.071 ✗ | -0.090 ~ p<.10 | -0.102 | weak |
| lock.stars | -0.023 ✗ | -0.039 ✗ | -0.046 | weak |
...
Universe N = 468 (post-cutover, both axes present).
...
| +0 | N=1 · 1-0 · 100% [21–100] · —  | N=2 · 0-2 · 0% [0–66] · —  | N=7 · 2-5 · 29% [8–64] · -50%  | N=65 · 34-29 · 54% [42–66] · +2%  | N=110 · 62-46 · 57% [48–66] · +9%  | N=48 · 23-25 · 48% [34–62] · -12%  | N=24 · 6-18 · 25% [12–45] · -54% ✗ |
| +1 | — | — | N=4 · 1-3 · 25% [5–70] · -56%  | N=25 · 14-11 · 56% [37–73] · +2%  | N=54 · 35-19 · 65% [51–76] · +23%  | N=33 · 15-18 · 45% [30–62] · -7%  | N=33 · 18-15 · 55% [38–70] · +7%  |
...
| Δw = −1 | 13 | 4-9-0 | 30.8% [13–58] | -41.4% | -4.0u | -1.60 ✗ noise |
| Δw = 0 | 97 | 54-41-2 | 56.8% [47–66] | +6.9% | +18.4u | 0.72 ✗ noise |
| Δw = +1 | 173 | 99-72-2 | 57.9% [50–65] | +9.6% | +23.4u | 1.33 ✗ noise |
| Δw = +2 | 97 | 46-51-0 | 47.4% [38–57] | -8.0% | -34.5u | -0.79 ✗ noise |
| Δw ≥ +3 | 83 | 36-47-0 | 43.4% [33–54] | -16.9% | -37.1u | -1.59 ✗ noise |

### §3d. Practical lock zones (v7.4 floor anatomy)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 190 | 102-88-0 | 53.7% [47–61] | +2.6% | -15.0u | 0.37 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 78 | 33-45-0 | 42.3% [32–53] | -20.9% | -31.8u | -1.95 ~ p<.10 |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 200 | 106-90-4 | 54.1% [47–61] | +2.9% | +10.2u | 0.43 ✗ noise |
...
Universe N = 553 picks where ≥1 proven wallet appeared on either side.
...
| Δcount = −1 | 28 | 14-14-0 | 50.0% [33–67] | -4.3% | -12.1u | -0.23 ✗ noise |
| Δcount = 0 (balanced) | 81 | 35-44-2 | 44.3% [34–55] | -14.9% | -8.6u | -1.39 ✗ noise |
| Δcount = +1 | 215 | 109-104-2 | 51.2% [44–58] | -3.8% | -25.9u | -0.59 ✗ noise |
| Δcount = +2 | 122 | 60-62-0 | 49.2% [40–58] | -6.5% | -21.8u | -0.73 ✗ noise |
| Δcount ≥ +3 (heavy support) | 96 | 60-36-0 | 62.5% [53–72] | +25.7% | +37.2u | 2.29 ✓ p<.05 |

**ρ(Δcount, WIN) = 0.077** ~ p<.10  ·  **ρ(Δcount, flat ROI) = 0.082** ~ p<.10
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 112 | 46-66-0 | 41.1% [32–50] | -20.6% | -55.5u | -2.26 ✓ p<.05 |
| Q2 | 128 | 58-69-1 | 45.7% [37–54] | -11.7% | -26.1u | -1.35 ✗ noise |
| Q3 (balanced) | 96 | 53-43-0 | 55.2% [45–65] | +5.7% | +0.2u | 0.57 ✗ noise |
| Q4 | 108 | 61-45-2 | 57.5% [48–67] | +9.7% | +17.9u | 1.02 ✗ noise |
| Q5 (best — heavy support) | 109 | 65-43-1 | 60.2% [51–69] | +16.0% | +29.0u | 1.60 ✗ noise |

**ρ(ΔWlNet, WIN) = 0.158** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.151** ✓ p<.01
...
Quintile cuts (units): ≤ -17.97 · ≤ -3.32 · ≤ 5.49 · ≤ 15.47 · > 15.47

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 121 | 54-66-1 | 45.0% [36–54] | -15.8% | -32.9u | -1.85 ~ p<.10 |
| Q2 | 101 | 43-58-0 | 42.6% [33–52] | -20.3% | -37.2u | -2.16 ✓ p<.05 |
| Q3 | 112 | 59-53-0 | 52.7% [43–62] | +0.5% | -4.9u | 0.06 ✗ noise |
| Q4 | 109 | 58-49-2 | 54.2% [45–63] | +2.0% | -0.0u | 0.22 ✗ noise |
| Q5 | 110 | 69-40-1 | 63.3% [54–72] | +29.2% | +40.5u | 2.82 ✓ p<.01 |
...
Quintile cuts (% ROI): ≤ -9.5 · ≤ -1.7 · ≤ 7.0 · ≤ 22.7 · > 22.7

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 117 | 34-82-1 | 29.3% [22–38] | -44.3% | -80.0u | -5.49 ✓ p<.01 |
| Q2 | 107 | 53-54-0 | 49.5% [40–59] | -8.8% | -12.1u | -0.97 ✗ noise |
| Q3 | 108 | 55-53-0 | 50.9% [42–60] | -3.1% | -18.7u | -0.33 ✗ noise |
| Q4 | 116 | 69-45-2 | 60.5% [51–69] | +14.9% | +21.9u | 1.68 ~ p<.10 |
| Q5 | 105 | 72-32-1 | 69.2% [60–77] | +40.7% | +54.4u | 4.00 ✓ p<.01 |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 52 | 10-41-1 | 19.6% [11–32] | -61.3% | -44.3u | -5.69 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 15 | 5-10-0 | 33.3% [15–58] | -37.8% | -7.8u | -1.58 ✗ noise |
| ΔBestRank = 0 (tied) | 1 | 0-1-0 | 0.0% [0–79] | -100.0% | -1.6u | 0.00 ✗ n<2 |
| ΔBestRank ∈ [+1,+4] | 20 | 8-12-0 | 40.0% [22–61] | -19.0% | -10.8u | -0.82 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 143 | 84-56-3 | 60.0% [52–68] | +19.9% | +23.4u | 2.22 ✓ p<.05 |

**ρ(ΔBestRank, WIN) = 0.333** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.381** ✓ p<.01  (N=231)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 29 | 7-22-0 | 24.1% [12–42] | -54.4% | -15.5u | -3.42 ✓ p<.01 |
| Δshare ∈ [−30,−10] pp | 5 | 1-4-0 | 20.0% [4–62] | -61.8% | -10.8u | -1.62 ✗ noise |
| Δshare ≈ 0 (±10 pp) | 360 | 177-181-2 | 49.4% [44–55] | -7.6% | -63.3u | -1.53 ✗ noise |
| Δshare ∈ [+10,+30] pp | 27 | 15-12-0 | 55.6% [37–72] | +17.8% | +0.8u | 0.79 ✗ noise |
| Δshare ≥ +30 pp | 132 | 83-47-2 | 63.8% [55–72] | +27.9% | +54.2u | 3.07 ✓ p<.01 |

**ρ(ΔTopQShare, WIN) = 0.175** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.196** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔTopQCount** | 0.198 ✓ p<.01 | 0.244 ✓ p<.01 | 0.216 |
| 2 | **ΔTopQShare** | 0.175 ✓ p<.01 | 0.196 ✓ p<.01 | 0.214 |
| 3 | **ΔWlNet** | 0.158 ✓ p<.01 | 0.151 ✓ p<.01 | 0.122 |
| 4 | **Δcount** | 0.077 ~ p<.10 | 0.082 ~ p<.10 | 0.075 |
| 5 | **ΔFlatPnl** | NaN — | NaN — | 0.175 |
| 6 | **ΔAvgRoi** | NaN — | NaN — | 0.289 |

_(ΔBestRank uses N=231 subset where both sides had a proven wallet — ρ(flat ROI) = 0.381 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 985, dateRange = 2026-04-18 → 2026-06-10, computedAt = 2026-06-11T16:41:21.473Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **553** rows · PIT aggregate computable on **550** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **550** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 381 · 55% · +5.8% | 326 · 53% · -1.6% | -7.3pp |
| WEAK (−3..0) | 152 · 43% · -15.7% | 207 · 51% · +1.6% | +17.3pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=309, WR=56%, ROI=+6.3% | N=247, WR=51%, ROI=-3.7% | -9.9pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=381, WR=55%, ROI=+5.8% | N=326, WR=53%, ROI=-1.6% | -7.3pp |
| AGS < −1 (mute veto) | N=52, WR=45%, ROI=-12.0% | N=123, WR=47%, ROI=-4.1% | +7.9pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-05-28 → 2026-06-10, N=222)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 109 · 56% · +6.6% |
| WEAK (−3..0) | 113 · 49% · -3.8% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=73, WR=58%, ROI=+8.7% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=109, WR=56%, ROI=+6.6% |
| AGS < −1 (mute veto) | N=71, WR=47%, ROI=-6.4% |
...
|---|---|---|---|---|
| `dCount` | COUNT | + | 1.04 | 1.50 |
| `dHcSizeRatio` | INTENSITY_HC | + | 0.91 | 4.32 |
| `dSumRankNorm` | QUALITY_RANK | − | 54.61 | 87.97 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.59 | 1.15 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **550/580** shipped+graded rows (95%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 87 | 44-43-0 | 50.6% [40–61] | -6.9% | -15.4u | -0.68 ✗ noise |
| LOCK | 101 | 48-53-0 | 47.5% [38–57] | -10.4% | -14.1u | -1.08 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 69 | 36-32-1 | 52.9% [41–64] | +1.8% | +8.3u | 0.16 ✗ noise |
| FADE | 129 | 58-68-3 | 46.0% [38–55] | -5.6% | -37.8u | -0.59 ✗ noise |
...
r(WIN) = **-0.013** ✗ · r(ROI) = **-0.046** ✗ · Spearman ρ(ROI) = **-0.048**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 114 | 58-54-2 | 51.8% [43–61] | +5.5% | -23.7u | 0.54 ✗ noise |
| z ∈ [−1, 0) | 190 | 103-85-2 | 54.8% [48–62] | +3.2% | +27.4u | 0.46 ✗ noise |
| z ∈ [0, +1) | 161 | 76-84-1 | 47.5% [40–55] | -9.5% | -35.0u | -1.25 ✗ noise |
| z ≥ +1 (very positive) | 85 | 41-44-0 | 48.2% [38–59] | -10.7% | -10.0u | -1.04 ✗ noise |
...
| z ∈ [0, +1) | 516 | 263-248-5 | 51.5% [47–56] | -2.1% | -38.3u | -0.50 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.063** ✗ · r(ROI) = **-0.072** ~ p<.10 · Spearman ρ(ROI) = **-0.071**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 102 | 57-44-1 | 56.4% [47–66] | +4.3% | -3.0u | 0.46 ✗ noise |
| z ∈ [−1, 0) | 188 | 101-85-2 | 54.3% [47–61] | +7.0% | +7.2u | 0.92 ✗ noise |
| z ∈ [0, +1) | 194 | 91-102-1 | 47.2% [40–54] | -9.3% | -39.4u | -1.33 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.063 ✗ | -0.072 ~ p<.10 | -0.071 |
| 2 | `dCount` | COUNT | -0.013 ✗ | -0.046 ✗ | -0.048 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | -0.032 | 0.811 | 49.1% | dominant |
| 2 | `dSumRankNorm` | -0.094 | 0.797 | 48.2% | meaningful |
| 3 | `dWinnerCtPreA` | -0.032 | 0.032 | 1.9% | silent (<0.2) |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.042 | +0.725 ⚠ | +0.042 |
| `dHcSizeRatio` | +0.042 | 1.000 | +0.017 | +1.000 ⚠ |
| `dSumRankNorm` | +0.725 ⚠ | +0.017 | 1.000 | +0.017 |
| `dWinnerCtPreA` | +0.042 | +1.000 ⚠ | +0.017 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **-0.012**. At AGS ≥ +0.12 fires N=255, WR=51.0%, ROI=-4.5%. At AGS ≥ +null fires N=336, WR=51.9%, ROI=-2.8%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-255 ROI (matched cohort) | Top-255 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.072 | +0.060 | WR=56%, ROI=+7.1% | -11.5pp | N=271, WR=56%, ROI=+6.4% |
| `dHcSizeRatio` | +0.045 | +0.033 | WR=54%, ROI=+2.0% | -6.4pp | N=261, WR=55%, ROI=+2.7% |
| `dSumRankNorm` | -0.050 | +0.039 | WR=48%, ROI=-9.9% | +5.5pp | N=254, WR=48%, ROI=-9.6% |
| `dWinnerCtPreA` | +0.048 | +0.036 | WR=54%, ROI=+2.0% | -6.4pp | N=250, WR=54%, ROI=+1.8% |
...
|---|---|---|---|---|
| 1 | `dHcSizeRatio` | +0.033 | -6.4pp | redundant — other features cover it |
| 2 | `dWinnerCtPreA` | +0.036 | -6.4pp | redundant — other features cover it |
| 3 | `dSumRankNorm` | +0.039 | +5.5pp | redundant — other features cover it |
| 4 | `dCount` | +0.060 | -11.5pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.150 | 0.150 | negative ↓ |
| 2 | `dCount` | COUNT | +0.050 | 0.050 | flat ≈ 0 |
| 3 | `dWinnerCtPreA` | QUALITY_TRACK | +0.038 | 0.038 | flat ≈ 0 |
| 4 | `dHcSizeRatio` | INTENSITY_HC | +0.016 | 0.016 | flat ≈ 0 |

Intercept b = +0.011 · Final log-loss = 0.6900 · N = 550.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 550 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/550 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 190 | 89-101-0 | 46.8% [40–54] | -14.2% | -69.3u | -2.09 ✓ p<.05 |
| 4.5★ | 83 | 54-28-1 | 65.9% [55–75] | +25.3% | +41.6u | 2.40 ✓ p<.05 |
| 4.0★ | 115 | 51-62-2 | 45.1% [36–54] | -11.9% | -13.9u | -1.29 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 75 | 39-35-1 | 52.7% [41–64] | +4.2% | -2.6u | 0.36 ✗ noise |
| 2.5★ | 79 | 40-38-1 | 51.3% [40–62] | -1.4% | -6.8u | -0.13 ✗ noise |

### §5b. Stars × Δw stratified — does the star tier hold up within each Δw cohort?

| Δw cohort | 5★ | 4.5★ | 4★ | 3.5★ | 3★ | 2.5★ |
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 28/57%/-1% | 23/61%/+18% | 23/36%/-27% | 6/33%/-26% | 30/38%/-29% | 34/48%/-7% |
| Δw = +1 | 34/53%/-3% | 32/68%/+24% | 55/46%/-10% | 28/54%/+4% | 27/67%/+31% | 29/55%/+2% |
| Δw = +2 | 61/43%/-19% | 14/64%/+20% | 30/50%/-1% | — | 9/44%/-3% | 8/38%/-16% |
| Δw ≥ +3 | 65/42%/-24% | 11/73%/+53% | 7/43%/-21% | 3/67%/+156% | 9/67%/+43% | 6/50%/+6% |
...
| −200/−151 | 52 | 27-25-0 | 51.9% [39–65] | -17.7% | -10.0u | -1.59 ✗ noise |
| −150/−101 | 354 | 176-175-3 | 50.1% [45–55] | -5.7% | -32.7u | -1.13 ✗ noise |
| −100/+100 | 6 | 3-3-0 | 50.0% [19–81] | +0.0% | -0.8u | 0.00 ✗ noise |
| +101/+150 | 114 | 54-58-2 | 48.2% [39–57] | +5.2% | -32.6u | 0.51 ✗ noise |
...
| −200/−151 | -40% (16) | +18% (16) | +24% (9) | -84% (10) |
| −150/−101 | -10% (85) | +2% (137) | -23% (71) | +1% (58) |
| −100/+100 | -100% (1) | +33% (3) | -100% (1) | +100% (1) |
| +101/+150 | +11% (26) | +5% (40) | +6% (31) | -6% (17) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 311 | 154-157-0 | 49.5% [44–55] | -4.2% | -48.1u | -0.72 ✗ noise |
| SPREAD | 88 | 43-44-1 | 49.4% [39–60] | -8.5% | +4.4u | -0.84 ✗ noise |
| TOTAL | 181 | 95-82-4 | 53.7% [46–61] | +3.5% | -3.5u | 0.50 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=79 · 44% · -18% | N=105 · 58% · +10% | N=62 · 47% · -5% | N=62 · 44% · -9% |
| SPREAD | N=23 · 36% · -30% | N=31 · 55% · +1% | N=17 · 65% · +15% | N=16 · 38% · -27% |
| TOTAL | N=43 · 61% · +17% | N=70 · 53% · +2% | N=43 · 40% · -23% | N=23 · 70% · +34% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 404 | 209-192-3 | 52.1% [47–57] | -1.0% | -11.3u | -0.21 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=107 · 51% · -4% | N=163 · 56% · +6% | N=87 · 47% · -8% | N=46 · 48% · -8% |
...
|---|---|---|
| **sharps3Plus** | 238 · 45% · -11.5% · -1.71 ~ p<.10 | 341 · 55% · +3.5% · 0.67 ✗ noise |
| **plusEV** | 64 · 48% · -2.3% · -0.15 ✗ noise | 515 · 51% · -2.7% · -0.64 ✗ noise |
| **pinnacleConfirms** | 139 · 51% · -1.1% · -0.12 ✗ noise | 282 · 51% · -3.5% · -0.61 ✗ noise |
| **invested10kPlus** | 285 · 50% · -3.4% · -0.56 ✗ noise | 136 · 51% · -1.3% · -0.16 ✗ noise |
| **lineMovingWith** | 273 · 54% · +2.7% · 0.45 ✗ noise | 306 · 48% · -7.5% · -1.34 ✗ noise |
| **predMarketAligns** | 144 · 51% · -2.6% · -0.30 ✗ noise | 277 · 51% · -2.8% · -0.47 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 153 | 81-72-0 | 52.9% [45–61] | +1.6% | +2.8u | 0.21 ✗ noise |
| 1 | 129 | 64-62-3 | 50.8% [42–59] | -3.1% | -22.3u | -0.37 ✗ noise |
| 2 | 134 | 68-64-2 | 51.5% [43–60] | -0.9% | +2.4u | -0.10 ✗ noise |
| 3 | 50 | 23-27-0 | 46.0% [33–60] | -11.5% | -10.7u | -0.81 ✗ noise |
| 4 | 50 | 24-26-0 | 48.0% [35–61] | -12.9% | -16.0u | -0.96 ✗ noise |
...
| NEAR_START | 230 | 107-119-4 | 47.3% [41–54] | -7.0% | -55.9u | -1.04 ✗ noise |
| NO_MOVE | 19 | 9-10-0 | 47.4% [27–68] | -13.5% | +1.5u | -0.62 ✗ noise |
| PREGAME | 99 | 56-43-0 | 56.6% [47–66] | +8.1% | +16.4u | 0.84 ✗ noise |
| SMALL_MOVE | 123 | 59-64-0 | 48.0% [39–57] | -8.4% | -14.8u | -0.94 ✗ noise |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 319 | 161-157-1 | 50.6% [45–56] | -4.7% | -58.8u | -0.88 ✗ noise |
| STRONG | 91 | 46-43-2 | 51.7% [41–62] | +2.0% | +4.7u | 0.19 ✗ noise |
| LEAN | 162 | 81-79-2 | 50.6% [43–58] | -1.0% | +5.5u | -0.12 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.102 ✓ p<.05 | -0.078 ~ p<.10 | -0.069 | -1.89 |
| totalInvested | -0.063 ✗ | -0.076 ~ p<.10 | -0.040 | -1.83 |
| evEdge | 0.094 ✓ p<.05 | 0.122 ✓ p<.01 | 0.065 | 2.95 |
| moneyPct | 0.034 ✗ | 0.007 ✗ | -0.003 | 0.16 |
| walletPct | 0.032 ✗ | 0.022 ✗ | 0.020 | 0.52 |
| criteriaMet | -0.027 ✗ | -0.017 ✗ | -0.045 | -0.41 |
| maxContribFor | -0.021 ✗ | -0.008 ✗ | 0.014 | -0.19 |
| meanBaseFor | -0.006 ✗ | 0.022 ✗ | 0.051 | 0.53 |
...
Sample with CLV: **568** picks. Mean CLV = **-0.0043**.
t-statistic vs zero: -3.26 → ✓ p<.01 · 95% CI [-0.0068, -0.0017]
...
| CLV (−2%, 0] | 331 | 165-163-3 | 50.3% [45–56] | -3.9% | -40.9u | -0.73 ✗ noise |
| CLV (0, +2%] | 148 | 78-70-0 | 52.7% [45–61] | +5.8% | -6.4u | 0.67 ✗ noise |
...
Trained on N=448 (with all features non-null). Intercept β₀ = 0.083.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | pw.ΔAvgRoi | +0.442 | ↑ helps |
| 2 | sharpCount | -0.289 | ↓ hurts |
| 3 | evEdge | +0.232 | ↑ helps |
| 4 | pw.Δcount | +0.192 | ↑ helps |
| 5 | log(impliedProb) | +0.162 | ↑ helps |
| 6 | peak.stars | -0.111 | ↓ hurts |
| 7 | pw.ΔFlatPnl | +0.108 | ↑ helps |
| 8 | HC margin | +0.106 | ↑ helps |
| 9 | pw.ΔWlNet | +0.094 | ↑ helps |
| 10 | Δw | -0.040 | ≈ flat |
| 11 | vault.star | +0.030 | ≈ flat |
| 12 | walletPct | +0.025 | ≈ flat |
| 13 | moneyPct | -0.024 | ≈ flat |
| 14 | odds (American) | -0.019 | ≈ flat |
| 15 | Δw + HC | +0.016 | ≈ flat |
| 16 | criteriaMet | -0.005 | ≈ flat |
| 17 | log10(invested) | +0.005 | ≈ flat |
| 18 | pw.ΔTopQShare | -0.001 | ≈ flat |
...
| Tier-1b HC = +1 (post-cutover) | 149 | 83-66 | 55.7% | 55.3% | -110 | 3.11% bankroll | 2.12u | ~ in range — 3.11u |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 78 | 33-45 | 42.3% | 43.2% | -110 | — (mute) | 2.06u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 101 | 49-52 | 48.5% | 48.6% | -110 | — (mute) | 2.47u | **MUTE** (negative EV at posterior) |
| Stale Δw = 0 | 120 | 61-56 | 52.1% | 52.0% | -110 | — (mute) | 1.80u | **MUTE** (negative EV at posterior) |
| Stale Δw ≤ −1 | 25 | 7-18 | 28.0% | 34.3% | -125 | — (mute) | 1.34u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.138  (annualized × √252 ≈ -2.19)
...
| 2026-05-16 | MLB | ML | away | 2.5 | 0.50 | -102 | 1 | 0 | 1 | 1 | -51 | 0.00 | W | +0.5u |
...
| 2026-05-21 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 0 | 0 | 2 | -7 | 0.00 | W | +0.3u |
...
| 2026-05-23 | MLB | ML | away | 2.5 | 2.75 | +109 | 2 | 0 | 2 | 2 | -26 | -0.50 | L | -2.8u |
| 2026-05-23 | MLB | TOTAL | over | 2.5 | 0.30 | -110 | 0 | 1 | 1 | 0 | -3 | 0.00 | W | +0.3u |
...
| 2026-05-23 | MLB | TOTAL | under | 2.5 | 0.30 | +108 | 0 | 0 | 0 | 0 | -12 | 0.00 | P | +0.0u |
| 2026-05-23 | MLB | ML | home | 4.0 | 2.50 | +118 | 1 | 0 | 1 | 1 | -7 | 1.10 | W | +2.9u |
| 2026-05-23 | MLB | ML | away | 3.0 | 1.25 | +166 | 2 | 1 | 3 | 2 | -22 | -0.30 | W | +1.8u |
...
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 1 | 1 | 2 | 0 | -25 | 0.00 | L | -1.6u |
...
| 2026-05-24 | MLB | ML | home | 2.5 | 0.50 | +144 | 1 | 1 | 2 | -1 | -50 | 0.00 | L | -0.5u |
...
| 2026-05-25 | MLB | TOTAL | over | 4.0 | 1.65 | +103 | 1 | 0 | 1 | 2 | -1 | 0.00 | L | -1.6u |
...
| 2026-05-25 | MLB | ML | away | 5.0 | 3.75 | -108 | 0 | 0 | 0 | 3 | -45 | -1.70 | L | -3.8u |
...
| 2026-05-26 | MLB | ML | away | 2.5 | 1.25 | +113 | 0 | 0 | 0 | 0 | 32 | -1.50 | W | +1.4u |
| 2026-05-26 | MLB | ML | home | 2.5 | 1.25 | -130 | 1 | 0 | 1 | 0 | 32 | -1.30 | W | +1.0u |
| 2026-05-26 | MLB | ML | away | 5.0 | 5.00 | -200 | 1 | 0 | 1 | 2 | 20 | -0.60 | W | +1.9u |
| 2026-05-26 | MLB | SPREAD | home | 4.0 | 1.00 | +105 | 1 | 0 | 1 | 2 | -1 | -0.20 | L | -1.0u |
...
| 2026-05-27 | MLB | SPREAD | away | 5.0 | 2.50 | +141 | 1 | 1 | 2 | 4 | -22 | 0.80 | L | -2.5u |
...
| 2026-05-27 | MLB | ML | away | 5.0 | 0.50 | -102 | 3 | 0 | 3 | 2 | 13 | -1.00 | L | -0.5u |
...
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 1.65 | +104 | 2 | 0 | 2 | 2 | -1 | 0.00 | W | +1.7u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 0.75 | +104 | 2 | 0 | 2 | 2 | 0 | 0.00 | W | +0.8u |
| 2026-05-27 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 2 | 5 | 3 | -20 | -0.30 | L | -2.5u |
...
| 2026-05-28 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 1 | 4 | 2 | -71 | -0.60 | L | -2.5u |
...
| 2026-05-29 | MLB | ML | home | 5.0 | 2.50 | +118 | 5 | 1 | 6 | 5 | 8 | -0.90 | L | -2.5u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 0.75 | -135 | 2 | 0 | 2 | 1 | -21 | 1.00 | L | -0.8u |
| 2026-05-29 | MLB | ML | home | 5.0 | 3.75 | -124 | 2 | 1 | 3 | 3 | 1 | -1.00 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 1.65 | -106 | 2 | 0 | 2 | 3 | 0 | 0.00 | L | -1.6u |
| 2026-05-29 | MLB | ML | home | 4.0 | 2.50 | +120 | 1 | 0 | 1 | 1 | -3 | 0.40 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 2.25 | -112 | 2 | 0 | 2 | 3 | 24 | 0.00 | W | +2.0u |
| 2026-05-29 | MLB | SPREAD | away | 4.0 | 0.75 | +150 | 0 | 0 | 0 | 1 | -6 | -0.50 | L | -0.8u |
| 2026-05-29 | MLB | ML | away | 5.0 | 2.50 | +140 | 2 | 1 | 3 | 1 | -19 | 1.00 | L | -2.5u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 1.65 | -103 | 0 | 0 | 0 | 2 | -25 | 0.00 | W | +1.6u |
| 2026-05-29 | MLB | ML | away | 4.5 | 1.25 | -142 | 0 | 1 | 1 | -1 | 19 | -1.20 | W | +0.3u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 1.65 | -135 | 1 | 0 | 1 | 2 | -25 | 0.40 | W | +1.2u |
| 2026-05-29 | MLB | ML | home | 4.5 | 1.25 | -134 | 1 | 0 | 1 | 0 | -4 | -1.70 | W | +2.8u |
| 2026-05-29 | MLB | SPREAD | away | 5.0 | 2.25 | -184 | 0 | 0 | 0 | 2 | -3 | -1.00 | W | +1.2u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 0.75 | -109 | 1 | 0 | 1 | 2 | 0 | 0.00 | W | +0.7u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.75 | -106 | 2 | 1 | 3 | 2 | 40 | 0.70 | L | -2.8u |
| 2026-05-29 | MLB | SPREAD | home | 4.0 | 1.65 | -175 | 0 | 0 | 0 | 2 | -25 | -0.80 | L | -1.6u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 0.30 | +105 | 2 | 1 | 3 | 1 | 14 | 0.00 | W | +0.3u |
...
| 2026-05-30 | MLB | ML | away | 4.0 | 3.75 | -132 | 1 | 1 | 2 | 1 | 50 | -1.00 | W | +2.9u |
| 2026-05-30 | MLB | SPREAD | home | 3.0 | 0.75 | -143 | 0 | 1 | 1 | 0 | 0 | -1.40 | L | -0.8u |
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -118 | 1 | 1 | 2 | 1 | -23 | -1.30 | L | -3.8u |
| 2026-05-30 | MLB | SPREAD | away | 4.0 | 1.00 | +152 | 1 | 0 | 1 | 1 | -6 | 0.20 | L | -1.0u |
| 2026-05-30 | MLB | ML | home | 5.0 | 5.00 | -120 | 0 | 0 | 0 | 3 | -45 | -1.10 | W | +4.2u |
| 2026-05-30 | MLB | TOTAL | over | 4.5 | 0.75 | +100 | 1 | 1 | 2 | 1 | 5 | 0.00 | W | +0.8u |
| 2026-05-30 | MLB | ML | home | 4.0 | 2.75 | -130 | 0 | 1 | 1 | 0 | 32 | -1.60 | W | +0.4u |
| 2026-05-30 | MLB | TOTAL | over | 4.0 | 2.25 | -116 | 2 | 0 | 2 | 2 | -1 | 0.00 | W | +1.9u |
| 2026-05-30 | MLB | TOTAL | under | 4.0 | 1.65 | -107 | 1 | 0 | 1 | 1 | 5 | 0.00 | L | -1.6u |
| 2026-05-30 | MLB | ML | home | 4.0 | 2.50 | +129 | 1 | 0 | 1 | 1 | -19 | -0.90 | W | +0.7u |
| 2026-05-30 | MLB | SPREAD | home | 5.0 | 1.65 | -120 | 2 | 1 | 3 | 2 | -25 | -0.60 | W | +1.4u |
| 2026-05-30 | MLB | ML | away | 5.0 | 2.50 | +108 | 1 | 0 | 1 | 3 | -45 | -0.90 | W | +2.7u |
| 2026-05-30 | MLB | ML | home | 4.0 | 0.50 | +110 | 1 | 0 | 1 | 1 | -19 | -0.20 | W | +0.6u |
| 2026-05-30 | MLB | ML | home | 5.0 | 1.25 | -102 | 2 | 0 | 2 | 2 | 7 | -0.70 | W | +1.2u |
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -122 | 1 | 1 | 2 | 2 | -26 | -0.20 | L | -3.8u |
...
| 2026-05-31 | MLB | TOTAL | under | 5.0 | 1.65 | -114 | 2 | 0 | 2 | 3 | -19 | 0.00 | L | -1.6u |
| 2026-05-31 | MLB | ML | home | 2.5 | 2.75 | -115 | 1 | 1 | 2 | 1 | 18 | 0.00 | W | +2.4u |
| 2026-05-31 | MLB | ML | away | 5.0 | 1.00 | +115 | -1 | 0 | -1 | 2 | -26 | -0.60 | L | -1.0u |
| 2026-05-31 | MLB | SPREAD | away | 5.0 | 1.00 | -117 | 3 | 1 | 4 | 3 | -20 | -0.20 | L | -1.0u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -164 | 0 | 1 | 1 | 2 | -26 | -1.20 | W | +2.3u |
| 2026-05-31 | MLB | ML | away | 3.0 | 1.25 | -184 | 0 | 0 | 0 | 0 | -14 | -1.70 | W | +0.7u |
| 2026-05-31 | MLB | ML | home | 2.5 | 1.25 | -232 | 0 | 0 | 0 | 1 | 23 | -0.50 | W | +0.5u |
...
| 2026-06-01 | MLB | ML | away | 5.0 | 2.50 | +160 | 2 | -1 | 1 | 2 | 46 | -1.30 | W | +2.7u |
| 2026-06-01 | MLB | TOTAL | under | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 2 | -37 | 0.00 | L | -1.0u |
| 2026-06-01 | MLB | ML | home | 3.0 | 0.50 | -142 | -1 | 0 | -1 | -1 | 31 | -0.40 | L | -0.5u |
| 2026-06-01 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 5 | 0.00 | L | -5.0u |
| 2026-06-01 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 2 | -30 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | ML | home | 2.5 | 0.25 | -215 | -1 | 0 | -1 | 0 | -5 | -1.40 | L | -0.3u |
| 2026-06-02 | MLB | TOTAL | under | 4.0 | 1.00 | -117 | 1 | 0 | 1 | 0 | 12 | 0.00 | L | -1.0u |
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +130 | 2 | 0 | 2 | 0 | 69 | -0.60 | W | +3.1u |
| 2026-06-02 | MLB | ML | away | 3.0 | 0.50 | +100 | 1 | 0 | 1 | 2 | 20 | -1.20 | W | +0.5u |
| 2026-06-02 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 17 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 17 | 0.00 | L | -3.0u |
...
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +134 | -1 | -1 | -2 | -1 | 52 | -1.00 | W | +1.2u |
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +125 | 0 | -1 | -1 | 0 | 58 | 0.40 | W | +1.3u |
| 2026-06-03 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 31 | 0.00 | L | -3.0u |
| 2026-06-03 | MLB | ML | home | 4.5 | 1.50 | +167 | 0 | 0 | 0 | -1 | 31 | -0.40 | L | -1.5u |
| 2026-06-03 | MLB | SPREAD | away | 4.0 | 1.00 | -111 | 1 | 0 | 1 | 0 | 11 | 0.20 | W | +0.8u |
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -103 | 3 | 1 | 4 | 3 | 7 | -1.20 | L | -0.5u |
| 2026-06-03 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 4 | 0.00 | L | -5.0u |
| 2026-06-03 | MLB | ML | away | 3.0 | 0.50 | +119 | 1 | 0 | 1 | 1 | 26 | 0.00 | W | +0.6u |
| 2026-06-03 | MLB | ML | away | 4.5 | 3.00 | -137 | 0 | 0 | 0 | -1 | 51 | -1.50 | L | -3.0u |
| 2026-06-03 | MLB | ML | home | 5.0 | 5.00 | -215 | 0 | 1 | 1 | 0 | 46 | -1.00 | W | +2.3u |
| 2026-06-03 | MLB | TOTAL | over | 2.5 | 0.25 | -110 | 1 | 1 | 2 | 1 | -8 | 0.00 | L | -0.3u |
| 2026-06-03 | MLB | TOTAL | under | 4.5 | 2.50 | -110 | 1 | 0 | 1 | 0 | 12 | 0.00 | W | +2.5u |
...
| 2026-06-03 | MLB | TOTAL | under | 4.5 | 2.50 | -110 | 1 | 0 | 1 | 0 | 12 | 0.00 | L | -2.5u |
...
| 2026-06-04 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | -1 | 0 | 1 | 17 | 0.00 | L | -1.0u |
...
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -188 | 0 | 0 | 0 | 0 | 32 | -1.10 | L | -1.0u |
| 2026-06-04 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 17 | 0.00 | W | +2.7u |
| 2026-06-04 | MLB | ML | home | 3.0 | 0.50 | -235 | 4 | 0 | 4 | 4 | 6 | 0.00 | L | -0.5u |
| 2026-06-04 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 0 | 23 | 0.00 | L | -5.0u |
| 2026-06-04 | NHL | ML | home | 2.5 | 0.25 | -160 | -3 | 0 | -3 | 2 | 9 | -0.40 | W | +0.2u |
| 2026-06-05 | MLB | ML | home | 2.5 | 0.25 | -144 | 1 | 1 | 2 | 0 | 30 | -1.20 | L | -0.3u |
| 2026-06-05 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | -1 | 33 | 0.00 | W | +2.8u |
| 2026-06-05 | MLB | ML | away | 3.0 | 0.50 | +128 | 1 | 0 | 1 | 1 | 5 | 0.00 | W | +0.6u |
| 2026-06-05 | MLB | TOTAL | over | 4.0 | 1.00 | -109 | 0 | 0 | 0 | 0 | 12 | 0.00 | P | +0.0u |
| 2026-06-05 | MLB | ML | home | 3.0 | 0.50 | -136 | 1 | 0 | 1 | 2 | 25 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 3 | 0 | 3 | 4 | -14 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | ML | away | 5.0 | 5.00 | -122 | 0 | 1 | 1 | 1 | 31 | -0.80 | L | -5.0u |
...
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 0 | -1 | -1 | 0 | 12 | 0.00 | W | +4.4u |
...
| 2026-06-06 | MLB | TOTAL | over | 2.5 | 0.25 | -110 | 1 | 0 | 1 | 0 | 33 | 0.00 | W | +0.2u |
| 2026-06-06 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 0 | 4 | 0.00 | W | +2.7u |
| 2026-06-06 | MLB | ML | home | 4.5 | 3.00 | -126 | 0 | 0 | 0 | 0 | 32 | -1.00 | W | +2.4u |
| 2026-06-06 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -14 | 0.00 | W | +2.7u |
| 2026-06-06 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 1 | 1 | -1 | 22 | 0.00 | L | -1.0u |
| 2026-06-06 | MLB | ML | home | 3.0 | 0.50 | -130 | 0 | 0 | 0 | -1 | 12 | -0.90 | L | -0.5u |
| 2026-06-06 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 5 | 0.00 | L | -5.0u |
| 2026-06-06 | MLB | ML | home | 4.5 | 3.00 | -350 | 0 | 1 | 1 | 0 | 48 | -0.90 | W | +0.9u |
| 2026-06-06 | MLB | TOTAL | under | 5.0 | 2.50 | -110 | 0 | 0 | 0 | 0 | 23 | 0.00 | L | -2.5u |
...
| 2026-06-06 | MLB | ML | home | 5.0 | 2.50 | +117 | -2 | -1 | -3 | -1 | 13 | 0.00 | L | -2.5u |
...
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | -107 | 1 | 0 | 1 | -1 | 64 | -0.80 | W | +0.2u |
| 2026-06-07 | MLB | TOTAL | over | 2.5 | 0.25 | -115 | 0 | 0 | 0 | -1 | -4 | 0.00 | W | +0.2u |
| 2026-06-07 | MLB | ML | home | 2.5 | 0.25 | -210 | -1 | 0 | -1 | 1 | 23 | 0.80 | L | -0.3u |
...
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | +102 | 1 | 0 | 1 | -2 | 29 | -0.20 | W | +0.5u |
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 2.25 | +164 | 1 | 1 | 2 | 1 | -6 | 29.50 | W | +3.7u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | +103 | -1 | 0 | -1 | -2 | -3 | 0.20 | W | +0.3u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | -1 | 0 | 1 | 17 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -102 | 2 | 0 | 2 | 0 | 32 | 0.50 | W | +1.0u |
| 2026-06-07 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 21 | 0.00 | W | +4.8u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | -127 | 0 | 1 | 1 | -1 | 64 | -1.90 | W | +0.4u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -3 | 0.00 | W | +0.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -113 | 6 | 1 | 7 | 5 | 23 | -0.50 | L | -3.0u |
| 2026-06-08 | MLB | ML | home | 4.5 | 3.00 | -129 | 3 | 0 | 3 | 1 | 64 | -0.40 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 0 | 11 | 0.00 | L | -3.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -121 | 1 | 1 | 2 | 1 | 37 | -1.60 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 18 | 0.00 | P | +0.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -146 | 1 | 0 | 1 | 1 | 38 | -0.50 | W | +2.0u |
| 2026-06-08 | MLB | ML | home | 4.0 | 1.00 | -118 | 2 | 0 | 2 | 3 | -21 | -0.40 | L | -1.0u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 2.50 | -116 | -2 | -2 | -4 | -1 | 42 | 0.00 | W | +2.5u |
...
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | +132 | 1 | 0 | 1 | 3 | 23 | -1.20 | L | -0.3u |
| 2026-06-09 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 23 | 0.00 | W | +4.3u |
| 2026-06-09 | MLB | ML | away | 3.0 | 0.50 | -148 | 1 | 0 | 1 | 3 | 15 | 0.00 | L | -0.5u |
...
| 2026-06-09 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 0 | 11 | 0.00 | W | +0.5u |
| 2026-06-09 | MLB | ML | away | 5.0 | 5.00 | -122 | 2 | 1 | 3 | 1 | 5 | 0.00 | W | +4.1u |
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | -120 | 0 | 0 | 0 | 0 | 21 | 0.00 | L | -0.3u |
| 2026-06-09 | MLB | ML | home | 4.0 | 1.00 | -107 | 1 | 0 | 1 | 0 | 31 | -1.30 | L | -1.0u |
| 2026-06-09 | MLB | ML | home | 5.0 | 5.00 | -105 | 1 | -1 | 0 | 1 | 4 | 0.00 | W | +4.8u |
| 2026-06-09 | MLB | ML | away | 4.5 | 2.50 | +115 | 1 | 0 | 1 | 0 | 32 | -0.70 | L | -2.5u |
...
| 2026-06-10 | MLB | ML | away | 4.5 | 3.00 | -148 | 0 | 0 | 0 | 0 | 10 | -0.50 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | +136 | 3 | 0 | 3 | 5 | 44 | -1.10 | L | -1.0u |
