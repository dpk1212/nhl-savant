...
_Auto-generated **5/18/2026, 12:17:07 PM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 204 shipped+graded picks · 2026-04-18 → 2026-05-17  (HC analyses scoped to post-cutover 2026-04-30, 92 picks)
**Headline:** 98-104-2 · WR 48.5% [41.7%–55.4%] vs 52.4% break-even · -7.2u flat (-3.6%) · -27.6u peak.
**Overall t-test:** t = -0.48 → ✗ noise.
...
- **ρ(Δw, flat ROI) = 0.169 ✓ p<.05**  (full sample, N=198)
- **ρ(HC, flat ROI) = 0.066 ✗**  (post-cutover, N=92)
- **ρ(Δw+HC, flat ROI) = 0.005 ✗**  (post-cutover, N=92)
...
- **Tier-1a (HC ≥ +2)** — N=11, WR 45.5%, flat ROI -9.3%. Bayesian posterior WR ≈ 47.6%, half-Kelly = **0.0%** bankroll at −110 → **size aggressively**.
- **Tier-1b (HC = +1)** — N=55, WR 58.2%, flat ROI +16.2%. Bayesian posterior WR ≈ 56.9%, half-Kelly = **4.8%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=15, WR 26.7%, flat ROI -50.6%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=43, WR 60.5%, flat ROI +30.8%. Bayesian posterior WR ≈ 58.5%, half-Kelly = **6.4%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -42.6% flat ROI on 42 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (1.05u/pick), we need **~1710 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 204. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **204** |
| W-L-P | 98-104-2 |
| Win rate | **48.5%** [41.7%–55.4%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +3.9 pp |
| Peak-units PnL | **-27.6u** |
| Flat-1u PnL | **-7.2u** (-3.6% flat ROI) |
| Flat t-statistic vs zero | -0.48 → ✗ noise |
| Flat 95% CI per-pick | [-0.180, 0.109]u |
...
We have **204** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = +1 | 66 | 38-27-1 | 58.5% [46–70] | +11.5% | +11.3u | 0.98 ✗ noise |
| Δw = +2 | 47 | 18-29-0 | 38.3% [26–53] | -23.4% | -22.0u | -1.60 ✗ noise |
| Δw ≥ +3 | 43 | 26-17-0 | 60.5% [46–74] | +30.8% | +1.6u | 1.58 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.142** ✓ p<.05  ·  **ρ(Δw, flat ROI) = 0.169** ✓ p<.05  (N=198)
...
| HC = 0 | 24 | 10-13-1 | 43.5% [26–63] | -18.0% | -15.1u | -0.95 ✗ noise |
| HC = +1 | 55 | 32-23-0 | 58.2% [45–70] | +16.2% | +2.2u | 1.17 ✗ noise |
| HC = +2 | 9 | 5-4-0 | 55.6% [27–81] | +10.8% | +3.7u | 0.31 ✗ noise |
| HC ≥ +3 | 2 | 0-2-0 | 0.0% [0–66] | -100.0% | -4.3u | 0.00 ✗ noise |

**Pearson ρ(HC, WIN) = 0.062** ✗  ·  **ρ(HC, flat ROI) = 0.066** ✗  (N=92)

Spearman rank ρ(HC, flat ROI) = 0.147.
...
| Σ = +3 | 14 | 4-10-0 | 28.6% [12–55] | -40.5% | -14.7u | -1.48 ✗ noise |
| Σ = +4 | 11 | 6-5-0 | 54.5% [28–79] | +8.9% | -7.7u | 0.27 ✗ noise |
| Σ = +5 | 7 | 4-3-0 | 57.1% [25–84] | +14.6% | +3.1u | 0.36 ✗ noise |
| Σ ≥ +6 | 6 | 3-3-0 | 50.0% [19–81] | +5.9% | -4.1u | 0.12 ✗ noise |

**Pearson ρ(Δw+HC, WIN) = -0.009** ✗  ·  **ρ(Σ, flat ROI) = 0.005** ✗  (N=92)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 92.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.044 ✗ | -0.029 ✗ | 0.002 | weak |
| HC margin | 0.062 ✗ | 0.066 ✗ | 0.147 | weak |
| Δw + HC | -0.009 ✗ | 0.005 ✗ | 0.063 | weak |
| peak.stars | -0.149 ✗ | -0.163 ✗ | -0.146 | weak |
| vault.star | -0.103 ✗ | -0.077 ✗ | -0.094 | weak |
| lock.stars | -0.133 ✗ | -0.174 ~ p<.10 | -0.163 | weak |
...
Universe N = 92 (post-cutover, both axes present).
...
| -2 | — | — | — | — | — | — | — |
| -1 | — | — | — | — | — | — | N=2 · 0-2 · 0% [0–66] · —  |
| +0 | — | — | — | N=1 · 0-1 · 0% [0–79] · —  | N=10 · 6-3 · 67% [35–88] · +23%  | N=8 · 3-5 · 38% [14–69] · -32%  | N=5 · 1-4 · 20% [4–62] · -61%  |
| +1 | — | — | N=1 · 0-1 · 0% [0–79] · —  | N=10 · 4-6 · 40% [17–69] · -19%  | N=22 · 17-5 · 77% [57–90] · +50% ★ | N=11 · 4-7 · 36% [15–65] · -24%  | N=11 · 7-4 · 64% [35–85] · +31%  |
| +2 | — | — | — | — | N=1 · 0-1 · 0% [0–79] · —  | N=2 · 0-2 · 0% [0–66] · —  | N=6 · 5-1 · 83% [44–97] · +66% ★ |
...
| Δw = +1 | 33 | 23-9-1 | 71.9% [55–84] | +37.3% | +15.9u | 2.42 ✓ p<.05 |
| Δw = +2 | 22 | 7-15-0 | 31.8% [16–53] | -37.3% | -18.2u | -1.80 ~ p<.10 |
| Δw ≥ +3 | 25 | 13-12-0 | 52.0% [33–70] | +5.4% | -10.5u | 0.25 ✗ noise |

### §3d. Practical lock zones (v7.4 floor anatomy)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 66 | 37-29-0 | 56.1% [44–67] | +11.9% | +1.6u | 0.94 ✗ noise |
...
Universe N = 184 picks where ≥1 proven wallet appeared on either side.
...
| Δcount = 0 (balanced) | 18 | 6-12-0 | 33.3% [16–56] | -41.1% | -13.3u | -2.00 ✓ p<.05 |
| Δcount = +1 | 48 | 27-20-1 | 57.4% [43–70] | +13.1% | +5.2u | 0.92 ✗ noise |
| Δcount = +2 | 54 | 23-30-1 | 43.4% [31–57] | -16.8% | -12.7u | -1.27 ✗ noise |
| Δcount ≥ +3 (heavy support) | 54 | 35-19-0 | 64.8% [51–76] | +36.7% | +13.5u | 2.27 ✓ p<.05 |

**ρ(Δcount, WIN) = 0.232** ✓ p<.01  ·  **ρ(Δcount, flat ROI) = 0.275** ✓ p<.01
...
| Q2 | 35 | 15-19-1 | 44.1% [29–61] | -9.3% | -2.8u | -0.53 ✗ noise |
| Q3 (balanced) | 33 | 15-18-0 | 45.5% [30–62] | -12.1% | -26.2u | -0.70 ✗ noise |
| Q4 | 37 | 22-15-0 | 59.5% [43–74] | +14.3% | +6.8u | 0.84 ✗ noise |
| Q5 (best — heavy support) | 35 | 23-11-1 | 67.6% [51–81] | +39.5% | +21.4u | 1.96 ~ p<.10 |

**ρ(ΔWlNet, WIN) = 0.224** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.197** ✓ p<.01
...
Quintile cuts (units): ≤ -2.45 · ≤ 0.05 · ≤ 2.76 · ≤ 9.40 · > 9.40

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 37 | 15-22-0 | 40.5% [26–57] | -19.4% | -11.9u | -1.17 ✗ noise |
| Q2 | 37 | 13-23-1 | 36.1% [22–52] | -26.2% | -16.0u | -1.62 ✗ noise |
| Q3 | 38 | 16-22-0 | 42.1% [28–58] | -22.2% | -24.5u | -1.46 ✗ noise |
| Q4 | 36 | 23-13-0 | 63.9% [48–78] | +21.1% | +6.6u | 1.34 ✗ noise |
| Q5 | 36 | 25-10-1 | 71.4% [55–84] | +55.0% | +27.8u | 2.64 ✓ p<.01 |

**ρ(ΔFlatPnl, WIN) = 0.267** ✓ p<.01  ·  **ρ(ΔFlatPnl, flat ROI) = 0.293** ✓ p<.01
...
Quintile cuts (% ROI): ≤ -9.2 · ≤ -0.1 · ≤ 9.2 · ≤ 27.6 · > 27.6

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 37 | 10-26-1 | 27.8% [16–44] | -38.1% | -26.0u | -2.23 ✓ p<.05 |
| Q2 | 38 | 16-22-0 | 42.1% [28–58] | -18.7% | -6.8u | -1.18 ✗ noise |
| Q3 | 36 | 11-25-0 | 30.6% [18–47] | -40.5% | -41.6u | -2.65 ✓ p<.01 |
| Q4 | 37 | 27-9-1 | 75.0% [59–86] | +40.3% | +23.2u | 2.79 ✓ p<.01 |
| Q5 | 36 | 28-8-0 | 77.8% [62–88] | +63.9% | +33.2u | 3.44 ✓ p<.01 |

**ρ(ΔAvgRoi, WIN) = 0.389** ✓ p<.01  ·  **ρ(ΔAvgRoi, flat ROI) = 0.379** ✓ p<.01
...
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 28 | 17-10-1 | 63.0% [44–78] | +30.2% | +8.7u | 1.40 ✗ noise |

**ρ(ΔBestRank, WIN) = 0.383** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.353** ✓ p<.01  (N=70)
...
| Δshare ≈ 0 (±10 pp) | 117 | 51-64-2 | 44.3% [36–53] | -15.6% | -46.2u | -1.76 ~ p<.10 |
| Δshare ∈ [+10,+30] pp | 14 | 8-6-0 | 57.1% [33–79] | +15.6% | +4.2u | 0.56 ✗ noise |
| Δshare ≥ +30 pp | 39 | 29-10-0 | 74.4% [59–85] | +55.2% | +28.8u | 3.03 ✓ p<.01 |

**ρ(ΔTopQShare, WIN) = 0.225** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.192** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔAvgRoi** | 0.389 ✓ p<.01 | 0.379 ✓ p<.01 | 0.360 |
| 2 | **ΔTopQCount** | 0.297 ✓ p<.01 | 0.324 ✓ p<.01 | 0.275 |
| 3 | **ΔFlatPnl** | 0.267 ✓ p<.01 | 0.293 ✓ p<.01 | 0.241 |
| 4 | **Δcount** | 0.232 ✓ p<.01 | 0.275 ✓ p<.01 | 0.196 |
| 5 | **ΔWlNet** | 0.224 ✓ p<.01 | 0.197 ✓ p<.01 | 0.183 |
| 6 | **ΔTopQShare** | 0.225 ✓ p<.01 | 0.192 ✓ p<.01 | 0.238 |

_(ΔBestRank uses N=70 subset where both sides had a proven wallet — ρ(flat ROI) = 0.353 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 395, dateRange = 2026-04-18 → 2026-05-17, computedAt = 2026-05-18T16:12:58.503Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **184** rows · PIT aggregate computable on **178** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **178** rows (34 used the cold-start fallback calibration for the early dates).
...
| NEUTRAL (0..+3) | 100 · 57% · +8.3% | 104 · 53% · +3.3% | -5.0pp |
| WEAK (−3..0) | 50 · 43% · -14.1% | 41 · 40% · -19.3% | -5.2pp |
| FADE (<−3) | 17 · 24% · -52.9% | 16 · 44% · +8.5% | +61.4pp |

Production-threshold lift (the rules that actually fire):

| Floor | In-sample fire | PIT-OOS fire | Δ ROI (OOS − in-sample) |
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=64, WR=60%, ROI=+19.0% | N=90, WR=58%, ROI=+11.5% | -7.5pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=102, WR=57%, ROI=+13.7% | N=112, WR=54%, ROI=+4.0% | -9.7pp |
| AGS < −1 (mute veto) | N=24, WR=21%, ROI=-61.3% | N=21, WR=43%, ROI=+9.5% | +70.8pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-05-04 → 2026-05-17, N=75)
...
| NEUTRAL (0..+3) | 51 · 51% · -0.4% |
| WEAK (−3..0) | 16 · 44% · -9.1% |
| FADE (<−3) | 4 · 50% · -4.5% |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=48, WR=56%, ROI=+8.2% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=55, WR=55%, ROI=+5.3% |
...
|---|---|---|---|---|
| `dCount` | COUNT | + | 1.43 | 1.58 |
| `dHcCount` | COUNT_HC | + | 0.45 | 0.82 |
| `dConvictionAvg` | INTENSITY | + | 0.53 | 0.55 |
| `dHcSizeRatio` | INTENSITY_HC | + | 1.50 | 5.25 |
| `forContribShare` | DOMINANCE | + | 0.81 | 0.25 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **178/204** shipped+graded rows (87%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| LOCK | 90 | 46-44-0 | 51.1% [41–61] | -1.9% | -18.9u | -0.19 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 34 | 12-21-1 | 36.4% [22–53] | -30.4% | -12.1u | -1.92 ~ p<.10 |
| FADE | 20 | 9-11-0 | 45.0% [26–66] | +15.0% | -8.8u | 0.43 ✗ noise |
...
r(WIN) = **0.116** ✗ · r(ROI) = **0.048** ✗ · Spearman ρ(ROI) = **0.070**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 20 | 9-11-0 | 45.0% [26–66] | +10.9% | -8.7u | 0.32 ✗ noise |
| z ∈ [−1, 0) | 64 | 30-32-2 | 48.4% [36–61] | -5.9% | -6.5u | -0.48 ✗ noise |
| z ∈ [0, +1) | 63 | 26-37-0 | 41.3% [30–54] | -21.5% | -26.0u | -1.78 ~ p<.10 |
| z ≥ +1 (very positive) | 31 | 19-12-0 | 61.3% [44–76] | +19.2% | +12.1u | 1.08 ✗ noise |
...
| z ∈ [0, +1) | 144 | 69-73-2 | 48.6% [41–57] | -5.6% | -26.0u | -0.68 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dConvictionAvg` (INTENSITY)

r(WIN) = **0.139** ~ p<.10 · r(ROI) = **0.037** ✗ · Spearman ρ(ROI) = **0.092**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 21 | 6-15-0 | 28.6% [14–50] | -21.5% | -13.9u | -0.67 ✗ noise |
| z ∈ [−1, 0) | 43 | 22-20-1 | 52.4% [38–67] | +1.8% | -5.0u | 0.11 ✗ noise |
| z ∈ [0, +1) | 92 | 44-47-1 | 48.4% [38–58] | -5.7% | -8.8u | -0.56 ✗ noise |
| z ≥ +1 (very positive) | 22 | 12-10-0 | 54.5% [35–73] | -0.8% | -1.3u | -0.04 ✗ noise |
...
r(WIN) = **0.096** ✗ · r(ROI) = **-0.006** ✗ · Spearman ρ(ROI) = **0.060**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 16 | 7-9-0 | 43.8% [23–67] | +14.2% | -6.4u | 0.35 ✗ noise |
| z ∈ [−1, 0) | 46 | 17-28-1 | 37.8% [25–52] | -25.4% | -22.1u | -1.75 ~ p<.10 |
| z ∈ [0, +1) | 116 | 60-55-1 | 52.2% [43–61] | +0.2% | -0.5u | 0.02 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |
...
|---|---|---|---|---|---|
| 1 | `dConvictionAvg` | INTENSITY | 0.139 ~ p<.10 | 0.037 ✗ | 0.092 |
| 2 | `dCount` | COUNT | 0.116 ✗ | 0.048 ✗ | 0.070 |
| 3 | `forContribShare` | DOMINANCE | 0.096 ✗ | -0.006 ✗ | 0.060 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | +0.210 | 0.790 | 32.1% | meaningful |
| 2 | `dConvictionAvg` | +0.095 | 0.777 | 31.5% | meaningful |
| 3 | `forContribShare` | +0.093 | 0.736 | 29.9% | meaningful |
| 4 | `dHcCount` | -0.106 | 0.106 | 4.3% | silent (<0.2) |
| 5 | `dHcSizeRatio` | -0.055 | 0.055 | 2.2% | silent (<0.2) |
...
|---|---|---|---|---|---|
| `dCount` | 1.000 | +0.305 | +0.286 | +0.305 | +0.526 |
| `dHcCount` | +0.305 | 1.000 | +0.142 | +1.000 ⚠ | +0.216 |
| `dConvictionAvg` | +0.286 | +0.142 | 1.000 | +0.142 | +0.877 ⚠ |
| `dHcSizeRatio` | +0.305 | +1.000 ⚠ | +0.142 | 1.000 | +0.216 |
| `forContribShare` | +0.526 | +0.216 | +0.877 ⚠ | +0.216 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **0.125**. At AGS ≥ +1 fires N=95, WR=55.8%, ROI=+7.6%. At AGS ≥ +null fires N=119, WR=51.7%, ROI=-0.6%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-95 ROI (matched cohort) | Top-95 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.093 | −0.032 | WR=52%, ROI=-0.5% | +8.0pp | N=80, WR=53%, ROI=+0.7% |
| `dHcCount` | +0.114 | −0.011 | WR=55%, ROI=+4.8% | +2.7pp | N=99, WR=54%, ROI=+3.2% |
| `dConvictionAvg` | +0.096 | −0.029 | WR=52%, ROI=+0.0% | +7.5pp | N=64, WR=52%, ROI=-0.1% |
| `dHcSizeRatio` | +0.123 | −0.002 | WR=55%, ROI=+4.8% | +2.7pp | N=98, WR=54%, ROI=+4.3% |
| `forContribShare` | +0.138 | +0.014 | WR=59%, ROI=+13.0% | -5.4pp | N=56, WR=55%, ROI=+6.4% |
...
|---|---|---|---|---|
| 1 | `dCount` | −0.032 | +8.0pp | carries marginal info |
| 2 | `dConvictionAvg` | −0.029 | +7.5pp | carries marginal info |
| 3 | `dHcCount` | −0.011 | +2.7pp | mild marginal info |
| 4 | `dHcSizeRatio` | −0.002 | +2.7pp | mild marginal info |
| 5 | `forContribShare` | +0.014 | -5.4pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dConvictionAvg` | INTENSITY | +0.267 | 0.267 | positive ↑ |
| 2 | `dCount` | COUNT | +0.148 | 0.148 | positive ↑ |
| 3 | `forContribShare` | DOMINANCE | -0.125 | 0.125 | negative ↓ |
| 4 | `dHcCount` | COUNT_HC | +0.003 | 0.003 | flat ≈ 0 |
| 5 | `dHcSizeRatio` | INTENSITY_HC | +0.002 | 0.002 | flat ≈ 0 |

Intercept b = -0.159 · Final log-loss = 0.6793 · N = 178.
...
|---|---|---|---|---|---|---|---|
| 1 | `dCount` | COUNT | #2 | #1 | #1 | #2 | 1.50 |
| 2 | `dConvictionAvg` | INTENSITY | #1 | #2 | #2 | #1 | 1.50 |
...
- **Workhorse**: `dCount` (COUNT) — ranks #2/#1/#1/#2 across the four lenses. Whatever else changes, this one stays.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 59 | 27-32-0 | 45.8% [34–58] | -16.6% | -27.7u | -1.35 ✗ noise |
| 4.5★ | 19 | 11-8-0 | 57.9% [36–77] | +19.3% | +6.0u | 0.73 ✗ noise |
| 4.0★ | 35 | 17-17-1 | 50.0% [34–66] | -1.7% | -0.9u | -0.10 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 19 | 7-11-1 | 38.9% [20–61] | -16.0% | -5.0u | -0.66 ✗ noise |
| 2.5★ | 34 | 17-17-0 | 50.0% [34–66] | -2.5% | -3.8u | -0.15 ✗ noise |
...
| Δw = +1 | 3/100%/+71% | 5/40%/-24% | 14/69%/+34% | 28/54%/+4% | 2/0%/-100% | 13/62%/+14% |
| Δw = +2 | 22/32%/-36% | 5/60%/+16% | 13/46%/-9% | — | 3/0%/-100% | 4/50%/+8% |
| Δw ≥ +3 | 29/48%/-12% | 4/75%/+90% | 2/100%/+91% | 3/67%/+156% | 4/100%/+133% | 1/100%/+145% |
...
| −150/−101 | 119 | 60-58-1 | 50.8% [42–60] | -3.2% | -0.1u | -0.37 ✗ noise |
| −100/+100 | 3 | 0-3-0 | 0.0% [0–56] | -100.0% | -4.5u | 0.00 ✗ noise |
| +101/+150 | 45 | 20-24-1 | 45.5% [32–60] | +0.4% | -19.5u | 0.03 ✗ noise |
...
| −150/−101 | -29% (23) | +21% (44) | -39% (28) | +18% (21) |
| −100/+100 | -100% (1) | -100% (1) | -100% (1) | — |
| +101/+150 | -7% (7) | -15% (14) | -1% (13) | +27% (11) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 110 | 52-58-0 | 47.3% [38–57] | -3.6% | -30.5u | -0.33 ✗ noise |
| SPREAD | 33 | 14-18-1 | 43.8% [28–61] | -15.8% | +1.5u | -0.96 ✗ noise |
| TOTAL | 61 | 32-28-1 | 53.3% [41–65] | +3.1% | +1.4u | 0.25 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=20 · 20% · -62% | N=35 · 57% · +8% | N=22 · 36% · -23% | N=30 · 60% · +35% |
| SPREAD | N=10 · 22% · -51% | N=9 · 33% · -35% | N=8 · 63% · +16% | N=5 · 60% · +17% |
| TOTAL | N=12 · 50% · -4% | N=22 · 71% · +36% | N=17 · 29% · -43% | N=8 · 63% · +22% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 83 | 37-46-0 | 44.6% [34–55] | -14.2% | -26.0u | -1.33 ✗ noise |
| NBA | 96 | 48-47-1 | 50.5% [41–60] | +2.9% | +3.3u | 0.25 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=12 · 25% · -47% | N=31 · 58% · +10% | N=24 · 29% · -45% | N=15 · 53% · +7% |
| NBA | N=25 · 25% · -52% | N=24 · 58% · +14% | N=16 · 50% · +3% | N=26 · 65% · +45% |
...
|---|---|---|
| **sharps3Plus** | 118 · 44% · -9.1% · -0.89 ✗ noise | 85 · 54% · +2.5% · 0.24 ✗ noise |
| **plusEV** | 27 · 37% · -20.0% · -0.78 ✗ noise | 176 · 50% · -1.8% · -0.24 ✗ noise |
| **pinnacleConfirms** | 57 · 46% · -5.9% · -0.38 ✗ noise | 74 · 49% · -4.3% · -0.35 ✗ noise |
| **invested10kPlus** | 107 · 45% · -8.2% · -0.75 ✗ noise | 24 · 58% · +9.6% · 0.49 ✗ noise |
| **lineMovingWith** | 112 · 49% · -3.0% · -0.30 ✗ noise | 91 · 48% · -5.8% · -0.53 ✗ noise |
| **predMarketAligns** | 49 · 51% · +2.6% · 0.16 ✗ noise | 82 · 45% · -9.5% · -0.82 ✗ noise |
...
| 1 | 42 | 18-23-1 | 43.9% [30–59] | -16.9% | -11.9u | -1.16 ✗ noise |
| 2 | 54 | 26-27-1 | 49.1% [36–62] | +0.4% | +9.0u | 0.03 ✗ noise |
| 3 | 25 | 12-13-0 | 48.0% [30–67] | -3.7% | -7.2u | -0.17 ✗ noise |
| 4 | 21 | 6-15-0 | 28.6% [14–50] | -41.5% | -19.0u | -1.99 ✓ p<.05 |
| 5 | 19 | 11-8-0 | 57.9% [36–77] | -0.4% | -0.2u | -0.02 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLEAR_MOVE | 48 | 30-17-1 | 63.8% [50–76] | +18.5% | +25.1u | 1.39 ✗ noise |
...
| SMALL_MOVE | 32 | 13-19-0 | 40.6% [26–58] | -16.9% | -17.0u | -0.90 ✗ noise |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 115 | 54-60-1 | 47.4% [38–56] | -11.3% | -27.0u | -1.29 ✗ noise |
| STRONG | 44 | 23-21-0 | 52.3% [38–66] | +4.5% | -0.3u | 0.29 ✗ noise |
| LEAN | 41 | 19-21-1 | 47.5% [33–63] | +8.4% | -1.6u | 0.40 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.081 ✗ | -0.013 ✗ | -0.038 | -0.18 |
| totalInvested | -0.108 ✗ | -0.086 ✗ | -0.028 | -1.23 |
| evEdge | 0.052 ✗ | 0.052 ✗ | 0.028 | 0.74 |
| moneyPct | -0.024 ✗ | -0.098 ✗ | -0.083 | -1.39 |
| walletPct | 0.051 ✗ | 0.009 ✗ | 0.008 | 0.12 |
| criteriaMet | -0.082 ✗ | -0.045 ✗ | -0.092 | -0.64 |
| maxContribFor | 0.029 ✗ | 0.045 ✗ | 0.073 | 0.64 |
| meanBaseFor | 0.010 ✗ | 0.025 ✗ | 0.050 | 0.36 |
...
Sample with CLV: **196** picks. Mean CLV = **-0.0031**.
t-statistic vs zero: -2.58 → ✓ p<.05 · 95% CI [-0.0054, -0.0007]

Bucketed CLV vs flat PnL:

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLV ≤ −2% | 18 | 10-8-0 | 55.6% [34–75] | -2.7% | +2.7u | -0.12 ✗ noise |
| CLV (−2%, 0] | 104 | 46-56-2 | 45.1% [36–55] | -10.3% | -31.3u | -1.02 ✗ noise |
| CLV (0, +2%] | 60 | 31-29-0 | 51.7% [39–64] | +10.9% | +2.8u | 0.71 ✗ noise |
...
Trained on N=93 (with all features non-null). Intercept β₀ = 0.059.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | pw.ΔAvgRoi | +0.573 | ↑ helps |
| 2 | pw.Δcount | +0.546 | ↑ helps |
| 3 | sharpCount | -0.412 | ↓ hurts |
| 4 | moneyPct | -0.339 | ↓ hurts |
| 5 | peak.stars | -0.319 | ↓ hurts |
| 6 | pw.ΔFlatPnl | +0.231 | ↑ helps |
| 7 | odds (American) | -0.206 | ↓ hurts |
| 8 | evEdge | +0.188 | ↑ helps |
| 9 | log(impliedProb) | +0.148 | ↑ helps |
| 10 | vault.star | -0.097 | ↓ hurts |
| 11 | criteriaMet | -0.089 | ↓ hurts |
| 12 | HC margin | +0.089 | ↑ helps |
| 13 | Δw | -0.083 | ↓ hurts |
| 14 | pw.ΔTopQShare | -0.061 | ↓ hurts |
| 15 | Δw + HC | -0.029 | ≈ flat |
| 16 | log10(invested) | +0.020 | ≈ flat |
| 17 | pw.ΔWlNet | +0.008 | ≈ flat |
...
|---|---|---|---|---|---|---|---|---|
| Tier-1a HC ≥ +2 (post-cutover) | 11 | 5-6 | 45.5% | 47.6% | -105 | — (mute) | 3.02u | **MUTE** (negative EV at posterior) |
| Tier-1b HC = +1 (post-cutover) | 55 | 32-23 | 58.2% | 56.9% | -108 | 5.20% bankroll | 1.77u | **UNDER-SIZED** — ship up to 5.20u (1u=1% bankroll) |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 15 | 4-11 | 26.7% | 36.0% | -110 | — (mute) | 2.02u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 43 | 26-17 | 60.5% | 58.5% | -105 | 7.45% bankroll | 2.73u | **UNDER-SIZED** — ship up to 7.45u (1u=1% bankroll) |
...
**Daily Sharpe-like (μ/σ):** -0.201  (annualized × √252 ≈ -3.19)
