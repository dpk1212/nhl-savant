...
_Auto-generated **6/17/2026, 12:31:55 PM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 678 shipped+graded picks · 2026-04-18 → 2026-06-16  (HC analyses scoped to post-cutover 2026-04-30, 566 picks)
**Headline:** 341-329-8 · WR 50.9% [47.1%–54.7%] vs 52.4% break-even · -18.2u flat (-2.7%) · -77.3u peak.
**Overall t-test:** t = -0.71 → ✗ noise.
...
- **ρ(Δw, flat ROI) = 0.007 ✗**  (full sample, N=672)
- **ρ(HC, flat ROI) = -0.021 ✗**  (post-cutover, N=566)
- **ρ(Δw+HC, flat ROI) = -0.050 ✗**  (post-cutover, N=566)
...
- **Tier-1b (HC = +1)** — N=161, WR 56.5%, flat ROI +8.3%. Bayesian posterior WR ≈ 56.1%, half-Kelly = **3.9%** bankroll at −110.
...
- **Stale Δw ≤ 0 (full sample)** — -8.5% flat ROI on 173 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (0.98u/pick), we need **~1488 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 678. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **678** |
| W-L-P | 341-329-8 |
| Win rate | **50.9%** [47.1%–54.7%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +1.5 pp |
| Peak-units PnL | **-77.3u** |
| Flat-1u PnL | **-18.2u** (-2.7% flat ROI) |
| Flat t-statistic vs zero | -0.71 → ✗ noise |
| Flat 95% CI per-pick | [-0.101, 0.047]u |
...
We have **678** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = −1 | 27 | 9-17-1 | 34.6% [19–54] | -33.4% | -9.3u | -1.90 ~ p<.10 |
| Δw = 0 | 140 | 71-66-3 | 51.8% [44–60] | -2.2% | +12.6u | -0.28 ✗ noise |
| Δw = +1 | 253 | 136-114-3 | 54.4% [48–60] | +2.8% | -21.6u | 0.47 ✗ noise |
| Δw = +2 | 137 | 67-69-1 | 49.3% [41–58] | -4.7% | -34.2u | -0.56 ✗ noise |
| Δw ≥ +3 | 109 | 52-57-0 | 47.7% [39–57] | -4.6% | -25.4u | -0.44 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.001** ✗  ·  **ρ(Δw, flat ROI) = 0.007** ✗  (N=672)
...
| HC = −1 | 25 | 14-11-0 | 56.0% [37–73] | +13.3% | +7.7u | 0.64 ✗ noise |
| HC = 0 | 335 | 163-165-7 | 49.7% [44–55] | -6.4% | -82.1u | -1.23 ✗ noise |
| HC = +1 | 161 | 91-70-0 | 56.5% [49–64] | +8.3% | +12.0u | 1.07 ✗ noise |
| HC = +2 | 32 | 17-15-0 | 53.1% [36–69] | +1.9% | -0.1u | 0.11 ✗ noise |
| HC ≥ +3 | 12 | 4-8-0 | 33.3% [14–61] | -50.4% | -6.7u | -2.38 ✓ p<.05 |

**Pearson ρ(HC, WIN) = -0.002** ✗  ·  **ρ(HC, flat ROI) = -0.021** ✗  (N=566)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 123 | 60-60-3 | 50.0% [41–59] | -5.1% | +4.5u | -0.59 ✗ noise |
| Σ = +1 | 180 | 98-79-3 | 55.4% [48–62] | +5.0% | -23.5u | 0.70 ✗ noise |
| Σ = +2 | 122 | 69-52-1 | 57.0% [48–65] | +6.7% | +3.8u | 0.78 ✗ noise |
...
**Pearson ρ(Δw+HC, WIN) = -0.037** ✗  ·  **ρ(Σ, flat ROI) = -0.050** ✗  (N=566)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 566.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.050 ✗ | -0.056 ✗ | -0.038 | weak |
| HC margin | -0.002 ✗ | -0.021 ✗ | 0.014 | weak |
| Δw + HC | -0.037 ✗ | -0.050 ✗ | -0.024 | weak |
| peak.stars | -0.055 ✗ | -0.071 ~ p<.10 | -0.074 | weak |
| vault.star | -0.022 ✗ | -0.036 ✗ | -0.057 | weak |
| lock.stars | -0.036 ✗ | -0.048 ✗ | -0.049 | weak |
...
Universe N = 566 (post-cutover, both axes present).

| HC \ Δw | ≤ −3 | -2 | -1 | +0 | +1 | +2 | ≥ +3 |
|---|---|---|---|---|---|---|---|
| ≤ −3 | — | — | — | — | — | — | — |
| -2 | — | N=1 · 1-0 · 100% [21–100] · —  | — | — | — | — | — |
| -1 | — | N=1 · 0-1 · 0% [0–79] · —  | N=4 · 2-2 · 50% [15–85] · +6%  | N=6 · 5-1 · 83% [44–97] · +75% ★ | N=8 · 3-5 · 38% [14–69] · -35%  | N=2 · 2-0 · 100% [34–100] · — ★ | N=4 · 2-2 · 50% [15–85] · -1%  |
| +0 | N=1 · 1-0 · 100% [21–100] · —  | N=2 · 0-2 · 0% [0–66] · —  | N=11 · 3-7 · 30% [11–60] · -42%  | N=83 · 42-39 · 52% [41–62] · -2%  | N=152 · 81-68 · 54% [46–62] · +3%  | N=60 · 30-29 · 51% [38–63] · -6%  | N=26 · 6-20 · 23% [11–42] · -58% ✗ |
| +1 | — | — | N=6 · 3-3 · 50% [19–81] · -12%  | N=26 · 15-11 · 58% [39–74] · +7%  | N=57 · 36-21 · 63% [50–74] · +20%  | N=36 · 18-18 · 50% [34–66] · -1%  | N=36 · 19-17 · 53% [37–68] · +3%  |
...
| Δw = −1 | 21 | 8-12-1 | 40.0% [22–61] | -24.1% | -4.9u | -1.19 ✗ noise |
| Δw = 0 | 117 | 64-51-2 | 55.7% [47–64] | +5.1% | +25.9u | 0.57 ✗ noise |
| Δw = +1 | 220 | 121-96-3 | 55.8% [49–62] | +5.4% | -17.1u | 0.84 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 205 | 112-93-0 | 54.6% [48–61] | +3.8% | +5.1u | 0.56 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 92 | 40-51-1 | 44.0% [34–54] | -17.7% | -42.6u | -1.80 ~ p<.10 |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 269 | 138-125-6 | 52.5% [46–58] | -0.3% | -29.3u | -0.06 ✗ noise |
...
Universe N = 656 picks where ≥1 proven wallet appeared on either side.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δcount ≤ −2 (heavy oppose) | 10 | 4-6-0 | 40.0% [17–69] | -25.5% | -5.3u | -0.83 ✗ noise |
| Δcount = −1 | 44 | 23-21-0 | 52.3% [38–66] | +3.6% | -7.4u | 0.24 ✗ noise |
| Δcount = 0 (balanced) | 107 | 47-58-2 | 44.8% [36–54] | -13.2% | -12.6u | -1.40 ✗ noise |
| Δcount = +1 | 251 | 125-125-1 | 50.0% [44–56] | -6.4% | -69.6u | -1.07 ✗ noise |
| Δcount = +2 | 140 | 70-69-1 | 50.4% [42–59] | -5.0% | -21.8u | -0.61 ✗ noise |
| Δcount ≥ +3 (heavy support) | 104 | 64-37-3 | 63.4% [54–72] | +25.4% | +45.3u | 2.43 ✓ p<.05 |

**ρ(Δcount, WIN) = 0.066** ~ p<.10  ·  **ρ(Δcount, flat ROI) = 0.077** ✓ p<.05
...
Quintile cuts: ≤ -12 · ≤ 1 · ≤ 8 · ≤ 22 · > 22

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 132 | 59-73-0 | 44.7% [36–53] | -13.3% | -47.3u | -1.55 ✗ noise |
| Q2 | 146 | 60-83-3 | 42.0% [34–50] | -18.2% | -43.7u | -2.30 ✓ p<.05 |
| Q3 (balanced) | 117 | 60-55-2 | 52.2% [43–61] | -0.9% | -18.9u | -0.10 ✗ noise |
| Q4 | 133 | 76-56-1 | 57.6% [49–66] | +11.6% | +7.9u | 1.34 ✗ noise |
| Q5 (best — heavy support) | 128 | 78-49-1 | 61.4% [53–69] | +14.1% | +30.5u | 1.60 ✗ noise |

**ρ(ΔWlNet, WIN) = 0.150** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.128** ✓ p<.01
...
Quintile cuts (units): ≤ -12.66 · ≤ -1.58 · ≤ 5.65 · ≤ 14.19 · > 14.19

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 137 | 61-75-1 | 44.9% [37–53] | -16.6% | -48.6u | -2.09 ✓ p<.05 |
| Q2 | 126 | 55-68-3 | 44.7% [36–54] | -15.7% | -15.3u | -1.88 ~ p<.10 |
| Q3 | 131 | 65-66-0 | 49.6% [41–58] | -7.4% | -22.7u | -0.89 ✗ noise |
| Q4 | 131 | 75-53-3 | 58.6% [50–67] | +12.6% | -3.1u | 1.49 ✗ noise |
| Q5 | 131 | 77-54-0 | 58.8% [50–67] | +18.3% | +18.5u | 1.93 ~ p<.10 |
...
Quintile cuts (% ROI): ≤ -8.8 · ≤ -0.5 · ≤ 7.0 · ≤ 22.0 · > 22.0

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 136 | 40-96-0 | 29.4% [22–38] | -43.6% | -97.1u | -5.72 ✓ p<.01 |
| Q2 | 131 | 71-58-2 | 55.0% [46–63] | +1.5% | +6.8u | 0.18 ✗ noise |
| Q3 | 127 | 64-61-2 | 51.2% [43–60] | -3.6% | -1.3u | -0.42 ✗ noise |
| Q4 | 132 | 80-51-1 | 61.1% [53–69] | +17.3% | +24.1u | 2.06 ✓ p<.05 |
| Q5 | 130 | 78-50-2 | 60.9% [52–69] | +21.1% | -3.9u | 2.28 ✓ p<.05 |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 70 | 16-53-1 | 23.2% [15–34] | -54.3% | -52.0u | -5.45 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 14 | 7-7-0 | 50.0% [27–73] | -4.1% | -0.3u | -0.15 ✗ noise |
| ΔBestRank = 0 (tied) | 1 | 1-0-0 | 100.0% [21–100] | +90.9% | +0.3u | 0.00 ✗ n<2 |
| ΔBestRank ∈ [+1,+4] | 17 | 6-11-0 | 35.3% [17–59] | -28.6% | -6.6u | -1.16 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 186 | 109-74-3 | 59.6% [52–66] | +17.9% | +25.4u | 2.34 ✓ p<.05 |

**ρ(ΔBestRank, WIN) = 0.317** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.341** ✓ p<.01  (N=288)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 37 | 11-26-0 | 29.7% [17–46] | -43.7% | -22.8u | -2.96 ✓ p<.01 |
| Δshare ∈ [−30,−10] pp | 5 | 0-5-0 | 0.0% [0–43] | -100.0% | -3.3u | 0.00 ✗ noise |
| Δshare ≈ 0 (±10 pp) | 456 | 221-230-5 | 49.0% [44–54] | -7.5% | -84.2u | -1.68 ~ p<.10 |
| Δshare ∈ [+10,+30] pp | 27 | 14-13-0 | 51.9% [34–69] | +1.2% | -1.4u | 0.06 ✗ noise |
| Δshare ≥ +30 pp | 131 | 87-42-2 | 67.4% [59–75] | +33.1% | +40.3u | 3.69 ✓ p<.01 |

**ρ(ΔTopQShare, WIN) = 0.163** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.173** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔTopQCount** | 0.178 ✓ p<.01 | 0.212 ✓ p<.01 | 0.181 |
| 2 | **ΔTopQShare** | 0.163 ✓ p<.01 | 0.173 ✓ p<.01 | 0.189 |
| 3 | **ΔWlNet** | 0.150 ✓ p<.01 | 0.128 ✓ p<.01 | 0.088 |
| 4 | **Δcount** | 0.066 ~ p<.10 | 0.077 ✓ p<.05 | 0.069 |
| 5 | **ΔFlatPnl** | NaN — | NaN — | 0.144 |
| 6 | **ΔAvgRoi** | NaN — | NaN — | 0.225 |

_(ΔBestRank uses N=288 subset where both sides had a proven wallet — ρ(flat ROI) = 0.341 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 1172, dateRange = 2026-04-18 → 2026-06-16, computedAt = 2026-06-17T16:28:23.476Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **656** rows · PIT aggregate computable on **648** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **648** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 456 · 54% · +2.2% | 386 · 52% · -3.1% | -5.4pp |
| WEAK (−3..0) | 180 · 46% · -10.6% | 250 · 51% · +1.3% | +11.9pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=358, WR=55%, ROI=+3.5% | N=292, WR=51%, ROI=-4.8% | -8.3pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=456, WR=54%, ROI=+2.2% | N=386, WR=52%, ROI=-3.1% | -5.4pp |
| AGS < −1 (mute veto) | N=64, WR=48%, ROI=-6.7% | N=149, WR=49%, ROI=-1.7% | +5.0pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-06-03 → 2026-06-16, N=245)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 122 · 54% · -0.9% |
| WEAK (−3..0) | 123 · 53% · +3.4% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=90, WR=55%, ROI=+0.0% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=122, WR=54%, ROI=-0.9% |
| AGS < −1 (mute veto) | N=80, WR=53%, ROI=+4.7% |
...
| `dHcSizeRatio` | INTENSITY_HC | + | 0.85 | 4.24 |
| `dSumRankNorm` | QUALITY_RANK | − | 52.71 | 86.43 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.55 | 1.09 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **648/678** shipped+graded rows (96%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 107 | 54-51-2 | 51.4% [42–61] | -5.7% | -26.0u | -0.64 ✗ noise |
| LOCK | 113 | 52-61-0 | 46.0% [37–55] | -13.0% | -30.5u | -1.43 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 84 | 41-41-2 | 50.0% [39–61] | -3.4% | -5.8u | -0.32 ✗ noise |
| FADE | 157 | 75-79-3 | 48.7% [41–57] | -2.0% | -24.7u | -0.24 ✗ noise |
...
r(WIN) = **-0.010** ✗ · r(ROI) = **-0.037** ✗ · Spearman ρ(ROI) = **-0.046**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 148 | 76-70-2 | 52.1% [44–60] | +4.5% | -14.8u | 0.52 ✗ noise |
| z ∈ [−1, 0) | 208 | 113-92-3 | 55.1% [48–62] | +3.7% | +8.2u | 0.56 ✗ noise |
| z ∈ [0, +1) | 198 | 92-105-1 | 46.7% [40–54] | -11.6% | -59.6u | -1.70 ~ p<.10 |
| z ≥ +1 (very positive) | 94 | 46-46-2 | 50.0% [40–60] | -8.0% | -5.3u | -0.83 ✗ noise |
...
| z ∈ [0, +1) | 614 | 312-294-8 | 51.5% [48–55] | -2.4% | -68.5u | -0.63 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.047** ✗ · r(ROI) = **-0.055** ✗ · Spearman ρ(ROI) = **-0.060**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 120 | 65-54-1 | 54.6% [46–63] | +1.5% | -12.9u | 0.17 ✗ noise |
| z ∈ [−1, 0) | 241 | 128-111-2 | 53.6% [47–60] | +4.2% | -12.2u | 0.65 ✗ noise |
| z ∈ [0, +1) | 214 | 100-110-4 | 47.6% [41–54] | -8.5% | -43.6u | -1.29 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.047 ✗ | -0.055 ✗ | -0.060 |
| 2 | `dCount` | COUNT | -0.010 ✗ | -0.037 ✗ | -0.046 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | -0.064 | 0.809 | 49.6% | dominant |
| 2 | `dSumRankNorm` | -0.141 | 0.787 | 48.2% | meaningful |
| 3 | `dWinnerCtPreA` | -0.026 | 0.026 | 1.6% | silent (<0.2) |
| 4 | `dHcSizeRatio` | -0.011 | 0.011 | 0.6% | silent (<0.2) |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.025 | +0.722 ⚠ | +0.025 |
| `dHcSizeRatio` | +0.025 | 1.000 | +0.000 | +1.000 ⚠ |
| `dSumRankNorm` | +0.722 ⚠ | +0.000 | 1.000 | +0.000 |
| `dWinnerCtPreA` | +0.025 | +1.000 ⚠ | +0.000 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **-0.017**. At AGS ≥ +0.12 fires N=296, WR=51.0%, ROI=-4.8%. At AGS ≥ +null fires N=391, WR=51.8%, ROI=-3.4%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-296 ROI (matched cohort) | Top-296 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.064 | +0.047 | WR=56%, ROI=+7.1% | -12.0pp | N=330, WR=55%, ROI=+4.6% |
| `dHcSizeRatio` | +0.033 | +0.016 | WR=54%, ROI=+0.8% | -5.6pp | N=311, WR=54%, ROI=+1.6% |
| `dSumRankNorm` | -0.052 | +0.035 | WR=47%, ROI=-11.0% | +6.2pp | N=288, WR=48%, ROI=-9.2% |
| `dWinnerCtPreA` | +0.035 | +0.018 | WR=54%, ROI=+0.8% | -5.6pp | N=300, WR=54%, ROI=+0.7% |
...
|---|---|---|---|---|
| 1 | `dHcSizeRatio` | +0.016 | -5.6pp | redundant — other features cover it |
| 2 | `dWinnerCtPreA` | +0.018 | -5.6pp | redundant — other features cover it |
| 3 | `dSumRankNorm` | +0.035 | +6.2pp | redundant — other features cover it |
| 4 | `dCount` | +0.047 | -12.0pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.113 | 0.113 | negative ↓ |
| 2 | `dCount` | COUNT | +0.035 | 0.035 | flat ≈ 0 |
| 3 | `dWinnerCtPreA` | QUALITY_TRACK | +0.031 | 0.031 | flat ≈ 0 |
| 4 | `dHcSizeRatio` | INTENSITY_HC | +0.012 | 0.012 | flat ≈ 0 |

Intercept b = +0.006 · Final log-loss = 0.6913 · N = 648.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 648 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/648 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 208 | 97-111-0 | 46.6% [40–53] | -14.0% | -80.8u | -2.14 ✓ p<.05 |
| 4.5★ | 107 | 64-41-2 | 61.0% [51–70] | +15.3% | +24.9u | 1.64 ✗ noise |
| 4.0★ | 143 | 66-75-2 | 46.8% [39–55] | -9.3% | -19.5u | -1.13 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 90 | 47-40-3 | 54.0% [44–64] | +4.2% | +1.2u | 0.41 ✗ noise |
| 2.5★ | 92 | 48-43-1 | 52.7% [43–63] | +0.7% | -7.0u | 0.07 ✗ noise |

### §5b. Stars × Δw stratified — does the star tier hold up within each Δw cohort?

| Δw cohort | 5★ | 4.5★ | 4★ | 3.5★ | 3★ | 2.5★ |
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 33/61%/+8% | 29/59%/+13% | 32/35%/-30% | 6/33%/-26% | 32/37%/-31% | 40/51%/-3% |
| Δw = +1 | 42/48%/-12% | 46/59%/+9% | 71/49%/-6% | 28/54%/+4% | 32/66%/+26% | 33/58%/+7% |
...
| −200/−151 | 66 | 35-31-0 | 53.0% [41–65] | -15.5% | -25.7u | -1.57 ✗ noise |
| −150/−101 | 413 | 209-199-5 | 51.2% [46–56] | -3.8% | -33.1u | -0.82 ✗ noise |
| −100/+100 | 8 | 4-4-0 | 50.0% [22–78] | +0.0% | -0.8u | 0.00 ✗ noise |
| +101/+150 | 130 | 57-70-3 | 44.9% [37–54] | -1.9% | -41.1u | -0.20 ✗ noise |
| +151/+200 | 18 | 10-8-0 | 55.6% [34–75] | +47.3% | +7.3u | 1.48 ✗ noise |
...
| −200/−151 | -33% (19) | +1% (25) | +27% (10) | -70% (11) |
| −150/−101 | -5% (102) | +0% (165) | -15% (81) | +1% (62) |
| −100/+100 | -100% (2) | +50% (4) | -100% (1) | +100% (1) |
| +101/+150 | +1% (33) | -4% (45) | +7% (33) | -16% (19) |
| +151/+200 | +26% (2) | +87% (7) | +37% (6) | +32% (2) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 365 | 182-182-1 | 50.0% [45–55] | -4.2% | -56.3u | -0.80 ✗ noise |
| SPREAD | 107 | 53-52-2 | 50.5% [41–60] | -5.8% | -7.3u | -0.63 ✗ noise |
| TOTAL | 206 | 106-95-5 | 52.7% [46–60] | +1.7% | -13.6u | 0.26 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=94 · 45% · -16% | N=126 · 56% · +4% | N=73 · 52% · +3% | N=69 · 43% · -11% |
| SPREAD | N=27 · 35% · -34% | N=44 · 58% · +9% | N=19 · 63% · +13% | N=16 · 38% · -27% |
| TOTAL | N=52 · 62% · +19% | N=83 · 51% · -3% | N=45 · 39% · -24% | N=24 · 67% · +29% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 498 | 256-237-5 | 51.9% [48–56] | -1.8% | -45.8u | -0.41 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=133 · 51% · -5% | N=210 · 54% · +3% | N=101 · 50% · -3% | N=53 · 47% · -11% |
...
|---|---|---|
| **sharps3Plus** | 261 · 46% · -10.0% · -1.58 ✗ noise | 416 · 54% · +1.6% · 0.33 ✗ noise |
| **plusEV** | 73 · 48% · -5.1% · -0.38 ✗ noise | 604 · 51% · -2.6% · -0.67 ✗ noise |
| **pinnacleConfirms** | 159 · 53% · +0.7% · 0.08 ✗ noise | 353 · 50% · -4.6% · -0.89 ✗ noise |
| **invested10kPlus** | 331 · 51% · -3.0% · -0.55 ✗ noise | 181 · 51% · -2.9% · -0.39 ✗ noise |
| **lineMovingWith** | 304 · 54% · +3.4% · 0.59 ✗ noise | 373 · 48% · -8.0% · -1.58 ✗ noise |
| **predMarketAligns** | 169 · 52% · -1.7% · -0.21 ✗ noise | 343 · 50% · -3.6% · -0.68 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 196 | 101-95-0 | 51.5% [45–58] | -0.4% | -18.8u | -0.06 ✗ noise |
| 1 | 143 | 69-69-5 | 50.0% [42–58] | -4.9% | -29.6u | -0.61 ✗ noise |
| 2 | 152 | 77-72-3 | 51.7% [44–60] | -1.2% | -1.0u | -0.16 ✗ noise |
| 3 | 59 | 29-30-0 | 49.2% [37–62] | -7.7% | -10.6u | -0.60 ✗ noise |
| 4 | 58 | 30-28-0 | 51.7% [39–64] | -6.5% | -10.4u | -0.53 ✗ noise |
...
| NEAR_START | 269 | 127-137-5 | 48.1% [42–54] | -6.7% | -64.0u | -1.09 ✗ noise |
| NO_MOVE | 22 | 11-11-0 | 50.0% [31–69] | -8.3% | +5.7u | -0.41 ✗ noise |
| PREGAME | 133 | 71-62-0 | 53.4% [45–62] | +3.1% | -9.2u | 0.36 ✗ noise |
| SMALL_MOVE | 142 | 70-70-2 | 50.0% [42–58] | -5.4% | -11.8u | -0.66 ✗ noise |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 381 | 192-186-3 | 50.8% [46–56] | -4.6% | -88.5u | -0.94 ✗ noise |
| STRONG | 102 | 51-49-2 | 51.0% [41–61] | -0.3% | -2.6u | -0.03 ✗ noise |
| LEAN | 186 | 94-89-3 | 51.4% [44–59] | +0.1% | +15.3u | 0.01 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.091 ✓ p<.05 | -0.072 ~ p<.10 | -0.059 | -1.88 |
| totalInvested | -0.064 ~ p<.10 | -0.076 ✓ p<.05 | -0.030 | -1.98 |
| evEdge | 0.090 ✓ p<.05 | 0.111 ✓ p<.01 | 0.047 | 2.89 |
| moneyPct | 0.030 ✗ | 0.001 ✗ | -0.016 | 0.04 |
| walletPct | 0.025 ✗ | 0.012 ✗ | 0.007 | 0.31 |
| criteriaMet | -0.004 ✗ | -0.004 ✗ | -0.040 | -0.11 |
| maxContribFor | -0.012 ✗ | 0.001 ✗ | 0.023 | 0.02 |
| meanBaseFor | 0.007 ✗ | 0.032 ✗ | 0.057 | 0.84 |
...
Sample with CLV: **665** picks. Mean CLV = **-0.0040**.
t-statistic vs zero: -3.22 → ✓ p<.01 · 95% CI [-0.0064, -0.0016]
...
Trained on N=531 (with all features non-null). Intercept β₀ = 0.068.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | sharpCount | -0.297 | ↓ hurts |
| 2 | pw.ΔAvgRoi | +0.243 | ↑ helps |
| 3 | evEdge | +0.214 | ↑ helps |
| 4 | pw.Δcount | +0.178 | ↑ helps |
| 5 | pw.ΔFlatPnl | +0.146 | ↑ helps |
| 6 | log(impliedProb) | +0.125 | ↑ helps |
| 7 | peak.stars | -0.124 | ↓ hurts |
| 8 | pw.ΔTopQShare | +0.104 | ↑ helps |
| 9 | HC margin | +0.089 | ↑ helps |
| 10 | pw.ΔWlNet | +0.084 | ↑ helps |
| 11 | vault.star | +0.076 | ↑ helps |
| 12 | odds (American) | -0.075 | ↓ hurts |
| 13 | Δw | -0.040 | ≈ flat |
| 14 | log10(invested) | +0.035 | ≈ flat |
| 15 | moneyPct | -0.028 | ≈ flat |
| 16 | criteriaMet | +0.027 | ≈ flat |
| 17 | Δw + HC | +0.010 | ≈ flat |
| 18 | walletPct | +0.005 | ≈ flat |
...
| Tier-1b HC = +1 (post-cutover) | 161 | 91-70 | 56.5% | 56.1% | -110 | 3.95% bankroll | 2.07u | **UNDER-SIZED** — ship up to 3.95u (1u=1% bankroll) |
...
| Stale Δw = 0 | 140 | 71-66 | 51.8% | 51.7% | -110 | — (mute) | 1.80u | **MUTE** (negative EV at posterior) |
| Stale Δw ≤ −1 | 33 | 11-21 | 34.4% | 38.1% | -116 | — (mute) | 1.38u | **MUTE** (negative EV at posterior) |
...
| 2026-06-16 | 21 | 12-9 | -10.3u | -77.3u |

**Peak cum PnL:** +7.1u
**Max drawdown:** -84.4u
**Longest losing-day streak:** 4
**Longest winning-day streak:** 5
**Daily Sharpe-like (μ/σ):** -0.196  (annualized × √252 ≈ -3.11)
...
| 2026-04-19 | MLB | ML | away | 2.5 | 1.00 | +100 | 0 | — | — | 0 | 26 | 1.00 | L | -1.0u |
...
| 2026-04-23 | MLB | ML | home | 3.0 | 1.00 | -155 | 0 | — | — | 1 | 28 | 0.30 | L | -1.0u |
...
| 2026-04-26 | MLB | ML | away | 3.5 | 0.75 | +108 | 1 | — | — | 2 | -2 | 0.50 | L | -0.8u |
| 2026-04-26 | MLB | TOTAL | over | 3.5 | 0.50 | -116 | 1 | — | — | -1 | 19 | 0.00 | L | -0.5u |
| 2026-04-26 | MLB | ML | home | 3.5 | 0.75 | -110 | 1 | — | — | 2 | 23 | -1.40 | L | -0.8u |
...
| 2026-04-28 | MLB | ML | home | 3.5 | 0.75 | -118 | 1 | — | — | 1 | 3 | -0.80 | W | +0.6u |
...
| 2026-04-29 | MLB | ML | home | 3.5 | 0.50 | -108 | 1 | — | — | 1 | 28 | 0.50 | L | -0.5u |
...
| 2026-05-03 | MLB | ML | away | 2.8 | 0.75 | -130 | 1 | 1 | 2 | -1 | -28 | -1.00 | W | +0.6u |
...
| 2026-05-12 | MLB | ML | away | 5.0 | 4.50 | +108 | 4 | 0 | 4 | 2 | 9 | -0.20 | L | -4.5u |
| 2026-05-12 | MLB | TOTAL | under | 4.0 | 0.64 | -110 | 2 | 1 | 3 | 2 | -4 | 0.00 | L | -0.6u |
| 2026-05-12 | MLB | ML | away | 4.5 | 3.00 | +129 | 3 | 0 | 3 | 1 | 28 | -1.00 | L | -3.0u |
...
| 2026-05-13 | MLB | TOTAL | under | 4.0 | 0.96 | -110 | 1 | 1 | 2 | 2 | -16 | 0.00 | W | +0.9u |
| 2026-05-13 | MLB | TOTAL | under | 5.0 | 3.50 | -110 | 4 | 2 | 6 | 5 | -24 | 0.00 | L | -3.5u |
...
| 2026-05-14 | MLB | ML | home | 4.0 | 1.25 | +108 | 2 | 0 | 2 | 2 | 9 | -0.90 | L | -1.3u |
...
| 2026-05-15 | MLB | ML | away | 4.0 | 2.75 | -211 | 2 | 1 | 3 | 1 | 28 | -0.90 | W | +1.3u |
| 2026-05-15 | MLB | ML | away | 3.0 | 1.25 | +115 | 0 | 1 | 1 | -1 | -28 | -1.10 | L | -1.3u |
...
| 2026-05-17 | MLB | ML | away | 4.0 | 2.75 | -148 | 1 | 0 | 1 | 2 | 9 | -0.70 | W | +1.9u |
| 2026-05-17 | MLB | ML | away | 2.5 | 0.50 | +139 | 0 | 1 | 1 | 0 | -47 | 0.70 | L | -0.5u |
...
| 2026-05-20 | MLB | ML | home | 4.0 | 2.75 | -154 | 2 | 0 | 2 | 1 | 28 | -1.50 | W | +1.9u |
| 2026-05-20 | MLB | TOTAL | under | 4.0 | 0.75 | -110 | 2 | 0 | 2 | 1 | -19 | 0.00 | L | -0.8u |
| 2026-05-20 | MLB | ML | home | 2.5 | 0.50 | -140 | 1 | 1 | 2 | 1 | -19 | -1.10 | W | +0.9u |
| 2026-05-20 | MLB | ML | home | 2.5 | 0.50 | +111 | 0 | 1 | 1 | -1 | -28 | 0.00 | W | +0.6u |
| 2026-05-20 | MLB | ML | away | 4.0 | 2.75 | +113 | 1 | 1 | 2 | 0 | -47 | -1.00 | L | -2.8u |
...
| 2026-05-22 | MLB | ML | home | 5.0 | 1.25 | -175 | 1 | 0 | 1 | 1 | 28 | -0.90 | L | -1.3u |
...
| 2026-05-22 | MLB | ML | home | 5.0 | 5.00 | -144 | 4 | 2 | 6 | 2 | 9 | -1.60 | L | -5.0u |
| 2026-05-22 | MLB | SPREAD | home | 5.0 | 0.75 | -155 | 2 | 0 | 2 | 1 | -19 | -0.30 | W | +0.4u |
| 2026-05-22 | MLB | ML | home | 5.0 | 2.75 | -158 | 1 | 0 | 1 | 1 | 28 | -0.80 | W | +1.7u |
| 2026-05-22 | MLB | SPREAD | home | 3.0 | 0.75 | -142 | 1 | 0 | 1 | 1 | -19 | -2.00 | L | -0.8u |
| 2026-05-22 | MLB | ML | home | 5.0 | 5.00 | -145 | 2 | 2 | 4 | 1 | 28 | -2.20 | L | -5.0u |
| 2026-05-22 | MLB | ML | home | 2.5 | 0.50 | +139 | 2 | 1 | 3 | 0 | -34 | -0.90 | W | +0.7u |
...
| 2026-05-23 | MLB | ML | home | 2.5 | 0.50 | -181 | 1 | 0 | 1 | 2 | 31 | -1.70 | W | +0.3u |
| 2026-05-23 | MLB | ML | away | 2.5 | 2.75 | +109 | 2 | 0 | 2 | 2 | -17 | -0.50 | L | -2.8u |
| 2026-05-23 | MLB | TOTAL | over | 2.5 | 0.30 | -110 | 0 | 1 | 1 | 0 | -10 | 0.00 | W | +0.3u |
...
| 2026-05-23 | MLB | SPREAD | away | 4.5 | 1.50 | -209 | 0 | 0 | 0 | 2 | -16 | 29.00 | W | +2.5u |
...
| 2026-05-24 | MLB | ML | home | 3.0 | 1.25 | -189 | 1 | 0 | 1 | 1 | 28 | 0.00 | W | +0.7u |
...
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 1 | 0 | 1 | 1 | 1 | 0.00 | L | -1.6u |
| 2026-05-24 | MLB | ML | home | 2.5 | 0.50 | +144 | 1 | 1 | 2 | -2 | -63 | 0.00 | L | -0.5u |
| 2026-05-24 | MLB | SPREAD | home | 4.0 | 1.65 | -110 | 2 | 1 | 3 | 2 | -16 | -1.30 | L | -1.6u |
| 2026-05-24 | MLB | ML | home | 3.0 | 1.25 | -107 | 1 | 0 | 1 | 1 | 3 | 0.00 | W | +1.2u |
...
| 2026-05-24 | MLB | ML | away | 4.0 | 1.25 | +148 | 2 | 2 | 4 | 0 | -23 | -1.40 | W | +1.9u |
| 2026-05-24 | MLB | ML | away | 3.0 | 1.25 | -122 | -1 | 1 | 0 | 0 | -24 | -1.10 | L | -1.3u |
...
| 2026-05-25 | MLB | ML | home | 5.0 | 5.00 | -310 | 2 | 0 | 2 | 2 | 30 | -1.20 | W | +1.6u |
| 2026-05-25 | MLB | TOTAL | over | 4.0 | 1.65 | +103 | 1 | 0 | 1 | 2 | 4 | 0.00 | L | -1.6u |
| 2026-05-25 | MLB | ML | home | 4.0 | 1.25 | -125 | 1 | -1 | 0 | 1 | -11 | -1.90 | L | -1.3u |
| 2026-05-25 | MLB | SPREAD | away | 4.0 | 1.65 | -184 | 1 | 0 | 1 | 1 | -6 | 28.40 | W | +2.4u |
| 2026-05-25 | MLB | TOTAL | under | 5.0 | 2.25 | -112 | 4 | 0 | 4 | 4 | -11 | 0.00 | L | -2.3u |
| 2026-05-25 | MLB | ML | home | 5.0 | 1.25 | -160 | 3 | 0 | 3 | 2 | -39 | -1.10 | L | -1.3u |
| 2026-05-25 | MLB | TOTAL | over | 5.0 | 3.00 | -110 | 3 | 0 | 3 | 3 | 10 | 0.00 | W | +2.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 3.75 | -108 | 0 | 0 | 0 | 3 | -36 | -1.70 | L | -3.8u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -124 | 2 | 0 | 2 | 2 | -16 | -1.30 | W | +0.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 5.00 | -119 | 2 | -1 | 1 | 4 | -9 | -0.60 | W | +3.1u |
| 2026-05-25 | MLB | ML | away | 2.5 | 2.75 | -113 | 0 | 0 | 0 | 0 | -1 | -1.80 | W | +1.1u |
| 2026-05-25 | MLB | ML | home | 4.0 | 5.00 | -209 | -1 | 0 | -1 | 3 | 11 | -0.80 | W | +2.3u |
| 2026-05-25 | MLB | TOTAL | under | 5.0 | 0.75 | -101 | 2 | 1 | 3 | 1 | -6 | 0.00 | W | +0.7u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -178 | 1 | 0 | 1 | 2 | -16 | -1.60 | W | +0.9u |
...
| 2026-05-26 | MLB | TOTAL | over | 5.0 | 1.65 | -110 | 2 | 0 | 2 | 2 | -16 | 0.00 | W | +1.5u |
| 2026-05-26 | MLB | ML | away | 5.0 | 1.50 | +200 | 2 | 0 | 2 | 2 | -23 | -1.00 | L | -1.5u |
| 2026-05-26 | MLB | SPREAD | away | 5.0 | 1.00 | -101 | 2 | 1 | 3 | 2 | -16 | 0.50 | L | -1.0u |
| 2026-05-26 | MLB | ML | away | 2.5 | 1.25 | +113 | 0 | 0 | 0 | 0 | 25 | -1.50 | W | +1.4u |
| 2026-05-26 | MLB | ML | home | 2.5 | 1.25 | -130 | 1 | 0 | 1 | 0 | 25 | -1.30 | W | +1.0u |
| 2026-05-26 | MLB | ML | away | 5.0 | 5.00 | -200 | 1 | 0 | 1 | 2 | 31 | -0.60 | W | +1.9u |
| 2026-05-26 | MLB | SPREAD | home | 4.0 | 1.00 | +105 | 1 | 0 | 1 | 2 | 4 | -0.20 | L | -1.0u |
| 2026-05-26 | MLB | ML | away | 5.0 | 5.00 | -102 | 3 | 1 | 4 | 3 | -24 | -0.50 | W | +4.9u |
| 2026-05-26 | MLB | ML | home | 5.0 | 3.75 | -108 | 3 | 1 | 4 | 3 | -1 | -0.20 | L | -3.8u |
| 2026-05-26 | MLB | ML | home | 5.0 | 5.00 | -105 | 2 | 1 | 3 | 2 | 31 | -2.00 | W | +3.6u |
| 2026-05-26 | MLB | ML | away | 5.0 | 2.50 | +116 | 1 | 0 | 1 | 2 | 31 | -1.00 | W | +2.9u |
...
| 2026-05-27 | MLB | SPREAD | away | 5.0 | 2.50 | +141 | 1 | 1 | 2 | 4 | -14 | 0.80 | L | -2.5u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 1.00 | +105 | 2 | 0 | 2 | 2 | -16 | 0.00 | L | -1.0u |
| 2026-05-27 | MLB | ML | home | 4.5 | 3.75 | -420 | 1 | 1 | 2 | 1 | 28 | -0.50 | W | +0.7u |
...
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 0.75 | +104 | 2 | 0 | 2 | 2 | 6 | 0.00 | W | +0.8u |
| 2026-05-27 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 2 | 5 | 3 | -9 | -0.30 | L | -2.5u |
| 2026-05-27 | MLB | SPREAD | away | 4.5 | 1.65 | -145 | 1 | 1 | 2 | 1 | 3 | -0.30 | W | +1.1u |
| 2026-05-27 | MLB | ML | away | 5.0 | 5.00 | -126 | 2 | 0 | 2 | 2 | -2 | -4.10 | L | -5.0u |
| 2026-05-27 | MLB | ML | home | 4.0 | 1.25 | -190 | 1 | 0 | 1 | 1 | 28 | -0.70 | W | +0.7u |
...
| 2026-05-28 | MLB | TOTAL | over | 5.0 | 3.00 | +101 | 3 | -1 | 2 | 3 | 29 | 0.00 | W | +2.5u |
| 2026-05-28 | MLB | ML | home | 5.0 | 1.25 | -140 | 2 | 0 | 2 | 2 | -20 | -0.50 | L | -1.3u |
| 2026-05-28 | MLB | TOTAL | under | 5.0 | 1.00 | -107 | 1 | 0 | 1 | 1 | 24 | 0.00 | W | +0.0u |
| 2026-05-28 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 1 | 4 | 2 | -64 | -0.60 | L | -2.5u |
| 2026-05-28 | MLB | TOTAL | over | 2.5 | 1.65 | -108 | 2 | 0 | 2 | 2 | -16 | 0.00 | L | -1.6u |
| 2026-05-28 | NBA | SPREAD | away | 5.0 | 1.00 | -110 | 1 | 2 | 3 | 0 | -2 | -0.90 | L | -1.0u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.50 | +118 | 5 | 1 | 6 | 5 | 13 | -0.90 | L | -2.5u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 0.75 | -135 | 2 | 0 | 2 | 1 | -27 | 1.00 | L | -0.8u |
| 2026-05-29 | MLB | ML | home | 5.0 | 3.75 | -124 | 2 | 1 | 3 | 3 | 12 | -1.00 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 1.65 | -106 | 2 | 0 | 2 | 3 | 6 | 0.00 | L | -1.6u |
...
| 2026-05-29 | MLB | ML | away | 5.0 | 2.50 | +140 | 2 | 1 | 3 | 1 | -28 | 1.00 | L | -2.5u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 1.65 | -103 | 0 | 0 | 0 | 2 | -16 | 0.00 | W | +1.6u |
| 2026-05-29 | MLB | ML | away | 4.5 | 1.25 | -142 | 0 | 1 | 1 | -1 | 13 | -1.20 | W | +0.3u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 1.65 | -135 | 1 | 0 | 1 | 2 | -16 | 0.40 | W | +1.2u |
| 2026-05-29 | MLB | ML | home | 4.5 | 1.25 | -134 | 1 | 0 | 1 | 0 | -7 | -1.70 | W | +2.8u |
| 2026-05-29 | MLB | SPREAD | away | 5.0 | 2.25 | -184 | 0 | 0 | 0 | 2 | 5 | -1.00 | W | +1.2u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 0.75 | -109 | 1 | 0 | 1 | 2 | 6 | 0.00 | W | +0.7u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.75 | -106 | 2 | 1 | 3 | 2 | 28 | 0.70 | L | -2.8u |
| 2026-05-29 | MLB | SPREAD | home | 4.0 | 1.65 | -175 | 0 | 0 | 0 | 2 | -16 | -0.80 | L | -1.6u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 0.30 | +105 | 2 | 1 | 3 | 1 | 0 | 0.00 | W | +0.3u |
...
| 2026-05-30 | MLB | ML | away | 4.5 | 2.75 | -125 | 1 | 2 | 3 | 1 | 22 | -0.60 | W | +2.3u |
...
| 2026-05-30 | MLB | ML | home | 5.0 | 5.00 | -120 | 0 | 0 | 0 | 3 | -36 | -1.10 | W | +4.2u |
| 2026-05-30 | MLB | TOTAL | over | 4.5 | 0.75 | +100 | 1 | 1 | 2 | 1 | -8 | 0.00 | W | +0.8u |
| 2026-05-30 | MLB | ML | home | 4.0 | 2.75 | -130 | 0 | 1 | 1 | 0 | 25 | -1.60 | W | +0.4u |
| 2026-05-30 | MLB | TOTAL | over | 4.0 | 2.25 | -116 | 2 | 0 | 2 | 2 | 17 | 0.00 | W | +1.9u |
| 2026-05-30 | MLB | TOTAL | under | 4.0 | 1.65 | -107 | 1 | 0 | 1 | 1 | 14 | 0.00 | L | -1.6u |
| 2026-05-30 | MLB | ML | home | 4.0 | 2.50 | +129 | 1 | 0 | 1 | 1 | -19 | -0.90 | W | +0.7u |
| 2026-05-30 | MLB | SPREAD | home | 5.0 | 1.65 | -120 | 2 | 1 | 3 | 2 | -16 | -0.60 | W | +1.4u |
| 2026-05-30 | MLB | ML | away | 5.0 | 2.50 | +108 | 1 | 0 | 1 | 3 | -36 | -0.90 | W | +2.7u |
| 2026-05-30 | MLB | ML | home | 4.0 | 0.50 | +110 | 1 | 0 | 1 | 1 | -19 | -0.20 | W | +0.6u |
| 2026-05-30 | MLB | ML | home | 5.0 | 1.25 | -102 | 2 | 0 | 2 | 2 | 9 | -0.70 | W | +1.2u |
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -122 | 1 | 1 | 2 | 2 | -17 | -0.20 | L | -3.8u |
...
| 2026-05-31 | MLB | ML | away | 3.0 | 2.75 | -125 | -2 | 0 | -2 | 1 | -11 | -1.20 | L | -2.8u |
| 2026-05-31 | MLB | TOTAL | under | 5.0 | 1.65 | -114 | 2 | 0 | 2 | 3 | -13 | 0.00 | L | -1.6u |
| 2026-05-31 | MLB | ML | home | 2.5 | 2.75 | -115 | 1 | 1 | 2 | 1 | 23 | 0.00 | W | +2.4u |
| 2026-05-31 | MLB | ML | away | 5.0 | 1.00 | +115 | -1 | 0 | -1 | 2 | -17 | -0.60 | L | -1.0u |
| 2026-05-31 | MLB | SPREAD | away | 5.0 | 1.00 | -117 | 3 | 1 | 4 | 3 | -15 | -0.20 | L | -1.0u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -164 | 0 | 1 | 1 | 2 | -17 | -1.20 | W | +2.3u |
| 2026-05-31 | MLB | ML | away | 3.0 | 1.25 | -184 | 0 | 0 | 0 | 0 | -23 | -1.70 | W | +0.7u |
| 2026-05-31 | MLB | ML | home | 2.5 | 1.25 | -232 | 0 | 0 | 0 | 1 | 35 | -0.50 | W | +0.5u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -102 | 0 | 1 | 1 | 2 | -51 | 0.20 | W | +4.9u |
| 2026-05-31 | MLB | TOTAL | over | 4.0 | 1.00 | +101 | 2 | 1 | 3 | 2 | -2 | 0.00 | L | -1.0u |
| 2026-05-31 | MLB | ML | away | 4.5 | 2.50 | +110 | 0 | 0 | 0 | 0 | -23 | -1.10 | L | -2.5u |
| 2026-06-01 | MLB | ML | home | 4.5 | 3.00 | -155 | 3 | 2 | 5 | 3 | 31 | -1.00 | W | +2.1u |
| 2026-06-01 | MLB | ML | away | 4.0 | 1.00 | +135 | 2 | 2 | 4 | 3 | 46 | -0.20 | W | +1.4u |
| 2026-06-01 | MLB | ML | away | 5.0 | 2.50 | +160 | 2 | -1 | 1 | 2 | 29 | -1.30 | W | +2.7u |
| 2026-06-01 | MLB | TOTAL | under | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 2 | -30 | 0.00 | L | -1.0u |
| 2026-06-01 | MLB | ML | home | 3.0 | 0.50 | -142 | -1 | 0 | -1 | -1 | 24 | -0.40 | L | -0.5u |
| 2026-06-01 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 6 | 0.00 | L | -5.0u |
| 2026-06-01 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 1 | -34 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | ML | home | 2.5 | 0.25 | -215 | -1 | 0 | -1 | 0 | 7 | -1.40 | L | -0.3u |
| 2026-06-02 | MLB | TOTAL | under | 4.0 | 1.00 | -117 | 1 | 0 | 1 | 0 | 0 | 0.00 | L | -1.0u |
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +130 | 2 | 0 | 2 | 0 | 61 | -0.60 | W | +3.1u |
| 2026-06-02 | MLB | ML | away | 3.0 | 0.50 | +100 | 1 | 0 | 1 | 2 | 31 | -1.20 | W | +0.5u |
...
| 2026-06-02 | MLB | ML | home | 4.0 | 1.00 | -112 | 1 | 0 | 1 | 1 | 28 | -1.10 | L | -1.0u |
| 2026-06-02 | MLB | ML | home | 4.0 | 1.00 | -106 | 1 | 0 | 1 | 1 | 28 | -0.50 | L | -1.0u |
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +102 | 0 | -1 | -1 | 1 | -18 | 0.00 | L | -2.5u |
| 2026-06-02 | NHL | TOTAL | over | 5.0 | 5.00 | -110 | 2 | 2 | 4 | 2 | 13 | 0.00 | W | +4.3u |
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -150 | 3 | 1 | 4 | 5 | 5 | -1.30 | W | +0.3u |
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +134 | -1 | -1 | -2 | -1 | 45 | -1.00 | W | +1.2u |
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +125 | 0 | -1 | -1 | 0 | 48 | 0.40 | W | +1.3u |
| 2026-06-03 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 39 | 0.00 | L | -3.0u |
| 2026-06-03 | MLB | ML | home | 4.5 | 1.50 | +167 | 0 | 0 | 0 | -1 | 20 | -0.40 | L | -1.5u |
| 2026-06-03 | MLB | SPREAD | away | 4.0 | 1.00 | -111 | 1 | 0 | 1 | 0 | 11 | 0.20 | W | +0.8u |
...
| 2026-06-03 | MLB | ML | home | 4.5 | 3.00 | -112 | 0 | 0 | 0 | 1 | 28 | -0.90 | W | +2.7u |
...
| 2026-06-04 | MLB | ML | away | 3.0 | 0.50 | +104 | 1 | 0 | 1 | 2 | 23 | 0.00 | W | +0.5u |
| 2026-06-04 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | -1 | 0 | 0 | 21 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | +102 | 0 | 0 | 0 | 1 | 28 | 0.00 | L | -1.0u |
...
| 2026-06-04 | MLB | ML | away | 2.5 | 0.25 | +105 | 0 | 0 | 0 | 0 | -26 | -1.00 | W | +0.2u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -210 | 1 | 0 | 1 | 2 | 54 | -1.00 | W | +0.5u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -188 | 0 | 0 | 0 | 0 | 25 | -1.10 | L | -1.0u |
...
| 2026-06-05 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | -1 | 24 | 0.00 | W | +2.8u |
| 2026-06-05 | MLB | ML | away | 3.0 | 0.50 | +128 | 1 | 0 | 1 | 0 | 19 | 0.00 | W | +0.6u |
| 2026-06-05 | MLB | TOTAL | over | 4.0 | 1.00 | -109 | 0 | 0 | 0 | 0 | 0 | 0.00 | P | +0.0u |
| 2026-06-05 | MLB | ML | home | 3.0 | 0.50 | -136 | 1 | 0 | 1 | 3 | 32 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 3 | 0 | 3 | 4 | 1 | 0.00 | W | +0.4u |
| 2026-06-05 | MLB | ML | away | 5.0 | 5.00 | -122 | 0 | 1 | 1 | 1 | 39 | -0.80 | L | -5.0u |
| 2026-06-05 | MLB | ML | home | 5.0 | 5.00 | -171 | 0 | 2 | 2 | 3 | 47 | -0.20 | W | +2.7u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -188 | 2 | 0 | 2 | 2 | 31 | -0.90 | W | +0.5u |
| 2026-06-05 | MLB | ML | away | 4.0 | 1.00 | -105 | 1 | 0 | 1 | 1 | 28 | 0.00 | L | -1.0u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -141 | 3 | 2 | 5 | 3 | 22 | 0.30 | W | +0.7u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 2.50 | -110 | 0 | 1 | 1 | -1 | 33 | 0.00 | W | +2.5u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -172 | 1 | 0 | 1 | 1 | 28 | 0.00 | L | -1.0u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 0 | -1 | -1 | 0 | 0 | 0.00 | W | +4.4u |
| 2026-06-05 | MLB | ML | away | 4.5 | 3.00 | -129 | -1 | 1 | 0 | -2 | 36 | -1.10 | W | +2.2u |
...
| 2026-06-06 | MLB | TOTAL | over | 2.5 | 0.25 | -110 | 1 | 0 | 1 | 0 | 19 | 0.00 | W | +0.2u |
| 2026-06-06 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 0 | 2 | 0.00 | W | +2.7u |
| 2026-06-06 | MLB | ML | home | 4.5 | 3.00 | -126 | 0 | 0 | 0 | 0 | 25 | -1.00 | W | +2.4u |
...
| 2026-06-06 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 1 | 0.00 | L | -5.0u |
...
| 2026-06-06 | MLB | ML | home | 5.0 | 5.00 | -123 | 0 | 0 | 0 | 1 | 1 | 0.00 | W | +4.1u |
| 2026-06-06 | MLB | TOTAL | under | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 1 | 0.00 | L | -1.0u |
| 2026-06-06 | MLB | ML | home | 5.0 | 2.50 | +117 | -2 | -1 | -3 | -1 | 2 | 0.00 | L | -2.5u |
| 2026-06-06 | MLB | ML | home | 5.0 | 5.00 | -154 | 2 | 1 | 3 | 0 | 61 | -0.80 | L | -5.0u |
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -130 | 1 | 0 | 1 | 0 | 48 | -0.90 | W | +2.2u |
| 2026-06-07 | MLB | TOTAL | over | 3.0 | 0.50 | -112 | 0 | 0 | 0 | 2 | 4 | 0.00 | L | -0.5u |
...
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -165 | 2 | 2 | 4 | 3 | 11 | -1.10 | W | +1.8u |
| 2026-06-07 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 1 | 1 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | -107 | 1 | 0 | 1 | -1 | 47 | -0.80 | W | +0.2u |
| 2026-06-07 | MLB | TOTAL | over | 2.5 | 0.25 | -115 | 0 | 0 | 0 | -1 | -12 | 0.00 | W | +0.2u |
| 2026-06-07 | MLB | ML | home | 2.5 | 0.25 | -210 | -1 | 0 | -1 | 1 | 35 | 0.80 | L | -0.3u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -4 | 0.00 | L | -0.5u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | +158 | 1 | 0 | 1 | 3 | 20 | -1.30 | L | -0.5u |
| 2026-06-07 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 3 | 0.00 | W | +0.9u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -105 | 1 | 0 | 1 | 1 | 28 | 0.00 | L | -1.0u |
| 2026-06-07 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 1 | 0.00 | L | -5.0u |
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 3.00 | -152 | 2 | 0 | 2 | 2 | 17 | -0.50 | W | +1.9u |
| 2026-06-07 | MLB | TOTAL | over | 5.0 | 2.25 | -114 | 1 | 1 | 2 | 0 | 0 | 0.00 | L | -2.3u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | +102 | 1 | 0 | 1 | -2 | 13 | -0.20 | W | +0.5u |
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 2.25 | +164 | 1 | 1 | 2 | 1 | 3 | 29.50 | W | +3.7u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | +103 | -1 | 0 | -1 | -2 | -15 | 0.20 | W | +0.3u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | -1 | 0 | 2 | 9 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -102 | 2 | 0 | 2 | 0 | 25 | 0.50 | W | +1.0u |
| 2026-06-07 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 1 | 0.00 | W | +4.8u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | -127 | 0 | 1 | 1 | -1 | 47 | -1.90 | W | +0.4u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -4 | 0.00 | W | +0.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -113 | 6 | 1 | 7 | 6 | 41 | -0.50 | L | -3.0u |
| 2026-06-08 | MLB | ML | home | 4.5 | 3.00 | -129 | 3 | 0 | 3 | 1 | 54 | -0.40 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | -1 | 5 | 0.00 | L | -3.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -121 | 1 | 1 | 2 | 0 | 46 | -1.60 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 3 | 5 | 0.00 | P | +0.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -146 | 1 | 0 | 1 | -1 | 52 | -0.50 | W | +2.0u |
| 2026-06-08 | MLB | ML | home | 4.0 | 1.00 | -118 | 2 | 0 | 2 | 1 | -21 | -0.40 | L | -1.0u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 2.50 | -116 | -2 | -2 | -4 | -1 | 34 | 0.00 | W | +2.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 1.50 | +151 | 0 | -1 | -1 | 0 | 6 | 0.00 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 5.0 | 2.50 | +101 | 0 | 0 | 0 | -1 | 11 | 0.00 | W | +2.5u |
...
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | +132 | 1 | 0 | 1 | 2 | 25 | -1.20 | L | -0.3u |
| 2026-06-09 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 13 | 0.00 | W | +4.3u |
| 2026-06-09 | MLB | ML | away | 3.0 | 0.50 | -148 | 1 | 0 | 1 | 2 | 31 | 0.00 | L | -0.5u |
| 2026-06-09 | MLB | ML | away | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 4 | 34 | 0.80 | L | -1.0u |
| 2026-06-09 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 0 | 0 | 1 | 2 | 0.00 | L | -1.0u |
| 2026-06-09 | MLB | ML | away | 4.0 | 1.00 | -143 | 1 | 0 | 1 | 1 | 28 | 0.00 | L | -1.0u |
| 2026-06-09 | MLB | SPREAD | home | 4.5 | 3.00 | -117 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +2.6u |
| 2026-06-09 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | -1 | 17 | 0.00 | W | +0.5u |
| 2026-06-09 | MLB | ML | away | 5.0 | 5.00 | -122 | 2 | 1 | 3 | 1 | 1 | 0.00 | W | +4.1u |
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | -120 | 0 | 0 | 0 | 0 | 14 | 0.00 | L | -0.3u |
| 2026-06-09 | MLB | ML | home | 4.0 | 1.00 | -107 | 1 | 0 | 1 | 1 | 28 | -1.30 | L | -1.0u |
| 2026-06-09 | MLB | ML | home | 5.0 | 5.00 | -105 | 1 | -1 | 0 | 1 | 1 | 0.00 | W | +4.8u |
| 2026-06-09 | MLB | ML | away | 4.5 | 2.50 | +115 | 1 | 0 | 1 | 0 | 25 | -0.70 | L | -2.5u |
| 2026-06-09 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 0 | 8 | 0.00 | W | +2.7u |
| 2026-06-09 | MLB | ML | away | 3.0 | 0.50 | -116 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +0.4u |
| 2026-06-09 | MLB | ML | home | 5.0 | 2.50 | +100 | 4 | 2 | 6 | 0 | 8 | 0.00 | W | +2.5u |
| 2026-06-09 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 1 | 2 | 0 | 14 | 0.00 | W | +4.5u |
| 2026-06-09 | MLB | ML | home | 4.0 | 1.00 | +102 | 2 | 0 | 2 | 1 | -3 | -1.20 | L | -1.0u |
...
| 2026-06-10 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 0 | 21 | 0.00 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 4.5 | 3.00 | -148 | 0 | 0 | 0 | 1 | 14 | -0.50 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | +136 | 3 | 0 | 3 | 4 | 46 | -1.10 | L | -1.0u |
...
| 2026-06-10 | MLB | TOTAL | under | 4.0 | 1.00 | -113 | 1 | 0 | 1 | 1 | 3 | 0.00 | L | -1.0u |
| 2026-06-10 | MLB | ML | home | 2.5 | 0.25 | -117 | 0 | 0 | 0 | 1 | -11 | 0.00 | W | +0.2u |
| 2026-06-10 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 1 | 1 | 0.00 | L | -5.0u |
| 2026-06-10 | MLB | ML | home | 4.0 | 1.00 | +178 | 1 | 0 | 1 | -1 | 20 | -1.40 | W | +1.7u |
| 2026-06-10 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 3 | 0 | 3 | 0 | 8 | 0.00 | W | +4.5u |
| 2026-06-10 | MLB | ML | away | 5.0 | 5.00 | -104 | 0 | 0 | 0 | 1 | 14 | -0.20 | L | -5.0u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | +148 | 0 | 0 | 0 | 1 | 28 | -0.80 | W | +1.5u |
| 2026-06-10 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 16 | 0.00 | W | +2.7u |
| 2026-06-10 | MLB | ML | home | 4.5 | 2.50 | +103 | 0 | 0 | 0 | 1 | 1 | 0.00 | W | +2.6u |
| 2026-06-10 | MLB | ML | home | 4.0 | 1.00 | -127 | 1 | 0 | 1 | 1 | 28 | 0.00 | L | -1.0u |
| 2026-06-10 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 16 | 0.00 | W | +3.0u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | -120 | 1 | 0 | 1 | 1 | 28 | -0.40 | W | +0.8u |
| 2026-06-10 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | -1 | 0 | -1 | 1 | 14 | 0.00 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 5.0 | 5.00 | -106 | 1 | 0 | 1 | 0 | 41 | -0.70 | L | -5.0u |
...
| 2026-06-11 | MLB | ML | away | 4.0 | 1.00 | +112 | 0 | 0 | 0 | 0 | 1 | 0.00 | L | -1.0u |
| 2026-06-11 | MLB | ML | away | 3.0 | 0.50 | -120 | -1 | 0 | -1 | 3 | -3 | -1.70 | P | +0.0u |
| 2026-06-11 | MLB | SPREAD | away | 4.5 | 2.50 | +140 | 1 | 0 | 1 | 2 | 4 | -1.00 | P | +0.0u |
| 2026-06-11 | MLB | ML | home | 5.0 | 5.00 | — | 1 | 0 | 1 | 1 | -4 | 0.00 | L | -5.0u |
| 2026-06-11 | MLB | ML | away | 3.0 | 0.50 | -167 | 1 | -1 | 0 | 1 | 53 | -0.10 | W | +0.3u |
| 2026-06-11 | MLB | TOTAL | under | 5.0 | 1.00 | -108 | 1 | 1 | 2 | 0 | -5 | 0.00 | L | -1.0u |
| 2026-06-11 | MLB | ML | away | 5.0 | 1.00 | +110 | 3 | 1 | 4 | 3 | 11 | -0.90 | L | -1.0u |
| 2026-06-11 | MLB | ML | away | 3.0 | 0.50 | -111 | 1 | 0 | 1 | 1 | 28 | 0.00 | L | -0.5u |
| 2026-06-11 | MLB | ML | home | 5.0 | 5.00 | -131 | 2 | 1 | 3 | 0 | 8 | 0.00 | W | +3.8u |
| 2026-06-11 | MLB | ML | away | 4.0 | 1.00 | +100 | 1 | 0 | 1 | 1 | -28 | -0.50 | W | +1.0u |
| 2026-06-11 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | -1 | -1 | -2 | 0 | 3 | 0.00 | W | +0.2u |
| 2026-06-11 | NHL | TOTAL | under | 3.0 | 0.50 | -104 | 2 | 0 | 2 | 3 | 14 | 0.00 | P | +0.0u |
| 2026-06-12 | MLB | ML | home | 5.0 | 5.00 | -114 | 0 | 0 | 0 | 0 | 8 | 0.00 | W | +4.4u |
| 2026-06-12 | MLB | ML | home | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 0 | 8 | 0.00 | L | -3.0u |
| 2026-06-12 | MLB | TOTAL | over | 4.0 | 1.00 | +100 | 0 | 0 | 0 | 0 | 0 | 0.00 | L | -1.0u |
| 2026-06-12 | MLB | ML | home | 3.0 | 0.50 | -210 | 2 | 0 | 2 | 1 | 28 | -0.10 | W | +0.2u |
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +111 | 3 | 1 | 4 | 3 | 11 | -0.70 | L | -0.3u |
| 2026-06-12 | MLB | ML | away | 4.0 | 1.00 | -114 | 2 | 0 | 2 | 0 | 11 | -1.20 | W | +0.9u |
| 2026-06-12 | MLB | ML | home | 5.0 | 2.50 | +123 | 0 | 1 | 1 | 0 | 1 | 0.00 | W | +3.1u |
| 2026-06-12 | MLB | SPREAD | away | 4.0 | 1.00 | +121 | 0 | 0 | 0 | 1 | 15 | 0.40 | L | -1.0u |
| 2026-06-12 | MLB | ML | home | 4.5 | 3.00 | -138 | 1 | 0 | 1 | 1 | 28 | -1.00 | L | -3.0u |
| 2026-06-12 | MLB | SPREAD | home | 3.0 | 0.50 | -107 | 2 | 0 | 2 | 2 | 16 | -0.40 | W | +0.4u |
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +118 | -1 | 0 | -1 | -1 | -20 | -0.20 | L | -0.3u |
| 2026-06-12 | MLB | ML | away | 4.0 | 1.00 | -136 | 2 | 0 | 2 | 1 | 28 | -1.30 | W | +0.7u |
| 2026-06-12 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | 1 | 3 | 0.00 | W | +2.7u |
| 2026-06-12 | MLB | ML | home | 3.0 | 0.50 | -134 | 2 | 0 | 2 | 2 | 31 | -1.10 | W | +0.4u |
...
| 2026-06-13 | MLB | ML | away | 5.0 | 5.00 | -128 | 3 | 0 | 3 | 1 | 60 | -0.20 | L | -5.0u |
| 2026-06-13 | MLB | SPREAD | away | 4.0 | 1.00 | +123 | 1 | 0 | 1 | 1 | 14 | 0.00 | L | -1.0u |
| 2026-06-13 | MLB | ML | away | 4.5 | 3.00 | -102 | 0 | 0 | 0 | 1 | 14 | -2.00 | W | +2.9u |
| 2026-06-13 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 0 | 0 | 0 | 0 | 3 | 0.00 | W | +4.5u |
| 2026-06-13 | MLB | ML | away | 2.5 | 0.25 | -118 | 0 | 0 | 0 | -1 | 45 | -1.30 | W | +0.2u |
| 2026-06-13 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +2.7u |
| 2026-06-13 | MLB | ML | away | 4.5 | 2.50 | +136 | 1 | 0 | 1 | -1 | -30 | 1.30 | L | -2.5u |
...
| 2026-06-13 | MLB | ML | away | 4.5 | 2.50 | +114 | 1 | 0 | 1 | 0 | 11 | 0.00 | L | -2.5u |
| 2026-06-13 | MLB | TOTAL | under | 4.0 | 1.00 | +101 | 0 | 0 | 0 | 0 | 0 | 0.00 | W | +1.0u |
| 2026-06-13 | MLB | ML | home | 4.5 | 3.00 | -157 | 0 | 0 | 0 | -1 | 13 | 0.00 | L | -3.0u |
| 2026-06-13 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 1 | 0 | 1 | 2 | 17 | 0.00 | W | +0.5u |
| 2026-06-13 | MLB | ML | home | 5.0 | 5.00 | -115 | 1 | 1 | 2 | -1 | 18 | -0.40 | W | +4.3u |
...
| 2026-06-14 | MLB | ML | away | 4.0 | 1.00 | +106 | 1 | 1 | 2 | 2 | 2 | -1.50 | L | -1.0u |
| 2026-06-14 | MLB | ML | home | 2.5 | 0.25 | -124 | 1 | 0 | 1 | 2 | -31 | -1.50 | W | +0.2u |
| 2026-06-14 | MLB | SPREAD | away | 5.0 | 5.00 | -180 | 1 | 0 | 1 | 0 | 8 | 0.00 | L | -5.0u |
...
| 2026-06-14 | MLB | SPREAD | away | 4.5 | 3.00 | -116 | 2 | 0 | 2 | 1 | 1 | 0.00 | L | -3.0u |
| 2026-06-14 | MLB | SPREAD | away | 4.0 | 1.00 | -158 | 1 | -1 | 0 | 2 | 17 | 0.10 | W | +0.6u |
| 2026-06-14 | MLB | ML | away | 4.0 | 1.00 | -125 | 2 | 1 | 3 | 4 | 25 | -1.20 | W | +0.8u |
| 2026-06-14 | MLB | ML | away | 4.5 | 3.00 | -101 | 1 | 0 | 1 | 1 | 14 | 0.00 | L | -3.0u |
| 2026-06-14 | MLB | ML | away | 2.5 | 0.25 | -115 | 2 | 0 | 2 | 2 | 31 | 0.00 | W | +0.2u |
| 2026-06-14 | NHL | ML | away | 2.5 | 0.25 | -115 | -1 | 1 | 0 | 1 | -5 | -0.20 | W | +0.2u |
| 2026-06-14 | NHL | TOTAL | under | 5.0 | 5.00 | -110 | -1 | 0 | -1 | 1 | 5 | 0.00 | W | +4.4u |
| 2026-06-15 | MLB | ML | home | 4.0 | 1.00 | -204 | 1 | 0 | 1 | 1 | 28 | -0.60 | W | +0.0u |
| 2026-06-15 | MLB | SPREAD | away | 4.5 | 3.00 | -114 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +2.9u |
| 2026-06-15 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 3 | 0.00 | L | -1.0u |
...
| 2026-06-15 | MLB | ML | away | 3.0 | 0.50 | +115 | 2 | 0 | 2 | 2 | 7 | -0.80 | L | -0.5u |
| 2026-06-15 | MLB | ML | away | 3.0 | 0.50 | +160 | 2 | 0 | 2 | 1 | -6 | -0.70 | L | -0.5u |
| 2026-06-15 | MLB | SPREAD | away | 2.5 | 0.25 | -120 | 0 | 0 | 0 | 0 | -7 | 0.00 | L | -0.3u |
| 2026-06-15 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 3 | 0 | 3 | 3 | 18 | 0.00 | L | -3.0u |
...
| 2026-06-15 | MLB | ML | home | 3.0 | 0.50 | -154 | 1 | 0 | 1 | 2 | 16 | 0.50 | W | +0.0u |
| 2026-06-15 | MLB | SPREAD | away | 5.0 | 5.00 | -160 | 1 | 0 | 1 | 1 | 4 | -1.30 | L | -5.0u |
| 2026-06-15 | MLB | ML | home | 2.5 | 0.25 | -161 | -1 | 1 | 0 | -2 | 16 | -1.00 | W | +0.0u |
| 2026-06-15 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 0 | 10 | 0.00 | L | -1.0u |
| 2026-06-16 | MLB | ML | home | 4.0 | 1.00 | -145 | 1 | 0 | 1 | 1 | 28 | -1.00 | W | +0.0u |
...
| 2026-06-16 | MLB | SPREAD | home | 4.0 | 1.00 | +156 | 1 | 0 | 1 | 1 | 4 | 0.00 | W | +0.0u |
| 2026-06-16 | MLB | ML | home | 4.5 | 3.00 | -163 | 5 | 3 | 8 | 5 | 24 | -1.00 | W | +2.4u |
| 2026-06-16 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | -1 | 0 | -1 | -1 | 5 | 0.00 | L | -3.0u |
| 2026-06-16 | MLB | ML | home | 4.5 | 3.00 | -135 | 3 | 2 | 5 | 3 | 0 | -2.10 | W | +4.5u |
| 2026-06-16 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 7 | 0.00 | W | +0.0u |
| 2026-06-16 | MLB | ML | away | 2.5 | 0.25 | -106 | 1 | 0 | 1 | 1 | 28 | -0.20 | W | +0.0u |
| 2026-06-16 | MLB | ML | home | 3.0 | 0.50 | -174 | 2 | 1 | 3 | 1 | 45 | -1.40 | W | +2.3u |
...
| 2026-06-16 | MLB | ML | away | 3.0 | 0.50 | -102 | 1 | 0 | 1 | 1 | 28 | -1.00 | L | -0.5u |
| 2026-06-16 | MLB | SPREAD | away | 4.0 | 1.00 | -160 | 0 | 0 | 0 | 2 | 7 | 30.10 | W | +0.0u |
| 2026-06-16 | MLB | ML | away | 5.0 | 2.50 | +120 | -1 | -1 | -2 | -1 | 28 | -1.80 | L | -2.5u |
| 2026-06-16 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 0 | 0 | 1 | 3 | 0.00 | L | -1.0u |
| 2026-06-16 | MLB | ML | away | 2.5 | 0.25 | -112 | 1 | 0 | 1 | 1 | 0 | -0.90 | W | +0.0u |
| 2026-06-16 | MLB | SPREAD | away | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 4 | 0.00 | W | +0.0u |
