...
_Auto-generated **6/10/2026, 12:29:21 PM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 555 shipped+graded picks · 2026-04-18 → 2026-06-09  (HC analyses scoped to post-cutover 2026-04-30, 443 picks)
**Headline:** 281-269-5 · WR 51.1% [46.9%–55.2%] vs 52.4% break-even · -11.6u flat (-2.1%) · -35.1u peak.
**Overall t-test:** t = -0.50 → ✗ noise.
...
- **ρ(Δw, flat ROI) = 0.008 ✗**  (full sample, N=549)
- **ρ(HC, flat ROI) = -0.027 ✗**  (post-cutover, N=443)
- **ρ(Δw+HC, flat ROI) = -0.065 ✗**  (post-cutover, N=443)
...
- **Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era)** — N=75, 32-43, WR 42.7% [32%–54%], flat ROI -20.2% (t=-1.85 ~ p<.10)

### Action map

- **Tier-1a (HC ≥ +2)** — N=41, WR 46.3%, flat ROI -14.1%. Bayesian posterior WR ≈ 47.1%, half-Kelly = **0.0%** bankroll at −110 → **size aggressively**.
- **Tier-1b (HC = +1)** — N=147, WR 55.8%, flat ROI +7.4%. Bayesian posterior WR ≈ 55.4%, half-Kelly = **3.2%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=75, WR 42.7%, flat ROI -20.2%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=97, WR 48.5%, flat ROI -2.1%. Bayesian posterior WR ≈ 48.6%, half-Kelly = **0.0%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -9.9% flat ROI on 134 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (0.99u/pick), we need **~1510 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 555. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **555** |
| W-L-P | 281-269-5 |
| Win rate | **51.1%** [46.9%–55.2%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +1.3 pp |
| Peak-units PnL | **-35.1u** |
| Flat-1u PnL | **-11.6u** (-2.1% flat ROI) |
| Flat t-statistic vs zero | -0.50 → ✗ noise |
| Flat 95% CI per-pick | [-0.103, 0.062]u |
...
We have **555** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
|---|---|---|---|---|---|---|
| Δw ≤ −2 | 5 | 2-3-0 | 40.0% [12–77] | -30.3% | -3.0u | -0.71 ✗ noise |
| Δw = −1 | 18 | 5-13-0 | 27.8% [12–51] | -46.2% | -5.5u | -2.16 ✓ p<.05 |
| Δw = 0 | 111 | 56-52-3 | 51.9% [43–61] | -3.1% | +4.8u | -0.35 ✗ noise |
| Δw = +1 | 197 | 110-85-2 | 56.4% [49–63] | +6.3% | +21.6u | 0.93 ✗ noise |
| Δw = +2 | 121 | 57-64-0 | 47.1% [38–56] | -7.9% | -33.2u | -0.87 ✗ noise |
| Δw ≥ +3 | 97 | 47-50-0 | 48.5% [39–58] | -2.1% | -23.8u | -0.18 ✗ noise |

**Pearson ρ(Δw, WIN) = -0.004** ✗  ·  **ρ(Δw, flat ROI) = 0.008** ✗  (N=549)
...
| HC = −1 | 20 | 10-10-0 | 50.0% [30–70] | +6.4% | +6.3u | 0.26 ✗ noise |
| HC = 0 | 234 | 118-112-4 | 51.3% [45–58] | -4.3% | -23.1u | -0.70 ✗ noise |
| HC = +1 | 147 | 82-65-0 | 55.8% [48–64] | +7.4% | +3.2u | 0.91 ✗ noise |
| HC = +2 | 31 | 16-15-0 | 51.6% [35–68] | -0.4% | -4.6u | -0.02 ✗ noise |
| HC ≥ +3 | 10 | 3-7-0 | 30.0% [11–60] | -56.7% | -8.8u | -2.57 ✓ p<.05 |

**Pearson ρ(HC, WIN) = -0.010** ✗  ·  **ρ(HC, flat ROI) = -0.027** ✗  (N=443)

Spearman rank ρ(HC, flat ROI) = 0.005.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 83 | 40-41-2 | 49.4% [39–60] | -6.0% | +3.0u | -0.56 ✗ noise |
| Σ = +1 | 128 | 74-52-2 | 58.7% [50–67] | +10.2% | +19.9u | 1.23 ✗ noise |
| Σ = +2 | 106 | 61-45-0 | 57.5% [48–67] | +7.9% | +9.3u | 0.85 ✗ noise |
| Σ = +3 | 52 | 20-32-0 | 38.5% [26–52] | -24.2% | -23.0u | -1.76 ~ p<.10 |
| Σ = +4 | 37 | 20-17-0 | 54.1% [38–69] | +6.2% | -9.3u | 0.37 ✗ noise |
| Σ = +5 | 16 | 7-9-0 | 43.8% [23–67] | -17.0% | -7.8u | -0.69 ✗ noise |
| Σ ≥ +6 | 21 | 8-13-0 | 38.1% [21–59] | -29.8% | -16.6u | -1.46 ✗ noise |

**Pearson ρ(Δw+HC, WIN) = -0.057** ✗  ·  **ρ(Σ, flat ROI) = -0.065** ✗  (N=443)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 443.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.071 ✗ | -0.072 ✗ | -0.047 | weak |
| HC margin | -0.010 ✗ | -0.027 ✗ | 0.005 | weak |
| Δw + HC | -0.057 ✗ | -0.065 ✗ | -0.036 | weak |
| peak.stars | -0.045 ✗ | -0.068 ✗ | -0.087 | weak |
| vault.star | -0.069 ✗ | -0.085 ~ p<.10 | -0.100 | weak |
| lock.stars | -0.019 ✗ | -0.037 ✗ | -0.046 | weak |
...
Universe N = 443 (post-cutover, both axes present).

| HC \ Δw | ≤ −3 | -2 | -1 | +0 | +1 | +2 | ≥ +3 |
|---|---|---|---|---|---|---|---|
| ≤ −3 | — | — | — | — | — | — | — |
| -2 | — | N=1 · 1-0 · 100% [21–100] · —  | — | — | — | — | — |
| -1 | — | N=1 · 0-1 · 0% [0–79] · —  | N=2 · 1-1 · 50% [9–91] · —  | N=5 · 4-1 · 80% [38–96] · +72%  | N=6 · 1-5 · 17% [3–56] · -67% ✗ | N=2 · 2-0 · 100% [34–100] · — ★ | N=4 · 2-2 · 50% [15–85] · -1%  |
| +0 | N=1 · 1-0 · 100% [21–100] · —  | N=1 · 0-1 · 0% [0–79] · —  | N=6 · 2-4 · 33% [10–70] · -42%  | N=56 · 29-25 · 54% [41–66] · +1%  | N=101 · 58-41 · 59% [49–68] · +10%  | N=47 · 23-24 · 49% [35–63] · -10%  | N=22 · 5-17 · 23% [10–43] · -59% ✗ |
| +1 | — | — | N=4 · 1-3 · 25% [5–70] · -56%  | N=25 · 14-11 · 56% [37–73] · +2%  | N=54 · 35-19 · 65% [51–76] · +23%  | N=33 · 15-18 · 45% [30–62] · -7%  | N=31 · 17-14 · 55% [38–71] · +8%  |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δw ≤ −2 | 4 | 2-2-0 | 50.0% [15–85] | -12.8% | -2.5u | -0.25 ✗ noise |
| Δw = −1 | 12 | 4-8-0 | 33.3% [14–61] | -36.5% | -1.0u | -1.32 ✗ noise |
| Δw = 0 | 88 | 49-37-2 | 57.0% [46–67] | +6.3% | +18.2u | 0.63 ✗ noise |
| Δw = +1 | 164 | 95-67-2 | 58.6% [51–66] | +10.5% | +26.2u | 1.42 ✗ noise |
| Δw = +2 | 96 | 46-50-0 | 47.9% [38–58] | -7.1% | -29.4u | -0.69 ✗ noise |
| Δw ≥ +3 | 79 | 34-45-0 | 43.0% [33–54] | -17.6% | -35.9u | -1.62 ✗ noise |

### §3d. Practical lock zones (v7.4 floor anatomy)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 188 | 101-87-0 | 53.7% [47–61] | +2.7% | -10.2u | 0.38 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 75 | 32-43-0 | 42.7% [32–54] | -20.2% | -30.3u | -1.85 ~ p<.10 |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 180 | 97-79-4 | 55.1% [48–62] | +4.0% | +16.0u | 0.57 ✗ noise |
...
Universe N = 526 picks where ≥1 proven wallet appeared on either side.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δcount ≤ −2 (heavy oppose) | 10 | 5-5-0 | 50.0% [24–76] | -0.2% | -4.5u | -0.01 ✗ noise |
| Δcount = −1 | 25 | 12-13-0 | 48.0% [30–67] | -6.5% | -5.4u | -0.33 ✗ noise |
| Δcount = 0 (balanced) | 75 | 34-39-2 | 46.6% [36–58] | -11.7% | -5.0u | -1.06 ✗ noise |
| Δcount = +1 | 203 | 103-98-2 | 51.2% [44–58] | -3.6% | -23.7u | -0.54 ✗ noise |
| Δcount = +2 | 120 | 58-62-0 | 48.3% [40–57] | -8.3% | -21.7u | -0.93 ✗ noise |
| Δcount ≥ +3 (heavy support) | 93 | 59-34-0 | 63.4% [53–73] | +27.7% | +38.5u | 2.43 ✓ p<.05 |

**ρ(Δcount, WIN) = 0.072** ~ p<.10  ·  **ρ(Δcount, flat ROI) = 0.082** ~ p<.10
...
Quintile cuts: ≤ -18 · ≤ -1 · ≤ 7 · ≤ 20 · > 20

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 111 | 45-66-0 | 40.5% [32–50] | -22.3% | -57.1u | -2.47 ✓ p<.05 |
| Q2 | 110 | 50-59-1 | 45.9% [37–55] | -10.4% | -16.5u | -1.10 ✗ noise |
| Q3 (balanced) | 103 | 55-48-0 | 53.4% [44–63] | +0.8% | -4.2u | 0.09 ✗ noise |
| Q4 | 101 | 60-39-2 | 60.6% [51–70] | +17.4% | +26.4u | 1.77 ~ p<.10 |
| Q5 (best — heavy support) | 101 | 61-39-1 | 61.0% [51–70] | +15.6% | +29.6u | 1.53 ✗ noise |

**ρ(ΔWlNet, WIN) = 0.166** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.153** ✓ p<.01
...
Quintile cuts (units): ≤ -17.97 · ≤ -3.36 · ≤ 5.49 · ≤ 15.23 · > 15.23

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 123 | 57-65-1 | 46.7% [38–56] | -13.0% | -24.0u | -1.53 ✗ noise |
| Q2 | 90 | 38-52-0 | 42.2% [33–53] | -20.5% | -36.9u | -2.05 ✓ p<.05 |
| Q3 | 103 | 51-52-0 | 49.5% [40–59] | -6.1% | -10.1u | -0.63 ✗ noise |
| Q4 | 105 | 59-44-2 | 57.3% [48–66] | +7.8% | +3.8u | 0.83 ✗ noise |
| Q5 | 105 | 66-38-1 | 63.5% [54–72] | +29.0% | +45.4u | 2.74 ✓ p<.01 |
...
Quintile cuts (% ROI): ≤ -9.5 · ≤ -2.5 · ≤ 7.3 · ≤ 22.1 · > 22.1

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 123 | 38-84-1 | 31.1% [24–40] | -40.6% | -77.0u | -5.05 ✓ p<.01 |
| Q2 | 88 | 42-46-0 | 47.7% [38–58] | -11.6% | -17.5u | -1.15 ✗ noise |
| Q3 | 107 | 55-52-0 | 51.4% [42–61] | -3.3% | -6.7u | -0.35 ✗ noise |
| Q4 | 103 | 64-37-2 | 63.4% [54–72] | +19.6% | +25.5u | 2.13 ✓ p<.05 |
| Q5 | 105 | 72-32-1 | 69.2% [60–77] | +39.6% | +53.8u | 3.91 ✓ p<.01 |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 48 | 8-39-1 | 17.0% [9–30] | -66.5% | -45.6u | -6.36 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 18 | 8-10-0 | 44.4% [25–66] | -10.2% | -7.0u | -0.41 ✗ noise |
| ΔBestRank = 0 (tied) | 2 | 1-1-0 | 50.0% [9–91] | -4.5% | -1.4u | -0.05 ✗ noise |
| ΔBestRank ∈ [+1,+4] | 19 | 8-11-0 | 42.1% [23–64] | -22.2% | -9.8u | -1.02 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 127 | 77-47-3 | 62.1% [53–70] | +23.7% | +40.5u | 2.51 ✓ p<.05 |

**ρ(ΔBestRank, WIN) = 0.371** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.419** ✓ p<.01  (N=214)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 29 | 6-23-0 | 20.7% [10–38] | -63.5% | -21.0u | -4.57 ✓ p<.01 |
| Δshare ∈ [−30,−10] pp | 5 | 2-3-0 | 40.0% [12–77] | -8.8% | -2.5u | -0.15 ✗ noise |
| Δshare ≈ 0 (±10 pp) | 340 | 169-169-2 | 50.0% [45–55] | -7.1% | -56.2u | -1.39 ✗ noise |
| Δshare ∈ [+10,+30] pp | 24 | 15-9-0 | 62.5% [43–79] | +28.2% | +5.8u | 1.25 ✗ noise |
| Δshare ≥ +30 pp | 128 | 79-47-2 | 62.7% [54–71] | +26.8% | +52.0u | 2.85 ✓ p<.01 |

**ρ(ΔTopQShare, WIN) = 0.173** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.198** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔTopQCount** | 0.197 ✓ p<.01 | 0.250 ✓ p<.01 | 0.229 |
| 2 | **ΔTopQShare** | 0.173 ✓ p<.01 | 0.198 ✓ p<.01 | 0.217 |
| 3 | **ΔWlNet** | 0.166 ✓ p<.01 | 0.153 ✓ p<.01 | 0.124 |
| 4 | **Δcount** | 0.072 ~ p<.10 | 0.082 ~ p<.10 | 0.072 |
| 5 | **ΔFlatPnl** | NaN — | NaN — | 0.172 |
| 6 | **ΔAvgRoi** | NaN — | NaN — | 0.296 |

_(ΔBestRank uses N=214 subset where both sides had a proven wallet — ρ(flat ROI) = 0.419 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 948, dateRange = 2026-04-18 → 2026-06-09, computedAt = 2026-06-10T16:26:14.807Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **526** rows · PIT aggregate computable on **525** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **525** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 359 · 55% · +5.6% | 310 · 52% · -2.1% | -7.7pp |
| WEAK (−3..0) | 147 · 46% · -13.0% | 196 · 52% · +3.8% | +16.8pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=292, WR=55%, ROI=+5.8% | N=237, WR=51%, ROI=-5.3% | -11.1pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=359, WR=55%, ROI=+5.6% | N=310, WR=52%, ROI=-2.1% | -7.7pp |
| AGS < −1 (mute veto) | N=53, WR=40%, ROI=-24.0% | N=113, WR=48%, ROI=-2.0% | +22.0pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-05-27 → 2026-06-09, N=216)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 112 · 56% · +4.5% |
| WEAK (−3..0) | 104 · 50% · -2.8% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=77, WR=53%, ROI=+0.5% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=112, WR=56%, ROI=+4.5% |
| AGS < −1 (mute veto) | N=62, WR=49%, ROI=-4.3% |
...
| `dHcSizeRatio` | INTENSITY_HC | + | 1.01 | 4.46 |
| `dSumRankNorm` | QUALITY_RANK | − | 54.94 | 87.85 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.57 | 1.14 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **525/555** shipped+graded rows (95%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 84 | 42-42-0 | 50.0% [40–60] | -8.3% | -17.2u | -0.80 ✗ noise |
| LOCK | 96 | 44-52-0 | 45.8% [36–56] | -13.7% | -21.9u | -1.39 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 67 | 35-31-1 | 53.0% [41–65] | +2.1% | +8.4u | 0.18 ✗ noise |
| FADE | 118 | 54-61-3 | 47.0% [38–56] | -4.5% | -28.3u | -0.45 ✗ noise |
...
r(WIN) = **-0.030** ✗ · r(ROI) = **-0.061** ✗ · Spearman ρ(ROI) = **-0.061**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 103 | 54-47-2 | 53.5% [44–63] | +8.0% | -14.2u | 0.75 ✗ noise |
| z ∈ [−1, 0) | 181 | 99-80-2 | 55.3% [48–62] | +4.1% | +33.5u | 0.58 ✗ noise |
| z ∈ [0, +1) | 158 | 74-83-1 | 47.1% [39–55] | -10.3% | -39.4u | -1.34 ✗ noise |
| z ≥ +1 (very positive) | 83 | 40-43-0 | 48.2% [38–59] | -10.9% | -9.3u | -1.04 ✗ noise |
...
| z ∈ [0, +1) | 491 | 252-234-5 | 51.9% [47–56] | -1.7% | -26.3u | -0.40 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.076** ~ p<.10 · r(ROI) = **-0.083** ~ p<.10 · Spearman ρ(ROI) = **-0.079**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 96 | 55-40-1 | 57.9% [48–67] | +5.9% | +5.8u | 0.63 ✗ noise |
| z ∈ [−1, 0) | 175 | 95-78-2 | 54.9% [47–62] | +8.0% | +13.3u | 1.02 ✗ noise |
| z ∈ [0, +1) | 191 | 89-101-1 | 46.8% [40–54] | -9.9% | -44.1u | -1.40 ✗ noise |
| z ≥ +1 (very positive) | 63 | 28-34-1 | 45.2% [33–57] | -16.5% | -4.3u | -1.40 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.076 ~ p<.10 | -0.083 ~ p<.10 | -0.079 |
| 2 | `dCount` | COUNT | -0.030 ✗ | -0.061 ✗ | -0.061 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | -0.008 | 0.799 | 48.8% | meaningful |
| 2 | `dSumRankNorm` | -0.074 | 0.792 | 48.3% | meaningful |
| 3 | `dWinnerCtPreA` | -0.033 | 0.033 | 2.0% | silent (<0.2) |
| 4 | `dHcSizeRatio` | -0.015 | 0.015 | 0.9% | silent (<0.2) |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.050 | +0.718 ⚠ | +0.050 |
| `dHcSizeRatio` | +0.050 | 1.000 | +0.024 | +1.000 ⚠ |
| `dSumRankNorm` | +0.718 ⚠ | +0.024 | 1.000 | +0.024 |
| `dWinnerCtPreA` | +0.050 | +1.000 ⚠ | +0.024 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **-0.026**. At AGS ≥ +0.12 fires N=247, WR=50.2%, ROI=-6.1%. At AGS ≥ +null fires N=322, WR=51.7%, ROI=-3.4%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-247 ROI (matched cohort) | Top-247 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.080 | +0.054 | WR=57%, ROI=+8.7% | -14.8pp | N=255, WR=57%, ROI=+8.2% |
| `dHcSizeRatio` | +0.040 | +0.014 | WR=54%, ROI=+2.3% | -8.4pp | N=248, WR=55%, ROI=+2.7% |
| `dSumRankNorm` | -0.061 | +0.035 | WR=47%, ROI=-10.9% | +4.9pp | N=249, WR=48%, ROI=-10.1% |
| `dWinnerCtPreA` | +0.043 | +0.017 | WR=55%, ROI=+3.2% | -9.2pp | N=237, WR=54%, ROI=+1.7% |
...
|---|---|---|---|---|
| 1 | `dHcSizeRatio` | +0.014 | -8.4pp | redundant — other features cover it |
| 2 | `dWinnerCtPreA` | +0.017 | -9.2pp | redundant — other features cover it |
| 3 | `dSumRankNorm` | +0.035 | +4.9pp | redundant — other features cover it |
| 4 | `dCount` | +0.054 | -14.8pp | redundant — other features cover it |
...
| 2 | `dWinnerCtPreA` | QUALITY_TRACK | +0.042 | 0.042 | flat ≈ 0 |
| 3 | `dCount` | COUNT | +0.023 | 0.023 | flat ≈ 0 |
| 4 | `dHcSizeRatio` | INTENSITY_HC | +0.019 | 0.019 | flat ≈ 0 |

Intercept b = +0.025 · Final log-loss = 0.6892 · N = 525.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 525 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/525 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 184 | 87-97-0 | 47.3% [40–54] | -13.4% | -58.4u | -1.95 ~ p<.10 |
| 4.5★ | 77 | 51-25-1 | 67.1% [56–77] | +27.5% | +42.3u | 2.52 ✓ p<.05 |
| 4.0★ | 107 | 47-58-2 | 44.8% [36–54] | -13.7% | -14.8u | -1.45 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 74 | 39-34-1 | 53.4% [42–64] | +5.6% | -2.1u | 0.48 ✗ noise |
| 2.5★ | 75 | 38-36-1 | 51.4% [40–62] | -1.2% | -6.0u | -0.11 ✗ noise |

### §5b. Stars × Δw stratified — does the star tier hold up within each Δw cohort?

| Δw cohort | 5★ | 4.5★ | 4★ | 3.5★ | 3★ | 2.5★ |
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 26/58%/-1% | 20/65%/+25% | 21/30%/-41% | 6/33%/-26% | 29/39%/-27% | 31/50%/-4% |
| Δw = +1 | 33/55%/-0% | 29/68%/+24% | 50/47%/-10% | 28/54%/+4% | 27/67%/+31% | 29/55%/+2% |
| Δw = +2 | 60/43%/-17% | 14/64%/+20% | 30/50%/-1% | — | 9/44%/-3% | 8/38%/-16% |
| Δw ≥ +3 | 63/41%/-24% | 11/73%/+53% | 6/50%/-8% | 3/67%/+156% | 9/67%/+43% | 5/40%/-12% |
...
| −150/−101 | 337 | 168-166-3 | 50.3% [45–56] | -5.4% | -18.7u | -1.05 ✗ noise |
| −100/+100 | 6 | 3-3-0 | 50.0% [19–81] | +0.0% | -0.8u | 0.00 ✗ noise |
| +101/+150 | 109 | 52-55-2 | 48.6% [39–58] | +5.9% | -34.9u | 0.56 ✗ noise |
| +151/+200 | 14 | 7-7-0 | 50.0% [27–73] | +33.1% | +6.1u | 0.90 ✗ noise |
...
| −150/−101 | -10% (79) | +3% (130) | -22% (70) | +0% (55) |
| −100/+100 | -100% (1) | +33% (3) | -100% (1) | +100% (1) |
| +101/+150 | +11% (22) | +5% (40) | +6% (31) | -0% (16) |
| +151/+200 | +26% (2) | +31% (4) | +65% (5) | +32% (2) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 298 | 149-149-0 | 50.0% [44–56] | -3.7% | -38.0u | -0.62 ✗ noise |
| SPREAD | 87 | 43-43-1 | 50.0% [40–60] | -7.5% | +5.4u | -0.73 ✗ noise |
| TOTAL | 170 | 89-77-4 | 53.6% [46–61] | +3.5% | -2.5u | 0.47 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=72 · 44% · -19% | N=100 · 59% · +11% | N=62 · 47% · -5% | N=61 · 44% · -8% |
| SPREAD | N=22 · 38% · -27% | N=31 · 55% · +1% | N=17 · 65% · +15% | N=16 · 38% · -27% |
| TOTAL | N=40 · 61% · +16% | N=66 · 53% · +2% | N=42 · 40% · -21% | N=20 · 70% · +35% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 381 | 199-179-3 | 52.6% [48–58] | -0.4% | +0.8u | -0.09 ✗ noise |
| NBA | 127 | 59-67-1 | 46.8% [38–56] | -6.8% | -15.0u | -0.70 ✗ noise |
| NHL | 47 | 23-23-1 | 50.0% [36–64] | -3.1% | -20.8u | -0.21 ✗ noise |

### §8b. Sport × Δw cohort

| Sport | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| MLB | N=97 · 52% · -4% | N=154 · 57% · +7% | N=86 · 48% · -7% | N=43 · 49% · -6% |
| NBA | N=29 · 32% · -41% | N=29 · 48% · -6% | N=23 · 48% · -5% | N=41 · 54% · +14% |
| NHL | N=8 · 63% · +33% | N=14 · 69% · +25% | N=12 · 42% · -20% | N=13 · 31% · -40% |
...
|---|---|---|
| **sharps3Plus** | 235 · 45% · -11.2% · -1.66 ~ p<.10 | 319 · 56% · +4.2% · 0.79 ✗ noise |
| **plusEV** | 63 · 49% · -0.7% · -0.05 ✗ noise | 491 · 51% · -2.6% · -0.59 ✗ noise |
| **pinnacleConfirms** | 137 · 52% · +0.4% · 0.04 ✗ noise | 262 · 51% · -4.0% · -0.66 ✗ noise |
| **invested10kPlus** | 277 · 50% · -3.6% · -0.59 ✗ noise | 122 · 52% · +0.0% · 0.00 ✗ noise |
| **lineMovingWith** | 269 · 54% · +3.5% · 0.58 ✗ noise | 285 · 48% · -7.9% · -1.37 ✗ noise |
| **predMarketAligns** | 141 · 51% · -1.9% · -0.21 ✗ noise | 258 · 51% · -2.8% · -0.47 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 137 | 74-63-0 | 54.0% [46–62] | +3.3% | +12.3u | 0.39 ✗ noise |
| 1 | 125 | 61-61-3 | 50.0% [41–59] | -5.3% | -26.2u | -0.63 ✗ noise |
| 2 | 132 | 67-63-2 | 51.5% [43–60] | -0.8% | +2.6u | -0.09 ✗ noise |
| 3 | 49 | 23-26-0 | 46.9% [34–61] | -9.6% | -9.7u | -0.67 ✗ noise |
| 4 | 48 | 24-24-0 | 50.0% [36–64] | -9.2% | -10.8u | -0.67 ✗ noise |
...
| NEAR_START | 226 | 107-115-4 | 48.2% [42–55] | -5.4% | -51.9u | -0.79 ✗ noise |
| NO_MOVE | 18 | 9-9-0 | 50.0% [29–71] | -8.6% | +6.5u | -0.38 ✗ noise |
| PREGAME | 88 | 50-38-0 | 56.8% [46–67] | +8.5% | +13.4u | 0.83 ✗ noise |
| SMALL_MOVE | 115 | 54-61-0 | 47.0% [38–56] | -11.6% | -13.8u | -1.27 ✗ noise |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 305 | 157-147-1 | 51.6% [46–57] | -3.1% | -40.7u | -0.57 ✗ noise |
| STRONG | 87 | 44-41-2 | 51.8% [41–62] | +1.6% | +7.0u | 0.15 ✗ noise |
| LEAN | 155 | 76-77-2 | 49.7% [42–58] | -2.7% | -2.9u | -0.31 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.107 ✓ p<.05 | -0.080 ~ p<.10 | -0.070 | -1.89 |
| totalInvested | -0.062 ✗ | -0.075 ~ p<.10 | -0.041 | -1.77 |
| evEdge | 0.086 ✓ p<.05 | 0.119 ✓ p<.01 | 0.067 | 2.82 |
| moneyPct | 0.044 ✗ | 0.014 ✗ | 0.010 | 0.33 |
| walletPct | 0.048 ✗ | 0.037 ✗ | 0.036 | 0.87 |
| criteriaMet | -0.025 ✗ | -0.013 ✗ | -0.041 | -0.31 |
| maxContribFor | -0.024 ✗ | -0.007 ✗ | 0.014 | -0.17 |
| meanBaseFor | -0.013 ✗ | 0.018 ✗ | 0.049 | 0.42 |
...
Sample with CLV: **543** picks. Mean CLV = **-0.0037**.
t-statistic vs zero: -3.02 → ✓ p<.01 · 95% CI [-0.0062, -0.0013]

Bucketed CLV vs flat PnL:

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLV ≤ −2% | 60 | 27-32-1 | 45.8% [34–58] | -19.8% | -13.9u | -1.74 ~ p<.10 |
| CLV (−2%, 0] | 315 | 158-154-3 | 50.6% [45–56] | -3.4% | -34.2u | -0.62 ✗ noise |
| CLV (0, +2%] | 143 | 77-66-0 | 53.8% [46–62] | +8.1% | +5.1u | 0.91 ✗ noise |
...
Trained on N=425 (with all features non-null). Intercept β₀ = 0.091.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | pw.ΔAvgRoi | +0.463 | ↑ helps |
| 2 | sharpCount | -0.289 | ↓ hurts |
| 3 | pw.Δcount | +0.220 | ↑ helps |
| 4 | evEdge | +0.213 | ↑ helps |
| 5 | log(impliedProb) | +0.188 | ↑ helps |
| 6 | peak.stars | -0.108 | ↓ hurts |
| 7 | pw.ΔFlatPnl | +0.106 | ↑ helps |
| 8 | HC margin | +0.098 | ↑ helps |
| 9 | pw.ΔWlNet | +0.097 | ↑ helps |
| 10 | Δw | -0.066 | ↓ hurts |
| 11 | walletPct | +0.053 | ↑ helps |
| 12 | log10(invested) | +0.040 | ≈ flat |
| 13 | vault.star | +0.037 | ≈ flat |
| 14 | moneyPct | -0.032 | ≈ flat |
| 15 | pw.ΔTopQShare | -0.027 | ≈ flat |
| 16 | odds (American) | -0.013 | ≈ flat |
| 17 | criteriaMet | -0.008 | ≈ flat |
| 18 | Δw + HC | -0.006 | ≈ flat |
...
| Tier-1b HC = +1 (post-cutover) | 147 | 82-65 | 55.8% | 55.4% | -110 | 3.18% bankroll | 2.11u | **UNDER-SIZED** — ship up to 3.18u (1u=1% bankroll) |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 75 | 32-43 | 42.7% | 43.5% | -110 | — (mute) | 2.00u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 97 | 47-50 | 48.5% | 48.6% | -110 | — (mute) | 2.46u | **MUTE** (negative EV at posterior) |
| Stale Δw = 0 | 111 | 56-52 | 51.9% | 51.7% | -110 | — (mute) | 1.77u | **MUTE** (negative EV at posterior) |
| Stale Δw ≤ −1 | 23 | 7-16 | 30.4% | 36.4% | -129 | — (mute) | 1.31u | **MUTE** (negative EV at posterior) |
...
**Daily Sharpe-like (μ/σ):** -0.107  (annualized × √252 ≈ -1.70)
...
| 2026-04-19 | MLB | ML | home | 4.0 | 2.00 | -106 | 3 | — | — | 1 | -7 | 0.00 | W | +1.8u |
| 2026-04-19 | MLB | ML | home | 3.0 | 1.00 | -125 | 3 | — | — | 1 | 2 | -0.60 | W | +0.8u |
| 2026-04-19 | MLB | ML | away | 2.5 | 1.00 | +100 | 0 | — | — | 0 | 26 | 1.00 | L | -1.0u |
| 2026-04-19 | NBA | ML | away | 4.5 | 1.00 | +295 | 4 | — | — | 4 | 18 | -0.50 | W | +3.1u |
...
| 2026-04-20 | NBA | ML | home | 3.0 | 1.00 | -235 | -1 | — | — | -2 | -19 | -1.00 | L | -1.0u |
...
| 2026-04-21 | NBA | ML | away | 3.5 | 0.50 | +475 | 3 | — | — | 4 | 21 | 0.60 | W | +2.4u |
| 2026-04-21 | NBA | SPREAD | away | 4.5 | 2.00 | -110 | 2 | — | — | 3 | -4 | -0.20 | W | +1.8u |
| 2026-04-21 | NBA | TOTAL | over | 4.0 | 1.75 | -102 | 0 | — | — | 1 | -8 | 0.00 | L | -1.8u |
| 2026-04-21 | NHL | ML | away | 3.0 | 0.75 | +145 | 3 | — | — | -2 | -6 | -0.90 | W | +1.1u |
| 2026-04-21 | NHL | ML | home | 2.5 | 1.00 | -184 | 1 | — | — | 0 | -7 | -1.60 | W | +0.5u |
...
| 2026-04-22 | NHL | ML | home | 3.0 | 0.50 | -188 | 1 | — | — | -2 | -9 | -1.80 | L | -0.5u |
...
| 2026-04-23 | NHL | ML | home | 2.5 | 1.35 | +140 | 1 | — | — | -2 | -5 | 1.40 | L | -1.4u |
| 2026-04-23 | NHL | TOTAL | over | 3.0 | 1.00 | -113 | 0 | — | — | — | — | 0.00 | W | +0.9u |
| 2026-04-24 | MLB | ML | home | 3.5 | 0.75 | -108 | 1 | — | — | 1 | -19 | -1.40 | W | +0.7u |
| 2026-04-24 | NBA | ML | away | 5.0 | 3.00 | -295 | 0 | — | — | 4 | 19 | 0.00 | W | +1.0u |
...
| 2026-04-24 | NHL | ML | home | 5.0 | 3.00 | +102 | 2 | — | — | 1 | 6 | -1.70 | W | +2.9u |
...
| 2026-04-25 | NBA | ML | home | 5.0 | 2.00 | +125 | 4 | — | — | 2 | 7 | -1.20 | W | +2.4u |
| 2026-04-25 | NBA | SPREAD | home | 5.0 | 2.00 | -105 | 2 | — | — | 2 | 5 | -0.70 | L | -2.0u |
...
| 2026-04-26 | MLB | ML | home | 3.5 | 0.75 | -110 | 1 | — | — | 1 | 28 | -1.40 | L | -0.8u |
...
| 2026-04-30 | NHL | ML | away | 2.5 | 0.75 | -130 | 0 | 1 | 1 | 0 | -4 | -0.60 | L | -0.8u |
...
| 2026-05-01 | NBA | ML | home | 5.0 | 3.00 | -180 | 3 | -1 | 2 | 3 | -15 | 0.10 | L | -3.0u |
...
| 2026-05-03 | NBA | ML | away | 4.0 | 0.75 | +310 | 0 | 1 | 1 | 2 | 1 | 0.70 | L | -0.8u |
...
| 2026-05-04 | MLB | ML | home | 3.5 | 1.13 | -199 | -1 | 1 | 0 | -1 | 0 | -0.20 | L | -1.1u |
...
| 2026-05-04 | NHL | ML | home | 3.5 | 1.13 | -165 | 1 | 1 | 2 | 1 | 7 | -0.10 | W | +0.7u |
...
| 2026-05-07 | MLB | TOTAL | over | 3.5 | 0.75 | -110 | 1 | 1 | 2 | 1 | -5 | 0.00 | W | +0.7u |
| 2026-05-08 | MLB | ML | home | 4.0 | 1.88 | -136 | 2 | 1 | 3 | 1 | -5 | -0.20 | L | -1.9u |
...
| 2026-05-09 | NBA | SPREAD | home | 4.5 | 1.70 | -104 | — | — | — | 2 | 10 | 0.00 | W | +1.6u |
...
| 2026-05-12 | NBA | SPREAD | away | 5.0 | 3.50 | -105 | 6 | 4 | 10 | 6 | 33 | -0.70 | L | -3.5u |
| 2026-05-13 | MLB | ML | home | 4.5 | 4.50 | -116 | 1 | 1 | 2 | 1 | -19 | -1.30 | W | +3.7u |
| 2026-05-13 | MLB | SPREAD | home | 5.0 | 3.50 | -105 | 1 | 1 | 2 | 2 | -24 | 0.90 | W | +3.2u |
...
| 2026-05-14 | MLB | TOTAL | over | 3.5 | 0.49 | -110 | 1 | 1 | 2 | 1 | -5 | 0.00 | L | -0.5u |
| 2026-05-14 | NHL | TOTAL | under | 5.0 | 3.50 | -110 | 3 | 1 | 4 | 1 | 7 | 0.00 | L | -3.5u |
| 2026-05-14 | NHL | ML | away | 4.5 | 1.95 | -114 | 0 | 1 | 1 | 4 | 10 | 0.00 | W | +1.7u |
...
| 2026-05-15 | NBA | ML | away | 2.5 | 0.50 | +145 | 6 | 1 | 7 | 5 | 30 | -0.50 | W | +0.8u |
| 2026-05-15 | NBA | TOTAL | over | 4.0 | 0.75 | -109 | 0 | 1 | 1 | 2 | -15 | 0.00 | L | -0.8u |
...
| 2026-05-16 | MLB | ML | away | 2.5 | 0.50 | -102 | 1 | 0 | 1 | 1 | -55 | 0.00 | W | +0.5u |
...
| 2026-05-17 | MLB | TOTAL | over | 4.5 | 2.25 | -110 | 2 | 1 | 3 | 2 | -24 | 0.00 | W | +2.0u |
...
| 2026-05-17 | NBA | TOTAL | under | 5.0 | 0.75 | -110 | 2 | 3 | 5 | 0 | 29 | 0.00 | L | -0.8u |
...
| 2026-05-18 | NHL | TOTAL | under | 4.5 | 2.25 | -110 | 3 | 1 | 4 | 1 | 7 | 0.00 | W | +2.0u |
...
| 2026-05-19 | MLB | ML | away | 2.5 | 1.25 | -104 | 1 | 1 | 2 | 0 | -14 | -1.20 | W | +1.2u |
...
| 2026-05-21 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 0 | 0 | 2 | -5 | 0.00 | W | +0.3u |
| 2026-05-21 | MLB | ML | home | 3.0 | 1.25 | -116 | 3 | 1 | 4 | 2 | -24 | -0.40 | L | -1.3u |
| 2026-05-21 | MLB | ML | away | 3.0 | 1.25 | +129 | 1 | 0 | 1 | 3 | -51 | -0.40 | W | +1.6u |
| 2026-05-21 | MLB | SPREAD | away | 4.0 | 1.65 | -170 | 1 | 1 | 2 | 1 | -5 | 0.30 | W | +1.0u |
| 2026-05-21 | NBA | SPREAD | away | 5.0 | 3.00 | -110 | 4 | 2 | 6 | 3 | 18 | 0.70 | L | -3.0u |
| 2026-05-21 | NHL | ML | home | 4.0 | 2.75 | -197 | 4 | 1 | 5 | 1 | 7 | -1.30 | L | -2.8u |
| 2026-05-21 | NHL | TOTAL | over | 3.0 | 0.75 | +103 | 1 | 0 | 1 | 1 | 7 | 0.00 | W | +0.7u |
...
| 2026-05-22 | NBA | ML | home | 5.0 | 5.00 | -120 | 0 | 0 | 0 | -3 | -36 | 0.00 | L | -5.0u |
| 2026-05-22 | NBA | SPREAD | home | 2.5 | 1.00 | -110 | 1 | 0 | 1 | -2 | 6 | -0.50 | L | -1.0u |
...
| 2026-05-23 | MLB | ML | home | 2.5 | 0.50 | -181 | 1 | 0 | 1 | 2 | 20 | -1.70 | W | +0.3u |
| 2026-05-23 | MLB | ML | away | 2.5 | 2.75 | +109 | 2 | 0 | 2 | 2 | -28 | -0.50 | L | -2.8u |
| 2026-05-23 | MLB | TOTAL | over | 2.5 | 0.30 | -110 | 0 | 1 | 1 | 0 | -1 | 0.00 | W | +0.3u |
...
| 2026-05-23 | MLB | TOTAL | under | 2.5 | 0.30 | +108 | 0 | 0 | 0 | 0 | -14 | 0.00 | P | +0.0u |
| 2026-05-23 | MLB | ML | home | 4.0 | 2.50 | +118 | 1 | 0 | 1 | 1 | -5 | 1.10 | W | +2.9u |
| 2026-05-23 | MLB | ML | away | 3.0 | 1.25 | +166 | 2 | 1 | 3 | 2 | -17 | -0.30 | W | +1.8u |
| 2026-05-23 | MLB | SPREAD | away | 4.5 | 2.25 | -123 | 1 | 0 | 1 | 2 | -13 | -0.90 | W | +1.6u |
...
| 2026-05-24 | MLB | ML | home | 4.5 | 3.75 | -101 | 2 | 1 | 3 | 2 | -24 | 0.00 | L | -3.8u |
| 2026-05-24 | MLB | ML | home | 3.0 | 1.25 | -189 | 1 | 0 | 1 | 1 | 28 | 0.00 | W | +0.7u |
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 0.75 | -110 | 1 | 0 | 1 | 2 | 11 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 1 | 1 | 2 | 0 | -30 | 0.00 | L | -1.6u |
| 2026-05-24 | MLB | ML | home | 5.0 | 5.00 | -115 | 1 | 1 | 2 | 1 | -5 | 0.00 | W | +4.3u |
...
| 2026-05-24 | MLB | ML | home | 2.5 | 0.50 | +144 | 1 | 1 | 2 | -1 | -57 | 0.00 | L | -0.5u |
...
| 2026-05-24 | MLB | TOTAL | under | 2.5 | 0.30 | -104 | 0 | 0 | 0 | 1 | 16 | 0.00 | W | +0.3u |
| 2026-05-24 | MLB | ML | away | 4.0 | 1.25 | +148 | 2 | 2 | 4 | 0 | -12 | -1.40 | W | +1.9u |
| 2026-05-24 | MLB | ML | away | 3.0 | 1.25 | -122 | -1 | 1 | 0 | 0 | -38 | -1.10 | L | -1.3u |
| 2026-05-24 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 2 | -9 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | SPREAD | home | 3.0 | 0.75 | +134 | 1 | 0 | 1 | 1 | -3 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 0 | -29 | 0.00 | W | +0.7u |
...
| 2026-05-25 | MLB | ML | home | 5.0 | 5.00 | -149 | 1 | 0 | 1 | 3 | 0 | -0.70 | L | -5.0u |
| 2026-05-25 | MLB | ML | home | 5.0 | 5.00 | -310 | 2 | 0 | 2 | 1 | 28 | -1.20 | W | +1.6u |
| 2026-05-25 | MLB | TOTAL | over | 4.0 | 1.65 | +103 | 1 | 0 | 1 | 2 | -3 | 0.00 | L | -1.6u |
| 2026-05-25 | MLB | ML | home | 4.0 | 1.25 | -125 | 1 | -1 | 0 | 1 | -23 | -1.90 | L | -1.3u |
| 2026-05-25 | MLB | SPREAD | away | 4.0 | 1.65 | -184 | 1 | 0 | 1 | 1 | -5 | 28.40 | W | +2.4u |
| 2026-05-25 | MLB | TOTAL | under | 5.0 | 2.25 | -112 | 4 | 0 | 4 | 4 | -19 | 0.00 | L | -2.3u |
| 2026-05-25 | MLB | ML | home | 5.0 | 1.25 | -160 | 3 | 0 | 3 | 2 | -39 | -1.10 | L | -1.3u |
| 2026-05-25 | MLB | TOTAL | over | 5.0 | 3.00 | -110 | 3 | 0 | 3 | 3 | 2 | 0.00 | W | +2.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 3.75 | -108 | 0 | 0 | 0 | 3 | -47 | -1.70 | L | -3.8u |
| 2026-05-25 | MLB | SPREAD | home | 5.0 | 1.65 | -124 | 2 | 0 | 2 | 2 | -27 | -1.30 | W | +0.5u |
| 2026-05-25 | MLB | ML | away | 5.0 | 5.00 | -119 | 2 | -1 | 1 | 4 | -17 | -0.60 | W | +3.1u |
| 2026-05-25 | MLB | ML | away | 2.5 | 2.75 | -113 | 0 | 0 | 0 | 0 | 11 | -1.80 | W | +1.1u |
| 2026-05-25 | MLB | ML | home | 4.0 | 5.00 | -209 | -1 | 0 | -1 | 3 | 0 | -0.80 | W | +2.3u |
...
| 2026-05-25 | NBA | ML | away | 5.0 | 5.00 | -125 | 0 | 0 | 0 | 3 | 30 | -0.40 | W | +4.0u |
...
| 2026-05-26 | MLB | ML | away | 5.0 | 5.00 | -200 | 1 | 0 | 1 | 2 | 20 | -0.60 | W | +1.9u |
...
| 2026-05-26 | MLB | ML | home | 5.0 | 5.00 | -105 | 2 | 1 | 3 | 2 | 20 | -2.00 | W | +3.6u |
| 2026-05-26 | MLB | ML | away | 5.0 | 2.50 | +116 | 1 | 0 | 1 | 2 | 20 | -1.00 | W | +2.9u |
| 2026-05-26 | NBA | ML | home | 5.0 | 5.00 | -198 | 2 | 4 | 6 | 2 | 11 | -0.70 | W | +1.9u |
| 2026-05-26 | NBA | SPREAD | home | 5.0 | 1.00 | -110 | 2 | 2 | 4 | 3 | 23 | 1.20 | W | +0.0u |
...
| 2026-05-27 | MLB | SPREAD | away | 5.0 | 2.50 | +141 | 1 | 1 | 2 | 4 | -25 | 0.80 | L | -2.5u |
...
| 2026-05-27 | MLB | ML | away | 5.0 | 0.50 | -102 | 3 | 0 | 3 | 2 | 14 | -1.00 | L | -0.5u |
| 2026-05-27 | MLB | SPREAD | away | 4.0 | 0.75 | -163 | 0 | 0 | 0 | 1 | -8 | 0.40 | W | +0.5u |
| 2026-05-27 | MLB | TOTAL | under | 5.0 | 1.00 | -112 | 3 | 1 | 4 | 3 | -22 | 0.00 | W | +0.0u |
| 2026-05-27 | MLB | ML | away | 4.0 | 1.00 | -108 | 1 | -1 | 0 | 0 | 41 | -0.90 | L | -1.0u |
| 2026-05-27 | MLB | ML | home | 5.0 | 0.50 | +132 | 2 | 0 | 2 | 2 | -2 | -0.50 | L | -0.5u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 1.65 | +104 | 2 | 0 | 2 | 2 | -3 | 0.00 | W | +1.7u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 0.75 | +104 | 2 | 0 | 2 | 2 | -2 | 0.00 | W | +0.8u |
| 2026-05-27 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 2 | 5 | 4 | -19 | -0.30 | L | -2.5u |
| 2026-05-27 | MLB | SPREAD | away | 4.5 | 1.65 | -145 | 1 | 1 | 2 | 1 | -8 | -0.30 | W | +1.1u |
| 2026-05-27 | MLB | ML | away | 5.0 | 5.00 | -126 | 2 | 0 | 2 | 1 | -14 | -4.10 | L | -5.0u |
...
| 2026-05-28 | MLB | TOTAL | over | 5.0 | 3.00 | +101 | 3 | -1 | 2 | 3 | 21 | 0.00 | W | +2.5u |
| 2026-05-28 | MLB | ML | home | 5.0 | 1.25 | -140 | 2 | 0 | 2 | 2 | -20 | -0.50 | L | -1.3u |
| 2026-05-28 | MLB | TOTAL | under | 5.0 | 1.00 | -107 | 1 | 0 | 1 | 1 | 38 | 0.00 | W | +0.0u |
| 2026-05-28 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 1 | 4 | 2 | -75 | -0.60 | L | -2.5u |
| 2026-05-28 | MLB | TOTAL | over | 2.5 | 1.65 | -108 | 2 | 0 | 2 | 2 | -27 | 0.00 | L | -1.6u |
| 2026-05-28 | NBA | SPREAD | away | 5.0 | 1.00 | -110 | 1 | 2 | 3 | 0 | 0 | -0.90 | L | -1.0u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.50 | +118 | 5 | 1 | 6 | 5 | 5 | -0.90 | L | -2.5u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 0.75 | -135 | 2 | 0 | 2 | 1 | -18 | 1.00 | L | -0.8u |
| 2026-05-29 | MLB | ML | home | 5.0 | 3.75 | -124 | 2 | 1 | 3 | 3 | 1 | -1.00 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 1.65 | -106 | 2 | 0 | 2 | 3 | -2 | 0.00 | L | -1.6u |
| 2026-05-29 | MLB | ML | home | 4.0 | 2.50 | +120 | 1 | 0 | 1 | 1 | -1 | 0.40 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 2.25 | -112 | 2 | 0 | 2 | 3 | 22 | 0.00 | W | +2.0u |
...
| 2026-05-29 | MLB | ML | away | 4.5 | 1.25 | -142 | 0 | 1 | 1 | -2 | 16 | -1.20 | W | +0.3u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 1.65 | -135 | 1 | 0 | 1 | 2 | -27 | 0.40 | W | +1.2u |
| 2026-05-29 | MLB | ML | home | 4.5 | 1.25 | -134 | 1 | 0 | 1 | 0 | -1 | -1.70 | W | +2.8u |
| 2026-05-29 | MLB | SPREAD | away | 5.0 | 2.25 | -184 | 0 | 0 | 0 | 2 | -6 | -1.00 | W | +1.2u |
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 0.75 | -109 | 1 | 0 | 1 | 2 | -2 | 0.00 | W | +0.7u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.75 | -106 | 2 | 1 | 3 | 2 | 43 | 0.70 | L | -2.8u |
| 2026-05-29 | MLB | SPREAD | home | 4.0 | 1.65 | -175 | 0 | 0 | 0 | 2 | -27 | -0.80 | L | -1.6u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 0.30 | +105 | 2 | 1 | 3 | 1 | 15 | 0.00 | W | +0.3u |
...
| 2026-05-30 | MLB | ML | away | 5.0 | 2.50 | +132 | 2 | 1 | 3 | 2 | -24 | 0.00 | L | -2.5u |
...
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -118 | 1 | 1 | 2 | 1 | -27 | -1.30 | L | -3.8u |
| 2026-05-30 | MLB | SPREAD | away | 4.0 | 1.00 | +152 | 1 | 0 | 1 | 1 | -8 | 0.20 | L | -1.0u |
| 2026-05-30 | MLB | ML | home | 5.0 | 5.00 | -120 | 0 | 0 | 0 | 3 | -47 | -1.10 | W | +4.2u |
...
| 2026-05-30 | MLB | TOTAL | under | 4.0 | 1.65 | -107 | 1 | 0 | 1 | 1 | 10 | 0.00 | L | -1.6u |
| 2026-05-30 | MLB | ML | home | 4.0 | 2.50 | +129 | 1 | 0 | 1 | 1 | -19 | -0.90 | W | +0.7u |
| 2026-05-30 | MLB | SPREAD | home | 5.0 | 1.65 | -120 | 2 | 1 | 3 | 2 | -27 | -0.60 | W | +1.4u |
| 2026-05-30 | MLB | ML | away | 5.0 | 2.50 | +108 | 1 | 0 | 1 | 3 | -47 | -0.90 | W | +2.7u |
| 2026-05-30 | MLB | ML | home | 4.0 | 0.50 | +110 | 1 | 0 | 1 | 1 | -19 | -0.20 | W | +0.6u |
| 2026-05-30 | MLB | ML | home | 5.0 | 1.25 | -102 | 2 | 0 | 2 | 2 | 9 | -0.70 | W | +1.2u |
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -122 | 1 | 1 | 2 | 2 | -28 | -0.20 | L | -3.8u |
| 2026-05-30 | MLB | TOTAL | under | 3.0 | 0.75 | -108 | 0 | 0 | 0 | 1 | -8 | 0.00 | L | -0.8u |
| 2026-05-30 | NBA | ML | home | 5.0 | 1.00 | -154 | 3 | 3 | 6 | 0 | 0 | 0.00 | L | -1.0u |
| 2026-05-30 | NBA | TOTAL | under | 5.0 | 2.50 | -109 | 5 | 0 | 5 | 6 | 9 | 0.00 | L | -2.5u |
| 2026-05-31 | MLB | ML | away | 3.0 | 2.75 | -125 | -2 | 0 | -2 | 1 | -23 | -1.20 | L | -2.8u |
| 2026-05-31 | MLB | TOTAL | under | 5.0 | 1.65 | -114 | 2 | 0 | 2 | 3 | -21 | 0.00 | L | -1.6u |
| 2026-05-31 | MLB | ML | home | 2.5 | 2.75 | -115 | 1 | 1 | 2 | 1 | 16 | 0.00 | W | +2.4u |
| 2026-05-31 | MLB | ML | away | 5.0 | 1.00 | +115 | -1 | 0 | -1 | 2 | -28 | -0.60 | L | -1.0u |
| 2026-05-31 | MLB | SPREAD | away | 5.0 | 1.00 | -117 | 3 | 1 | 4 | 3 | -22 | -0.20 | L | -1.0u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -164 | 0 | 1 | 1 | 2 | -28 | -1.20 | W | +2.3u |
| 2026-05-31 | MLB | ML | away | 3.0 | 1.25 | -184 | 0 | 0 | 0 | 0 | -12 | -1.70 | W | +0.7u |
| 2026-05-31 | MLB | ML | home | 2.5 | 1.25 | -232 | 0 | 0 | 0 | 1 | 21 | -0.50 | W | +0.5u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -102 | 0 | 1 | 1 | 2 | -61 | 0.20 | W | +4.9u |
| 2026-05-31 | MLB | TOTAL | over | 4.0 | 1.00 | +101 | 2 | 1 | 3 | 2 | -15 | 0.00 | L | -1.0u |
| 2026-05-31 | MLB | ML | away | 4.5 | 2.50 | +110 | 0 | 0 | 0 | 0 | -12 | -1.10 | L | -2.5u |
| 2026-06-01 | MLB | ML | home | 4.5 | 3.00 | -155 | 3 | 2 | 5 | 3 | 20 | -1.00 | W | +2.1u |
| 2026-06-01 | MLB | ML | away | 4.0 | 1.00 | +135 | 2 | 2 | 4 | 3 | 38 | -0.20 | W | +1.4u |
| 2026-06-01 | MLB | ML | away | 5.0 | 2.50 | +160 | 2 | -1 | 1 | 2 | 45 | -1.30 | W | +2.7u |
| 2026-06-01 | MLB | TOTAL | under | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 2 | -36 | 0.00 | L | -1.0u |
| 2026-06-01 | MLB | ML | home | 3.0 | 0.50 | -142 | -1 | 0 | -1 | 0 | 36 | -0.40 | L | -0.5u |
| 2026-06-01 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 5 | 0.00 | L | -5.0u |
| 2026-06-01 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 2 | -27 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | ML | home | 2.5 | 0.25 | -215 | -1 | 0 | -1 | 0 | -2 | -1.40 | L | -0.3u |
| 2026-06-02 | MLB | TOTAL | under | 4.0 | 1.00 | -117 | 1 | 0 | 1 | 0 | 14 | 0.00 | L | -1.0u |
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +130 | 2 | 0 | 2 | 0 | 70 | -0.60 | W | +3.1u |
| 2026-06-02 | MLB | ML | away | 3.0 | 0.50 | +100 | 1 | 0 | 1 | 2 | 20 | -1.20 | W | +0.5u |
| 2026-06-02 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | L | -3.0u |
...
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +134 | -1 | -1 | -2 | -1 | 56 | -1.00 | W | +1.2u |
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +125 | 0 | -1 | -1 | 0 | 62 | 0.40 | W | +1.3u |
| 2026-06-03 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 26 | 0.00 | L | -3.0u |
| 2026-06-03 | MLB | ML | home | 4.5 | 1.50 | +167 | 0 | 0 | 0 | -1 | 36 | -0.40 | L | -1.5u |
| 2026-06-03 | MLB | SPREAD | away | 4.0 | 1.00 | -111 | 1 | 0 | 1 | 0 | 18 | 0.20 | W | +0.8u |
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -103 | 3 | 1 | 4 | 2 | 8 | -1.20 | L | -0.5u |
| 2026-06-03 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 3 | 0.00 | L | -5.0u |
| 2026-06-03 | MLB | ML | away | 3.0 | 0.50 | +119 | 1 | 0 | 1 | 1 | 28 | 0.00 | W | +0.6u |
| 2026-06-03 | MLB | ML | away | 4.5 | 3.00 | -137 | 0 | 0 | 0 | -1 | 55 | -1.50 | L | -3.0u |
| 2026-06-03 | MLB | ML | home | 5.0 | 5.00 | -215 | 0 | 1 | 1 | 0 | 48 | -1.00 | W | +2.3u |
| 2026-06-03 | MLB | TOTAL | over | 2.5 | 0.25 | -110 | 1 | 1 | 2 | 1 | -8 | 0.00 | L | -0.3u |
| 2026-06-03 | MLB | TOTAL | under | 4.5 | 2.50 | -110 | 1 | 0 | 1 | 0 | 14 | 0.00 | W | +2.5u |
| 2026-06-03 | MLB | ML | home | 4.5 | 3.00 | -112 | 0 | 0 | 0 | 1 | 28 | -0.90 | W | +2.7u |
| 2026-06-03 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 1 | 3 | 0.00 | W | +4.5u |
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -139 | 0 | 0 | 0 | 0 | 69 | -1.20 | W | +0.3u |
| 2026-06-03 | MLB | TOTAL | under | 4.5 | 2.50 | -110 | 1 | 0 | 1 | 0 | 14 | 0.00 | L | -2.5u |
| 2026-06-03 | NBA | ML | home | 2.5 | 0.25 | -198 | 3 | 4 | 7 | 5 | 14 | -1.20 | L | -0.3u |
| 2026-06-03 | NBA | SPREAD | away | 2.5 | 0.25 | -104 | 3 | -1 | 2 | 3 | -1 | -1.20 | W | +0.2u |
| 2026-06-04 | MLB | ML | away | 3.0 | 0.50 | +104 | 1 | 0 | 1 | 1 | 28 | 0.00 | W | +0.5u |
| 2026-06-04 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | -1 | 0 | 1 | 14 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | +102 | 0 | 0 | 0 | 1 | 28 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 5.0 | 2.50 | +118 | 1 | 1 | 2 | 1 | 62 | -0.40 | W | +3.0u |
| 2026-06-04 | MLB | SPREAD | away | 5.0 | 5.00 | -111 | 0 | 0 | 0 | 1 | 10 | 0.00 | L | -5.0u |
...
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -188 | 0 | 0 | 0 | 0 | 36 | -1.10 | L | -1.0u |
| 2026-06-04 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +2.7u |
| 2026-06-04 | MLB | ML | home | 3.0 | 0.50 | -235 | 4 | 0 | 4 | 4 | 3 | 0.00 | L | -0.5u |
| 2026-06-04 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 0 | 22 | 0.00 | L | -5.0u |
| 2026-06-04 | NHL | ML | home | 2.5 | 0.25 | -160 | -3 | 0 | -3 | 2 | 9 | -0.40 | W | +0.2u |
| 2026-06-05 | MLB | ML | home | 2.5 | 0.25 | -144 | 1 | 1 | 2 | 0 | 39 | -1.20 | L | -0.3u |
| 2026-06-05 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | -1 | 35 | 0.00 | W | +2.8u |
| 2026-06-05 | MLB | ML | away | 3.0 | 0.50 | +128 | 1 | 0 | 1 | 1 | 10 | 0.00 | W | +0.6u |
| 2026-06-05 | MLB | TOTAL | over | 4.0 | 1.00 | -109 | 0 | 0 | 0 | 0 | 14 | 0.00 | P | +0.0u |
...
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -188 | 2 | 0 | 2 | 2 | 20 | -0.90 | W | +0.5u |
| 2026-06-05 | MLB | ML | away | 4.0 | 1.00 | -105 | 1 | 0 | 1 | 1 | 28 | 0.00 | L | -1.0u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -141 | 3 | 2 | 5 | 3 | 18 | 0.30 | W | +0.7u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 2.50 | -110 | 0 | 1 | 1 | -1 | 42 | 0.00 | W | +2.5u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -172 | 1 | 0 | 1 | 1 | 28 | 0.00 | L | -1.0u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 0 | -1 | -1 | 0 | 14 | 0.00 | W | +4.4u |
| 2026-06-05 | MLB | ML | away | 4.5 | 3.00 | -129 | -1 | 1 | 0 | -2 | 45 | -1.10 | W | +2.2u |
| 2026-06-05 | MLB | SPREAD | away | 3.0 | 0.50 | +126 | 1 | 0 | 1 | 1 | 10 | 0.00 | W | +0.6u |
| 2026-06-05 | NBA | ML | home | 2.5 | 0.25 | -230 | 2 | 2 | 4 | 4 | 18 | 1.00 | L | -0.3u |
| 2026-06-05 | NBA | SPREAD | home | 2.5 | 0.25 | -106 | 3 | 0 | 3 | 0 | 4 | -0.70 | L | -0.3u |
| 2026-06-06 | MLB | TOTAL | over | 2.5 | 0.25 | -110 | 1 | 0 | 1 | 0 | 32 | 0.00 | W | +0.2u |
| 2026-06-06 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 0 | 3 | 0.00 | W | +2.7u |
| 2026-06-06 | MLB | ML | home | 4.5 | 3.00 | -126 | 0 | 0 | 0 | 0 | 36 | -1.00 | W | +2.4u |
| 2026-06-06 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -9 | 0.00 | W | +2.7u |
...
| 2026-06-06 | MLB | TOTAL | under | 5.0 | 2.50 | -110 | 0 | 0 | 0 | 0 | 22 | 0.00 | L | -2.5u |
...
| 2026-06-06 | MLB | ML | home | 5.0 | 5.00 | -154 | 2 | 1 | 3 | 0 | 70 | -0.80 | L | -5.0u |
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -130 | 1 | 0 | 1 | 0 | 48 | -0.90 | W | +2.2u |
| 2026-06-07 | MLB | TOTAL | over | 3.0 | 0.50 | -112 | 0 | 0 | 0 | 3 | -9 | 0.00 | L | -0.5u |
| 2026-06-07 | MLB | ML | home | 5.0 | 5.00 | -143 | 1 | 0 | 1 | 1 | 10 | 0.00 | W | +3.5u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -9 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -136 | 1 | 0 | 1 | 0 | 48 | 0.00 | W | +0.7u |
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -165 | 2 | 2 | 4 | 3 | 0 | -1.10 | W | +1.8u |
...
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -1 | 0.00 | L | -0.5u |
...
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 3.00 | -152 | 2 | 0 | 2 | 1 | 6 | -0.50 | W | +1.9u |
| 2026-06-07 | MLB | TOTAL | over | 5.0 | 2.25 | -114 | 1 | 1 | 2 | 1 | -18 | 0.00 | L | -2.3u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | +102 | 1 | 0 | 1 | -2 | 31 | -0.20 | W | +0.5u |
...
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -102 | 2 | 0 | 2 | 0 | 36 | 0.50 | W | +1.0u |
| 2026-06-07 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 21 | 0.00 | W | +4.8u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | -127 | 0 | 1 | 1 | -1 | 60 | -1.90 | W | +0.4u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -1 | 0.00 | W | +0.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -113 | 6 | 1 | 7 | 5 | 28 | -0.50 | L | -3.0u |
| 2026-06-08 | MLB | ML | home | 4.5 | 3.00 | -129 | 3 | 0 | 3 | 1 | 66 | -0.40 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 0 | 13 | 0.00 | L | -3.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -121 | 1 | 1 | 2 | 1 | 46 | -1.60 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | P | +0.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -146 | 1 | 0 | 1 | 1 | 47 | -0.50 | W | +2.0u |
| 2026-06-08 | MLB | ML | home | 4.0 | 1.00 | -118 | 2 | 0 | 2 | 3 | -18 | -0.40 | L | -1.0u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 2.50 | -116 | -2 | -2 | -4 | -1 | 41 | 0.00 | W | +2.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 1.50 | +151 | 0 | -1 | -1 | 1 | 5 | 0.00 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 5.0 | 2.50 | +101 | 0 | 0 | 0 | 0 | 15 | 0.00 | W | +2.5u |
| 2026-06-08 | NBA | ML | home | 2.5 | 0.25 | -132 | 5 | 2 | 7 | 3 | -1 | -0.40 | L | -0.3u |
| 2026-06-08 | NBA | SPREAD | away | 5.0 | 5.00 | -110 | 3 | 2 | 5 | 2 | 5 | -1.30 | W | +4.3u |
| 2026-06-08 | NBA | TOTAL | under | 4.0 | 1.00 | -107 | 1 | 0 | 1 | 3 | -1 | 0.00 | L | -1.0u |
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | +132 | 1 | 0 | 1 | 3 | 14 | -1.20 | L | -0.3u |
| 2026-06-09 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 22 | 0.00 | W | +4.3u |
| 2026-06-09 | MLB | ML | away | 3.0 | 0.50 | -148 | 1 | 0 | 1 | 3 | 16 | 0.00 | L | -0.5u |
| 2026-06-09 | MLB | ML | away | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 4 | 18 | 0.80 | L | -1.0u |
| 2026-06-09 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 0 | 0 | 1 | 2 | 0.00 | L | -1.0u |
| 2026-06-09 | MLB | ML | away | 4.0 | 1.00 | -143 | 1 | 0 | 1 | 1 | 28 | 0.00 | L | -1.0u |
| 2026-06-09 | MLB | SPREAD | home | 4.5 | 3.00 | -117 | 1 | 0 | 1 | 1 | 10 | 0.00 | W | +2.6u |
| 2026-06-09 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 0 | 8 | 0.00 | W | +0.5u |
| 2026-06-09 | MLB | ML | away | 5.0 | 5.00 | -122 | 2 | 1 | 3 | 1 | 5 | 0.00 | W | +4.1u |
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | -120 | 0 | 0 | 0 | 0 | 18 | 0.00 | L | -0.3u |
| 2026-06-09 | MLB | ML | home | 4.0 | 1.00 | -107 | 1 | 0 | 1 | 0 | 32 | -1.30 | L | -1.0u |
| 2026-06-09 | MLB | ML | home | 5.0 | 5.00 | -105 | 1 | -1 | 0 | 1 | 3 | 0.00 | W | +4.8u |
| 2026-06-09 | MLB | ML | away | 4.5 | 2.50 | +115 | 1 | 0 | 1 | 0 | 36 | -0.70 | L | -2.5u |
| 2026-06-09 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 5 | 0.00 | W | +2.7u |
| 2026-06-09 | MLB | ML | away | 3.0 | 0.50 | -116 | 1 | 0 | 1 | 1 | 10 | 0.00 | W | +0.4u |
...
| 2026-06-09 | NHL | SPREAD | away | 4.5 | 1.00 | +215 | 0 | 0 | 0 | 2 | 9 | 41.70 | W | +2.1u |
| 2026-06-09 | NHL | TOTAL | under | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 2 | 10 | 0.00 | L | -5.0u |
