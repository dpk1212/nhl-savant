...
_Auto-generated **6/28/2026, 10:30:38 AM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 897 shipped+graded picks · 2026-04-18 → 2026-06-27  (HC analyses scoped to post-cutover 2026-04-30, 785 picks)
**Headline:** 449-440-8 · WR 50.5% [47.2%–53.8%] vs 52.4% break-even · -38.7u flat (-4.3%) · -193.1u peak.
**Overall t-test:** t = -1.33 → ✗ noise.
...
- **ρ(Δw, flat ROI) = 0.023 ✗**  (full sample, N=891)
- **ρ(HC, flat ROI) = -0.024 ✗**  (post-cutover, N=785)
- **ρ(Δw+HC, flat ROI) = -0.024 ✗**  (post-cutover, N=785)
...
- **Stale Δw ≤ 0 (full sample)** — N=244, 112-128, WR 46.7% [40%–53%], flat ROI -12.4% (t=-2.05 ✓ p<.05)

### Action map

- **Tier-1a (HC ≥ +2)** — N=54, WR 44.4%, flat ROI -19.4%. Bayesian posterior WR ≈ 45.3%, half-Kelly = **0.0%** bankroll at −110 → **size aggressively**.
- **Tier-1b (HC = +1)** — N=184, WR 58.7%, flat ROI +10.3%. Bayesian posterior WR ≈ 58.2%, half-Kelly = **6.2%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=117, WR 46.6%, flat ROI -12.9%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=128, WR 50.8%, flat ROI -2.1%. Bayesian posterior WR ≈ 50.7%, half-Kelly = **0.0%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -12.4% flat ROI on 244 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (0.98u/pick), we need **~1462 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 897. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **897** |
| W-L-P | 449-440-8 |
| Win rate | **50.5%** [47.2%–53.8%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +1.9 pp |
| Peak-units PnL | **-193.1u** |
| Flat-1u PnL | **-38.7u** (-4.3% flat ROI) |
| Flat t-statistic vs zero | -1.33 → ✗ noise |
| Flat 95% CI per-pick | [-0.107, 0.021]u |
...
We have **897** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = 0 | 194 | 93-98-3 | 48.7% [42–56] | -9.0% | -48.1u | -1.33 ✗ noise |
| Δw = +1 | 360 | 188-169-3 | 52.7% [47–58] | -0.3% | -95.7u | -0.07 ✗ noise |
| Δw = +2 | 159 | 80-78-1 | 50.6% [43–58] | -3.3% | -23.4u | -0.43 ✗ noise |
| Δw ≥ +3 | 128 | 65-63-0 | 50.8% [42–59] | -2.1% | -8.9u | -0.22 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.028** ✗  ·  **ρ(Δw, flat ROI) = 0.023** ✗  (N=891)
...
| HC = 0 | 516 | 248-261-7 | 48.7% [44–53] | -8.5% | -216.3u | -2.02 ✓ p<.05 |
| HC = +1 | 184 | 108-76-0 | 58.7% [51–66] | +10.3% | +24.7u | 1.45 ✗ noise |
| HC = +2 | 38 | 19-19-0 | 50.0% [35–65] | -5.9% | +3.6u | -0.37 ✗ noise |
| HC ≥ +3 | 16 | 5-11-0 | 31.3% [14–56] | -51.5% | -5.7u | -2.75 ✓ p<.01 |

**Pearson ρ(HC, WIN) = -0.006** ✗  ·  **ρ(HC, flat ROI) = -0.024** ✗  (N=785)

Spearman rank ρ(HC, flat ROI) = 0.016.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 191 | 90-98-3 | 47.9% [41–55] | -9.9% | -59.9u | -1.44 ✗ noise |
| Σ = +1 | 278 | 145-130-3 | 52.7% [47–59] | -0.3% | -97.6u | -0.05 ✗ noise |
| Σ = +2 | 150 | 82-67-1 | 55.0% [47–63] | +3.5% | -1.5u | 0.45 ✗ noise |
| Σ = +3 | 71 | 33-38-0 | 46.5% [35–58] | -11.9% | -7.8u | -1.03 ✗ noise |
| Σ = +4 | 43 | 24-19-0 | 55.8% [41–70] | +8.9% | +0.4u | 0.58 ✗ noise |
| Σ = +5 | 23 | 12-11-0 | 52.2% [33–71] | -11.0% | -6.4u | -0.58 ✗ noise |
| Σ ≥ +6 | 29 | 12-17-0 | 41.4% [26–59] | -28.8% | -9.7u | -1.75 ~ p<.10 |

**Pearson ρ(Δw+HC, WIN) = -0.006** ✗  ·  **ρ(Σ, flat ROI) = -0.024** ✗  (N=785)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 785.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.004 ✗ | -0.019 ✗ | -0.002 | weak |
| HC margin | -0.006 ✗ | -0.024 ✗ | 0.016 | weak |
| Δw + HC | -0.006 ✗ | -0.024 ✗ | 0.006 | weak |
| peak.stars | -0.034 ✗ | -0.047 ✗ | -0.048 | weak |
| vault.star | -0.013 ✗ | -0.030 ✗ | -0.047 | weak |
| lock.stars | -0.025 ✗ | -0.039 ✗ | -0.037 | weak |
...
Universe N = 785 (post-cutover, both axes present).
...
| +0 | N=2 · 1-1 · 50% [9–91] · —  | N=4 · 1-3 · 25% [5–70] · -44%  | N=19 · 6-12 · 33% [16–56] · -34%  | N=132 · 63-67 · 48% [40–57] · -10%  | N=248 · 127-118 · 52% [46–58] · -2%  | N=78 · 39-38 · 51% [40–62] · -6%  | N=33 · 11-22 · 33% [20–50] · -38% ✗ |
| +1 | — | — | N=8 · 5-3 · 63% [31–86] · +5%  | N=28 · 16-12 · 57% [39–73] · +6%  | N=65 · 40-25 · 62% [49–72] · +18%  | N=40 · 22-18 · 55% [40–69] · +6%  | N=43 · 25-18 · 58% [43–72] · +6%  |
| +2 | — | N=1 · 0-1 · 0% [0–79] · —  | — | N=3 · 1-2 · 33% [6–79] · -47%  | N=4 · 1-3 · 25% [5–70] · -55%  | N=11 · 5-6 · 45% [21–72] · -7%  | N=19 · 12-7 · 63% [41–81] · +16%  |
| ≥ +3 | — | — | — | N=1 · 1-0 · 100% [21–100] · —  | N=1 · 1-0 · 100% [21–100] · —  | N=3 · 1-2 · 33% [6–79] · -50%  | N=11 · 2-9 · 18% [5–48] · -72% ✗ |
...
| Δw = 0 | 171 | 86-83-2 | 50.9% [43–58] | -4.9% | -34.7u | -0.68 ✗ noise |
| Δw = +1 | 327 | 173-151-3 | 53.4% [48–59] | +1.1% | -91.1u | 0.20 ✗ noise |
| Δw = +2 | 134 | 69-64-1 | 51.9% [43–60] | -1.9% | -19.6u | -0.22 ✗ noise |
| Δw ≥ +3 | 110 | 52-58-0 | 47.3% [38–57] | -13.3% | -21.0u | -1.47 ✗ noise |

### §3d. Practical lock zones (v7.4 floor anatomy)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 238 | 132-106-0 | 55.5% [49–62] | +3.5% | +22.6u | 0.57 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 117 | 54-62-1 | 46.6% [38–56] | -12.9% | -37.9u | -1.46 ✗ noise |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 430 | 212-212-6 | 50.0% [45–55] | -5.4% | -167.2u | -1.17 ✗ noise |
...
Universe N = 818 picks where ≥1 proven wallet appeared on either side.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δcount ≤ −2 (heavy oppose) | 33 | 13-20-0 | 39.4% [25–56] | -22.1% | -18.2u | -1.26 ✗ noise |
| Δcount = −1 | 77 | 34-43-0 | 44.2% [34–55] | -13.2% | -22.5u | -1.16 ✗ noise |
| Δcount = 0 (balanced) | 119 | 52-65-2 | 44.4% [36–53] | -16.7% | -33.3u | -1.94 ~ p<.10 |
| Δcount = +1 | 319 | 170-148-1 | 53.5% [48–59] | +0.7% | -116.1u | 0.14 ✗ noise |
| Δcount = +2 | 156 | 79-76-1 | 51.0% [43–59] | -4.8% | -21.3u | -0.62 ✗ noise |
| Δcount ≥ +3 (heavy support) | 114 | 72-39-3 | 64.9% [56–73] | +26.3% | +53.6u | 2.68 ✓ p<.01 |

**ρ(Δcount, WIN) = 0.116** ✓ p<.01  ·  **ρ(Δcount, flat ROI) = 0.115** ✓ p<.01
...
Quintile cuts: ≤ -8 · ≤ 0 · ≤ 9 · ≤ 14 · > 14

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 180 | 67-113-0 | 37.2% [30–44] | -26.8% | -92.3u | -3.71 ✓ p<.01 |
| Q2 | 165 | 75-88-2 | 46.0% [39–54] | -12.6% | -31.2u | -1.70 ~ p<.10 |
| Q3 (balanced) | 156 | 84-70-2 | 54.5% [47–62] | +2.7% | -23.6u | 0.36 ✗ noise |
| Q4 | 155 | 94-60-1 | 61.0% [53–68] | +15.1% | -35.0u | 1.98 ✓ p<.05 |
| Q5 (best — heavy support) | 162 | 100-60-2 | 62.5% [55–70] | +17.8% | +24.5u | 2.24 ✓ p<.05 |

**ρ(ΔWlNet, WIN) = 0.191** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.173** ✓ p<.01
...
Quintile cuts (units): ≤ -27.58 · ≤ 14.76 · ≤ -20.48 · ≤ 5.40 · > 5.40

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 78 | 30-47-1 | 39.0% [29–50] | -26.1% | -26.9u | -2.45 ✓ p<.05 |
| Q2 | 532 | 276-252-4 | 52.3% [48–57] | -0.8% | -98.1u | -0.20 ✗ noise |
| Q3 | 0 | — | — | — | — | — |
| Q4 | 0 | — | — | — | — | — |
| Q5 | 208 | 114-92-2 | 55.3% [49–62] | +5.9% | -32.7u | 0.82 ✗ noise |
...
Quintile cuts (% ROI): ≤ -9.5 · ≤ 30.0 · ≤ -12.7 · ≤ 10.0 · > 10.0

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 170 | 56-112-2 | 33.3% [27–41] | -35.7% | -105.2u | -5.09 ✓ p<.01 |
| Q2 | 478 | 270-206-2 | 56.7% [52–61] | +7.7% | -4.0u | 1.74 ~ p<.10 |
| Q3 | 0 | — | — | — | — | — |
| Q4 | 0 | — | — | — | — | — |
| Q5 | 170 | 94-73-3 | 56.3% [49–64] | +6.7% | -48.6u | 0.86 ✗ noise |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 99 | 30-67-2 | 30.9% [23–41] | -39.7% | -55.9u | -4.38 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 26 | 10-16-0 | 38.5% [22–57] | -26.1% | -12.3u | -1.37 ✗ noise |
| ΔBestRank = 0 (tied) | 5 | 4-1-0 | 80.0% [38–96] | +58.8% | +5.1u | 1.47 ✗ noise |
| ΔBestRank ∈ [+1,+4] | 16 | 8-8-0 | 50.0% [28–72] | -0.2% | +0.4u | -0.01 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 205 | 110-93-2 | 54.2% [47–61] | +3.1% | -36.8u | 0.43 ✗ noise |

**ρ(ΔBestRank, WIN) = 0.248** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.232** ✓ p<.01  (N=351)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 64 | 19-44-1 | 30.2% [20–42] | -40.4% | -42.3u | -3.51 ✓ p<.01 |
| Δshare ∈ [−30,−10] pp | 8 | 1-7-0 | 12.5% [2–47] | -76.1% | -4.3u | -3.19 ✓ p<.01 |
| Δshare ≈ 0 (±10 pp) | 528 | 275-251-2 | 52.3% [48–57] | -0.5% | -100.9u | -0.13 ✗ noise |
| Δshare ∈ [+10,+30] pp | 29 | 13-15-1 | 46.4% [30–64] | -13.3% | +2.5u | -0.76 ✗ noise |
| Δshare ≥ +30 pp | 189 | 112-74-3 | 60.2% [53–67] | +13.8% | -12.8u | 1.89 ~ p<.10 |

**ρ(ΔTopQShare, WIN) = 0.112** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.102** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔWlNet** | 0.191 ✓ p<.01 | 0.173 ✓ p<.01 | 0.138 |
| 2 | **ΔTopQCount** | 0.160 ✓ p<.01 | 0.153 ✓ p<.01 | 0.106 |
| 3 | **Δcount** | 0.116 ✓ p<.01 | 0.115 ✓ p<.01 | 0.092 |
| 4 | **ΔTopQShare** | 0.112 ✓ p<.01 | 0.102 ✓ p<.01 | 0.096 |
| 5 | **ΔFlatPnl** | NaN — | NaN — | 0.082 |
| 6 | **ΔAvgRoi** | NaN — | NaN — | 0.109 |

_(ΔBestRank uses N=351 subset where both sides had a proven wallet — ρ(flat ROI) = 0.232 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 1440, dateRange = 2026-04-18 → 2026-06-27, computedAt = 2026-06-28T14:26:50.785Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **818** rows · PIT aggregate computable on **859** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **859** rows (34 used the cold-start fallback calibration for the early dates).
...
| NEUTRAL (0..+3) | 639 · 54% · +1.9% | 476 · 53% · -1.2% | -3.1pp |
| WEAK (−3..0) | 150 · 45% · -12.3% | 312 · 51% · +0.2% | +12.4pp |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=423, WR=56%, ROI=+5.8% | N=367, WR=53%, ROI=-1.1% | -6.8pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=639, WR=54%, ROI=+1.9% | N=477, WR=53%, ROI=-1.4% | -3.3pp |
| AGS < −1 (mute veto) | N=69, WR=46%, ROI=-8.2% | N=184, WR=47%, ROI=-5.5% | +2.7pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-06-14 → 2026-06-27, N=235)
...
| NEUTRAL (0..+3) | 130 · 57% · +2.2% |
| WEAK (−3..0) | 102 · 46% · -12.6% |
| FADE (<−3) | 2 · 0% · -100.0% |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=111, WR=58%, ROI=+4.0% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=131, WR=56%, ROI=+1.4% |
| AGS < −1 (mute veto) | N=52, WR=40%, ROI=-22.2% |
...
|---|---|---|---|---|
| `dCount` | COUNT | + | 0.72 | 2.09 |
| `dHcSizeRatio` | INTENSITY_HC | + | 0.58 | 5.66 |
| `dSumRankNorm` | QUALITY_RANK | − | 40.23 | 90.65 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.37 | 1.60 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **859/897** shipped+graded rows (96%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 143 | 79-62-2 | 56.0% [48–64] | +0.2% | -11.3u | 0.03 ✗ noise |
| LOCK | 156 | 73-83-0 | 46.8% [39–55] | -11.2% | -67.8u | -1.44 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 122 | 63-57-2 | 52.5% [44–61] | +0.1% | -25.2u | 0.02 ✗ noise |
| FADE | 209 | 96-110-3 | 46.6% [40–53] | -6.8% | -70.2u | -0.94 ✗ noise |
...
r(WIN) = **0.047** ✗ · r(ROI) = **0.018** ✗ · Spearman ρ(ROI) = **-0.009**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 180 | 87-91-2 | 48.9% [42–56] | -4.0% | -47.0u | -0.53 ✗ noise |
| z ∈ [−1, 0) | 339 | 176-160-3 | 52.4% [47–58] | -0.4% | -90.3u | -0.07 ✗ noise |
| z ∈ [0, +1) | 227 | 111-115-1 | 49.1% [43–56] | -8.4% | -42.5u | -1.32 ✗ noise |
| z ≥ +1 (very positive) | 113 | 58-53-2 | 52.3% [43–61] | -6.1% | -4.0u | -0.70 ✗ noise |
...
| z ∈ [0, +1) | 825 | 417-400-8 | 51.0% [48–54] | -4.0% | -180.7u | -1.20 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.043** ✗ · r(ROI) = **-0.043** ✗ · Spearman ρ(ROI) = **-0.037**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 154 | 83-70-1 | 54.2% [46–62] | -0.3% | -12.4u | -0.04 ✗ noise |
| z ∈ [−1, 0) | 357 | 184-171-2 | 51.8% [47–57] | -0.7% | -95.1u | -0.13 ✗ noise |
| z ∈ [0, +1) | 265 | 126-135-4 | 48.3% [42–54] | -7.5% | -76.2u | -1.27 ✗ noise |
| z ≥ +1 (very positive) | 83 | 39-43-1 | 47.6% [37–58] | -13.7% | -0.2u | -1.35 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.043 ✗ | -0.043 ✗ | -0.037 |
| 2 | `dCount` | COUNT | 0.047 ✗ | 0.018 ✗ | -0.009 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | -0.108 | 0.813 | 50.7% | dominant |
| 2 | `dSumRankNorm` | -0.221 | 0.778 | 48.5% | meaningful |
...
|---|---|---|---|---|
| `dCount` | 1.000 | -0.020 | +0.650 | -0.020 |
| `dHcSizeRatio` | -0.020 | 1.000 | -0.046 | +1.000 ⚠ |
| `dSumRankNorm` | +0.650 | -0.046 | 1.000 | -0.046 |
| `dWinnerCtPreA` | -0.020 | +1.000 ⚠ | -0.046 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **0.008**. At AGS ≥ +0.12 fires N=395, WR=52.4%, ROI=-3.1%. At AGS ≥ +null fires N=512, WR=52.1%, ROI=-3.8%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-395 ROI (matched cohort) | Top-395 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.050 | +0.042 | WR=56%, ROI=+5.3% | -8.5pp | N=476, WR=53%, ROI=+0.2% |
| `dHcSizeRatio` | +0.045 | +0.037 | WR=54%, ROI=+0.0% | -3.2pp | N=422, WR=53%, ROI=-1.4% |
| `dSumRankNorm` | -0.023 | +0.015 | WR=49%, ROI=-8.4% | +5.3pp | N=336, WR=51%, ROI=-6.5% |
| `dWinnerCtPreA` | +0.045 | +0.037 | WR=54%, ROI=-0.2% | -3.0pp | N=414, WR=54%, ROI=-0.6% |
...
|---|---|---|---|---|
| 1 | `dSumRankNorm` | +0.015 | +5.3pp | redundant — other features cover it |
| 2 | `dWinnerCtPreA` | +0.037 | -3.0pp | redundant — other features cover it |
| 3 | `dHcSizeRatio` | +0.037 | -3.2pp | redundant — other features cover it |
| 4 | `dCount` | +0.042 | -8.5pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.176 | 0.176 | negative ↓ |
| 2 | `dCount` | COUNT | +0.141 | 0.141 | positive ↑ |
| 3 | `dWinnerCtPreA` | QUALITY_TRACK | +0.010 | 0.010 | flat ≈ 0 |
| 4 | `dHcSizeRatio` | INTENSITY_HC | +0.004 | 0.004 | flat ≈ 0 |

Intercept b = -0.012 · Final log-loss = 0.6882 · N = 859.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 859 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/859 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 256 | 124-132-0 | 48.4% [42–55] | -11.7% | -135.8u | -2.00 ✓ p<.05 |
| 4.5★ | 183 | 100-81-2 | 55.2% [48–62] | +4.7% | -32.5u | 0.65 ✗ noise |
| 4.0★ | 175 | 80-93-2 | 46.2% [39–54] | -10.9% | -25.8u | -1.47 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 114 | 57-54-3 | 51.4% [42–60] | -1.0% | +1.7u | -0.11 ✗ noise |
| 2.5★ | 131 | 69-61-1 | 53.1% [45–61] | -0.4% | -4.5u | -0.04 ✗ noise |

### §5b. Stars × Δw stratified — does the star tier hold up within each Δw cohort?

| Δw cohort | 5★ | 4.5★ | 4★ | 3.5★ | 3★ | 2.5★ |
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 48/52%/-7% | 46/50%/-5% | 41/35%/-34% | 6/33%/-26% | 41/36%/-31% | 61/55%/+5% |
| Δw = +1 | 67/54%/-2% | 89/53%/+0% | 88/47%/-9% | 28/54%/+4% | 45/58%/+12% | 42/55%/-0% |
| Δw = +2 | 69/45%/-15% | 25/56%/+5% | 37/57%/+9% | — | 17/56%/+7% | 11/45%/-9% |
| Δw ≥ +3 | 70/43%/-23% | 20/75%/+43% | 9/44%/-10% | 3/67%/+156% | 11/73%/+47% | 15/40%/-26% |
...
| −200/−151 | 91 | 53-38-0 | 58.2% [48–68] | -7.2% | -29.2u | -0.87 ✗ noise |
| −150/−101 | 520 | 262-253-5 | 50.9% [47–55] | -4.4% | -94.3u | -1.08 ✗ noise |
| −100/+100 | 11 | 6-5-0 | 54.5% [28–79] | +9.1% | +1.8u | 0.29 ✗ noise |
| +101/+150 | 176 | 73-100-3 | 42.2% [35–50] | -7.3% | -87.3u | -0.90 ✗ noise |
...
| −200/−151 | -23% (27) | +4% (35) | +33% (12) | -40% (16) |
| −150/−101 | -7% (136) | -1% (220) | -12% (91) | -3% (70) |
| −100/+100 | -100% (3) | +67% (6) | -100% (1) | +100% (1) |
| +101/+150 | -14% (51) | -6% (68) | +1% (37) | -10% (20) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 478 | 235-242-1 | 49.3% [45–54] | -7.4% | -105.4u | -1.63 ✗ noise |
| SPREAD | 151 | 77-72-2 | 51.7% [44–60] | -2.8% | -38.9u | -0.36 ✗ noise |
| TOTAL | 268 | 137-126-5 | 52.1% [46–58] | +0.3% | -48.7u | 0.05 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=133 · 43% · -20% | N=172 · 52% · -4% | N=85 · 54% · +5% | N=85 · 48% · -7% |
| SPREAD | N=41 · 38% · -31% | N=70 · 59% · +14% | N=23 · 61% · +8% | N=16 · 38% · -27% |
| TOTAL | N=70 · 59% · +13% | N=118 · 50% · -4% | N=51 · 40% · -22% | N=27 · 67% · +28% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 679 | 344-330-5 | 51.0% [47–55] | -3.6% | -163.2u | -0.97 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=192 · 49% · -9% | N=307 · 52% · -1% | N=117 · 51% · -2% | N=62 · 50% · -6% |
...
|---|---|---|
| **sharps3Plus** | 312 · 46% · -11.0% · -1.94 ~ p<.10 | 584 · 53% · -1.0% · -0.25 ✗ noise |
| **plusEV** | 84 · 52% · +0.3% · 0.02 ✗ noise | 812 · 50% · -5.0% · -1.47 ✗ noise |
| **pinnacleConfirms** | 183 · 55% · +3.3% · 0.45 ✗ noise | 531 · 49% · -8.1% · -1.93 ~ p<.10 |
| **invested10kPlus** | 404 · 51% · -4.8% · -0.98 ✗ noise | 310 · 50% · -5.6% · -1.01 ✗ noise |
| **lineMovingWith** | 344 · 55% · +3.7% · 0.70 ✗ noise | 552 · 48% · -9.6% · -2.32 ✓ p<.05 |
| **predMarketAligns** | 201 · 52% · -2.4% · -0.34 ✗ noise | 513 · 50% · -6.2% · -1.46 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 331 | 167-164-0 | 50.5% [45–56] | -4.0% | -130.0u | -0.74 ✗ noise |
| 1 | 168 | 79-84-5 | 48.5% [41–56] | -6.4% | -38.6u | -0.86 ✗ noise |
| 2 | 181 | 90-88-3 | 50.6% [43–58] | -4.9% | -2.6u | -0.68 ✗ noise |
| 3 | 68 | 34-34-0 | 50.0% [38–62] | -7.3% | -11.3u | -0.62 ✗ noise |
| 4 | 68 | 37-31-0 | 54.4% [43–66] | -0.7% | -9.1u | -0.06 ✗ noise |
| 5 | 64 | 33-31-0 | 51.6% [40–63] | -7.1% | -6.2u | -0.60 ✗ noise |
...
| NEAR_START | 335 | 161-169-5 | 48.8% [43–54] | -6.5% | -65.1u | -1.19 ✗ noise |
| NO_MOVE | 27 | 13-14-0 | 48.1% [31–66] | -10.7% | +6.5u | -0.58 ✗ noise |
| PREGAME | 245 | 126-119-0 | 51.4% [45–58] | -2.4% | -104.3u | -0.39 ✗ noise |
| SMALL_MOVE | 169 | 83-84-2 | 49.7% [42–57] | -6.8% | -27.6u | -0.91 ✗ noise |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 519 | 264-252-3 | 51.2% [47–55] | -4.4% | -162.1u | -1.05 ✗ noise |
| STRONG | 124 | 62-60-2 | 50.8% [42–60] | -2.7% | -6.3u | -0.31 ✗ noise |
| LEAN | 242 | 118-121-3 | 49.4% [43–56] | -4.4% | -22.2u | -0.68 ✗ noise |
...
|---|---|---|---|---|
| sharpCount | -0.057 ~ p<.10 | -0.051 ✗ | -0.045 | -1.53 |
| totalInvested | -0.056 ~ p<.10 | -0.065 ✓ p<.05 | -0.008 | -1.96 |
| evEdge | 0.092 ✓ p<.01 | 0.115 ✓ p<.01 | 0.050 | 3.48 |
| moneyPct | 0.037 ✗ | 0.015 ✗ | 0.004 | 0.46 |
| walletPct | 0.039 ✗ | 0.030 ✗ | 0.024 | 0.90 |
| criteriaMet | 0.018 ✗ | 0.012 ✗ | -0.023 | 0.35 |
| maxContribFor | -0.006 ✗ | 0.006 ✗ | 0.021 | 0.19 |
| meanBaseFor | -0.005 ✗ | 0.022 ✗ | 0.041 | 0.65 |
...
Sample with CLV: **882** picks. Mean CLV = **-0.0029**.
t-statistic vs zero: -1.79 → ~ p<.10 · 95% CI [-0.0061, 0.0003]

Bucketed CLV vs flat PnL:

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLV ≤ −2% | 104 | 47-56-1 | 45.6% [36–55] | -16.5% | -40.1u | -1.81 ~ p<.10 |
| CLV (−2%, 0] | 513 | 260-247-6 | 51.3% [47–56] | -3.3% | -90.5u | -0.78 ✗ noise |
| CLV (0, +2%] | 222 | 114-108-0 | 51.4% [45–58] | -0.0% | -49.8u | -0.00 ✗ noise |
...
Trained on N=657 (with all features non-null). Intercept β₀ = 0.059.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | sharpCount | -0.266 | ↓ hurts |
| 2 | pw.ΔAvgRoi | +0.255 | ↑ helps |
| 3 | log(impliedProb) | +0.229 | ↑ helps |
| 4 | pw.Δcount | +0.207 | ↑ helps |
| 5 | evEdge | +0.188 | ↑ helps |
| 6 | pw.ΔWlNet | +0.172 | ↑ helps |
| 7 | odds (American) | -0.151 | ↓ hurts |
| 8 | pw.ΔTopQShare | +0.110 | ↑ helps |
| 9 | peak.stars | -0.084 | ↓ hurts |
| 10 | pw.ΔFlatPnl | +0.078 | ↑ helps |
| 11 | moneyPct | -0.066 | ↓ hurts |
| 12 | criteriaMet | +0.056 | ↑ helps |
| 13 | vault.star | +0.051 | ↑ helps |
| 14 | walletPct | +0.030 | ≈ flat |
| 15 | Δw | -0.030 | ≈ flat |
| 16 | log10(invested) | +0.023 | ≈ flat |
| 17 | HC margin | +0.019 | ≈ flat |
| 18 | Δw + HC | -0.014 | ≈ flat |
...
|---|---|---|---|---|---|---|---|---|
| Tier-1a HC ≥ +2 (post-cutover) | 54 | 24-30 | 44.4% | 45.3% | -110 | — (mute) | 2.45u | **MUTE** (negative EV at posterior) |
| Tier-1b HC = +1 (post-cutover) | 184 | 108-76 | 58.7% | 58.2% | -110 | 6.16% bankroll | 2.05u | **UNDER-SIZED** — ship up to 6.16u (1u=1% bankroll) |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 117 | 54-62 | 46.6% | 46.8% | -110 | — (mute) | 2.03u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 128 | 65-63 | 50.8% | 50.7% | -110 | — (mute) | 2.36u | **MUTE** (negative EV at posterior) |
| Stale Δw = 0 | 194 | 93-98 | 48.7% | 48.8% | -110 | — (mute) | 1.84u | **MUTE** (negative EV at posterior) |
...
**Peak cum PnL:** +7.1u
**Max drawdown:** -200.1u
**Longest losing-day streak:** 9
**Longest winning-day streak:** 5
**Daily Sharpe-like (μ/σ):** -0.357  (annualized × √252 ≈ -5.67)
...
| 2026-04-26 | MLB | ML | away | 3.5 | 0.75 | +108 | 1 | — | — | 2 | 9 | 0.50 | L | -0.8u |
...
| 2026-04-26 | MLB | TOTAL | over | 4.0 | 0.75 | -102 | 1 | — | — | 2 | -5 | 0.00 | W | +0.7u |
...
| 2026-04-28 | MLB | ML | home | 3.5 | 0.75 | -118 | 1 | — | — | 1 | 14 | -0.80 | W | +0.6u |
...
| 2026-05-13 | MLB | TOTAL | under | 5.0 | 3.50 | -110 | 4 | 2 | 6 | 4 | -19 | 0.00 | L | -3.5u |
...
| 2026-05-16 | MLB | ML | away | 5.0 | 4.50 | +124 | 3 | 1 | 4 | 3 | -28 | -1.30 | W | +1.4u |
...
| 2026-05-17 | MLB | ML | home | 4.0 | 2.75 | -114 | 3 | 1 | 4 | 3 | -11 | 2.20 | W | +2.4u |
...
| 2026-05-19 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 2 | 0 | 2 | 0 | 0 | 0.00 | W | +1.5u |
...
| 2026-05-23 | MLB | ML | home | 5.0 | 1.00 | -148 | 0 | 0 | 0 | 1 | -21 | -0.20 | L | -1.0u |
...
| 2026-05-23 | MLB | ML | away | 2.5 | 1.25 | -111 | -1 | 1 | 0 | 1 | 13 | 0.40 | L | -1.3u |
...
| 2026-05-24 | MLB | ML | home | 2.5 | 0.50 | +144 | 1 | 1 | 2 | -1 | -36 | 0.00 | L | -0.5u |
| 2026-05-24 | MLB | SPREAD | home | 4.0 | 1.65 | -110 | 2 | 1 | 3 | 2 | -6 | -1.30 | L | -1.6u |
| 2026-05-24 | MLB | ML | home | 3.0 | 1.25 | -107 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +1.2u |
...
| 2026-05-25 | MLB | ML | home | 5.0 | 5.00 | -149 | 1 | 0 | 1 | 2 | -8 | -0.70 | L | -5.0u |
| 2026-05-25 | MLB | ML | home | 5.0 | 5.00 | -310 | 2 | 0 | 2 | 1 | 3 | -1.20 | W | +1.6u |
| 2026-05-25 | MLB | TOTAL | over | 4.0 | 1.65 | +103 | 1 | 0 | 1 | 2 | 24 | 0.00 | L | -1.6u |
...
| 2026-05-25 | MLB | ML | home | 5.0 | 1.25 | -160 | 3 | 0 | 3 | 2 | -40 | -1.10 | L | -1.3u |
...
| 2026-05-25 | MLB | ML | home | 4.0 | 5.00 | -209 | -1 | 0 | -1 | 2 | -8 | -0.80 | W | +2.3u |
...
| 2026-05-26 | MLB | SPREAD | home | 4.0 | 1.00 | +105 | 1 | 0 | 1 | 2 | 24 | -0.20 | L | -1.0u |
| 2026-05-26 | MLB | ML | away | 5.0 | 5.00 | -102 | 3 | 1 | 4 | 2 | -27 | -0.50 | W | +4.9u |
...
| 2026-05-27 | MLB | ML | home | 4.5 | 0.50 | -102 | 3 | 1 | 4 | 1 | -6 | -1.10 | W | +0.4u |
...
| 2026-05-27 | MLB | ML | away | 4.0 | 1.00 | -108 | 1 | -1 | 0 | 0 | 27 | -0.90 | L | -1.0u |
| 2026-05-27 | MLB | ML | home | 5.0 | 0.50 | +132 | 2 | 0 | 2 | 2 | 26 | -0.50 | L | -0.5u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 1.65 | +104 | 2 | 0 | 2 | 2 | 24 | 0.00 | W | +1.7u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 0.75 | +104 | 2 | 0 | 2 | 2 | 27 | 0.00 | W | +0.8u |
| 2026-05-27 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 2 | 5 | 2 | -28 | -0.30 | L | -2.5u |
...
| 2026-05-28 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 1 | 4 | 3 | -27 | -0.60 | L | -2.5u |
...
| 2026-05-29 | MLB | ML | home | 5.0 | 2.50 | +118 | 5 | 1 | 6 | 4 | 34 | -0.90 | L | -2.5u |
...
| 2026-05-29 | MLB | ML | away | 4.5 | 1.25 | -142 | 0 | 1 | 1 | 0 | 52 | -1.20 | W | +0.3u |
...
| 2026-05-29 | MLB | ML | home | 5.0 | 2.75 | -106 | 2 | 1 | 3 | 0 | -2 | 0.70 | L | -2.8u |
...
| 2026-05-30 | MLB | ML | away | 5.0 | 3.75 | -118 | 1 | 1 | 2 | 1 | -5 | -1.30 | L | -3.8u |
...
| 2026-05-31 | MLB | ML | home | 2.5 | 2.75 | -115 | 1 | 1 | 2 | 1 | 43 | 0.00 | W | +2.4u |
| 2026-05-31 | MLB | ML | away | 5.0 | 1.00 | +115 | -1 | 0 | -1 | 2 | -8 | -0.60 | L | -1.0u |
| 2026-05-31 | MLB | SPREAD | away | 5.0 | 1.00 | -117 | 3 | 1 | 4 | 3 | 5 | -0.20 | L | -1.0u |
...
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -102 | 0 | 1 | 1 | 3 | -14 | 0.20 | W | +4.9u |
...
| 2026-06-01 | MLB | ML | away | 4.0 | 1.00 | +135 | 2 | 2 | 4 | 2 | 25 | -0.20 | W | +1.4u |
| 2026-06-01 | MLB | ML | away | 5.0 | 2.50 | +160 | 2 | -1 | 1 | 2 | 26 | -1.30 | W | +2.7u |
| 2026-06-01 | MLB | TOTAL | under | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 2 | -10 | 0.00 | L | -1.0u |
| 2026-06-01 | MLB | ML | home | 3.0 | 0.50 | -142 | -1 | 0 | -1 | -2 | -14 | -0.40 | L | -0.5u |
| 2026-06-01 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 16 | 0.00 | L | -5.0u |
| 2026-06-01 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 2 | -23 | 0.00 | W | +2.7u |
| 2026-06-02 | MLB | ML | home | 2.5 | 0.25 | -215 | -1 | 0 | -1 | -1 | -12 | -1.40 | L | -0.3u |
| 2026-06-02 | MLB | TOTAL | under | 4.0 | 1.00 | -117 | 1 | 0 | 1 | 0 | 1 | 0.00 | L | -1.0u |
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +130 | 2 | 0 | 2 | -1 | 24 | -0.60 | W | +3.1u |
...
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +102 | 0 | -1 | -1 | 1 | -8 | 0.00 | L | -2.5u |
| 2026-06-02 | NHL | TOTAL | over | 5.0 | 5.00 | -110 | 2 | 2 | 4 | 2 | 13 | 0.00 | W | +4.3u |
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -150 | 3 | 1 | 4 | 4 | -14 | -1.30 | W | +0.3u |
| 2026-06-03 | MLB | ML | away | 4.0 | 1.00 | +134 | -1 | -1 | -2 | -2 | 8 | -1.00 | W | +1.2u |
...
| 2026-06-03 | MLB | ML | home | 5.0 | 5.00 | -215 | 0 | 1 | 1 | -1 | 21 | -1.00 | W | +2.3u |
...
| 2026-06-04 | MLB | ML | home | 5.0 | 2.50 | +118 | 1 | 1 | 2 | 0 | 37 | -0.40 | W | +3.0u |
| 2026-06-04 | MLB | SPREAD | away | 5.0 | 5.00 | -111 | 0 | 0 | 0 | 1 | 14 | 0.00 | L | -5.0u |
| 2026-06-04 | MLB | ML | home | 5.0 | 5.00 | -131 | 1 | 0 | 1 | 0 | 37 | 0.20 | W | +3.5u |
...
| 2026-06-05 | MLB | ML | home | 3.0 | 0.50 | -136 | 1 | 0 | 1 | 2 | 10 | 0.00 | W | +0.4u |
...
| 2026-06-06 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 1 | 1 | -1 | 8 | 0.00 | L | -1.0u |
| 2026-06-06 | MLB | ML | home | 3.0 | 0.50 | -130 | 0 | 0 | 0 | -1 | 14 | -0.90 | L | -0.5u |
...
| 2026-06-06 | MLB | ML | home | 5.0 | 2.50 | +117 | -2 | -1 | -3 | 0 | 24 | 0.00 | L | -2.5u |
| 2026-06-06 | MLB | ML | home | 5.0 | 5.00 | -154 | 2 | 1 | 3 | -1 | 24 | -0.80 | L | -5.0u |
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -130 | 1 | 0 | 1 | -1 | 21 | -0.90 | W | +2.2u |
| 2026-06-07 | MLB | TOTAL | over | 3.0 | 0.50 | -112 | 0 | 0 | 0 | 3 | 15 | 0.00 | L | -0.5u |
| 2026-06-07 | MLB | ML | home | 5.0 | 5.00 | -143 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +3.5u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -5 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -136 | 1 | 0 | 1 | -1 | 21 | 0.00 | W | +0.7u |
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -165 | 2 | 2 | 4 | 2 | -8 | -1.10 | W | +1.8u |
...
| 2026-06-07 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +0.9u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -105 | 1 | 0 | 1 | 0 | 0 | 0.00 | L | -1.0u |
| 2026-06-07 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -5.0u |
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 3.00 | -152 | 2 | 0 | 2 | 1 | 34 | -0.50 | W | +1.9u |
...
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | +103 | -1 | 0 | -1 | -1 | 5 | 0.20 | W | +0.3u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | -1 | 0 | 1 | 19 | 0.00 | L | -3.0u |
...
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -113 | 6 | 1 | 7 | 5 | 39 | -0.50 | L | -3.0u |
| 2026-06-08 | MLB | ML | home | 4.5 | 3.00 | -129 | 3 | 0 | 3 | 1 | 19 | -0.40 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | -1 | -4 | 0.00 | L | -3.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -121 | 1 | 1 | 2 | -1 | -1 | -1.60 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 2 | 52 | 0.00 | P | +0.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -146 | 1 | 0 | 1 | -1 | -2 | -0.50 | W | +2.0u |
| 2026-06-08 | MLB | ML | home | 4.0 | 1.00 | -118 | 2 | 0 | 2 | 2 | -52 | -0.40 | L | -1.0u |
...
| 2026-06-09 | MLB | ML | away | 3.0 | 0.50 | -148 | 1 | 0 | 1 | 2 | 6 | 0.00 | L | -0.5u |
| 2026-06-09 | MLB | ML | away | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 3 | 23 | 0.80 | L | -1.0u |
...
| 2026-06-09 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | -1 | 9 | 0.00 | W | +0.5u |
| 2026-06-09 | MLB | ML | away | 5.0 | 5.00 | -122 | 2 | 1 | 3 | 1 | 11 | 0.00 | W | +4.1u |
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | -120 | 0 | 0 | 0 | -1 | -14 | 0.00 | L | -0.3u |
| 2026-06-09 | MLB | ML | home | 4.0 | 1.00 | -107 | 1 | 0 | 1 | -1 | 7 | -1.30 | L | -1.0u |
...
| 2026-06-09 | MLB | ML | home | 4.0 | 1.00 | +102 | 2 | 0 | 2 | 2 | -6 | -1.20 | L | -1.0u |
| 2026-06-09 | MLB | ML | away | 4.0 | 1.00 | -119 | 1 | 0 | 1 | -1 | 21 | -0.80 | L | -1.0u |
...
| 2026-06-10 | MLB | ML | away | 5.0 | 5.00 | -106 | 1 | 0 | 1 | -2 | 12 | -0.70 | L | -5.0u |
...
| 2026-06-11 | MLB | ML | away | 4.0 | 1.00 | +112 | 0 | 0 | 0 | 0 | 11 | 0.00 | L | -1.0u |
...
| 2026-06-11 | MLB | ML | away | 3.0 | 0.50 | -167 | 1 | -1 | 0 | 0 | 28 | -0.10 | W | +0.3u |
| 2026-06-11 | MLB | TOTAL | under | 5.0 | 1.00 | -108 | 1 | 1 | 2 | 0 | -21 | 0.00 | L | -1.0u |
| 2026-06-11 | MLB | ML | away | 5.0 | 1.00 | +110 | 3 | 1 | 4 | 2 | -8 | -0.90 | L | -1.0u |
...
| 2026-06-11 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | -1 | -1 | -2 | 0 | 22 | 0.00 | W | +0.2u |
| 2026-06-11 | NHL | TOTAL | under | 3.0 | 0.50 | -104 | 2 | 0 | 2 | 3 | 14 | 0.00 | P | +0.0u |
| 2026-06-12 | MLB | ML | home | 5.0 | 5.00 | -114 | 0 | 0 | 0 | 0 | -5 | 0.00 | W | +4.4u |
| 2026-06-12 | MLB | ML | home | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | -12 | 0.00 | L | -3.0u |
| 2026-06-12 | MLB | TOTAL | over | 4.0 | 1.00 | +100 | 0 | 0 | 0 | 0 | 1 | 0.00 | L | -1.0u |
| 2026-06-12 | MLB | ML | home | 3.0 | 0.50 | -210 | 2 | 0 | 2 | 1 | -7 | -0.10 | W | +0.2u |
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +111 | 3 | 1 | 4 | 2 | -8 | -0.70 | L | -0.3u |
...
| 2026-06-12 | MLB | ML | home | 4.5 | 3.00 | -138 | 1 | 0 | 1 | -1 | 7 | -1.00 | L | -3.0u |
| 2026-06-12 | MLB | SPREAD | home | 3.0 | 0.50 | -107 | 2 | 0 | 2 | 2 | 7 | -0.40 | W | +0.4u |
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +118 | -1 | 0 | -1 | -1 | -26 | -0.20 | L | -0.3u |
| 2026-06-12 | MLB | ML | away | 4.0 | 1.00 | -136 | 2 | 0 | 2 | 1 | -7 | -1.30 | W | +0.7u |
| 2026-06-12 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | 1 | 14 | 0.00 | W | +2.7u |
| 2026-06-12 | MLB | ML | home | 3.0 | 0.50 | -134 | 2 | 0 | 2 | 2 | 6 | -1.10 | W | +0.4u |
...
| 2026-06-13 | MLB | ML | home | 4.5 | 3.00 | -157 | 0 | 0 | 0 | -1 | 0 | 0.00 | L | -3.0u |
| 2026-06-13 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 1 | 0 | 1 | 1 | 34 | 0.00 | W | +0.5u |
| 2026-06-13 | MLB | ML | home | 5.0 | 5.00 | -115 | 1 | 1 | 2 | -1 | 5 | -0.40 | W | +4.3u |
...
| 2026-06-14 | MLB | SPREAD | away | 4.0 | 1.00 | -158 | 1 | -1 | 0 | 1 | 34 | 0.10 | W | +0.6u |
| 2026-06-14 | MLB | ML | away | 4.0 | 1.00 | -125 | 2 | 1 | 3 | 3 | 6 | -1.20 | W | +0.8u |
| 2026-06-14 | MLB | ML | away | 4.5 | 3.00 | -101 | 1 | 0 | 1 | 1 | 14 | 0.00 | L | -3.0u |
| 2026-06-14 | MLB | ML | away | 2.5 | 0.25 | -115 | 2 | 0 | 2 | 2 | 6 | 0.00 | W | +0.2u |
...
| 2026-06-15 | MLB | ML | away | 3.0 | 0.50 | +115 | 2 | 0 | 2 | 2 | 16 | -0.80 | L | -0.5u |
| 2026-06-15 | MLB | ML | away | 3.0 | 0.50 | +160 | 2 | 0 | 2 | 0 | 20 | -0.70 | L | -0.5u |
| 2026-06-15 | MLB | SPREAD | away | 2.5 | 0.25 | -120 | 0 | 0 | 0 | -1 | 0 | 0.00 | L | -0.3u |
| 2026-06-15 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 3 | 0 | 3 | 2 | 32 | 0.00 | L | -3.0u |
| 2026-06-15 | MLB | ML | home | 2.5 | 0.25 | -157 | 1 | 0 | 1 | 2 | -8 | -0.20 | L | -0.3u |
| 2026-06-15 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | L | -1.0u |
| 2026-06-15 | MLB | ML | home | 3.0 | 0.50 | -132 | 3 | 1 | 4 | 3 | 6 | -0.70 | W | +2.2u |
| 2026-06-15 | MLB | TOTAL | under | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 0 | 0 | 0.00 | L | -1.0u |
| 2026-06-15 | MLB | ML | home | 3.0 | 0.50 | -154 | 1 | 0 | 1 | 3 | -1 | 0.50 | W | +0.0u |
| 2026-06-15 | MLB | SPREAD | away | 5.0 | 5.00 | -160 | 1 | 0 | 1 | 1 | 11 | -1.30 | L | -5.0u |
| 2026-06-15 | MLB | ML | home | 2.5 | 0.25 | -161 | -1 | 1 | 0 | -2 | 5 | -1.00 | W | +0.0u |
...
| 2026-06-16 | MLB | SPREAD | home | 4.0 | 1.00 | +156 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-16 | MLB | ML | home | 4.5 | 3.00 | -163 | 5 | 3 | 8 | 4 | 10 | -1.00 | W | +2.4u |
| 2026-06-16 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | -1 | 0 | -1 | -1 | -18 | 0.00 | L | -3.0u |
| 2026-06-16 | MLB | ML | home | 4.5 | 3.00 | -135 | 3 | 2 | 5 | 2 | 9 | -2.10 | W | +4.5u |
| 2026-06-16 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 7 | 0.00 | W | +0.0u |
| 2026-06-16 | MLB | ML | away | 2.5 | 0.25 | -106 | 1 | 0 | 1 | 0 | 0 | -0.20 | W | +0.0u |
| 2026-06-16 | MLB | ML | home | 3.0 | 0.50 | -174 | 2 | 1 | 3 | 1 | 7 | -1.40 | W | +2.3u |
| 2026-06-16 | MLB | ML | away | 4.0 | 1.00 | -116 | 0 | 0 | 0 | -1 | -8 | -0.80 | L | -1.0u |
| 2026-06-16 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 2 | 21 | 0.00 | L | -5.0u |
| 2026-06-16 | MLB | ML | home | 3.0 | 0.50 | -138 | 0 | 0 | 0 | -1 | -2 | 0.70 | L | -0.5u |
| 2026-06-16 | MLB | ML | away | 3.0 | 0.50 | -102 | 1 | 0 | 1 | 0 | 0 | -1.00 | L | -0.5u |
| 2026-06-16 | MLB | SPREAD | away | 4.0 | 1.00 | -160 | 0 | 0 | 0 | 2 | 24 | 30.10 | W | +0.0u |
| 2026-06-16 | MLB | ML | home | 3.0 | 0.50 | -161 | 1 | 1 | 2 | 0 | -21 | -0.40 | L | -0.5u |
| 2026-06-16 | MLB | ML | away | 5.0 | 2.50 | +120 | -1 | -1 | -2 | -1 | 30 | -1.80 | L | -2.5u |
| 2026-06-16 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 0 | 0 | 2 | 7 | 0.00 | L | -1.0u |
| 2026-06-16 | MLB | ML | away | 2.5 | 0.25 | -112 | 1 | 0 | 1 | 2 | 7 | -0.90 | W | +0.0u |
| 2026-06-16 | MLB | SPREAD | away | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-16 | SOC | ML | home | 4.0 | 1.00 | +1375 | 1 | 0 | 1 | -2 | -27 | 0.00 | L | -1.0u |
| 2026-06-17 | MLB | ML | away | 2.5 | 0.25 | +126 | -2 | 0 | -2 | -2 | -15 | -0.40 | W | +0.0u |
| 2026-06-17 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +2.7u |
| 2026-06-17 | MLB | ML | away | 4.5 | 2.50 | +112 | -1 | -1 | -2 | -2 | 17 | -1.20 | L | -2.5u |
...
| 2026-06-17 | MLB | SPREAD | away | 5.0 | 5.00 | -181 | 0 | 0 | 0 | 1 | 11 | -0.80 | W | +0.0u |
...
| 2026-06-17 | SOC | ML | away | 5.0 | 1.00 | +1028 | 1 | 0 | 1 | -5 | -35 | 0.00 | L | -1.0u |
| 2026-06-17 | SOC | ML | home | 4.0 | 1.00 | -140 | 0 | 0 | 0 | 0 | 4 | -0.30 | W | +0.0u |
| 2026-06-17 | SOC | ML | home | 4.0 | 1.00 | +142 | 1 | 0 | 1 | 3 | -11 | 0.00 | W | +0.0u |
| 2026-06-18 | MLB | ML | home | 4.0 | 1.00 | -138 | 1 | 0 | 1 | 1 | 3 | 0.00 | W | +0.0u |
| 2026-06-18 | MLB | ML | home | 4.5 | 3.00 | -141 | 1 | 1 | 2 | 0 | 12 | -1.30 | L | -3.0u |
| 2026-06-18 | MLB | ML | home | 4.5 | 3.00 | -151 | 3 | 0 | 3 | 2 | 18 | -1.50 | W | +0.0u |
...
| 2026-06-19 | MLB | SPREAD | away | 5.0 | 5.00 | -194 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
...
| 2026-06-19 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 2 | 0 | 2 | 2 | -14 | 0.00 | L | -3.0u |
| 2026-06-19 | MLB | ML | away | 4.0 | 1.00 | +107 | 0 | 0 | 0 | 1 | -3 | 0.00 | L | -1.0u |
| 2026-06-19 | MLB | SPREAD | away | 4.0 | 1.00 | -115 | 2 | 0 | 2 | 3 | 29 | 0.00 | W | +2.5u |
| 2026-06-19 | MLB | ML | away | 4.5 | 2.50 | +141 | 1 | 0 | 1 | 1 | 14 | 0.00 | L | -2.5u |
| 2026-06-19 | MLB | ML | home | 2.5 | 0.25 | +158 | -1 | -1 | -2 | -1 | -14 | -1.10 | W | +0.0u |
...
| 2026-06-19 | MLB | SPREAD | away | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
...
| 2026-06-20 | MLB | SPREAD | away | 5.0 | 5.00 | -194 | 0 | 0 | 0 | 1 | 11 | 0.00 | W | +0.0u |
...
| 2026-06-20 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | -1 | 1 | 0 | 1 | 14 | 0.00 | W | +0.0u |
| 2026-06-20 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | 4 | 0.00 | W | +1.8u |
| 2026-06-20 | MLB | ML | away | 3.0 | 0.50 | +116 | 0 | 0 | 0 | -2 | 0 | 0.00 | W | +0.0u |
| 2026-06-20 | MLB | TOTAL | under | 4.0 | 1.00 | -110 | -1 | 0 | -1 | -1 | -18 | 0.00 | L | -1.0u |
| 2026-06-20 | MLB | ML | home | 4.0 | 1.00 | -190 | 2 | 1 | 3 | 0 | 9 | -1.70 | W | +2.0u |
...
| 2026-06-20 | SOC | ML | away | 2.5 | 0.25 | +474 | -3 | 0 | -3 | -20 | -48 | 0.00 | L | -0.3u |
| 2026-06-20 | SOC | ML | away | 2.5 | 0.25 | +2200 | 0 | 0 | 0 | -1 | -13 | -0.20 | L | -0.3u |
| 2026-06-21 | MLB | ML | home | 4.0 | 1.00 | -226 | 1 | 0 | 1 | 0 | 16 | 0.30 | L | -1.0u |
| 2026-06-21 | MLB | SPREAD | away | 5.0 | 5.00 | -190 | 0 | 0 | 0 | 1 | 11 | -0.50 | L | -5.0u |
| 2026-06-21 | MLB | TOTAL | under | 4.5 | 2.50 | +100 | 1 | 1 | 2 | 1 | 32 | 0.00 | W | +2.5u |
| 2026-06-21 | MLB | ML | home | 4.0 | 1.00 | -104 | -1 | 0 | -1 | 0 | -9 | -0.50 | L | -1.0u |
| 2026-06-21 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 0 | 0 | 0.00 | L | -1.0u |
| 2026-06-21 | MLB | ML | away | 5.0 | 2.50 | +113 | 0 | 0 | 0 | 1 | -3 | 0.00 | L | -2.5u |
...
| 2026-06-21 | MLB | ML | home | 4.5 | 3.00 | -178 | 3 | 0 | 3 | 3 | 52 | -1.30 | W | +1.6u |
| 2026-06-21 | MLB | ML | home | 3.0 | 0.50 | +130 | 0 | 0 | 0 | -1 | -2 | -0.80 | L | -0.5u |
| 2026-06-21 | MLB | ML | home | 3.0 | 0.50 | +123 | 1 | 0 | 1 | 0 | 0 | -0.20 | W | +0.0u |
| 2026-06-21 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | -1 | -2 | 0.00 | L | -3.0u |
| 2026-06-21 | MLB | SPREAD | away | 5.0 | 2.50 | +130 | 0 | 0 | 0 | 1 | 11 | -1.30 | W | +0.0u |
| 2026-06-21 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | 2 | 0 | 2 | 2 | 13 | 0.00 | L | -0.3u |
| 2026-06-21 | MLB | TOTAL | under | 4.5 | 1.00 | -114 | 1 | 1 | 2 | 1 | -21 | 0.00 | W | +0.0u |
| 2026-06-21 | SOC | ML | away | 4.5 | 1.00 | +725 | 2 | 0 | 2 | -4 | -48 | 0.00 | L | -1.0u |
| 2026-06-21 | SOC | ML | home | 4.0 | 1.00 | +650 | 2 | 0 | 2 | 1 | 0 | -0.20 | L | -1.0u |
| 2026-06-21 | SOC | ML | draw | 3.0 | 0.50 | +950 | 0 | 0 | 0 | -9 | -36 | 0.00 | L | -0.5u |
| 2026-06-22 | MLB | ML | home | 4.5 | 3.00 | -138 | 0 | 0 | 0 | 0 | 12 | 0.30 | W | +0.0u |
| 2026-06-22 | MLB | SPREAD | away | 5.0 | 5.00 | -168 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-22 | MLB | TOTAL | over | 4.5 | 1.00 | +105 | 1 | 0 | 1 | 1 | 3 | 0.00 | L | -1.0u |
| 2026-06-22 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 0 | 14 | 0.00 | L | -3.0u |
| 2026-06-22 | MLB | SPREAD | away | 5.0 | 2.50 | +118 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-22 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 14 | 0.00 | W | +0.0u |
| 2026-06-22 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +2.7u |
| 2026-06-22 | MLB | ML | home | 5.0 | 5.00 | -124 | 1 | 0 | 1 | 1 | 11 | -1.20 | W | +2.3u |
| 2026-06-22 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 3 | 0 | 3 | 3 | 35 | 0.00 | W | +2.7u |
...
| 2026-06-22 | MLB | SPREAD | home | 4.5 | 1.00 | -109 | 0 | 0 | 0 | -1 | 16 | 0.00 | W | +0.0u |
| 2026-06-22 | MLB | SPREAD | away | 4.5 | 2.50 | +138 | 2 | 0 | 2 | 1 | 32 | 0.00 | L | -2.5u |
| 2026-06-22 | MLB | TOTAL | under | 4.0 | 1.00 | -104 | 2 | 1 | 3 | 2 | 7 | 0.00 | W | +3.9u |
| 2026-06-22 | MLB | ML | away | 5.0 | 5.00 | — | 1 | 0 | 1 | 1 | 2 | 0.00 | L | -5.0u |
| 2026-06-22 | SOC | ML | draw | 4.5 | 1.00 | +350 | -1 | 0 | -1 | -16 | -42 | -0.70 | L | -1.0u |
| 2026-06-22 | SOC | ML | home | 2.5 | 0.25 | -950 | 1 | 0 | 1 | 8 | 49 | 0.00 | W | +0.0u |
| 2026-06-22 | SOC | ML | home | 4.5 | 2.50 | +139 | 1 | 0 | 1 | 9 | 39 | 0.00 | W | +0.0u |
| 2026-06-23 | MLB | ML | home | 3.0 | 0.50 | -109 | 0 | 0 | 0 | -1 | -13 | -1.80 | L | -0.5u |
| 2026-06-23 | MLB | SPREAD | away | 5.0 | 5.00 | -168 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-23 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 0 | 0 | 0 | 1 | -3 | 0.00 | W | +0.0u |
| 2026-06-23 | MLB | ML | away | 4.5 | 3.00 | -108 | 2 | 0 | 2 | 2 | -5 | -1.40 | L | -3.0u |
| 2026-06-23 | MLB | ML | away | 4.5 | 3.00 | -133 | 1 | 0 | 1 | 2 | 12 | -1.40 | L | -3.0u |
...
| 2026-06-23 | MLB | ML | away | 4.5 | 3.00 | -172 | 1 | 0 | 1 | 1 | -7 | 0.00 | W | +0.0u |
| 2026-06-23 | MLB | TOTAL | under | 5.0 | 1.00 | -109 | 2 | 0 | 2 | 2 | -3 | 0.00 | L | -1.0u |
| 2026-06-23 | MLB | SPREAD | away | 5.0 | 2.50 | +132 | 1 | 0 | 1 | 1 | -7 | 0.00 | W | +0.0u |
| 2026-06-23 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | L | -1.0u |
| 2026-06-23 | MLB | ML | home | 5.0 | 2.50 | +104 | 1 | 0 | 1 | 1 | -7 | 0.00 | L | -2.5u |
| 2026-06-23 | MLB | SPREAD | away | 5.0 | 5.00 | -110 | 0 | 0 | 0 | 1 | 11 | 0.00 | L | -5.0u |
| 2026-06-23 | MLB | ML | away | 4.0 | 1.00 | +117 | 1 | 0 | 1 | 0 | 5 | -0.20 | L | -1.0u |
| 2026-06-23 | MLB | SPREAD | away | 2.5 | 0.25 | +106 | 1 | 0 | 1 | 0 | 33 | -1.50 | W | +0.0u |
| 2026-06-23 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | 0 | 0 | 0 | 0 | -4 | 0.00 | W | +0.0u |
...
| 2026-06-23 | SOC | ML | away | 4.5 | 1.00 | +1800 | 1 | 0 | 1 | -3 | -23 | 0.00 | L | -1.0u |
| 2026-06-24 | MLB | SPREAD | away | 5.0 | 5.00 | -214 | 0 | 0 | 0 | 1 | 11 | 0.00 | W | +0.0u |
...
| 2026-06-24 | MLB | TOTAL | under | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +0.0u |
...
| 2026-06-24 | MLB | SPREAD | away | 5.0 | 5.00 | -105 | 0 | 0 | 0 | 1 | 11 | 0.00 | L | -5.0u |
| 2026-06-24 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | -1 | 0 | 1 | -4 | 0.00 | W | +3.6u |
| 2026-06-24 | MLB | ML | away | 4.5 | 2.50 | -134 | 1 | 0 | 1 | 2 | 7 | -0.20 | W | +0.0u |
| 2026-06-24 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 0 | 0 | 0 | -1 | -11 | 0.00 | L | -5.0u |
| 2026-06-24 | MLB | ML | home | 4.5 | 3.00 | -134 | 1 | 0 | 1 | 1 | -7 | -1.90 | L | -3.0u |
| 2026-06-24 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | 0 | 0 | 0 | 0 | 0 | 0.00 | W | +0.0u |
| 2026-06-24 | MLB | ML | away | 3.0 | 0.50 | +132 | 0 | 0 | 0 | -1 | -2 | -2.20 | L | -0.5u |
| 2026-06-24 | MLB | SPREAD | home | 4.0 | 1.00 | -115 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +0.0u |
| 2026-06-24 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | L | -3.0u |
| 2026-06-24 | MLB | ML | away | 4.5 | 2.50 | +117 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-24 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +0.0u |
| 2026-06-24 | MLB | ML | home | 2.5 | 0.25 | -102 | -1 | 0 | -1 | -1 | 7 | -0.70 | W | +0.0u |
| 2026-06-24 | MLB | SPREAD | away | 4.0 | 1.00 | +136 | 1 | 0 | 1 | 1 | 14 | 0.00 | L | -1.0u |
| 2026-06-24 | MLB | TOTAL | under | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | W | +0.0u |
| 2026-06-24 | MLB | ML | home | 4.5 | 2.50 | +108 | 0 | 0 | 0 | 0 | -9 | 0.00 | L | -2.5u |
...
| 2026-06-24 | SOC | ML | home | 4.5 | 3.00 | -525 | 4 | 1 | 5 | 2 | 59 | 0.50 | W | +1.1u |
| 2026-06-24 | SOC | ML | away | 4.5 | 3.00 | -104 | -1 | 0 | -1 | 2 | 29 | -1.00 | W | +0.0u |
| 2026-06-24 | SOC | ML | home | 2.5 | 0.25 | -257 | 2 | 0 | 2 | 2 | 23 | -1.10 | W | +0.0u |
...
| 2026-06-25 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 2 | 0 | 2 | 2 | -5 | 0.00 | W | +3.6u |
| 2026-06-25 | MLB | ML | away | 2.5 | 0.25 | -136 | 3 | 0 | 3 | 2 | -9 | -2.40 | L | -0.3u |
| 2026-06-25 | MLB | SPREAD | away | 5.0 | 2.50 | +114 | 2 | 0 | 2 | 2 | -5 | -1.90 | L | -2.5u |
| 2026-06-25 | MLB | TOTAL | under | 4.5 | 3.00 | -116 | 0 | 0 | 0 | 0 | -2 | 0.00 | L | -3.0u |
| 2026-06-25 | MLB | ML | home | 4.5 | 1.00 | +443 | 1 | 0 | 1 | 2 | -7 | 0.00 | L | -1.0u |
| 2026-06-25 | MLB | SPREAD | away | 4.5 | 3.00 | -105 | 1 | 0 | 1 | 1 | -2 | 0.00 | W | +0.0u |
| 2026-06-25 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | 0 | 1 | 1 | -1 | -14 | 0.00 | L | -0.3u |
| 2026-06-25 | SOC | ML | home | 4.5 | 1.50 | +163 | -1 | 0 | -1 | -1 | 5 | 0.00 | L | -1.5u |
| 2026-06-25 | SOC | ML | away | 2.5 | 0.25 | -600 | 4 | 1 | 5 | 4 | 39 | -0.70 | W | +0.0u |
| 2026-06-25 | SOC | ML | away | 4.0 | 1.00 | -110 | 12 | 7 | 19 | 12 | 40 | -0.90 | L | -1.0u |
| 2026-06-25 | SOC | ML | away | 5.0 | 5.00 | -700 | 5 | 1 | 6 | 4 | 36 | 1.80 | W | +0.5u |
| 2026-06-25 | SOC | ML | away | 2.5 | 0.25 | -105 | 4 | 4 | 8 | 5 | 3 | -0.20 | L | -0.3u |
| 2026-06-26 | MLB | ML | away | 4.5 | 3.00 | -120 | 2 | 0 | 2 | 1 | -7 | -0.80 | W | +3.3u |
...
| 2026-06-26 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 1 | 2 | 1 | 11 | 0.00 | L | -5.0u |
...
| 2026-06-26 | MLB | SPREAD | away | 4.5 | 3.00 | -204 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-26 | MLB | ML | home | 4.0 | 1.00 | -2261 | 0 | 0 | 0 | 0 | -5 | 0.00 | W | +0.0u |
| 2026-06-26 | MLB | ML | away | 2.5 | 0.25 | -154 | 0 | 0 | 0 | 1 | 14 | 0.00 | W | +0.0u |
| 2026-06-26 | MLB | SPREAD | away | 4.5 | 2.50 | +110 | 1 | 1 | 2 | 1 | 28 | 0.00 | L | -2.5u |
| 2026-06-26 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | -7 | 0.00 | W | +0.0u |
| 2026-06-26 | MLB | ML | away | 4.0 | 1.00 | -106 | 1 | 0 | 1 | 1 | 14 | -1.00 | W | +0.0u |
| 2026-06-26 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | L | -3.0u |
| 2026-06-26 | MLB | ML | away | 3.0 | 0.50 | +121 | 1 | 0 | 1 | 0 | 0 | -0.80 | L | -0.5u |
| 2026-06-26 | SOC | ML | away | 5.0 | 5.00 | -600 | 1 | 0 | 1 | 1 | 17 | -0.30 | W | +0.8u |
| 2026-06-26 | SOC | ML | away | 3.0 | 0.50 | -200 | 7 | 2 | 9 | 8 | 57 | -0.20 | W | +4.1u |
| 2026-06-26 | SOC | ML | away | 2.5 | 0.25 | -155 | 5 | 2 | 7 | 8 | 48 | 1.20 | W | +1.6u |
| 2026-06-26 | SOC | ML | home | 3.0 | 0.50 | +150 | 0 | 2 | 2 | -1 | 9 | -0.30 | L | -0.5u |
| 2026-06-26 | SOC | ML | home | 2.5 | 0.25 | -380 | -1 | 1 | 0 | 0 | 15 | 0.00 | W | +0.0u |
| 2026-06-26 | SOC | ML | home | 2.5 | 0.25 | +135 | -2 | 2 | 0 | -5 | -9 | -0.30 | L | -0.3u |
| 2026-06-27 | MLB | ML | away | 5.0 | 2.50 | +121 | 0 | 0 | 0 | 0 | 5 | 0.00 | L | -2.5u |
| 2026-06-27 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 14 | 0.00 | L | -1.0u |
| 2026-06-27 | MLB | ML | away | 4.0 | 1.00 | +116 | 0 | 0 | 0 | 1 | -41 | -0.70 | L | -1.0u |
| 2026-06-27 | MLB | ML | home | 2.5 | 0.25 | -155 | 0 | 2 | 2 | 0 | 1 | -0.80 | L | -0.3u |
| 2026-06-27 | MLB | ML | away | 2.5 | 0.25 | -112 | 3 | 1 | 4 | 4 | 41 | -0.90 | W | +3.6u |
| 2026-06-27 | MLB | ML | home | 4.5 | 3.00 | -134 | 1 | 0 | 1 | 0 | 0 | 0.00 | L | -3.0u |
| 2026-06-27 | MLB | TOTAL | under | 2.5 | 0.25 | -104 | 4 | 1 | 5 | 3 | -6 | 0.00 | L | -0.3u |
| 2026-06-27 | MLB | ML | away | 5.0 | 2.50 | +114 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -2.5u |
| 2026-06-27 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | -7 | 0.00 | W | +0.0u |
| 2026-06-27 | MLB | ML | home | 4.5 | 3.00 | -130 | 1 | 0 | 1 | 0 | 0 | 0.00 | L | -3.0u |
| 2026-06-27 | MLB | SPREAD | away | 4.5 | 3.00 | -204 | 2 | 0 | 2 | 2 | 24 | -1.70 | W | +2.3u |
| 2026-06-27 | MLB | ML | away | 4.0 | 1.00 | -104 | 0 | 0 | 0 | 0 | 0 | -1.20 | L | -1.0u |
| 2026-06-27 | MLB | ML | home | 4.0 | 1.00 | -123 | 0 | 0 | 0 | -1 | -2 | 0.00 | W | +3.3u |
| 2026-06-27 | MLB | SPREAD | home | 4.5 | 1.50 | +154 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-27 | MLB | TOTAL | over | 2.5 | 1.00 | -110 | 1 | 0 | 1 | 0 | 0 | 0.00 | L | -1.0u |
| 2026-06-27 | MLB | ML | away | 4.5 | 3.00 | -142 | 1 | 0 | 1 | 0 | 0 | 0.00 | L | -3.0u |
| 2026-06-27 | MLB | ML | home | 4.5 | 3.00 | -178 | 3 | 0 | 3 | 2 | 9 | -0.10 | L | -3.0u |
| 2026-06-27 | MLB | SPREAD | home | 4.5 | 2.50 | +113 | 1 | 0 | 1 | 1 | -7 | 0.00 | L | -2.5u |
| 2026-06-27 | SOC | ML | away | 5.0 | 5.00 | -500 | 2 | 1 | 3 | 2 | 10 | 1.30 | W | +0.8u |
| 2026-06-27 | SOC | ML | draw | 2.5 | 0.25 | +109 | -1 | 0 | -1 | -1 | 14 | 1.40 | W | +0.0u |
| 2026-06-27 | SOC | ML | away | 5.0 | 5.00 | -575 | 4 | 1 | 5 | 5 | 28 | -0.10 | W | +0.8u |
| 2026-06-27 | SOC | ML | home | 2.5 | 0.25 | -122 | 1 | 3 | 4 | 4 | 13 | 1.00 | W | +2.5u |
