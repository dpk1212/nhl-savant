...
_Auto-generated **6/23/2026, 11:42:41 AM ET** by `scripts/v6FullAnalysis.js`. Do not edit by hand._
...
**Sample:** 767 shipped+graded picks · 2026-04-18 → 2026-06-22  (HC analyses scoped to post-cutover 2026-04-30, 655 picks)
**Headline:** 387-372-8 · WR 51.0% [47.4%–54.5%] vs 52.4% break-even · -20.9u flat (-2.7%) · -123.7u peak.
**Overall t-test:** t = -0.77 → ✗ noise.
...
- **ρ(Δw, flat ROI) = 0.017 ✗**  (full sample, N=761)
- **ρ(HC, flat ROI) = -0.009 ✗**  (post-cutover, N=655)
- **ρ(Δw+HC, flat ROI) = -0.031 ✗**  (post-cutover, N=655)
...
- **Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era)** — N=101, 45-55, WR 45.0% [36%–55%], flat ROI -16.2% (t=-1.74 ~ p<.10)

### Action map

- **Tier-1a (HC ≥ +2)** — N=44, WR 47.7%, flat ROI -12.4%. Bayesian posterior WR ≈ 48.1%, half-Kelly = **0.0%** bankroll at −110 → **size aggressively**.
- **Tier-1b (HC = +1)** — N=170, WR 57.6%, flat ROI +10.3%. Bayesian posterior WR ≈ 57.2%, half-Kelly = **5.1%** bankroll at −110.
- **Tier-2 (HC ≤ 0 ∧ Δw ≥ +2, HC era)** — N=101, WR 45.0%, flat ROI -16.2%. Δw saves the pick when HC is silent.
- **Δw ≥ +3 (full sample)** — N=114, WR 50.0%, flat ROI -0.8%. Bayesian posterior WR ≈ 50.0%, half-Kelly = **0.0%** bankroll at −110.
- **Stale Δw ≤ 0 (full sample)** — -9.1% flat ROI on 206 picks. Already muted by v7.x; should not re-appear.
- **Sample size:** at observed σ (0.98u/pick), we need **~1477 graded picks** to validate a true +5% flat ROI at 95% confidence. We have 767. Cohort findings — especially HC subsets — are provisional until N grows.
...
| Shipped + graded | **767** |
| W-L-P | 387-372-8 |
| Win rate | **51.0%** [47.4%–54.5%] |
| Break-even WR @ −110 | 52.38% |
| Distance to break-even | WR needs +1.4 pp |
| Peak-units PnL | **-123.7u** |
| Flat-1u PnL | **-20.9u** (-2.7% flat ROI) |
| Flat t-statistic vs zero | -0.77 → ✗ noise |
| Flat 95% CI per-pick | [-0.097, 0.042]u |
...
We have **767** graded picks. Anything we conclude on cohorts smaller than ~200 is provisional.
...
| Δw = 0 | 164 | 82-79-3 | 50.9% [43–59] | -4.0% | -14.6u | -0.54 ✗ noise |
| Δw = +1 | 297 | 159-135-3 | 54.1% [48–60] | +2.0% | -45.4u | 0.37 ✗ noise |
| Δw = +2 | 144 | 70-73-1 | 49.0% [41–57] | -5.6% | -34.0u | -0.69 ✗ noise |
| Δw ≥ +3 | 114 | 57-57-0 | 50.0% [41–59] | -0.8% | -15.7u | -0.08 ✗ noise |

**Pearson ρ(Δw, WIN) = 0.013** ✗  ·  **ρ(Δw, flat ROI) = 0.017** ✗  (N=761)
...
| HC = 0 | 411 | 200-204-7 | 49.5% [45–54] | -7.0% | -136.4u | -1.49 ✗ noise |
| HC = +1 | 170 | 98-72-0 | 57.6% [50–65] | +10.3% | +22.5u | 1.38 ✗ noise |
| HC = +2 | 32 | 17-15-0 | 53.1% [36–69] | +1.9% | -0.1u | 0.11 ✗ noise |
| HC ≥ +3 | 12 | 4-8-0 | 33.3% [14–61] | -50.4% | -6.7u | -2.38 ✓ p<.05 |

**Pearson ρ(HC, WIN) = 0.007** ✗  ·  **ρ(HC, flat ROI) = -0.009** ✗  (N=655)

Spearman rank ρ(HC, flat ROI) = 0.028.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Σ ≤ 0 | 156 | 75-78-3 | 49.0% [41–57] | -6.7% | -28.1u | -0.86 ✗ noise |
| Σ = +1 | 219 | 118-98-3 | 54.6% [48–61] | +3.2% | -49.3u | 0.50 ✗ noise |
| Σ = +2 | 132 | 73-58-1 | 55.7% [47–64] | +4.4% | +0.2u | 0.54 ✗ noise |
| Σ = +3 | 65 | 30-35-0 | 46.2% [35–58] | -12.3% | -7.6u | -1.01 ✗ noise |
...
**Pearson ρ(Δw+HC, WIN) = -0.018** ✗  ·  **ρ(Σ, flat ROI) = -0.031** ✗  (N=655)

### §2d. Which axis is the strongest single predictor?

Comparison restricted to the post-cutover sample where every axis has a value (so the rows are apples-to-apples). N = 655.

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | Verdict |
|---|---|---|---|---|
| Δw | -0.029 ✗ | -0.037 ✗ | -0.019 | weak |
| HC margin | 0.007 ✗ | -0.009 ✗ | 0.028 | weak |
| Δw + HC | -0.018 ✗ | -0.031 ✗ | -0.002 | weak |
| peak.stars | -0.034 ✗ | -0.054 ✗ | -0.057 | weak |
| vault.star | -0.015 ✗ | -0.028 ✗ | -0.045 | weak |
| lock.stars | -0.020 ✗ | -0.036 ✗ | -0.037 | weak |
...
Universe N = 655 (post-cutover, both axes present).
...
| +0 | N=1 · 1-0 · 100% [21–100] · —  | N=4 · 1-3 · 25% [5–70] · -44%  | N=14 · 3-10 · 23% [8–50] · -54% ✗ | N=106 · 53-51 · 51% [41–60] · -4%  | N=191 · 101-87 · 54% [47–61] · +1%  | N=65 · 31-33 · 48% [37–60] · -10%  | N=30 · 10-20 · 33% [19–51] · -40% ✗ |
| +1 | — | — | N=7 · 4-3 · 57% [25–84] · +2%  | N=26 · 15-11 · 58% [39–74] · +7%  | N=62 · 39-23 · 63% [50–74] · +19%  | N=38 · 20-18 · 53% [37–68] · +3%  | N=37 · 20-17 · 54% [38–69] · +6%  |
...
| Δw = 0 | 141 | 75-64-2 | 54.0% [46–62] | +1.8% | -1.2u | 0.22 ✗ noise |
| Δw = +1 | 264 | 144-117-3 | 55.2% [49–61] | +4.1% | -40.8u | 0.70 ✗ noise |
| Δw = +2 | 119 | 59-59-1 | 50.0% [41–59] | -4.5% | -30.2u | -0.50 ✗ noise |
| Δw ≥ +3 | 96 | 44-52-0 | 45.8% [36–56] | -13.4% | -27.8u | -1.36 ✗ noise |

### §3d. Practical lock zones (v7.4 floor anatomy)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Tier-1: HC ≥ +1 | 214 | 119-95-0 | 55.6% [49–62] | +5.7% | +15.7u | 0.85 ✗ noise |
| Tier-2: HC ≤ 0 ∧ Δw ≥ +2 | 101 | 45-55-1 | 45.0% [36–55] | -16.2% | -41.2u | -1.74 ~ p<.10 |
| No-ship zone: HC ≤ 0 ∧ Δw ≤ +1 | 340 | 172-162-6 | 51.5% [46–57] | -2.3% | -87.7u | -0.44 ✗ noise |
...
Universe N = 739 picks where ≥1 proven wallet appeared on either side.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δcount ≤ −2 (heavy oppose) | 16 | 8-8-0 | 50.0% [28–72] | +0.6% | -6.4u | 0.02 ✗ noise |
| Δcount = −1 | 50 | 22-28-0 | 44.0% [31–58] | -13.6% | -24.5u | -0.97 ✗ noise |
| Δcount = 0 (balanced) | 126 | 57-67-2 | 46.0% [37–55] | -11.0% | -14.9u | -1.26 ✗ noise |
| Δcount = +1 | 280 | 142-137-1 | 50.9% [45–57] | -5.0% | -107.8u | -0.87 ✗ noise |
| Δcount = +2 | 149 | 76-72-1 | 51.4% [43–59] | -3.3% | -17.5u | -0.41 ✗ noise |
| Δcount ≥ +3 (heavy support) | 118 | 73-42-3 | 63.5% [54–72] | +24.5% | +55.5u | 2.54 ✓ p<.05 |

**ρ(Δcount, WIN) = 0.075** ✓ p<.05  ·  **ρ(Δcount, flat ROI) = 0.082** ✓ p<.05
...
Quintile cuts: ≤ -8 · ≤ 2 · ≤ 11 · ≤ 22 · > 22

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 (worst — heavy oppose) | 157 | 69-88-0 | 43.9% [36–52] | -13.5% | -64.7u | -1.70 ~ p<.10 |
| Q2 | 146 | 63-81-2 | 43.8% [36–52] | -14.6% | -43.5u | -1.81 ~ p<.10 |
| Q3 (balanced) | 177 | 98-77-2 | 56.0% [49–63] | +5.7% | -31.5u | 0.80 ✗ noise |
| Q4 | 113 | 63-49-1 | 56.3% [47–65] | +8.2% | +1.8u | 0.88 ✗ noise |
| Q5 (best — heavy support) | 146 | 85-59-2 | 59.0% [51–67] | +8.6% | +22.4u | 1.06 ✗ noise |

**ρ(ΔWlNet, WIN) = 0.135** ✓ p<.01  ·  **ρ(ΔWlNet, flat ROI) = 0.108** ✓ p<.01
...
Quintile cuts (units): ≤ -4.29 · ≤ 19.63 · ≤ 0.25 · ≤ 0.27 · > 0.27

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 240 | 110-128-2 | 46.2% [40–53] | -13.1% | -55.5u | -2.13 ✓ p<.05 |
| Q2 | 364 | 195-166-3 | 54.0% [49–59] | +2.3% | -40.0u | 0.46 ✗ noise |
| Q3 | 0 | — | — | — | — | — |
| Q4 | 0 | — | — | — | — | — |
| Q5 | 135 | 73-60-2 | 54.9% [46–63] | +9.2% | -20.1u | 0.99 ✗ noise |
...
Quintile cuts (% ROI): ≤ -3.9 · ≤ 20.7 · ≤ 0.6 · ≤ 1.0 · > 1.0

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Q1 | 227 | 88-137-2 | 39.1% [33–46] | -26.3% | -90.3u | -4.27 ✓ p<.01 |
| Q2 | 335 | 188-145-2 | 56.5% [51–62] | +7.5% | +18.2u | 1.42 ✗ noise |
| Q3 | 0 | — | — | — | — | — |
| Q4 | 0 | — | — | — | — | — |
| Q5 | 177 | 102-72-3 | 58.6% [51–66] | +13.7% | -43.4u | 1.78 ~ p<.10 |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ΔBestRank ≤ −5 (we have worse #1 by ≥5) | 98 | 31-65-2 | 32.3% [24–42] | -36.0% | -52.9u | -3.83 ✓ p<.01 |
| ΔBestRank ∈ [−4,−1] | 18 | 8-10-0 | 44.4% [25–66] | -11.9% | -16.7u | -0.49 ✗ noise |
| ΔBestRank = 0 (tied) | 2 | 2-0-0 | 100.0% [34–100] | +99.5% | +2.9u | 11.64 ✓ p<.01 |
| ΔBestRank ∈ [+1,+4] | 25 | 12-13-0 | 48.0% [30–67] | -8.3% | +13.2u | -0.42 ✗ noise |
| ΔBestRank ≥ +5 (we have better #1 by ≥5) | 190 | 103-85-2 | 54.8% [48–62] | +8.2% | -21.1u | 1.07 ✗ noise |

**ρ(ΔBestRank, WIN) = 0.225** ✓ p<.01  ·  **ρ(ΔBestRank, flat ROI) = 0.238** ✓ p<.01  (N=333)
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| Δshare ≤ −30 pp | 56 | 18-37-1 | 32.7% [22–46] | -35.4% | -37.3u | -2.81 ✓ p<.01 |
| Δshare ∈ [−30,−10] pp | 5 | 0-5-0 | 0.0% [0–43] | -100.0% | -3.3u | 0.00 ✗ noise |
| Δshare ≈ 0 (±10 pp) | 491 | 250-239-2 | 51.1% [47–56] | -3.3% | -72.7u | -0.76 ✗ noise |
| Δshare ∈ [+10,+30] pp | 29 | 13-15-1 | 46.4% [30–64] | -10.3% | -4.9u | -0.57 ✗ noise |
| Δshare ≥ +30 pp | 158 | 97-58-3 | 62.6% [55–70] | +21.2% | +2.7u | 2.61 ✓ p<.01 |

**ρ(ΔTopQShare, WIN) = 0.124** ✓ p<.01  ·  **ρ(ΔTopQShare, flat ROI) = 0.124** ✓ p<.01
...
|---|---|---|---|---|
| 1 | **ΔTopQCount** | 0.140 ✓ p<.01 | 0.165 ✓ p<.01 | 0.124 |
| 2 | **ΔTopQShare** | 0.124 ✓ p<.01 | 0.124 ✓ p<.01 | 0.123 |
| 3 | **ΔWlNet** | 0.135 ✓ p<.01 | 0.108 ✓ p<.01 | 0.065 |
| 4 | **Δcount** | 0.075 ✓ p<.05 | 0.082 ✓ p<.05 | 0.075 |
| 5 | **ΔFlatPnl** | NaN — | NaN — | 0.088 |
| 6 | **ΔAvgRoi** | NaN — | NaN — | 0.111 |

_(ΔBestRank uses N=333 subset where both sides had a proven wallet — ρ(flat ROI) = 0.238 ✓ p<.01.)_
...
**In-sample (live production) calibration**: source = `cron`, sampleSize = 1301, dateRange = 2026-04-18 → 2026-06-22, computedAt = 2026-06-23T15:38:58.769Z. _This is what production scores against today; the §AGS-0a audit below shows how much its in-sample numbers diverge from the leakage-free walk-forward version._
...
Coverage: in-sample AGS computable on **739** rows · PIT aggregate computable on **735** rows (the proven wallet count drops because some wallets weren't yet proven on those early dates) · PIT walk-forward AGS computed on **735** rows (34 used the cold-start fallback calibration for the early dates).
...
| LOCK (+5..+7) | 0 · — · — | 0 · — · — | — |
| STRONG (+3..+5) | 0 · — · — | 0 · — · — | — |
| NEUTRAL (0..+3) | 504 · 55% · +4.2% | 429 · 52% · -3.0% | -7.2pp |
| WEAK (−3..0) | 213 · 44% · -14.3% | 288 · 51% · +1.2% | +15.5pp |
| FADE (<−3) | 0 · — · — | 0 · — · — | — |
...
|---|---|---|---|
| AGS ≥ +5 (lock-floor route C) | N=395, WR=54%, ROI=+2.9% | N=330, WR=52%, ROI=-3.5% | -6.4pp |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=504, WR=55%, ROI=+4.2% | N=429, WR=52%, ROI=-3.0% | -7.2pp |
| AGS < −1 (mute veto) | N=81, WR=43%, ROI=-15.6% | N=167, WR=48%, ROI=-2.7% | +12.9pp |
...
#### §AGS-0a-recent. Last-14-days holdout (PIT-OOS, 2026-06-09 → 2026-06-22, N=225)
...
| LOCK (+5..+7) | 0 · — · — |
| STRONG (+3..+5) | 0 · — · — |
| NEUTRAL (0..+3) | 120 · 52% · -3.6% |
| WEAK (−3..0) | 105 · 50% · -3.2% |
| FADE (<−3) | 0 · — · — |

| Floor | Fire (PIT-OOS, last 14d) |
|---|---|
| AGS ≥ +5 (lock-floor route C) | N=98, WR=55%, ROI=+2.9% |
| AGS ≥ +3 (Δw=+1 confirm route B) | N=120, WR=52%, ROI=-3.6% |
| AGS < −1 (mute veto) | N=62, WR=50%, ROI=-1.1% |
...
|---|---|---|---|---|
| `dCount` | COUNT | + | 0.96 | 1.48 |
| `dHcSizeRatio` | INTENSITY_HC | + | 0.82 | 4.25 |
| `dSumRankNorm` | QUALITY_RANK | − | 49.31 | 84.80 |
| `dWinnerCtPreA` | QUALITY_TRACK | − | 0.52 | 1.08 |

### §AGS-1. Coverage + distribution

PIT-OOS AGS computable on **735/767** shipped+graded rows (96%). Rows drop out for two reasons: missing frozen `walletDetails[]` (older docs), or no wallet on either side was yet proven on this pick's date under the strict-prior PIT lens.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ELITE | 121 | 63-56-2 | 52.9% [44–62] | -3.4% | -19.0u | -0.41 ✗ noise |
| LOCK | 136 | 64-72-0 | 47.1% [39–55] | -11.2% | -43.2u | -1.35 ✗ noise |
| STRONG | 0 | — | — | — | — | — |
| NEUTRAL | 0 | — | — | — | — | — |
| WEAK | 105 | 52-51-2 | 50.5% [41–60] | -3.4% | -14.4u | -0.36 ✗ noise |
| FADE | 176 | 84-89-3 | 48.6% [41–56] | -2.4% | -46.4u | -0.30 ✗ noise |
...
r(WIN) = **0.006** ✗ · r(ROI) = **-0.021** ✗ · Spearman ρ(ROI) = **-0.033**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 170 | 85-83-2 | 50.6% [43–58] | +1.5% | -33.0u | 0.18 ✗ noise |
| z ∈ [−1, 0) | 258 | 138-117-3 | 54.1% [48–60] | +1.8% | -26.0u | 0.31 ✗ noise |
| z ∈ [0, +1) | 208 | 99-108-1 | 47.8% [41–55] | -10.1% | -51.5u | -1.53 ✗ noise |
| z ≥ +1 (very positive) | 99 | 49-48-2 | 50.5% [41–60] | -6.9% | -7.4u | -0.73 ✗ noise |
...
| z ∈ [0, +1) | 701 | 356-337-8 | 51.4% [48–55] | -2.8% | -114.9u | -0.77 ✗ noise |
| z ≥ +1 (very positive) | 0 | — | — | — | — | — |

#### `dSumRankNorm` (QUALITY_RANK)

r(WIN) = **-0.034** ✗ · r(ROI) = **-0.041** ✗ · Spearman ρ(ROI) = **-0.046**.

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| z < −1 (very negative) | 137 | 73-63-1 | 53.7% [45–62] | +0.2% | -10.5u | 0.02 ✗ noise |
| z ∈ [−1, 0) | 285 | 149-134-2 | 52.7% [47–58] | +1.9% | -47.9u | 0.32 ✗ noise |
| z ∈ [0, +1) | 238 | 114-120-4 | 48.7% [42–55] | -6.9% | -58.3u | -1.11 ✗ noise |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.034 ✗ | -0.041 ✗ | -0.046 |
| 2 | `dCount` | COUNT | 0.006 ✗ | -0.021 ✗ | -0.033 |
...
|---|---|---|---|---|---|
| 1 | `dCount` | -0.094 | 0.790 | 49.3% | meaningful |
| 2 | `dSumRankNorm` | -0.192 | 0.782 | 48.8% | meaningful |
...
|---|---|---|---|---|
| `dCount` | 1.000 | +0.013 | +0.695 | +0.013 |
| `dHcSizeRatio` | +0.013 | 1.000 | -0.020 | +1.000 ⚠ |
| `dSumRankNorm` | +0.695 | -0.020 | 1.000 | -0.020 |
| `dWinnerCtPreA` | +0.013 | +1.000 ⚠ | -0.020 | 1.000 |
...
**Baseline (full 6-feature AGS):** Spearman ρ(AGS, flat ROI) = **-0.014**. At AGS ≥ +0.12 fires N=337, WR=51.6%, ROI=-3.8%. At AGS ≥ +null fires N=437, WR=51.8%, ROI=-3.5%.

| Feature dropped | ρ(5-feat AGS, ROI) | ρ drop vs full | Top-337 ROI (matched cohort) | Top-337 lift loss vs baseline | Same-threshold ≥+5 cell |
|---|---|---|---|---|---|
| `dCount` | +0.052 | +0.038 | WR=55%, ROI=+5.5% | -9.4pp | N=389, WR=54%, ROI=+2.4% |
| `dHcSizeRatio` | +0.026 | +0.012 | WR=54%, ROI=+0.1% | -3.9pp | N=360, WR=53%, ROI=-0.4% |
| `dSumRankNorm` | -0.043 | +0.030 | WR=48%, ROI=-10.2% | +6.3pp | N=303, WR=49%, ROI=-7.9% |
| `dWinnerCtPreA` | +0.027 | +0.014 | WR=53%, ROI=-1.9% | -2.0pp | N=350, WR=53%, ROI=-0.9% |
...
|---|---|---|---|---|
| 1 | `dHcSizeRatio` | +0.012 | -3.9pp | redundant — other features cover it |
| 2 | `dWinnerCtPreA` | +0.014 | -2.0pp | redundant — other features cover it |
| 3 | `dSumRankNorm` | +0.030 | +6.3pp | redundant — other features cover it |
| 4 | `dCount` | +0.038 | -9.4pp | redundant — other features cover it |
...
|---|---|---|---|---|---|
| 1 | `dSumRankNorm` | QUALITY_RANK | -0.100 | 0.100 | negative ↓ |
| 2 | `dCount` | COUNT | +0.051 | 0.051 | positive ↑ |
| 3 | `dWinnerCtPreA` | QUALITY_TRACK | +0.025 | 0.025 | flat ≈ 0 |
| 4 | `dHcSizeRatio` | INTENSITY_HC | +0.010 | 0.010 | flat ≈ 0 |

Intercept b = +0.005 · Final log-loss = 0.6918 · N = 735.
...
- **In-sample calibration source**: `cron` (used as cold-start fallback for the first 34 of 735 PIT rows where prior history was thin). Live calibration is loaded; the means/SDs above are this morning's.
- **Look-ahead controls**: PIT proven gate (strict-prior-events tier lens) + walk-forward feature calibration (mean/SD per feature recomputed at each pick date from prior picks only, 34/735 cold-started). Production thresholds (+5/+3/-1) were tuned on overlapping data and are still treated as fixed constants here — the §AGS-0a leakage audit shows the true lift those thresholds deliver out-of-sample.
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 5.0★ | 232 | 113-119-0 | 48.7% [42–55] | -10.3% | -98.1u | -1.66 ~ p<.10 |
| 4.5★ | 141 | 80-59-2 | 57.6% [49–65] | +8.5% | -2.5u | 1.05 ✗ noise |
| 4.0★ | 153 | 70-81-2 | 46.4% [39–54] | -10.6% | -17.1u | -1.34 ✗ noise |
| 3.5★ | 38 | 19-19-0 | 50.0% [35–65] | +8.8% | +3.8u | 0.43 ✗ noise |
| 3.0★ | 100 | 52-45-3 | 53.6% [44–63] | +3.6% | -1.3u | 0.37 ✗ noise |
...
|---|---|---|---|---|---|---|
| Δw ≤ 0 | 40/57%/+3% | 41/54%/+2% | 35/32%/-36% | 6/33%/-26% | 35/39%/-25% | 48/53%/+3% |
| Δw = +1 | 58/55%/+1% | 61/56%/+4% | 75/47%/-9% | 28/54%/+4% | 39/62%/+19% | 35/54%/+1% |
| Δw = +2 | 64/44%/-16% | 18/50%/-7% | 36/58%/+12% | — | 16/53%/+3% | 10/40%/-14% |
| Δw ≥ +3 | 68/41%/-24% | 18/78%/+52% | 7/43%/-21% | 3/67%/+156% | 10/70%/+46% | 8/38%/-21% |
...
| −200/−151 | 82 | 46-36-0 | 56.1% [45–66] | -10.8% | -31.7u | -1.23 ✗ noise |
| −150/−101 | 456 | 232-219-5 | 51.4% [47–56] | -3.4% | -49.9u | -0.77 ✗ noise |
| −100/+100 | 10 | 6-4-0 | 60.0% [31–83] | +20.0% | +4.3u | 0.61 ✗ noise |
| +101/+150 | 151 | 65-83-3 | 43.9% [36–52] | -3.9% | -61.5u | -0.44 ✗ noise |
...
| −200/−151 | -24% (25) | -1% (32) | +30% (11) | -50% (13) |
| −150/−101 | -8% (117) | +2% (187) | -15% (85) | +3% (64) |
| −100/+100 | -100% (2) | +67% (6) | -100% (1) | +100% (1) |
| +101/+150 | -5% (44) | -4% (52) | +1% (35) | -10% (20) |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| ML | 403 | 202-200-1 | 50.2% [45–55] | -4.1% | -79.8u | -0.82 ✗ noise |
| SPREAD | 129 | 64-63-2 | 50.4% [42–59] | -5.9% | -20.2u | -0.71 ✗ noise |
| TOTAL | 235 | 121-109-5 | 52.6% [46–59] | +1.4% | -23.7u | 0.22 ✗ noise |

### §7b. Market × Δw cohort

| Market | Δw ≤ 0 | Δw = +1 | Δw = +2 | Δw ≥ +3 |
|---|---|---|---|---|
| ML | N=109 · 45% · -15% | N=144 · 55% · +2% | N=75 · 52% · +2% | N=72 · 46% · -7% |
| SPREAD | N=36 · 37% · -30% | N=55 · 57% · +8% | N=21 · 62% · +11% | N=16 · 38% · -27% |
| TOTAL | N=61 · 59% · +13% | N=98 · 51% · -2% | N=48 · 38% · -25% | N=26 · 69% · +33% |
...
| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| MLB | 587 | 302-280-5 | 51.9% [48–56] | -2.0% | -92.3u | -0.50 ✗ noise |
...
|---|---|---|---|---|
| MLB | N=166 · 50% · -6% | N=254 · 54% · +2% | N=108 · 50% · -4% | N=58 · 52% · -3% |
...
|---|---|---|
| **sharps3Plus** | 276 · 47% · -8.5% · -1.38 ✗ noise | 490 · 53% · +0.2% · 0.05 ✗ noise |
| **plusEV** | 76 · 49% · -4.6% · -0.36 ✗ noise | 690 · 51% · -2.7% · -0.74 ✗ noise |
| **pinnacleConfirms** | 172 · 54% · +3.0% · 0.38 ✗ noise | 420 · 49% · -6.6% · -1.39 ✗ noise |
| **invested10kPlus** | 349 · 51% · -2.9% · -0.54 ✗ noise | 243 · 50% · -5.1% · -0.81 ✗ noise |
| **lineMovingWith** | 328 · 55% · +4.5% · 0.82 ✗ noise | 438 · 48% · -8.4% · -1.81 ~ p<.10 |
| **predMarketAligns** | 186 · 53% · -0.7% · -0.10 ✗ noise | 406 · 50% · -5.2% · -1.07 ✗ noise |

### §9b. Total criteria met (0–6)

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| 0 | 252 | 127-125-0 | 50.4% [44–57] | -3.2% | -68.8u | -0.53 ✗ noise |
| 1 | 152 | 74-73-5 | 50.3% [42–58] | -4.1% | -31.1u | -0.52 ✗ noise |
| 2 | 163 | 83-77-3 | 51.9% [44–59] | -1.0% | +0.5u | -0.13 ✗ noise |
| 3 | 61 | 31-30-0 | 50.8% [39–63] | -4.4% | -8.9u | -0.35 ✗ noise |
| 4 | 64 | 34-30-0 | 53.1% [41–65] | -3.0% | -8.9u | -0.25 ✗ noise |
...
| NEAR_START | 295 | 142-148-5 | 49.0% [43–55] | -5.5% | -66.5u | -0.94 ✗ noise |
| NO_MOVE | 22 | 11-11-0 | 50.0% [31–69] | -8.3% | +5.7u | -0.41 ✗ noise |
| PREGAME | 179 | 93-86-0 | 52.0% [45–59] | -0.5% | -50.3u | -0.07 ✗ noise |
| SMALL_MOVE | 155 | 77-76-2 | 50.3% [42–58] | -4.5% | -16.2u | -0.58 ✗ noise |

### §9d. Consensus grade

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| DOMINANT | 436 | 223-210-3 | 51.5% [47–56] | -3.5% | -117.1u | -0.78 ✗ noise |
| STRONG | 109 | 55-52-2 | 51.4% [42–61] | +0.2% | +0.1u | 0.02 ✗ noise |
| LEAN | 211 | 104-104-3 | 50.0% [43–57] | -2.3% | -4.6u | -0.32 ✗ noise |
| CONTESTED | 10 | 4-6-0 | 40.0% [17–69] | -22.2% | -3.7u | -0.69 ✗ noise |

### §9e. Continuous criteria — correlation with WIN / flat ROI

| Predictor | ρ(·, WIN) | ρ(·, flat ROI) | Spearman ρ | t-stat |
|---|---|---|---|---|
| sharpCount | -0.081 ✓ p<.05 | -0.064 ~ p<.10 | -0.053 | -1.77 |
| totalInvested | -0.063 ~ p<.10 | -0.073 ✓ p<.05 | -0.018 | -2.02 |
| evEdge | 0.085 ✓ p<.05 | 0.104 ✓ p<.01 | 0.040 | 2.90 |
| moneyPct | 0.040 ✗ | 0.012 ✗ | -0.006 | 0.34 |
| walletPct | 0.033 ✗ | 0.017 ✗ | 0.011 | 0.47 |
| criteriaMet | 0.010 ✗ | 0.009 ✗ | -0.025 | 0.25 |
| maxContribFor | -0.013 ✗ | 0.000 ✗ | 0.019 | 0.00 |
| meanBaseFor | -0.002 ✗ | 0.022 ✗ | 0.040 | 0.60 |
...
Sample with CLV: **752** picks. Mean CLV = **-0.0042**.
t-statistic vs zero: -3.74 → ✓ p<.01 · 95% CI [-0.0064, -0.0020]

Bucketed CLV vs flat PnL:

| Bucket | N | W-L-P | WR % [95% Wilson] | Flat ROI | Peak PnL | Flat t-stat |
|---|---|---|---|---|---|---|
| CLV ≤ −2% | 82 | 39-42-1 | 48.1% [38–59] | -12.3% | -19.1u | -1.21 ✗ noise |
| CLV (−2%, 0] | 444 | 223-215-6 | 50.9% [46–56] | -3.3% | -65.8u | -0.73 ✗ noise |
| CLV (0, +2%] | 192 | 102-90-0 | 53.1% [46–60] | +4.9% | -27.6u | 0.66 ✗ noise |
| CLV > +2% | 34 | 17-16-1 | 51.5% [35–67] | -4.3% | -1.5u | -0.26 ✗ noise |
...
Trained on N=554 (with all features non-null). Intercept β₀ = 0.115.

| Rank | Feature | β (z-scaled) | Direction |
|---|---|---|---|
| 1 | sharpCount | -0.303 | ↓ hurts |
| 2 | pw.ΔAvgRoi | +0.265 | ↑ helps |
| 3 | pw.Δcount | +0.215 | ↑ helps |
| 4 | evEdge | +0.179 | ↑ helps |
| 5 | log(impliedProb) | +0.149 | ↑ helps |
| 6 | pw.ΔFlatPnl | +0.146 | ↑ helps |
| 7 | peak.stars | -0.109 | ↓ hurts |
| 8 | HC margin | +0.103 | ↑ helps |
| 9 | pw.ΔTopQShare | +0.101 | ↑ helps |
| 10 | vault.star | +0.093 | ↑ helps |
| 11 | Δw | -0.058 | ↓ hurts |
| 12 | criteriaMet | +0.054 | ↑ helps |
| 13 | moneyPct | -0.047 | ≈ flat |
| 14 | odds (American) | -0.046 | ≈ flat |
| 15 | log10(invested) | +0.031 | ≈ flat |
| 16 | pw.ΔWlNet | +0.029 | ≈ flat |
| 17 | walletPct | +0.019 | ≈ flat |
| 18 | Δw + HC | +0.002 | ≈ flat |
...
| Tier-1b HC = +1 (post-cutover) | 170 | 98-72 | 57.6% | 57.2% | -110 | 5.08% bankroll | 2.05u | **UNDER-SIZED** — ship up to 5.08u (1u=1% bankroll) |
| Tier-2 HC ≤ 0 ∧ Δw ≥ +2 (HC era) | 101 | 45-55 | 45.0% | 45.5% | -110 | — (mute) | 2.06u | **MUTE** (negative EV at posterior) |
| Δw ≥ +3 (full sample) | 114 | 57-57 | 50.0% | 50.0% | -110 | — (mute) | 2.48u | **MUTE** (negative EV at posterior) |
| Stale Δw = 0 | 164 | 82-79 | 50.9% | 50.9% | -110 | — (mute) | 1.86u | **MUTE** (negative EV at posterior) |
...
| 2026-06-22 | 15 | 8-7 | -8.1u | -123.7u |

**Peak cum PnL:** +7.1u
**Max drawdown:** -130.8u
**Longest losing-day streak:** 4
**Longest winning-day streak:** 5
**Daily Sharpe-like (μ/σ):** -0.275  (annualized × √252 ≈ -4.37)
...
| 2026-04-19 | MLB | ML | away | 2.5 | 1.00 | +100 | 0 | — | — | 0 | 29 | 1.00 | L | -1.0u |
...
| 2026-04-23 | MLB | ML | home | 3.0 | 1.00 | -155 | 0 | — | — | 1 | 31 | 0.30 | L | -1.0u |
...
| 2026-04-26 | MLB | ML | away | 3.5 | 0.75 | +108 | 1 | — | — | 2 | 7 | 0.50 | L | -0.8u |
| 2026-04-26 | MLB | TOTAL | over | 3.5 | 0.50 | -116 | 1 | — | — | -1 | 19 | 0.00 | L | -0.5u |
| 2026-04-26 | MLB | ML | home | 3.5 | 0.75 | -110 | 1 | — | — | 2 | 26 | -1.40 | L | -0.8u |
| 2026-04-26 | MLB | ML | away | 5.0 | 2.00 | +100 | 2 | — | — | 1 | -5 | 0.00 | L | -2.0u |
| 2026-04-26 | MLB | TOTAL | over | 4.0 | 0.75 | -102 | 1 | — | — | 2 | -7 | 0.00 | W | +0.7u |
...
| 2026-04-27 | MLB | ML | home | 5.0 | 2.00 | +140 | 2 | — | — | 0 | -32 | -0.50 | L | -2.0u |
...
| 2026-04-28 | MLB | ML | home | 3.5 | 0.75 | -118 | 1 | — | — | 1 | 12 | -0.80 | W | +0.6u |
...
| 2026-04-29 | MLB | ML | home | 3.5 | 0.50 | -108 | 1 | — | — | 1 | 31 | 0.50 | L | -0.5u |
...
| 2026-05-03 | MLB | ML | away | 2.8 | 0.75 | -130 | 1 | 1 | 2 | -1 | -31 | -1.00 | W | +0.6u |
...
| 2026-05-11 | MLB | ML | away | 3.5 | 1.13 | -101 | 1 | 1 | 2 | 2 | -26 | 0.00 | W | +1.1u |
...
| 2026-05-12 | MLB | ML | away | 5.0 | 4.50 | +108 | 4 | 0 | 4 | 2 | 12 | -0.20 | L | -4.5u |
| 2026-05-12 | MLB | TOTAL | under | 4.0 | 0.64 | -110 | 2 | 1 | 3 | 2 | -6 | 0.00 | L | -0.6u |
| 2026-05-12 | MLB | ML | away | 4.5 | 3.00 | +129 | 3 | 0 | 3 | 1 | 31 | -1.00 | L | -3.0u |
...
| 2026-05-13 | MLB | TOTAL | under | 5.0 | 3.50 | -110 | 4 | 2 | 6 | 5 | -20 | 0.00 | L | -3.5u |
...
| 2026-05-14 | MLB | ML | home | 4.0 | 1.25 | +108 | 2 | 0 | 2 | 2 | 12 | -0.90 | L | -1.3u |
...
| 2026-05-15 | MLB | ML | away | 4.0 | 2.75 | -211 | 2 | 1 | 3 | 1 | 31 | -0.90 | W | +1.3u |
| 2026-05-15 | MLB | ML | away | 3.0 | 1.25 | +115 | 0 | 1 | 1 | -1 | -31 | -1.10 | L | -1.3u |
...
| 2026-05-16 | MLB | ML | away | 5.0 | 4.50 | +124 | 3 | 1 | 4 | 4 | -32 | -1.30 | W | +1.4u |
...
| 2026-05-16 | MLB | TOTAL | over | 4.0 | 1.65 | -110 | 2 | 0 | 2 | 2 | -23 | 0.00 | L | -1.6u |
| 2026-05-16 | MLB | ML | away | 2.5 | 0.50 | -102 | 1 | 0 | 1 | 1 | -41 | 0.00 | W | +0.5u |
| 2026-05-17 | MLB | ML | away | 4.0 | 2.75 | -148 | 1 | 0 | 1 | 2 | 12 | -0.70 | W | +1.9u |
| 2026-05-17 | MLB | ML | away | 2.5 | 0.50 | +139 | 0 | 1 | 1 | 0 | -50 | 0.70 | L | -0.5u |
...
| 2026-05-18 | MLB | ML | home | 4.5 | 5.00 | -111 | 2 | 1 | 3 | 2 | 12 | -1.10 | W | +4.4u |
| 2026-05-18 | MLB | ML | away | 4.0 | 2.50 | +120 | 2 | 0 | 2 | 1 | -19 | -2.10 | L | -2.5u |
| 2026-05-18 | MLB | ML | home | 3.0 | 1.25 | -118 | 2 | 0 | 2 | 1 | -19 | 1.00 | W | +1.1u |
| 2026-05-18 | MLB | ML | home | 4.0 | 2.75 | -150 | 2 | 0 | 2 | 1 | 31 | -0.80 | L | -2.8u |
| 2026-05-18 | MLB | ML | home | 3.0 | 1.25 | +132 | 2 | 0 | 2 | 2 | -8 | 0.40 | W | +1.6u |
...
| 2026-05-19 | MLB | ML | home | 5.0 | 2.50 | +118 | 1 | 1 | 2 | 1 | -27 | -1.30 | L | -2.5u |
| 2026-05-19 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 2 | 0 | 2 | 1 | 0 | 0.00 | W | +1.5u |
| 2026-05-19 | MLB | ML | home | 2.5 | 2.50 | +105 | 1 | 1 | 2 | 2 | -26 | -0.90 | L | -2.5u |
...
| 2026-05-20 | MLB | ML | home | 4.0 | 2.75 | -154 | 2 | 0 | 2 | 1 | 31 | -1.50 | W | +1.9u |
| 2026-05-20 | MLB | TOTAL | under | 4.0 | 0.75 | -110 | 2 | 0 | 2 | 1 | -19 | 0.00 | L | -0.8u |
| 2026-05-20 | MLB | ML | home | 2.5 | 0.50 | -140 | 1 | 1 | 2 | 1 | -19 | -1.10 | W | +0.9u |
| 2026-05-20 | MLB | ML | home | 2.5 | 0.50 | +111 | 0 | 1 | 1 | -1 | -31 | 0.00 | W | +0.6u |
| 2026-05-20 | MLB | ML | away | 4.0 | 2.75 | +113 | 1 | 1 | 2 | 0 | -50 | -1.00 | L | -2.8u |
...
| 2026-05-21 | MLB | ML | home | 5.0 | 2.50 | +125 | 1 | 1 | 2 | 2 | -26 | -0.40 | L | -2.5u |
...
| 2026-05-21 | MLB | TOTAL | under | 2.5 | 0.30 | -110 | 0 | 0 | 0 | 2 | -16 | 0.00 | W | +0.3u |
| 2026-05-21 | MLB | ML | home | 3.0 | 1.25 | -116 | 3 | 1 | 4 | 2 | -25 | -0.40 | L | -1.3u |
| 2026-05-21 | MLB | ML | away | 3.0 | 1.25 | +129 | 1 | 0 | 1 | 3 | -57 | -0.40 | W | +1.6u |
...
| 2026-05-22 | MLB | ML | home | 5.0 | 1.25 | -175 | 1 | 0 | 1 | 1 | 31 | -0.90 | L | -1.3u |
| 2026-05-22 | MLB | ML | home | 4.0 | 1.25 | -195 | 3 | 0 | 3 | 0 | 0 | 0.80 | L | -1.3u |
| 2026-05-22 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | -1 | 4 | 0.00 | W | +0.7u |
| 2026-05-22 | MLB | ML | home | 3.0 | 1.25 | -137 | 1 | 0 | 1 | 0 | -19 | 0.00 | L | -1.3u |
| 2026-05-22 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 0 | 0 | 0.00 | L | -0.8u |
| 2026-05-22 | MLB | ML | home | 5.0 | 5.00 | -144 | 4 | 2 | 6 | 2 | 12 | -1.60 | L | -5.0u |
| 2026-05-22 | MLB | SPREAD | home | 5.0 | 0.75 | -155 | 2 | 0 | 2 | 1 | -19 | -0.30 | W | +0.4u |
| 2026-05-22 | MLB | ML | home | 5.0 | 2.75 | -158 | 1 | 0 | 1 | 1 | 31 | -0.80 | W | +1.7u |
| 2026-05-22 | MLB | SPREAD | home | 3.0 | 0.75 | -142 | 1 | 0 | 1 | 1 | -19 | -2.00 | L | -0.8u |
| 2026-05-22 | MLB | ML | home | 5.0 | 5.00 | -145 | 2 | 2 | 4 | 1 | 31 | -2.20 | L | -5.0u |
| 2026-05-22 | MLB | ML | home | 2.5 | 0.50 | +139 | 2 | 1 | 3 | 0 | -37 | -0.90 | W | +0.7u |
| 2026-05-22 | MLB | SPREAD | home | 4.0 | 1.65 | -119 | 1 | 1 | 2 | 1 | -19 | -1.20 | W | +1.3u |
| 2026-05-22 | MLB | ML | away | 5.0 | 1.50 | +185 | 3 | 0 | 3 | 2 | -26 | -1.10 | L | -1.5u |
...
| 2026-05-23 | MLB | ML | home | 2.5 | 0.50 | -181 | 1 | 0 | 1 | 2 | 40 | -1.70 | W | +0.3u |
| 2026-05-23 | MLB | ML | away | 2.5 | 2.75 | +109 | 2 | 0 | 2 | 2 | -8 | -0.50 | L | -2.8u |
| 2026-05-23 | MLB | TOTAL | over | 2.5 | 0.30 | -110 | 0 | 1 | 1 | 0 | -27 | 0.00 | W | +0.3u |
| 2026-05-23 | MLB | ML | home | 5.0 | 1.00 | -148 | 0 | 0 | 0 | 1 | -17 | -0.20 | L | -1.0u |
| 2026-05-23 | MLB | SPREAD | away | 3.0 | 0.75 | -163 | 1 | 0 | 1 | 1 | -19 | 0.00 | W | +0.5u |
| 2026-05-23 | MLB | TOTAL | under | 5.0 | 3.00 | -110 | 3 | 1 | 4 | 3 | -23 | 0.00 | W | +2.7u |
| 2026-05-23 | MLB | SPREAD | home | 3.0 | 0.75 | -163 | 0 | 0 | 0 | 1 | 9 | -0.90 | L | -0.8u |
| 2026-05-23 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 2 | 1 | 3 | 2 | -23 | 0.00 | L | -0.8u |
...
| 2026-05-24 | MLB | ML | home | 3.0 | 1.25 | -189 | 1 | 0 | 1 | 1 | 31 | 0.00 | W | +0.7u |
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 0.75 | -110 | 1 | 0 | 1 | 2 | -3 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | TOTAL | under | 4.0 | 1.65 | -110 | 1 | 1 | 2 | 0 | -28 | 0.00 | L | -1.6u |
...
| 2026-05-24 | MLB | ML | home | 3.0 | 1.25 | -107 | 1 | 0 | 1 | 1 | 12 | 0.00 | W | +1.2u |
...
| 2026-05-24 | MLB | TOTAL | over | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 2 | -8 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | SPREAD | home | 3.0 | 0.75 | +134 | 1 | 0 | 1 | 1 | -2 | 0.00 | L | -0.8u |
| 2026-05-24 | MLB | TOTAL | under | 3.0 | 0.75 | -110 | 1 | 0 | 1 | 0 | -30 | 0.00 | W | +0.7u |
...
| 2026-05-25 | MLB | ML | home | 5.0 | 5.00 | -310 | 2 | 0 | 2 | 2 | 33 | -1.20 | W | +1.6u |
| 2026-05-25 | MLB | TOTAL | over | 4.0 | 1.65 | +103 | 1 | 0 | 1 | 2 | 19 | 0.00 | L | -1.6u |
| 2026-05-25 | MLB | ML | home | 4.0 | 1.25 | -125 | 1 | -1 | 0 | 1 | -2 | -1.90 | L | -1.3u |
| 2026-05-25 | MLB | SPREAD | away | 4.0 | 1.65 | -184 | 1 | 0 | 1 | 1 | -6 | 28.40 | W | +2.4u |
| 2026-05-25 | MLB | TOTAL | under | 5.0 | 2.25 | -112 | 4 | 0 | 4 | 4 | 2 | 0.00 | L | -2.3u |
| 2026-05-25 | MLB | ML | home | 5.0 | 1.25 | -160 | 3 | 0 | 3 | 2 | -36 | -1.10 | L | -1.3u |
| 2026-05-25 | MLB | TOTAL | over | 5.0 | 3.00 | -110 | 3 | 0 | 3 | 3 | 26 | 0.00 | W | +2.5u |
...
| 2026-05-26 | MLB | ML | away | 5.0 | 1.50 | +200 | 2 | 0 | 2 | 2 | -26 | -1.00 | L | -1.5u |
| 2026-05-26 | MLB | SPREAD | away | 5.0 | 1.00 | -101 | 2 | 1 | 3 | 2 | -10 | 0.50 | L | -1.0u |
| 2026-05-26 | MLB | ML | away | 2.5 | 1.25 | +113 | 0 | 0 | 0 | 0 | 22 | -1.50 | W | +1.4u |
| 2026-05-26 | MLB | ML | home | 2.5 | 1.25 | -130 | 1 | 0 | 1 | 0 | 22 | -1.30 | W | +1.0u |
| 2026-05-26 | MLB | ML | away | 5.0 | 5.00 | -200 | 1 | 0 | 1 | 2 | 40 | -0.60 | W | +1.9u |
| 2026-05-26 | MLB | SPREAD | home | 4.0 | 1.00 | +105 | 1 | 0 | 1 | 2 | 19 | -0.20 | L | -1.0u |
| 2026-05-26 | MLB | ML | away | 5.0 | 5.00 | -102 | 3 | 1 | 4 | 3 | -23 | -0.50 | W | +4.9u |
| 2026-05-26 | MLB | ML | home | 5.0 | 3.75 | -108 | 3 | 1 | 4 | 3 | 3 | -0.20 | L | -3.8u |
| 2026-05-26 | MLB | ML | home | 5.0 | 5.00 | -105 | 2 | 1 | 3 | 2 | 40 | -2.00 | W | +3.6u |
| 2026-05-26 | MLB | ML | away | 5.0 | 2.50 | +116 | 1 | 0 | 1 | 2 | 40 | -1.00 | W | +2.9u |
...
| 2026-05-27 | MLB | ML | home | 4.5 | 0.50 | -102 | 3 | 1 | 4 | 3 | 24 | -1.10 | W | +0.4u |
...
| 2026-05-27 | MLB | ML | home | 4.5 | 3.75 | -420 | 1 | 1 | 2 | 1 | 31 | -0.50 | W | +0.7u |
| 2026-05-27 | MLB | ML | home | 3.0 | 1.25 | -144 | -1 | -1 | -2 | 0 | -11 | -1.00 | L | -1.3u |
| 2026-05-27 | MLB | ML | away | 5.0 | 0.50 | -102 | 3 | 0 | 3 | 2 | 0 | -1.00 | L | -0.5u |
...
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 1.65 | +104 | 2 | 0 | 2 | 2 | 19 | 0.00 | W | +1.7u |
| 2026-05-27 | MLB | TOTAL | under | 4.0 | 0.75 | +104 | 2 | 0 | 2 | 2 | 21 | 0.00 | W | +0.8u |
| 2026-05-27 | MLB | ML | away | 5.0 | 2.50 | +128 | 3 | 2 | 5 | 3 | 3 | -0.30 | L | -2.5u |
| 2026-05-27 | MLB | SPREAD | away | 4.5 | 1.65 | -145 | 1 | 1 | 2 | 1 | 9 | -0.30 | W | +1.1u |
| 2026-05-27 | MLB | ML | away | 5.0 | 5.00 | -126 | 2 | 0 | 2 | 2 | 2 | -4.10 | L | -5.0u |
| 2026-05-27 | MLB | ML | home | 4.0 | 1.25 | -190 | 1 | 0 | 1 | 1 | 31 | -0.70 | W | +0.7u |
...
| 2026-05-28 | MLB | TOTAL | over | 5.0 | 3.00 | +101 | 3 | -1 | 2 | 3 | 45 | 0.00 | W | +2.5u |
...
| 2026-05-29 | MLB | ML | home | 5.0 | 2.50 | +118 | 5 | 1 | 6 | 5 | 24 | -0.90 | L | -2.5u |
| 2026-05-29 | MLB | SPREAD | home | 5.0 | 0.75 | -135 | 2 | 0 | 2 | 1 | -33 | 1.00 | L | -0.8u |
| 2026-05-29 | MLB | ML | home | 5.0 | 3.75 | -124 | 2 | 1 | 3 | 3 | 21 | -1.00 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 1.65 | -106 | 2 | 0 | 2 | 3 | 21 | 0.00 | L | -1.6u |
| 2026-05-29 | MLB | ML | home | 4.0 | 2.50 | +120 | 1 | 0 | 1 | 1 | -7 | 0.40 | W | +3.0u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 2.25 | -112 | 2 | 0 | 2 | 3 | 43 | 0.00 | W | +2.0u |
...
| 2026-05-29 | MLB | ML | away | 4.5 | 1.25 | -142 | 0 | 1 | 1 | -1 | 16 | -1.20 | W | +0.3u |
...
| 2026-05-29 | MLB | TOTAL | over | 4.0 | 0.75 | -109 | 1 | 0 | 1 | 2 | 21 | 0.00 | W | +0.7u |
| 2026-05-29 | MLB | ML | home | 5.0 | 2.75 | -106 | 2 | 1 | 3 | 2 | 32 | 0.70 | L | -2.8u |
| 2026-05-29 | MLB | SPREAD | home | 4.0 | 1.65 | -175 | 0 | 0 | 0 | 2 | -10 | -0.80 | L | -1.6u |
| 2026-05-29 | MLB | TOTAL | over | 4.5 | 0.30 | +105 | 2 | 1 | 3 | 1 | 1 | 0.00 | W | +0.3u |
...
| 2026-05-30 | MLB | TOTAL | over | 4.5 | 0.75 | +100 | 1 | 1 | 2 | 1 | -5 | 0.00 | W | +0.8u |
| 2026-05-30 | MLB | ML | home | 4.0 | 2.75 | -130 | 0 | 1 | 1 | 0 | 22 | -1.60 | W | +0.4u |
| 2026-05-30 | MLB | TOTAL | over | 4.0 | 2.25 | -116 | 2 | 0 | 2 | 2 | 20 | 0.00 | W | +1.9u |
| 2026-05-30 | MLB | TOTAL | under | 4.0 | 1.65 | -107 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -1.6u |
...
| 2026-05-30 | MLB | ML | home | 5.0 | 1.25 | -102 | 2 | 0 | 2 | 2 | 12 | -0.70 | W | +1.2u |
...
| 2026-05-31 | MLB | TOTAL | under | 5.0 | 1.65 | -114 | 2 | 0 | 2 | 3 | 2 | 0.00 | L | -1.6u |
| 2026-05-31 | MLB | ML | home | 2.5 | 2.75 | -115 | 1 | 1 | 2 | 1 | 38 | 0.00 | W | +2.4u |
| 2026-05-31 | MLB | ML | away | 5.0 | 1.00 | +115 | -1 | 0 | -1 | 2 | -8 | -0.60 | L | -1.0u |
| 2026-05-31 | MLB | SPREAD | away | 5.0 | 1.00 | -117 | 3 | 1 | 4 | 3 | 0 | -0.20 | L | -1.0u |
| 2026-05-31 | MLB | ML | home | 5.0 | 5.00 | -164 | 0 | 1 | 1 | 2 | -8 | -1.20 | W | +2.3u |
| 2026-05-31 | MLB | ML | away | 3.0 | 1.25 | -184 | 0 | 0 | 0 | 0 | -26 | -1.70 | W | +0.7u |
| 2026-05-31 | MLB | ML | home | 2.5 | 1.25 | -232 | 0 | 0 | 0 | 1 | 47 | -0.50 | W | +0.5u |
...
| 2026-06-01 | MLB | ML | home | 4.5 | 3.00 | -155 | 3 | 2 | 5 | 3 | 40 | -1.00 | W | +2.1u |
| 2026-06-01 | MLB | ML | away | 4.0 | 1.00 | +135 | 2 | 2 | 4 | 3 | 50 | -0.20 | W | +1.4u |
| 2026-06-01 | MLB | ML | away | 5.0 | 2.50 | +160 | 2 | -1 | 1 | 2 | 27 | -1.30 | W | +2.7u |
| 2026-06-01 | MLB | TOTAL | under | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 2 | -12 | 0.00 | L | -1.0u |
| 2026-06-01 | MLB | ML | home | 3.0 | 0.50 | -142 | -1 | 0 | -1 | -1 | 21 | -0.40 | L | -0.5u |
...
| 2026-06-02 | MLB | ML | away | 3.0 | 0.50 | +100 | 1 | 0 | 1 | 2 | 40 | -1.20 | W | +0.5u |
...
| 2026-06-02 | MLB | ML | home | 4.0 | 1.00 | -112 | 1 | 0 | 1 | 1 | 31 | -1.10 | L | -1.0u |
| 2026-06-02 | MLB | ML | home | 4.0 | 1.00 | -106 | 1 | 0 | 1 | 1 | 31 | -0.50 | L | -1.0u |
| 2026-06-02 | MLB | ML | away | 5.0 | 2.50 | +102 | 0 | -1 | -1 | 1 | -6 | 0.00 | L | -2.5u |
...
| 2026-06-03 | MLB | ML | home | 3.0 | 0.50 | -103 | 3 | 1 | 4 | 3 | 15 | -1.20 | L | -0.5u |
| 2026-06-03 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | -12 | 0.00 | L | -5.0u |
| 2026-06-03 | MLB | ML | away | 3.0 | 0.50 | +119 | 1 | 0 | 1 | 0 | 36 | 0.00 | W | +0.6u |
| 2026-06-03 | MLB | ML | away | 4.5 | 3.00 | -137 | 0 | 0 | 0 | -1 | 41 | -1.50 | L | -3.0u |
| 2026-06-03 | MLB | ML | home | 5.0 | 5.00 | -215 | 0 | 1 | 1 | 0 | 48 | -1.00 | W | +2.3u |
| 2026-06-03 | MLB | TOTAL | over | 2.5 | 0.25 | -110 | 1 | 1 | 2 | 1 | -19 | 0.00 | L | -0.3u |
| 2026-06-03 | MLB | TOTAL | under | 4.5 | 2.50 | -110 | 1 | 0 | 1 | 0 | 3 | 0.00 | W | +2.5u |
| 2026-06-03 | MLB | ML | home | 4.5 | 3.00 | -112 | 0 | 0 | 0 | 1 | 31 | -0.90 | W | +2.7u |
...
| 2026-06-04 | MLB | ML | away | 3.0 | 0.50 | +104 | 1 | 0 | 1 | 2 | 26 | 0.00 | W | +0.5u |
| 2026-06-04 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | -1 | 0 | 0 | 21 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | +102 | 0 | 0 | 0 | 1 | 31 | 0.00 | L | -1.0u |
| 2026-06-04 | MLB | ML | home | 5.0 | 2.50 | +118 | 1 | 1 | 2 | 1 | 64 | -0.40 | W | +3.0u |
| 2026-06-04 | MLB | SPREAD | away | 5.0 | 5.00 | -111 | 0 | 0 | 0 | 1 | 11 | 0.00 | L | -5.0u |
| 2026-06-04 | MLB | ML | home | 5.0 | 5.00 | -131 | 1 | 0 | 1 | 1 | 64 | 0.20 | W | +3.5u |
| 2026-06-04 | MLB | ML | away | 2.5 | 0.25 | +105 | 0 | 0 | 0 | 0 | -29 | -1.00 | W | +0.2u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -210 | 1 | 0 | 1 | 2 | 69 | -1.00 | W | +0.5u |
| 2026-06-04 | MLB | ML | home | 4.0 | 1.00 | -188 | 0 | 0 | 0 | 0 | 22 | -1.10 | L | -1.0u |
| 2026-06-04 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 0 | 21 | 0.00 | W | +2.7u |
| 2026-06-04 | MLB | ML | home | 3.0 | 0.50 | -235 | 4 | 0 | 4 | 4 | 28 | 0.00 | L | -0.5u |
| 2026-06-04 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 0 | 7 | 0.00 | L | -5.0u |
| 2026-06-04 | NHL | ML | home | 2.5 | 0.25 | -160 | -3 | 0 | -3 | 2 | 11 | -0.40 | W | +0.2u |
| 2026-06-05 | MLB | ML | home | 2.5 | 0.25 | -144 | 1 | 1 | 2 | 0 | 26 | -1.20 | L | -0.3u |
| 2026-06-05 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | -1 | 15 | 0.00 | W | +2.8u |
| 2026-06-05 | MLB | ML | away | 3.0 | 0.50 | +128 | 1 | 0 | 1 | 0 | 16 | 0.00 | W | +0.6u |
...
| 2026-06-05 | MLB | ML | home | 5.0 | 5.00 | -171 | 0 | 2 | 2 | 3 | 56 | -0.20 | W | +2.7u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -188 | 2 | 0 | 2 | 2 | 40 | -0.90 | W | +0.5u |
| 2026-06-05 | MLB | ML | away | 4.0 | 1.00 | -105 | 1 | 0 | 1 | 1 | 31 | 0.00 | L | -1.0u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -141 | 3 | 2 | 5 | 3 | 25 | 0.30 | W | +0.7u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 2.50 | -110 | 0 | 1 | 1 | -1 | 24 | 0.00 | W | +2.5u |
| 2026-06-05 | MLB | ML | home | 4.0 | 1.00 | -172 | 1 | 0 | 1 | 1 | 31 | 0.00 | L | -1.0u |
| 2026-06-05 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 0 | -1 | -1 | 0 | 3 | 0.00 | W | +4.4u |
| 2026-06-05 | MLB | ML | away | 4.5 | 3.00 | -129 | -1 | 1 | 0 | -2 | 24 | -1.10 | W | +2.2u |
| 2026-06-05 | MLB | SPREAD | away | 3.0 | 0.50 | +126 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.6u |
| 2026-06-05 | NBA | ML | home | 2.5 | 0.25 | -230 | 2 | 2 | 4 | 4 | 11 | 1.00 | L | -0.3u |
| 2026-06-05 | NBA | SPREAD | home | 2.5 | 0.25 | -106 | 3 | 0 | 3 | 0 | 4 | -0.70 | L | -0.3u |
| 2026-06-06 | MLB | TOTAL | over | 2.5 | 0.25 | -110 | 1 | 0 | 1 | 0 | 22 | 0.00 | W | +0.2u |
| 2026-06-06 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 0 | 2 | 0.00 | W | +2.7u |
| 2026-06-06 | MLB | ML | home | 4.5 | 3.00 | -126 | 0 | 0 | 0 | 0 | 22 | -1.00 | W | +2.4u |
| 2026-06-06 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -8 | 0.00 | W | +2.7u |
| 2026-06-06 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 1 | 1 | -1 | 5 | 0.00 | L | -1.0u |
| 2026-06-06 | MLB | ML | home | 3.0 | 0.50 | -130 | 0 | 0 | 0 | -1 | 20 | -0.90 | L | -0.5u |
...
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -130 | 1 | 0 | 1 | 0 | 48 | -0.90 | W | +2.2u |
| 2026-06-07 | MLB | TOTAL | over | 3.0 | 0.50 | -112 | 0 | 0 | 0 | 3 | 17 | 0.00 | L | -0.5u |
| 2026-06-07 | MLB | ML | home | 5.0 | 5.00 | -143 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +3.5u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | -8 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -136 | 1 | 0 | 1 | 0 | 48 | 0.00 | W | +0.7u |
| 2026-06-07 | MLB | ML | home | 4.5 | 3.00 | -165 | 2 | 2 | 4 | 3 | 23 | -1.10 | W | +1.8u |
| 2026-06-07 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 1 | 2 | 1 | -1 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | -107 | 1 | 0 | 1 | -1 | 44 | -0.80 | W | +0.2u |
| 2026-06-07 | MLB | TOTAL | over | 2.5 | 0.25 | -115 | 0 | 0 | 0 | -1 | -18 | 0.00 | W | +0.2u |
| 2026-06-07 | MLB | ML | home | 2.5 | 0.25 | -210 | -1 | 0 | -1 | 1 | 47 | 0.80 | L | -0.3u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -7 | 0.00 | L | -0.5u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | +158 | 1 | 0 | 1 | 3 | 23 | -1.30 | L | -0.5u |
| 2026-06-07 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 12 | 0.00 | W | +0.9u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -105 | 1 | 0 | 1 | 1 | 31 | 0.00 | L | -1.0u |
| 2026-06-07 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 10 | 0.00 | L | -5.0u |
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 3.00 | -152 | 2 | 0 | 2 | 1 | 22 | -0.50 | W | +1.9u |
| 2026-06-07 | MLB | TOTAL | over | 5.0 | 2.25 | -114 | 1 | 1 | 2 | 1 | -5 | 0.00 | L | -2.3u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | +102 | 1 | 0 | 1 | -2 | 0 | -0.20 | W | +0.5u |
| 2026-06-07 | MLB | SPREAD | away | 4.5 | 2.25 | +164 | 1 | 1 | 2 | 1 | 9 | 29.50 | W | +3.7u |
| 2026-06-07 | MLB | ML | away | 2.5 | 0.25 | +103 | -1 | 0 | -1 | -2 | -30 | 0.20 | W | +0.3u |
| 2026-06-07 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | -1 | 0 | 1 | 11 | 0.00 | L | -3.0u |
| 2026-06-07 | MLB | ML | home | 4.0 | 1.00 | -102 | 2 | 0 | 2 | 0 | 22 | 0.50 | W | +1.0u |
| 2026-06-07 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 4 | 0.00 | W | +4.8u |
| 2026-06-07 | MLB | ML | home | 3.0 | 0.50 | -127 | 0 | 1 | 1 | -1 | 44 | -1.90 | W | +0.4u |
| 2026-06-07 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | 1 | -7 | 0.00 | W | +0.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -113 | 6 | 1 | 7 | 6 | 58 | -0.50 | L | -3.0u |
| 2026-06-08 | MLB | ML | home | 4.5 | 3.00 | -129 | 3 | 0 | 3 | 2 | 52 | -0.40 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | -1 | 2 | 0.00 | L | -3.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -121 | 1 | 1 | 2 | 0 | 34 | -1.60 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 2 | 37 | 0.00 | P | +0.0u |
| 2026-06-08 | MLB | ML | away | 4.5 | 3.00 | -146 | 1 | 0 | 1 | 0 | 38 | -0.50 | W | +2.0u |
| 2026-06-08 | MLB | ML | home | 4.0 | 1.00 | -118 | 2 | 0 | 2 | 2 | -34 | -0.40 | L | -1.0u |
| 2026-06-08 | MLB | TOTAL | over | 4.5 | 2.50 | -116 | -2 | -2 | -4 | -2 | 21 | 0.00 | W | +2.5u |
| 2026-06-08 | MLB | ML | away | 4.5 | 1.50 | +151 | 0 | -1 | -1 | 0 | 15 | 0.00 | W | +2.3u |
| 2026-06-08 | MLB | TOTAL | under | 5.0 | 2.50 | +101 | 0 | 0 | 0 | -1 | -1 | 0.00 | W | +2.5u |
...
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | +132 | 1 | 0 | 1 | 3 | 38 | -1.20 | L | -0.3u |
| 2026-06-09 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 7 | 0.00 | W | +4.3u |
| 2026-06-09 | MLB | ML | away | 3.0 | 0.50 | -148 | 1 | 0 | 1 | 3 | 38 | 0.00 | L | -0.5u |
| 2026-06-09 | MLB | ML | away | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 4 | 48 | 0.80 | L | -1.0u |
| 2026-06-09 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 0 | 0 | 1 | 0 | 0.00 | L | -1.0u |
| 2026-06-09 | MLB | ML | away | 4.0 | 1.00 | -143 | 1 | 0 | 1 | 1 | 31 | 0.00 | L | -1.0u |
| 2026-06-09 | MLB | SPREAD | home | 4.5 | 3.00 | -117 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +2.6u |
| 2026-06-09 | MLB | TOTAL | under | 3.0 | 0.50 | -110 | 0 | 0 | 0 | -1 | 8 | 0.00 | W | +0.5u |
| 2026-06-09 | MLB | ML | away | 5.0 | 5.00 | -122 | 2 | 1 | 3 | 1 | 10 | 0.00 | W | +4.1u |
| 2026-06-09 | MLB | ML | away | 2.5 | 0.25 | -120 | 0 | 0 | 0 | 0 | 20 | 0.00 | L | -0.3u |
| 2026-06-09 | MLB | ML | home | 4.0 | 1.00 | -107 | 1 | 0 | 1 | 0 | 33 | -1.30 | L | -1.0u |
| 2026-06-09 | MLB | ML | home | 5.0 | 5.00 | -105 | 1 | -1 | 0 | 1 | -1 | 0.00 | W | +4.8u |
| 2026-06-09 | MLB | ML | away | 4.5 | 2.50 | +115 | 1 | 0 | 1 | 0 | 22 | -0.70 | L | -2.5u |
| 2026-06-09 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 0 | 11 | 0.00 | W | +2.7u |
| 2026-06-09 | MLB | ML | away | 3.0 | 0.50 | -116 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.4u |
| 2026-06-09 | MLB | ML | home | 5.0 | 2.50 | +100 | 4 | 2 | 6 | 0 | 0 | 0.00 | W | +2.5u |
| 2026-06-09 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 1 | 2 | 0 | 8 | 0.00 | W | +4.5u |
| 2026-06-09 | MLB | ML | home | 4.0 | 1.00 | +102 | 2 | 0 | 2 | 2 | -2 | -1.20 | L | -1.0u |
| 2026-06-09 | MLB | ML | away | 4.0 | 1.00 | -119 | 1 | 0 | 1 | 0 | 48 | -0.80 | L | -1.0u |
...
| 2026-06-10 | MLB | ML | away | 4.5 | 3.00 | -148 | 0 | 0 | 0 | 0 | 13 | -0.50 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | +136 | 3 | 0 | 3 | 5 | 52 | -1.10 | L | -1.0u |
| 2026-06-10 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 0 | 0 | 1 | 0 | 0.00 | W | +0.9u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | -172 | 1 | 0 | 1 | 2 | 28 | -1.00 | L | -1.0u |
| 2026-06-10 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 0 | 0 | 0 | 1 | -1 | 0.00 | W | +4.5u |
| 2026-06-10 | MLB | ML | away | 3.0 | 0.50 | +136 | 0 | 0 | 0 | -2 | 21 | 0.00 | L | -0.5u |
| 2026-06-10 | MLB | TOTAL | under | 4.0 | 1.00 | -113 | 1 | 0 | 1 | 1 | 9 | 0.00 | L | -1.0u |
| 2026-06-10 | MLB | ML | home | 2.5 | 0.25 | -117 | 0 | 0 | 0 | 1 | -14 | 0.00 | W | +0.2u |
| 2026-06-10 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 1 | -1 | 0.00 | L | -5.0u |
| 2026-06-10 | MLB | ML | home | 4.0 | 1.00 | +178 | 1 | 0 | 1 | -2 | 22 | -1.40 | W | +1.7u |
| 2026-06-10 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 3 | 0 | 3 | 0 | 0 | 0.00 | W | +4.5u |
| 2026-06-10 | MLB | ML | away | 5.0 | 5.00 | -104 | 0 | 0 | 0 | 1 | 11 | -0.20 | L | -5.0u |
...
| 2026-06-10 | MLB | ML | home | 4.0 | 1.00 | -127 | 1 | 0 | 1 | 1 | 31 | 0.00 | L | -1.0u |
| 2026-06-10 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 0 | 21 | 0.00 | W | +3.0u |
| 2026-06-10 | MLB | ML | away | 4.0 | 1.00 | -120 | 1 | 0 | 1 | 1 | 31 | -0.40 | W | +0.8u |
| 2026-06-10 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | -1 | 0 | -1 | 1 | 11 | 0.00 | L | -3.0u |
| 2026-06-10 | MLB | ML | away | 5.0 | 5.00 | -106 | 1 | 0 | 1 | -1 | 34 | -0.70 | L | -5.0u |
| 2026-06-10 | MLB | SPREAD | home | 2.5 | 1.00 | -190 | 0 | 0 | 0 | 0 | -15 | -31.40 | L | -1.0u |
| 2026-06-10 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 4 | 1 | 5 | -1 | -14 | 0.00 | L | -5.0u |
...
| 2026-06-11 | MLB | ML | home | 5.0 | 5.00 | — | 1 | 0 | 1 | 1 | -7 | 0.00 | L | -5.0u |
| 2026-06-11 | MLB | ML | away | 3.0 | 0.50 | -167 | 1 | -1 | 0 | 1 | 55 | -0.10 | W | +0.3u |
| 2026-06-11 | MLB | TOTAL | under | 5.0 | 1.00 | -108 | 1 | 1 | 2 | 0 | -14 | 0.00 | L | -1.0u |
| 2026-06-11 | MLB | ML | away | 5.0 | 1.00 | +110 | 3 | 1 | 4 | 3 | 23 | -0.90 | L | -1.0u |
| 2026-06-11 | MLB | ML | away | 3.0 | 0.50 | -111 | 1 | 0 | 1 | 1 | 31 | 0.00 | L | -0.5u |
| 2026-06-11 | MLB | ML | home | 5.0 | 5.00 | -131 | 2 | 1 | 3 | 0 | 0 | 0.00 | W | +3.8u |
| 2026-06-11 | MLB | ML | away | 4.0 | 1.00 | +100 | 1 | 0 | 1 | 1 | -34 | -0.50 | W | +1.0u |
| 2026-06-11 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | -1 | -1 | -2 | 0 | 15 | 0.00 | W | +0.2u |
| 2026-06-11 | NHL | TOTAL | under | 3.0 | 0.50 | -104 | 2 | 0 | 2 | 3 | 14 | 0.00 | P | +0.0u |
| 2026-06-12 | MLB | ML | home | 5.0 | 5.00 | -114 | 0 | 0 | 0 | 0 | 0 | 0.00 | W | +4.4u |
| 2026-06-12 | MLB | ML | home | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | -2 | 0.00 | L | -3.0u |
| 2026-06-12 | MLB | TOTAL | over | 4.0 | 1.00 | +100 | 0 | 0 | 0 | 0 | 3 | 0.00 | L | -1.0u |
| 2026-06-12 | MLB | ML | home | 3.0 | 0.50 | -210 | 2 | 0 | 2 | 2 | 29 | -0.10 | W | +0.2u |
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +111 | 3 | 1 | 4 | 3 | 23 | -0.70 | L | -0.3u |
| 2026-06-12 | MLB | ML | away | 4.0 | 1.00 | -114 | 2 | 0 | 2 | 1 | 0 | -1.20 | W | +0.9u |
| 2026-06-12 | MLB | ML | home | 5.0 | 2.50 | +123 | 0 | 1 | 1 | 0 | -2 | 0.00 | W | +3.1u |
| 2026-06-12 | MLB | SPREAD | away | 4.0 | 1.00 | +121 | 0 | 0 | 0 | 2 | 20 | 0.40 | L | -1.0u |
| 2026-06-12 | MLB | ML | home | 4.5 | 3.00 | -138 | 1 | 0 | 1 | 0 | 33 | -1.00 | L | -3.0u |
| 2026-06-12 | MLB | SPREAD | home | 3.0 | 0.50 | -107 | 2 | 0 | 2 | 2 | 9 | -0.40 | W | +0.4u |
| 2026-06-12 | MLB | ML | away | 2.5 | 0.25 | +118 | -1 | 0 | -1 | -1 | -18 | -0.20 | L | -0.3u |
| 2026-06-12 | MLB | ML | away | 4.0 | 1.00 | -136 | 2 | 0 | 2 | 2 | 29 | -1.30 | W | +0.7u |
| 2026-06-12 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | -1 | -1 | 1 | 12 | 0.00 | W | +2.7u |
| 2026-06-12 | MLB | ML | home | 3.0 | 0.50 | -134 | 2 | 0 | 2 | 3 | 38 | -1.10 | W | +0.4u |
| 2026-06-12 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | -1 | 0.00 | W | +2.7u |
| 2026-06-12 | MLB | SPREAD | away | 4.0 | 1.00 | -106 | 1 | 0 | 1 | 0 | 13 | -1.00 | L | -1.0u |
| 2026-06-13 | MLB | ML | away | 5.0 | 5.00 | -128 | 3 | 0 | 3 | 1 | 49 | -0.20 | L | -5.0u |
| 2026-06-13 | MLB | SPREAD | away | 4.0 | 1.00 | +123 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -1.0u |
| 2026-06-13 | MLB | ML | away | 4.5 | 3.00 | -102 | 0 | 0 | 0 | 1 | 11 | -2.00 | W | +2.9u |
| 2026-06-13 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 0 | 0 | 0 | 1 | 10 | 0.00 | W | +4.5u |
| 2026-06-13 | MLB | ML | away | 2.5 | 0.25 | -118 | 0 | 0 | 0 | -2 | 39 | -1.30 | W | +0.2u |
| 2026-06-13 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +2.7u |
| 2026-06-13 | MLB | ML | away | 4.5 | 2.50 | +136 | 1 | 0 | 1 | -2 | -28 | 1.30 | L | -2.5u |
| 2026-06-13 | MLB | ML | home | 5.0 | 2.50 | +134 | 2 | 0 | 2 | -1 | -2 | 0.00 | W | +3.4u |
| 2026-06-13 | MLB | SPREAD | home | 4.0 | 1.00 | -130 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.8u |
...
| 2026-06-13 | MLB | ML | home | 4.5 | 3.00 | -157 | 0 | 0 | 0 | -1 | 5 | 0.00 | L | -3.0u |
| 2026-06-13 | MLB | TOTAL | over | 3.0 | 0.50 | -110 | 1 | 0 | 1 | 1 | 22 | 0.00 | W | +0.5u |
| 2026-06-13 | MLB | ML | home | 5.0 | 5.00 | -115 | 1 | 1 | 2 | -1 | 7 | -0.40 | W | +4.3u |
| 2026-06-13 | MLB | SPREAD | away | 4.0 | 1.00 | -106 | 0 | 0 | 0 | 1 | 11 | 0.00 | L | -1.0u |
...
| 2026-06-14 | MLB | ML | home | 2.5 | 0.25 | -124 | 1 | 0 | 1 | 2 | -28 | -1.50 | W | +0.2u |
| 2026-06-14 | MLB | SPREAD | away | 5.0 | 5.00 | -180 | 1 | 0 | 1 | 0 | 11 | 0.00 | L | -5.0u |
| 2026-06-14 | MLB | ML | home | 5.0 | 5.00 | -192 | 1 | 0 | 1 | 1 | 2 | 0.00 | L | -5.0u |
| 2026-06-14 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -3.0u |
| 2026-06-14 | MLB | ML | away | 4.5 | 2.50 | +106 | 0 | 0 | 0 | 1 | 11 | 0.00 | L | -2.5u |
| 2026-06-14 | MLB | SPREAD | away | 4.5 | 3.00 | -116 | 2 | 0 | 2 | 2 | 8 | 0.00 | L | -3.0u |
| 2026-06-14 | MLB | SPREAD | away | 4.0 | 1.00 | -158 | 1 | -1 | 0 | 1 | 22 | 0.10 | W | +0.6u |
| 2026-06-14 | MLB | ML | away | 4.0 | 1.00 | -125 | 2 | 1 | 3 | 4 | 34 | -1.20 | W | +0.8u |
| 2026-06-14 | MLB | ML | away | 4.5 | 3.00 | -101 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -3.0u |
| 2026-06-14 | MLB | ML | away | 2.5 | 0.25 | -115 | 2 | 0 | 2 | 3 | 38 | 0.00 | W | +0.2u |
| 2026-06-14 | NHL | ML | away | 2.5 | 0.25 | -115 | -1 | 1 | 0 | 1 | -5 | -0.20 | W | +0.2u |
| 2026-06-14 | NHL | TOTAL | under | 5.0 | 5.00 | -110 | -1 | 0 | -1 | 1 | 5 | 0.00 | W | +4.4u |
| 2026-06-15 | MLB | ML | home | 4.0 | 1.00 | -204 | 1 | 0 | 1 | 1 | 31 | -0.60 | W | +0.0u |
| 2026-06-15 | MLB | SPREAD | away | 4.5 | 3.00 | -114 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +2.9u |
| 2026-06-15 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 12 | 0.00 | L | -1.0u |
| 2026-06-15 | MLB | SPREAD | home | 4.0 | 1.00 | +153 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-15 | MLB | TOTAL | over | 4.5 | 2.50 | -110 | 0 | 0 | 0 | 0 | 3 | 0.00 | W | +0.0u |
| 2026-06-15 | MLB | ML | away | 3.0 | 0.50 | +115 | 2 | 0 | 2 | 2 | 10 | -0.80 | L | -0.5u |
| 2026-06-15 | MLB | ML | away | 3.0 | 0.50 | +160 | 2 | 0 | 2 | 0 | 11 | -0.70 | L | -0.5u |
| 2026-06-15 | MLB | SPREAD | away | 2.5 | 0.25 | -120 | 0 | 0 | 0 | -1 | -2 | 0.00 | L | -0.3u |
| 2026-06-15 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 3 | 0 | 3 | 2 | 24 | 0.00 | L | -3.0u |
| 2026-06-15 | MLB | ML | home | 2.5 | 0.25 | -157 | 1 | 0 | 1 | 3 | 28 | -0.20 | L | -0.3u |
| 2026-06-15 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 12 | 0.00 | L | -1.0u |
| 2026-06-15 | MLB | ML | home | 3.0 | 0.50 | -132 | 3 | 1 | 4 | 3 | 3 | -0.70 | W | +2.2u |
| 2026-06-15 | MLB | TOTAL | under | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 0 | 0.00 | L | -1.0u |
| 2026-06-15 | MLB | ML | home | 3.0 | 0.50 | -154 | 1 | 0 | 1 | 3 | 4 | 0.50 | W | +0.0u |
| 2026-06-15 | MLB | SPREAD | away | 5.0 | 5.00 | -160 | 1 | 0 | 1 | 1 | 9 | -1.30 | L | -5.0u |
| 2026-06-15 | MLB | ML | home | 2.5 | 0.25 | -161 | -1 | 1 | 0 | -2 | 11 | -1.00 | W | +0.0u |
| 2026-06-15 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 13 | 0.00 | L | -1.0u |
| 2026-06-16 | MLB | ML | home | 4.0 | 1.00 | -145 | 1 | 0 | 1 | 1 | 31 | -1.00 | W | +0.0u |
| 2026-06-16 | MLB | SPREAD | away | 4.5 | 1.00 | -162 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-16 | MLB | TOTAL | under | 5.0 | 5.00 | -101 | 1 | 0 | 1 | 1 | 7 | 0.00 | W | +0.0u |
| 2026-06-16 | MLB | ML | home | 4.5 | 3.00 | -194 | 1 | 0 | 1 | -1 | 17 | 0.40 | L | -3.0u |
...
| 2026-06-16 | MLB | ML | home | 4.5 | 3.00 | -163 | 5 | 3 | 8 | 5 | 37 | -1.00 | W | +2.4u |
| 2026-06-16 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | -1 | 0 | -1 | -1 | -9 | 0.00 | L | -3.0u |
| 2026-06-16 | MLB | ML | home | 4.5 | 3.00 | -135 | 3 | 2 | 5 | 2 | 7 | -2.10 | W | +4.5u |
| 2026-06-16 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 7 | 0.00 | W | +0.0u |
| 2026-06-16 | MLB | ML | away | 2.5 | 0.25 | -106 | 1 | 0 | 1 | 1 | 31 | -0.20 | W | +0.0u |
| 2026-06-16 | MLB | ML | home | 3.0 | 0.50 | -174 | 2 | 1 | 3 | 2 | 37 | -1.40 | W | +2.3u |
| 2026-06-16 | MLB | ML | away | 4.0 | 1.00 | -116 | 0 | 0 | 0 | 0 | 28 | -0.80 | L | -1.0u |
| 2026-06-16 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 2 | 0 | 2 | 2 | 18 | 0.00 | L | -5.0u |
| 2026-06-16 | MLB | ML | home | 3.0 | 0.50 | -138 | 0 | 0 | 0 | 0 | 32 | 0.70 | L | -0.5u |
| 2026-06-16 | MLB | ML | away | 3.0 | 0.50 | -102 | 1 | 0 | 1 | 1 | 31 | -1.00 | L | -0.5u |
| 2026-06-16 | MLB | SPREAD | away | 4.0 | 1.00 | -160 | 0 | 0 | 0 | 2 | 18 | 30.10 | W | +0.0u |
| 2026-06-16 | MLB | ML | home | 3.0 | 0.50 | -161 | 1 | 1 | 2 | 1 | 17 | -0.40 | L | -0.5u |
| 2026-06-16 | MLB | ML | away | 5.0 | 2.50 | +120 | -1 | -1 | -2 | -1 | 28 | -1.80 | L | -2.5u |
| 2026-06-16 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 0 | 0 | 0 | 2 | 10 | 0.00 | L | -1.0u |
| 2026-06-16 | MLB | ML | away | 2.5 | 0.25 | -112 | 1 | 0 | 1 | 2 | 8 | -0.90 | W | +0.0u |
| 2026-06-16 | MLB | SPREAD | away | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +0.0u |
| 2026-06-17 | MLB | ML | away | 2.5 | 0.25 | +126 | -2 | 0 | -2 | -1 | -8 | -0.40 | W | +0.0u |
| 2026-06-17 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +2.7u |
| 2026-06-17 | MLB | ML | away | 4.5 | 2.50 | +112 | -1 | -1 | -2 | -1 | 50 | -1.20 | L | -2.5u |
| 2026-06-17 | MLB | ML | home | 5.0 | 5.00 | -173 | 1 | 0 | 1 | 1 | -4 | 0.00 | W | +0.0u |
| 2026-06-17 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +2.7u |
| 2026-06-17 | MLB | ML | away | 5.0 | 2.50 | +100 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +2.5u |
| 2026-06-17 | MLB | ML | home | 4.5 | 2.50 | +115 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -2.5u |
| 2026-06-17 | MLB | SPREAD | home | 4.5 | 3.00 | -141 | 0 | 0 | 0 | 1 | 11 | 0.00 | L | -3.0u |
...
| 2026-06-17 | MLB | SPREAD | home | 2.5 | 0.25 | +125 | -1 | 0 | -1 | -1 | 12 | -0.60 | L | -0.3u |
| 2026-06-17 | MLB | ML | home | 5.0 | 5.00 | -123 | 1 | 0 | 1 | 0 | 11 | 0.00 | L | -5.0u |
...
| 2026-06-18 | MLB | ML | home | 4.5 | 3.00 | -151 | 3 | 0 | 3 | 3 | 48 | -1.50 | W | +0.0u |
| 2026-06-18 | MLB | ML | away | 4.5 | 2.50 | +108 | 3 | 1 | 4 | 3 | -1 | -1.20 | W | +2.6u |
| 2026-06-18 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +2.7u |
| 2026-06-18 | MLB | SPREAD | away | 4.5 | 3.00 | -199 | 1 | 0 | 1 | 2 | 7 | 0.00 | L | -3.0u |
| 2026-06-18 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 3 | 0 | 3 | 3 | -8 | 0.00 | W | +2.8u |
| 2026-06-19 | MLB | ML | home | 4.5 | 3.00 | -205 | 1 | 0 | 1 | 1 | 7 | 0.10 | W | +0.0u |
| 2026-06-19 | MLB | TOTAL | over | 4.5 | 3.00 | -114 | 0 | 0 | 0 | 2 | 20 | 0.00 | W | +0.0u |
...
| 2026-06-19 | MLB | ML | away | 4.5 | 1.00 | +239 | 1 | 0 | 1 | 1 | -4 | 0.00 | L | -1.0u |
| 2026-06-19 | MLB | SPREAD | home | 4.5 | 3.00 | -111 | 1 | 1 | 2 | 0 | 12 | 0.00 | W | +3.1u |
| 2026-06-19 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 2 | 0 | 2 | 2 | -11 | 0.00 | L | -3.0u |
| 2026-06-19 | MLB | ML | away | 4.0 | 1.00 | +107 | 0 | 0 | 0 | 0 | -38 | 0.00 | L | -1.0u |
| 2026-06-19 | MLB | SPREAD | away | 4.0 | 1.00 | -115 | 2 | 0 | 2 | 3 | 19 | 0.00 | W | +2.5u |
| 2026-06-19 | MLB | ML | away | 4.5 | 2.50 | +141 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -2.5u |
| 2026-06-19 | MLB | ML | home | 2.5 | 0.25 | +158 | -1 | -1 | -2 | 0 | -11 | -1.10 | W | +0.0u |
| 2026-06-19 | MLB | SPREAD | away | 4.5 | 2.50 | -101 | 0 | -1 | -1 | 0 | 13 | -0.70 | L | -2.5u |
| 2026-06-19 | MLB | ML | home | 4.5 | 3.00 | -163 | -1 | -1 | -2 | -1 | 59 | -0.40 | W | +2.4u |
| 2026-06-19 | MLB | SPREAD | home | 4.5 | 2.50 | +130 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-19 | MLB | TOTAL | over | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -5.0u |
| 2026-06-19 | MLB | ML | home | 3.0 | 0.50 | -152 | 1 | 0 | 1 | 1 | 31 | 0.00 | W | +0.0u |
| 2026-06-19 | MLB | SPREAD | home | 2.5 | 0.25 | +147 | 1 | 0 | 1 | 0 | 0 | 0.00 | L | -0.3u |
| 2026-06-19 | MLB | ML | home | 5.0 | 1.00 | -109 | 1 | 0 | 1 | 1 | -4 | 0.00 | W | +0.0u |
| 2026-06-19 | MLB | SPREAD | away | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +0.0u |
| 2026-06-19 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -3.0u |
...
| 2026-06-20 | MLB | ML | home | 4.5 | 3.00 | -200 | -2 | 0 | -2 | -3 | -23 | -1.30 | L | -3.0u |
| 2026-06-20 | MLB | SPREAD | home | 3.0 | 0.50 | -110 | 1 | 0 | 1 | -1 | -1 | 0.00 | L | -0.5u |
| 2026-06-20 | MLB | ML | away | 4.5 | 2.50 | +123 | 2 | 0 | 2 | 3 | 4 | -3.20 | L | -2.5u |
| 2026-06-20 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | -1 | 1 | 0 | 0 | 11 | 0.00 | W | +0.0u |
| 2026-06-20 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 2 | 8 | 0.00 | W | +1.8u |
| 2026-06-20 | MLB | ML | away | 3.0 | 0.50 | +116 | 0 | 0 | 0 | -2 | 2 | 0.00 | W | +0.0u |
| 2026-06-20 | MLB | TOTAL | under | 4.0 | 1.00 | -110 | -1 | 0 | -1 | -1 | -9 | 0.00 | L | -1.0u |
| 2026-06-20 | MLB | ML | home | 4.0 | 1.00 | -190 | 2 | 1 | 3 | 0 | 42 | -1.70 | W | +2.0u |
| 2026-06-20 | MLB | ML | home | 5.0 | 5.00 | -137 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +2.2u |
...
| 2026-06-21 | MLB | ML | home | 4.0 | 1.00 | -226 | 1 | 0 | 1 | 1 | 47 | 0.30 | L | -1.0u |
| 2026-06-21 | MLB | SPREAD | away | 5.0 | 5.00 | -190 | 0 | 0 | 0 | 1 | 9 | -0.50 | L | -5.0u |
| 2026-06-21 | MLB | TOTAL | under | 4.5 | 2.50 | +100 | 1 | 1 | 2 | 2 | 25 | 0.00 | W | +2.5u |
| 2026-06-21 | MLB | ML | home | 4.0 | 1.00 | -104 | -1 | 0 | -1 | -1 | -34 | -0.50 | L | -1.0u |
| 2026-06-21 | MLB | TOTAL | over | 4.0 | 1.00 | -110 | 1 | 0 | 1 | 1 | 0 | 0.00 | L | -1.0u |
| 2026-06-21 | MLB | ML | away | 5.0 | 2.50 | +113 | 0 | 0 | 0 | 1 | -7 | 0.00 | L | -2.5u |
| 2026-06-21 | MLB | TOTAL | over | 2.5 | 0.25 | -110 | 0 | 0 | 0 | 0 | -1 | 0.00 | L | -0.3u |
| 2026-06-21 | MLB | TOTAL | under | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 1 | 13 | 0.00 | L | -3.0u |
| 2026-06-21 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | W | +0.0u |
| 2026-06-21 | MLB | ML | away | 2.5 | 0.25 | +110 | 0 | 0 | 0 | 1 | 31 | -1.00 | W | +0.0u |
| 2026-06-21 | MLB | SPREAD | home | 2.5 | 0.25 | -110 | 0 | 0 | 0 | 0 | 0 | -1.00 | L | -0.3u |
| 2026-06-21 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 1 | 0 | 1 | 1 | 11 | 0.00 | L | -3.0u |
| 2026-06-21 | MLB | ML | home | 4.5 | 3.00 | -178 | 3 | 0 | 3 | 3 | 37 | -1.30 | W | +1.6u |
| 2026-06-21 | MLB | ML | home | 3.0 | 0.50 | +130 | 0 | 0 | 0 | 0 | 32 | -0.80 | L | -0.5u |
| 2026-06-21 | MLB | ML | home | 3.0 | 0.50 | +123 | 1 | 0 | 1 | 1 | 31 | -0.20 | W | +0.0u |
...
| 2026-06-21 | MLB | TOTAL | under | 2.5 | 0.25 | -110 | 2 | 0 | 2 | 2 | 8 | 0.00 | L | -0.3u |
| 2026-06-21 | MLB | TOTAL | under | 4.5 | 1.00 | -114 | 1 | 1 | 2 | 1 | -17 | 0.00 | W | +0.0u |
| 2026-06-22 | MLB | ML | home | 4.5 | 3.00 | -138 | 0 | 0 | 0 | 0 | 12 | 0.30 | W | +0.0u |
...
| 2026-06-22 | MLB | TOTAL | over | 4.5 | 3.00 | -110 | 0 | 0 | 0 | 0 | 11 | 0.00 | L | -3.0u |
| 2026-06-22 | MLB | SPREAD | away | 5.0 | 2.50 | +118 | 1 | 0 | 1 | 1 | 9 | 0.00 | W | +0.0u |
| 2026-06-22 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 1 | 0 | 1 | 0 | 9 | 0.00 | W | +0.0u |
| 2026-06-22 | MLB | ML | home | 5.0 | 5.00 | -124 | 1 | 0 | 1 | 1 | 10 | -1.20 | W | +2.3u |
| 2026-06-22 | MLB | TOTAL | under | 5.0 | 5.00 | -110 | 3 | 0 | 3 | 3 | 30 | 0.00 | W | +2.7u |
| 2026-06-22 | MLB | ML | home | 3.0 | 0.50 | -180 | 1 | 0 | 1 | 1 | 31 | -1.30 | L | -0.5u |
| 2026-06-22 | MLB | ML | home | 5.0 | 2.50 | +133 | 0 | 0 | 0 | 0 | -6 | 0.00 | L | -2.5u |
| 2026-06-22 | MLB | ML | home | 5.0 | 2.50 | +137 | 0 | 0 | 0 | 0 | -6 | 0.00 | L | -2.5u |
| 2026-06-22 | MLB | SPREAD | home | 4.5 | 1.00 | -109 | 0 | 0 | 0 | -1 | 13 | 0.00 | W | +0.0u |
| 2026-06-22 | MLB | SPREAD | away | 4.5 | 2.50 | +138 | 2 | 0 | 2 | 1 | 22 | 0.00 | L | -2.5u |
| 2026-06-22 | MLB | TOTAL | under | 4.0 | 1.00 | -104 | 2 | 1 | 3 | 3 | 5 | 0.00 | W | +3.9u |
