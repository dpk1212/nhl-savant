...
async function buildV12QConvMute(report, stats) {
  ...
  report.push(`### Coverage`);
  report.push('');
  report.push(`| Window | Sides | With qConv stamp | Graded w/ stamp | Mute-eligible tiers graded |`);
  report.push(`|--------|------:|-----------------:|----------------:|------------------:|`);
  report.push(
