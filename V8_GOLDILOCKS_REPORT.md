...
_Generated 2026-04-24T13:50:50.782Z_
...
|---|---:|---:|
| roiNorm≥70 & sizeRatio≥1 | +0.325 | +0.221 |
| contribution≥50 | +0.241 | +0.214 |
| invested≥$5k | +0.179 | +0.192 |
| walletBase≥50 & sizeRatio≥1 | +0.258 | +0.192 |
| roiNorm≥50 & sizeRatio≥1 | +0.208 | +0.180 |
| contribution≥60 | +0.264 | +0.167 |
| roiNorm≥50 & sizeRatio≥1.25 | +0.213 | +0.164 |
| convictionMult≥1 | +0.200 | +0.162 |
| sizeRatio≥1 (roi any) | +0.200 | +0.162 |
| roiNorm≥60 & sizeRatio≥1 | +0.216 | +0.155 |
| roiNorm≥60 & sizeRatio≥1.25 | +0.213 | +0.146 |
| rankNorm≥60 | +0.170 | +0.114 |
| walletBase≥60 & sizeRatio≥1 | +0.252 | +0.099 |
| roiNorm≥50 (size any) | +0.104 | +0.086 |
...
|---|---:|---:|
| invested≥$5k | +0.248 | +0.264 |
| convictionMult≥1 | +0.264 | +0.197 |
| sizeRatio≥1 (roi any) | +0.264 | +0.197 |
| walletBase≥50 & sizeRatio≥1 | +0.264 | +0.151 |
| roiNorm≥60 & sizeRatio≥1.25 | +0.234 | +0.143 |
| contribution≥50 | +0.191 | +0.131 |
| roiNorm≥50 & sizeRatio≥1.25 | +0.215 | +0.115 |
| rankNorm≥60 | +0.178 | +0.114 |
| roiNorm≥60 & sizeRatio≥1 | +0.196 | +0.113 |
| roiNorm≥70 & sizeRatio≥1 | +0.255 | +0.110 |
| roiNorm≥50 & sizeRatio≥1 | +0.179 | +0.098 |
| contribution≥60 | +0.246 | +0.097 |
| roiNorm≥50 (size any) | +0.123 | +0.069 |
| walletBase≥60 & sizeRatio≥1 | +0.207 | +0.038 |
...
| Bucket | N | WR | flat ROI | units-wtd ROI |
|---|---:|---:|---:|---:|
| margin ≤ 0 | 17 | 35.3% | -33.1% | -46.3% |
| margin +1 | 31 | 48.4% | +11.2% | -6.5% |
| margin +2 | 18 | 44.4% | -18.4% | -8.8% |
| margin ≥+3 | 8 | 62.5% | +24.3% | +22.8% |

#### Quality: roiNorm≥60 & sizeRatio≥1

| Bucket | N | WR | flat ROI | units-wtd ROI |
|---|---:|---:|---:|---:|
| margin ≤ 0 | 43 | 48.8% | +1.4% | -8.5% |
...
| Bucket | N | WR | flat ROI | units-wtd ROI |
|---|---:|---:|---:|---:|
| margin ≤ 0 | 17 | 52.9% | +22.2% | +16.5% |
| margin +1 | 22 | 31.8% | -37.7% | -47.9% |
| margin +2 | 23 | 52.2% | +8.8% | -0.0% |
| margin ≥+3 | 12 | 50.0% | -8.3% | +1.0% |

#### Quality: walletBase≥60 & sizeRatio≥1

| Bucket | N | WR | flat ROI | units-wtd ROI |
|---|---:|---:|---:|---:|
| margin ≤ 0 | 48 | 50.0% | +9.8% | +0.9% |
...
Use this as a hint generator, not a backtest — with N=74 most rules are overfit.

### Single-factor rules (N ≥ 3)

| Rule | N | WR | flat ROI | wtd ROI |
|---|---:|---:|---:|---:|
| walletPlayScore≥3 | 24 | 54.2% | +25.8% | +15.8% |
| stars≥3.5 | 27 | 51.9% | +18.0% | +7.5% |
| walletPlayScore≥2 | 36 | 50.0% | +13.3% | +7.2% |
| topShare≤0.5 | 47 | 51.1% | +9.2% | +4.5% |
| qFor(roi50+size1)≥1 | 40 | 47.5% | +8.1% | +1.3% |
| concPenalty≤2.5 | 63 | 50.8% | +6.0% | +0.6% |
| regime=CLEAR_MOVE | 15 | 60.0% | +5.0% | +14.7% |
| stars≥3 | 48 | 47.9% | +3.0% | -3.8% |
| netEdge≥1 | 47 | 46.8% | +1.7% | -0.7% |
| walletCountFor≥3 | 51 | 47.1% | +0.6% | -1.0% |
| qMargin(roi60+size1.25)≥1 | 29 | 48.3% | -0.6% | +2.6% |
| meanBase_F≥55 | 33 | 51.5% | -1.4% | -7.2% |
| maxRoiN_F≥70 | 40 | 47.5% | -3.6% | -11.3% |
| sumInvested_F≥$10k | 74 | 45.9% | -4.7% | -9.4% |
| walletCountAgainst=0 | 25 | 48.0% | -6.6% | -13.7% |
| qFor(roi50+size1)≥2 | 16 | 43.8% | -8.4% | +5.8% |
| qFor(roi60+size1.25)≥2 | 14 | 42.9% | -11.7% | +1.4% |
| qMargin(roi50+size1)≥1 | 34 | 41.2% | -15.0% | -12.4% |

### Top 2-factor AND rules (N ≥ 3, top 25)

| Rule | N | WR | flat ROI | wtd ROI |
|---|---:|---:|---:|---:|
| qFor(roi50+size1)≥1 ∧ walletPlayScore≥3 | 19 | 57.9% | +43.2% | +26.5% |
| walletCountAgainst=0 ∧ regime=CLEAR_MOVE | 7 | 71.4% | +36.9% | +49.2% |
| qFor(roi50+size1)≥1 ∧ stars≥3.5 | 20 | 55.0% | +36.0% | +15.0% |
| qFor(roi50+size1)≥1 ∧ walletPlayScore≥2 | 27 | 55.6% | +32.9% | +21.8% |
| regime=CLEAR_MOVE ∧ meanBase_F≥55 | 7 | 71.4% | +29.0% | +23.5% |
| concPenalty≤2.5 ∧ regime=CLEAR_MOVE | 11 | 72.7% | +28.0% | +31.7% |
| walletPlayScore≥2 ∧ regime=CLEAR_MOVE | 4 | 75.0% | +27.6% | +30.0% |
| walletCountFor≥3 ∧ stars≥3.5 | 25 | 56.0% | +27.5% | +19.7% |
| netEdge≥1 ∧ stars≥3.5 | 25 | 56.0% | +27.5% | +19.7% |
| topShare≤0.5 ∧ stars≥3.5 | 25 | 56.0% | +27.5% | +19.7% |
| walletCountFor≥3 ∧ walletPlayScore≥3 | 24 | 54.2% | +25.8% | +15.8% |
| walletPlayScore≥2 ∧ walletPlayScore≥3 | 24 | 54.2% | +25.8% | +15.8% |
| walletPlayScore≥2 ∧ stars≥3.5 | 24 | 54.2% | +25.8% | +15.8% |
| walletPlayScore≥3 ∧ netEdge≥1 | 24 | 54.2% | +25.8% | +15.8% |
| walletPlayScore≥3 ∧ topShare≤0.5 | 24 | 54.2% | +25.8% | +15.8% |
| walletPlayScore≥3 ∧ concPenalty≤2.5 | 24 | 54.2% | +25.8% | +15.8% |
| walletPlayScore≥3 ∧ stars≥3 | 24 | 54.2% | +25.8% | +15.8% |
| walletPlayScore≥3 ∧ stars≥3.5 | 24 | 54.2% | +25.8% | +15.8% |
| walletPlayScore≥3 ∧ sumInvested_F≥$10k | 24 | 54.2% | +25.8% | +15.8% |
| concPenalty≤2.5 ∧ stars≥3.5 | 24 | 54.2% | +25.8% | +15.8% |
| qFor(roi50+size1)≥1 ∧ topShare≤0.5 | 30 | 53.3% | +23.6% | +16.7% |
| qFor(roi50+size1)≥2 ∧ walletPlayScore≥3 | 11 | 54.5% | +22.4% | +24.4% |
| qFor(roi50+size1)≥2 ∧ stars≥3.5 | 11 | 54.5% | +22.4% | +24.4% |
| topShare≤0.5 ∧ regime=CLEAR_MOVE | 8 | 75.0% | +22.0% | +31.7% |
| qMargin(roi60+size1.25)≥1 ∧ walletPlayScore≥2 | 21 | 57.1% | +21.9% | +23.3% |
...
| concPenalty≤2.5 ∧ regime=CLEAR_MOVE ∧ meanBase_F≥55 | 6 | 83.3% | +50.5% | +47.9% |
| qFor(roi50+size1)≥1 ∧ walletCountFor≥3 ∧ walletPlayScore≥3 | 19 | 57.9% | +43.2% | +26.5% |
| qFor(roi50+size1)≥1 ∧ walletCountFor≥3 ∧ stars≥3.5 | 19 | 57.9% | +43.2% | +26.5% |
| qFor(roi50+size1)≥1 ∧ walletPlayScore≥2 ∧ walletPlayScore≥3 | 19 | 57.9% | +43.2% | +26.5% |
| qFor(roi50+size1)≥1 ∧ walletPlayScore≥2 ∧ stars≥3.5 | 19 | 57.9% | +43.2% | +26.5% |
| qFor(roi50+size1)≥1 ∧ walletPlayScore≥3 ∧ netEdge≥1 | 19 | 57.9% | +43.2% | +26.5% |
| qFor(roi50+size1)≥1 ∧ walletPlayScore≥3 ∧ topShare≤0.5 | 19 | 57.9% | +43.2% | +26.5% |
| qFor(roi50+size1)≥1 ∧ walletPlayScore≥3 ∧ concPenalty≤2.5 | 19 | 57.9% | +43.2% | +26.5% |
| qFor(roi50+size1)≥1 ∧ walletPlayScore≥3 ∧ stars≥3 | 19 | 57.9% | +43.2% | +26.5% |
| qFor(roi50+size1)≥1 ∧ walletPlayScore≥3 ∧ stars≥3.5 | 19 | 57.9% | +43.2% | +26.5% |
| qFor(roi50+size1)≥1 ∧ walletPlayScore≥3 ∧ sumInvested_F≥$10k | 19 | 57.9% | +43.2% | +26.5% |
| qFor(roi50+size1)≥1 ∧ netEdge≥1 ∧ stars≥3.5 | 19 | 57.9% | +43.2% | +26.5% |
| qFor(roi50+size1)≥1 ∧ topShare≤0.5 ∧ stars≥3.5 | 19 | 57.9% | +43.2% | +26.5% |
| qFor(roi50+size1)≥1 ∧ concPenalty≤2.5 ∧ stars≥3.5 | 19 | 57.9% | +43.2% | +26.5% |
| walletCountAgainst=0 ∧ regime=CLEAR_MOVE ∧ sumInvested_F≥$10k | 7 | 71.4% | +36.9% | +49.2% |
| qFor(roi50+size1)≥1 ∧ stars≥3 ∧ stars≥3.5 | 20 | 55.0% | +36.0% | +15.0% |
| qFor(roi50+size1)≥1 ∧ stars≥3.5 ∧ sumInvested_F≥$10k | 20 | 55.0% | +36.0% | +15.0% |
| qMargin(roi60+size1.25)≥1 ∧ walletPlayScore≥2 ∧ meanBase_F≥55 | 12 | 66.7% | +35.0% | +35.3% |
...
| qFor(roi50+size1)≥1 ∧ walletCountFor≥3 ∧ walletPlayScore≥2 | 27 | 55.6% | +32.9% | +21.8% |
| qFor(roi50+size1)≥1 ∧ walletPlayScore≥2 ∧ topShare≤0.5 | 27 | 55.6% | +32.9% | +21.8% |
| qFor(roi50+size1)≥1 ∧ walletPlayScore≥2 ∧ concPenalty≤2.5 | 27 | 55.6% | +32.9% | +21.8% |