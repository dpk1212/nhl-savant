    ...
    const matchedGame = {
      ...
      barttorvik: (awayBartt && homeBartt) ? {
        ...
        away: {
          ...
          eFG_off_rank: awayBartt.eFG_off_rank,
          eFG_def_rank: awayBartt.eFG_def_rank,
          to_off: awayBartt.to_off,
          to_def: awayBartt.to_def,
          to_off_rank: awayBartt.to_off_rank,
          to_def_rank: awayBartt.to_def_rank,
          oreb_off: awayBartt.oreb_off,
          oreb_def: awayBartt.oreb_def,
          oreb_off_rank: awayBartt.oreb_off_rank,
          oreb_def_rank: awayBartt.oreb_def_rank,
          twoP_off: awayBartt.twoP_off,
          twoP_def: awayBartt.twoP_def,
          twoP_off_rank: awayBartt.twoP_off_rank,
          twoP_def_rank: awayBartt.twoP_def_rank,
          threeP_off: awayBartt.threeP_off,
          threeP_def: awayBartt.threeP_def,
          threeP_off_rank: awayBartt.threeP_off_rank,
          threeP_def_rank: awayBartt.threeP_def_rank,
          // Betting Edge data
          ...
          ftRate_off_rank: awayBartt.ftRate_off_rank,
          ftRate_def_rank: awayBartt.ftRate_def_rank,
          threeP_rate_off: awayBartt.threeP_rate_off,
          threeP_rate_def: awayBartt.threeP_rate_def,
          threeP_rate_off_rank: awayBartt.threeP_rate_off_rank,
          threeP_rate_def_rank: awayBartt.threeP_rate_def_rank,
          wab: awayBartt.wab,
        ...
        home: {
          ...
          eFG_off_rank: homeBartt.eFG_off_rank,
          eFG_def_rank: homeBartt.eFG_def_rank,
          to_off: homeBartt.to_off,
          to_def: homeBartt.to_def,
          to_off_rank: homeBartt.to_off_rank,
          to_def_rank: homeBartt.to_def_rank,
          oreb_off: homeBartt.oreb_off,
          oreb_def: homeBartt.oreb_def,
          oreb_off_rank: homeBartt.oreb_off_rank,
          oreb_def_rank: homeBartt.oreb_def_rank,
          twoP_off: homeBartt.twoP_off,
          twoP_def: homeBartt.twoP_def,
          twoP_off_rank: homeBartt.twoP_off_rank,
          twoP_def_rank: homeBartt.twoP_def_rank,
          threeP_off: homeBartt.threeP_off,
          threeP_def: homeBartt.threeP_def,
          threeP_off_rank: homeBartt.threeP_off_rank,
          threeP_def_rank: homeBartt.threeP_def_rank,
          // Betting Edge data
          ...
          ftRate_off_rank: homeBartt.ftRate_off_rank,
          ftRate_def_rank: homeBartt.ftRate_def_rank,
          threeP_rate_off: homeBartt.threeP_rate_off,
          threeP_rate_def: homeBartt.threeP_rate_def,
          threeP_rate_off_rank: homeBartt.threeP_rate_off_rank,
          threeP_rate_def_rank: homeBartt.threeP_rate_def_rank,
          wab: homeBartt.wab,
