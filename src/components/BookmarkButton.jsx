  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: isBookmarked 
          ? '0 4px 12px rgba(212, 175, 55, 0.3), 0 0 20px rgba(212, 175, 55, 0.2) inset'
          : isHovered
    ...
    >
      ...
      <Bookmark 
        ...
        stroke={isBookmarked ? '#D4AF37' : 'rgba(212, 175, 55, 0.6)'}
        strokeWidth={2.5}
        style={{
          transition: 'all 0.3s ease',
          position: 'relative',
          zIndex: 1,
          filter: isBookmarked ? 'drop-shadow(0 0 4px rgba(212, 175, 55, 0.6))' : 'none'
        }}
      />
