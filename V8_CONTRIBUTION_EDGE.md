...
_Generated 2026-05-10T14:00:03.268Z_

N = 307 picks (LOCKED=199, SHADOW=108)
...
#### Threshold T = 30   |   ρ(qFor, won) = 0.063   ρ(qFor, flat ROI) = 0.076

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 1 | 0.0% | -100.0% | — |
| qFor ≥ 1 | 64 | 48.4% | -8.7% | +0.4% |
| qFor ≥ 2 | 111 | 46.8% | -9.0% | -11.0% |
| qFor ≥ 3+ | 131 | 49.6% | -1.9% | +4.9% |

#### Threshold T = 40   |   ρ(qFor, won) = 0.080   ρ(qFor, flat ROI) = 0.082

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 8 | 37.5% | -34.0% | -9.1% |
| qFor ≥ 1 | 94 | 50.0% | -5.1% | -4.6% |
| qFor ≥ 2 | 103 | 47.6% | -7.6% | +1.0% |
| qFor ≥ 3+ | 102 | 48.0% | -3.7% | +1.0% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.115   ρ(qFor, flat ROI) = 0.078

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 40 | 50.0% | -5.4% | -17.5% |
| qFor ≥ 1 | 138 | 50.0% | -3.0% | +10.6% |
| qFor ≥ 2 | 72 | 41.7% | -17.3% | -13.9% |
| qFor ≥ 3+ | 57 | 50.9% | -0.5% | +4.8% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.186   ρ(qFor, flat ROI) = 0.115

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 96 | 47.9% | -8.8% | -10.9% |
| qFor ≥ 1 | 130 | 50.0% | -2.5% | +9.1% |
| qFor ≥ 2 | 42 | 47.6% | -9.6% | -4.5% |
| qFor ≥ 3+ | 39 | 43.6% | -8.5% | -1.5% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.230   ρ(qFor, flat ROI) = 0.130

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 149 | 49.0% | -6.6% | -6.1% |
| qFor ≥ 1 | 110 | 44.5% | -12.6% | +0.4% |
| qFor ≥ 2 | 34 | 55.9% | +6.5% | +1.6% |
| qFor ≥ 3+ | 14 | 50.0% | +17.7% | +17.7% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.148   ρ(margin, flat ROI) = 0.114

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 29 | 37.9% | -29.9% | -33.3% |
| margin +1 | 116 | 48.3% | -6.8% | +7.3% |
| margin +2 | 87 | 51.7% | -0.7% | +3.0% |
| margin ≥ +3 | 75 | 48.0% | -2.4% | -1.9% |

#### Threshold T = 40   |   ρ(margin, won) = 0.129   ρ(margin, flat ROI) = 0.079

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 45 | 44.4% | -6.4% | -9.7% |
| margin +1 | 125 | 52.0% | +0.4% | +7.0% |
| margin +2 | 81 | 44.4% | -15.8% | -5.3% |
| margin ≥ +3 | 56 | 48.2% | -6.8% | +0.1% |

#### Threshold T = 50   |   ρ(margin, won) = 0.130   ρ(margin, flat ROI) = 0.055
...
#### Threshold T = 70   |   ρ(margin, won) = 0.224   ρ(margin, flat ROI) = 0.086

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 184 | 48.4% | -4.1% | +0.4% |
| margin +1 | 90 | 46.7% | -12.0% | -4.3% |
...
| 1 | 109 / 51.4% / -1.8% | 26 / 46.2% / -5.6% | 3 / 33.3% / -23.3% | — | — | — | — |
| 2 | 43 / 32.6% / -38.7% | 24 / 50.0% / -8.5% | 4 / 75.0% / +36.5% | 1 / 100.0% / +475.0% | — | — | — |
| 3 | 9 / 66.7% / +23.3% | 8 / 75.0% / +28.8% | 4 / 50.0% / +47.6% | 1 / 100.0% / +198.0% | 1 / 0.0% / -100.0% | 1 / 100.0% / +45.9% | — |
...
| 1 | 72 / 50.0% / -6.7% | 20 / 55.0% / +10.2% | 2 / 0.0% / -100.0% | — | — | — | — | — | — |
| 2 | 54 / 44.4% / -15.3% | 42 / 54.8% / +8.6% | 5 / 20.0% / -61.8% | 2 / 50.0% / -1.9% | — | — | — | — | — |
| 3 | 22 / 45.5% / -11.7% | 22 / 45.5% / -12.5% | 6 / 83.3% / +61.0% | 3 / 66.7% / +131.2% | 1 / 0.0% / -100.0% | 1 / 100.0% / +45.9% | — | — | — |
...
ρ(Δcontribution, won) = -0.013   |   ρ(Δcontribution, flat ROI) = -0.014
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 70.2) | 102 | 32.8 | 48.0% | -4.0% | +1.0% |
| Mid  (70.3 .. 124.4) | 102 | 96.7 | 53.9% | +5.4% | +5.5% |
| High (Δ ≥ 124.5) | 103 | 203.9 | 42.7% | -19.8% | -3.7% |
...
| 0 < Δ ≤ 50 | 42 | 54.8% | +5.6% | -0.7% |
| 50 < Δ ≤ 100 | 100 | 49.0% | -0.2% | +9.1% |
| Δ > 100 | 150 | 46.7% | -12.2% | -3.6% |
...
| --- | --- | --- | --- | --- |
| STRONG | 117 | 44.4% | -16.2% | -4.8% |
| STANDARD | 109 | 51.4% | -1.8% | +8.5% |
| LEAN | 69 | 50.7% | +0.4% | -1.1% |
...
| --- | --- | --- | --- |
| STRONG | 117 | 3.89 | 1.46 |
| STANDARD | 109 | 3.07 | 0.76 |
| LEAN | 69 | 3.18 | 0.82 |
| MUTE | 12 | 3.85 | 1.13 |
