...
_Generated 2026-04-30T14:33:36.492Z_

N = 196 picks (LOCKED=146, SHADOW=50)
...
#### Threshold T = 30   |   ρ(qFor, won) = 0.176   ρ(qFor, flat ROI) = 0.171

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 1 | 0.0% | -100.0% | — |
| qFor ≥ 1 | 20 | 45.0% | -14.3% | -26.6% |
| qFor ≥ 2 | 83 | 43.4% | -16.0% | -13.4% |
| qFor ≥ 3+ | 92 | 52.2% | +4.4% | +2.5% |

#### Threshold T = 40   |   ρ(qFor, won) = 0.204   ρ(qFor, flat ROI) = 0.175

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 4 | 0.0% | -100.0% | -100.0% |
| qFor ≥ 1 | 41 | 43.9% | -15.4% | -31.0% |
| qFor ≥ 2 | 80 | 48.8% | -6.2% | -1.3% |
| qFor ≥ 3+ | 71 | 50.7% | +3.1% | +0.9% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.181   ρ(qFor, flat ROI) = 0.139

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 27 | 33.3% | -32.8% | -39.4% |
| qFor ≥ 1 | 76 | 51.3% | -0.6% | +8.8% |
| qFor ≥ 2 | 55 | 41.8% | -15.6% | -24.4% |
| qFor ≥ 3+ | 38 | 57.9% | +12.6% | +14.0% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.253   ρ(qFor, flat ROI) = 0.159

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 61 | 39.3% | -23.1% | -17.1% |
| qFor ≥ 1 | 80 | 52.5% | +2.7% | +2.2% |
| qFor ≥ 2 | 29 | 48.3% | -5.3% | -5.3% |
| qFor ≥ 3+ | 26 | 50.0% | +1.4% | -0.9% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.216   ρ(qFor, flat ROI) = 0.115

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 95 | 49.5% | -4.5% | -3.3% |
| qFor ≥ 1 | 67 | 40.3% | -20.1% | -12.3% |
| qFor ≥ 2 | 24 | 58.3% | +10.8% | +0.4% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.228   ρ(margin, flat ROI) = 0.187

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 15 | 20.0% | -63.7% | -77.8% |
| margin +1 | 70 | 45.7% | -10.1% | +3.7% |
| margin +2 | 62 | 53.2% | +0.4% | -0.1% |
| margin ≥ +3 | 49 | 51.0% | +6.7% | -8.7% |

#### Threshold T = 40   |   ρ(margin, won) = 0.204   ρ(margin, flat ROI) = 0.139

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 26 | 34.6% | -15.6% | -9.2% |
| margin +1 | 71 | 50.7% | -2.4% | +1.7% |
| margin +2 | 62 | 45.2% | -14.6% | -12.1% |
| margin ≥ +3 | 37 | 54.1% | +4.7% | -1.8% |

#### Threshold T = 50   |   ρ(margin, won) = 0.177   ρ(margin, flat ROI) = 0.093
...
#### Threshold T = 60   |   ρ(margin, won) = 0.218   ρ(margin, flat ROI) = 0.075
...
#### Threshold T = 70   |   ρ(margin, won) = 0.172   ρ(margin, flat ROI) = 0.035

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 118 | 49.2% | -0.6% | +5.4% |
| margin +1 | 54 | 40.7% | -24.5% | -25.4% |
| margin +2 | 17 | 58.8% | +13.0% | +12.5% |
...
| 1 | 61 / 52.5% / -0.1% | 13 / 46.2% / -5.3% | 2 / 50.0% / +15.0% | — | — |
| 2 | 30 / 36.7% / -31.7% | 21 / 42.9% / -20.7% | 3 / 66.7% / +16.6% | 1 / 100.0% / +475.0% | — |
| 3 | 5 / 100.0% / +96.6% | 6 / 83.3% / +39.8% | 3 / 66.7% / +96.7% | — | 1 / 0.0% / -100.0% |
| 4 | 4 / 50.0% / -2.4% | 1 / 0.0% / -100.0% | 3 / 0.0% / -100.0% | 1 / 100.0% / +90.9% | 2 / 50.0% / +27.0% |
| 5 | 1 / 100.0% / +26.7% | 5 / 60.0% / +0.9% | 3 / 0.0% / -100.0% | — | — |
...
| 1 | 30 / 40.0% / -25.9% | 10 / 60.0% / +24.6% | 1 / 0.0% / -100.0% | — | — | — | — | — | — |
| 2 | 41 / 48.8% / -8.2% | 34 / 55.9% / +9.9% | 4 / 0.0% / -100.0% | 1 / 0.0% / -100.0% | — | — | — | — | — |
| 3 | 14 / 50.0% / -3.0% | 16 / 37.5% / -24.5% | 5 / 100.0% / +93.2% | 3 / 66.7% / +131.2% | 1 / 0.0% / -100.0% | — | — | — | — |
| 4 | 3 / 33.3% / -37.4% | 3 / 66.7% / +6.3% | 3 / 33.3% / -55.4% | 2 / 0.0% / -100.0% | 1 / 100.0% / +154.0% | — | — | — | 1 / 0.0% / -100.0% |
| 5 | 3 / 66.7% / +30.2% | 2 / 100.0% / +90.1% | 5 / 40.0% / +3.0% | 2 / 50.0% / -4.5% | — | — | — | — | — |
| 6 | 1 / 100.0% / +26.7% | 1 / 100.0% / +90.9% | 2 / 0.0% / -100.0% | 1 / 100.0% / +110.0% | — | — | — | — | — |
| 7 | 1 / 0.0% / -100.0% | 1 / 100.0% / +95.2% | — | — | — | — | — | — | — |

## D. Continuous Δcontribution (sumContrib_F − sumContrib_A) terciles

No threshold. Sort all picks by Δ and cut into thirds.

ρ(Δcontribution, won) = 0.040   |   ρ(Δcontribution, flat ROI) = 0.023
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 74.9) | 65 | 36.9 | 44.6% | -5.3% | +21.5% |
| Mid  (75.2 .. 128.0) | 65 | 101.9 | 52.3% | +0.2% | -19.0% |
| High (Δ ≥ 128.8) | 66 | 210.3 | 45.5% | -14.8% | -10.6% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 8 | 25.0% | -41.5% | +5.1% |
| 0 < Δ ≤ 50 | 24 | 41.7% | -15.9% | +5.7% |
| 50 < Δ ≤ 100 | 61 | 50.8% | +5.6% | +5.6% |
| Δ > 100 | 103 | 48.5% | -9.1% | -10.5% |
...
| --- | --- | --- | --- | --- |
| STRONG | 86 | 47.7% | -10.0% | -7.9% |
| STANDARD | 61 | 52.5% | -0.1% | -0.8% |
| LEAN | 41 | 41.5% | -17.0% | -11.5% |
