...
_Generated 2026-05-17T14:04:11.286Z_

N = 377 picks (LOCKED=260, SHADOW=117)
Baseline: WR 49.1% · flat ROI -5.3% · units-wtd ROI -0.4%
...
#### Threshold T = 30   |   ρ(qFor, won) = 0.103   ρ(qFor, flat ROI) = 0.098

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 1 | 0.0% | -100.0% | — |
| qFor ≥ 1 | 86 | 48.8% | -9.4% | -1.8% |
| qFor ≥ 2 | 129 | 45.0% | -13.0% | -18.2% |
| qFor ≥ 3+ | 161 | 52.8% | +3.5% | +8.4% |

#### Threshold T = 40   |   ρ(qFor, won) = 0.097   ρ(qFor, flat ROI) = 0.083

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 10 | 40.0% | -26.8% | -0.6% |
| qFor ≥ 1 | 124 | 50.0% | -5.8% | -5.7% |
| qFor ≥ 2 | 123 | 46.3% | -10.5% | -0.2% |
| qFor ≥ 3+ | 120 | 51.7% | +2.1% | +2.2% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.138   ρ(qFor, flat ROI) = 0.086

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 49 | 46.9% | -11.3% | -15.5% |
| qFor ≥ 1 | 174 | 49.4% | -4.9% | +1.9% |
| qFor ≥ 2 | 89 | 46.1% | -9.1% | -2.0% |
| qFor ≥ 3+ | 65 | 53.8% | +3.2% | +2.6% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.200   ρ(qFor, flat ROI) = 0.114

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 115 | 45.2% | -13.8% | -15.1% |
| qFor ≥ 1 | 164 | 51.2% | -0.8% | +10.3% |
| qFor ≥ 2 | 54 | 53.7% | -0.3% | -0.6% |
| qFor ≥ 3+ | 44 | 45.5% | -6.3% | -7.9% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.245   ρ(qFor, flat ROI) = 0.139

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 182 | 46.7% | -11.3% | -10.5% |
| qFor ≥ 1 | 139 | 48.9% | -4.9% | +5.2% |
| qFor ≥ 2 | 39 | 61.5% | +15.0% | +12.2% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.160   ρ(margin, flat ROI) = 0.129

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 45 | 40.0% | -27.6% | -34.3% |
| margin +1 | 135 | 48.1% | -8.3% | +3.5% |
| margin +2 | 102 | 52.9% | +1.7% | -0.1% |
| margin ≥ +3 | 95 | 50.5% | +1.8% | +3.7% |

#### Threshold T = 40   |   ρ(margin, won) = 0.118   ρ(margin, flat ROI) = 0.075

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 63 | 47.6% | -4.6% | +2.3% |
| margin +1 | 150 | 51.3% | -1.9% | +3.2% |
| margin +2 | 98 | 46.9% | -9.6% | +1.8% |
| margin ≥ +3 | 66 | 48.5% | -7.5% | -8.0% |

#### Threshold T = 50   |   ρ(margin, won) = 0.120   ρ(margin, flat ROI) = 0.057

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 104 | 51.0% | +2.2% | +7.4% |
| margin +1 | 168 | 50.6% | -2.9% | +0.5% |
| margin +2 | 68 | 41.2% | -22.5% | -9.2% |
| margin ≥ +3 | 37 | 51.4% | -6.1% | -1.1% |

#### Threshold T = 60   |   ρ(margin, won) = 0.163   ρ(margin, flat ROI) = 0.067

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 158 | 51.9% | +2.0% | +9.9% |
| margin +1 | 155 | 47.1% | -9.7% | -1.8% |
| margin +2 | 41 | 46.3% | -13.2% | -14.2% |
| margin ≥ +3 | 23 | 47.8% | -12.5% | -4.9% |

#### Threshold T = 70   |   ρ(margin, won) = 0.218   ρ(margin, flat ROI) = 0.091

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 225 | 48.0% | -6.0% | -1.3% |
| margin +1 | 112 | 49.1% | -7.3% | -0.5% |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 41 / 51.2% / -4.0% | 7 / 28.6% / -41.4% | 1 / 0.0% / -100.0% | — | — | — | — |
| 1 | 134 / 49.3% / -6.0% | 36 / 50.0% / -2.0% | 4 / 50.0% / +4.4% | — | — | — | — |
| 2 | 54 / 37.0% / -29.6% | 27 / 51.9% / -2.0% | 6 / 83.3% / +54.0% | 2 / 100.0% / +259.7% | — | — | — |
...
| 1 | 89 / 49.4% / -7.7% | 29 / 58.6% / +13.0% | 5 / 20.0% / -62.5% | 1 / 0.0% / -100.0% | — | — | — | — | — |
| 2 | 67 / 44.8% / -15.1% | 47 / 51.1% / +1.1% | 7 / 28.6% / -46.0% | 2 / 50.0% / -1.9% | — | — | — | — | — |
| 3 | 27 / 48.1% / -6.8% | 23 / 47.8% / -6.5% | 7 / 85.7% / +65.3% | 3 / 66.7% / +131.2% | 1 / 0.0% / -100.0% | 1 / 100.0% / +45.9% | — | — | — |
| 4 | 6 / 16.7% / -68.7% | 7 / 42.9% / -26.1% | 5 / 60.0% / +17.0% | 4 / 50.0% / +14.6% | 2 / 100.0% / +99.2% | 1 / 0.0% / -100.0% | — | — | 1 / 0.0% / -100.0% |
...
ρ(Δcontribution, won) = 0.019   |   ρ(Δcontribution, flat ROI) = 0.021
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 69.6) | 125 | 29.3 | 47.2% | -10.7% | -5.8% |
| Mid  (69.9 .. 126.1) | 126 | 97.2 | 52.4% | +3.8% | -2.6% |
| High (Δ ≥ 126.1) | 126 | 202.7 | 47.6% | -9.1% | +3.1% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 22 | 40.9% | -22.1% | -8.2% |
| 0 < Δ ≤ 50 | 51 | 56.9% | +7.4% | +2.3% |
| 50 < Δ ≤ 100 | 122 | 46.7% | -5.9% | +0.6% |
| Δ > 100 | 182 | 49.5% | -6.5% | -0.8% |
...
| --- | --- | --- | --- | --- |
| STRONG | 139 | 47.5% | -10.4% | -1.7% |
| STANDARD | 134 | 49.3% | -6.0% | -4.3% |
| LEAN | 87 | 52.9% | +2.8% | +8.8% |
| MUTE | 17 | 41.2% | -0.4% | +0.3% |

#### Current V8 ★/units assigned within each proposed tier

| Tier | N | mean ★ | mean units |
| --- | --- | --- | --- |
| STRONG | 139 | 3.96 | 1.68 |
| STANDARD | 134 | 3.29 | 0.98 |
| LEAN | 87 | 3.28 | 0.98 |
| MUTE | 17 | 3.43 | 0.98 |
