...
_Generated 2026-05-12T15:21:21.833Z_

N = 329 picks (LOCKED=219, SHADOW=110)
Baseline: WR 48.9% · flat ROI -5.1% · units-wtd ROI +1.3%
...
#### Threshold T = 30   |   ρ(qFor, won) = 0.062   ρ(qFor, flat ROI) = 0.067

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 1 | 0.0% | -100.0% | — |
| qFor ≥ 1 | 75 | 49.3% | -7.3% | +4.2% |
| qFor ≥ 2 | 115 | 47.0% | -8.8% | -12.8% |
| qFor ≥ 3+ | 138 | 50.7% | -0.2% | +7.4% |

#### Threshold T = 40   |   ρ(qFor, won) = 0.089   ρ(qFor, flat ROI) = 0.081

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 8 | 37.5% | -34.0% | -9.1% |
| qFor ≥ 1 | 106 | 50.0% | -5.3% | -4.0% |
| qFor ≥ 2 | 107 | 47.7% | -7.4% | -1.2% |
| qFor ≥ 3+ | 108 | 50.0% | -0.5% | +5.2% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.133   ρ(qFor, flat ROI) = 0.081

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 41 | 48.8% | -7.7% | -19.8% |
| qFor ≥ 1 | 150 | 50.0% | -3.3% | +8.5% |
| qFor ≥ 2 | 78 | 43.6% | -12.9% | -8.8% |
| qFor ≥ 3+ | 60 | 53.3% | +2.4% | +7.7% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.204   ρ(qFor, flat ROI) = 0.116

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 99 | 46.5% | -11.5% | -13.6% |
| qFor ≥ 1 | 143 | 51.0% | -0.4% | +10.6% |
| qFor ≥ 2 | 46 | 50.0% | -5.5% | -1.3% |
| qFor ≥ 3+ | 41 | 46.3% | -5.5% | +0.5% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.258   ρ(qFor, flat ROI) = 0.143

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 153 | 47.7% | -9.0% | -8.7% |
| qFor ≥ 1 | 123 | 46.3% | -9.2% | +0.7% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.134   ρ(margin, flat ROI) = 0.100

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 36 | 41.7% | -23.5% | -24.1% |
| margin +1 | 123 | 48.8% | -6.1% | +10.7% |
| margin +2 | 91 | 52.7% | +2.1% | +2.4% |
| margin ≥ +3 | 79 | 48.1% | -3.4% | -0.9% |

#### Threshold T = 40   |   ρ(margin, won) = 0.127   ρ(margin, flat ROI) = 0.077

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 51 | 45.1% | -7.9% | -11.4% |
| margin +1 | 133 | 52.6% | +1.7% | +11.3% |
| margin +2 | 86 | 45.3% | -13.1% | -6.5% |
| margin ≥ +3 | 59 | 49.2% | -6.3% | +2.2% |

#### Threshold T = 50   |   ρ(margin, won) = 0.136   ρ(margin, flat ROI) = 0.056

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 85 | 50.6% | +3.2% | +2.7% |
| margin +1 | 150 | 51.3% | -0.5% | +8.9% |
| margin +2 | 60 | 38.3% | -29.2% | -18.7% |
| margin ≥ +3 | 34 | 52.9% | -3.5% | +8.6% |

#### Threshold T = 60   |   ρ(margin, won) = 0.175   ρ(margin, flat ROI) = 0.066

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 137 | 52.6% | +4.3% | +13.6% |
| margin +1 | 133 | 45.9% | -11.7% | -6.0% |
| margin +2 | 37 | 45.9% | -14.3% | -7.1% |
| margin ≥ +3 | 22 | 50.0% | -8.5% | +3.5% |

#### Threshold T = 70   |   ρ(margin, won) = 0.245   ρ(margin, flat ROI) = 0.102

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 191 | 48.2% | -4.9% | +1.7% |
| margin +1 | 101 | 47.5% | -9.8% | -6.0% |
| margin +2 | 28 | 57.1% | +5.1% | +6.3% |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 35 / 51.4% / -3.6% | 6 / 33.3% / -31.7% | — | — | — | — | — |
| 1 | 118 / 50.0% / -4.0% | 29 / 51.7% / +1.4% | 3 / 33.3% / -23.3% | — | — | — | — |
| 2 | 47 / 34.0% / -35.6% | 26 / 53.8% / +1.8% | 4 / 75.0% / +36.5% | 1 / 100.0% / +475.0% | — | — | — |
...
| 5 | 2 / 100.0% / +22.3% | 6 / 50.0% / -15.9% | 3 / 0.0% / -100.0% | 1 / 0.0% / -100.0% | — | — | 1 / 0.0% / -100.0% |
...
| 1 | 78 / 50.0% / -5.8% | 25 / 56.0% / +7.6% | 3 / 0.0% / -100.0% | — | — | — | — | — | — |
| 2 | 57 / 43.9% / -16.3% | 43 / 55.8% / +10.5% | 5 / 20.0% / -61.8% | 2 / 50.0% / -1.9% | — | — | — | — | — |
...
| 5 | 6 / 83.3% / +38.3% | 3 / 66.7% / +26.7% | 5 / 40.0% / +3.0% | 2 / 50.0% / -4.5% | 1 / 0.0% / -100.0% | — | — | — | — |
...
ρ(Δcontribution, won) = -0.003   |   ρ(Δcontribution, flat ROI) = -0.005
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 69.9) | 109 | 32.2 | 48.6% | -7.3% | +2.8% |
| Mid  (70.0 .. 124.5) | 110 | 96.2 | 53.6% | +8.2% | +7.3% |
| High (Δ ≥ 125.4) | 110 | 204.7 | 44.5% | -16.2% | -2.7% |
...
| 0 < Δ ≤ 50 | 46 | 56.5% | +7.0% | +2.5% |
| 50 < Δ ≤ 100 | 109 | 49.5% | +0.5% | +12.0% |
| Δ > 100 | 158 | 47.5% | -10.5% | -3.0% |
...
| --- | --- | --- | --- | --- |
| STRONG | 126 | 46.8% | -11.8% | -0.7% |
| STANDARD | 118 | 50.0% | -4.0% | +4.2% |
| LEAN | 72 | 52.8% | +3.0% | +2.5% |
...
| --- | --- | --- | --- |
| STRONG | 126 | 3.93 | 1.54 |
| STANDARD | 118 | 3.14 | 0.79 |
| LEAN | 72 | 3.20 | 0.83 |
| MUTE | 13 | 3.83 | 1.10 |
