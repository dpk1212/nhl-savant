...
_Generated 2026-06-03T17:27:11.984Z_

N = 737 picks (LOCKED=512, SHADOW=225)
Baseline: WR 50.1% · flat ROI -3.5% · units-wtd ROI -1.9%
...
#### Threshold T = 30   |   ρ(qFor, won) = -0.058   ρ(qFor, flat ROI) = -0.007

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 61 | 54.1% | -1.0% | +9.9% |
| qFor ≥ 1 | 265 | 54.0% | +1.4% | +5.7% |
| qFor ≥ 2 | 191 | 45.0% | -13.2% | -10.5% |
| qFor ≥ 3+ | 220 | 48.6% | -1.7% | -3.6% |

#### Threshold T = 40   |   ρ(qFor, won) = -0.077   ρ(qFor, flat ROI) = -0.022

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 124 | 54.0% | -0.1% | +9.2% |
| qFor ≥ 1 | 288 | 53.8% | +1.4% | +4.9% |
| qFor ≥ 2 | 167 | 43.7% | -10.8% | -7.5% |
| qFor ≥ 3+ | 158 | 46.8% | -7.5% | -10.4% |

#### Threshold T = 50   |   ρ(qFor, won) = -0.001   ρ(qFor, flat ROI) = 0.016

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 196 | 54.1% | +0.5% | +3.4% |
| qFor ≥ 1 | 324 | 50.6% | -3.4% | +3.5% |
| qFor ≥ 2 | 130 | 43.1% | -9.1% | -13.2% |
| qFor ≥ 3+ | 87 | 49.4% | -4.8% | -6.5% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.074   ρ(qFor, flat ROI) = 0.060

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 327 | 51.4% | -3.7% | -1.8% |
| qFor ≥ 1 | 281 | 50.5% | -0.1% | +5.4% |
| qFor ≥ 2 | 75 | 48.0% | -8.0% | -11.7% |
| qFor ≥ 3+ | 54 | 42.6% | -14.1% | -16.0% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.148   ρ(qFor, flat ROI) = 0.090

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 443 | 51.5% | -3.1% | +1.6% |
| qFor ≥ 1 | 219 | 48.9% | -1.9% | -0.4% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.042   ρ(margin, flat ROI) = 0.046

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 170 | 51.8% | +0.1% | -7.4% |
| margin +1 | 298 | 48.3% | -8.7% | -1.6% |
| margin +2 | 147 | 53.7% | +3.8% | +6.9% |
| margin ≥ +3 | 122 | 47.5% | -4.8% | -6.4% |

#### Threshold T = 40   |   ρ(margin, won) = -0.008   ρ(margin, flat ROI) = -0.005

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 229 | 53.7% | +4.6% | +3.9% |
| margin +1 | 285 | 51.6% | -1.8% | +5.7% |
| margin +2 | 139 | 44.6% | -13.0% | -5.5% |
| margin ≥ +3 | 84 | 44.0% | -16.1% | -21.3% |

#### Threshold T = 50   |   ρ(margin, won) = 0.031   ρ(margin, flat ROI) = 0.004

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 280 | 54.6% | +6.8% | +6.1% |
| margin +1 | 311 | 49.2% | -5.9% | -1.7% |
| margin +2 | 98 | 40.8% | -21.5% | -12.8% |
| margin ≥ +3 | 48 | 47.9% | -11.5% | -8.5% |

#### Threshold T = 60   |   ρ(margin, won) = 0.083   ρ(margin, flat ROI) = 0.028

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 394 | 53.3% | +3.5% | +2.4% |
| margin +1 | 262 | 46.9% | -10.1% | -1.3% |
| margin +2 | 56 | 42.9% | -18.6% | -18.8% |
| margin ≥ +3 | 25 | 48.0% | -11.8% | -7.7% |

#### Threshold T = 70   |   ρ(margin, won) = 0.166   ρ(margin, flat ROI) = 0.067

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 501 | 51.7% | +0.2% | +3.8% |
| margin +1 | 185 | 46.5% | -11.5% | -9.6% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 167 / 53.9% / +0.1% | 23 / 56.5% / +7.0% | 6 / 50.0% / -12.9% | — | — | — | — | — |
| 1 | 262 / 49.6% / -6.1% | 50 / 54.0% / +4.7% | 9 / 44.4% / -12.4% | 2 / 100.0% / +135.0% | — | 1 / 100.0% / +82.0% | — | — |
| 2 | 77 / 39.0% / -24.3% | 40 / 42.5% / -17.2% | 8 / 87.5% / +145.2% | 3 / 66.7% / +139.8% | 1 / 0.0% / -100.0% | — | 1 / 0.0% / -100.0% | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 100 / 54.0% / +0.3% | 18 / 50.0% / -7.1% | 6 / 66.7% / +14.6% | — | — | — | — | — | — |
| 1 | 213 / 51.6% / -3.2% | 61 / 63.9% / +20.8% | 9 / 33.3% / -37.9% | 4 / 50.0% / +17.5% | — | 1 / 100.0% / +82.0% | — | — | — |
| 2 | 97 / 43.3% / -16.4% | 56 / 46.4% / -7.5% | 11 / 36.4% / +28.7% | 2 / 50.0% / -1.9% | — | 1 / 0.0% / -100.0% | — | — | — |
...
ρ(Δcontribution, won) = -0.124   |   ρ(Δcontribution, flat ROI) = -0.069
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 50.6) | 245 | 3.0 | 56.3% | +8.1% | +5.5% |
| Mid  (50.6 .. 103.2) | 246 | 74.1 | 47.2% | -8.2% | -1.1% |
| High (Δ ≥ 104.0) | 246 | 172.3 | 46.7% | -10.4% | -6.0% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 76 | 56.6% | +16.6% | +8.0% |
| 0 < Δ ≤ 50 | 163 | 57.1% | +5.8% | +5.6% |
| 50 < Δ ≤ 100 | 238 | 46.2% | -9.9% | -2.4% |
| Δ > 100 | 260 | 47.3% | -9.4% | -5.5% |
...
| --- | --- | --- | --- | --- |
| STRONG | 195 | 44.1% | -14.9% | -11.5% |
| STANDARD | 262 | 49.6% | -6.1% | +0.6% |
| LEAN | 230 | 55.2% | +7.0% | +12.5% |
| MUTE | 50 | 52.0% | +5.8% | -28.6% |

#### Current V8 ★/units assigned within each proposed tier

| Tier | N | mean ★ | mean units |
| --- | --- | --- | --- |
| STRONG | 195 | 4.01 | 1.79 |
| STANDARD | 262 | 3.48 | 1.31 |
| LEAN | 230 | 3.27 | 1.13 |
| MUTE | 50 | 2.50 | 0.95 |
