...
_Generated 2026-06-05T15:34:50.454Z_

N = 779 picks (LOCKED=544, SHADOW=235)
Baseline: WR 50.2% · flat ROI -3.4% · units-wtd ROI -2.2%
...
#### Threshold T = 30   |   ρ(qFor, won) = -0.058   ρ(qFor, flat ROI) = -0.012

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 67 | 55.2% | +2.1% | +9.5% |
| qFor ≥ 1 | 291 | 53.6% | +0.7% | +4.7% |
| qFor ≥ 2 | 195 | 45.6% | -12.1% | -10.9% |
| qFor ≥ 3+ | 226 | 48.2% | -2.7% | -4.0% |

#### Threshold T = 40   |   ρ(qFor, won) = -0.079   ρ(qFor, flat ROI) = -0.029

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 143 | 53.8% | +0.3% | +7.6% |
| qFor ≥ 1 | 306 | 53.9% | +1.5% | +4.9% |
| qFor ≥ 2 | 170 | 44.1% | -10.3% | -9.2% |
| qFor ≥ 3+ | 160 | 46.3% | -8.7% | -10.7% |

#### Threshold T = 50   |   ρ(qFor, won) = -0.005   ρ(qFor, flat ROI) = 0.010

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 218 | 54.1% | +1.0% | +3.3% |
| qFor ≥ 1 | 340 | 50.9% | -3.0% | +3.4% |
| qFor ≥ 2 | 133 | 42.9% | -9.9% | -15.4% |
| qFor ≥ 3+ | 88 | 48.9% | -5.8% | -6.6% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.066   ρ(qFor, flat ROI) = 0.052

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 359 | 51.5% | -3.2% | -2.9% |
| qFor ≥ 1 | 289 | 50.5% | -0.3% | +5.4% |
| qFor ≥ 2 | 76 | 48.7% | -7.0% | -11.4% |
| qFor ≥ 3+ | 55 | 41.8% | -15.7% | -16.2% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.143   ρ(qFor, flat ROI) = 0.084

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 478 | 51.5% | -3.0% | +0.3% |
| qFor ≥ 1 | 225 | 49.3% | -1.2% | +0.3% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.038   ρ(margin, flat ROI) = 0.037

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 190 | 51.6% | -0.0% | -9.1% |
| margin +1 | 315 | 48.9% | -7.8% | +0.4% |
| margin +2 | 149 | 53.7% | +3.7% | +4.6% |
| margin ≥ +3 | 125 | 47.2% | -5.7% | -6.8% |

#### Threshold T = 40   |   ρ(margin, won) = -0.012   ρ(margin, flat ROI) = -0.012

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 255 | 53.7% | +4.6% | +3.7% |
| margin +1 | 297 | 51.9% | -1.4% | +5.6% |
| margin +2 | 142 | 44.4% | -13.6% | -8.0% |
| margin ≥ +3 | 85 | 43.5% | -17.1% | -21.5% |

#### Threshold T = 50   |   ρ(margin, won) = 0.031   ρ(margin, flat ROI) = -0.000

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 305 | 54.8% | +6.9% | +7.0% |
| margin +1 | 325 | 49.2% | -6.0% | -2.6% |
...
| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 426 | 53.3% | +3.4% | +1.1% |
| margin +1 | 270 | 47.0% | -10.0% | -1.1% |
| margin +2 | 57 | 43.9% | -17.1% | -18.4% |
| margin ≥ +3 | 26 | 46.2% | -15.2% | -8.1% |

#### Threshold T = 70   |   ρ(margin, won) = 0.165   ρ(margin, flat ROI) = 0.064

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 536 | 51.7% | +0.1% | +2.4% |
| margin +1 | 191 | 47.1% | -10.5% | -8.5% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 185 / 54.6% / +1.7% | 27 / 51.9% / -0.7% | 6 / 50.0% / -12.9% | — | — | — | — | — |
| 1 | 275 / 49.8% / -5.8% | 53 / 54.7% / +6.1% | 9 / 44.4% / -12.4% | 2 / 100.0% / +135.0% | — | 1 / 100.0% / +82.0% | — | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 115 / 54.8% / +2.4% | 22 / 45.5% / -14.0% | 6 / 66.7% / +14.6% | — | — | — | — | — | — |
| 1 | 225 / 52.0% / -2.6% | 66 / 62.1% / +17.4% | 10 / 40.0% / -26.9% | 4 / 50.0% / +17.5% | — | 1 / 100.0% / +82.0% | — | — | — |
| 2 | 99 / 43.4% / -16.4% | 56 / 46.4% / -7.5% | 11 / 36.4% / +28.7% | 3 / 66.7% / +30.8% | — | 1 / 0.0% / -100.0% | — | — | — |
| 3 | 38 / 44.7% / -14.0% | 33 / 45.5% / -9.9% | 7 / 85.7% / +65.3% | 6 / 50.0% / +39.7% | 1 / 0.0% / -100.0% | 3 / 33.3% / -51.4% | 1 / 0.0% / -100.0% | — | — |
...
ρ(Δcontribution, won) = -0.132   |   ρ(Δcontribution, flat ROI) = -0.080
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 49.6) | 259 | 1.4 | 57.1% | +10.0% | +5.9% |
| Mid  (49.7 .. 100.7) | 260 | 71.6 | 46.2% | -10.7% | -4.6% |
| High (Δ ≥ 101.0) | 260 | 171.1 | 47.3% | -9.4% | -4.9% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 84 | 56.0% | +15.6% | +8.0% |
| 0 < Δ ≤ 50 | 181 | 57.5% | +6.7% | +3.5% |
| 50 < Δ ≤ 100 | 251 | 45.8% | -11.1% | -4.1% |
| Δ > 100 | 263 | 47.5% | -8.9% | -4.8% |
...
| --- | --- | --- | --- | --- |
| STRONG | 199 | 43.7% | -15.8% | -12.9% |
| STANDARD | 275 | 49.8% | -5.8% | -0.3% |
| LEAN | 251 | 55.8% | +7.9% | +14.3% |
...
| --- | --- | --- | --- |
| STRONG | 199 | 4.00 | 1.79 |
| STANDARD | 275 | 3.49 | 1.35 |
| LEAN | 251 | 3.34 | 1.14 |
| MUTE | 54 | 2.56 | 0.97 |
