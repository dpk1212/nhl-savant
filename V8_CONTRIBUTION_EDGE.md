...
_Generated 2026-06-10T16:21:10.796Z_

N = 900 picks (LOCKED=634, SHADOW=266)
Baseline: WR 50.7% · flat ROI -2.6% · units-wtd ROI +1.1%
...
#### Threshold T = 30   |   ρ(qFor, won) = -0.045   ρ(qFor, flat ROI) = -0.019

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 80 | 50.0% | -7.8% | +0.8% |
| qFor ≥ 1 | 346 | 55.8% | +6.2% | +13.2% |
| qFor ≥ 2 | 231 | 47.2% | -10.4% | -6.5% |
| qFor ≥ 3+ | 243 | 46.9% | -5.9% | -5.3% |

#### Threshold T = 40   |   ρ(qFor, won) = -0.056   ρ(qFor, flat ROI) = -0.024

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 177 | 50.8% | -4.5% | -0.1% |
| qFor ≥ 1 | 371 | 55.8% | +5.5% | +13.2% |
| qFor ≥ 2 | 186 | 45.7% | -8.5% | -7.6% |
| qFor ≥ 3+ | 166 | 44.6% | -12.0% | -11.4% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.007   ρ(qFor, flat ROI) = 0.013

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 277 | 52.0% | -1.9% | +2.7% |
| qFor ≥ 1 | 396 | 53.5% | +1.6% | +10.8% |
| qFor ≥ 2 | 137 | 41.6% | -12.5% | -18.4% |
| qFor ≥ 3+ | 90 | 47.8% | -7.9% | -6.9% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.082   ρ(qFor, flat ROI) = 0.060

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 439 | 50.6% | -4.3% | -0.6% |
| qFor ≥ 1 | 326 | 53.4% | +4.2% | +11.5% |
| qFor ≥ 2 | 78 | 47.4% | -9.4% | -14.5% |
| qFor ≥ 3+ | 57 | 40.4% | -18.7% | -16.5% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.154   ρ(qFor, flat ROI) = 0.089

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 577 | 51.3% | -2.9% | +3.9% |
| qFor ≥ 1 | 245 | 51.4% | +2.0% | +2.9% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.016   ρ(margin, flat ROI) = 0.014

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 248 | 52.8% | +2.2% | +4.3% |
| margin +1 | 347 | 50.1% | -5.1% | +1.4% |
| margin +2 | 173 | 52.0% | -0.4% | +5.7% |
| margin ≥ +3 | 132 | 46.2% | -7.9% | -8.1% |

#### Threshold T = 40   |   ρ(margin, won) = -0.001   ρ(margin, flat ROI) = -0.006

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 318 | 52.5% | +1.9% | +2.1% |
| margin +1 | 342 | 54.1% | +3.0% | +13.7% |
| margin +2 | 151 | 44.4% | -14.0% | -7.7% |
| margin ≥ +3 | 89 | 41.6% | -20.8% | -22.2% |

#### Threshold T = 50   |   ρ(margin, won) = 0.035   ρ(margin, flat ROI) = 0.003

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 381 | 53.8% | +5.0% | +8.0% |
| margin +1 | 365 | 51.2% | -2.6% | +4.2% |
| margin +2 | 103 | 39.8% | -23.7% | -19.0% |
| margin ≥ +3 | 51 | 45.1% | -16.7% | -9.1% |

#### Threshold T = 60   |   ρ(margin, won) = 0.097   ρ(margin, flat ROI) = 0.037

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 510 | 52.2% | +1.3% | +3.0% |
| margin +1 | 305 | 50.2% | -4.6% | +5.0% |
| margin +2 | 59 | 42.4% | -19.9% | -22.3% |
| margin ≥ +3 | 26 | 46.2% | -15.2% | -8.1% |

#### Threshold T = 70   |   ρ(margin, won) = 0.172   ρ(margin, flat ROI) = 0.070

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 637 | 51.5% | -0.3% | +5.4% |
| margin +1 | 210 | 49.5% | -6.3% | -5.0% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 234 / 53.0% / +0.1% | 37 / 45.9% / -12.8% | 6 / 50.0% / -12.9% | — | — | — | — | — |
| 1 | 314 / 52.2% / -1.5% | 70 / 58.6% / +12.6% | 9 / 44.4% / -12.4% | 2 / 100.0% / +135.0% | — | 1 / 100.0% / +82.0% | — | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 141 / 52.5% / -1.5% | 30 / 40.0% / -22.3% | 6 / 66.7% / +14.6% | — | — | — | — | — | — |
| 1 | 262 / 54.6% / +3.0% | 90 / 61.1% / +15.6% | 14 / 42.9% / -21.2% | 4 / 50.0% / +17.5% | — | 1 / 100.0% / +82.0% | — | — | — |
| 2 | 106 / 44.3% / -15.1% | 64 / 48.4% / -5.2% | 12 / 41.7% / +31.2% | 3 / 66.7% / +30.8% | — | 1 / 0.0% / -100.0% | — | — | — |
| 3 | 39 / 43.6% / -16.2% | 35 / 42.9% / -15.1% | 7 / 85.7% / +65.3% | 6 / 50.0% / +39.7% | 1 / 0.0% / -100.0% | 3 / 33.3% / -51.4% | 1 / 0.0% / -100.0% | — | — |
| 4 | 7 / 14.3% / -73.2% | 9 / 33.3% / -42.6% | 5 / 60.0% / +17.0% | 5 / 60.0% / +44.6% | 2 / 100.0% / +99.2% | 1 / 0.0% / -100.0% | — | — | 1 / 0.0% / -100.0% |
...
ρ(Δcontribution, won) = -0.149   |   ρ(Δcontribution, flat ROI) = -0.099
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 42.5) | 300 | -2.4 | 56.7% | +9.6% | +14.5% |
| Mid  (42.6 .. 97.1) | 300 | 67.3 | 48.0% | -8.0% | -4.4% |
| High (Δ ≥ 97.1) | 300 | 164.9 | 47.3% | -9.4% | -3.6% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 113 | 54.0% | +10.3% | +4.4% |
| 0 < Δ ≤ 50 | 229 | 58.5% | +9.4% | +15.4% |
| 50 < Δ ≤ 100 | 271 | 46.1% | -10.6% | -3.7% |
| Δ > 100 | 287 | 47.4% | -9.7% | -4.1% |
...
| STANDARD | 314 | 52.2% | -1.5% | +7.2% |
| LEAN | 317 | 55.2% | +7.1% | +15.8% |
| MUTE | 64 | 46.9% | -5.4% | -34.2% |
