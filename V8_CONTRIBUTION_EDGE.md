...
_Generated 2026-05-06T15:11:26.302Z_

N = 285 picks (LOCKED=181, SHADOW=104)
...
#### Threshold T = 30   |   ρ(qFor, won) = 0.060   ρ(qFor, flat ROI) = 0.086

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 1 | 0.0% | -100.0% | — |
| qFor ≥ 1 | 53 | 47.2% | -12.7% | -12.8% |
| qFor ≥ 2 | 108 | 46.3% | -10.1% | -12.1% |
| qFor ≥ 3+ | 123 | 47.2% | -5.1% | -1.8% |

#### Threshold T = 40   |   ρ(qFor, won) = 0.066   ρ(qFor, flat ROI) = 0.086

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 8 | 37.5% | -34.0% | -9.1% |
| qFor ≥ 1 | 81 | 49.4% | -7.2% | -16.6% |
| qFor ≥ 2 | 101 | 46.5% | -9.7% | -1.5% |
| qFor ≥ 3+ | 95 | 45.3% | -6.9% | -5.4% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.081   ρ(qFor, flat ROI) = 0.070

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 40 | 50.0% | -5.4% | -17.5% |
| qFor ≥ 1 | 124 | 49.2% | -5.0% | +6.4% |
| qFor ≥ 2 | 67 | 38.8% | -22.8% | -27.2% |
| qFor ≥ 3+ | 54 | 48.1% | -2.3% | +2.5% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.150   ρ(qFor, flat ROI) = 0.105

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 95 | 47.4% | -9.9% | -11.7% |
| qFor ≥ 1 | 116 | 49.1% | -4.6% | +2.4% |
| qFor ≥ 2 | 36 | 41.7% | -18.4% | -17.9% |
| qFor ≥ 3+ | 38 | 42.1% | -9.5% | -3.4% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.182   ρ(qFor, flat ROI) = 0.106

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 143 | 49.0% | -6.7% | -6.3% |
| qFor ≥ 1 | 99 | 42.4% | -17.3% | -8.3% |
| qFor ≥ 2 | 30 | 50.0% | -1.4% | -11.2% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.143   ρ(margin, flat ROI) = 0.121

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 24 | 33.3% | -39.6% | -56.5% |
| margin +1 | 108 | 47.2% | -8.9% | +3.5% |
| margin +2 | 84 | 51.2% | -1.8% | +0.6% |
| margin ≥ +3 | 69 | 44.9% | -6.1% | -10.6% |

#### Threshold T = 40   |   ρ(margin, won) = 0.116   ρ(margin, flat ROI) = 0.080

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 40 | 42.5% | -9.3% | -18.0% |
| margin +1 | 115 | 51.3% | -1.1% | +2.4% |
| margin +2 | 79 | 43.0% | -18.6% | -10.7% |
| margin ≥ +3 | 51 | 45.1% | -10.3% | -6.3% |

#### Threshold T = 50   |   ρ(margin, won) = 0.105   ρ(margin, flat ROI) = 0.048
...
#### Threshold T = 60   |   ρ(margin, won) = 0.145   ρ(margin, flat ROI) = 0.054
...
#### Threshold T = 70   |   ρ(margin, won) = 0.187   ρ(margin, flat ROI) = 0.064

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 175 | 48.0% | -4.7% | -0.0% |
| margin +1 | 80 | 43.8% | -18.2% | -16.3% |
| margin +2 | 22 | 45.5% | -12.7% | -16.8% |
...
| 1 | 98 / 50.0% / -4.7% | 24 / 45.8% / -7.8% | 2 / 50.0% / +15.0% | — | — | — | — |
| 2 | 40 / 30.0% / -43.9% | 23 / 47.8% / -12.9% | 3 / 66.7% / +16.6% | 1 / 100.0% / +475.0% | — | — | — |
| 3 | 8 / 62.5% / +22.9% | 8 / 75.0% / +28.8% | 4 / 50.0% / +47.6% | 1 / 100.0% / +198.0% | 1 / 0.0% / -100.0% | — | — |
...
| 1 | 62 / 48.4% / -10.4% | 18 / 55.6% / +9.0% | 1 / 0.0% / -100.0% | — | — | — | — | — | — |
| 2 | 53 / 43.4% / -17.5% | 42 / 54.8% / +8.6% | 5 / 20.0% / -61.8% | 1 / 0.0% / -100.0% | — | — | — | — | — |
| 3 | 19 / 42.1% / -18.3% | 21 / 42.9% / -17.5% | 6 / 83.3% / +61.0% | 3 / 66.7% / +131.2% | 1 / 0.0% / -100.0% | — | — | — | — |
...
ρ(Δcontribution, won) = -0.042   |   ρ(Δcontribution, flat ROI) = -0.023
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 71.0) | 95 | 35.3 | 46.3% | -7.1% | -1.8% |
| Mid  (71.7 .. 124.4) | 95 | 96.8 | 54.7% | +6.9% | +4.1% |
| High (Δ ≥ 124.5) | 95 | 203.6 | 38.9% | -26.0% | -13.7% |
...
| 0 < Δ ≤ 50 | 40 | 55.0% | +6.0% | -3.3% |
| 50 < Δ ≤ 100 | 94 | 48.9% | -0.0% | +6.8% |
| Δ > 100 | 139 | 43.9% | -16.9% | -11.3% |
...
| --- | --- | --- | --- | --- |
| STRONG | 111 | 42.3% | -19.2% | -11.1% |
| STANDARD | 98 | 50.0% | -4.7% | +1.7% |
| LEAN | 66 | 50.0% | -1.7% | -5.9% |
...
| --- | --- | --- | --- |
| STRONG | 111 | 3.84 | 1.38 |
| STANDARD | 98 | 3.01 | 0.70 |
| LEAN | 66 | 3.16 | 0.80 |
| MUTE | 10 | 3.92 | 1.14 |
