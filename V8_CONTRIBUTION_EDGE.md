...
_Generated 2026-05-29T16:23:24.373Z_

N = 636 picks (LOCKED=438, SHADOW=198)
Baseline: WR 49.8% · flat ROI -4.0% · units-wtd ROI -3.6%
...
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 42 | 57.1% | +3.0% | +10.4% |
| qFor ≥ 1 | 218 | 53.2% | -0.7% | +6.4% |
| qFor ≥ 2 | 167 | 43.7% | -15.2% | -19.4% |
| qFor ≥ 3+ | 209 | 49.8% | +0.2% | -2.6% |

#### Threshold T = 40   |   ρ(qFor, won) = -0.056   ρ(qFor, flat ROI) = -0.008

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 79 | 57.0% | +5.4% | +19.4% |
| qFor ≥ 1 | 245 | 52.2% | -2.3% | +0.2% |
| qFor ≥ 2 | 157 | 44.6% | -9.5% | -8.0% |
| qFor ≥ 3+ | 155 | 47.7% | -5.7% | -8.8% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.013   ρ(qFor, flat ROI) = 0.022

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 146 | 55.5% | +3.2% | +4.8% |
| qFor ≥ 1 | 280 | 49.6% | -5.7% | +0.8% |
| qFor ≥ 2 | 124 | 43.5% | -8.6% | -13.2% |
| qFor ≥ 3+ | 86 | 50.0% | -3.7% | -6.5% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.085   ρ(qFor, flat ROI) = 0.064

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 259 | 51.7% | -3.1% | -4.2% |
| qFor ≥ 1 | 249 | 49.8% | -1.8% | +4.1% |
| qFor ≥ 2 | 75 | 48.0% | -8.0% | -11.7% |
| qFor ≥ 3+ | 53 | 43.4% | -12.5% | -16.0% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.162   ρ(qFor, flat ROI) = 0.103

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 360 | 51.1% | -4.2% | -2.7% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.061   ρ(margin, flat ROI) = 0.064

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 126 | 51.6% | +0.4% | -5.3% |
| margin +1 | 264 | 47.3% | -11.0% | -6.9% |
| margin +2 | 131 | 54.2% | +5.0% | +5.1% |
| margin ≥ +3 | 115 | 48.7% | -2.7% | -5.7% |

#### Threshold T = 40   |   ρ(margin, won) = 0.009   ρ(margin, flat ROI) = 0.001

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 171 | 54.4% | +7.5% | +6.8% |
| margin +1 | 252 | 50.8% | -3.8% | +1.5% |
| margin +2 | 131 | 45.0% | -12.9% | -7.3% |
| margin ≥ +3 | 82 | 45.1% | -14.0% | -19.0% |

#### Threshold T = 50   |   ρ(margin, won) = 0.046   ρ(margin, flat ROI) = 0.007

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 220 | 55.0% | +8.8% | +6.0% |
| margin +1 | 276 | 48.9% | -6.9% | -3.4% |
| margin +2 | 93 | 40.9% | -22.6% | -14.2% |
| margin ≥ +3 | 47 | 48.9% | -9.6% | -8.5% |

#### Threshold T = 60   |   ρ(margin, won) = 0.090   ρ(margin, flat ROI) = 0.027

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 322 | 53.7% | +4.9% | +2.8% |
| margin +1 | 234 | 46.2% | -12.2% | -4.3% |
| margin +2 | 55 | 43.6% | -17.1% | -18.8% |
| margin ≥ +3 | 25 | 48.0% | -11.8% | -7.7% |

#### Threshold T = 70   |   ρ(margin, won) = 0.170   ρ(margin, flat ROI) = 0.070

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 416 | 51.7% | +0.4% | +1.4% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 125 / 56.0% / +4.1% | 18 / 50.0% / -3.9% | 3 / 66.7% / +10.0% | — | — | — | — | — |
| 1 | 228 / 49.1% / -7.6% | 42 / 50.0% / -3.0% | 7 / 42.9% / -12.4% | 2 / 100.0% / +135.0% | — | 1 / 100.0% / +82.0% | — | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 66 / 59.1% / +9.3% | 10 / 30.0% / -38.3% | 3 / 100.0% / +64.9% | — | — | — | — | — | — |
| 1 | 181 / 50.3% / -6.8% | 51 / 62.7% / +18.3% | 8 / 25.0% / -52.1% | 4 / 50.0% / +17.5% | — | 1 / 100.0% / +82.0% | — | — | — |
| 2 | 90 / 43.3% / -17.6% | 55 / 47.3% / -5.9% | 10 / 40.0% / +41.6% | 2 / 50.0% / -1.9% | — | — | — | — | — |
...
ρ(Δcontribution, won) = -0.111   |   ρ(Δcontribution, flat ROI) = -0.059
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 53.8) | 212 | 8.9 | 56.6% | +8.7% | +7.0% |
| Mid  (54.1 .. 110.2) | 212 | 79.7 | 46.7% | -8.6% | -4.4% |
| High (Δ ≥ 111.1) | 212 | 180.0 | 46.2% | -12.0% | -7.5% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 56 | 55.4% | +18.6% | +6.6% |
| 0 < Δ ≤ 50 | 126 | 60.3% | +10.9% | +14.5% |
| 50 < Δ ≤ 100 | 209 | 44.5% | -13.1% | -7.4% |
| Δ > 100 | 245 | 47.8% | -9.0% | -7.0% |
...
| STANDARD | 228 | 49.1% | -7.6% | -1.8% |
| LEAN | 180 | 56.1% | +9.7% | +13.7% |
| MUTE | 40 | 50.0% | +4.8% | -28.3% |
