...
_Generated 2026-06-07T14:28:06.903Z_

N = 825 picks (LOCKED=576, SHADOW=249)
...
#### Threshold T = 30   |   ρ(qFor, won) = -0.047   ρ(qFor, flat ROI) = -0.010

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 70 | 52.9% | -2.2% | +6.2% |
| qFor ≥ 1 | 316 | 53.8% | +1.3% | +6.5% |
| qFor ≥ 2 | 208 | 46.2% | -11.9% | -9.8% |
| qFor ≥ 3+ | 231 | 48.1% | -3.3% | -3.9% |

#### Threshold T = 40   |   ρ(qFor, won) = -0.073   ρ(qFor, flat ROI) = -0.028

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 157 | 52.9% | -1.7% | +4.8% |
| qFor ≥ 1 | 332 | 54.2% | +2.0% | +7.4% |
| qFor ≥ 2 | 174 | 44.3% | -10.4% | -9.5% |
| qFor ≥ 3+ | 162 | 45.7% | -9.8% | -10.9% |

#### Threshold T = 50   |   ρ(qFor, won) = -0.004   ρ(qFor, flat ROI) = 0.008

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 242 | 53.3% | -0.5% | +5.3% |
| qFor ≥ 1 | 359 | 51.5% | -2.1% | +4.5% |
| qFor ≥ 2 | 135 | 42.2% | -11.2% | -17.2% |
| qFor ≥ 3+ | 89 | 48.3% | -6.9% | -6.8% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.070   ρ(qFor, flat ROI) = 0.053

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 389 | 51.2% | -3.9% | -0.7% |
| qFor ≥ 1 | 302 | 51.3% | +0.8% | +6.1% |
| qFor ≥ 2 | 78 | 47.4% | -9.4% | -14.5% |
| qFor ≥ 3+ | 56 | 41.1% | -17.2% | -16.3% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.144   ρ(qFor, flat ROI) = 0.084

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 517 | 51.5% | -3.2% | +2.3% |
| qFor ≥ 1 | 231 | 49.4% | -1.5% | -1.1% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.041   ρ(margin, flat ROI) = 0.038

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 211 | 51.2% | -0.8% | -2.1% |
| margin +1 | 330 | 48.8% | -8.2% | -3.6% |
| margin +2 | 157 | 54.1% | +4.0% | +8.2% |
| margin ≥ +3 | 127 | 47.2% | -5.7% | -6.7% |

#### Threshold T = 40   |   ρ(margin, won) = -0.000   ρ(margin, flat ROI) = -0.004

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 280 | 52.5% | +1.8% | +1.9% |
| margin +1 | 315 | 52.7% | +0.1% | +7.6% |
| margin +2 | 144 | 44.4% | -13.7% | -6.6% |
| margin ≥ +3 | 86 | 43.0% | -18.0% | -21.6% |

#### Threshold T = 50   |   ρ(margin, won) = 0.035   ρ(margin, flat ROI) = 0.002
...
#### Threshold T = 60   |   ρ(margin, won) = 0.089   ρ(margin, flat ROI) = 0.029
...
#### Threshold T = 70   |   ρ(margin, won) = 0.172   ρ(margin, flat ROI) = 0.069

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 576 | 51.6% | -0.4% | +4.0% |
| margin +1 | 197 | 47.2% | -10.5% | -9.5% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 207 / 54.1% / +0.9% | 29 / 48.3% / -7.6% | 6 / 50.0% / -12.9% | — | — | — | — | — |
| 1 | 290 / 50.7% / -4.4% | 57 / 54.4% / +5.3% | 9 / 44.4% / -12.4% | 2 / 100.0% / +135.0% | — | 1 / 100.0% / +82.0% | — | — |
| 2 | 80 / 38.8% / -25.0% | 42 / 40.5% / -21.2% | 8 / 87.5% / +145.2% | 3 / 66.7% / +139.8% | 1 / 0.0% / -100.0% | — | 1 / 0.0% / -100.0% | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 127 / 54.3% / +1.3% | 24 / 41.7% / -21.2% | 6 / 66.7% / +14.6% | — | — | — | — | — | — |
| 1 | 240 / 53.3% / -0.0% | 76 / 59.2% / +11.9% | 11 / 36.4% / -33.6% | 4 / 50.0% / +17.5% | — | 1 / 100.0% / +82.0% | — | — | — |
| 2 | 100 / 44.0% / -15.7% | 59 / 45.8% / -9.3% | 11 / 36.4% / +28.7% | 3 / 66.7% / +30.8% | — | 1 / 0.0% / -100.0% | — | — | — |
...
ρ(Δcontribution, won) = -0.127   |   ρ(Δcontribution, flat ROI) = -0.078
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 46.5) | 275 | -0.1 | 56.0% | +8.3% | +7.1% |
| Mid  (46.7 .. 99.4) | 275 | 69.8 | 46.2% | -11.8% | -4.8% |
| High (Δ ≥ 99.9) | 275 | 168.3 | 48.4% | -7.3% | -3.9% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 93 | 52.7% | +8.4% | +7.7% |
| 0 < Δ ≤ 50 | 203 | 57.6% | +7.4% | +6.5% |
| 50 < Δ ≤ 100 | 256 | 45.7% | -11.6% | -4.6% |
| Δ > 100 | 273 | 48.0% | -8.4% | -4.6% |
...
| --- | --- | --- | --- | --- |
| STRONG | 202 | 43.1% | -17.1% | -14.2% |
| STANDARD | 290 | 50.7% | -4.4% | +2.3% |
| LEAN | 277 | 55.2% | +6.7% | +13.8% |
| MUTE | 56 | 48.2% | -1.6% | -34.6% |

#### Current V8 ★/units assigned within each proposed tier

| Tier | N | mean ★ | mean units |
| --- | --- | --- | --- |
| STRONG | 202 | 4.00 | 1.79 |
| STANDARD | 290 | 3.53 | 1.39 |
| LEAN | 277 | 3.35 | 1.16 |
| MUTE | 56 | 2.58 | 0.96 |
