...
_Generated 2026-05-04T14:38:52.245Z_

N = 261 picks (LOCKED=169, SHADOW=92)
...
#### Threshold T = 30   |   ρ(qFor, won) = 0.064   ρ(qFor, flat ROI) = 0.089

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 1 | 0.0% | -100.0% | — |
| qFor ≥ 1 | 39 | 48.7% | -9.8% | -10.8% |
| qFor ≥ 2 | 105 | 46.7% | -9.4% | -11.1% |
| qFor ≥ 3+ | 116 | 48.3% | -2.7% | +0.7% |

#### Threshold T = 40   |   ρ(qFor, won) = 0.082   ρ(qFor, flat ROI) = 0.098

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 6 | 16.7% | -72.5% | -34.0% |
| qFor ≥ 1 | 68 | 51.5% | -3.2% | -17.3% |
| qFor ≥ 2 | 98 | 46.9% | -8.9% | -3.3% |
| qFor ≥ 3+ | 89 | 47.2% | -2.8% | +0.0% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.104   ρ(qFor, flat ROI) = 0.088

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 36 | 44.4% | -14.4% | -24.8% |
| qFor ≥ 1 | 112 | 50.9% | -1.9% | +5.3% |
| qFor ≥ 2 | 64 | 40.6% | -19.2% | -23.3% |
| qFor ≥ 3+ | 49 | 51.0% | +3.7% | +9.9% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.167   ρ(qFor, flat ROI) = 0.119

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 89 | 46.1% | -11.7% | -12.0% |
| qFor ≥ 1 | 105 | 50.5% | -2.1% | +1.4% |
| qFor ≥ 2 | 34 | 44.1% | -13.6% | -14.9% |
| qFor ≥ 3+ | 33 | 45.5% | -1.7% | +6.0% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.189   ρ(qFor, flat ROI) = 0.110

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 133 | 49.6% | -5.0% | -3.4% |
| qFor ≥ 1 | 89 | 41.6% | -19.1% | -15.3% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.127   ρ(margin, flat ROI) = 0.110

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 22 | 36.4% | -34.1% | -39.4% |
| margin +1 | 94 | 47.9% | -7.2% | +4.9% |
| margin +2 | 81 | 51.9% | -0.5% | +1.8% |
| margin ≥ +3 | 64 | 45.3% | -4.9% | -12.0% |

#### Threshold T = 40   |   ρ(margin, won) = 0.111   ρ(margin, flat ROI) = 0.076

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 36 | 41.7% | -9.3% | -3.7% |
| margin +1 | 102 | 52.9% | +2.4% | +2.8% |
| margin +2 | 76 | 43.4% | -18.0% | -13.5% |
| margin ≥ +3 | 47 | 46.8% | -6.9% | -2.3% |

#### Threshold T = 50   |   ρ(margin, won) = 0.109   ρ(margin, flat ROI) = 0.048
...
#### Threshold T = 60   |   ρ(margin, won) = 0.154   ρ(margin, flat ROI) = 0.058
...
#### Threshold T = 70   |   ρ(margin, won) = 0.185   ρ(margin, flat ROI) = 0.057

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 164 | 48.8% | -2.6% | +2.8% |
| margin +1 | 70 | 42.9% | -20.6% | -25.6% |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 31 / 45.2% / -13.8% | 5 / 40.0% / -18.0% | — | — | — | — | — |
| 1 | 87 / 51.7% / -1.8% | 23 / 47.8% / -3.8% | 2 / 50.0% / +15.0% | — | — | — | — |
| 2 | 37 / 32.4% / -39.4% | 23 / 47.8% / -12.9% | 3 / 66.7% / +16.6% | 1 / 100.0% / +475.0% | — | — | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 3 / 0.0% / -100.0% | 2 / 0.0% / -100.0% | 1 / 100.0% / +64.9% | — | — | — | — | — | — |
| 1 | 50 / 50.0% / -7.6% | 17 / 58.8% / +15.4% | 1 / 0.0% / -100.0% | — | — | — | — | — | — |
| 2 | 50 / 44.0% / -16.5% | 42 / 54.8% / +8.6% | 5 / 20.0% / -61.8% | 1 / 0.0% / -100.0% | — | — | — | — | — |
...
| 5 | 3 / 66.7% / +30.2% | 3 / 66.7% / +26.7% | 5 / 40.0% / +3.0% | 2 / 50.0% / -4.5% | 1 / 0.0% / -100.0% | — | — | — | — |
...
ρ(Δcontribution, won) = -0.051   |   ρ(Δcontribution, flat ROI) = -0.031
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 71.9) | 87 | 35.4 | 48.3% | -2.6% | +10.4% |
| Mid  (72.3 .. 124.5) | 87 | 97.9 | 54.0% | +5.8% | -1.0% |
| High (Δ ≥ 125.4) | 87 | 204.3 | 40.2% | -23.7% | -13.4% |
...
| 0 < Δ ≤ 50 | 35 | 51.4% | +1.0% | +3.3% |
| 50 < Δ ≤ 100 | 86 | 51.2% | +4.5% | +8.6% |
| Δ > 100 | 129 | 45.0% | -15.0% | -11.0% |
...
| --- | --- | --- | --- | --- |
| STRONG | 104 | 44.2% | -15.6% | -7.8% |
| STANDARD | 87 | 51.7% | -1.8% | -2.4% |
| LEAN | 60 | 48.3% | -3.6% | +0.4% |
...
| --- | --- | --- | --- |
| STRONG | 104 | 3.80 | 1.35 |
| STANDARD | 87 | 3.03 | 0.69 |
| LEAN | 60 | 3.15 | 0.77 |
| MUTE | 10 | 3.92 | 1.14 |
