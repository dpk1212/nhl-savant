...
_Generated 2026-07-05T14:15:43.268Z_

N = 1547 picks (LOCKED=1137, SHADOW=410)
...
#### Threshold T = 30   |   ρ(qFor, won) = 0.006   ρ(qFor, flat ROI) = 0.007

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 228 | 44.7% | -15.0% | -12.8% |
| qFor ≥ 1 | 630 | 54.4% | +2.6% | +8.1% |
| qFor ≥ 2 | 350 | 47.1% | -11.2% | -13.2% |
| qFor ≥ 3+ | 339 | 50.4% | -2.5% | -3.2% |

#### Threshold T = 40   |   ρ(qFor, won) = -0.011   ρ(qFor, flat ROI) = -0.002

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 494 | 49.4% | -6.6% | -2.8% |
| qFor ≥ 1 | 585 | 54.2% | +1.4% | +5.4% |
| qFor ≥ 2 | 247 | 47.0% | -8.4% | -9.3% |
| qFor ≥ 3+ | 221 | 47.1% | -9.1% | -10.4% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.048   ρ(qFor, flat ROI) = 0.045

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 707 | 49.6% | -6.6% | -5.9% |
| qFor ≥ 1 | 546 | 52.6% | -1.3% | +5.9% |
| qFor ≥ 2 | 174 | 46.6% | -5.0% | -12.2% |
| qFor ≥ 3+ | 120 | 51.7% | -2.8% | -1.1% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.119   ρ(qFor, flat ROI) = 0.086

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 949 | 50.2% | -5.7% | -4.3% |
| qFor ≥ 1 | 428 | 52.3% | +1.0% | +6.3% |
| qFor ≥ 2 | 95 | 47.4% | -9.8% | -13.4% |
| qFor ≥ 3+ | 75 | 48.0% | -8.0% | -7.4% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.198   ρ(qFor, flat ROI) = 0.113

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 1127 | 50.6% | -4.7% | -1.5% |
| qFor ≥ 1 | 317 | 50.8% | -1.4% | -0.4% |
| qFor ≥ 2 | 63 | 49.2% | -9.2% | -12.0% |
| qFor ≥ 3+ | 40 | 47.5% | -5.8% | -9.0% |
...
| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 544 | 49.8% | -4.5% | -0.6% |
| margin +1 | 571 | 50.8% | -5.0% | -3.7% |
| margin +2 | 254 | 52.8% | -0.2% | +4.6% |
| margin ≥ +3 | 178 | 48.3% | -6.6% | -8.4% |

#### Threshold T = 40   |   ρ(margin, won) = 0.023   ρ(margin, flat ROI) = 0.008

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 721 | 51.0% | -2.6% | -0.3% |
| margin +1 | 503 | 52.7% | -0.5% | +3.7% |
| margin +2 | 202 | 46.0% | -12.0% | -7.4% |
| margin ≥ +3 | 121 | 45.5% | -16.4% | -19.7% |

#### Threshold T = 50   |   ρ(margin, won) = 0.060   ρ(margin, flat ROI) = 0.029
...
#### Threshold T = 60   |   ρ(margin, won) = 0.129   ρ(margin, flat ROI) = 0.070
...
#### Threshold T = 70   |   ρ(margin, won) = 0.209   ρ(margin, flat ROI) = 0.099

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 1199 | 50.8% | -3.1% | +0.1% |
| margin +1 | 278 | 49.3% | -7.4% | -7.4% |
| margin +2 | 46 | 45.7% | -16.3% | -17.5% |
| margin ≥ +3 | 24 | 58.3% | +2.5% | +4.9% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 604 / 49.0% / -8.0% | 90 / 53.3% / +3.2% | 10 / 60.0% / +3.6% | 1 / 100.0% / +90.9% | 1 / 0.0% / -100.0% | — | — | — | — | — | — | — | 1 / 0.0% / -100.0% |
| 1 | 431 / 51.3% / -3.4% | 94 / 59.6% / +10.3% | 13 / 53.8% / -2.2% | 3 / 66.7% / +56.7% | — | 2 / 50.0% / -9.0% | 2 / 0.0% / -100.0% | — | — | — | — | — | 1 / 0.0% / -100.0% |
...
| 5 | 4 / 75.0% / -1.6% | 10 / 40.0% / -30.5% | 7 / 28.6% / -46.3% | 3 / 0.0% / -100.0% | 1 / 100.0% / +10.5% | — | 1 / 0.0% / -100.0% | — | — | — | — | — | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 400 / 48.3% / -9.5% | 82 / 53.7% / +4.3% | 9 / 66.7% / +30.0% | 2 / 50.0% / -4.5% | 1 / 0.0% / -100.0% | — | — | — | — | — | — | — | — | — | — |
| 1 | 406 / 52.5% / -1.3% | 141 / 58.2% / +8.9% | 28 / 60.7% / +6.1% | 7 / 57.1% / +7.3% | — | 2 / 50.0% / -9.0% | — | 1 / 0.0% / -100.0% | — | — | — | — | — | — | — |
| 2 | 148 / 46.6% / -12.5% | 76 / 50.0% / -3.3% | 15 / 46.7% / +28.8% | 4 / 50.0% / -1.9% | — | 2 / 0.0% / -100.0% | — | — | — | — | — | — | — | 1 / 0.0% / -100.0% | 1 / 0.0% / -100.0% |
...
| 5 | 7 / 85.7% / +41.8% | 10 / 40.0% / -28.6% | 5 / 40.0% / +3.0% | 5 / 40.0% / -12.8% | 4 / 50.0% / -6.0% | 1 / 100.0% / +10.5% | 1 / 100.0% / +129.0% | — | — | — | — | — | — | — | — |
...
ρ(Δcontribution, won) = -0.102   |   ρ(Δcontribution, flat ROI) = -0.066
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 27.4) | 515 | -22.0 | 50.3% | -3.3% | +3.1% |
| Mid  (27.4 .. 76.4) | 516 | 49.8 | 52.5% | -0.9% | +0.3% |
| High (Δ ≥ 76.4) | 516 | 155.9 | 48.6% | -8.4% | -7.9% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 260 | 50.4% | -0.2% | -1.6% |
| 0 < Δ ≤ 50 | 521 | 52.0% | -2.8% | -0.3% |
| 50 < Δ ≤ 100 | 386 | 50.3% | -4.4% | +1.2% |
| Δ > 100 | 380 | 48.7% | -8.8% | -6.7% |
...
| --- | --- | --- | --- | --- |
| STRONG | 264 | 47.3% | -11.1% | -9.2% |
| STANDARD | 431 | 51.3% | -3.4% | +2.3% |
| LEAN | 715 | 51.0% | -3.1% | -0.8% |
| MUTE | 137 | 51.1% | +0.9% | -6.3% |

#### Current V8 ★/units assigned within each proposed tier

| Tier | N | mean ★ | mean units |
| --- | --- | --- | --- |
| STRONG | 264 | 3.95 | 1.79 |
| STANDARD | 431 | 3.66 | 1.49 |
| LEAN | 715 | 3.67 | 1.36 |
| MUTE | 137 | 3.04 | 1.19 |
