...
_Generated 2026-06-06T14:16:14.497Z_

N = 799 picks (LOCKED=562, SHADOW=237)
...
#### Threshold T = 30   |   ρ(qFor, won) = -0.054   ρ(qFor, flat ROI) = -0.013

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 69 | 53.6% | -0.8% | +6.2% |
| qFor ≥ 1 | 303 | 54.5% | +2.6% | +7.1% |
| qFor ≥ 2 | 198 | 46.5% | -11.0% | -9.1% |
| qFor ≥ 3+ | 229 | 48.0% | -3.2% | -4.0% |

#### Threshold T = 40   |   ρ(qFor, won) = -0.079   ρ(qFor, flat ROI) = -0.033

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 149 | 54.4% | +1.6% | +7.8% |
| qFor ≥ 1 | 316 | 54.4% | +2.5% | +6.6% |
| qFor ≥ 2 | 172 | 44.8% | -9.4% | -7.7% |
| qFor ≥ 3+ | 162 | 45.7% | -9.8% | -10.9% |

#### Threshold T = 50   |   ρ(qFor, won) = -0.009   ρ(qFor, flat ROI) = 0.003

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 228 | 54.8% | +2.6% | +6.7% |
| qFor ≥ 1 | 349 | 51.3% | -2.5% | +4.0% |
| qFor ≥ 2 | 133 | 42.9% | -9.9% | -15.4% |
| qFor ≥ 3+ | 89 | 48.3% | -6.9% | -6.8% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.068   ρ(qFor, flat ROI) = 0.049

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 369 | 52.0% | -2.1% | -0.7% |
| qFor ≥ 1 | 298 | 51.0% | +0.3% | +5.9% |
| qFor ≥ 2 | 76 | 48.7% | -7.0% | -11.4% |
| qFor ≥ 3+ | 56 | 41.1% | -17.2% | -16.3% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.143   ρ(qFor, flat ROI) = 0.081

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 493 | 52.1% | -1.7% | +2.3% |
| qFor ≥ 1 | 229 | 49.3% | -1.4% | +0.2% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.037   ρ(margin, flat ROI) = 0.033

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 200 | 52.0% | +0.9% | -3.5% |
| margin +1 | 321 | 49.2% | -7.2% | -0.4% |
| margin +2 | 151 | 54.3% | +4.4% | +5.9% |
| margin ≥ +3 | 127 | 47.2% | -5.7% | -6.7% |

#### Threshold T = 40   |   ρ(margin, won) = -0.006   ρ(margin, flat ROI) = -0.011

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 262 | 53.8% | +4.8% | +3.8% |
| margin +1 | 307 | 52.8% | +0.3% | +7.5% |
| margin +2 | 144 | 44.4% | -13.7% | -6.6% |
...
#### Threshold T = 60   |   ρ(margin, won) = 0.086   ρ(margin, flat ROI) = 0.025
...
#### Threshold T = 70   |   ρ(margin, won) = 0.171   ρ(margin, flat ROI) = 0.066

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 552 | 52.2% | +1.0% | +4.2% |
| margin +1 | 195 | 47.2% | -10.5% | -8.2% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 194 / 55.7% / +4.1% | 28 / 50.0% / -4.3% | 6 / 50.0% / -12.9% | — | — | — | — | — |
| 1 | 284 / 50.4% / -5.0% | 53 / 54.7% / +6.1% | 9 / 44.4% / -12.4% | 2 / 100.0% / +135.0% | — | 1 / 100.0% / +82.0% | — | — |
| 2 | 79 / 39.2% / -24.1% | 41 / 41.5% / -19.2% | 8 / 87.5% / +145.2% | 3 / 66.7% / +139.8% | 1 / 0.0% / -100.0% | — | 1 / 0.0% / -100.0% | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 121 / 55.4% / +3.7% | 22 / 45.5% / -14.0% | 6 / 66.7% / +14.6% | — | — | — | — | — | — |
| 1 | 234 / 53.0% / -0.6% | 67 / 61.2% / +15.7% | 10 / 40.0% / -26.9% | 4 / 50.0% / +17.5% | — | 1 / 100.0% / +82.0% | — | — | — |
| 2 | 100 / 44.0% / -15.7% | 57 / 47.4% / -6.1% | 11 / 36.4% / +28.7% | 3 / 66.7% / +30.8% | — | 1 / 0.0% / -100.0% | — | — | — |
| 3 | 38 / 44.7% / -14.0% | 34 / 44.1% / -12.6% | 7 / 85.7% / +65.3% | 6 / 50.0% / +39.7% | 1 / 0.0% / -100.0% | 3 / 33.3% / -51.4% | 1 / 0.0% / -100.0% | — | — |
...
ρ(Δcontribution, won) = -0.134   |   ρ(Δcontribution, flat ROI) = -0.086
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 49.0) | 266 | 1.0 | 57.5% | +10.9% | +8.9% |
| Mid  (49.2 .. 100.2) | 266 | 70.9 | 46.6% | -9.9% | -3.3% |
| High (Δ ≥ 100.3) | 267 | 170.1 | 47.6% | -9.2% | -5.0% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 87 | 56.3% | +15.8% | +13.0% |
| 0 < Δ ≤ 50 | 191 | 57.6% | +7.6% | +6.6% |
| 50 < Δ ≤ 100 | 253 | 46.2% | -10.5% | -3.8% |
| Δ > 100 | 268 | 47.8% | -8.7% | -4.9% |
...
| --- | --- | --- | --- | --- |
| STRONG | 200 | 43.5% | -16.2% | -13.0% |
| STANDARD | 284 | 50.4% | -5.0% | +0.6% |
| LEAN | 260 | 56.5% | +9.5% | +16.6% |
| MUTE | 55 | 49.1% | +0.2% | -33.3% |

#### Current V8 ★/units assigned within each proposed tier

| Tier | N | mean ★ | mean units |
| --- | --- | --- | --- |
| STRONG | 200 | 3.99 | 1.78 |
| STANDARD | 284 | 3.51 | 1.37 |
| LEAN | 260 | 3.35 | 1.15 |
| MUTE | 55 | 2.56 | 0.96 |
