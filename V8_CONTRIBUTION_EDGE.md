...
_Generated 2026-06-09T15:38:33.087Z_

N = 874 picks (LOCKED=613, SHADOW=261)
Baseline: WR 50.7% · flat ROI -2.7% · units-wtd ROI -0.1%
...
#### Threshold T = 30   |   ρ(qFor, won) = -0.051   ρ(qFor, flat ROI) = -0.021

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 74 | 54.1% | -0.4% | +7.0% |
| qFor ≥ 1 | 335 | 54.9% | +3.9% | +9.3% |
| qFor ≥ 2 | 226 | 46.9% | -10.9% | -7.2% |
| qFor ≥ 3+ | 239 | 47.3% | -5.1% | -4.9% |

#### Threshold T = 40   |   ρ(qFor, won) = -0.065   ρ(qFor, flat ROI) = -0.029

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 167 | 52.7% | -1.8% | +5.3% |
| qFor ≥ 1 | 358 | 55.0% | +3.8% | +8.9% |
| qFor ≥ 2 | 184 | 45.7% | -8.5% | -7.4% |
| qFor ≥ 3+ | 165 | 44.8% | -11.4% | -11.3% |

#### Threshold T = 50   |   ρ(qFor, won) = -0.004   ρ(qFor, flat ROI) = 0.004

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 262 | 53.4% | +0.0% | +6.0% |
| qFor ≥ 1 | 385 | 52.7% | +0.1% | +6.9% |
| qFor ≥ 2 | 137 | 41.6% | -12.5% | -18.4% |
| qFor ≥ 3+ | 90 | 47.8% | -7.9% | -6.9% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.072   ρ(qFor, flat ROI) = 0.051

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 420 | 51.2% | -3.7% | -0.3% |
| qFor ≥ 1 | 319 | 52.7% | +2.9% | +8.5% |
| qFor ≥ 2 | 78 | 47.4% | -9.4% | -14.5% |
| qFor ≥ 3+ | 57 | 40.4% | -18.7% | -16.5% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.149   ρ(qFor, flat ROI) = 0.084

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 554 | 51.4% | -3.0% | +2.5% |
| qFor ≥ 1 | 242 | 51.2% | +1.6% | +2.2% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.017   ρ(margin, flat ROI) = 0.015

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 234 | 53.4% | +3.4% | +1.6% |
| margin +1 | 342 | 49.4% | -7.1% | -0.9% |
| margin +2 | 169 | 52.7% | +0.9% | +6.8% |
| margin ≥ +3 | 129 | 46.5% | -7.2% | -7.8% |

#### Threshold T = 40   |   ρ(margin, won) = -0.003   ρ(margin, flat ROI) = -0.009

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 303 | 53.1% | +2.8% | +2.7% |
| margin +1 | 334 | 53.6% | +1.8% | +10.4% |
| margin +2 | 149 | 44.3% | -14.1% | -7.5% |
| margin ≥ +3 | 88 | 42.0% | -19.9% | -22.1% |

#### Threshold T = 50   |   ρ(margin, won) = 0.026   ρ(margin, flat ROI) = -0.005

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 364 | 54.9% | +6.8% | +9.5% |
| margin +1 | 356 | 50.3% | -4.4% | +0.6% |
| margin +2 | 103 | 39.8% | -23.7% | -19.0% |
| margin ≥ +3 | 51 | 45.1% | -16.7% | -9.1% |

#### Threshold T = 60   |   ρ(margin, won) = 0.091   ρ(margin, flat ROI) = 0.030

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 489 | 52.8% | +2.1% | +2.8% |
| margin +1 | 300 | 49.3% | -6.2% | +2.6% |
| margin +2 | 59 | 42.4% | -19.9% | -22.3% |
| margin ≥ +3 | 26 | 46.2% | -15.2% | -8.1% |

#### Threshold T = 70   |   ρ(margin, won) = 0.173   ρ(margin, flat ROI) = 0.068

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 614 | 51.6% | -0.3% | +4.1% |
| margin +1 | 207 | 49.3% | -6.9% | -5.8% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 222 / 55.0% / +2.9% | 34 / 44.1% / -16.3% | 6 / 50.0% / -12.9% | — | — | — | — | — |
| 1 | 305 / 51.1% / -3.6% | 68 / 58.8% / +13.1% | 9 / 44.4% / -12.4% | 2 / 100.0% / +135.0% | — | 1 / 100.0% / +82.0% | — | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 134 / 54.5% / +1.3% | 27 / 40.7% / -20.7% | 6 / 66.7% / +14.6% | — | — | — | — | — | — |
| 1 | 254 / 53.9% / +1.4% | 85 / 60.0% / +13.4% | 14 / 42.9% / -21.2% | 4 / 50.0% / +17.5% | — | 1 / 100.0% / +82.0% | — | — | — |
| 2 | 104 / 44.2% / -15.3% | 64 / 48.4% / -5.2% | 12 / 41.7% / +31.2% | 3 / 66.7% / +30.8% | — | 1 / 0.0% / -100.0% | — | — | — |
...
ρ(Δcontribution, won) = -0.145   |   ρ(Δcontribution, flat ROI) = -0.096
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 43.9) | 291 | -1.5 | 57.4% | +11.0% | +12.2% |
| Mid  (43.9 .. 98.0) | 291 | 68.2 | 47.4% | -9.7% | -4.7% |
| High (Δ ≥ 98.0) | 292 | 166.1 | 47.3% | -9.5% | -4.3% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 107 | 54.2% | +11.1% | +3.6% |
| 0 < Δ ≤ 50 | 218 | 58.7% | +9.3% | +12.7% |
| 50 < Δ ≤ 100 | 267 | 46.1% | -11.1% | -4.1% |
| Δ > 100 | 282 | 47.5% | -9.4% | -4.7% |
...
| STANDARD | 305 | 51.1% | -3.6% | +3.1% |
| LEAN | 303 | 56.8% | +9.5% | +18.4% |
| MUTE | 61 | 45.9% | -7.0% | -38.9% |
