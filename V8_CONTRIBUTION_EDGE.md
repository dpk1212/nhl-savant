...
_Generated 2026-05-09T13:58:16.341Z_

N = 302 picks (LOCKED=194, SHADOW=108)
...
#### Threshold T = 30   |   ρ(qFor, won) = 0.058   ρ(qFor, flat ROI) = 0.075

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 1 | 0.0% | -100.0% | — |
| qFor ≥ 1 | 62 | 48.4% | -8.9% | +1.6% |
| qFor ≥ 2 | 110 | 46.4% | -9.9% | -13.0% |
| qFor ≥ 3+ | 129 | 48.8% | -2.8% | +3.4% |

#### Threshold T = 40   |   ρ(qFor, won) = 0.070   ρ(qFor, flat ROI) = 0.079

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 8 | 37.5% | -34.0% | -9.1% |
| qFor ≥ 1 | 92 | 50.0% | -5.1% | -4.1% |
| qFor ≥ 2 | 102 | 47.1% | -8.6% | -0.7% |
| qFor ≥ 3+ | 100 | 47.0% | -5.0% | -1.0% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.100   ρ(qFor, flat ROI) = 0.072

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 40 | 50.0% | -5.4% | -17.5% |
| qFor ≥ 1 | 136 | 50.0% | -3.0% | +11.2% |
| qFor ≥ 2 | 70 | 40.0% | -20.6% | -18.7% |
| qFor ≥ 3+ | 56 | 50.0% | -1.0% | +3.8% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.170   ρ(qFor, flat ROI) = 0.108

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 96 | 47.9% | -8.8% | -10.9% |
| qFor ≥ 1 | 128 | 50.0% | -2.5% | +9.6% |
| qFor ≥ 2 | 40 | 45.0% | -14.9% | -10.5% |
| qFor ≥ 3+ | 38 | 42.1% | -9.5% | -3.4% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.213   ρ(qFor, flat ROI) = 0.122

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 149 | 49.0% | -6.6% | -6.1% |
| qFor ≥ 1 | 107 | 43.9% | -13.8% | -0.8% |
| qFor ≥ 2 | 33 | 54.5% | +3.8% | -1.3% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.145   ρ(margin, flat ROI) = 0.115

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 27 | 37.0% | -31.9% | -40.7% |
| margin +1 | 115 | 47.8% | -7.7% | +6.6% |
| margin +2 | 87 | 51.7% | -0.7% | +3.0% |
| margin ≥ +3 | 73 | 46.6% | -4.2% | -4.7% |

#### Threshold T = 40   |   ρ(margin, won) = 0.123   ρ(margin, flat ROI) = 0.078

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 43 | 44.2% | -6.6% | -12.1% |
| margin +1 | 124 | 51.6% | -0.4% | +6.4% |
| margin +2 | 81 | 44.4% | -15.8% | -5.3% |
| margin ≥ +3 | 54 | 46.3% | -9.4% | -3.2% |

#### Threshold T = 50   |   ρ(margin, won) = 0.118   ρ(margin, flat ROI) = 0.051
...
#### Threshold T = 60   |   ρ(margin, won) = 0.155   ρ(margin, flat ROI) = 0.054
...
| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 183 | 48.6% | -3.6% | +1.2% |
| margin +1 | 87 | 44.8% | -15.7% | -8.6% |
...
| 1 | 108 / 50.9% / -2.7% | 26 / 46.2% / -5.6% | 2 / 50.0% / +15.0% | — | — | — | — |
| 2 | 42 / 31.0% / -41.9% | 24 / 50.0% / -8.5% | 3 / 66.7% / +16.6% | 1 / 100.0% / +475.0% | — | — | — |
...
| 1 | 71 / 49.3% / -8.1% | 20 / 55.0% / +10.2% | 1 / 0.0% / -100.0% | — | — | — | — | — | — |
| 2 | 54 / 44.4% / -15.3% | 42 / 54.8% / +8.6% | 5 / 20.0% / -61.8% | 1 / 0.0% / -100.0% | — | — | — | — | — |
| 3 | 21 / 42.9% / -16.8% | 22 / 45.5% / -12.5% | 6 / 83.3% / +61.0% | 3 / 66.7% / +131.2% | 1 / 0.0% / -100.0% | 1 / 100.0% / +45.9% | — | — | — |
...
ρ(Δcontribution, won) = -0.028   |   ρ(Δcontribution, flat ROI) = -0.020
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 70.2) | 100 | 33.9 | 48.0% | -4.0% | +0.4% |
| Mid  (70.3 .. 124.3) | 101 | 96.4 | 54.5% | +6.4% | +5.5% |
| High (Δ ≥ 124.4) | 101 | 202.8 | 40.6% | -23.4% | -6.4% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 14 | 42.9% | -13.5% | +14.5% |
| 0 < Δ ≤ 50 | 41 | 53.7% | +3.4% | -5.2% |
| 50 < Δ ≤ 100 | 100 | 49.0% | -0.2% | +9.1% |
| Δ > 100 | 147 | 45.6% | -13.9% | -5.7% |
...
| --- | --- | --- | --- | --- |
| STRONG | 115 | 43.5% | -17.5% | -6.9% |
| STANDARD | 108 | 50.9% | -2.7% | +7.8% |
| LEAN | 68 | 50.0% | -1.0% | -4.1% |
| MUTE | 11 | 45.5% | +23.7% | +19.0% |

#### Current V8 ★/units assigned within each proposed tier

| Tier | N | mean ★ | mean units |
| --- | --- | --- | --- |
| STRONG | 115 | 3.88 | 1.43 |
| STANDARD | 108 | 3.07 | 0.76 |
| LEAN | 68 | 3.17 | 0.81 |
| MUTE | 11 | 3.89 | 1.13 |
