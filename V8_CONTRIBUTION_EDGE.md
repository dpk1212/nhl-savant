...
_Generated 2026-05-30T14:13:15.870Z_

N = 661 picks (LOCKED=461, SHADOW=200)
...
#### Threshold T = 30   |   ρ(qFor, won) = -0.060   ρ(qFor, flat ROI) = 0.002

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 49 | 55.1% | +0.0% | -2.9% |
| qFor ≥ 1 | 230 | 53.9% | +0.7% | +5.8% |
| qFor ≥ 2 | 171 | 43.9% | -15.1% | -18.4% |
| qFor ≥ 3+ | 211 | 49.3% | -0.8% | -3.5% |

#### Threshold T = 40   |   ρ(qFor, won) = -0.067   ρ(qFor, flat ROI) = -0.012

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 91 | 56.0% | +3.6% | +7.4% |
| qFor ≥ 1 | 257 | 52.5% | -1.7% | -0.2% |
| qFor ≥ 2 | 158 | 44.3% | -10.1% | -8.4% |
| qFor ≥ 3+ | 155 | 47.7% | -5.7% | -8.8% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.005   ρ(qFor, flat ROI) = 0.020

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 160 | 55.0% | +2.4% | -1.2% |
| qFor ≥ 1 | 291 | 49.8% | -5.4% | +0.5% |
| qFor ≥ 2 | 124 | 43.5% | -8.6% | -13.2% |
| qFor ≥ 3+ | 86 | 50.0% | -3.7% | -6.5% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.078   ρ(qFor, flat ROI) = 0.060

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 277 | 52.0% | -2.6% | -4.9% |
| qFor ≥ 1 | 256 | 49.6% | -2.3% | +2.4% |
| qFor ≥ 2 | 75 | 48.0% | -8.0% | -11.7% |
| qFor ≥ 3+ | 53 | 43.4% | -12.5% | -16.0% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.159   ρ(qFor, flat ROI) = 0.101

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 378 | 51.3% | -3.8% | -3.2% |
| qFor ≥ 1 | 209 | 48.8% | -2.1% | +0.1% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.049   ρ(margin, flat ROI) = 0.058

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 138 | 51.4% | -0.2% | -9.8% |
| margin +1 | 272 | 48.2% | -9.4% | -5.5% |
| margin +2 | 136 | 52.9% | +2.4% | +2.8% |
| margin ≥ +3 | 115 | 48.7% | -2.7% | -5.7% |

#### Threshold T = 40   |   ρ(margin, won) = 0.000   ρ(margin, flat ROI) = -0.002

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 184 | 54.3% | +6.9% | +3.6% |
| margin +1 | 263 | 51.0% | -3.4% | +0.7% |
| margin +2 | 132 | 44.7% | -13.5% | -7.8% |
...
#### Threshold T = 60   |   ρ(margin, won) = 0.088   ρ(margin, flat ROI) = 0.026
...
| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 434 | 51.8% | +0.6% | +0.7% |
| margin +1 | 176 | 46.0% | -12.9% | -10.4% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 138 / 55.1% / +2.3% | 19 / 52.6% / +1.7% | 3 / 66.7% / +10.0% | — | — | — | — | — |
| 1 | 239 / 49.4% / -7.2% | 42 / 50.0% / -3.0% | 7 / 42.9% / -12.4% | 2 / 100.0% / +135.0% | — | 1 / 100.0% / +82.0% | — | — |
| 2 | 72 / 38.9% / -25.9% | 39 / 43.6% / -15.1% | 8 / 87.5% / +145.2% | 3 / 66.7% / +139.8% | 1 / 0.0% / -100.0% | — | 1 / 0.0% / -100.0% | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 76 / 56.6% / +4.5% | 12 / 41.7% / -17.3% | 3 / 100.0% / +64.9% | — | — | — | — | — | — |
| 1 | 192 / 50.5% / -6.1% | 52 / 63.5% / +19.3% | 8 / 25.0% / -52.1% | 4 / 50.0% / +17.5% | — | 1 / 100.0% / +82.0% | — | — | — |
| 2 | 91 / 42.9% / -18.5% | 55 / 47.3% / -5.9% | 10 / 40.0% / +41.6% | 2 / 50.0% / -1.9% | — | — | — | — | — |
...
| 5 | 6 / 83.3% / +38.3% | 7 / 28.6% / -45.7% | 5 / 40.0% / +3.0% | 4 / 50.0% / +9.0% | 2 / 50.0% / -10.0% | — | — | — | — |
...
ρ(Δcontribution, won) = -0.124   |   ρ(Δcontribution, flat ROI) = -0.067
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 52.8) | 220 | 8.5 | 57.7% | +10.5% | +5.3% |
| Mid  (52.9 .. 107.1) | 220 | 78.1 | 45.5% | -10.8% | -5.5% |
| High (Δ ≥ 107.8) | 221 | 177.5 | 46.6% | -11.4% | -7.9% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 60 | 56.7% | +19.8% | +9.1% |
| 0 < Δ ≤ 50 | 135 | 60.0% | +10.4% | +10.2% |
| 50 < Δ ≤ 100 | 218 | 44.5% | -13.1% | -9.1% |
| Δ > 100 | 248 | 47.6% | -9.3% | -7.0% |
...
| --- | --- | --- | --- | --- |
| STRONG | 188 | 44.7% | -14.4% | -11.4% |
| STANDARD | 239 | 49.4% | -7.2% | -1.9% |
| LEAN | 193 | 55.4% | +8.0% | +8.7% |
| MUTE | 41 | 51.2% | +7.1% | -28.3% |

#### Current V8 ★/units assigned within each proposed tier

| Tier | N | mean ★ | mean units |
| --- | --- | --- | --- |
| STRONG | 188 | 3.97 | 1.80 |
| STANDARD | 239 | 3.41 | 1.26 |
| LEAN | 193 | 3.19 | 1.04 |
| MUTE | 41 | 2.65 | 0.99 |
