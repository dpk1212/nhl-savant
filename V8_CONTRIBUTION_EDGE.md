...
_Generated 2026-05-31T14:17:08.990Z_

N = 684 picks (LOCKED=482, SHADOW=202)
Baseline: WR 50.1% · flat ROI -3.4% · units-wtd ROI -3.7%
...
#### Threshold T = 30   |   ρ(qFor, won) = -0.056   ρ(qFor, flat ROI) = -0.000

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 51 | 52.9% | -3.9% | -4.5% |
| qFor ≥ 1 | 240 | 54.2% | +1.7% | +5.1% |
| qFor ≥ 2 | 180 | 45.6% | -12.0% | -12.8% |
| qFor ≥ 3+ | 213 | 48.8% | -1.7% | -4.1% |

#### Threshold T = 40   |   ρ(qFor, won) = -0.070   ρ(qFor, flat ROI) = -0.016

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 97 | 54.6% | +1.0% | +1.3% |
| qFor ≥ 1 | 271 | 53.9% | +1.3% | +4.0% |
| qFor ≥ 2 | 159 | 44.0% | -10.6% | -9.5% |
| qFor ≥ 3+ | 157 | 47.1% | -6.9% | -9.6% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.005   ρ(qFor, flat ROI) = 0.018

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 167 | 54.5% | +1.5% | -3.3% |
| qFor ≥ 1 | 305 | 50.8% | -3.2% | +3.0% |
| qFor ≥ 2 | 125 | 43.2% | -9.4% | -14.3% |
...
| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 291 | 51.9% | -2.8% | -6.3% |
| qFor ≥ 1 | 264 | 50.4% | -0.6% | +4.9% |
| qFor ≥ 2 | 75 | 48.0% | -8.0% | -11.7% |
| qFor ≥ 3+ | 54 | 42.6% | -14.1% | -16.0% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.153   ρ(qFor, flat ROI) = 0.096

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 397 | 51.6% | -3.0% | -2.4% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.050   ρ(margin, flat ROI) = 0.054

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 143 | 51.0% | -0.7% | -11.4% |
| margin +1 | 282 | 48.9% | -7.8% | -2.7% |
| margin +2 | 142 | 53.5% | +3.6% | +3.3% |
| margin ≥ +3 | 117 | 47.9% | -4.4% | -6.6% |

#### Threshold T = 40   |   ρ(margin, won) = -0.001   ρ(margin, flat ROI) = -0.005

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 193 | 54.4% | +6.9% | +3.5% |
| margin +1 | 274 | 51.8% | -1.5% | +3.3% |
| margin +2 | 134 | 44.0% | -14.8% | -8.9% |
| margin ≥ +3 | 83 | 44.6% | -15.1% | -20.2% |

#### Threshold T = 50   |   ρ(margin, won) = 0.039   ρ(margin, flat ROI) = 0.002

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 244 | 54.9% | +8.2% | +2.9% |
| margin +1 | 298 | 49.7% | -5.3% | -1.9% |
| margin +2 | 94 | 40.4% | -23.4% | -15.5% |
| margin ≥ +3 | 48 | 47.9% | -11.5% | -8.5% |

#### Threshold T = 60   |   ρ(margin, won) = 0.082   ρ(margin, flat ROI) = 0.024

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 355 | 53.8% | +4.8% | +0.2% |
| margin +1 | 248 | 46.8% | -10.9% | -2.8% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 143 / 54.5% / +1.3% | 20 / 50.0% / -3.4% | 4 / 75.0% / +30.6% | — | — | — | — | — |
| 1 | 250 / 50.0% / -5.6% | 45 / 53.3% / +3.6% | 7 / 42.9% / -12.4% | 2 / 100.0% / +135.0% | — | 1 / 100.0% / +82.0% | — | — |
| 2 | 73 / 38.4% / -26.9% | 39 / 43.6% / -15.1% | 8 / 87.5% / +145.2% | 3 / 66.7% / +139.8% | 1 / 0.0% / -100.0% | — | 1 / 0.0% / -100.0% | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 80 / 55.0% / +1.5% | 13 / 38.5% / -23.6% | 4 / 100.0% / +71.8% | — | — | — | — | — | — |
| 1 | 203 / 51.7% / -3.3% | 55 / 65.5% / +23.6% | 8 / 25.0% / -52.1% | 4 / 50.0% / +17.5% | — | 1 / 100.0% / +82.0% | — | — | — |
| 2 | 92 / 42.4% / -19.4% | 55 / 47.3% / -5.9% | 10 / 40.0% / +41.6% | 2 / 50.0% / -1.9% | — | — | — | — | — |
...
ρ(Δcontribution, won) = -0.125   |   ρ(Δcontribution, flat ROI) = -0.071
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 52.6) | 228 | 7.9 | 57.0% | +9.2% | +3.3% |
| Mid  (52.8 .. 106.7) | 228 | 77.4 | 46.9% | -7.8% | -3.2% |
| High (Δ ≥ 106.8) | 228 | 176.5 | 46.5% | -11.5% | -7.3% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 62 | 56.5% | +19.1% | +3.7% |
| 0 < Δ ≤ 50 | 142 | 59.2% | +9.1% | +9.1% |
| 50 < Δ ≤ 100 | 227 | 45.8% | -10.5% | -6.8% |
| Δ > 100 | 253 | 47.4% | -9.6% | -6.4% |
...
| --- | --- | --- | --- | --- |
| STRONG | 190 | 44.2% | -15.3% | -12.1% |
| STANDARD | 250 | 50.0% | -5.6% | -0.3% |
| LEAN | 201 | 55.7% | +8.5% | +9.9% |
| MUTE | 43 | 51.2% | +6.6% | -29.8% |

#### Current V8 ★/units assigned within each proposed tier

| Tier | N | mean ★ | mean units |
| --- | --- | --- | --- |
| STRONG | 190 | 3.99 | 1.80 |
| STANDARD | 250 | 3.46 | 1.30 |
| LEAN | 201 | 3.21 | 1.07 |
| MUTE | 43 | 2.67 | 1.07 |
