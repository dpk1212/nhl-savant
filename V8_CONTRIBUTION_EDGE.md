...
_Generated 2026-06-04T15:58:25.574Z_

N = 761 picks (LOCKED=531, SHADOW=230)
...
#### Threshold T = 30   |   ρ(qFor, won) = -0.059   ρ(qFor, flat ROI) = -0.011

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 63 | 55.6% | +2.1% | +11.9% |
| qFor ≥ 1 | 280 | 53.6% | +0.8% | +6.0% |
| qFor ≥ 2 | 193 | 45.1% | -13.2% | -12.1% |
| qFor ≥ 3+ | 225 | 48.4% | -2.3% | -3.8% |

#### Threshold T = 40   |   ρ(qFor, won) = -0.079   ρ(qFor, flat ROI) = -0.027

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 136 | 53.7% | +0.1% | +8.3% |
| qFor ≥ 1 | 296 | 53.7% | +1.0% | +5.4% |
| qFor ≥ 2 | 170 | 44.1% | -10.3% | -9.2% |
| qFor ≥ 3+ | 159 | 46.5% | -8.1% | -10.4% |

#### Threshold T = 50   |   ρ(qFor, won) = -0.003   ρ(qFor, flat ROI) = 0.012

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 210 | 53.8% | +0.3% | +3.7% |
| qFor ≥ 1 | 331 | 50.8% | -3.2% | +3.8% |
| qFor ≥ 2 | 132 | 43.2% | -9.2% | -15.0% |
| qFor ≥ 3+ | 88 | 48.9% | -5.8% | -6.6% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.071   ρ(qFor, flat ROI) = 0.056

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 346 | 51.2% | -3.9% | -2.0% |
| qFor ≥ 1 | 284 | 50.7% | +0.1% | +5.3% |
| qFor ≥ 2 | 76 | 48.7% | -7.0% | -11.4% |
| qFor ≥ 3+ | 55 | 41.8% | -15.7% | -16.2% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.144   ρ(qFor, flat ROI) = 0.085

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 464 | 51.3% | -3.3% | +1.1% |
| qFor ≥ 1 | 221 | 49.3% | -1.2% | -0.2% |
| qFor ≥ 2 | 52 | 48.1% | -10.0% | -14.7% |
| qFor ≥ 3+ | 24 | 37.5% | -15.9% | -21.8% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.035   ρ(margin, flat ROI) = 0.036

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 182 | 52.2% | +1.2% | -5.7% |
| margin +1 | 306 | 48.4% | -8.8% | -1.0% |
| margin +2 | 148 | 53.4% | +3.1% | +4.6% |
| margin ≥ +3 | 125 | 47.2% | -5.7% | -6.8% |

#### Threshold T = 40   |   ρ(margin, won) = -0.014   ρ(margin, flat ROI) = -0.013

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 245 | 53.9% | +5.1% | +5.0% |
| margin +1 | 290 | 51.4% | -2.3% | +5.3% |
| margin +2 | 141 | 44.7% | -13.0% | -7.6% |
| margin ≥ +3 | 85 | 43.5% | -17.1% | -21.5% |

#### Threshold T = 50   |   ρ(margin, won) = 0.027   ρ(margin, flat ROI) = -0.002
...
#### Threshold T = 60   |   ρ(margin, won) = 0.081   ρ(margin, flat ROI) = 0.025
...
#### Threshold T = 70   |   ρ(margin, won) = 0.164   ρ(margin, flat ROI) = 0.064

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 522 | 51.5% | -0.1% | +3.2% |
| margin +1 | 187 | 47.1% | -10.7% | -9.4% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 177 / 54.2% / +0.9% | 27 / 51.9% / -0.7% | 6 / 50.0% / -12.9% | — | — | — | — | — |
| 1 | 267 / 49.4% / -6.5% | 52 / 55.8% / +8.2% | 9 / 44.4% / -12.4% | 2 / 100.0% / +135.0% | — | 1 / 100.0% / +82.0% | — | — |
| 2 | 79 / 39.2% / -24.1% | 40 / 42.5% / -17.2% | 8 / 87.5% / +145.2% | 3 / 66.7% / +139.8% | 1 / 0.0% / -100.0% | — | 1 / 0.0% / -100.0% | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 108 / 54.6% / +2.1% | 22 / 45.5% / -14.0% | 6 / 66.7% / +14.6% | — | — | — | — | — | — |
| 1 | 218 / 51.4% / -3.9% | 63 / 63.5% / +20.0% | 10 / 40.0% / -26.9% | 4 / 50.0% / +17.5% | — | 1 / 100.0% / +82.0% | — | — | — |
| 2 | 99 / 43.4% / -16.4% | 56 / 46.4% / -7.5% | 11 / 36.4% / +28.7% | 3 / 66.7% / +30.8% | — | 1 / 0.0% / -100.0% | — | — | — |
| 3 | 38 / 44.7% / -14.0% | 32 / 46.9% / -7.1% | 7 / 85.7% / +65.3% | 6 / 50.0% / +39.7% | 1 / 0.0% / -100.0% | 3 / 33.3% / -51.4% | 1 / 0.0% / -100.0% | — | — |
...
ρ(Δcontribution, won) = -0.133   |   ρ(Δcontribution, flat ROI) = -0.080
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 49.7) | 253 | 1.2 | 57.7% | +10.9% | +10.6% |
| Mid  (49.8 .. 101.6) | 254 | 72.5 | 45.3% | -12.0% | -6.3% |
| High (Δ ≥ 101.9) | 254 | 172.8 | 47.2% | -9.5% | -5.5% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 83 | 55.4% | +14.5% | +7.7% |
| 0 < Δ ≤ 50 | 173 | 58.4% | +8.1% | +9.2% |
| 50 < Δ ≤ 100 | 243 | 45.3% | -11.8% | -5.5% |
| Δ > 100 | 262 | 47.3% | -9.4% | -5.4% |
...
| --- | --- | --- | --- | --- |
| STRONG | 198 | 43.9% | -15.4% | -12.7% |
| STANDARD | 267 | 49.4% | -6.5% | -0.2% |
| LEAN | 242 | 55.8% | +8.0% | +15.0% |
| MUTE | 54 | 50.0% | +2.0% | -33.0% |

#### Current V8 ★/units assigned within each proposed tier

| Tier | N | mean ★ | mean units |
| --- | --- | --- | --- |
| STRONG | 198 | 4.00 | 1.79 |
| STANDARD | 267 | 3.47 | 1.31 |
| LEAN | 242 | 3.32 | 1.16 |
| MUTE | 54 | 2.56 | 0.97 |
