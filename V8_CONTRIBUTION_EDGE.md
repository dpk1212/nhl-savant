...
_Generated 2026-05-23T14:08:51.030Z_

N = 495 picks (LOCKED=329, SHADOW=166)
...
#### Threshold T = 30   |   ρ(qFor, won) = 0.038   ρ(qFor, flat ROI) = 0.064

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 12 | 41.7% | -22.4% | -28.4% |
| qFor ≥ 1 | 147 | 49.7% | -7.2% | -4.0% |
| qFor ≥ 2 | 149 | 45.0% | -13.1% | -16.7% |
| qFor ≥ 3+ | 187 | 50.3% | -1.4% | -2.2% |

#### Threshold T = 40   |   ρ(qFor, won) = 0.037   ρ(qFor, flat ROI) = 0.049

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 31 | 45.2% | -14.0% | -32.0% |
| qFor ≥ 1 | 183 | 50.3% | -5.7% | -3.0% |
| qFor ≥ 2 | 140 | 47.1% | -8.6% | -2.9% |
| qFor ≥ 3+ | 141 | 47.5% | -6.2% | -10.3% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.087   ρ(qFor, flat ROI) = 0.060

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 84 | 50.0% | -5.5% | -19.4% |
| qFor ≥ 1 | 226 | 48.7% | -6.9% | +1.5% |
| qFor ≥ 2 | 107 | 45.8% | -9.1% | -8.4% |
| qFor ≥ 3+ | 78 | 48.7% | -7.0% | -11.8% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.129   ρ(qFor, flat ROI) = 0.080

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 178 | 48.3% | -8.1% | -13.2% |
| qFor ≥ 1 | 203 | 49.8% | -4.0% | +6.0% |
| qFor ≥ 2 | 65 | 47.7% | -10.0% | -15.1% |
| qFor ≥ 3+ | 49 | 42.9% | -13.0% | -19.2% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.198   ρ(qFor, flat ROI) = 0.117

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 260 | 47.7% | -9.5% | -12.1% |
| qFor ≥ 1 | 168 | 49.4% | -4.2% | +4.5% |
| qFor ≥ 2 | 47 | 51.1% | -4.5% | -9.4% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.114   ρ(margin, flat ROI) = 0.103

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 75 | 44.0% | -18.2% | -34.1% |
| margin +1 | 197 | 46.2% | -12.9% | -4.0% |
| margin +2 | 118 | 54.2% | +5.3% | +0.7% |
| margin ≥ +3 | 105 | 48.6% | -2.5% | -6.1% |

#### Threshold T = 40   |   ρ(margin, won) = 0.083   ρ(margin, flat ROI) = 0.052

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 103 | 46.6% | -8.3% | -12.3% |
| margin +1 | 202 | 51.0% | -2.9% | +4.6% |
| margin +2 | 114 | 48.2% | -6.6% | -1.3% |
| margin ≥ +3 | 76 | 43.4% | -17.8% | -21.9% |

#### Threshold T = 50   |   ρ(margin, won) = 0.097   ρ(margin, flat ROI) = 0.044
...
#### Threshold T = 60   |   ρ(margin, won) = 0.117   ρ(margin, flat ROI) = 0.047
...
#### Threshold T = 70   |   ρ(margin, won) = 0.194   ρ(margin, flat ROI) = 0.088

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 307 | 48.5% | -5.7% | -4.3% |
| margin +1 | 143 | 47.6% | -10.1% | -7.3% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 69 / 50.7% / -4.2% | 13 / 46.2% / -9.2% | 2 / 50.0% / -24.7% | — | — | — | — | — |
| 1 | 182 / 48.9% / -7.2% | 39 / 48.7% / -4.2% | 5 / 40.0% / -16.5% | — | — | — | — | — |
| 2 | 64 / 39.1% / -25.5% | 33 / 51.5% / +0.3% | 6 / 83.3% / +54.0% | 3 / 66.7% / +139.8% | — | — | 1 / 0.0% / -100.0% | — |
| 3 | 13 / 61.5% / +10.7% | 12 / 58.3% / +1.8% | 7 / 57.1% / +45.1% | 2 / 100.0% / +121.2% | 1 / 0.0% / -100.0% | 1 / 100.0% / +45.9% | — | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 23 / 39.1% / -24.6% | 6 / 50.0% / +2.8% | 2 / 100.0% / +57.7% | — | — | — | — | — | — |
| 1 | 135 / 49.6% / -7.9% | 41 / 58.5% / +13.0% | 5 / 20.0% / -62.5% | 2 / 0.0% / -100.0% | — | — | — | — | — |
| 2 | 79 / 46.8% / -10.8% | 52 / 50.0% / -0.4% | 7 / 28.6% / -46.0% | 2 / 50.0% / -1.9% | — | — | — | — | — |
| 3 | 33 / 42.4% / -19.6% | 27 / 48.1% / -4.6% | 7 / 85.7% / +65.3% | 6 / 50.0% / +39.7% | 1 / 0.0% / -100.0% | 2 / 50.0% / -27.1% | 1 / 0.0% / -100.0% | — | — |
...
ρ(Δcontribution, won) = -0.036   |   ρ(Δcontribution, flat ROI) = -0.007
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 60.5) | 165 | 21.5 | 49.1% | -7.7% | -16.7% |
| Mid  (60.5 .. 118.9) | 165 | 87.9 | 50.9% | +1.1% | +4.1% |
| High (Δ ≥ 120.3) | 165 | 191.4 | 44.8% | -14.8% | -8.4% |
...
| 0 < Δ ≤ 50 | 85 | 55.3% | +4.3% | +3.4% |
| 50 < Δ ≤ 100 | 162 | 44.4% | -11.9% | -5.7% |
| Δ > 100 | 216 | 48.6% | -7.7% | -7.6% |
...
| --- | --- | --- | --- | --- |
| STRONG | 166 | 45.8% | -12.7% | -10.5% |
| STANDARD | 182 | 48.9% | -7.2% | -0.8% |
| LEAN | 119 | 52.1% | +0.6% | +0.7% |
| MUTE | 28 | 42.9% | -6.7% | -28.6% |

#### Current V8 ★/units assigned within each proposed tier

| Tier | N | mean ★ | mean units |
| --- | --- | --- | --- |
| STRONG | 166 | 3.96 | 1.79 |
| STANDARD | 182 | 3.24 | 1.01 |
| LEAN | 119 | 3.03 | 0.89 |
| MUTE | 28 | 2.78 | 0.99 |
