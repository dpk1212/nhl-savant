...
_Generated 2026-06-18T15:59:40.369Z_

N = 1091 picks (LOCKED=770, SHADOW=321)
Baseline: WR 50.5% · flat ROI -3.2% · units-wtd ROI -1.0%
...
#### Threshold T = 30   |   ρ(qFor, won) = -0.027   ρ(qFor, flat ROI) = -0.018

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 111 | 45.9% | -13.1% | +1.9% |
| qFor ≥ 1 | 438 | 55.3% | +5.1% | +8.1% |
| qFor ≥ 2 | 280 | 47.5% | -10.3% | -11.3% |
| qFor ≥ 3+ | 262 | 47.7% | -5.2% | -4.9% |

#### Threshold T = 40   |   ρ(qFor, won) = -0.056   ρ(qFor, flat ROI) = -0.035

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 260 | 50.8% | -3.5% | -0.4% |
| qFor ≥ 1 | 447 | 54.4% | +2.7% | +7.3% |
| qFor ≥ 2 | 209 | 47.4% | -6.7% | -9.0% |
| qFor ≥ 3+ | 175 | 44.0% | -13.4% | -11.5% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.014   ρ(qFor, flat ROI) = 0.015

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 402 | 50.0% | -5.1% | -9.2% |
| qFor ≥ 1 | 449 | 53.9% | +2.0% | +13.1% |
| qFor ≥ 2 | 146 | 43.8% | -9.4% | -16.6% |
| qFor ≥ 3+ | 94 | 46.8% | -9.8% | -7.5% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.080   ρ(qFor, flat ROI) = 0.056

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 595 | 50.4% | -4.3% | -5.1% |
| qFor ≥ 1 | 358 | 53.1% | +2.8% | +11.7% |
| qFor ≥ 2 | 80 | 47.5% | -9.3% | -14.3% |
| qFor ≥ 3+ | 58 | 39.7% | -20.1% | -16.7% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.157   ρ(qFor, flat ROI) = 0.088

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 747 | 51.1% | -3.0% | -0.5% |
| qFor ≥ 1 | 264 | 51.1% | +0.5% | +4.2% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.034   ρ(margin, flat ROI) = 0.019

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 332 | 50.6% | -2.0% | +0.3% |
| margin +1 | 412 | 50.7% | -4.0% | -1.6% |
| margin +2 | 205 | 52.7% | +0.1% | +4.7% |
| margin ≥ +3 | 142 | 46.5% | -8.1% | -8.0% |

#### Threshold T = 40   |   ρ(margin, won) = 0.000   ρ(margin, flat ROI) = -0.012

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 430 | 51.4% | -0.6% | -2.6% |
| margin +1 | 399 | 53.6% | +2.2% | +10.0% |
| margin +2 | 168 | 45.8% | -12.4% | -7.0% |
| margin ≥ +3 | 94 | 41.5% | -21.2% | -21.5% |

#### Threshold T = 50   |   ρ(margin, won) = 0.040   ρ(margin, flat ROI) = 0.008

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 515 | 51.8% | +0.7% | -2.7% |
| margin +1 | 413 | 52.1% | -1.2% | +7.8% |
| margin +2 | 111 | 41.4% | -21.4% | -17.8% |
| margin ≥ +3 | 52 | 44.2% | -18.3% | -9.3% |

#### Threshold T = 60   |   ρ(margin, won) = 0.095   ρ(margin, flat ROI) = 0.038

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 671 | 51.6% | -0.2% | -2.0% |
| margin +1 | 334 | 50.0% | -5.6% | +5.8% |
| margin +2 | 60 | 43.3% | -18.1% | -21.3% |
| margin ≥ +3 | 26 | 46.2% | -15.2% | -8.1% |

#### Threshold T = 70   |   ρ(margin, won) = 0.174   ρ(margin, flat ROI) = 0.073

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 809 | 51.3% | -1.0% | +1.1% |
| margin +1 | 229 | 48.9% | -8.1% | -3.9% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 336 / 50.3% / -4.5% | 57 / 45.6% / -11.9% | 9 / 66.7% / +15.1% | — | — | — | — | — | — |
| 1 | 360 / 52.8% / -0.6% | 76 / 59.2% / +12.8% | 9 / 44.4% / -12.4% | 3 / 66.7% / +56.7% | — | 1 / 100.0% / +82.0% | — | — | — |
...
| qFor \ qAgainst | 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 204 / 51.0% / -4.1% | 48 / 45.8% / -9.1% | 8 / 75.0% / +46.3% | — | — | — | — | — | — |
| 1 | 312 / 53.8% / +1.9% | 110 / 56.4% / +5.9% | 18 / 50.0% / -9.1% | 6 / 50.0% / +6.2% | — | 1 / 100.0% / +82.0% | — | — | — |
| 2 | 121 / 47.1% / -11.4% | 71 / 49.3% / -4.2% | 13 / 38.5% / +21.1% | 3 / 66.7% / +30.8% | — | 1 / 0.0% / -100.0% | — | — | — |
...
ρ(Δcontribution, won) = -0.135   |   ρ(Δcontribution, flat ROI) = -0.092
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 35.1) | 363 | -9.2 | 52.3% | +1.6% | +4.7% |
| Mid  (35.3 .. 89.5) | 364 | 60.4 | 51.1% | -3.2% | +0.1% |
| High (Δ ≥ 89.5) | 364 | 156.0 | 48.1% | -7.9% | -5.7% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 162 | 50.0% | +1.0% | -3.8% |
| 0 < Δ ≤ 50 | 308 | 56.5% | +6.1% | +5.7% |
| 50 < Δ ≤ 100 | 307 | 47.6% | -8.6% | -2.3% |
| Δ > 100 | 314 | 47.8% | -9.1% | -4.2% |
...
| STANDARD | 360 | 52.8% | -0.6% | +10.6% |
| LEAN | 425 | 52.7% | +2.0% | +2.7% |
| MUTE | 90 | 47.8% | -4.9% | -30.9% |
