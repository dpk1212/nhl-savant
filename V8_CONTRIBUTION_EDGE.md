...
_Generated 2026-06-15T17:30:10.468Z_

N = 1021 picks (LOCKED=717, SHADOW=304)
Baseline: WR 50.4% · flat ROI -3.0% · units-wtd ROI -0.4%
...
#### Threshold T = 30   |   ρ(qFor, won) = -0.022   ρ(qFor, flat ROI) = -0.011

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 95 | 46.3% | -13.2% | -5.3% |
| qFor ≥ 1 | 403 | 54.8% | +4.6% | +9.5% |
| qFor ≥ 2 | 267 | 48.3% | -8.6% | -8.3% |
| qFor ≥ 3+ | 256 | 47.3% | -5.6% | -5.3% |

#### Threshold T = 40   |   ρ(qFor, won) = -0.042   ρ(qFor, flat ROI) = -0.023

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 215 | 49.8% | -5.5% | -1.6% |
| qFor ≥ 1 | 431 | 54.8% | +3.7% | +9.3% |
| qFor ≥ 2 | 202 | 47.5% | -6.0% | -8.8% |
| qFor ≥ 3+ | 173 | 43.9% | -13.3% | -11.9% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.022   ρ(qFor, flat ROI) = 0.021

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 349 | 49.9% | -5.2% | -8.3% |
| qFor ≥ 1 | 434 | 53.9% | +2.2% | +13.1% |
| qFor ≥ 2 | 145 | 43.4% | -9.8% | -17.6% |
| qFor ≥ 3+ | 93 | 47.3% | -8.8% | -7.0% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.087   ρ(qFor, flat ROI) = 0.062

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 536 | 50.2% | -4.6% | -5.0% |
| qFor ≥ 1 | 348 | 53.2% | +3.4% | +12.4% |
| qFor ≥ 2 | 79 | 48.1% | -8.1% | -13.7% |
| qFor ≥ 3+ | 58 | 39.7% | -20.1% | -16.7% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.160   ρ(qFor, flat ROI) = 0.093

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 686 | 51.0% | -3.2% | +0.1% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.033   ρ(margin, flat ROI) = 0.020

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 300 | 51.0% | -1.0% | +0.6% |
| margin +1 | 385 | 50.1% | -5.1% | -0.8% |
| margin +2 | 198 | 53.0% | +1.2% | +5.8% |
| margin ≥ +3 | 138 | 46.4% | -7.8% | -8.4% |

#### Threshold T = 40   |   ρ(margin, won) = 0.009   ρ(margin, flat ROI) = -0.003

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 380 | 51.1% | -0.9% | -2.0% |
| margin +1 | 386 | 53.9% | +2.9% | +11.2% |
| margin +2 | 162 | 46.3% | -11.3% | -6.6% |
| margin ≥ +3 | 93 | 40.9% | -22.1% | -22.9% |

#### Threshold T = 50   |   ρ(margin, won) = 0.045   ρ(margin, flat ROI) = 0.011

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 461 | 51.8% | +1.1% | -1.4% |
| margin +1 | 399 | 52.1% | -0.9% | +7.9% |
| margin +2 | 109 | 41.3% | -21.4% | -18.7% |
| margin ≥ +3 | 52 | 44.2% | -18.3% | -9.3% |

#### Threshold T = 60   |   ρ(margin, won) = 0.099   ρ(margin, flat ROI) = 0.041

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 611 | 51.4% | -0.2% | -1.8% |
| margin +1 | 324 | 50.3% | -4.7% | +6.9% |
| margin +2 | 60 | 43.3% | -18.1% | -21.3% |
| margin ≥ +3 | 26 | 46.2% | -15.2% | -8.1% |

#### Threshold T = 70   |   ρ(margin, won) = 0.173   ρ(margin, flat ROI) = 0.075

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 747 | 51.1% | -1.0% | +1.6% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 290 / 50.0% / -5.1% | 51 / 47.1% / -8.6% | 8 / 62.5% / +9.9% | — | — | — | — | — | — |
| 1 | 346 / 52.9% / -0.2% | 75 / 58.7% / +12.0% | 9 / 44.4% / -12.4% | 3 / 66.7% / +56.7% | — | 1 / 100.0% / +82.0% | — | — | — |
...
| qFor \ qAgainst | 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 168 / 49.4% / -7.1% | 39 / 46.2% / -9.0% | 8 / 75.0% / +46.3% | — | — | — | — | — | — |
| 1 | 301 / 54.2% / +2.7% | 106 / 57.5% / +8.4% | 17 / 47.1% / -13.0% | 6 / 50.0% / +6.2% | — | 1 / 100.0% / +82.0% | — | — | — |
| 2 | 116 / 47.4% / -10.5% | 69 / 49.3% / -3.9% | 13 / 38.5% / +21.1% | 3 / 66.7% / +30.8% | — | 1 / 0.0% / -100.0% | — | — | — |
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 39.6) | 340 | -8.1 | 54.1% | +5.1% | +8.9% |
| Mid  (39.6 .. 91.8) | 340 | 63.5 | 48.8% | -7.1% | -3.7% |
| High (Δ ≥ 91.8) | 341 | 159.0 | 48.4% | -7.1% | -4.4% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 145 | 51.0% | +4.0% | -4.6% |
| 0 < Δ ≤ 50 | 272 | 56.3% | +5.6% | +8.2% |
| 50 < Δ ≤ 100 | 299 | 47.2% | -9.2% | -2.8% |
| Δ > 100 | 305 | 48.2% | -8.1% | -3.5% |
...
| STANDARD | 346 | 52.9% | -0.2% | +10.8% |
| LEAN | 378 | 52.6% | +2.1% | +4.0% |
| MUTE | 83 | 48.2% | -3.2% | -30.0% |
