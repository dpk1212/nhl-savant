...
_Generated 2026-05-16T14:05:17.587Z_

N = 368 picks (LOCKED=254, SHADOW=114)
Baseline: WR 49.2% · flat ROI -5.2% · units-wtd ROI -1.4%
...
#### Threshold T = 30   |   ρ(qFor, won) = 0.098   ρ(qFor, flat ROI) = 0.088

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 1 | 0.0% | -100.0% | — |
| qFor ≥ 1 | 84 | 48.8% | -9.1% | -2.7% |
| qFor ≥ 2 | 124 | 46.0% | -11.2% | -17.4% |
| qFor ≥ 3+ | 159 | 52.2% | +2.2% | +6.3% |

#### Threshold T = 40   |   ρ(qFor, won) = 0.095   ρ(qFor, flat ROI) = 0.079

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 10 | 40.0% | -26.8% | -0.6% |
| qFor ≥ 1 | 120 | 50.0% | -5.7% | -7.6% |
| qFor ≥ 2 | 120 | 47.5% | -8.2% | +2.2% |
| qFor ≥ 3+ | 118 | 50.8% | +0.3% | -0.7% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.135   ρ(qFor, flat ROI) = 0.078

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 47 | 46.8% | -10.9% | -17.7% |
| qFor ≥ 1 | 169 | 50.3% | -3.4% | +3.4% |
| qFor ≥ 2 | 87 | 44.8% | -11.8% | -6.8% |
| qFor ≥ 3+ | 65 | 53.8% | +3.2% | +2.6% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.201   ρ(qFor, flat ROI) = 0.112

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 111 | 45.0% | -14.1% | -19.2% |
| qFor ≥ 1 | 160 | 51.9% | +0.3% | +10.3% |
| qFor ≥ 2 | 53 | 52.8% | -2.1% | -1.1% |
| qFor ≥ 3+ | 44 | 45.5% | -6.3% | -7.9% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.247   ρ(qFor, flat ROI) = 0.139

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 175 | 46.9% | -11.2% | -15.2% |
| qFor ≥ 1 | 138 | 49.3% | -4.2% | +6.7% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.151   ρ(margin, flat ROI) = 0.118

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 43 | 41.9% | -24.3% | -32.6% |
| margin +1 | 132 | 48.5% | -7.4% | +4.7% |
| margin +2 | 99 | 52.5% | +0.6% | -0.8% |
| margin ≥ +3 | 94 | 50.0% | +0.5% | +0.7% |

#### Threshold T = 40   |   ρ(margin, won) = 0.110   ρ(margin, flat ROI) = 0.067

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 62 | 48.4% | -3.1% | +3.2% |
| margin +1 | 145 | 51.7% | -1.1% | +2.5% |
| margin +2 | 96 | 46.9% | -10.1% | -0.6% |
| margin ≥ +3 | 65 | 47.7% | -9.1% | -8.5% |

#### Threshold T = 50   |   ρ(margin, won) = 0.110   ρ(margin, flat ROI) = 0.043

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 100 | 52.0% | +4.8% | +8.2% |
| margin +1 | 165 | 50.9% | -2.5% | +1.3% |
| margin +2 | 66 | 39.4% | -26.6% | -15.8% |
| margin ≥ +3 | 37 | 51.4% | -6.1% | -1.1% |

#### Threshold T = 60   |   ρ(margin, won) = 0.158   ρ(margin, flat ROI) = 0.058

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 153 | 52.3% | +2.9% | +8.6% |
| margin +1 | 152 | 47.4% | -9.4% | -2.6% |
| margin +2 | 40 | 45.0% | -15.9% | -15.0% |
| margin ≥ +3 | 23 | 47.8% | -12.5% | -4.9% |

#### Threshold T = 70   |   ρ(margin, won) = 0.217   ρ(margin, flat ROI) = 0.088

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 218 | 48.2% | -5.7% | -4.3% |
| margin +1 | 111 | 49.5% | -6.4% | +1.0% |
...
| 1 | 131 / 49.6% / -5.5% | 34 / 52.9% / +3.8% | 4 / 50.0% / +4.4% | — | — | — | — |
| 2 | 52 / 34.6% / -35.0% | 27 / 51.9% / -2.0% | 6 / 83.3% / +54.0% | 2 / 100.0% / +259.7% | — | — | — |
...
| 1 | 86 / 48.8% / -8.8% | 29 / 58.6% / +13.0% | 4 / 25.0% / -53.1% | 1 / 0.0% / -100.0% | — | — | — | — | — |
| 2 | 66 / 45.5% / -13.8% | 45 / 53.3% / +5.6% | 7 / 28.6% / -46.0% | 2 / 50.0% / -1.9% | — | — | — | — | — |
| 3 | 27 / 48.1% / -6.8% | 22 / 45.5% / -12.5% | 7 / 85.7% / +65.3% | 3 / 66.7% / +131.2% | 1 / 0.0% / -100.0% | 1 / 100.0% / +45.9% | — | — | — |
| 4 | 6 / 16.7% / -68.7% | 6 / 33.3% / -46.8% | 5 / 60.0% / +17.0% | 4 / 50.0% / +14.6% | 2 / 100.0% / +99.2% | 1 / 0.0% / -100.0% | — | — | 1 / 0.0% / -100.0% |
...
ρ(Δcontribution, won) = 0.007   |   ρ(Δcontribution, flat ROI) = 0.007
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 69.6) | 122 | 30.5 | 48.4% | -8.5% | -4.4% |
| Mid  (69.9 .. 126.1) | 123 | 97.5 | 52.0% | +3.3% | -4.4% |
| High (Δ ≥ 126.1) | 123 | 204.1 | 47.2% | -10.3% | +1.6% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 20 | 45.0% | -14.3% | -1.8% |
| 0 < Δ ≤ 50 | 50 | 58.0% | +9.6% | +3.5% |
| 50 < Δ ≤ 100 | 119 | 46.2% | -6.7% | -1.5% |
| Δ > 100 | 179 | 49.2% | -7.3% | -2.1% |
...
| --- | --- | --- | --- | --- |
| STRONG | 137 | 46.7% | -12.2% | -4.4% |
| STANDARD | 131 | 49.6% | -5.5% | -3.5% |
| LEAN | 84 | 53.6% | +4.6% | +9.2% |
| MUTE | 16 | 43.8% | +5.8% | +3.4% |

#### Current V8 ★/units assigned within each proposed tier

| Tier | N | mean ★ | mean units |
| --- | --- | --- | --- |
| STRONG | 137 | 3.96 | 1.67 |
| STANDARD | 131 | 3.26 | 0.95 |
| LEAN | 84 | 3.29 | 0.98 |
| MUTE | 16 | 3.48 | 1.01 |
