...
_Generated 2026-05-21T15:56:01.868Z_

N = 457 picks (LOCKED=297, SHADOW=160)
...
#### Threshold T = 30   |   ρ(qFor, won) = 0.049   ρ(qFor, flat ROI) = 0.069

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 10 | 40.0% | -26.0% | — |
| qFor ≥ 1 | 132 | 49.2% | -7.8% | -5.5% |
| qFor ≥ 2 | 139 | 45.3% | -12.2% | -15.2% |
| qFor ≥ 3+ | 176 | 51.7% | +1.1% | +4.5% |

#### Threshold T = 40   |   ρ(qFor, won) = 0.052   ρ(qFor, flat ROI) = 0.058

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 26 | 46.2% | -12.6% | -0.6% |
| qFor ≥ 1 | 167 | 49.7% | -6.3% | -3.9% |
| qFor ≥ 2 | 132 | 47.0% | -9.2% | -2.3% |
| qFor ≥ 3+ | 132 | 50.0% | -1.6% | -1.5% |

#### Threshold T = 50   |   ρ(qFor, won) = 0.104   ρ(qFor, flat ROI) = 0.070

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 78 | 50.0% | -5.3% | -16.8% |
| qFor ≥ 1 | 208 | 47.6% | -8.6% | -1.1% |
| qFor ≥ 2 | 99 | 47.5% | -6.5% | -2.1% |
| qFor ≥ 3+ | 72 | 52.8% | +0.7% | -0.2% |

#### Threshold T = 60   |   ρ(qFor, won) = 0.142   ρ(qFor, flat ROI) = 0.085

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 162 | 48.1% | -8.1% | -12.8% |
| qFor ≥ 1 | 187 | 49.7% | -4.3% | +9.5% |
| qFor ≥ 2 | 61 | 50.8% | -4.2% | -7.9% |
| qFor ≥ 3+ | 47 | 44.7% | -9.3% | -12.0% |

#### Threshold T = 70   |   ρ(qFor, won) = 0.206   ρ(qFor, flat ROI) = 0.119

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| qFor ≥ 0 | 236 | 47.9% | -9.0% | -9.7% |
| qFor ≥ 1 | 159 | 49.1% | -5.0% | +6.0% |
...
#### Threshold T = 30   |   ρ(margin, won) = 0.116   ρ(margin, flat ROI) = 0.102

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 69 | 43.5% | -19.7% | -29.3% |
| margin +1 | 177 | 46.9% | -11.0% | -0.6% |
| margin +2 | 111 | 54.1% | +4.5% | +1.8% |
| margin ≥ +3 | 100 | 50.0% | +0.1% | -0.4% |

#### Threshold T = 40   |   ρ(margin, won) = 0.087   ρ(margin, flat ROI) = 0.054

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 91 | 47.3% | -6.8% | -0.4% |
| margin +1 | 187 | 51.3% | -1.9% | +5.1% |
| margin +2 | 108 | 47.2% | -9.0% | -1.3% |
| margin ≥ +3 | 71 | 46.5% | -12.0% | -13.5% |

#### Threshold T = 50   |   ρ(margin, won) = 0.100   ρ(margin, flat ROI) = 0.047
...
#### Threshold T = 60   |   ρ(margin, won) = 0.111   ρ(margin, flat ROI) = 0.037
...
#### Threshold T = 70   |   ρ(margin, won) = 0.187   ρ(margin, flat ROI) = 0.079

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| margin ≤ 0 | 282 | 48.9% | -4.6% | +0.0% |
| margin +1 | 132 | 47.7% | -10.1% | -5.0% |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 63 / 50.8% / -3.9% | 13 / 46.2% / -9.2% | 2 / 50.0% / -24.7% | — | — | — | — |
| 1 | 166 / 47.6% / -9.3% | 37 / 48.6% / -4.6% | 5 / 40.0% / -16.5% | — | — | — | — |
| 2 | 61 / 41.0% / -21.8% | 29 / 51.7% / -2.0% | 6 / 83.3% / +54.0% | 3 / 66.7% / +139.8% | — | — | — |
| 3 | 11 / 72.7% / +30.8% | 11 / 63.6% / +11.0% | 7 / 57.1% / +45.1% | 2 / 100.0% / +121.2% | 1 / 0.0% / -100.0% | 1 / 100.0% / +45.9% | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 18 / 38.9% / -25.6% | 6 / 50.0% / +2.8% | 2 / 100.0% / +57.7% | — | — | — | — | — | — |
| 1 | 123 / 49.6% / -7.4% | 37 / 56.8% / +10.0% | 5 / 20.0% / -62.5% | 2 / 0.0% / -100.0% | — | — | — | — | — |
| 2 | 74 / 45.9% / -12.6% | 49 / 51.0% / +1.0% | 7 / 28.6% / -46.0% | 2 / 50.0% / -1.9% | — | — | — | — | — |
| 3 | 30 / 46.7% / -11.5% | 26 / 46.2% / -10.1% | 7 / 85.7% / +65.3% | 5 / 60.0% / +67.6% | 1 / 0.0% / -100.0% | 2 / 50.0% / -27.1% | — | — | — |
...
ρ(Δcontribution, won) = -0.027   |   ρ(Δcontribution, flat ROI) = -0.004
...
| --- | --- | --- | --- | --- | --- |
| Low  (Δ ≤ 61.7) | 152 | 21.9 | 50.0% | -5.3% | -6.5% |
| Mid  (61.8 .. 120.4) | 152 | 89.6 | 50.7% | +0.5% | +5.8% |
| High (Δ ≥ 121.1) | 153 | 192.4 | 45.8% | -13.5% | -5.3% |

#### Absolute Δcontribution cuts

| Bucket | N | WR | flat ROI | wtd ROI |
| --- | --- | --- | --- | --- |
| Δ ≤ 0 (opposition matched/led) | 31 | 48.4% | -7.4% | -6.3% |
| 0 < Δ ≤ 50 | 77 | 54.5% | +2.7% | +3.3% |
| 50 < Δ ≤ 100 | 146 | 45.2% | -9.4% | +0.1% |
| Δ > 100 | 203 | 49.3% | -6.9% | -3.9% |
...
| --- | --- | --- | --- | --- |
| STRONG | 154 | 48.1% | -8.9% | -3.5% |
| STANDARD | 166 | 47.6% | -9.3% | -5.2% |
| LEAN | 111 | 52.3% | +0.9% | +4.4% |
| MUTE | 26 | 46.2% | +0.5% | +4.2% |

#### Current V8 ★/units assigned within each proposed tier

| Tier | N | mean ★ | mean units |
| --- | --- | --- | --- |
| STRONG | 154 | 3.97 | 1.76 |
| STANDARD | 166 | 3.20 | 0.98 |
| LEAN | 111 | 3.06 | 0.86 |
| MUTE | 26 | 2.76 | 0.73 |
