# What works (update from pulse)

Seed 2026-07-10:
- Outbound replies on high-velocity niche parents
- Decision-window / unfinished story formats
- Lead green (wins/proof) not negative-led
- Public vs sharp money map → verdict
- Dual job heroes (engage + convert plant)

2026-07-11 (pre-grade — bet, not measured win yet):
